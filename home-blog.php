...
<section id="home_blog" class="grey-wrapper section-shadow sec-spacing">
	<div class="container">
		...
		<div id="home_blog" class="blog-masonry ajax_posts padding-top">
			<?php
			$post_id = ($awada_theme_options['portfolio_post'] == ''?'':$awada_theme_options['portfolio_post']);
			$portfolio_id = intval($post_id);
			$args = array('post_type' => 'post', 'posts_per_page' => $awada_theme_options['home_load_post_num'], 'post__not_in' => array($portfolio_id));
			...
			<div class="col-md-4 awada-grid-item">
