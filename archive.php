        ...
        <div class="col-md-12 bread-row">
            <div class="container jobile-container">
                <div class="col-md-6 no-padding-lr bread-left">
                   <h2>
                        <?php if ( have_posts() ) : esc_html_e( 'Archives', 'jobile' ); echo ' : ' . get_the_date('M-Y');
                            endif; ?>
                    </h2>
                </div>
                    ...
                    <div class="col-md-8">
                        ...
                        <?php while ( have_posts() ) : the_post(); ?>
                            <div class="col-md-12 no-padding-lr sear-result-column">
                                ...
                                <?php }else { ?>
                                    <img src="<?php echo esc_url(get_template_directory_uri()) ?>/images/no-image.jpg" width="100" height="86" alt="" />
                                 <?php } ?>
                                 </div>
                                    ...
                                    <div class="result-btm-text"><?php the_excerpt(); ?><a href="<?php echo  esc_url(get_permalink()); ?>" class="color-068587"><?php esc_html_e('Read More','jobile'); ?></a></div>
                                    </div>
                                    </div>
                                    </div>
                                </div>
