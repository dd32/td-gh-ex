			...
			<header class="page-header">
				<h2 class="page-title">
					<?php
						...
						elseif ( is_month() ) :
							printf( __( 'Month: %s', 'mwsmall' ), '<span>' . get_the_date( _e( 'F Y', 'monthly archives date format', 'mwsmall' ) ) . '</span>' );

						elseif ( is_year() ) :
							printf( __( 'Year: %s', 'mwsmall' ), '<span>' . get_the_date( _e( 'Y', 'yearly archives date format', 'mwsmall' ) ) . '</span>' );
