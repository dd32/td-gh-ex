 ...
 <div class="col-md-12 a1-breadcrumb" >
   <div class="container a1-container">
     <div class="col-md-6 col-sm-6 no-padding-lr left-part">
       <h3>
       <?php        if ( is_day() ) :
           esc_html_e( 'Daily Archives', 'a1' ); echo ': <span>' . get_the_date() . '</span>';
       elseif ( is_month() ) :
           esc_html_e( 'Monthly Archives', 'a1' ); echo ': <span>' . get_the_date( 'F Y' ) . '</span>';
       elseif ( is_year() ) :
           esc_html_e( 'Yearly Archives', 'a1' ); echo ': <span>' . get_the_date( 'Y' ) . '</span>';
       endif; ?>
       </h3>
     </div>
