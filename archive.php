...
<div id="content" class="twocolumns">
	<?php if (have_posts()) : ?>
		...
		<?php while (have_posts()) : the_post(); ?>
			<div class="post">
				<h2 id="post-<?php the_ID(); ?>">
					<a href="<?php the_permalink() ?>" rel="bookmark" title="<?php printf(__('Permanent Link to %s', 'rcg-forest'), the_title_attribute('echo=0')); ?>"><?php the_title(); ?></a>
				</h2>
				...
				<div class="postinfocom">
					<small>
						...
						<span class="alignright com">
							<?php comments_popup_link(__('No Comments &#187;', 'rcg-forest'), __('1 Comment &#187;', 'rcg-forest'), __('% Comments &#187;', 'rcg-forest')); ?>
						</span>
					</small>
				</div>
			</div>
		...
		<div class="navigation">
			<div class="nav-prev"><?php next_posts_link(__('&laquo; Older Entries', 'rcg-forest')); ?></div>
			<div class="nav-next"><?php previous_posts_link(__('Newer Entries &raquo;', 'rcg-forest')); ?></div>
		</div>
	<?php else : ?>
