...
<h4 class="page-title">
<?php
    if ( is_day() ) : printf( __( 'Daily Archiv: %s', 'northern-web-coders' ), get_the_date('l - d F Y') );
	elseif ( is_month() ) : printf( __( 'Monthly Archiv: %s', 'northern-web-coders' ), get_the_date('F, Y') );
	elseif ( is_year() ) : printf( __( 'Yearly Archiv: %s', 'northern-web-coders' ), get_the_date( 'Y' ) );
    endif;
?>
</h4>
