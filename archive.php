  ...
  <div class="col-md-12 a1-breadcrumb">
    <div class="container a1-container">
      <div class="col-md-6 col-sm-6 no-padding-lr left-part">
        ...
        <?php 
        if ( is_day() ) :
            printf( __( 'Daily Archives: %s', 'a1' ), '<span>' . get_the_date() . '</span>' );

        elseif ( is_month() ) :
            printf( __( 'Monthly Archives: %s', 'a1' ), '<span>' . get_the_date( 'F Y' ) . '</span>' );

        elseif ( is_year() ) :
            printf( __( 'Yearly Archives: %s', 'a1' ), '<span>' . get_the_date( 'Y' ) . '</span>' );
        endif;
        ?>
        </h3>
      </div>
