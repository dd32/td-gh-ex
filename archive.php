...
<h2 class="pagetitle"><?php printf( __( 'Daily Archives: <span>%s</span>', 'quickpress'), get_the_date() ); ?></h2>

 	  <?php /* If this is a monthly archive */ } elseif (is_month()) { ?>
<h2 class="pagetitle"><?php printf( __( 'Monthly Archives: <span>%s</span>', 'quickpress'), get_the_date( 'F Y' ) ); ?></h2>

 	  <?php /* If this is a yearly archive */ } elseif (is_year()) { ?>
<h2 class="pagetitle"><?php printf( __( 'Monthly Archives: <span>%s</span>', 'quickpress'), get_the_date( 'Y' ) ); ?></h2>
