...
if( ! class_exists('Yds_Customizer_API_Wrapper') ) {
    class Yds_Customizer_API_Wrapper {
...
public static function getInstance($options) {
 if (!self::$instance) {
 self::$instance = new Yds_Customizer_API_Wrapper($options);
 }
...
/**
 ...
 public function enqueue_scripts() {
       ...
       wp_localize_script( 'customizer-js', 'personalportfolio_upgrade', array( 'message' => __( 'Upgrade to Pro', 'abaya')));
   }
/**
...
/**
   ...
   public function add_control($wp_customize, $field_id, $field_details) {
       ...
       switch ($type) {
		   ...
		   case 'woo_category':
              $test = array();
		   $teh_cats = get_terms('product_cat', array ('orderby'=>'count','order' => 'DESC'));
