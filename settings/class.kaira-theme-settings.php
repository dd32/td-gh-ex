...
class Kaira_theme_settings {
	...
	public function __construct() {
		...
		$this->sections['general']   = __( 'General Settings', 'electa' );
		$this->sections['styling']   = __( 'Styling Settings', 'electa' );
        $this->sections['blog']   = __( 'Blog Settings', 'electa' );
        $this->sections['social']   = __( 'Social Links', 'electa' );
        $this->sections['website']   = __( 'Website Text', 'electa' );
        
		$this->sections['premium']     = __( 'Kaira', 'electa' );
	...
	public function kaira_add_pages() {
		$admin_page = add_theme_page( __( 'ELECTA Settings', 'electa' ), __( 'ELECTA Settings', 'electa' ), 'manage_options', 'kaira-theme-options', array( &$this, 'kaira_display_page' ) );
	...
	public function kaira_create_setting( $args = array() ) {
		...
		$defaults = array(
			...
			'title'   => __( 'Kaira Setting', 'electa' ),
			'desc'    => __( 'This is a default description.', 'electa' ),
			'std'     => '',
			'type'    => 'text',
			'section' => 'general',
			'choices' => array(),
	...
	public function kaira_display_page() {
		...
		echo '<div class="wrap kaira-theme-options-wrap">
                ...
                <h2>' . __( 'Electa Theme Settings', 'electa' ) . '</h2>
                <div class="kaira-recommended-plugins">' . __( 'Install <a href="'. admin_url('plugin-install.php?tab=favorites&user=kaira') . '" target="_blank">recommended plugins</a> to make your website development easier', 'electa' ) . '</div>';
                    if ( isset( $_GET['settings-updated'] ) && $_GET['settings-updated'] == true )
            			echo '<div class="updated fade"><p>' . __( 'Theme options updated.', 'electa' ) . '</p></div>';
            		...
            		echo '</div>
            		<p class="submit"><input name="Submit" type="submit" class="button-primary" value="' . __( 'Save Changes', 'electa' ) . '" /></p>
            	</form>';
    	echo '</div>';
	}
		...
		switch ( $type ) {
			...
			case 'checkbox':
				echo '<input class="checkbox' . esc_attr( $field_class ) . '" type="checkbox" id="' . esc_attr( $id ) . '" name="kaira_theme_options[' . esc_attr( $id ) . ']" value="1" ' . checked( $options[$id], 1, false ) . ' />
                      <label class="option-description" for="' . wp_kses_post( $id ) . '">' . wp_kses_post( $desc ) . '</label>';
				break;
            ...
            case 'upsell':
                echo '<a href="' . esc_url( $desc ) . '" class="kaira-upsell-btn" target="_blank">Upgrade to Electa Premium</a>';
                echo '<br /><span class="description">' . __( 'Upgrade to premium to get all features', 'electa' ) . '</span></label>';
                break;
	...
	public function get_kaira_option() {
		...
		$this->settings['kra-favicon'] = array(
			...
			'desc'    => __( 'Upload a favicon to your website, this needs to be 16 pixels by 16 pixels', 'electa' ),
			'std'     => '',
			'type'    => 'media',
			'section' => 'general'
		);
        ...
        $this->settings['kra-header-slogan'] = array(
            'section' => 'general',
        ...
        $this->settings['kra-header-search'] = array(
            ...
            'desc'    => __( 'Select this to show the search in the header', 'electa' ),
            'type'    => 'checkbox',
            'std'     => 1 // Set to 1 to be checked by default
        );
        $this->settings['kra-heading-upsell-zero'] = array(
            'section' => 'general',
            'title'   => __( 'Sticky Header', 'electa' ),
            'desc'    => __( 'http://sllwi.re/p/Fs', 'electa' ),
            'type'    => 'upsell',
            'std'     => ''
        );
        
        $this->settings['kra-heading-one-two'] = array(
            'section' => 'general',
            'title'   => '', // Not used for headings.
            'desc'    => 'Homepage Settings',
            'type'    => 'heading'
        );
        $this->settings['kra-home-blocks-enable'] = array(
            'section' => 'general',
        ...
        $this->settings['kra-home-blocks-categories'] = array(
            'section' => 'general',
            'title'   => __( 'Home Blocks Categories', 'electa' ),
            'desc'    => __( 'Enter the ID of the <a href="'. admin_url('edit-tags.php?taxonomy=category') . '" target="_blank">post categories</a> you\'d like to EXCLUDE from the Blog, enter only the ID\'s with a minus sign (-) before them, separated by a comma (,)<br />Eg: "-13, -17, -19"<br />If you enter the ID\'s without the minus then it\'ll show ONLY posts in those categories.', 'electa' ),
            'type'    => 'text',
            'std'     => ''
        );
        ...
        /* Styling Settings
        ===========================================*/
        $this->settings['kra-header-bg-color'] = array(
            'title'   => __( 'Header Background color', 'electa' ),
            'desc'    => __( 'This is the color of the header background. Default: #FFFFFF', 'electa' ),
            'std'     => '#FFFFFF',
            'type'    => 'color',
            'section' => 'styling'
        );
        
        $this->settings['kra-heading-two-two'] = array(
            'section' => 'styling',
            'title'   => '', // Not used for headings.
            'desc'    => 'Site Colors',
            'type'    => 'heading'
        ...
        $this->settings['kra-primary-color'] = array(
            ...
            'desc'    => __( 'This is the color of buttons, etc around the site. Default: #4965A0', 'electa' ),
            'std'     => '#4965A0',
            'type'    => 'color',
            'section' => 'styling'
        );
        $this->settings['kra-primary-color-hover'] = array(
            ...
            'desc'    => __( 'This is the hover color for buttons, etc around the site. Default: #3e578b', 'electa' ),
            'std'     => '#3e578b',
            'type'    => 'color',
            'section' => 'styling'
        );
        ...
        $this->settings['kra-body-google-font-url'] = array(
            'section' => 'styling',
            'title'   => __( 'Body font URL', 'electa' ),
            'desc'    => __( 'Enter ONLY the fonts URL here. Eg: link href=\'<b><big> //fonts.googleapis.com/css?family=Open+Sans:400italic,400 </big></b>\' rel=\'stylesheet\' type=\'text/css\'', 'electa' ),
            'type'    => 'url',
        ...
        $this->settings['kra-body-google-font-name'] = array(
            'section' => 'styling',
            'title'   => __( 'Body font name', 'electa' ),
            'desc'    => __( 'Enter the FULL name. Eg:<b><big> font-family: \'Open Sans\', sans-serif; </big></b>', 'electa' ),
            'type'    => 'text',
            'std'     => 'font-family: \'Open Sans\', sans-serif;'
        );
        $this->settings['kra-body-google-font-color'] = array(
            'title'   => __( 'Body font color', 'electa' ),
            'desc'    => __( 'Select a color for the body font. Default: #7B7D80', 'electa' ),
            'std'     => '#7B7D80',
            'type'    => 'color',
            'section' => 'styling'
        );
        $this->settings['kra-heading-google-font-url'] = array(
            'section' => 'styling',
            'title'   => __( 'Heading font URL', 'electa' ),
            'desc'    => __( 'Enter ONLY the fonts URL here. Eg: link href=\'<b><big> //fonts.googleapis.com/css?family=Open+Sans:400italic,400 </big></b>\' rel=\'stylesheet\' type=\'text/css\'', 'electa' ),
            'type'    => 'url',
        ...
        $this->settings['kra-heading-google-font-name'] = array(
            'section' => 'styling',
            'title'   => __( 'Heading font name', 'electa' ),
            'desc'    => __( 'Enter the FULL name. Eg:<b><big> font-family: \'Roboto\', sans-serif; </big></b>', 'electa' ),
            'type'    => 'text',
            'std'     => 'font-family: \'Roboto\', sans-serif;'
        );
        $this->settings['kra-heading-google-font-color'] = array(
            'title'   => __( 'Heading font color', 'electa' ),
            'desc'    => __( 'Select a color for the body font. Default: #5A5A5A', 'electa' ),
            'std'     => '#5A5A5A',
            'type'    => 'color',
            'section' => 'styling'
        );
        ...
        $this->settings['kra-custom-css'] = array(
            ...
            'desc'    => __( 'Add Custom CSS to add your own styling to the Theme', 'electa' ),
            'std'     => '',
            'type'    => 'textarea',
            'section' => 'styling',
            'class'   => 'code'
        ...
        /* Blog Settings
        ===========================================*/
        $this->settings['kra-blog-blocks-enable'] = array(
            'section' => 'blog',
        ...
        $this->settings['kra-blog-title'] = array(
            ...
            'desc'    => __( 'Enter the title you want for the blog page.', 'electa' ),
            'type'    => 'text',
            'std'     => 'Blog'
        );
        $this->settings['kra-blog-excl-categories'] = array(
            'section' => 'blog',
            'title'   => __( 'Blog Categories', 'electa' ),
            'desc'    => __( 'Enter the ID\'s of the <a href="'. admin_url('edit-tags.php?taxonomy=category') . '" target="_blank">post categories</a> you\'d like to EXCLUDE from the Blog, enter only the ID\'s with a minus sign (-) before them, separated by a comma (,)<br />Eg: "-13, -17, -19"<br />If you enter the ID\'s without the minus then it\'ll show ONLY posts in those categories.', 'electa' ),
            'type'    => 'text',
            'std'     => ''
        );
        ...
        $this->settings['kra-heading-upsell-three'] = array(
            'section' => 'social',
            'title'   => __( 'Social Media Links', 'electa' ),
            'desc'    => __( 'http://sllwi.re/p/Fs', 'electa' ),
            'type'    => 'upsell',
            'std'     => ''
        );
        ...
        $this->settings['kra-website-error-head'] = array(
            ...
            'desc'    => __( 'Enter the heading for the 404 Error page', 'electa' ),
            'type'    => 'text',
            'std'     => 'Oops! That page can\'t be found.'
        );
        $this->settings['kra-website-error-msg'] = array(
            'title'   => __( 'Error 404 Message', 'electa' ),
            'desc'    => __( 'Enter the default text on the 404 error page (Page not found)', 'electa' ),
        ...
        $this->settings['kra-website-nosearch-msg'] = array(
            ...
            'desc'    => __( 'Enter the default text for when no search results are found', 'electa' ),
