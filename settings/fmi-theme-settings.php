...
class Fmi_theme_settings{
	...
	public function get_fmi_option() {
        ...
        $this->settings['vs-body-google-font-url'] = array(
            ...
            'desc'    => __( 'Enter ONLY the fonts URL here. Eg: link href=\'<b><big> //fonts.googleapis.com/css?family=Open+Sans:400,300,300italic,400italic,600,600italic,700,700italic </big></b>\' rel=\'stylesheet\' type=\'text/css\'','fmi'),
            'type'    => 'url',
        ...
        $this->settings['vs-heading-google-font-url'] = array(
            'section' => 'styling',
            'title'   => __( 'Heading font URL', 'fmi' ),
            'desc'    => __( 'Enter ONLY the fonts URL here. Eg: link href=\'<b><big> //fonts.googleapis.com/css?family=Roboto:400,300,300italic,400italic,500,500italic,700,700italic </big></b>\' rel=\'stylesheet\' type=\'text/css\'', 'fmi' ),
            'type'    => 'url',
            'std'     => '//fonts.googleapis.com/css?family=Roboto:400,300,300italic,400italic,500,500italic,700,700italic'
        );
        $this->settings['vs-heading-google-font-name'] = array(
            'section' => 'styling',
            'title'   => __( 'Heading font name', 'fmi' ),
            'desc'    => __( 'Enter the FULL name. Eg:<b><big> font-family: \'Roboto\', sans-serif; </big></b>', 'fmi' ),
            'type'    => 'text',
	...
	public function load_fmi_scripts() {
        wp_enqueue_script( 'base-js', get_stylesheet_directory_uri() . '/settings/js/fmi-admin.js', array( 'jquery', 'jquery-ui-draggable', 'jquery-ui-slider', 'jquery-touch-punch', 'iris', 'wp-color-picker' ), false, 1 );
	...
	public function load_fmi_styles() {
        ...
        wp_enqueue_style( 'base-css', get_stylesheet_directory_uri() . '/settings/css/fmi-admin.css' );
	}
