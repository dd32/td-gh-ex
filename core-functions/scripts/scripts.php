...
function asiathemes_scripts()
{
 /*--------Css----------*/
	...
	wp_enqueue_script('becorp-animations-js',ASIATHEMES_TEMPLATE_DIR_URI.'/js/animations.js');
	// /** Animation CSS **/
	wp_enqueue_style('becorp-animations.min-css',ASIATHEMES_TEMPLATE_DIR_URI.'/css/animations.css');
