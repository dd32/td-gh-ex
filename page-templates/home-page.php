		...
		<div id="myCarousel" class="carousel slide">
		   ...
		   <?php  for($a1_i=1; $a1_i <= 5 ;$a1_i++ ): if(empty($a1_options['slider-img-'.$a1_i])) { continue; } ?>
			  <div class="item <?php if($a1_i==1){ echo'active'; } ?>">
				 <img src="<?php if(!empty($a1_options['slider-img-'.$a1_i])) { echo esc_url($a1_options['slider-img-'.$a1_i]); } ?>" width="1350" height="539" alt="First slide">
			...
			<?php if(!empty($a1_options['productcontent'])) { echo '<div class="col-md-7 col-sm-7 description-left">'.$a1_options['productcontent'].'</div>'; } ?>
				<div class="col-md-4 col-sm-4 col-md-offset-1 col-sm-offset-1 description-right">
					<form method="post" name="contact_form" id="contact_form">
						<input id="a1_name" type="text" name="a1_name" placeholder="Enter your name">
						<input id="a1_email" type="email" name="a1_email" placeholder="Enter your email">
						<input id="a1_phone" type="text" name="a1_phone" placeholder="Enter your phone">
						<textarea id="a1_message" name="a1_message" placeholder="Enter your message"></textarea>
						<input type="submit" name="a1_submit" id="a1_submit" value="send">
					</form>
...
$data = '<a class="step2popup contact-button" href="'.esc_url($a1_options['get-touch-page']).'" data="3">'.esc_attr($a1_options['contactus-now-text']).'</a>'; echo apply_filters("the_content",$data); } ?>
		</div>
	</div>
<?php } ?>
<!--get touch end-->
