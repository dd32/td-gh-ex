...
<?php while ( have_posts() ) : the_post(); ?>      
      ...
      <div class="col-md-12 singleblog-img no-padding singleblog-contan">
			 ...
			 if($top_mag_featured_image[0] != '') { ?>
       		 <img src="<?php echo esc_url($top_mag_featured_image[0]); ?>" width="<?php echo esc_attr($top_mag_featured_image[1]); ?>" height="<?php echo esc_attr($top_mag_featured_image[2]); ?>" alt="<?php echo get_the_title(); ?>" class="img-responsive" />
			 <?php } ?>
          	<?php the_content(); ?>
       </div>        
