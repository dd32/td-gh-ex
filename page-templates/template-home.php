...
<section id="content">
 <section class="container paddingtop">
      ...
      <?php }elseif(isset($home_template_blog)&&$home_template_blog=='listleft'){?>
      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 pull-left">
        <div class="sidebar wow fadeInUp">
         <?php if (is_active_sidebar('primary-sidebar') ) {dynamic_sidebar('primary-sidebar');} ?>
        </div>
      ...
      <?php }elseif(isset($home_template_blog)&&$home_template_blog=='listright'){?>      
      <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
          <main id="main" class="site-main">
          <div class="row">
           <?php 
      ...
      <?php }elseif(isset($home_template_blog)&&$home_template_blog=='listfull'){?>      
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <main id="main" class="site-main">
          <div class="row">
           <?php 
