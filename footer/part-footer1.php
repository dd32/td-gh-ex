 ...
 <div id="footer">
    ...
    <div class="row">
           ...
           <?php
				...
				$safreen_footertext = esc_html(get_theme_mod('safreen_footertext'));
...
echo $safreen_footertext;
            ...
            <?php $safreen_social2_checkbox = get_theme_mod('safreen_social2_checkbox');?>
<?php if( isset($safreen_social2_checkbox) && $safreen_social2_checkbox != 0 ):?>
