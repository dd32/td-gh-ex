...
class Options_Machine {
	...
	public static function optionsframework_sidebars_function($id,$std,$oldorder,$order){
		...
		if(!empty($val['icon_o'])) {
			...
			$icon_option = array(
			"icon-adjust" => "icon-adjust", "icon-align-center" => "icon-align-center", "icon-align-justify" => "icon-align-justify", "icon-align-left" => "icon-align-left", "icon-align-right" => "icon-align-right", "icon-arrow-down" => "icon-arrow-down", "icon-arrow-left" => "icon-arrow-left", "icon-arrow-right" => "icon-arrow-right", "icon-arrow-up" => "icon-arrow-up", "icon-asterisk" => "icon-asterisk", "icon-backward" => "icon-backward", "icon-ban-circle" => "icon-ban-circle", "icon-bar-chart" => "icon-bar-chart", "icon-beaker" => "icon-beaker", "icon-bell" => "icon-bell", "icon-bold" => "icon-bold", "icon-bolt" => "icon-bolt", "icon-bookmark" => "icon-bookmark", "icon-bookmark-empty" => "icon-bookmark-empty", "icon-briefcase" => "icon-briefcase", "icon-bullhorn" => "icon-bullhorn", "icon-calendar" => "icon-calendar", "icon-camera" => "icon-camera", "icon-camera-retro" => "icon-camera-retro", "icon-caret-down" => "icon-caret-down", "icon-caret-left" => "icon-caret-left", "icon-caret-right" => "icon-caret-right", "icon-caret-up" => "icon-caret-up", "icon-certificate" => "icon-certificate", "icon-check" => "icon-check", "icon-check-empty" => "icon-check-empty", "icon-chevron-down" => "icon-chevron-down", "icon-chevron-left" => "icon-chevron-left", "icon-chevron-right" => "icon-chevron-right", "icon-chevron-up" => "icon-chevron-up", "icon-circle-arrow-down" => "icon-circle-arrow-down", "icon-circle-arrow-left" => "icon-circle-arrow-left", "icon-circle-arrow-right" => "icon-circle-arrow-right", "icon-circle-arrow-up" => "icon-circle-arrow-up", "icon-cloud" => "icon-cloud", "icon-cog" => "icon-cog", "icon-cogs" => "icon-cogs", "icon-columns" => "icon-columns", "icon-comment" => "icon-comment", "icon-comment-alt" => "icon-comment-alt", "icon-comments" => "icon-comments", "icon-comments-alt" => "icon-comments-alt", "icon-copy" => "icon-copy", "icon-credit-card" => "icon-credit-card", "icon-cut" => "icon-cut", "icon-dashboard" => "icon-dashboard", "icon-download" => "icon-download", "icon-download-alt" => "icon-download-alt", "icon-edit" => "icon-edit", "icon-eject" => "icon-eject", "icon-envelope" => "icon-envelope", "icon-envelope-alt" => "icon-envelope-alt", "icon-exclamation-sign" => "icon-exclamation-sign", "icon-external-link" => "icon-external-link", "icon-eye-close" => "icon-eye-close", "icon-eye-open" => "icon-eye-open", "icon-facebook" => "icon-facebook", "icon-facebook-sign" => "icon-facebook-sign", "icon-facetime-video" => "icon-facetime-video", "icon-fast-backward" => "icon-fast-backward", "icon-fast-forward" => "icon-fast-forward", "icon-file" => "icon-file", "icon-film" => "icon-film", "icon-filter" => "icon-filter", "icon-fire" => "icon-fire", "icon-folder-close" => "icon-folder-close", "icon-folder-open" => "icon-folder-open", "icon-font" => "icon-font", "icon-forward" => "icon-forward", "icon-fullscreen" => "icon-fullscreen", "icon-gift" => "icon-gift", "icon-github" => "icon-github", "icon-github-sign" => "icon-github-sign", "icon-glass" => "icon-glass", "icon-globe" => "icon-globe", "icon-google-plus" => "icon-google-plus", "icon-google-plus-sign" => "icon-google-plus-sign", "icon-group" => "icon-group", "icon-hand-down" => "icon-hand-down", "icon-hand-left" => "icon-hand-left", "icon-hand-right" => "icon-hand-right", "icon-hand-up" => "icon-hand-up", "icon-hdd" => "icon-hdd", "icon-heart" => "icon-heart", "icon-heart-empty" => "icon-heart-empty", "icon-home" => "icon-home", "icon-inbox" => "icon-inbox", "icon-indent-left" => "icon-indent-left", "icon-indent-right" => "icon-indent-right", "icon-info-sign" => "icon-info-sign", "icon-italic" => "icon-italic", "icon-key" => "icon-key", "icon-leaf" => "icon-leaf", "icon-legal" => "icon-legal", "icon-lemon" => "icon-lemon", "icon-link" => "icon-link", "icon-linkedin" => "icon-linkedin", "icon-linkedin-sign" => "icon-linkedin-sign", "icon-list" => "icon-list", "icon-list-ol" => "icon-list-ol", "icon-list-ul" => "icon-list-ul", "icon-magic" => "icon-magic", "icon-magnet" => "icon-magnet", "icon-map-marker" => "icon-map-marker", "icon-minus" => "icon-minus", "icon-minus-sign" => "icon-minus-sign", "icon-money" => "icon-money", "icon-move" => "icon-move", "icon-music" => "icon-music", "icon-off" => "icon-off", "icon-ok" => "icon-ok", "icon-ok-circle" => "icon-ok-circle", "icon-ok-sign" => "icon-ok-sign", "icon-paper-clip" => "icon-paper-clip", "icon-paste" => "icon-paste", "icon-pause" => "icon-pause", "icon-pencil" => "icon-pencil", "icon-phone" => "icon-phone", "icon-phone-sign" => "icon-phone-sign", "icon-picture" => "icon-picture", "icon-pinterest" => "icon-pinterest", "icon-pinterest-sign" => "icon-pinterest-sign", "icon-plane" => "icon-plane", "icon-play" => "icon-play", "icon-play-circle" => "icon-play-circle", "icon-plus" => "icon-plus", "icon-plus-sign" => "icon-plus-sign", "icon-print" => "icon-print", "icon-pushpin" => "icon-pushpin", "icon-question-sign" => "icon-question-sign", "icon-random" => "icon-random", "icon-remove" => "icon-remove", "icon-remove-circle" => "icon-remove-circle", "icon-remove-sign" => "icon-remove-sign", "icon-reorder" => "icon-reorder", "icon-repeat" => "icon-repeat", "icon-resize-full" => "icon-resize-full", "icon-resize-horizontal" => "icon-resize-horizontal", "icon-resize-small" => "icon-resize-small", "icon-resize-vertical" => "icon-resize-vertical", "icon-retweet" => "icon-retweet", "icon-road" => "icon-road", "icon-rss" => "icon-rss", "icon-save" => "icon-save", "icon-screenshot" => "icon-screenshot", "icon-search" => "icon-search", "icon-share" => "icon-share", "icon-share-alt" => "icon-share-alt", "icon-shopping-cart" => "icon-shopping-cart", "icon-sign-blank" => "icon-sign-blank", "icon-signal" => "icon-signal", "icon-signin" => "icon-signin", "icon-signout" => "icon-signout", "icon-sitemap" => "icon-sitemap", "icon-sort" => "icon-sort", "icon-sort-down" => "icon-sort-down", "icon-sort-up" => "icon-sort-up", "icon-star" => "icon-star", "icon-star-empty" => "icon-star-empty", "icon-star-half" => "icon-star-half", "icon-step-backward" => "icon-step-backward", "icon-step-forward" => "icon-step-forward", "icon-stop" => "icon-stop", "icon-strikethrough" => "icon-strikethrough", "icon-table" => "icon-table", "icon-tasks" => "icon-tasks", "icon-text-height" => "icon-text-height", "icon-text-width" => "icon-text-width", "icon-th" => "icon-th", "icon-th-large" => "icon-th-large", "icon-th-list" => "icon-th-list", "icon-thumbs-down" => "icon-thumbs-down", "icon-thumbs-up" => "icon-thumbs-up", "icon-time" => "icon-time", "icon-tint" => "icon-tint", "icon-trash" => "icon-trash", "icon-trophy" => "icon-trophy", "icon-truck" => "icon-truck", "icon-twitter" => "icon-twitter", "icon-twitter-sign" => "icon-twitter-sign", "icon-umbrella" => "icon-umbrella", "icon-underline" => "icon-underline", "icon-undo" => "icon-undo", "icon-unlock" => "icon-unlock", "icon-upload" => "icon-upload", "icon-upload-alt" => "icon-upload-alt", "icon-user" => "icon-user", "icon-user-md" => "icon-user-md", "icon-warning-sign" => "icon-warning-sign", "icon-wrench" => "icon-wrench", "icon-zoom-in" => "icon-zoom-in", "icon-zoom-out" => "icon-zoom-out",
			);
					if(!empty($val['icon_o'])) {
