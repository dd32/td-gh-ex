...
?>
		...
		<div class="wrap getting-started">
			...
			<div class="intro-wrap">
				<div class="intro">
					<h3><?php esc_html_e( 'Anissa', 'anissa' ); ?></h3>
					<h4><?php esc_html_e( 'Anissa Theme Documentation', 'anissa' ); ?></h4>
				</div>
			</div>

			<div class="panels">
				<ul class="inline-list">
					<li class="current"><a id="help-tab" href="#"><?php esc_html_e( 'Help File', 'anissa' ); ?></a></li>
					<li><a id="themes-tab" href="#"><?php esc_html_e( 'More Themes &amp; Support', 'anissa' ); ?></a></li>
				</ul>
				...
				<div id="panel" class="panel">
					...
					<div id="help-panel" class="panel-left visible">
						...
						<?php
							...
							$rss = fetch_feed( 'https://alienwp.com/documentation/anissa-theme-documentation/feed/?withoutcomments=1' );
						...
						<?php if ( is_wp_error( $rss ) || empty( $rss_items_check ) ) : ?>
							<p><?php esc_html_e( 'This help file feed seems to be temporarily down. You can always view the help file on AlienWP in the meantime.', 'anissa' ); ?> <a href="https://alienwp.com/documentation/anissa-theme-documentation/" title="View help file"><?php esc_html_e( 'anissa Help File &rarr;', 'anissa' ); ?></a></p>
						<?php else : ?>
					...
					<div id="themes-panel" class="panel-left">
						<div class="theme-intro">
							<div class="theme-intro-left">
								<p><?php _e( 'Minimal and simple, yet powerful and efficient themes for serious site owners and professional WordPress users. Get our entire collection of 18 Themes and Full Support for just $59', 'anissa' ); ?></p>
							</div>
						...
						<!-- Output the feed -->
						<?php if ( is_wp_error( $rss ) || empty( $rss_items_check ) ) : ?>
							<p><?php esc_html_e( 'This page feed seems to be temporarily down. You can always view the themes on AlienWP in the meantime.', 'anissa' ); ?> <a href="https://alienwp.com/themes/" title="View help file"><?php esc_html_e( 'anissa Help File &rarr;', 'anissa' ); ?></a></p>
						<?php else : ?>
						    <?php foreach ( $rss_items as $item ) : ?>
								<?php echo $item->get_content(); ?>
						    <?php endforeach; ?>
					...
					<div class="panel-right"><img src="<?php echo get_template_directory_uri() . '/admin/getting-started/logo.png'; ?>" class="alienlogo"/>
						<div class="panel-aside panel-club">
							...
							<a href="<?php echo esc_url('https://alienwp.com/ref/9/'); ?>"><img src="<?php echo get_template_directory_uri() . '/admin/getting-started/club.jpg'; ?>" alt="<?php esc_html_e( 'Join the Theme Club!', 'anissa' ); ?>" /></a>
