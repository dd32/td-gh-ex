	...
	function weaverx_customizer_define_pagebuilder_sections() {
		...
		$pb_sections['pb-header-replace'] = array(
			...
			'options'     => array(
				...
				'pb-hdr1' => weaverx_cz_group_title( esc_html__( 'Header Replacement Page', 'weaver-xtreme' ),
					esc_html__( 'You can replace the entire Weaver Header area with the content from a page builder page. None of the standard theme header elements except the menu bars will be displayed.  You can also specify a Header Replacement as a Per Page option.', 'weaver-xtreme' ) ),
		...
		if ( ! defined( 'ELEMENTOR_VERSION' ) && ! defined( 'SITEORIGIN_PANELS_VERSION' ) ) {
			$pb_sections['pb-header-replace']['options']['no-pb1'] = weaverx_cz_group_title( esc_html__( 'No Page Builder Detected', 'weaver-xtreme' ),
		...
		$pb_sections['footer-pb-replace'] = array(
			...
			'options'     => array(
				...
				'pb-ftr1' => weaverx_cz_group_title( esc_html__( 'Footer Replacement', 'weaver-xtreme' ),
		...
		if ( ! defined( 'ELEMENTOR_VERSION' ) && ! defined( 'SITEORIGIN_PANELS_VERSION' ) ) {
			$pb_sections['footer-pb-replace']['options']['no-pb2'] = weaverx_cz_group_title( esc_html__( 'No Page Builder Detected', 'weaver-xtreme' ),
				esc_html__( 'Sorry, Weaver can only show a list of page builder pages from Elementor or SiteOrigin Page Builder, but you can still provide a page/post ID. Please install and activate one of those plugins.', 'weaver-xtreme' ) );
		}
			...
			'options'     => array(
				...
				'elementor_primary_color' => array(
					...
					'control' => array(
						...
						'label'        => esc_html__( 'Elementor Primary Color', 'weaver-xtreme' ),
						'description'  => esc_html__( 'The Primary color is used for Elementor Titles and other elements.', 'weaver-xtreme' ),
					),
				),
				...
				'elementor_secondary_color' => array(
					...
					'control' => array(
						'control_type' => WEAVERX_COLOR_CONTROL,
						'label'        => esc_html__( 'Elementor Secondary Color', 'weaver-xtreme' ),
						'description'  => esc_html__( 'The Secondary color is used in just a few Elementor elements.', 'weaver-xtreme' ),
					),
				),
				...
				'elementor_text_color' => array(
					...
					'control' => array(
						'control_type' => WEAVERX_COLOR_CONTROL,
						'label'        => esc_html__( 'Elementor Text Color', 'weaver-xtreme' ),
						'description'  => esc_html__( 'The Text color is used as the main text color in most of the Elementor elements.', 'weaver-xtreme' ),
					),
				),
				...
				'elementor_accent_color' => array(
					...
					'control' => array(
						'control_type' => WEAVERX_COLOR_CONTROL,
						'label'        => esc_html__( 'Elementor Accent Color', 'weaver-xtreme' ),
						'description'  => esc_html__( 'The Accent color is used as ta highlight color in some Elementor elements such as the TAB element.', 'weaver-xtreme' ),
					),
				),
			),
