            ...
            <div class="attire-sb-layout">
                <label>
                    <input type="radio" <?php $this->link(); ?> name="<?php echo esc_attr($this->id); ?>"
                           value="no-sidebar"/>
                    <img src="<?php echo esc_attr($imguri); ?>no-sidebar.png" alt="Full Width" title="Full Width"/>
                </label>
                <label>
                    <input type="radio" <?php $this->link(); ?> name="<?php echo esc_attr($this->id); ?>"
                           value="left-sidebar-1"/>
                    <img src="<?php echo esc_attr($imguri); ?>left-sidebar.png" alt="Left Sidebar"
                         title="Left Sidebar"/>
                </label>
                <label>
                    <input type="radio" <?php $this->link(); ?> name="<?php echo esc_attr($this->id); ?>"
                           value="right-sidebar-1"/>
                    <img src="<?php echo esc_attr($imguri); ?>right-sidebar.png" alt="Right Sidebar"
                         title="Right Sidebar"/>
                </label>
                <label>
                    <input type="radio" <?php $this->link(); ?> name="<?php echo esc_attr($this->id); ?>"
                           value="sidebar-2"/>
                    <img src="<?php echo esc_attr($imguri); ?>sidebar-2.png" alt="Sidebar | Content | Sidebar"
                         title="Sidebar | Content | Sidebar"/>
                </label>
                <label>
                    <input type="radio" <?php $this->link(); ?> name="<?php echo esc_attr($this->id); ?>"
                           value="left-sidebar-2"/>
                    <img src="<?php echo esc_attr($imguri); ?>left-sidebar-2.png" alt="Two Left Sidebar"
                         title="Two Left Sidebar"/>
                </label>
                <label>
                    <input type="radio" <?php $this->link(); ?> name="<?php echo esc_attr($this->id); ?>"
                           value="right-sidebar-2"/>
                    <img src="<?php echo esc_attr($imguri); ?>right-sidebar-2.png" alt="Two Right Sidebar"
            ...
            <div class="attire-image-picker">
                <?php foreach ($this->choices as $choice): ?>
                    ...
                    <label>
                        ...
                        <img src="<?php echo esc_attr($choice['src']); ?>"
