...
?><?php if ($mantra_s1bg != "#FFFFFF") { ?> #primary { background-color:<?php echo $mantra_s1bg; ?>} <?php }
?><?php if ($mantra_s2bg != "#FFFFFF") { ?> #secondary { background-color:<?php echo $mantra_s2bg; ?>} <?php }
