...
function optionsframework_fields() {
	...
	foreach ($options as $value) {
		...
		case 'typography':	
			...
			$faces = antmagazine_recognized_font_faces();
			...
			/* Font Style */
			$styles = antmagazine_recognized_font_styles();
		...
		case 'background':
			...
			$repeats = antmagazine_recognized_background_repeat();
			...
			$positions = antmagazine_recognized_background_position();
		...
		case "info":
			...
			if ( $value['desc'] ) {
				$output .= apply_filters('antmagazine_sanitize_info', $value['desc'] ) . "\n";
			}
