...
if (!class_exists('newsmag_Redux_Framework_config')) {

    class newsmag_Redux_Framework_config {
        ...
        public function setSections() {
                ...
                'fields'    => array(
                    ...
                    array(
                     ...
                     array(
                        ...
                        'subtitle'  => __('Allowed maximum height 39px', 'redux-framework'),
                    ...
                    array(
                        ...
                        'default'  => __('© Copyright 2014 Newsmag. All Rights Reserved.', 'redux-framework'),
                    ),
            ...
            $this->sections[] = array(
                ...
                'desc'      => __('<p class="description">Newsmag News / Magazine WordPress Theme</p>', 'redux-framework'),
                'fields'    => array(
                    array(
                        'id'        => 'opt-raw-info',
                        'type'      => 'raw',
        ...
        public function setHelpTabs() {
            ...
            $this->args['help_tabs'][] = array(
                'id'        => 'redux-help-tab-1',
                'title'     => __('Newsmag Help', 'redux-framework-demo'),
...
// SOCIAL ICONS -> Setup custom links in the footer for quick links in your panel footer icons.
    ...
    global $reduxConfig;
    $reduxConfig = new newsmag_Redux_Framework_config();
}

/**
  Custom function for the callback referenced above
 */
if (!function_exists('newsmag_my_custom_field')):
    function newsmag_my_custom_field($field, $value) {
        print_r($field);
        echo '<br/>';
        print_r($value);
    }
 ...
 * */
if (!function_exists('newsmag_validate_callback_function')):
    function newsmag_validate_callback_function($field, $value, $existing_value) {
        $error = false;
        $value = 'just testing';
