...
/**
			...
			if ( !empty($type) ) {
				...
				**/
				if (!empty($type) && empty($data)) {
					...
					} else if ($type == "portfolio" || $type == "portfolio") {
						$args=array(
							'post_type' => 'portfolio',
							'post_status' => 'publish',
							'posts_per_page' => 100
        ...
        public function _options_page_html() {
			...
			echo '<a href="http://www.thinkupthemes.com/themes/renden/" target="_blank" class="promotion-button">Upgrade Now</a>';
