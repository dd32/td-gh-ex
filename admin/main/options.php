...
//			),
	...
	Redux::setSection( $opt_name, array(
		...
		'desc'       => __('<span class="redux-title">Homepage Layout</span>', 'lan-thinkupthemes'),
		'icon_class' => '',
		'icon'       => 'el el-home',
        'subsection' => $thinkup_customizer_subsection,
        'customizer' => true,
	...
	Redux::setSection( $opt_name, array(
		...
		'fields'     => array(
			...
			array(
				'title'                      => __('Last FM', 'lan-thinkupthemes'), 
				$thinkup_subtitle_panel      => __('Enable link to Last FM profile.', 'lan-thinkupthemes'),
				$thinkup_subtitle_customizer => __('Enable link to Last FM profile.', 'lan-thinkupthemes'),
			...
			array(
				'desc'     => __('Input the url to your Last FM page. <strong>Note:</strong> Add http:// as the url is an external link.', 'lan-thinkupthemes'),
			...
			array(
				'desc'     => __('Use Custom Last FM Icon', 'lan-thinkupthemes'),
