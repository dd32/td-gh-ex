		...
		<div id="current-theme" class="<?php echo esc_attr( $class ); ?>">
			<?php if ( $screenshot ) : ?>
				...
				<a href="<?php echo wp_customize_url(); ?>" class="load-customize hide-if-no-customize" title="<?php echo esc_attr( $customize_title ); ?>">
					<img src="<?php echo esc_url( $screenshot ); ?>" alt="<?php esc_attr_e( 'Current theme preview', 'redux-framework' ); ?>" />
				</a>
				<?php endif; ?>
				<img class="hide-if-customize" src="<?php echo esc_url( $screenshot ); ?>" alt="<?php esc_attr_e( 'Current theme preview', 'redux-framework' ); ?>" />
			<?php endif; ?>
	...
	$sections[] = array(
		...
		'fields' => array(
			...
			array(
				...
				'subtitle' => __('Select page layout. This will only be applied to static homepages (front page) and not to homepage blogs.', 'redux-framework'),
...
//				'default' => '1'// 1 = on | 0 = off
			...
			array(
				'subtitle' => __('Enter a <strong>title</strong> message.<br /><br />This will be one of the first messages your visitors see. Use this to get their attention.', 'redux-framework'),
			...
			array(
				...
				'subtitle' => __('Specify a text for button 1.', 'redux-framework'),
	...
	-----------------------------------------------------------------------------------*/					
		...
		'fields' => array(
			...
			array(
				...
				'type'=>'info',
				'style'=>'help',
				'desc' => __( '<span class="redux-title">Control Sub-Footer Content</span>', 'redux-framework')
				),

			array(
				'title' => __('Post-Footer Widgets Layout', 'redux-framework'), 
				'subtitle' => __('Select post-footer layout. Take complete control of the post-footer content by adding widgets.', 'redux-framework'),
				'id'=>'thinkup_subfooter_layout',
				'type' => 'image_select',
				'compiler'=>true,
				'options' => array(
					'option1' => REDUX_URL.'assets/img/layout/sub-footer/option01.png',
					'option2' => REDUX_URL.'assets/img/layout/sub-footer/option02.png',
					'option3' => REDUX_URL.'assets/img/layout/sub-footer/option03.png',
					'option4' => REDUX_URL.'assets/img/layout/sub-footer/option04.png',
					'option5' => REDUX_URL.'assets/img/layout/sub-footer/option05.png',
					'option6' => REDUX_URL.'assets/img/layout/sub-footer/option06.png',
					'option7' => REDUX_URL.'assets/img/layout/sub-footer/option07.png',
					'option8' => REDUX_URL.'assets/img/layout/sub-footer/option08.png',
					),
				),
			...
			array(
				...
				'subtitle' => __('Switch on to enable button to hide post-footer widgets.', 'redux-framework'),
	...
	-----------------------------------------------------------------------------------*/					
		...
		'fields' => array(
			...
			array(
				...
				'type'=>'info',
				'style'=>'help',
				'desc' => __( '<span class="redux-title">Social Media Content</span>', 'redux-framework')
				),			
				
			array(
				'title' => __('Display Message', 'redux-framework'), 
				'subtitle' => __('Add a message here. E.g. &#34;Follow Us&#34;.<br />(Only shown in header)', 'redux-framework'),
			...
			array(
				...
				'subtitle' => __('Enable link to Pinterest profile.', 'redux-framework'),
			...
			array(
				...
				'type' => 'text',
				'validate' => 'url',
				'fold' => array('thinkup_header_pinterestswitch'=>1),
				),				
	...
	-----------------------------------------------------------------------------------*/					
		...
		'fields' => array(
			...
			array(
				...
				'subtitle' => __('Choose which links to show on the post hover.', 'redux-framework'),
			...
			array(
				...
				'subtitle' => __('Check to enable social media sharing.', 'redux-framework'),
			...
			array(
				...
				'subtitle' => __('Specify a message to encourage sharing.<br />Leave blank to display the default message.', 'redux-framework'),
				'id'=>'thinkup_post_sharemessage',
				'type' => 'text',
				'validate' => 'html', //see http://codex.wordpress.org/Function_Reference/wp_kses_post
				'fold' => array('thinkup_post_share'=>1),
				),
	...
	-----------------------------------------------------------------------------------*/	
		...
		'fields' => array(
			...
			array(
				...
				'type'=>'promotion',
				'image' => get_template_directory_uri()  . '/admin/main/assets/img/promotion/1_trusted_team.png',
				'feat' => '//www.thinkupthemes.com/themes/renden/',
				),
