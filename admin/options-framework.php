...
function optionsframework_load_scripts( $hook ) {
	...
	// Enqueue custom option panel JS
	wp_enqueue_script( 'jquery-ui', OPTIONS_FRAMEWORK_DIRECTORY . 'js/jquery-ui.js' );
	
	// Enqueue custom option panel JS
	wp_enqueue_script( 'switchButton', OPTIONS_FRAMEWORK_DIRECTORY . 'js/jquery.switchButton.js' );
...
function optionsframework_page() {
	settings_errors(); ?>
    <?php $themename = wp_get_theme(); if ( $themename->name == 'Apprise' ) : ?>
	<?php $theme_version = $themename->get('Version'); ?>
    <?php endif; ?>

	<div id="optionsframework-wrap" class="wrap">
    <?php screen_icon( 'themes' ); ?>
    <h2><?php echo $themename ?> ( v.<?php echo $theme_version ?> ) Theme Options</h2>
