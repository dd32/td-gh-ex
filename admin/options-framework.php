...
function optionsframework_setdefaults() {
	...
	$values = antmagazine_get_default_values();
...
function optionsframework_load_scripts() {
	...
	add_action('admin_head', 'antmagazine_admin_head');
...
function antmagazine_admin_head() {
...
function optionsframework_page() {
    ...
    <div id="optionsframework" class="postbox">
        ...
        <div id="optionsframework-submit">
            ...
            <input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( 'Restore Defaults' ); ?>" onclick="return confirm( '<?php print esc_js( __( 'Click OK to reset. Any theme settings will be lost!' , 'antmagazine' ) ); ?>' );" />
            <div class="clear"></div>
		</div>
	</form>
</div> <!-- / #container -->
...
function optionsframework_validate( $input ) {
	...
	if ( isset( $_POST['reset'] ) ) {
		...
		return antmagazine_get_default_values();
	}
	...
	if ( isset( $_POST['update'] ) ) {
		...
		foreach ( $options as $option ) {
			...
			if ( has_filter( 'antmagazine_sanitize_' . $option['type'] ) ) {
				$clean[$id] = apply_filters( 'antmagazine_sanitize_' . $option['type'], $input[$id], $option );
			}
		}
...
function antmagazine_get_default_values() {
	$output = array();
	...
	foreach ( (array) $config as $option ) {
		...
		if ( has_filter( 'antmagazine_sanitize_' . $option['type'] ) ) {
			$output[$option['id']] = apply_filters( 'antmagazine_sanitize_' . $option['type'], $option['std'], $option );
		}
	}
	return $output;
}
...
function optionsframework_adminbar() {
	...
	$wp_admin_bar->add_menu( array(
		'parent' => 'appearance',
		'id' => 'antmagazine_theme_options',
		'title' => __( 'Theme Options' , 'antmagazine' ),
		'href' => admin_url( 'themes.php?page=options-framework' )
  ));
}

if ( ! function_exists( 'antmagazine_get_option' ) ) {
	...
	function antmagazine_get_option( $name, $default = false ) {
