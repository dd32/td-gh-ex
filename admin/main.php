...
<div id="admin_links"> 
	<a target="_blank" href="http://www.cryoutcreations.eu/mantra">Mantra Home Page</a> 
...
function startfarb(a,b) {
	...
	jQuery(a).click(function() {
			if(jQuery(b).css('display') == 'none')	jQuery(b).css('display','inline-block').hide().show(300);
		});
