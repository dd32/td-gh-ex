...
function weaverx_install_tgm_plugins() {
	$plugins = array(
		...
		array(
			'name'     => __('WP Retina 2x (recommended only if you use HD images)', 'weaver-xtreme' /*adm*/), // The plugin name
...
<p><em><strong>WP Edit</strong></em> provides enhanced page and post editing, including Manual Excerpts. It is not essential.</p>
<p><em><strong>WP Retina 2x</strong></em> provides automatic support for high and standard resolution images in the
Media Library. You need this only if you use high resolution (Retina) images.</p>', 'weaver-xtreme' /*adm*/),
