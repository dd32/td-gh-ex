	...
	<div class="row">
     <div class="col-md-12">
		<div class="main-heading">
		   ...
		   <h2 class="wow fadeInLeft animated" data-wow-delay=".5s" style="visibility: visible; -webkit-animation-delay: .5s;"><?php if($home_service_setting['service_title_one'] !='') { echo $home_service_setting['service_title_one']; } ?>&nbsp;<span><?php if($home_service_setting['service_title_two'] !='') { echo $home_service_setting['service_title_two']; } ?></span> </h2>
		   <p class="wow fadeInRight animated" data-wow-delay=".8s" style="visibility: visible; -webkit-animation-delay: .8s;"><?php if($home_service_setting['service_description'] !='') { echo $home_service_setting['service_description']; } ?></p>
		</div>
      </div>	
    </div>
	
	<div class="row">
		<div class="col-md-4 services wow bounceIn animated" data-wow-delay=".5s" style="visibility: visible; -webkit-animation-delay: .5s;">
