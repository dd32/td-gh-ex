...
if ($postimageurl) {
?><a href="<?php the_permalink() ?>" rel="bookmark" title="<?php the_title(); ?>"><img src="<?php bloginfo('wpurl'); ?>/wp-content/uploads/<?php $values = get_post_custom_values("feature-image"); echo $values[0]; ?>" class="foot-latest" alt="Image" /></a> 
<?php } else { ?>
