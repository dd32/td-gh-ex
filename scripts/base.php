...
array( "name" => "Visited:", "id" => $shortname."_a_link_decoration_visited", "type" => "select", "std" => "none", "options" => array( "none", "underline", "overline", "line-through", "blink"), ),
 ...
 array( "name" => "Link Font Style", "type" => "right-half"), array( "name" => "Normal:", "id" => $shortname."_a_link_style", "type" => "select", "std" => "italic", "options" => array( "italic", "normal", "oblique"), ), array( "name" => "Visited:", "id" => $shortname."_a_link_style_visited", "type" => "select", "std" => "italic", "options" => array( "italic", "normal", "oblique"), ), array( "name" => "Hover:", "id" => $shortname."_a_link_style_hover", "type" => "select", "std" => "italic", "options" => array( "italic", "normal", "oblique"), ), array( "type" => "box-close"),
