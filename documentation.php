...
<?php _e('A lot of time and careful testing were put into this theme to make it work for <b>you</b> :).', 'aaron'); ?><br/>
<?php _e('If you like the theme, please ', 'aaron'); ?><a href="https://wordpress.org/support/view/theme-reviews/aaron"><?php _e('review it on WordPress.org', 'aaron'); ?></a><br/><br/>
...
<?php _e('Your feedback is essential for the future developement of the theme.', 'aaron'); ?>
	...
	<div class="doc-box" id="aaron-menus">
		...
		This menu will collapse on smaller screens, and can then be opened and closed by a menu button. It can also be closed with the Esc key.','aaron' ); ?><br/><br/>
