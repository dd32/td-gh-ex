...
function aaron_docs() {
	...
	<div class="doc-box" id="aaron-menus">
		...
		<?php
		esc_html_e(
			'dribbble, facebook, flickr, foursquare, github, google plus, instagram, jsfiddle, linkedin, pinterest, reddit, soundcloud, stackoverflow,
			tumblr, twitter, vimeo, vine, yelp, youtube, wordpress, paypal, lastfm, behance, deviantart, spotify, skype, slack, amazon, steam, xing, medium, qq, codepen.',
			'aaron'
		);
		?>
		</i>
	...
	<div class="doc-box" id="aaron-front">
		...
		<?php esc_html_e( 'The Call to Action is a great way to get your visitors attention. In the customizer you can:', 'aaron' ); ?>
			...
			alt="<?php esc_attr_e( 'An image describing how to set a static front page.', 'aaron' ); ?>">
			<br>
	...
	<div class="doc-box" id="aaron-plugins">
		...
		<ul>
			...
			alt="<?php esc_attr_e( 'An image describing three featured posts on the front page, two with featured images and one that only displays the post title.', 'aaron' ); ?>">
						<br>
					</li>
