		...
		<div class="right-column">
			<form method="get" action="<?php echo esc_url( $siteorigin_premium_info['buy_url'] ) ?>" id="purchase-form" target="_blank">
				...
				<div class="options hide-if-no-js">
					...
					<label><input type="radio" name="variable_pricing_option" value="custom" class="custom-price" > <strong><?php _e('Custom', 'vantage') ?></strong> <input type="number" name="variable_pricing_custom" value="15" placeholder="$3+" min="3"> </label>
				</div>
