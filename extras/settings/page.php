<div class="wrap">
	...
	<h2 id="theme-settings-title">
		...
		<?php printf(__( '%s Theme Settings', 'puro' ), $theme->get('Name')) ?>
	</h2>
	...
	<script id="settings-preview-modal-template" type="text/template">
		...
		<div id="siteorigin-settings-preview-toolbar">
			<h3><?php printf(__( '%s Theme Settings Preview', 'puro' ), $theme->get('Name')) ?></h3>
			...
			<div id="settings-tour-modal-wrapper">
				...
				<div id="settings-tour-modal">
					...
					<div id="settings-tour-step-content">
						...
						<div class="right-column">
							...
							<div class="settings-form-buttons">
								...
								<input type="button" class="button-secondary siteorigin-settings-preview" value="<?php esc_attr_e('Preview', 'puro') ?>" />
								<div class="tour-next button-secondary">
									<span data-text-continue="<?php echo esc_attr('Continue', 'puro') ?>" data-text-done="<?php echo esc_attr('Done', 'puro') ?>"><?php _e('Continue', 'puro') ?></span>
					...
					<div id="settings-tour-toolbar">
						...
						<input type="button" class="button-primary siteorigin-settings-save" value="<?php esc_attr_e('Save Settings', 'puro') ?>" />
						<input type="button" class="button-secondary siteorigin-settings-close" value="<?php esc_attr_e('Close', 'puro') ?>" />
					</div>
