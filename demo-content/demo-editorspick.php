<div class="content-wrapper">
    <h1 class="sidebar-title"><span><?php _e( 'Editor Pick\'s', 'accesspress-mag' ); ?></span></h1>
        <div class="sidebar-posts-wrapper">            
            <div class="single_post clearfix first-post non-zoomin">
                    ...
                    <div class="post-content"><p><?php _e( 'Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec', 'accesspress-mag' ); ?></p></div>            
            </div>
