...
<?php
echo '<p>' . get_post_meta(get_post_thumbnail_id(), 'appeal_photographer_url', true);
echo '</p><p>' . get_post_meta($post->ID, 'appeal_photographer_url', true);
echo '</p><p>' . get_post_meta( $post->ID, 'appeal_photographer_name', true ) . '</p>';
?>
            </div>
                <div class="entry-attachment">
                    ...
                    <p class="attachment">
                       ...
                       title="<?php the_title(); ?>"
                       rel="attachment"><img src="<?php echo $att_image[0];?>"
