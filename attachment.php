...
<a href="<?php echo esc_url( get_permalink( $post->post_parent ) ); ?>" title="<?php printf( esc_attr__( 'Return to %s', 'bands' ), esc_attr( get_the_title( $post->post_parent ), 1 ) ); ?>" rev="attachment"><?php esc_html_e( 'Return to', 'bands' ); ?> <?php echo get_the_title( $post->post_parent ); ?></a>
