...
<a class="assistive-text" href="#content"
		title="<?php esc_attr_e( 'Skip to content', 'maxflat-core' ); ?>"><?php _e( 'Skip to content', 'maxflat-core' ); ?></a>
	<?php
	//fixed menu option
	$fixed = __MAXFLAT::option( 'maxflat_menu_fixed' );
?>
<div class="maxflat-nav-menu <?php echo $fixed=='1'? ' fixed-menu':'' ?> <?php maxflat_menu_icons_class() ?>">
