...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'conica' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'conica' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'conica' ),
		'cyrillic'     => __( 'Cyrillic', 'conica' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'conica' ),
		'devanagari'   => __( 'Devanagari', 'conica' ),
		'greek'        => __( 'Greek', 'conica' ),
		'greek-ext'    => __( 'Greek Extended', 'conica' ),
		'khmer'        => __( 'Khmer', 'conica' ),
		'latin'        => __( 'Latin', 'conica' ),
		'latin-ext'    => __( 'Latin Extended', 'conica' ),
		'vietnamese'   => __( 'Vietnamese', 'conica' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'conica' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'conica' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'conica' ),
