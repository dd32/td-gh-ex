...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'advocator-lite'  ),
		'cyrillic'     => __( 'Cyrillic', 'advocator-lite'  ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'advocator-lite'  ),
		'devanagari'   => __( 'Devanagari', 'advocator-lite'  ),
		'greek'        => __( 'Greek', 'advocator-lite'  ),
		'greek-ext'    => __( 'Greek Extended', 'advocator-lite'  ),
		'khmer'        => __( 'Khmer', 'advocator-lite'  ),
		'latin'        => __( 'Latin', 'advocator-lite'  ),
		'latin-ext'    => __( 'Latin Extended', 'advocator-lite'  ),
		'vietnamese'   => __( 'Vietnamese', 'advocator-lite'  ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'advocator-lite'  ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'advocator-lite'  ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'advocator-lite'  ),
