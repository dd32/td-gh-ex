...
function customizer_library_avant_options() {
    ...
    $options['avant-noteon-layout'] = array(
        ...
        'section' => $section,
        'type'    => 'note',
        'description' => __( '<b>Premium Extra Features:</b><br />- Add Full Website Loader & design settings<br />- Add your own "Site Built By" backlink in the Footer<br />- Add Title & Tagline with uploaded logo and adjust<br />- Set custom website container width<br />- Set custom Sidebar width<br />- Change Side Social Links design<br />- Change Site Attribution text', 'avant' )
    );
