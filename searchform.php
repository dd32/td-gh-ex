...
<button type="submit"<?php aamla_attr( 'search-submit' ); ?>><?php aamla_icon( array( 'icon' => 'search' ) ); ?><span class="screen-reader-text"><?php echo esc_html_x( 'Search', 'submit button', 'aamla' ); ?></span></button>
</form>
