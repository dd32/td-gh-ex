...
<form role="search" method="get" class="search-form form-inline spacer-top spacer-bottom" action="<?php echo esc_url( home_url('/') ); ?>">
	<div class=" input-group">
		<input type="search" class="search-field form-control input-sm" placeholder="<?php echo esc_attr_x('Search &hellip;', 'placeholder', 'b3'); ?>" value="<?php echo esc_attr( get_search_query() ); ?>" name="s">
