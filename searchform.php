...
<form role="search" method="get" class="search-form" autocomplete="off" action="<?php echo esc_url( home_url( '/' ) ); ?>">
    <label>
	<span class="screen-reader-text"><?php echo _x( 'Search for:', 'label', 'actinia' ); ?></span>
    ...
    <input type="submit" class="search-submit" value=""><span class="screen-reader-text"><?php echo _x( 'Search', 'submit button', 'actinia' ); ?></span>
</form>