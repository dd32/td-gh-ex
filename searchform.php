...
<form role="search" method="get" class="search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	<label>
		...
		<input type="search" class="search-field px-3 py-2" placeholder="<?php echo esc_attr_x( 'Search', 'placeholder','appointment-booking' ); ?>" value="<?php echo get_search_query() ?>" name="s">
	</label>
