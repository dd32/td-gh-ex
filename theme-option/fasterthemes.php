...
function fastertheme_framework_page(){ 
		...
		$topmag_image=get_template_directory_uri().'/theme-option/images/logo.png';
		echo "<h1><img src='".$topmag_image."' height='64px'  /> ". __( 'FasterThemes Options', 'customtheme' ) . "</h1>"; 
		
		echo '<div class="ft-options-saved"><img src="'.get_template_directory_uri().'/theme-option/images/options-saved.png"/></div>';
?>
