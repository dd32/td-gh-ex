      ...
      <form method="post" action="options.php" id="form-option" class="theme_option_ft">
        ...
        <div id="options-group-1" class="group basicsettings">
          ...
          <div id="section-logo" class="section section-upload ">
            ...
            <div class="option">
              <div class="controls">
                <input id="logo" class="upload" type="text" name="faster_theme_options[logo]" value="<?php if(!empty($options['logo'])) { echo $options['logo']; } ?>"placeholder="<?php _e('No file chosen','redpro'); ?>" />
          ...
          <div id="section-logo" class="section section-upload ">
            ...
            <div class="option">
              <div class="controls">
                <input id="logo" class="upload" type="text" name="faster_theme_options[fevicon]" value="<?php if(!empty($options['fevicon'])) { echo $options['fevicon']; } ?>" placeholder="<?php _e('No file chosen','redpro'); ?>" />
                <input id="upload_image_button" class="upload-button button" type="button" value="<?php _e('Upload','redpro'); ?>" />
                <div class="screenshot" id="logo-image">
