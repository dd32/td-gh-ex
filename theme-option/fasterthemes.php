      ...
      <form method="post" action="options.php" id="form-option" class="theme_option_ft">
        ...
        <div id="options-group-1" class="group socialsettings">
          ...
          <div id="section-title" class="section section-textarea">
            <h4 class="heading">Home Title</h4>
            <div class="option">
              <div class="controls">
          ...
          <div id="section-content" class="section section-textarea">
            <h4 class="heading">Home Content</h4>
            <div class="option">
              <div class="controls">
                <textarea id="home-content" class="of-input" name="faster_theme_options[home-content]" size="32"><?php if(!empty($generator_options['home-content'])) { echo $generator_options['home-content']; } ?></textarea>
              </div>
