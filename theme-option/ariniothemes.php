...
function arinio_framework_page(){ 
		...
		echo "<h1>". __( 'Aron Theme Options', 'customtheme' ) . "</h1>"; 
...
<div class="tnotify">
        <h1>Get Aron PRO Theme!  Just $11</h1>
        <p style="font-size:15px; line-height: 20px;">You are using the aron, Free Version of aron Pro Theme. Upgrade to Pro for extra features like Home Page Unlimited Slider, Work Gallery, Team section, Client Section and many more Page Templates, Social Link Section, Life time theme support and much more.</p>
        <a href="http://arinio.com/aron-responsive-multipurpose-wordpress-theme/" target="blank">Upgrade to aron PRO Theme here >></a>
    </div>
 ...
 <h3>Slider Settings</h3>
  ...
  <div id="optionsframework-sidebar">
		<div class="metabox-holder">
	    	<div class="postbox">
	    		<h3><?php esc_attr_e( 'About aron', 'aron' ); ?></h3>
      			<div class="inside"> 
					<div class="option-btn"><a class="btn upgrade" target="_blank" href="<?php echo esc_url( 'http://arinio.com/aron-responsive-multipurpose-wordpress-theme/' ); ?>"><?php esc_attr_e( 'Upgrade to Pro' , 'aron' ); ?></a></div>
                    <div class="option-btn"><a class="btn rate" target="_blank" href="<?php echo esc_url( 'http://arinio.com/' ); ?>"><?php esc_attr_e( 'View More our themes' , 'aron' ); ?></a></div>
					<div class="option-btn"><a class="btn support" target="_blank" href="<?php echo esc_url( 'http://arinio.com/support/' ); ?>"><?php esc_attr_e( 'Free Support' , 'aron' ); ?></a></div>
					<div class="option-btn"><a class="btn doc" target="_blank" href="<?php echo esc_url( 'http://arinio.com/document/' ); ?>"><?php esc_attr_e( 'Documentation' , 'aron' ); ?></a></div>
					<div class="option-btn"><a class="btn demo" target="_blank" href="<?php echo esc_url( 'http://arinio.com/aron-responsive-multipurpose-wordpress-theme/' ); ?>"><?php esc_attr_e( 'View Demo' , 'aron' ); ?></a></div>
...
We are also helping poor community so please help us to help and HAVE A BETTER WORLD. Even 2$ really help :)', 'aron' ); ?></strong>
