	...
	$(document).ready(function() {
		...
		function generator_add_file(event, selector) {
			...
			frame.on( 'select', function() {
				...
				selector.find('.upload-button').unbind().addClass('remove-file').removeClass('upload-button').val(generator_l10n.remove);
		...
		function generator_remove_file(selector) {
			...
			selector.find('.remove-file').unbind().addClass('upload-button').removeClass('remove-file').val(generator_l10n.upload);
