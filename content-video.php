...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>  
	...
	<div class="entry-container post-format">
        ...
        <header class="entry-header">
            ...
            <h2 class="entry-format"><a href="<?php echo esc_url( get_post_format_link( 'video' ) ); ?>" title="<?php esc_attr_e( 'All Video Posts', 'catch-kathmandu' ); ?>"><?php esc_html_e( 'Video', 'catch-kathmandu' ); ?></a></h2>
    	</header><!-- .entry-header -->  
