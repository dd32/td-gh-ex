...
if(!is_active_sidebar('sidebar-woo')) $pagelayout = 'fullcontent';
?>
<div id="pagename" class="d5_woo_page"></div>
<div id="container" class="sinpagepostcon woopagecon box90 <?php echo $pagelayout; ?>">	
	<div id="containerin">
		...
		if ( $pagelayout != 'fullcontent') get_sidebar( 'ecommerce' ); ?>
	</div>
	<?php  ?>
</div>
<?php get_footer();