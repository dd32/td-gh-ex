			...
			<div class="row">
				<div class="col-md-12">
					...
					<?php if (get_post_meta( get_the_ID(), 'banner_description', true )) { ?>
						...
						<?php } else { ?>
						<p><?php _e('Autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et dolore feugait.', 'elegance'); ?></p>
						<?php }  ?>
					</div>
				</div>
			</div>
