(function () {
    ...
    jQuery(function () {
        ...
        var social_icons = '<a href="#" class="button ig-shortcodes-toggle-icon-list ig-shortcodes-toggle-social-list" style="float:left;display:block;">Choose icon</a><div class="social-icon"></div>\
<i class="current-social-icon ja-social-icon-"></i>\
<div class="ig-shortcodes-icon-list-holder" style="display:none;">\
<ul class="ig-shortcodes-icon-list">\
...
<li><a href="#"><i class="ja-social-icon-instagram"></i> <span>ja-social-icon-instagram</span></a></li>\
        ...
        var fa_icons = '<ul class="ig-shortcodes-icon-list">\
...
.ig-shortcodes-form { display: block; overflow: hidden; height: 100%; position: relative; font-family: Arial,Helvetica ; color: #333; font-size: 12px; text-align: left; background: #FFF; }\
.ig-shortcodes-form a { text-decoration: none; }\
.ig-shortcodes-form .ig-shortcodes-form-top { overflow: auto; height: 100%; position: relative; padding: 0 0 0 120px; margin: 0 0 0 0; }\
.ig-shortcodes-form .ig-shortcodes-form-types { position: absolute; top: 0px; left: 0px; width: 120px; min-height: 100%; background: #444; border-right: 1px solid #333; }\
.ig-shortcodes-form .ig-shortcodes-form-types .ig-shortcodes-form-title { display: block; padding: 14px 20px 14px 20px; position: relative; font-size: 12px; line-height: 14px; font-weight:bold; color: #fff; background:#333; border-bottom: 1px solid #333; }\
.ig-shortcodes-form .ig-shortcodes-form-types .ig-shortcodes-form-title img { position: absolute; top: 13px; left: 12px; } \
.ig-shortcodes-form .ig-shortcodes-form-types ul { list-style: none; margin: 0px; padding: 0px; }\
.ig-shortcodes-form .ig-shortcodes-form-types ul li { display: block; border-bottom: 1px solid #333; margin: 0px; }\
.ig-shortcodes-form .ig-shortcodes-form-types ul li.active { width: 121px; font-weight: bold; }\
.ig-shortcodes-form .ig-shortcodes-form-types ul li a { display: block; padding: 14px 20px; font-size: 12px; color: #fff; }\
.ig-shortcodes-form .ig-shortcodes-form-types ul li.active a { background: #FFF; color:#444;}\
.ig-shortcodes-form .ig-shortcodes-form-types ul li a:hover { background: #333; color:#fff;}\
.ig-shortcodes-form .ig-shortcodes-form-tabs { background: #FFF; padding: 20px 20px 70px 20px; overflow: hidden; }\
.ig-shortcodes-form .ig-shortcodes-form-tab { display: none; }\
.ig-shortcodes-form .ig-shortcodes-form-tabs h2 { display: block; padding: 0 10px 10px 10px; line-height: normal; font-size: 18px; margin: 0 0 10px 0; border-bottom: 1px solid #EEE; }\
.ig-shortcodes-form .ig-shortcodes-form-fields { overflow: auto; }\
.ig-shortcodes-form .ig-shortcodes-form-tabs table { width: 100%; border: none; font-size: 12px; text-align: left; }\
.ig-shortcodes-form .ig-shortcodes-form-tabs table th,  .ig-shortcodes-form .ig-shortcodes-form-tabs table td { padding: 14px 10px 14px 0; border-bottom: 1px solid #EEE; vertical-align: top; }\
.ig-shortcodes-form .ig-shortcodes-form-tabs table th { font-weight: normal; text-align: left; width: 120px; }\
.ig-shortcodes-form .ig-shortcodes-form-tabs table th label { padding: 5px 0 0 10px; display: block; }\
.ig-shortcodes-form .ig-shortcodes-form-tabs table td input, .ig-shortcodes-form .ig-shortcodes-form-tabs table td textarea { border: 1px solid #DDD; box-shadow: inset 1px 1px 4px #f9f9f9; padding: 6px 8px; font-family: Helvetica; font-size: 12px; color: #888; width: 80%; }\
.ig-shortcodes-form .ig-shortcodes-form-tabs table td .wp-picker-container input[type="text"] { width: 80px!important; margin: 0 5px 0 0; }\
.ig-shortcodes-form .ig-shortcodes-form-tabs table td .wp-picker-container input.button { width: auto!important; }\
.ig-shortcodes-form .ig-shortcodes-form-tabs table td textarea { height: 100px; }\
.ig-shortcodes-form .ig-shortcodes-form-tabs table td textarea:disabled { background: #EEE; }\
.ig-shortcodes-form .ig-shortcodes-form-tabs table td input:focus, .ig-shortcodes-form .ig-shortcodes-form-tabs table td textarea:focus { color: #333; border-color: #BBB; background: #FFF; outline: none; }\
.ig-shortcodes-form .ig-shortcodes-form-tabs table td span.tip { display: block; padding: 5px 0; color: #999; }\
.ig-shortcodes-form .ig-shortcodes-submit { clear: both; height: 50px; position: absolute; bottom: 0px; left: 0px; width: 100%; background: #EEE; border-top: 1px solid #DDD; }\
.ig-shortcodes-form .ig-shortcodes-submit .button-primary { position: absolute; right: 20px; top: 15px; }\
.ig-shortcodes-form .current-icon, .ig-shortcodes-form .current-social-icon { margin: 0 0 0 10px; font-size: 14px; width: 24px; text-align:center; height: 24px; line-height: 24px; }\
.ig-shortcodes-toggle-social-list { margin: 0 0 20px 0; }\
.ig-shortcodes-form .social-icon, .ig-shortcodes-form .current-social-icon { margin: 0 0 0 10px; display: block; float: left; }\
.ig-shortcodes-form .current-social-icon { display: none; }\
.ig-shortcodes-form .social-icon img { width: 21px; height: 21px; margin: 1px 0 0 0; }\
.ig-shortcodes-form .ig-shortcodes-social-link-field { float: left; width: 220px!important; margin: 0 0 0 10px; }\
.ig-shortcodes-form .ig-shortcodes-icon-list-holder { clear: both; overflow: hidden; }\
.ig-shortcodes-form .ig-shortcodes-icon-list { padding: 10px 0 0 0; display: block; list-style: none; margin: 0px; }\
.ig-shortcodes-form .ig-shortcodes-icon-list li { display: block; float: left; width: 40px; height: 40px; margin: 0 10px 10px 0; }\
.ig-shortcodes-form .ig-shortcodes-icon-list li a { display: block; float: left; width: 40px; height: 40px; text-align: center; line-height: 40px; background: #f9f9f9; border: 1px solid #EEE; }\
.ig-shortcodes-form .ig-shortcodes-icon-list li a:hover { border: 1px solid #CCC; box-shadow: 1px 1px 2px #EEE; }\
.ig-shortcodes-form .ig-shortcodes-icon-list li a i { font-size: 14px; }\
.ig-shortcodes-form .ig-shortcodes-icon-list li a img { width: 20px; height: 20px; margin-top: 10px; }\
.ig-shortcodes-form .ig-shortcodes-icon-list li a span { display: none; }\
.ig-shortcodes-form .column-structures { display: block; padding: 0 0 0 10px; }\
.ig-shortcodes-form .column-structures a { display: block; width: 100px; height: 40px; float: left; margin: 0 10px 20px 0; }\
.ig-shortcodes-form .column-structures a span { float:left; position: relative; display: block; height: 40px; overflow: hidden; }\
.ig-shortcodes-form .column-structures a i { background: #EEE; position: absolute; left: -2px; top: 0px; display: block; height: 40px; line-height: 40px; font-size: 14px; text-align: center; width: 100%; }\
.ig-shortcodes-form .column-structures a:hover i, .ig-shortcodes-form .column-structures a.active i { background: #999; color: #FFF; }\
.ig-shortcodes-form .column-structures label { margin: 0 0 14px 0; display: block; font-size: 14px; }\
.ig-shortcodes-form .clearfix { clear: both; }\
#ig-shortcodes-form-tab_tabs td label,\
#ig-shortcodes-form-tab_accordion td label { display: block; padding: 5px 0 10px 0; color: #999; }\
#ig-shortcodes-form-tab_tabs input,\
#ig-shortcodes-form-tab_accordion input,\
#ig-shortcodes-form-tab_accordion .ig-shortcodes-toggle-icon-list { margin: 0 0 10px 0; }\
</style>\
		<div id="ig-shortcodes-form"><div class="ig-shortcodes-form">\
		<div class="ig-shortcodes-form-top">\
		<div class="ig-shortcodes-form-types">\
			<span class="ig-shortcodes-form-title">SHORTCODES</span>\
			<ul>\
				<li class="ig-shortcodes-form-type-button active" type="button"><a href="#">Buttons</a></li>\
				<li class="ig-shortcodes-form-type-social" type="social"><a href="#">Social</a></li>\
				<li class="ig-shortcodes-form-type-columns" type="columns"><a href="#">Columns</a></li>\
				<li class="ig-shortcodes-form-type-toggle" type="toggle"><a href="#">Toggles</a></li>\
				<li class="ig-shortcodes-form-type-accordion" type="accordion"><a href="#">Accordion</a></li>\
				<li class="ig-shortcodes-form-type-tabs" type="tabs"><a href="#">Tabs</a></li>\
				<li class="ig-shortcodes-form-type-alertbox" type="alertbox"><a href="#">Alert Boxes</a></li>\
				<li class="ig-shortcodes-form-type-pullleft" type="pullleft"><a href="#">Quote Left</a></li>\
				<li class="ig-shortcodes-form-type-pullright" type="pullright"><a href="#">Quote Right</a></li>\
				<li class="ig-shortcodes-form-type-features" type="features"><a href="#">Box features</a></li>\
				<li class="ig-shortcodes-form-type-list" type="list"><a href="#">List</a></li>\
			</ul>\
		</div><!-- end types -->\
		<div class="ig-shortcodes-form-tabs">\
<!-- BUTTON -->\
			<div class="ig-shortcodes-form-tab" id="ig-shortcodes-form-tab_button" style="display:block">\
				<h2>Add a button</h2>\
				<div class="ig-shortcodes-form-fields">\
				<table cellpadding="0" cellspacing="0">\
					<tr>\
						<th><label>Link (Include http://)</label></th>\
						<td><input type="text" value="" fieldname="url" /></td>\
					</tr>\
					<tr>\
						<th><label>Icon (optional)</label></th>\
						<td>\
<a href="#" class="button ig-shortcodes-toggle-icon-list">Choose an icon</a>\
<i class="current-icon fa-icon-"></i>\
<div class="ig-shortcodes-icon-list-holder" style="display:none">\
<p style="margin-bottom:0px">' + fa_icons + '</div>\
					...
					<tr>\
						...
						<td>\
							...
							<input type="text" class="ig-shortcodes-button_colour_custom" fieldname="colour_custom" value="" />\
						</td>\
					</tr>\
					<tr>\
					...
					<tr>\
						...
						<td>\
							<select fieldname="edge">\
								<option value="straight">Squared</option>\
...
<!-- SOCIAL ICONS -->\
			<div class="ig-shortcodes-form-tab" id="ig-shortcodes-form-tab_social">\
				...
				<table cellpadding="0" cellspacing="0">\
					<tr>\
						...
						<td>' + social_icons + '\
							...
							<input type="text" value="" class="ig-shortcodes-social-link-field" fieldname="link" />\
						</td>\
					</tr>\
					<tr>\
...
<!-- COLUMNS -->\
			<div class="ig-shortcodes-form-tab" id="ig-shortcodes-form-tab_columns">\
				<h2>Add columns</h2>\
				<div class="ig-shortcodes-form-fields">\
				<table cellpadding="0" cellspacing="0">\
					<tr>\
...
<!-- TOGGLE -->\
			<div class="ig-shortcodes-form-tab" id="ig-shortcodes-form-tab_toggle">\
				<h2>Add toggles</h2>\
				<div class="ig-shortcodes-form-fields">\
				<table cellpadding="0" cellspacing="0">\
					<tr>\
...
<!-- ACCORDION -->\
			<div class="ig-shortcodes-form-tab" id="ig-shortcodes-form-tab_accordion">\
...
<!-- TABS -->\
			<div class="ig-shortcodes-form-tab" id="ig-shortcodes-form-tab_tabs">\
				<h2>Add tabs</h2>\
				<div class="ig-shortcodes-form-fields">\
				<table cellpadding="0" cellspacing="0">\
					<tr>\
...
<!-- ALERTBOX -->\
			<div class="ig-shortcodes-form-tab" id="ig-shortcodes-form-tab_alertbox">\
...
<!-- PULL QUOTE LEFT -->\
			<div class="ig-shortcodes-form-tab" id="ig-shortcodes-form-tab_pullleft">\
...
<!-- PULL QUOTE RIGHT -->\
			<div class="ig-shortcodes-form-tab" id="ig-shortcodes-form-tab_pullright">\
...
<!-- BOXFEATURES -->\
			<div class="ig-shortcodes-form-tab" id="ig-shortcodes-form-tab_features">\
				<h2>Box Features</h2>\
				<div class="ig-shortcodes-form-fields">\
				<table cellpadding="0" cellspacing="0">\
					<tr>\
		...
		<!-- LIST -->\
			<div class="ig-shortcodes-form-tab" id="ig-shortcodes-form-tab_list">\
				<h2>Add List</h2>\
				<div class="ig-shortcodes-form-fields">\
				<table cellpadding="0" cellspacing="0">\
				<th><label>Icon</label></th>\
					...
					<tr>\
						...
						<th><label>List</br>(Insert * before each new line)</label></th>\
						<td><textarea fieldname="text"></textarea></td>\
					</tr>\
				</table>\
				</div>\
		...
		<div class="ig-shortcodes-submit">\
			<input style="display:none" id="ig-shortcodes-form-type" value="button" />\
			<textarea style="display:none" id="ig-shortcodes-form-code-to-add"></textarea>\
			<input type="button" id="ig_shortcodes-submit" class="button-primary" value="Insert Shortcode" name="submit" />\
		</div>\
	</div></div>');
