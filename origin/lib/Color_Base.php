...
class Origin_Color_Base {
	 ...
	 * @return array An XYZ color array
	 */ 
	 ...
	 * @return array An HSV color array
	 */
	...
	/**
	 * Converts a LAB color into XYZ
	 * @param array $lab An LAB color array.
	 * @return array An XYZ color array.
	 */
	 ...
	 * @param array $xyz An XYZ color array
	 * @return array An LAB color array
	 */
	...
	/**
	 * Convert an LAB color to an RGB color
	 * @param $lab An LAB color array.
	 * @return array An RGB color array.
	 */
	 ...
	 * @param array $lab A LAB color array. 
	 * @return array An HSV color array.
	 */
	...
	/**
	 * Converts a floating point number into a grayscale HEX color.
	 * @static
	 * @param $float
	 * @return string
	 */
