...
// Homepage Layout   sortable 
  ...
  cts_add_field( array(
		  ...
		  'section'		 => 'homepage_layout',
		  'default'		 => '<a class="install-now button-primary button" href="' . esc_url( 'https://www.coothemes.com/beat-food-free/' ) . '" aria-label="Best Food PRO" data-name="Best Food PRO">' . __( 'Discover Best Food PRO', 'best-food' ) . '</a>',
		  'priority'		 => 10,
	  ) ); 
  }
