...
if ( ! class_exists( 'Coothemes_About_Page' ) ) {
	...
	class Coothemes_About_Page {
		...
		public function style_and_scripts( $hook_suffix ) {
			...
			wp_enqueue_style( 'ct-about-page-css', get_stylesheet_directory_uri() . '/custom/ct-about-page/css/ct_about_page_css.css', array(), THETA_VERSION );

			if ( 'appearance_page_' . $this->theme_slug . '-welcome' == $hook_suffix ) {

				wp_enqueue_script( 'ct-about-page-js', get_stylesheet_directory_uri() . '/custom/ct-about-page/js/ct_about_page_scripts.js', array( 'jquery' ), THETA_VERSION );
				...
				wp_localize_script(
					'ct-about-page-js', 'ctAboutPageObject', array(
						...
						'activating_string'   => esc_html__( 'Activating', 'best-restaurant' ),
					)
				);
