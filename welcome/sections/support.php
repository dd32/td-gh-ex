...
<div class="support-process">
	<h3><?php echo esc_html__('Create Support Tickets', 'accesspress-lite'); ?></h3>
	<p><?php echo esc_html__('Still having problem after reading all the documentation? No Problem!! Please create a support ticket. Our dedicated support team will help you to solve your problem', 'accesspress-lite'); ?></p>
	<a class="button" target="_blank" href="http://accesspressthemes.com/support/"><?php echo esc_html__('Create Support Tickets', 'accesspress-lite'); ?></a>
</div>