...
<div id="accessform">
	<form action="javascript:function(){return false;}">
		<div id="basic_accessibility_widget_options">
			...
			<input name="background-colour" type='text' id="basic_accessibility_background-color" maxlength="10" title="<?PHP echo esc_html(__("Background colour", "antonine")); ?>" />
			<input type='hidden' name="basic_accessibility_background-color_default" id="basic_accessibility_background-color_default" value="<?PHP echo esc_html(get_theme_mod('site_allsite_background_colour')); ?>" />
			<button id="basic_accessibility_widget_restore_background"><?PHP echo __("Restore", "antonine"); ?></button>
			<label for="basic_accessibility_color">
				<?PHP echo __("Text Colour", "antonine"); ?>
			</label>
			<input name="text-colour" type='text' title="<?PHP echo esc_html(__("Text colour", "antonine")); ?>" id="basic_accessibility_color" maxlength="10" />
			<input type='hidden' name="basic_accessibility_color_default" id="basic_accessibility_color_default" value="<?PHP echo esc_html(get_theme_mod('site_alltext_colour')); ?>" />
			...
			<button id="basic_accessibility_widget_font-size_restore"><?PHP echo __("Restore", "antonine"); ?></button>
