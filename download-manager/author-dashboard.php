...
<div class="row">
    ...
    <div id="tabs" style="margin: 0;">
        ...
        <a class="adp-item <?php if ($task == 'edit-profile') { ?>active<?php } ?>" href="<?php echo sprintf("$menu_url", "edit-profile"); ?>"><i class="fa fa-user-edit mr-3"></i><?php _e( "Edit Profile" , "download-manager" ); ?></a>

        <a class="adp-item <?php if ($task == 'settings') { ?>active<?php } ?>" href="<?php echo sprintf("$menu_url", "settings"); ?>"><i class="fa fa-tools mr-3"></i><?php _e( "Settings" , "download-manager" ); ?></a>
