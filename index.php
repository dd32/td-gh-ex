...
?>
   ...
   <section class="home-section page-section">
   	<div class="col-md-12 page-title">
        <h2><?php
        if(!empty($medium_options['blog-title']))
                echo esc_attr($medium_options['blog-title']);
        else
            _e ('Blog','medium');
       ?>
        </h2>
   	...
   	<div class="container blog-container">	
		...
		if( have_posts() ) : while (have_posts()) : the_post(); 
			if($medium_i == 1 || $medium_i == 4){
				$medium_class = 'col-md-7 col-sm-7';
                    ...
                    <div class="blog-left">
                    	<?php                        
                            if(!empty($medium_featured_image[0])) {
                                echo '<a href="'.esc_url(get_permalink()).'"><img src="'.$medium_featured_image[0].'" class="img-responsive" alt="'.esc_attr(get_the_title()).'" /></a>';
				}
                        ?>
