...
<main role="main" id="maincontent" class="our-services">
  <div class="innerlightbox">
	  <div class="container">
      <?php
      $advance_business_left_right = get_theme_mod( 'advance_business_layout_options','Right Sidebar');
      if($advance_business_left_right == 'Left Sidebar'){ ?>
        <div class="row">
          ...
          <div id="post-<?php the_ID(); ?>" <?php post_class('col-lg-8 col-md-8'); ?>>
            ...
            ?>
            <?php if( get_theme_mod( 'advance_business_blog_post_pagination',true) != '') { ?>
