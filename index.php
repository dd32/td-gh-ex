...
?>
<?php get_header(); ?>
    <div class="<?php echo get_theme_mod('barista_blog_layout_settings', 'default'); ?>">
        ...
        <?php if ('sidebar-left' == get_theme_mod('barista_blog_layout_settings')) { ?>
            <?php get_sidebar(); ?>
        <?php } ?>
        <?php if ('sidebar-right' == get_theme_mod('barista_blog_layout_settings')) { ?>
            <?php get_sidebar(); ?>
        <?php } ?>
    </div>
<?php get_footer(); ?>