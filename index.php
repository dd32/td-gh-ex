        ...
        <?php if (have_posts()) : ?>
            ...
            <?php if (is_home() && is_front_page()) { ?>
                <header class="page-header">
                    <?php echo sprintf(esc_html__('%1$s Latest Posts %2$s', 'ace-corporate'), '<h1 class="page-title">', '</h1>'); ?>
                </header>
            <?php } ?>
            <!-- .page-header -->
                ...
                <div class="nav-links clearfix">
                    ...
                    <?php else : ?>
                        <div class="nav-next disabled">
                            <a href="#"> <i
                                        class="fa fa-long-arrow-right post-arrow"></i><?php esc_html_e('No Newer post', 'ace-corporate'); ?>
                            </a></div>
                    <?php endif; ?>
                </div><!-- .nav-links -->
            </nav><!-- .navigation -->
