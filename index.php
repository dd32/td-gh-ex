...
<small>&#8838; <?php the_time('F jS') ?> by <?php the_author_posts_link('namefl'); ?> | <?php edit_post_link('Edit','','<strong>|</strong>'); ?>  &#732; <?php comments_popup_link('No Comments &#187;', '1 Comment &#187;', '% Comments &#187;'); ?></small>
