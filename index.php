...
<li id="post-<?php the_ID(); ?>" <?php post_class('content'); ?>>
    ...
    <span class="tag"><?php wp_link_pages(); ?></br><?php if (is_single()) : ?>This entry was posted in <?php the_category(', '); the_tags(' and tagged ', ', ', ''); endif;?> <?php if (get_theme_mod('author_setting') != 'off') : ?>by <?php the_author_posts_link(); endif; ?><?php if ( ( get_theme_mod('comments_setting') != 'none' ) &&  ( get_theme_mod('comments_setting') != 'pages' ) ) : ?> <?php if ((get_theme_mod('commentsclosed_setting') != 'off') && !is_page()) : echo 'with ';  comments_popup_link( 'no comments yet', '1 comment', '% comments', 'comments-link', 'comments disabled'); elseif ((get_theme_mod('commentsclosed_setting') != 'off') && is_page()) : comments_popup_link( 'with no comments yet', 'with 1 comment', 'with % comments', 'comments-link', ''); else : endif; endif; ?></span>
</li>
