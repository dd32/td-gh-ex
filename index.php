...
<h3 class="arc-src"><span><?php esc_html_e('Apologies, but the page you requested could not be found. Perhaps searching will help', 'd5-design'); ?></span></h3>		<?php get_search_form(); ?><br />
		<p><a href="<?php echo esc_url(home_url()); ?>" title="Browse the Home Page">&laquo; <?php esc_html_e('You can also Visit the Following. These are the Featured Contents', 'd5-design'); ?></a></p><br />
