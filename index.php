...
<div class="container">	
	<div class="row qua_blog_wrapper">		
		...
		<?php 	while(have_posts()):the_post();
				...
				<div class="qua_post_date"><span class="date"><?php echo get_the_date('j'); ?></span><h6><?php echo the_time('M'); ?></h6>
				</div>
				<div class="qua_post_title_wrapper">
						...
						<i class="fa fa-group"></i><a href="<?php the_permalink(); ?>"><?php the_category(' '); ?></a>
						</div>
						<?php } ?>
						</div>
				</div>
