...
function moesia_custom_styles($custom) {
    ...
    if ( isset($latest_news_bg) && ( $latest_news_bg != '#fff' ) ) {
        $custom .= ".latest_news-area { background-color: {$latest_news_bg} !important; }"."\n";
    }
    if ( isset($latest_news_title) && ( $latest_news_title != '#444' ) ) {
        $custom .= ".latest_news-area .widget-title { color: {$latest_news_title}; }"."\n";
    }
    if ( isset($latest_news_title_dec) && ( $latest_news_title_dec != '#ff6b53' ) ) {
        $custom .= ".latest_news-area .widget-title:after { border-color: {$latest_news_title_dec}; }"."\n";
    }
