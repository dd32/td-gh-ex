...
*/
$frfboxfstk = esc_html(associationx_get_option('frfboxfstk', ''));
$fboxnum = 4;
if( !$frfboxfstk ) return;
?>
<div class="box90">	
    <?php 
    ...
    <div class="featured-boxs stkfeatured">
    	<?php $counter = 0; if (have_posts()) : global $associationx_ExLength; $associationx_ExLength = 30; while ( $associationx_fpbp_query->have_posts() ) : $counter++; if ( $counter > $fboxnum ): break; endif; $associationx_fpbp_query->the_post(); ?>
