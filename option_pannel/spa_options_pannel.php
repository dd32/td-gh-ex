...
<div id="wpbody">
    ...
    <!-- header div is start -->
        ...
        <div id="company-logo" style="float:right;margin-top:2px; font-size:18px;color:#000000;text-shadow:#fff 0px 1px 0, #000 0 -1px 0;"><center><strong>SpaSalon Lite By</strong></center>&nbsp;<a href="http://www.webriti.com/" target="_blank"><img src="<?php echo get_template_directory_uri('template_directory').'/option_pannel/images/png.png' ?> " /></a>
        </div>
...
<div id="myModal" class="modal hide" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="background:transparent;border:0px;">
      ...
      <div id="title"><h2 style="background:#6BB3D1;margin-top:0%;padding-bottom:10px;padding-top:10px;color:#FFFFFF">SpaSalon-Pro</h2>
    ...
    <tr>
                    ...
                    <td style="text-align: center;"><p><img src="<?php echo get_template_directory_uri('template_directory').'/option_pannel/images/cross.png' ?> " /></p></td>
                    <td style="text-align: center;"><p><img src="<?php echo get_template_directory_uri('template_directory').'/option_pannel/images/icon_check.png' ?> " /></p></td>
                </tr>
                ...
                <tr>
					...
					<span class="tooltip"><?php  _e('Number of Page Templates which come with the Theme','sis_spa');?></span></span> </p></td>
                ...
                <tr>
					...
					<span class="tooltip"><?php  _e('Showcase the team behind your business with About Us Template.','sis_spa');?></span></span></p></td>
                    <td style="text-align: center;"><p><img src="<?php echo get_template_directory_uri('template_directory').'/option_pannel/images/cross.png' ?> " /></p></td>
                    <td style="text-align: center;"><p><img src="<?php echo get_template_directory_uri('template_directory').'/option_pannel/images/icon_check.png' ?> " /></p></td>
                </tr>
                ...
                <tr>
					...
					<span class="tooltip"><?php  _e('Showcase different services which your business offers.It is available in single column and two column layout','sis_spa');?></span></span> </p></td>
                    <td style="text-align: center;"><p><img src="<?php echo get_template_directory_uri('template_directory').'/option_pannel/images/cross.png' ?> " /></p></td>
                    <td style="text-align: center;"><p><img src="<?php echo get_template_directory_uri('template_directory').'/option_pannel/images/icon_check.png' ?> " /></p></td>
                </tr>
                ...
                <tr>
					...
					<span class="tooltip"><?php  _e('Showcase different products which you offer.','sis_spa');?></span></span></p></td>
                    <td style="text-align: center;"><p><img src="<?php echo get_template_directory_uri('template_directory').'/option_pannel/images/cross.png' ?> " /></p></td>
                    <td style="text-align: center;"><p><img src="<?php echo get_template_directory_uri('template_directory').'/option_pannel/images/icon_check.png' ?> " /></p></td>
                </tr>
                ...
                <tr>
					...
					<span class="tooltip"><?php  _e('Customize the sidebar with the included widgets','sis_spa');?></span></span> </p></td>
                    <td style="text-align: center;"><p><img src="<?php echo get_template_directory_uri('template_directory').'/option_pannel/images/cross.png' ?> " /></p></td>
                    <td style="text-align: center;"><p><img src="<?php echo get_template_directory_uri('template_directory').'/option_pannel/images/icon_check.png' ?> " /></p></td>
                </tr>
					...
					<span class="tooltip"><?php  _e('Get our fast and friendly support.','sis_spa');?></span></span></p></td>
