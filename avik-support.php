...
<div class="avik-tab-support">
	...
	<div id="WELCOME" class="tabcontent">
		...
		<button class="avik-button-admin-support"><a target="_blank" class="avik-button" href="<?php echo esc_url('https://www.denisfranchi.com/avik-pro-10-0-0/' ); ?>"><?php esc_html_e('Pro Version', 'avik'); ?></a></button></p>
			<div class="avik-update"><p><b><?php esc_html_e('Avik Version: 1.3.6','avik');?></b> <button class="avik-button-admin-support"><a target="_blank" class="avik-button" href="<?php echo esc_url( 'https://www.denisfranchi.com/avik-1-2-7/' ); ?>"><?php esc_html_e('Update details', 'avik'); ?></a></button></div></p>
	</div>
	<!-- Guides -->
			...
			<div class="comparison">
				<table>
					...
					<tr class="compare-row">
						...
						<td><span><?php esc_html_e('15','avik');?></span>
						</td>
						<td><span><?php esc_html_e('15','avik');?></span></td>
					</tr>
					<!-- Layou setting -->
					<tr>
						<td></td>
