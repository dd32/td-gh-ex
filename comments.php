...
<p><?php _e("You must be",'quality'); ?> <a href="<?php echo get_option('siteurl'); ?>/wp-login.php?redirect_to=<?php echo urlencode(get_permalink()); ?>"><?php _e("logged in",'quality')?></a> <?php _e("to post a comment",'quality'); ?>
</p>
<?php else : ?>
