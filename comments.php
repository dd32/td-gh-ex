	...
	<section id="respond" class="respond-form">
		...
		<?php
			...
			$comment_form_args = array(
				...
				'logged_in_as'         => '<div class="control-group logged-in-as"><span class="help-block muted smaller-text">' . sprintf( __( 'You logged in as <a href="%1$s">%2$s</a>. <a href="%3$s">Log out</a>', 'activetab' ), admin_url( 'profile.php' ), $user_identity, wp_logout_url( apply_filters( 'the_permalink', get_permalink( $post_id ) ) ) ) . '</span></div>',
