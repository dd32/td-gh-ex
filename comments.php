...
<div id="comments" class="comments-wrapper">
	...
	*/
	$universal_args = array( 
 	        ...
 	        'comment_field' => '<p class="comment-form-comment"><label for="comment" id="comment-label">' . _x( 'Comment', 'noun', 'universal' ) . ' <span class="required">('.__( 'required', 'universal' ).')</span></label><textarea id="comment" name="comment" cols="45" rows="8" aria-required="true" required></textarea></p>', 
			'comment_notes_after' => '',
