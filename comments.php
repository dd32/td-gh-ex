 ...
 * handled by a callback to cell_comment() which is
...
<div id="comments" class="comments-area">
	...
	<h2 class="comments-title">
		...
		<nav id="comment-nav-above" class="navigation comment-navigation comment-navigation-above" role="navigation">
			<h1 class="screen-reader-text"><?php esc_html_e( 'Comment navigation', 'cell' ); ?></h1>
			<div class="nav-links">
				<div class="nav-previous"><?php previous_comments_link( esc_html__( 'Older Comments', 'cell' ) ); ?></div>
				<div class="nav-next"><?php next_comments_link( esc_html__( 'Newer Comments', 'cell' ) ); ?></div>
			</div><!-- .nav-links -->
	...
	<div class="no-comments-wrapper">
		<p class="no-comments"><?php esc_html_e( 'Comments are closed.', 'cell' ); ?></p>
	</div><!-- .comments-area-wrapper -->
	<?php endif; ?>
