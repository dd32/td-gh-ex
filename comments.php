	...
	<?php  
	 $fields=array(
		...
		add_filter('comment_form_default_fields','my_fields');
			...
			<textarea id="comments" rows="5" class="blog-form-control-textarea" name="comment" type="text" placeholder="Message:"></textarea></div>',		
			...
			'title_reply'=> '<div class="comment-title"><h3><i class="fa fa-comment-o"></i>'.__('Leave a Comment', 'wallstreet').'</h3></div>',
			'id_form'=> 'commentform'
			);
