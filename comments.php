...
function lookilite_comment ($comment, $args, $depth) {
...
<?php if ( get_comment_pages_count() > 1 && get_option( 'page_comments' ) ) :  ?>
    ...
    <section class="col-md-12">
        ...
        <div class="wp-pagenavi">
             ...
             <div class="left"><?php previous_comments_link(__('&laquo;','wip')) ?></div>
             <div class="right"><?php next_comments_link(__('&raquo;','wip')) ?></div>
...
<section class="col-md-12">
	...
	<?php comment_form(array('label_submit' =>  __('Leave a reply','wip')) ); ?>
