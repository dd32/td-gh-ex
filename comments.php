 ...
 * handled by a callback to urvr_comment() which is
...
<div id="comments" class="comments-area">
	...
	<?php if ( have_comments() ) : ?>
		...
		<nav id="comment-nav-above" class="comment-navigation" role="navigation">
			<h1 class="screen-reader-text"><?php _e( 'Comment navigation', TEXTDOMAIN ); ?></h1>
		...
		<ol class="comment-list">
			<?php
				 ...
				 * to use urvr_comment() to format the comments.
				 * If you want to override this in a child theme, then you can
				 * define urvr_comment() and that will be used instead.
				 * See urvr_comment() in inc/template-tags.php for more.
				 */
				wp_list_comments( array( 'callback' => 'urvr_comment', 'avatar_size'  => 75, ) );
			?>
		</ol><!-- .comment-list -->
