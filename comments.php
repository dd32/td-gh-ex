...
<?php if ( post_password_required() ) : ?>
    <p class="nopassword"><?php _e( 'This post is password protected. Enter the password to view any comments.', 'attire' ); ?></p>
    </div>
	<?php
	return;
endif;
...
<?php if ( have_comments() ) :
	?>
    <h2><?php echo apply_filters( ATTIRE_THEME_PREFIX . 'discussion_title', __( 'Discussion', 'attire' ) ); ?></h2>
