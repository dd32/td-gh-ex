	...
	$foodrecipes_args = array(
			...
			'fields' => apply_filters( 'comment_form_default_fields', array(
						...
						'email' =>
						  ...
						  'comment_field' => '<p>' .
						  '<textarea id="comment" name="comment" class="form-control-address" placeholder="Comment*" cols="45" rows="8" aria-required="true"></textarea>' .
						  '</p>',						 
    'comment_notes_after' => 'All fields are mandatory.',
				  );
	?>
  <?php comment_form($foodrecipes_args); ?>
</div>
