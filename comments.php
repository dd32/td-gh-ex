...
<?php if ( have_comments() ) : ?>
	...
	<h3 class="comments-title">
		...
		global $post;
		echo '<a href="'.get_post_comments_feed_link( $post->ID ).'" class="rss-feed-link" title="'.esc_attr( __( 'Post comments RSS feed', 'activetab' ) ).'"><i class="fa fa-rss-square"></i></a>';
		?>
	</h3>
...
<?php if ( comments_open() ) : ?>
	...
	<section id="respond" class="respond-form">
		...
		<div id="cancel-comment-reply">
			<p><?php cancel_comment_reply_link( '<span class="btn btn-default btn-small"><i class="fa fa-remove"></i> '.__( 'Cancel reply', 'activetab' ).'</span>' ); ?></p>
		</div>
