...
<?php if ($comments) : ?>
	...
	<?php foreach ($comments as $comment) : ?>
		...
		<li class="clearfix <?php if ($comment->comment_author_email == "author@website.com") echo 'author'; else echo $oddcomment; ?> item" id="comment-<?php comment_ID() ?>">
		  <div class="commentmetadata">
  			<?php echo get_avatar( $comment, 48 ); ?>
			  <strong><?php comment_author_link() ?></strong><br />
			  <small><a href="#comment-<?php comment_ID() ?>" title=""><?php comment_date('d M Y') ?> <?php comment_time() ?></a> <?php edit_comment_link('e','',''); ?></small>				
