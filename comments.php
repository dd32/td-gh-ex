...
<?php if ( have_comments() ) :
	...
	if ( get_comment_pages_count() > 1 && get_option( 'page_comments' ) ) : ?>
        <nav id="comment-nav-above">
            <h1 class="assistive-text"><?php echo __( 'Comment navigation', 'attire' ); ?></h1>
            <div class="nav-previous"><?php previous_comments_link( '&larr;' . __( 'Previous Comments', 'attire' ) ); ?></div>
            <div class="nav-next"><?php next_comments_link( __( 'Next Comments', 'attire' ) . ' &rarr;' ); ?></div>
        </nav>
	<?php endif; ?>
    ...
    <ul class="commentlist">
		 ...
		 */
		wp_list_comments( array( 'callback'    => 'Attire::Comment',
		                         'avatar_size' => 64,
