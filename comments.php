...
<h1 class="assistive-text section-heading"><?php esc_attr_e( 'Comment navigation', 'twentytwelve' ); ?></h1>
...
<p class="nocomments"><?php esc_attr_e( 'Comments are closed.' , 'twentytwelve' ); ?></p>
