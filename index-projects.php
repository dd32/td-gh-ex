...
<div class="services_mid_mn">
  <div class="container">
    <div class="services_top_mn">
      ...
      <h2><?php esc_html($current_options['home_project_heading_one']); ?>
        <?php } ?>
        <?php if($current_options['home_project_heading_two']!='') {?>
        <span> <?php esc_html($current_options['home_project_heading_two']); ?>
        <?php } ?>
        </span>
      </h2>
      <?php if($current_options['project_tagline']!='') {?>
      <p><?php esc_html($current_options['project_tagline']); ?></p>
      <?php }  ?>
    </div>
    <div class="row-fluid">
          ...
          <div class="row-fluid service_section">
            <div class="span3 rec_cols_mn">
              ...
              <h3><a href="<?php echo esc_url($current_options['project_one_url']); ?>">
                ...
                <?php esc_html($current_options['project_title_one']); ?></a>
                <?php } ?>
              </h3>
              <?php if($current_options['project_text_one']!='') {?>
              <p><?php esc_html($current_options['project_text_one']); ?></p>
              <?php } ?>		
            </div>
            <div class="span3 rec_cols_mn">
              ...
              <h3><a href="<?php echo esc_url($current_options['project_two_url']); ?>">
                ...
                <?php esc_html($current_options['project_title_two']); ?></a>
                <?php } ?>
              </h3>
              <?php if($current_options['project_text_two']!='') {?>
              <p><?php esc_html($current_options['project_text_two']); ?></p>
              <?php } ?>		
            </div>
            <div class="span3 rec_cols_mn">
              ...
              <h3><a href="<?php echo esc_url($current_options['project_three_url']); ?>">
                ...
                <?php esc_html($current_options['project_title_three']); ?></a>
                <?php } ?>
              </h3>
              <?php if($current_options['project_text_three']!='') {?>
              <p><?php esc_html($current_options['project_text_three']); ?></p>
              <?php } ?>		
            </div>
            <div class="span3 rec_cols_mn">
              ...
              <h3><a href="<?php echo esc_url($current_options['project_four_url']); ?>">
                ...
                <?php esc_html($current_options['project_title_four']); ?></a>
                <?php } ?>
              </h3>
              <?php if($current_options['project_text_four']!='') {?>
              <p><?php esc_html($current_options['project_text_four']); ?></p>
              <?php } ?>		
            </div>
          </div>
        </div>
