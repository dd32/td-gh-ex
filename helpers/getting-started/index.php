 ...
 */
function bexley_redirect_on_activation() {

    global $pagenow;

    if ( is_admin() && 'themes.php' === $pagenow && isset( $_GET['activated'] ) ) {

        wp_redirect( admin_url( 'themes.php?page=bexley-getting-started' ) );

    }

}

add_action( 'admin_init', 'bexley_redirect_on_activation' );
...
function bexley_load_admin_scripts() {
    ...
    wp_register_style( 'bexley-getting-started', get_stylesheet_directory_uri() . '/helpers/getting-started/getting-started.css', false, '1.0.0' );
    wp_enqueue_style( 'bexley-getting-started' );
