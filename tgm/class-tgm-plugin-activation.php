...
if ( ! class_exists( 'TGM_Plugin_Activation' ) ) {
    ...
    class TGM_Plugin_Activation {
         ...
         * @var string
         */
        protected $menu = 'arise-install-plugins';
         ...
         * does the arise_init action hook, and hooks in the interactions to init.
         *
        ...
        public function init() {
             ...
             */
            if ( true !== apply_filters( 'arise_load', ( is_admin() && ! defined( 'DOING_AJAX' ) ) ) ) {
                return;
            }
        ...
        protected function add_admin_menu( array $args ) {
            if ( has_filter( 'arise_admin_menu_use_add_theme_page' ) ) {
                _deprecated_function( 'The "arise_admin_menu_use_add_theme_page" filter', '2.5.0', esc_html__( 'Set the parent_slug config variable instead.', 'arise' ) );
            }
        ...
        public function maybe_adjust_source_dir( $source, $remote_source, $upgrader ) {
            if ( ! $this->is_arise_page() || ! is_object( $GLOBALS['wp_filesystem'] ) ) {
                return $source;
            }
        ...
        public function sanitize_key( $key ) {
            ...
            */
            return apply_filters( 'arise_sanitize_key', $key, $raw_key );
        }
         ...
         * http://example.com/wp-admin/themes.php?page=arise-install-plugins
         *
         * @since 2.5.0
         *
         ...
         *
         * I.e. depending on the config settings passed something along the lines of:
         * http://example.com/wp-admin/themes.php?page=arise-install-plugins&plugin_status=install
         *
         * @since 2.5.0
         *
         ...
         */
        public function show_arise_version() {
            echo '<p style="float: right; padding: 0em 1.5em 0.5em 0;"><strong><small>',
                esc_html( sprintf( _x( 'TGMPA v%s', '%s = version number', 'arise' ), self::TGMPA_VERSION ) ),
                '</small></strong></p>';
        }
...
if ( ! class_exists( 'TGMPA_List_Table' ) ) {
    ...
    class TGMPA_List_Table extends WP_List_Table {
        ...
        public function __construct() {
            ...
            add_filter( 'arise_table_data_items', array( $this, 'sort_table_items' ) );
        }
        ...
        public function process_bulk_actions() {
            ...
            if ( 'arise-bulk-install' === $this->current_action() || 'arise-bulk-update' === $this->current_action() ) {
                ...
                if ( empty( $_POST['plugin'] ) ) {
                    if ( 'install' === $install_type ) {
                        $message = __( 'No plugins were selected to be installed. No action taken.', 'arise' );
                    } else {
                        $message = __( 'No plugins were selected to be updated. No action taken.', 'arise' );
                    }
                ...
                $plugins_to_install = array_map( array( $this->arise, 'sanitize_key' ), $plugins_to_install );
                ...
                foreach ( $plugins_to_install as $key => $slug ) {
                    ...
                    if ( 'update' === $install_type && ( $this->arise->is_plugin_installed( $slug ) && ( false === $this->arise->does_plugin_have_update( $slug ) || ! $this->arise->can_plugin_update( $slug ) ) ) ) {
                        unset( $plugins_to_install[ $key ] );
                    }
                }
            ...
            if ( 'arise-bulk-activate' === $this->current_action() ) {
                ...
                if ( empty( $_POST['plugin'] ) ) {
                    echo '<div id="message" class="error"><p>', esc_html__( 'No plugins were selected to be activated. No action taken.', 'arise' ), '</p></div>';
                ...
                if ( isset( $_POST['plugin'] ) ) {
                    ...
                    $plugins = array_map( array( $this->arise, 'sanitize_key' ), $plugins );
                }
        ...
        public function prepare_items() {
            ...
            $this->items = apply_filters( 'arise_table_data_items', $this->_gather_plugin_data() );
        }
