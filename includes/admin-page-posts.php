...
if ( ! ( function_exists( 'wvrx_ts_installed' ) ||
		function_exists( 'weaverxplus_plugin_installed' ) && version_compare('0.13',WEAVER_XPLUS_VERSION,'>') ) ) {
...
Weaver X Theme Support</a> free plugin, or the <a href="http://plus.weavertheme.com/" target="_blank" alt="Weaver Xtreme">
