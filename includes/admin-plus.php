...
<em><?php weaverx_site('','http://plus.weavertheme.com/',__('Weaver Xtreme Plus','weaver-xtreme' /*adm*/)); ?>
...
<br />
<span style="margin-left:20px;"></span><?php _e('Visit','weaver-xtreme' /*adm*/); ?> <?php weaverx_site('','http://plus.weavertheme.com/','Weaver Xtreme Plus'); ?><?php _e('Plus.WeaverTheme.com<','weaver-xtreme' /*adm*/); ?>/a>
...
function weaverxplus_intro($title) {
	...
	' <span style="float:right;margin-right:4em;font-size:small;font-style:italic;"><a href="http://plus.weavertheme.com/" target="_blank";>' . __('Get Weaver Xtreme Plus','weaver-xtreme' /*adm*/) . '</a></span></h4>'. "\n";
}
