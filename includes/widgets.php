...
if ( ! function_exists( 'best_business_register_widgets' ) ) :
	 ...
	 * @since 1.0.0
	 */
	function best_business_register_widgets() {

		// Social widget.
		register_widget( 'Best_Business_Social_Widget' );
		...
		// Services widget.
		register_widget( 'Best_Business_Services_Widget' );
	}

endif;

add_action( 'widgets_init', 'best_business_register_widgets' );
...
if ( ! class_exists( 'Best_Business_Featured_Page_Widget' ) ) :
