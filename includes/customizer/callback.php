...
if ( ! function_exists( 'best_business_is_featured_slider_active' ) ) :
	 ...
	 */
	function best_business_is_featured_slider_active( $control ) {
...
if ( ! function_exists( 'best_business_is_featured_page_slider_active' ) ) :
