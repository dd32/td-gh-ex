...
function weaverx_mainopts_general() {
	...
	array('name' => __('Container Area','weaver-xtreme' /*adm*/,'weaver-xtreme' /*adm*/), 'id' => 'container', 'type' => 'widget_area_submit',
...
function weaverx_mainopts_header() {
	...
	array('name' => '<small>' . __('Use Actual Image Size','weaver-xtreme' /*adm*/) . '</small>',
		...
		'info' => __('Check to use actual header image size, centered in header. (Default: theme width) (&starf;Plus)','weaver-xtreme' /*adm*/)),
...
<br />
	<textarea name="<?php weaverx_sapi_main_name('_perpagewidgets'); ?>" rows=1 style="width:60%;"><?php echo(esc_textarea(weaverx_getopt('_perpagewidgets'))); ?></textarea>
<?php
