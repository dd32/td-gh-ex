<header id="masthead" class="site-header site-header-one <?php echo ( kaira_theme_option( 'kra-header-search' ) == 1) ? '' : 'bg-left'; ?><?php echo ( kaira_theme_option( 'kra-website-layout' ) == 'site-layout-boxed') ? ' header-boxed-in' : ''; ?>" role="banner">
