...
function avis_lite_theme_register_required_plugins() {
	 ...
	 */
	$config = array(
		'domain'       		=> 'avis-lite-lite',         	        // Text domain - likely want to be the same as your theme.
		'default_path' 		=> 'AVIS_REQUIRED_PLUGINS',     // Default absolute path to pre-packaged plugins
		...
		'strings'      		=> array(
			...
			'notice_cannot_activate' 					=> _n_noop( 'Sorry, but you do not have the correct permissions to activate the %s plugin. Contact the administrator of this site for help on getting the plugin activated.', 'Sorry, but you do not have the correct permissions to activate the %s plugins. Contact the administrator of this site for help on getting the plugins activated.','avis-lite' ), // %1$s = plugin name(s)
			'notice_ask_to_update' 						=> _n_noop( 'The following plugin needs to be updated to its latest version to ensure maximum compatibility with this theme: %1$s.', 'The following plugins need to be updated to their latest version to ensure maximum compatibility with this theme: %1$s.','avis-lite' ), // %1$s = plugin name(s)
...
add_action( 'tgmpa_register', 'avis_lite_theme_register_required_plugins');