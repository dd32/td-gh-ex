...
function cmb2_get_oembed( $args = array() ) {
	...
	$error = sprintf( esc_html__( 'No oEmbed Results Found for %s. View more info at %s.', 'bento' ), $oembed['fallback'], ' <a href="http://codex.wordpress.org/Embeds" target="_blank">codex.wordpress.org/Embeds</a>' );
