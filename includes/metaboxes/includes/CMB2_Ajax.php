...
class CMB2_Ajax {
	...
	public function get_oembed( $args ) {
		...
		return '<p class="ui-state-error-text">' . sprintf( esc_html__( 'No oEmbed Results Found for %s. View more info at', 'bento' ), $oembed['fallback'] ) . ' <a href="http://codex.wordpress.org/Embeds" target="_blank">codex.wordpress.org/Embeds</a>.</p>';
	}
