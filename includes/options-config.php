...
$upgrade_to_pro = __( 'Try Pro For Free', 'greenr' );   
...
$options = array( 
    ...
    'panels' => apply_filters( 'greenr_customizer_options', array(
        'theme_options' => array(
            ...
            'sections' => array(    
                    ...
                    'fields' => array(
                        'color' => array(       
                            ...
                            'choices' => array(       
                                ...
                                '3' => __('Green_flat', 'greenr'),
                                '4' => __('More color schemes in Greenr Pro Version', 'greenr'),
                            ),
                            'default' => 1,  
                        ), 
                        'breadcrumb' => array(  
                            'type' => 'checkbox',
                            'label' => __('Enable Breadcrumb Navigation', 'greenr'),
                            'description' => __(' Check to display breadcrumb navigation.', 'greenr'),
                            'default' => 1, 
                ...
                'header_section' => array(
                    ...
                    'description' => __('Theme options related to header section', 'greenr'),
                    'fields' => array(
                        'site-title' => array(
                            'type' => 'checkbox',
                            'label' => __('Enable logo as site title', 'greenr'),
                            'description' => __('Enable to load custom logo as site title in header.','greenr'),
                            'default' => 0,
                            'sanitize_callback' => 'greenr_boolean',  
                        ),
                        'custom-logo' => array(
                            'type' => 'image',
                            'label' => __('Custom Logo: Upload any media using the WordPress native uploader', 'greenr'),
                            'description' => __('Upload any media using the WordPress native uploader','greenr'),
                ...
                'social_network' => array(
                    ...
                    'fields' => array(
                        'social-dribbble' => array(
                            ...
                            'description' => __('Your Dribbble link ', 'greenr'),
                            'sanitize_callback' => 'esc_url_raw',
                        ),
                        'social-facebook' => array(
                            'type' => 'text',
                            'label' => __('Facebook', 'greenr'),
                            'description' => __('Your Facebook link', 'greenr'),       
                            'sanitize_callback' => 'esc_url_raw',
                        ),
                        'social-twitter' => array(
                            'type' => 'text',
                            'label' => __('Twitter', 'greenr'),
                            'description' => __('Your Twitter link', 'greenr'),
                            'sanitize_callback' => 'esc_url_raw',
                        ),
                        'social-google' => array(
                            'type' => 'text',
                            'label' => __('Google +', 'greenr'),
                            'description' => __('Your Google Plus', 'greenr'),
                            'sanitize_callback' => 'esc_url_raw',
                        ),
                        'social-linkedin' => array(
                            'type' => 'text',
                            'label' => __('LinkedIn', 'greenr'),
                            'description' => __('Your LinkedIn link', 'greenr'),
                            'sanitize_callback' => 'esc_url_raw',
                        ),
                        'social-rss' => array(
                            'type' => 'text',
                            'label' => __('RSS', 'greenr'),
                            'description' => __('Your RSS link','greenr'),
                            'sanitize_callback' => 'esc_url_raw',
                        ),
                    ),
                ),
       ...
       'home' => array(
            ...
            'description'    => __('Theme options related to home page', 'greenr'),
            'sections' => array(
...
function greenr_breadcrumb_char_choices($value='') {
    $choices = array('1','2','3');
