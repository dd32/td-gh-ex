...
$options = array( 
    ...
    'panels' => apply_filters( 'boxy_customizer_options', array(
        'theme_options' => array(
            ...
            'sections' => array(    
                'general_settings' => array(
                    ...
                    'description' => __('General Settings of Theme to change look and feel through out the site', 'boxy'),
                    'fields' => array(
                        'color' => array(         
                            'type' => 'select',   
                        ...
                        'breadcrumb' => array(  
                            'type' => 'checkbox',
                            'label' => __('Enable Breadcrumb Navigation', 'boxy'),
                ...
                'header_section' => array(
                    ...
                    'description' => __('Theme options related to header section', 'boxy'),
                    'fields' => array(
                        'site-title' => array(
                            'type' => 'checkbox',
                            'label' => __('Enable logo as site title', 'boxy'),
                            'description' => __('Enable to load custom logo as site title in header.','boxy'),
                            'default' => 0,
                            'sanitize_callback' => 'boxy_boolean',  
                        ),
                        'custom-logo' => array(
                            'type' => 'image',
                            'label' => __('Custom Logo: Upload any media using the WordPress native uploader', 'boxy'),
                            'description' => __('Upload any media using the WordPress native uploader','boxy'),
       ...
       'home' => array(
            'priority'       => 9,
            'title'          => __('Home', 'boxy'),
            'description'    => __('Theme options related to home page', 'boxy'),
            'sections' => array(
                'slider_section' => array(
                    'title' => __('Flexslider Settings', 'boxy'),
                    'description' => __('','boxy'),
                    'fields' => array(
                        'image_upload-1' => array(              
                            ...
                            'sanitize_callback' => 'esc_url_raw',
                            'default' => BOXY_PARENT_URL .'/images/slide1.jpg',
                        ),
                        'flexcaption-1' => array(
                            'type' => 'text',
...
function boxy_breadcrumb_char_choices($value='') {
    $choices = array('1','2','3');
