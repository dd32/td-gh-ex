...
*/
    ...
    $sb_areas = array ('primary' => '#primary-widget-area,.widget-area-primary',
    'secondary' => '#secondary-widget-area,.widget-area-secondary',
    'top' => '.widget-area-top',
    'bottom' => '.widget-area-bottom',
    'header' => '#header',
    'header_html' => '#header-html',
    'header_sb' => '#header-widget-area,.widget-area-header',
    'footer' => '#colophon',
    'footer_html' => '#footer-html',
    'footer_sb' => '#footer-widget-area,.widget-area-footer',
    'content' => '#content',
    'container' => '#container',
    'infobar' => '#infobar',
    'wrapper' => '#wrapper',
...
// custom widths for header, footer widget areas
    ...
    $hf_sb = array ('_header_sb_' => '#header-widget-area,.widget-area-header', '_footer_sb_' => '#footer-widget-area,.widget-area-footer',
    ...
    if ( ! $override ) {
        ...
        foreach ( $sb_horizontal_areas as $id => $tag ) {     // horizontal area widths
            ...
            if ( $w ) {
                ...
                if ( $ltag == '#footer-widget-area' )
                    weaverx_f_write( $sout, ".widget-area-footer{width:{$w}%;}.is-phone .widget-area-footer{width:98%}\n");
                    if ( $ltag == '#footer-header-area' )
                    weaverx_f_write( $sout, ".widget-area-header{width:{$w}%;}.is-phone .widget-area-header{width:98%}\n");
