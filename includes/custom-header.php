 ...
 * @uses optimize_admin_header_style()
 * @uses optimize_admin_header_image()
 */
function optimize_custom_header_setup() {
	add_theme_support( 'custom-header', apply_filters( 'optimize_custom_header_args', array(
		...
		'admin-head-callback'    => 'optimize_admin_header_style',
		'admin-preview-callback' => 'optimize_admin_header_image',
	) ) );
}
...
endif; // optimize_header_style

if ( ! function_exists( 'optimize_admin_header_style' ) ) :
/**
 * Styles the header image displayed on the Appearance > Header admin panel.
 *
 * @see optimize_custom_header_setup().
 */
function optimize_admin_header_style() {
?>
	<style type="text/css">
...
endif; // optimize_admin_header_style
...
endif; // optimize_admin_header_image