...
$output .= '</div>';
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'category' ) ?>"><?php _e( 'Category', 'electa' ) ?></label>
            ...
            <span class="widgets-desc"><?php _e( 'Enter the ID\'s of the <a href="' . admin_url( 'edit-tags.php?taxonomy=category' ) . '" target="_blank">post categories</a> you want to show in this carousel. Eg: "4,6,8". Or leave blank to show ALL posts.', 'electa' ) ?></span>
		</p>
		
		<p>
			<label for="<?php echo $this->get_field_id( 'columns' ) ?>"><?php _e( 'Columns', 'electa' ) ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'show-featured-image' ) ?>"><?php _e( 'Show Featured Image', 'electa' ) ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'show-title' ) ?>"><?php _e( 'Show Title', 'electa' ) ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'show-excerpt' ) ?>"><?php _e( 'Show Post Excerpt', 'electa' ) ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'category' ) ?>"><?php _e( 'Excerpt Length', 'electa' ) ?></label>
            ...
            <span class="widgets-desc"><?php _e( 'Enter the character length you want the excerpt to be. Default is 200 characters.', 'electa' ) ?></span>
        </p>
		
		<p>
			<label for="<?php echo $this->get_field_id( 'show-meta' ) ?>"><?php _e( 'Show Post Meta', 'electa' ) ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'carousel-pagination' ) ?>"><?php _e( 'Carousel Pagination', 'electa' ) ?></label>
