	...
	class balanced_blog_Popular_Posts extends WP_Widget {
		...
		function __construct() {
			$opts = array(
				...
				'description'	 => esc_html__( 'Displays your popular posts with thumbnail and date. Recommended use: in sidebar or footer', 'balanced-blog' ),
			);

			parent::__construct( 'balanced-blog-popular-posts', esc_html__( 'Balanced Blog: Popular posts', 'balanced-blog' ), $opts );
		}
		...
		function widget( $args, $instance ) {
			...
			function form( $instance ) {
				...
				$instance = wp_parse_args( (array) $instance, array(
					'title'			 => esc_html__( 'Popular posts', 'balanced-blog' ),
					'post_number'	 => 5,
				) );
				?>
				<p>
