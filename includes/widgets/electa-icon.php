...
class electa_icon extends WP_Widget {
	...
	function form( $instance ) {
		...
		?>
		<p>
			<label for="<?php echo $this->get_field_id( 'icon_name' ) ?>"><?php _e( 'Icon Name', 'electa' ) ?></label>
            ...
            <span class="widgets-desc"><?php _e( 'Select the icon from <a href="http://fortawesome.github.io/Font-Awesome/cheatsheet/" target="_blank">Font Awesome</a>, select the text name and add it here. Eg: "fa-glass".', 'electa' ) ?></span>
		</p>
        
        <p>
            <label for="<?php echo $this->get_field_id( 'icon_bg_color' ) ?>"><?php _e( 'Icon Background Color', 'electa' ) ?></label>
            ...
            <span class="widgets-desc"><?php _e( 'Enter the hash value for the background color of the icon. Eg: "#000000" (Include the "#"")', 'electa' ) ?></span>
        </p>
        
        <p>
            <label for="<?php echo $this->get_field_id( 'icon_color' ) ?>"><?php _e( 'Icon Color', 'electa' ) ?></label>
            ...
            <span class="widgets-desc"><?php _e( 'Enter the hash value for the color of the icon. Eg: "#000000" (Include the "#"")', 'electa' ) ?></span>
        </p>
		
		<p>
			<label for="<?php echo $this->get_field_id( 'icon_size' ) ?>"><?php _e( 'Icon Size', 'electa' ) ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'icon_style' ) ?>"><?php _e( 'Icon Style', 'electa' ) ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'icon_align' ) ?>"><?php _e( 'Icon Alignment', 'electa' ) ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'icon_link' ) ?>"><?php _e( 'Icon Link', 'electa' ) ?></label>
            ...
            <span class="widgets-desc"><?php _e( 'Enter the link url for the icon. Don\'t forget the "http://"', 'electa' ) ?></span>
        </p>
        
        <p>
            <label for="<?php echo $this->get_field_id( 'icon_link_target' ) ?>"><?php _e( 'Icon Link Target', 'electa' ) ?></label>
