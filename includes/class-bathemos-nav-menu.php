 ...
 * @since 1.0.0
 */
class Bathemos_Nav_Menu extends Walker_Nav_Menu {
	...
	static function init() {
		...
		// Provide data.
		add_filter( 'bathemos_nav_menu_walker', array( __CLASS__, 'get_name' ), 10, 2 );
		add_filter( 'nav_menu_link_attributes', array( __CLASS__, 'get_menu_link_attr' ), 10, 3 );
		add_filter( 'bathemos_nav_menu_fallback', array( __CLASS__, 'get_fallback' ), 10, 2 );
	}
	...
	public static function fallback( $args ) {
        ...
        $fb_output = apply_filters( 'bathemos_nav_menu_fallback_html', $fb_output, $args );
