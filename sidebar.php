...
<li><a href="<?php bloginfo('url'); ?>/site-map/">Site Map</a></li>
	<li><a href="<?php bloginfo('rss_url'); ?>">RSS Feed</a> <a href="<?php bloginfo('rss_url'); ?>"><img src="<?php bloginfo('url'); ?>/wp-content/themes/76-digital-ora/images/rss_blue.png" alt="RSS Feed" /></a></li>
...
&feed_image='.get_bloginfo('url').'/wp-content/themes/76-digital-ora/images/rss_blue.png'); ?>
</ul>
</li><li class="dotted_line">&nbsp;</li>
