<div class="grid_6">
  <div id="sidebar">
    <div id="sidebar_inside">
	  ...
	  <?php 
      if ( ! dynamic_sidebar( 'chiplife-primary-sidebar' ) ):
      ...
      <div class="widget widget_pages widget-widget_pages">
        <div class="widget-wrap widget-inside">
          <h3 class="widget-title"><?php _e( 'Pages', 'chiplife' ); ?></h3>
      ...
      <div class="widget widget_categories widget-widget_categories">
        <div class="widget-wrap widget-inside">
          <h3 class="widget-title"><?php _e( 'Categories', 'chiplife' ); ?></h3>
      ...
      <div class="widget widget_archive widget-widget_archive">
        <div class="widget-wrap widget-inside">
          <h3 class="widget-title"><?php _e( 'Archives', 'chiplife' ); ?></h3>
      ...
      <div class="widget widget_calendar widget-widget_calendar">
        <div class="widget-wrap widget-inside">
          <h3 class="widget-title"><?php _e( 'Calendar', 'chiplife' ); ?></h3>
          <?php get_calendar(); ?>
        </div>
      </div>
      ...
      <div class="widget widget_recent_entries widget-widget_recent_entries">
        <div class="widget-wrap widget-inside">
          <h3 class="widget-title"><?php _e( 'Recent Posts', 'chiplife' ); ?></h3>
      ...
      <div class="widget widget_tag_cloud widget-widget_tag_cloud">
        <div class="widget-wrap widget-inside">
          <h3 class="widget-title"><?php _e( 'Tag Cloud', 'chiplife' ); ?></h3>
      ...
      <div class="widget widget_text widget-widget_text">
        <div class="widget-wrap widget-inside">
          <h3 class="widget-title"><?php _e( 'About Chiplife', 'chiplife' ); ?></h3>
          <div class="textwidget"><?php printf( __( '%s', 'chiplife' ), $chiplife_theme_data['Description'] ); ?></div>
        </div>
      </div>
      
      <div class="widget widget_meta widget-widget_meta">
        <div class="widget-wrap widget-inside">
          <h3 class="widget-title"><?php _e( 'Meta', 'chiplife' ); ?></h3>
            <ul>
              <?php wp_register(); ?>
