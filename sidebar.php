...
for($i=1;$i<$max;$i++):?>
	...
	<div id="sidebar<?php echo $i;?>" class="sidebar widget-area sb_<?php echo $type;?>" role="complementary">
		<ul>
			<?php 
			...
			<h5 class="widgettitle"><?php _e( 'Pages', 'webfish-theme' ); ?></h5>
				<ul>
			...
			<li id="archives" class="widget-container">
				<h5 class="widgettitle"><?php _e( 'Archives', 'webfish-theme' ); ?></h5>
				<ul>
			...
			<li id="meta" class="widget-container">
				<h5 class="widgettitle"><?php _e( 'Meta', 'webfish-theme' ); ?></h5>
				<ul>
					<?php wp_register(); ?>
