...
//		echo '<pre>'.json_encode($theme_mod,JSON_PRETTY_PRINT).'</pre>';
        ...
        wp_enqueue_script('attire-html5', get_template_directory_uri() . '/js/html5shiv.js');
        wp_script_add_data('attire-html5', 'conditional', 'lt IE 9');
        wp_enqueue_script('attire-respond', get_template_directory_uri() . '/js/respond.min.js');
        wp_script_add_data('attire-respond', 'conditional', 'lt IE 9');

        wp_register_script('popper', ATTIRE_TEMPLATE_URL . '/bootstrap/js/popper.min.js', array(), false, true);
        wp_enqueue_script('bootstrap', ATTIRE_TEMPLATE_URL . '/bootstrap/js/bootstrap.min.js', array(
            'jquery',
            'popper'
        ), false, true);
        wp_enqueue_script('modernizer', ATTIRE_TEMPLATE_URL . '/js/modernizr-custom.js', array(), false, true);
        wp_enqueue_script('attire-site', ATTIRE_TEMPLATE_URL . '/js/site.js', array('jquery'), false, true);
                ...
                <div class="card comment-card">
                    ...
                    <div class="card-footer">
                        ...
                        <div class="comment-edit-reply">
                            <small><?php edit_comment_link('&nbsp;<i class="fa fa-pencil"></i> Edit', ' '); ?></small>
    ...
    public function GetAttireDefaults()
    {
        $this->attire_defaults = array(
            ...
            'copyright_info' => '&copy; Copyright 2017 | All Rights Reserved.',
