...
class MetaBoxes {
	...
	function PageWidth( $post ) {
		...
		echo wp_nonce_field( 'page_layout_nonce', 'page_layout_nonce' );
		echo '<select class="form-control" id="page_width" name="attire_post_meta[layout_page]">';
		echo '<option  value="default"  ' . $default . '> Theme Default</option>';
		echo '<option  value="container-fluid"  ' . $container_fluid . '> Full-Width</option>';
		echo '<option  value="container"  ' . $container . '> Container</option>';
		echo '</select>';
                            ...
                            <span class='input-group-btn'>
                                <button rel='#cph_image' class='btn btn-default btn-media-upload' type='button'>
                                    <i class='fa fa-picture-o'></i>
                                            ...
                                            <input class='form-control' type='text' name='attire_post_meta[cph_image]'
                                ...
                                <div class='col-md-7' style="padding-top: 15px">
                                    <button class="btn btn-sm btn-default col-md-12" id="clear_cph" type="button">Clear
                                    </button>
	...
	function SavePostMeta( $postid, $post ) {
		...
		if ( isset( $_POST['attire_post_meta'] ) && is_array( $_POST['attire_post_meta'] ) ) {
			...
			if ( wp_verify_nonce( $_REQUEST['page_settings_nonce'], 'page_settings_nonce' ) ) {
