...
//			$atts['class']  = 'dropdown-item';
            ...
            $item_output .= ($args->has_children) ? ' </a><span class="dropdown-toggler"><i class="fa fa-caret-down" aria-hidden="true"></i></span>' : '</a>';
    ...
    public static function fallback($args)
    {
        if (current_user_can('manage_options')) {
            ...
            $fb_output .= '>';
            $fb_output .= '<li class="nav-item menu-item"><a href="' . get_home_url() . '">Home</a></li>';
            $fb_output .= '<li class="nav-item menu-item"><a href="' . admin_url('nav-menus.php') . '">Add a menu</a></li>';
            $fb_output .= '</ul>';
