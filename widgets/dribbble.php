...
// Dribbble widget for Hoffman WordPress theme

include_once(ABSPATH . WPINC . '/feed.php');

class hoffman_dribbble extends WP_Widget {

	function hoffman_dribbble() {
		parent::WP_Widget(false, $name = 'Dribbble widget', array('description' => __('Displays your latest Dribbble photos.', 'hoffman') ));	
	}
	...
	function form($instance) {
		...
		<p>
			<label for="<?php echo $this->get_field_id('dribbble_username'); ?>"><?php  _e('Dribbble username', 'hoffman'); ?>:
		...
		<p>
			<label for="<?php echo $this->get_field_id('dribbble_number'); ?>"><?php _e('Number of images to display:', 'hoffman'); ?>
...
register_widget('hoffman_dribbble'); ?>