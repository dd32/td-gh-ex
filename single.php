...
?>
    ...
    <?php }?>
		...
		<div id="primary" class="content-area <?php echo $content_class;?>">
            ...
            'prev_text'				=> __( '%title <i class="fa fa-long-arrow-left post-arrow"></i>', 'ace-corporate' ),
            'next_text'				=> __( '<i class="fa fa-long-arrow-right post-arrow"></i> %title', 'ace-corporate' ),
            'in_same_term'    		=> true,
            'screen_reader_text'	=> esc_html__( 'Continue Reading', 'ace-corporate'),
        ) );?>
