...
while ( have_posts() ) {
	...
	<nav id="nav-above" class="navigation">
		...
		<?php if ( weaverx_getopt( 'single_nav_style' ) == 'prev_next' ) { ?>
			<div class="nav-previous"><?php previous_post_link( '%link', weaverx_filter_text( __( '<span class="meta-nav">&larr;</span> Previous', 'weaver-xtreme' ) ), $cats ); ?></div>
			<div class="nav-next"><?php next_post_link( '%link', weaverx_filter_text( __( 'Next <span class="meta-nav">&rarr;</span>', 'weaver-xtreme' ) ), $cats ); ?></div>
