...
<?php do_action('greenr_single_flexslider_featured_image'); ?>
		...
		<?php while ( have_posts() ) : the_post(); ?>
			...
			<?php get_template_part( 'content', 'single' ); ?>
				...
				<?php if( get_theme_mod ('social_sharing_box',true)): ?>
					<div class="share-box">
						<h4><?php _e( 'Share this on ...', 'greenr' ); ?></h4>
						<ul>
				...
				<h4><?php echo __( 'About Author:', 'greenr' ); ?> <?php the_author_posts_link(); ?></h4>
			...
			<?php if( get_theme_mod('related_posts') && function_exists( 'greenr_related_posts' ) ) : ?>
				<section class="related-posts clearfix">
					<?php greenr_related_posts(); ?>
				</section>
			<?php endif;  ?>
