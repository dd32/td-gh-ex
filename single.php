				...
				while ( have_posts() ): the_post(); ?>
                    ...
                    <div <?php post_class( 'post' ); ?>>
                        ...
                        <div class="single-post-tags">
                            <h3 class="tag-title"><?php _e( 'Post Tags', 'attire' ); ?></h3>
                        ...
                        <div class="single-post-author">
                            ...
                            <h3 class="author-title"><?php _e( 'About The Author', 'attire' ); ?></h3>

                            <div class="post-author-info">

                                <div class="media">
                                    <img class="mr-3"
                                         src="<?php echo get_avatar_url( get_the_author_meta( 'ID' ), array( 'size' => 90 ) ) ?>"
                                         alt="Author Avatar">
                                    <div class="media-body">
                                        <h4 class="mt-0"><?php echo get_the_author_meta( 'display_name' ); ?></h4>
