...
<div class="metabox">Posted by <?php the_author_posts_link () ?> | <?php the_time('M j, Y') ?> | <?php the_tags('Tags: ', ', '); ?>  <?php comments_popup_link(' No Comments', ' 1 Comment', ' % Comments '); ?></div><?php the_content(); ?><?php wp_link_pages('<p><strong>Pages:</strong>', '</p>', 'number'); ?>
<div class="advert-x">
