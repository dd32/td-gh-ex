...
<div id="content">
		  ...
		  <?php if ( have_posts() ) while ( have_posts() ) : the_post(); ?>
			...
			<?php  wp_link_pages( array( 'before' => '<div class="page-link"><span>' . esc_html__('Pages:','d5-design') . '</span>', 'after' => '</div>' ) ); ?>
           <div class="floatleft"><?php previous_post_link('&laquo; %link'); ?></div>
            ...
            <div class="floatleft"><?php previous_image_link( false, esc_html__('&laquo; Previous Image','d5-design') ); ?></div>
			<div class="floatright"><?php next_image_link( false, esc_html__('Next Image &raquo;','d5-design') ); ?></div> 
            <?php endif; ?>
          	</div>
			 <div class="content-ver-sep"></div><br />
			<?php endwhile;?>
