...
<h3 class="bqpheading"><?php _e('Latest <em>Blog', 'sunrain'); ?></em> Posts</h3>
...
<?php if (esc_html(sunrain_get_option('fpostex', '1')) != '1'): get_template_part( 'front-page-content' ); endif;?>
