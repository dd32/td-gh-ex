			...
			<div class="row">
				<div class="col-md-12">
					<div class="home-jumbotron jumbotron">
						<h1><?php echo apply_filters( 'the_title', $bavotasan_theme_options['jumbo_headline_title'] ); ?></h1>
...
?>
	<div class="container from-the-blog">
		<div class="row">
			<div id="primary" <?php if ( 2 > $paged ) { ?>class="col-md-12"<?php } else { bavotasan_primary_attr(); }; ?>>
				<?php if ( 2 > $paged ) { ?>
