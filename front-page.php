				...
				foreach ($layout as $key=>$value) {
				    switch($key) {
					    ...
					    case 'block_two':?>
									...
									<?php get_template_part('templates/home/example', 'iconmenu'); ?>
					    ...
					    case 'block_four': ?>
							...
							<?php if(kadence_display_sidebar()) {$display_sidebar = true; $fullclass = '';} else {$display_sidebar = false; $fullclass = 'fullwidth';}
								...
								?>
								<div id="<?php echo $contentid;?>" class="homecontent <?php echo $fullclass; ?>  <?php echo $postclass; ?> clearfix home-margin"> 
							  <?php  if($summary == 'full'){
						            if($display_sidebar){
