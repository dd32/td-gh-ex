		...
		<div class="row">
			<div class="columns large-16">
				...
				if ('' != get_the_post_thumbnail()) {
					?>
					<a href="<?php the_permalink(); ?>" class="smartlib-thumbnail-outer"><?php smartlib_get_format_ico($post_format) ?><?php the_post_thumbnail('wide-image'); ?></a>

					<?php
				}else if ( $post_format == 'gallery' && !empty( $featured_image ) ) {
					?>
					<a href="<?php the_permalink(); ?>" class="smartlib-thumbnail-outer"><?php smartlib_get_format_ico($post_format) ?><?php echo $featured_image; ?></a>
					<?php
				}
