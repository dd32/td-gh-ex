...
function beauty_studio_dynamic_editor_styles(){
	...
	$beauty_studio_link_color               = esc_attr( $beauty_studio_customizer_all_values['beauty_studio-link-color'] );
	$beauty_studio_link_hover_color         = esc_attr( $beauty_studio_customizer_all_values['beauty_studio-link-hover-color'] );
...
function beauty_studio_block_editor_styles() {
	wp_enqueue_style( 'beauty_studio-googleapis', '//fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i,800,800i', array(), null );
	wp_enqueue_style( 'beauty_studio-block-editor-styles', get_template_directory_uri() . '/acmethemes/gutenberg/gutenberg-edit.css', false, '1.0' );

	/**
	 * Styles from the customizer
	 */
	wp_add_inline_style( 'beauty_studio-block-editor-styles', beauty_studio_dynamic_editor_styles() );
}
add_action( 'enqueue_block_editor_assets', 'beauty_studio_block_editor_styles',99 );

function beauty_studio_gutenberg_scripts() {
	wp_enqueue_style( 'beauty_studio-block-front-styles', get_template_directory_uri() . '/acmethemes/gutenberg/gutenberg-front.css', false, '1.0' );
	wp_style_add_data( 'beauty_studio-block-front-styles', 'rtl', 'replace' );
}
