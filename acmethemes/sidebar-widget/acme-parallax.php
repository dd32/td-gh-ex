 ...
 * @since 1.0.0
 */
if ( ! class_exists( 'Beauty_Studio_Feature' ) ) {

	class Beauty_Studio_Feature extends WP_Widget {
		...
		private function defaults(){
			...
			$defaults = array(
				...
				'sub_title'         => '',
				'bg_image'          => '',
				'button_one_text'   => esc_html__( 'Book Now', 'beauty-studio' ),
				'button_one_url'    => '',
				'button_two_text'   => esc_html__( 'Learn More', 'beauty-studio' ),
				'button_two_url'    => ''
			);
			return $defaults;
		}
		...
		function __construct() {
			parent::__construct(
                    ...
                    esc_html__('AT Parallax Section', 'beauty-studio'),
                    /*Widget description*/
                    array(
                            'description' => esc_html__( 'Show Parallax Section.', 'beauty-studio' )
                    )
			);
		}
		...
		public function form( $instance ) {
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'sub_title' ) ); ?>"><?php esc_html_e( 'Short Description', 'beauty-studio' ); ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'button_one_text' ) ); ?>"><?php esc_html_e( 'Extra Button Text', 'beauty-studio' ); ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'button_one_url' ) ); ?>"><?php esc_html_e( 'Button Link Url', 'beauty-studio' ); ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'button_two_text' ) ); ?>"><?php esc_html_e( 'Extra Button Text', 'beauty-studio' ); ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'button_two_url' ) ); ?>"><?php esc_html_e( 'Button Link Url', 'beauty-studio' ); ?></label>
	...
	} // Class Beauty_Studio_Feature ends here
}