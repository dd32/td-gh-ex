 ...
 * @since 1.0.0
 */
if ( ! class_exists( 'Beauty_Studio_Team' ) ) {

    class Beauty_Studio_Team extends WP_Widget {
        ...
        public function form( $instance ) {
            ...
            <p>
                ...
                <select class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'column_number' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'column_number' ) ); ?>" >
                    <?php
                    $beauty_studio_team_column_numbers = beauty_studio_widget_column_number();
                    foreach ( $beauty_studio_team_column_numbers as $key => $value ){
                        ?>
	               ...
	               <?php
                    ...
                    <div <?php echo $div_attr;?>>
                        ...
                        if( !empty ( $post_in ) ) :
                            ...
                            $team_query = new WP_Query( $beauty_studio_post_in_page_args );
                            /*The Loop*/
    ...
    } // Class Beauty Studio_team ends here
}