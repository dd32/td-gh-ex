...
$styleSheets[3]["sheet"]='<link href="'. get_stylesheet_directory_uri() . '/style/white_l.css" rel="stylesheet" type="text/css" />';
...
$styleSheets[2]["sheet"]='<link href="'. get_stylesheet_directory_uri() . '/style/black_l.css" rel="stylesheet" type="text/css" />';
...
$styleSheets[4]["sheet"]='<link href="'. get_stylesheet_directory_uri() . '/style/dyslexic.css" rel="stylesheet" type="text/css" />';

$styleSheets[5]["text"]='<span class="white">Single column black text on white </span>';

$styleSheets[5]["title"]='Click here to set Style 5';

$styleSheets[5]["sheet"]='<link href="'. get_stylesheet_directory_uri() . '/style/zoom_w.css" rel="stylesheet" type="text/css" />';
...
$styleSheets[6]["sheet"]='<link href="'. get_stylesheet_directory_uri() . '/style/zoom_b.css" rel="stylesheet" type="text/css" />';
