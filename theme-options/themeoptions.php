		...
		$advent_options = get_option( 'advent_theme_options' );
		 ?>
          ...
          <div id="options-group-1" class="group themeoptions-tabs">   
            ...
            <div class="themeoptions-inner-tab-group active">
                ...
                <input id="logo-img" class="upload" type="text" name="advent_theme_options[logo]" 
                            value="<?php if(!empty($advent_options['logo'])) { echo esc_url($advent_options['logo']); } ?>" placeholder="<?php _e('No file chosen','advent'); ?>" />
                <input id="upload_image_button" class="upload-button button" type="button" value="<?php _e('Upload','advent'); ?>" />
                <div class="screenshot" id="logo-image">
                  <?php if(!empty($advent_options['logo'])) { echo "<img src='".esc_url($advent_options['logo'])."' /><a class='remove-image'></a>"; } ?>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="themeoptions-inner-tab-group">
                ...
                <div class="ft-control">
                  <input id="favicon-img" class="upload" type="text" name="advent_theme_options[favicon]" 
                            value="<?php if(!empty($advent_options['favicon'])) { echo esc_url($advent_options['favicon']); } ?>" placeholder="<?php _e('No file chosen','advent'); ?>" />
                  ...
                  <div class="screenshot" id="favicon-image">
                    <?php  if(!empty($advent_options['favicon'])) { echo "<img src='".esc_url($advent_options['favicon'])."' /><a class='remove-image'></a>"; } ?>
                  </div>
                </div>
              </div>
            </div>     
            <div id="section-footertext" class="section theme-tabs">
              ...
              <div class="themeoptions-inner-tab-group">
              	<div class="ft-control">
                  	...
                  	<input maxlength="300" type="text" id="footertext" class="of-input" name="advent_theme_options[footertext]" size="32"  value="<?php if(!empty($advent_options['footertext'])) { echo esc_attr($advent_options['footertext']); } ?>">
                </div>                
              </div>
            </div>
		</div>          
            ...
            <div id="headertop-logo" class="section theme-tabs">
              ...
              <div class="themeoptions-inner-tab-group">
                ...
                <input id="headertop-logo" class="upload" type="text" name="advent_theme_options[headertop-logo]" 
                            value="<?php if(!empty($advent_options['headertop-logo'])) { echo esc_url($advent_options['headertop-logo']); } ?>" placeholder="<?php _e('No file chosen','advent'); ?>" />
                <input id="upload_image_button" class="upload-button button" type="button" value="<?php _e('Upload','advent'); ?>" />
                <div class="screenshot" id="headertop-logo">
                  <?php if(!empty($advent_options['headertop-logo'])) { echo "<img src='".esc_url($advent_options['headertop-logo'])."' /><a class='remove-image'></a>"; } ?>
                </div>
              </div>
              </div>
            </div>
            <div id="headertop-img" class="section theme-tabs">
              ...
              <div class="themeoptions-inner-tab-group">
                ...
                <input id="headertop-img" class="upload" type="text" name="advent_theme_options[headertop-img]" 
                            value="<?php if(!empty($advent_options['headertop-img'])) { echo esc_url($advent_options['headertop-img']); } ?>" placeholder="<?php _e('No file chosen','advent'); ?>" />
                <input id="upload_image_button" class="upload-button button" type="button" value="<?php _e('Upload','advent'); ?>" />
                <div class="screenshot" id="headertop-img">
                  <?php if(!empty($advent_options['headertop-img'])) { echo "<img src='".esc_url($advent_options['headertop-img'])."' /><a class='remove-image'></a>"; } ?>
                </div>
              </div>
              </div>
            </div>
          ...
          <div id="headertop-bg" class="section theme-tabs">
              ...
              <div class="themeoptions-inner-tab-group">
                ...
                <input id="headertop-bg" class="upload" type="text" name="advent_theme_options[headertop-bg]" 
                            value="<?php if(!empty($advent_options['headertop-bg'])) { echo esc_url($advent_options['headertop-bg']); } ?>" placeholder="<?php _e('No file chosen','advent'); ?>" />
                <input id="upload_image_button" class="upload-button button" type="button" value="<?php _e('Upload','advent'); ?>" />
                <div class="screenshot" id="headertop-bg">
                  <?php if(!empty($advent_options['headertop-bg'])) { echo "<img src='".esc_url($advent_options['headertop-bg'])."' /><a class='remove-image'></a>"; } ?>
                </div>
              </div>
              </div>
            </div>
            ...
            <div id="section-title" class="section theme-tabs">
              ...
              <div class="themeoptions-inner-tab-group">
              	<div class="ft-control">
                  	...
                  	<input maxlength="100" id="title" class="of-input" name="advent_theme_options[home-title]"  type="text" size="50" value="<?php if(!empty($advent_options['home-title'])) { echo esc_attr($advent_options['home-title']); } ?>" />
                </div>                
              </div>
            </div>
          ...
          <?php for($advent_section_i=1; $advent_section_i <=6 ;$advent_section_i++ ): ?>
            ...
            <div class="themeoptions-inner-tab-group">
              <div class="ft-control">
                <div class="explain"><?php _e('Enter any font-awesome icon name here. i.e. ','advent'); echo 'fa-inr *'; ?></div>
                    <input type="text"   placeholder="<?php _e('Enter icon class i.e. ','advent'); echo 'fa-inr'; ?>" id="faicon-<?php echo $advent_section_i;?>" class="of-input" name="advent_theme_options[faicon-<?php echo $advent_section_i;?>]" size="32"  value="<?php if(!empty($advent_options['faicon-'.$advent_section_i])) { echo esc_attr($advent_options['faicon-'.$advent_section_i]); } ?>">
                     <a href="http://fortawesome.github.io/Font-Awesome/icons/" target="_blank"><?php _e('View all icons','advent'); ?></a>
			  </div>
			<div class="ft-control">
                <div class="explain"><?php _e('Enter secion title for your home template , you would like to display in the Home Page.','advent'); echo '*'; ?></div>
                    <input type="text" maxlength="50"   placeholder="<?php _e('Enter title here','advent'); ?>" id="title-<?php echo $advent_section_i;?>" class="of-input" name="advent_theme_options[section-title-<?php echo $advent_section_i;?>]" size="32"  value="<?php if(!empty($advent_options['section-title-'.$advent_section_i])) { echo esc_attr($advent_options['section-title-'.$advent_section_i]); } ?>">
              </div>
				<div class="ft-control">
                 <div class="explain"><?php _e('Enter section content for home template , you would like to display in the Home Page.','advent'); ?></div>
              <textarea maxlength="200"  name="advent_theme_options[section-content-<?php echo $advent_section_i; ?>]" rows="6" id="content-<?php echo $advent_section_i; ?>" placeholder="<?php _e('Enter Content here','advent'); ?>" class="of-input"><?php if(!empty($advent_options['section-content-'.$advent_section_i])) { echo esc_attr($advent_options['section-content-'.$advent_section_i]); } ?></textarea>
              </div>                              
            </div>
            </div>
            <?php endfor; ?>
            ...
            <div id="howitwork-title" class="section theme-tabs">
              ...
              <div class="themeoptions-inner-tab-group">
              	<div class="ft-control">
                  	...
                  	<input maxlength="100" id="howitwork" class="of-input" name="advent_theme_options[howitwork]" type="text" size="50" value="<?php if(!empty($advent_options['howitwork'])) { echo esc_attr($advent_options['howitwork']); } ?>" />
                </div>                
              </div>
            </div>
            <div id="howitwork-heading" class="section theme-tabs">
              ...
              <div class="themeoptions-inner-tab-group">
              	<div class="ft-control">
					...
					<input maxlength="70" id="howitworktitle" class="of-input" name="advent_theme_options[howitworktitle]" type="text" size="50" value="<?php if(!empty($advent_options['howitworktitle'])) { echo esc_attr($advent_options['howitworktitle']); } ?>" />
                </div>                
              </div>
            </div>
            <div id="howitwork-desc" class="section theme-tabs">
              ...
              <div class="themeoptions-inner-tab-group">
              	<div class="ft-control">
					...
					<textarea maxlength="1000" name="advent_theme_options[howitworkdesc]" rows="6" id="howitworkdesc" class="of-input"><?php if(!empty($advent_options['howitworkdesc'])) { echo esc_attr($advent_options['howitworkdesc']); } ?></textarea>
				</div>                
              </div>
            </div>
            <div id="howitwork-img" class="section theme-tabs">
              ...
              <div class="themeoptions-inner-tab-group">
                ...
                <input id="howitwork-img" class="upload" type="text" name="advent_theme_options[howitwork-img]" 
                            value="<?php if(!empty($advent_options['howitwork-img'])) { echo esc_url($advent_options['howitwork-img']); } ?>" placeholder="<?php _e('No file chosen','advent'); ?>" />
                <input id="upload_image_button" class="upload-button button" type="button" value="<?php _e('Upload','advent'); ?>" />
                <div class="screenshot" id="howitwork-img">
                  <?php if(!empty($advent_options['howitwork-img'])) { echo "<img src='".esc_url($advent_options['howitwork-img'])."' /><a class='remove-image'></a>"; } ?>
                </div>
              </div>
              </div>
            </div>
            ...
            <div id="section-recent-title" class="section theme-tabs">
              ...
              <div class="themeoptions-inner-tab-group">
              	<div class="ft-control">
                  	...
                  	<input maxlength="100" id="post" class="of-input" name="advent_theme_options[post-title]" type="text" size="50" value="<?php if(!empty($advent_options['post-title'])) { echo esc_attr($advent_options['post-title']); } ?>" />
                </div>                
              </div>
            </div>
            <div class="section theme-tabs theme-short_description">
              ...
              <div class="themeoptions-inner-tab-group  active">
              	<div class="ft-control">
              		<div class="explain"><?php _e('Send email i.e. ','advent'); ?>name@gmail.com</div>                
                  	 <input id="email" class="of-input" name="advent_theme_options[email]" type="text" size="30" value="<?php if(!empty($advent_options['email'])) { echo esc_attr($advent_options['email']); } ?>" />
                </div>                
              </div>
            </div>            
            <div id="section-facebook" class="section theme-tabs">
              ...
              <div class="themeoptions-inner-tab-group">
              	<div class="ft-control">
                  	...
                  	<input id="facebook" class="of-input" name="advent_theme_options[facebook]" size="30" type="text" value="<?php if(!empty($advent_options['facebook'])) { echo esc_url($advent_options['facebook']); } ?>" />
                </div>                
              </div>
            </div>
            <div id="section-twitter" class="section theme-tabs">
              ...
              <div class="themeoptions-inner-tab-group">
              	<div class="ft-control">
                  	...
                  	<input id="twitter" class="of-input" name="advent_theme_options[twitter]" type="text" size="30" value="<?php if(!empty($advent_options['twitter'])) { echo esc_url($advent_options['twitter']); } ?>" />
                </div>                
              </div>
            </div>
              ...
              <div class="themeoptions-inner-tab-group">
              	<div class="ft-control">
              		<div class="explain"><?php _e('Pinterest profile or page URL i.e.','advent'); ?> https://pinterest.com/username/</div>                
                  	 <input id="pinterest" class="of-input" name="advent_theme_options[pinterest]" type="text" size="30" value="<?php if(!empty($advent_options['pinterest'])) { echo esc_url($advent_options['pinterest']); } ?>" />
                </div>                
              </div>
            </div>
          </div>
...
<div class="save-options"><h2><?php _e('Options saved successfully.','advent'); ?></h2></div>
<?php } ?>
