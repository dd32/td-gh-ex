              ...
              <div class="faster-inner-tab-group active">
                ...
                <div class="ft-control">
                  <input id="favicon-img" class="upload" type="text" name="medium_theme_options[logo]" 
                            value="<?php if(!empty($medium_options['logo'])) { echo esc_url($medium_options['logo']); } ?>" placeholder="<?php _e('No file chosen','medium') ?>" />
                  <input id="upload_image_button1" class="upload-button button" type="button" value="Upload" />
                  <div class="screenshot" id="favicon-image">
                    <?php  if(!empty($medium_options['logo'])) { echo "<img src='".esc_url($medium_options['logo'])."' /><a class='remove-image'>".__('Remove','medium')."</a>"; } ?>
                  </div>
                </div>
            ...
            <div class="section theme-tabs theme-favicon">
              ...
              <div class="faster-inner-tab-group">
                ...
                <div class="ft-control">
                  <input id="favicon-img" class="upload" type="text" name="medium_theme_options[favicon]" 
                            value="<?php if(!empty($medium_options['favicon'])) { echo esc_url($medium_options['favicon']); } ?>" placeholder="<?php _e('No file chosen','medium') ?>" />
                  <input id="upload_image_button1" class="upload-button button" type="button" value="Upload" />
                  <div class="screenshot" id="favicon-image">
                    <?php  if(!empty($medium_options['favicon'])) { echo "<img src='".esc_url($medium_options['favicon'])."' /><a class='remove-image'>".__('Remove','medium')."</a>"; } ?>
                  </div>
                </div>
              ...
              <div class="faster-inner-tab-group">              	
                <div class="ft-control">
                  	...
                  	<input id="scmessage" name="medium_theme_options[search-text]" type="text" value="<?php if(!empty($medium_options['search-text'])) { echo wp_filter_nohtml_kses($medium_options['search-text']); } ?>" placeholder="<?php _e('i.e. Find Portfolio,Blog and contact','medium') ?>" size="32" />
                </div>
              ...
              <div class="faster-inner-tab-group">              	
                <div class="ft-control">
                  	...
                  	<input id="scmessage" name="medium_theme_options[blog-title]" type="text" value="<?php if(!empty($medium_options['blog-title'])) { echo wp_filter_nohtml_kses($medium_options['blog-title']); } ?>" placeholder="<?php _e('Footer Settings i.e. Blog','medium') ?>" size="32" />
                </div>
            ...
            <div id="section-social" class="section theme-tabs">
              ...
              <div class="faster-inner-tab-group">
                <div class="ft-control">
                  	...
                  	<input id="scmessage" name="medium_theme_options[scmessage]" type="text" value="<?php if(!empty($medium_options['scmessage'])) { echo wp_filter_nohtml_kses($medium_options['scmessage']); } ?>" placeholder="<?php _e('i.e. Connect With Me','medium') ?>" size="32" />
                </div>
              	<div class="ft-control">
              		<div class="explain"><?php _e('Facebook profile','medium') ?></div>                
                  	<input id="facebook" name="medium_theme_options[fburl]" type="text" value="<?php if(!empty($medium_options['fburl'])) { echo esc_url($medium_options['fburl']); } ?>" placeholder="http://facebook.com/username/" size="32" />
                </div>
                <div class="ft-control">
              		<div class="explain"><?php _e('Twitter profile','medium') ?></div>                
                  	<input id="twitter" name="medium_theme_options[twitter]" type="text" value="<?php if(!empty($medium_options['twitter'])) { echo esc_url($medium_options['twitter']); } ?>" placeholder="http://www.twitter.com/username/" size="32" />
                </div>
                <div class="ft-control">
              		<div class="explain"><?php _e('Google Plus profile','medium') ?></div>                
                  	 <input id="googleplus" name="medium_theme_options[googleplus]" type="text" value="<?php if(!empty($medium_options['googleplus'])) { echo esc_url($medium_options['googleplus']); } ?>" placeholder="https://plus.google.com/username/" size="32" />
                </div>
                <div class="ft-control">
