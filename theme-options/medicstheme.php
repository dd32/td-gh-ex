...
<div class="medicstheme-themes">
  ...
  <div class="medicstheme-header">
    <div class="logo">
      <?php $medics_image=get_template_directory_uri().'/theme-options/images/logo.png';
		echo "<a href='http://fasterthemes.com' target='_blank'><img src='".$medics_image."' alt='medicstheme' /></a>"; ?>
    </div>
    <div class="header-right">
      <?php echo "<h1>". __( 'Theme Options', 'medics' ) . "</h1>"; 			
        ...
        $medics_options = get_option( 'medics_theme_options' ); ?>
          ...
          <div id="options-group-2" class="group faster-inner-tabs"> 
			<div id="section-fburl" class="section theme-tabs">
              ...
              <div class="faster-inner-tab-group active">
              	<div class="ft-control">
              		<div class="explain"><?php _e( 'Facebook profile or page URL i.e. ', 'medics' ); ?>http://facebook.com/username/</div>
                  <input id="fburl" class="of-input" name="medics_theme_options[fburl]" size="30" type="text" value="<?php if(!empty($medics_options['fburl'])) { echo esc_url($medics_options['fburl']); } ?>" />
                </div>                
              </div>
            </div>
            ...
            <div class="section theme-tabs theme-post">
              ...
              <div class="faster-inner-tab-group">
                ...
                <select name="medics_theme_options[post-category]" id="category">
                  <option value=""><?php _e('Select Category','medics'); ?></option>
                  <?php 
                	 $medics_args = array(
                	  'orderby' => 'name',
                	  'parent' => 0
