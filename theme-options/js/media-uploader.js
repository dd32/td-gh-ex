(function($) {
	$(document).ready(function() {
		...
		function avocation_add_file(event, selector) {
			...
			frame.on( 'select', function() {
				...
				selector.find('.remove-image, .remove-file').on('click', function() {
					avocation_remove_file( $(this).parents('.section') );
				});
			});
		...
		function avocation_remove_file(selector) {
			...
			selector.find('.upload-button').live('click', function() {
				avocation_add_file(event, $(this).parents('.section'));
			});
		}
