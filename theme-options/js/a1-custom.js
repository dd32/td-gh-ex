jQuery(document).ready(function ($) {
    ...
    (function ($) {
        var allPanels = $('.a1-inner-tabs .a1-inner-tab-group').hide();
        $('.a1-inner-tabs .a1-inner-tab-group.active').show();
        var allPanelsThis = $('.a1-inner-tabs .a1-inner-tab');
        $('.a1-inner-tabs .a1-inner-tab').click(function () {
            $this = $(this);
            $targetThis = $this;
            $target = $this.next();
