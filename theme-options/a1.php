...
function a1_options_validate($input) {
    ...
    $input['header-location'] = sanitize_text_field($input['header-location']);
...
function a1_framework_page() {
    ...
    <?php settings_fields('a1_options');
    $a1_options = get_option('a1_theme_options'); ?>
    		    <!-------------- Basic Settings----------------->
    		    <div id="options-group-1" class="group basicsettings a1-inner-tabs">           <div class="section theme-tabs theme-logo"> <a class="heading a1-inner-tab active" href="javascript:void(0)"><?php _e('Logo (Recommended Size', 'a1'); ?> : 100px * 62px)</a>
    			    <div class="a1-inner-tab-group active">
    				<div class="ft-control">
    				    <input id="logo-img" class="upload" type="text" name="a1_theme_options[logo]" value="<?php if (!empty($a1_options['logo'])) {
	...
	echo "</a>";
    			...
    			<div class="section theme-tabs theme-favicon"> <a class="heading a1-inner-tab" href="javascript:void(0)"><?php _e('Favicon', 'a1'); ?></a>
    				...
    				<div class="ft-control">
    				    <input id="favicon-img" class="upload" type="text" name="a1_theme_options[favicon]" value="<?php if (!empty($a1_options['favicon'])) {
	...
	echo"</a>";
    			...
    			<div id="section-header-location" class="section theme-tabs theme-colors theme-fonts"> <a class="heading a1-inner-tab" href="javascript:void(0)"><?php _e('Location', 'a1'); ?></a>
    			    <div class="a1-inner-tab-group">
    				<div class="ft-control">
    				    <div class="explain"></div>
    				    <input type="text" id="header-location" class="of-input" name="a1_theme_options[header-location]" size="32"  value="<?php if (!empty($a1_options['header-location'])) {
	echo esc_attr($a1_options['header-location']);
    } ?>">
    				</div>
    			    </div>
    			</div>
    			<div id="section-phone" class="section theme-tabs theme-colors theme-fonts"> <a class="heading a1-inner-tab" href="javascript:void(0)"><?php _e('Phone', 'a1'); ?></a>
    				...
    				<div class="ft-control">
    				    ...
    				    <input type="text" id="phone" class="of-input" name="a1_theme_options[phone]" size="32"  value="<?php if (!empty($a1_options['phone'])) {
	echo esc_attr($a1_options['phone']);
    			...
    			<div id="section-email" class="section theme-tabs theme-colors theme-fonts"> <a class="heading a1-inner-tab" href="javascript:void(0)"><?php _e('E-mail', 'a1'); ?></a>
    				...
    				<div class="ft-control">
    				    ...
    				    <input type="text" id="email" class="of-input" validType="email" name="a1_theme_options[email]" size="32"  value="<?php if (!empty($a1_options['email'])) {
	echo sanitize_email($a1_options['email']);
    			...
    			<div id="section-facebook" class="section theme-tabs"> <a class="heading a1-inner-tab" href="javascript:void(0)"><?php _e('Facebook Link', 'a1'); ?></a>
    				...
    				<div class="ft-control">
    				    ...
    				    <input id="facebook" class="of-input" name="a1_theme_options[fburl]" size="30" type="text" value="<?php if (!empty($a1_options['fburl'])) {
	echo esc_url($a1_options['fburl']);
    			...
    			<div id="section-twitter" class="section theme-tabs"> <a class="heading a1-inner-tab" href="javascript:void(0)"><?php _e('Twitter Link', 'a1'); ?></a>
    				...
    				<div class="ft-control">
    				    ...
    				    <input id="twitter" class="of-input" name="a1_theme_options[twitter]" type="text" size="30" value="<?php if (!empty($a1_options['twitter'])) {
	echo esc_url($a1_options['twitter']);
    			...
    			<div id="section-pinterest" class="section theme-tabs"> <a class="heading a1-inner-tab" href="javascript:void(0)"><?php _e('Pinterest Link', 'a1'); ?></a>
    				...
    				<div class="ft-control">
    				    ...
    				    <input id="pinterest" class="of-input" name="a1_theme_options[pinterest]" type="text" size="30" value="<?php if (!empty($a1_options['pinterest'])) {
	echo esc_url($a1_options['pinterest']);
    			...
    			<div id="section-googleplus" class="section theme-tabs"> <a class="heading a1-inner-tab" href="javascript:void(0)"><?php _e('Google+ Link', 'a1'); ?></a>
    				...
    				<div class="ft-control">
    				    ...
    				    <input id="googleplus" class="of-input" name="a1_theme_options[googleplus]" type="text" size="30" value="<?php if (!empty($a1_options['googleplus'])) {
	echo esc_url($a1_options['googleplus']);
    			...
    			<div id="section-footertext" class="section theme-tabs"> <a class="heading a1-inner-tab active" href="javascript:void(0)"><?php _e('Copyright Text', 'a1'); ?></a>
    				...
    				<div class="ft-control">
    				    ...
    				    <input type="text" id="footertext" class="of-input" name="a1_theme_options[footertext]" size="32"  value="<?php if (!empty($a1_options['footertext'])) {
	echo esc_attr($a1_options['footertext']);
    			...
    			<div class="section theme-tabs theme-content"> <a class="heading a1-inner-tab" href="javascript:void(0)"><?php _e('Content', 'a1'); ?></a>
    				...
    				<div class="ft-control">
    				    ...
    				    <textarea name="a1_theme_options[footer-content]" rows="6" id="footer-content" class="of-input"><?php if (!empty($a1_options['footer-content'])) {
				...
				<div class="section theme-tabs theme-slider-img"> <a class="heading a1-inner-tab" href="javascript:void(0)"><?php _e('Slider', 'a1'); ?> <?php echo $a1_i; ?></a>
					...
					<div class="ft-control">
					    <input id="slider-img-<?php echo $a1_i; ?>" class="upload" type="text" name="a1_theme_options[slider-img-<?php echo $a1_i; ?>]" 
						   value="<?php if (!empty($a1_options['slider-img-' . $a1_i])) {
	...
	<?php if (!empty($a1_options['slider-img-' . $a1_i])) {
	    ...
	    echo "</a>";
					...
					<div class="ft-control">
					    <input type="text" placeholder="<?php _e('Slide Caption', 'a1'); ?>" id="slidecaption-<?php echo $a1_i; ?>" class="of-input" name="a1_theme_options[slidecaption-<?php echo $a1_i; ?>]" size="32"  value="<?php if (!empty($a1_options['slidecaption-' . $a1_i])) {
	    echo esc_attr($a1_options['slidecaption-' . $a1_i]);
	} ?>">
					</div>
					<div class="ft-control">
					    <input type="text" placeholder="<?php _e('Slide Button Text', 'a1'); ?>" id="slidebuttontext-<?php echo $a1_i; ?>" class="of-input" name="a1_theme_options[slidebuttontext-<?php echo $a1_i; ?>]" size="32"  value="<?php if (!empty($a1_options['slidebuttontext-' . $a1_i])) {
	    echo esc_attr($a1_options['slidebuttontext-' . $a1_i]);
	} ?>">
					</div>
					<div class="ft-control">
					    <input type="text" placeholder="<?php _e('Slide Button Link', 'a1'); ?>" id="slidebuttonlink-<?php echo $a1_i; ?>" class="of-input" name="a1_theme_options[slidebuttonlink-<?php echo $a1_i; ?>]" size="32"  value="<?php if (!empty($a1_options['slidebuttonlink-' . $a1_i])) {
    ...
    <?php endfor; ?>
    			...
    			<div id="section-coretitle" class="section theme-tabs"> <a class="heading a1-inner-tab" href="javascript:void(0)"><?php _e('Title', 'a1'); ?></a>
    				...
    				<div class="ft-control">
    				    ...
    				    <input id="coretitle" class="of-input" name="a1_theme_options[coretitle]" type="text" size="50" value="<?php if (!empty($a1_options['coretitle'])) {
    			...
    			<div class="section theme-tabs theme-short_description"> <a class="heading a1-inner-tab" href="javascript:void(0)"><?php _e('Caption', 'a1'); ?></a>
    				...
    				<div class="ft-control">
    				    ...
    				    <textarea name="a1_theme_options[corecaption]" rows="6" id="corecaption1" class="of-input"><?php if (!empty($a1_options['corecaption'])) {
    ...
    <?php for ($a1_section_i = 1; $a1_section_i <= 3; $a1_section_i++): ?>
				<div class="section theme-tabs theme-slider-img"> <a class="heading a1-inner-tab" href="javascript:void(0)"><?php _e('Tab', 'a1'); ?> <?php echo $a1_section_i; ?></a>
				    <div class="a1-inner-tab-group">
					<div class="ft-control">
					    <input id="first-image-<?php echo $a1_section_i; ?>" class="upload" type="text" name="a1_theme_options[home-icon-<?php echo $a1_section_i; ?>]" value="<?php if (!empty($a1_options['home-icon-' . $a1_section_i])) {
	    echo esc_url($a1_options['home-icon-' . $a1_section_i]);
	} ?>" placeholder="<?php _e('No file chosen', 'a1'); ?>" />
					    <input id="upload_image_button" class="upload-button button" type="button" value="<?php _e('Upload', 'a1'); ?>" />
					    <div class="screenshot" id="first-img-<?php echo $a1_section_i; ?>">
	<?php if (!empty($a1_options['home-icon-' . $a1_section_i])) {
	    ...
	    echo "</a>";
					...
					<div class="ft-control">
					    ...
					    <input type="text" placeholder="<?php _e('Enter title here', 'a1'); ?>" id="title-<?php echo $a1_section_i; ?>" class="of-input" name="a1_theme_options[section-title-<?php echo $a1_section_i; ?>]" size="32"  value="<?php if (!empty($a1_options['section-title-' . $a1_section_i])) {
					...
					<div class="ft-control">
					    ...
					    <textarea name="a1_theme_options[section-content-<?php echo $a1_section_i; ?>]" rows="6" id="content-<?php echo $a1_section_i; ?>" placeholder="<?php _e('Enter Content here', 'a1'); ?>" class="of-input"><?php if (!empty($a1_options['section-content-' . $a1_section_i])) {
    ...
    <?php endfor; ?>
    			...
    			<div id="section-producttitle" class="section theme-tabs"> <a class="heading a1-inner-tab" href="javascript:void(0)"><?php _e('Title', 'a1'); ?></a>
    				...
    				<div class="ft-control">
    				    ...
    				    <input id="producttitle" class="of-input" name="a1_theme_options[producttitle]" type="text" size="50" value="<?php if (!empty($a1_options['producttitle'])) {
	echo esc_attr($a1_options['producttitle']);
    			...
    			<div class="section theme-tabs theme-short_description"> <a class="heading a1-inner-tab" href="javascript:void(0)"><?php _e('Caption', 'a1'); ?></a>
    				...
    				<div class="ft-control">
    				    ...
    				    <textarea name="a1_theme_options[productcaption]" rows="6" id="productcaption1" class="of-input"><?php if (!empty($a1_options['productcaption'])) {
    ...
    ?> 
    			...
    			<div class="section theme-tabs theme-short_description"> <a class="heading a1-inner-tab" href="javascript:void(0)"><?php _e('Form E-mail', 'a1'); ?></a>
    				...
    				<div class="ft-control">
    				    ...
    				    <input id="product-form-email" class="of-input" name="a1_theme_options[product-form-email]" type="text" size="50" value="<?php if (!empty($a1_options['product-form-email'])) {
	echo sanitize_email($a1_options['product-form-email']);
    			...
    			<div id="section-get-touch-title" class="section theme-tabs"> <a class="heading a1-inner-tab" href="javascript:void(0)"><?php _e('Title', 'a1'); ?></a>
    				...
    				<div class="ft-control">
    				    ...
    				    <input id="get-touch-title" class="of-input" name="a1_theme_options[get-touch-title]" type="text" size="50" value="<?php if (!empty($a1_options['get-touch-title'])) {
	echo esc_attr($a1_options['get-touch-title']);
    			...
    			<div class="section theme-tabs theme-get-touch"> <a class="heading a1-inner-tab" href="javascript:void(0)"><?php _e('Caption', 'a1'); ?></a>
    				...
    				<div class="ft-control">
    				    ...
    				    <textarea name="a1_theme_options[get-touch-caption]" rows="6" id="get-touch-caption1" class="of-input"><?php if (!empty($a1_options['get-touch-caption'])) {
	echo esc_attr($a1_options['get-touch-caption']);
    			...
    			<div class="section theme-tabs theme-get-touch-logo"> <a class="heading a1-inner-tab" href="javascript:void(0)"><?php _e('Get in Touch Logo', 'a1'); ?></a>
    			    <div class="a1-inner-tab-group">
    				<div class="ft-control">
    				    <input id="get-touch-logo-img" class="upload" type="text" name="a1_theme_options[get-touch-logo]" value="<?php if (!empty($a1_options['get-touch-logo'])) {
	echo esc_url($a1_options['get-touch-logo']);
    } ?>" placeholder="<?php _e('No file chosen', 'a1'); ?>" />
    				    <input id="upload_image_button" class="upload-button button" type="button" value="<?php _e('Upload', 'a1'); ?>" />
    				    <div class="screenshot" id="get-touch-logo-image">
    <?php if (!empty($a1_options['get-touch-logo'])) {
	...
	echo "</a>";
    			...
    			<div id="section-contactus-now" class="section theme-tabs"> <a class="heading a1-inner-tab" href="javascript:void(0)"><?php _e('Button Text', 'a1'); ?></a>
    				...
    				<div class="ft-control">
    				    ...
    				    <input id="contactus-now-text" class="of-input" name="a1_theme_options[contactus-now-text]" type="text" size="50" value="<?php if (!empty($a1_options['contactus-now-text'])) {
	echo esc_attr($a1_options['contactus-now-text']);
    			...
    			<div id="section-contactus-now" class="section theme-tabs"> <a class="heading a1-inner-tab" href="javascript:void(0)"><?php _e('Contact Link', 'a1'); ?></a>
    				...
    				<div class="ft-control">
    				    ...
    				    <input type="text" class="of-input" size="50" name="a1_theme_options[get-touch-page]" value="<?php if (!empty($a1_options['get-touch-page'])) {
	echo $a1_options['get-touch-page'];
    			...
    			<div id="section-blogtitle" class="section theme-tabs"> <a class="heading a1-inner-tab active" href="javascript:void(0)"><?php _e('Blog Title', 'a1'); ?></a>
    			    <div class="a1-inner-tab-group active">
    				<div class="ft-control">
    				    <input type="text" id="blogtitle" class="of-input" name="a1_theme_options[blogtitle]" size="32"  value="<?php if (!empty($a1_options['blogtitle'])) {
	echo esc_attr($a1_options['blogtitle']);
    			...
    			<div id="section-entry-meta-by" class="section theme-tabs"> <a class="heading a1-inner-tab" href="javascript:void(0)"><?php _e('Entry meta by word', 'a1'); ?></a>
    				...
    				<div class="ft-control">
    				    ...
    				    <input id="entry-meta-by" class="of-input" name="a1_theme_options[entry-meta-by]" type="text" size="50" value="<?php if (!empty($a1_options['entry-meta-by'])) {
	echo esc_attr($a1_options['entry-meta-by']);
    			...
    			<div id="section-entry-meta-in" class="section theme-tabs"> <a class="heading a1-inner-tab" href="javascript:void(0)"><?php _e('Entry meta in word', 'a1'); ?></a>
    				...
    				<div class="ft-control">
    				    ...
    				    <input id="entry-meta-in" class="of-input" name="a1_theme_options[entry-meta-in]" type="text" size="50" value="<?php if (!empty($a1_options['entry-meta-in'])) {
	echo esc_attr($a1_options['entry-meta-in']);
    			...
    			<div id="section-entry-meta-on" class="section theme-tabs"> <a class="heading a1-inner-tab" href="javascript:void(0)"><?php _e('Entry meta on word', 'a1'); ?></a>
    				...
    				<div class="ft-control">
    				    ...
    				    <input id="entry-meta-on" class="of-input" name="a1_theme_options[entry-meta-on]" type="text" size="50" value="<?php if (!empty($a1_options['entry-meta-on'])) {
	echo esc_attr($a1_options['entry-meta-on']);
    			...
    			<div id="section-entry-meta-comments" class="section theme-tabs"> <a class="heading a1-inner-tab" href="javascript:void(0)"><?php _e('Entry meta comments word', 'a1'); ?></a>
    				...
    				<div class="ft-control">
    				    ...
    				    <input id="entry-meta-comments" class="of-input" name="a1_theme_options[entry-meta-comments]" type="text" size="50" value="<?php if (!empty($a1_options['entry-meta-comments'])) {
	echo esc_attr($a1_options['entry-meta-comments']);
    			...
    			<div id="section-entry-meta-tags" class="section theme-tabs"> <a class="heading a1-inner-tab" href="javascript:void(0)"><?php _e('Entry meta tags word', 'a1'); ?></a>
    				...
    				<div class="ft-control">
    				    ...
    				    <input id="entry-meta-tags" class="of-input" name="a1_theme_options[entry-meta-tags]" type="text" size="50" value="<?php if (!empty($a1_options['entry-meta-tags'])) {
