...
if ( ! class_exists( 'Best_Business_Widget_Helper' ) ) {
			...
			switch ( $type ) {
				...
				case 'image':
					...
					<div class="widget-field-image">
						<label for="<?php echo esc_attr( $this->get_field_id( $key ) ); ?>"><?php echo esc_html( $field['label'] ); ?></label>
						<input type="button" class="button button-primary wh-image-picker" value="<?php esc_attr_e( 'Upload', 'best-business' ); ?>" data-uploader_title="<?php esc_attr_e( 'Select Image', 'best-business' ); ?>" data-uploader_button_text="<?php esc_attr_e( 'Choose Image', 'best-business' ); ?>" />
						...
						<input type="button" class="button button-secondary btn-image-remove" value="<?php esc_attr_e( 'Remove', 'best-business' ); ?>" <?php echo ( empty( $value ) ) ? 'style="display:none;"' : ''; ?> />
