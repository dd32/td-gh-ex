...
final class Example_1_Customize {
	...
	public function enqueue_control_scripts() {
		...
		wp_enqueue_script( 'example-1-customize-controls', trailingslashit( get_template_directory_uri() ) . 'share/customizer-pro/customize-controls.js', array( 'customize-controls' ) );

		wp_enqueue_style( 'example-1-customize-controls', trailingslashit( get_template_directory_uri() ) . 'share/customizer-pro/customize-controls.css' );
	}
}
