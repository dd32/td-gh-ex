		...
		if($elitepress_current_options['header_social_media_enabled']==true) { ?>
			<div class="col-md-6">
				<ul class="head-contact-social">
					...
					<?php }
					if($elitepress_current_options['social_media_googleplus_link']!='') { ?>
					<li class="googleplus"><a href="<?php echo esc_url($elitepress_current_options['social_media_googleplus_link']); ?>" <?php if($elitepress_current_options['google_media_link_target']==true){ echo "target='_blank'"; } ?> ><i class="fa fa-google-plus"> </i></a></li>
					<?php }
