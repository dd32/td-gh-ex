<?php
/**
 * Template Name: Home Boxed Template
 *
...
<body class="boxed" style="background: url(http://accesspressthemes.com/accesspress-root/wp-content/themes/accesspress-root/inc/panel/images/patterns/pattern5.png) repeat;">
<div id="outer-wrap">
<div id="inner-wrap"> 
	...
	<header id="masthead" class="site-header">
		<div class="ak-container">
			...
			<?php if(of_get_option('logo_setting') == 'image' || of_get_option('logo_setting') == 'image_text') : 
				...
				<a class="site-logo" href="<?php echo esc_url( home_url( '/' ) ); ?>"><img src="<?php echo of_get_option('logo'); ?>" alt="<?php bloginfo( 'name' ); ?>"/> </a> 
			<?php endif;
			endif;
