...
<div class="entry-meta">
								...
								printf( __( '<span class="meta-prep meta-prep-entry-date">Published </span> <span class="entry-date"><time class="entry-date" datetime="%1$s">%2$s</time></span> at <a href="%3$s" title="Link to full-size image">%4$s &times; %5$s</a> in <a href="%6$s" title="Return to %7$s" rel="gallery">%8$s</a>.', 'optimize' ),
							...
							?>
								<?php edit_post_link( __( 'Edit', 'optimize' ), '<span class="edit-link">', '</span>' ); ?>
								</div><!-- .entry-meta -->
...
?>
								...
								$attachment_size = apply_filters( 'optimize_attachment_size', array( 960, 960 ) );
...
<span class="postmeta_box">
		<ul class="auth"> <?php optimize_post_meta_data(); ?>, in <?php the_category(', '); ?>
</ul>
<ul class="tags">			
