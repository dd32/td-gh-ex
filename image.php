			...
			?>
				...
				<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
					...
					<nav id="image-navigation" class="navigation image-navigation">
						<div class="nav-links">
							<div class="nav-previous"><?php previous_image_link( false, __( 'Previous Image', 'antonine' ) ); ?></div><div class="nav-next"><?php next_image_link( false, __( 'Next Image', 'antonine' ) ); ?></div>
						</div><!-- .nav-links -->
					...
					<div class="entry-content">
						...
						<div class="entry-attachment">
							<?php
								 ...
								 */
								$image_size = apply_filters( 'antonine_attachment_size', 'large' );
