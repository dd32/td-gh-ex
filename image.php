                ...
                <article id="post-<?php the_ID(); ?>" <?php post_class('image-attachment'); ?>>
                    <header class="post-header">
                        ...
                        <nav id="image-navigation" class="navigation">
                            <span class="previous-image"><?php previous_image_link( false, __('&larr; Previous', 'rockers')); ?></span>
                            <span class="next-image"><?php next_image_link( false, __('Next &rarr;', 'rockers')); ?></span>
                        </nav>
                    </header>
