	...
	<div class="flexslider et_slider_auto et_slider_speed_7000" id="featured">		
		<ul class="slides">
			<li class="slide flex-active-slide">
				...
				<h2><a href="#"><?php echo $current_options['slider_title']; ?></a></h2><br>
				<?php } if($current_options['slider_description']) { ?>
				<div class="description"><?php echo $current_options['slider_description']; ?></div>
				<?php } if($current_options['slider_image']) { ?>
				<img style="width:1140px; height:420px;" alt="Sleek &amp; Beautiful" src="<?php echo $current_options['slider_image']; ?>">
				<?php } ?>
			</li> <!-- end .slide -->				
		</ul>	
	</div>
