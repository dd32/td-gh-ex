...
class Typography {
	...
	public function __construct() {
		$this->font_options = apply_filters( 'aamla_typography_controls', [
			'primary'   => [
	...
	/**
	 * Add typography specific customizer section.
	 *
	 * @since 1.0.1
	 *
	...
	public function add_sections( $sections = [] ) {
		return array_merge( $sections,
			[
				'aamla_typography_section' =>
				[
					'title' => esc_html__( 'Typography', 'aamla' ),
	...
	/**
	 * Add typography specific customizer controls and settings.
	 *
	 * @since 1.0.1
	 *
		...
		$controls = array_merge( $controls,
			[
				[
					...
					'section' => 'aamla_typography_section',
	...
	/**
	 * Set default values for typography customization options.
	 *
	 * @since 1.0.1
	 *
	...
	/**
	 * Add path to typoraphy custom control class.
	 *
	 * @since 1.0.1
	 *
	...
	public function control_path( $path, $setting ) {
		...
		if ( in_array( $setting, $arr, true ) ) {
			$path = get_template_directory() . '/add-on/typography/class-customize-google-fonts.php';
		}
	...
	/**
	 * Sanitize typography customizer options.
	 *
	 * @since 1.0.1
	 *
	...
	public function get_google_sans_fonts() {
		if ( empty( $this->google_sans_fonts ) ) {
			require_once get_template_directory() . '/add-on/typography/admin/google-fonts.php';
