			...
			<section id="cta-banner" class="clearfix">
				<div class="ak-container">
					...
					<div class="cta-banner-btn">
						<a href="<?php echo esc_url($call_to_action_link); ?>"><?php echo esc_html($call_to_action_button_text); ?></a>
					</div>
					<?php endif; ?>
				</div>
			</section> <!-- cta-simple -->
					...
					if($query->have_posts()):
						...
						<div class="widget-block">
							<div class="info-block-wrap">
								...
								<a class="info-read-more" href="<?php the_permalink(); ?>"><?php echo esc_html(of_get_option('project_readmore')); ?></a>
							</div>
						</div> <!-- widget-block -->
						<?php
						endwhile;
					...
					<?php 
						...
						<?php
							while($query->have_posts()):
								$query->the_post();
							?>
							<a id="testimonial-<?php the_ID(); ?>" class="testimonial-thumb" href="#">
							<?php 
							if(has_post_thumbnail()):
						...
						<?php
							while($query->have_posts()):
								$query->the_post();
							?>
							<div class="testimonail-content testimonial-<?php the_ID() ?>"> 
