...
<div id="control-portfolio">
   ...
   <div class="row">
        <!-- Column 1 -->
          <?php
	          $portfolio_c_1_cat = esc_attr( get_theme_mod('avik_portfolio_c_1_category'));
        ...
        <div class="col-md-4 col-ms-6 column 1 tabcontent">
          <div class="content avik-portfolio">
           <a href="<?php the_permalink();?>">
              ...
              echo esc_attr($avik_image_attributes[0]); else: echo get_template_directory_uri().'/images/avik-default.jpg'; endif; ?>"/></a>
          </div>
          </div>             
          <?php endwhile; 
            wp_reset_query();
  ...
  <section class="contact" id="contact">
     <div class="row paddong-contact">
       ...
       <div class="col-lg-6 address">
         <?php
	       $contact_cat = esc_attr( get_theme_mod('avik_contact_category'));
	       $contact_count =1;
