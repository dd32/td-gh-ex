...
<div id="carouselSection" class="cntr"> 
		<div id="myCarousel" class="carousel slide">
			...
			<div class="carousel-inner">
				...
				<div class="item active" style="background-image:url( <?php  $options = get_option( 'arinio_theme_options' );  if($options['slide1image'] != '') { echo $options['slide1image']; }else{ echo get_template_directory_uri(); echo '/img/slide4.jpg'; } ?>);">
