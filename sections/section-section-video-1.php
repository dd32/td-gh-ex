    ...
    <div class="row">
      <div class="col-md-8 col-md-offset-2 col-sm-12 col-xs-12">
        <div class="video-content">
          ...
          <h2 class="section-title <?php echo $avata_animation;?>" style="font-size: 32px;font-weight: 400;" data-os-animation="fadeInUp" data-os-animation-delay="<?php echo $avata_animation_delay;?>"><?php echo wp_kses($section_title, $allowedposttags);?></h2>
          <p class="section-subtitle text-center <?php echo $avata_animation;?>" data-os-animation="fadeInUp" data-os-animation-delay="<?php echo $avata_animation_delay;?>"><?php echo wp_kses($section_subtitle, $allowedposttags);?></p>
        </div>
      </div>
    </div>
  </div>
