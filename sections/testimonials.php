							...
							<?php while( $jetpack_testimonials_query->have_posts() ): $jetpack_testimonials_query->the_post(); ?>
								<div class="item">
									<div class="testimonials-item">
										<div class="ot-testimonials-text"><p><?php echo asterion()->customizer->sanitize_html(get_the_content());?></p></div>
										<div class="ot-testimonials-image"><?php the_post_thumbnail( $post->ID, 'asterion-portfolio' ); ?></div>
										<h3><?php the_title(); ?></h3>
									</div>
								</div>
							<?php endwhile; ?>
