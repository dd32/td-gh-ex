<div class="container">
    ...
    <div class="row">
    	...
    	<?php echo do_action('avventura_lite_searched_item', 'off'); ?>
		...
		?>
			...
			<div class="post-container col-md-12" >
                ...
                <article class="post-article not-found">
                	...
                	<p><?php esc_html_e( 'Sorry, no posts matched your criteria', 'avventura-lite' ) ?> <strong>: <?php echo esc_attr($s); ?> </strong></p>
