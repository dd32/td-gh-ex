              ...
              <?php $args = array( 'posts_per_page' => 2, 'post__not_in' => get_option('sticky_posts'), 'orderby' => 'date', 'order' => 'desc' );
                    ...
                    <?php while( $postquery->have_posts() ) : $postquery->the_post(); ?>
                        <div class="recent-post">
                            ...
                            <p><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a><br/><?php the_excerpt(); ?></p> 
                            <a class="morebtn" href="<?php echo esc_url( get_permalink() ); ?>"><?php esc_html_e('Read More','adventure-lite'); ?></a>                                              
                        </div>
                    <?php endwhile; ?>
...
<?php $about_title = get_theme_mod('about_title'); ?>	
         ...
         <div class="copyright-wrapper">
        	<div class="container">
            	 ...
            	 <div class="design-by"><?php printf('<a target="_blank" href="'.esc_url(SKTTHEMES_FREE_THEME_URL).'" rel="nofollow">Adventure Lite</a>' ); ?></div>
                 <div class="clear"></div>
            </div>           
        </div>
