...
<footer>
		 ...
		 */
			...
			$copyrighttxt = ! empty($copyrighttxt) ? $copyrighttxt : __('&copy; ', 'aadya') . __(date('Y')) . sprintf(' <a href="%1$s" title="%2$s" rel="home">%3$s</a>', esc_url(home_url( '/' )), get_bloginfo( 'name' ), get_bloginfo( 'name' ));
...
<div id="footer">
  <div class="container footer-nav">	
	...
	<p class="text-muted credit"><?php echo $copyrighttxt;?> <?php echo aadya_get_branding();?> </p>
	</div> 	
