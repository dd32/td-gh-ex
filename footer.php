...
?>
	...
	<footer id="colophon" class="site-footer" role="contentinfo">
		<div class="site-info smallPart">
			...
			<span class="sep"> | </span>
			<?php printf( __( 'Theme: %1$s by %2$s.', 'zenzero' ), 'Zenzero', '<a target="_blank" href="http://crestaproject.com/downloads/zenzero/" rel="nofollow" title="CrestaProject">CrestaProject</a>' ); ?>
		</div><!-- .site-info -->
