...
<a href="#" class="back-to-top <?php echo $canshow; ?>" rel="nofollow">
...
if ( $num_widget !== 0 ) {
    ...
    <div class="footer-widgets-area">
        <div class="<?php echo AttireThemeEngine::NextGetOption( 'footer_widget_content_layout_type', 'container' ) ?> footer-widgets-outer">
