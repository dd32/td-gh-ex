...
?>
    <?php if( get_theme_mod( 'automobile_car_dealer_hide_show_scroll',true) != '') { ?>
        ...
        <?php }else if($automobile_car_dealer_theme_lay == 'Center align'){ ?>
    ...
    <footer role="contentinfo">
        <?php //Set widget areas classes based on user choice
            ...
            if ($automobile_car_dealer_widget_areas == '3') {
                $cols = 'col-md-4';
            } elseif ($automobile_car_dealer_widget_areas == '4') {
                $cols = 'col-md-3';
            } elseif ($automobile_car_dealer_widget_areas == '2') {
                $cols = 'col-md-6';
            } else {
                $cols = 'col-md-12';
            }
