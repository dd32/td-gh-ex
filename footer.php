	...
	<footer>
		<div class="copyright">
			...
			| Theme <a href="<?php echo esc_url( __( 'http://hjyl.org/', 'olo' ) ); ?>" title="designed by hjy.org">olo</a><?php if (get_option('olo_icp')!='') { ?>. <?php echo esc_attr(get_option('olo_icp')); ?><?php } ?></p>
		</div>
