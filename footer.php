...
?>
 ...
 <footer id="colophon" class="footer_area"> 
            <div class="<?php if ( false == esc_attr(get_theme_mod('atomy_enable_full_width_footer', true) )):?>container-fluid pl-0 pr-0 <?php endif;?> <?php if ( true == esc_attr(get_theme_mod('atomy_enable_full_width_footer', true) )):?><?php echo esc_attr( get_theme_mod( 'atomy_enable_full_width_body','container') )?><?php endif;?>">
                    ...
                    <h5>
                      <?php if ( false == esc_attr( get_theme_mod( 'at_enable_copyright_footer', false) )) : ?>
                       ...
                       <span>
                        ...
                        <?php  echo esc_html('By Franchi Design','atomy');?></a>
                       </span>
                    </h5>
                    </div>
                </div>
