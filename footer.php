<?php $arjunaOptions = get_option('arjuna_options'); ?>
	...
	<div class="<?php if($arjunaOptions['footerStyle']=='style1'): ?>footer<?php else: ?>footer2<?php endif; ?>">
		...
		<a href="http://www.srssolutions.com/en/" class="icon2"><img src="<?php bloginfo('template_url'); ?>/images/<?php if($arjunaOptions['footerStyle']=='style1'): ?>srsIcon.png<?php else: ?>srsIcon2.jpg<?php endif; ?>" width="18" height="30" alt="Web Design by SRS Solutions" /></a>
