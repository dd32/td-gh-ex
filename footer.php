             ...
             <div class="row copyright" >
                ...
                <div class="col-md-12" >
                    ...
                    <p>
                    	...
                    	<?php if (avventura_lite_setting('avventura_lite_copyright_text')): ?>
                    		<?php echo wp_filter_post_kses(avventura_lite_setting('avventura_lite_copyright_text')); ?>
                    	<?php else: ?>
                    		<?php esc_html_e('Copyright','avventura-lite'); ?> <?php echo get_bloginfo("name"); ?> <?php echo date_i18n("Y"); ?> 
                    	<?php endif; ?> 
                    	| <?php esc_html_e('Theme by ','avventura-lite'); ?><a href="<?php echo esc_url('https://www.themeinprogress.com/'); ?>" target="_blank">ThemeinProgress</a> |
