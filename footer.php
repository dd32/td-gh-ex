...
<div class="footer_section">
	...
	<?php if($wallstreet_current_options['footer_social_media_enabled'] == true) { 
			if($wallstreet_current_options['social_media_twitter_link'] !='' || $wallstreet_current_options['social_media_facebook_link'] !='' || $wallstreet_current_options['social_media_googleplus_link'] !='' ||  $wallstreet_current_options['social_media_linkedin_link'] !='' || $wallstreet_current_options['social_media_youtube_link'] !='' || $wallstreet_current_options['social_media_instagram_link'] !='' ) { ?>
