<!-- Footer Section -->
<?php
$appointment_blue_footer_setting = wp_parse_args(get_option('appointment_options', array()), appointment_blue_default_data());
            ...
            if ($appointment_blue_footer_setting['footer_social_media_enabled'] == 0) {
                ...
                <div class="col-md-4">
                    <ul class="footer-contact-social">
                        <?php if ($appointment_blue_footer_setting['footer_social_media_facebook_link'] != '') { ?>
                            <li class="facebook"><a href="<?php echo esc_url($appointment_blue_footer_facebook); ?>" <?php
                                if ($appointment_blue_footer_setting['footer_facebook_media_enabled'] == 1) {
                                    echo "target='_blank'";
                                }
                                ?> ><i class="fa fa-facebook"></i></a></li>
                                                <?php } if ($appointment_blue_footer_setting['footer_social_media_twitter_link'] != '') { ?>
                            <li class="twitter"><a href="<?php echo esc_url($appointment_blue_footer_twitter); ?>" <?php
                                if ($appointment_blue_footer_setting['footer_twitter_media_enabled'] == 1) {
                                    echo "target='_blank'";
                                }
                                ?> ><i class="fa fa-twitter"></i></a></li>
                                               <?php } if ($appointment_blue_footer_setting['footer_social_media_linkedin_link'] != '') { ?>
                            <li class="linkedin"><a href="<?php echo esc_url($appointment_blue_footer_linkdin); ?>" <?php
                                if ($appointment_blue_footer_setting['footer_linkedin_media_enabled'] == 1) {
                                    echo "target='_blank'";
                                }
