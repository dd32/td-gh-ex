...
?>
		...
		<footer id="footer" role="contentinfo">
			<div class="container">
				...
				<div class="copyright">
					<span id="abc-custom-copyright" class="pull-left"><?php echo apply_filters( 'abacus_footer_notice', sprintf( __( 'Copyright &copy; %1$s %2$s. All Rights Reserved.', 'abacus' ), date( 'Y' ), ' <a href="' . home_url() . '">' . get_bloginfo( 'name' ) .'</a>' ) ); ?></span>
