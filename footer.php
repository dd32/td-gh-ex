			...
			<div class="container">
				<footer id="colophon" class="site-footer row align-items-center" role="contentinfo">
					...
					<div class="col-md-4 site-info self-align-last text-right">
						<h6 class="mb-0"><?php echo wp_kses_post( get_theme_mod( 'bani_footer_text_right', __( '<a href="https://themes.salttechno.com/">WordPress Blog Themes</a> by SALT TECHNO', 'bani' ) ) ); ?></h6>
					</div><!-- .site-info -->
				</footer><!-- #colophon -->
			</div>
			<!-- /.container -->
