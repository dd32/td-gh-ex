    ...
    <div class="container jobile-container">
        <div class="row">
            ...
            <div class="col-md-3 footer-column4 clearfix col-xs-12 col-sm-6 ">
				<?php if(is_active_sidebar( 'footer-area-4' )) : dynamic_sidebar('footer-area-4'); endif; ?>
            </div>
        </div>
    </div>
    <div class="col-md-12 no-padding-lr footer-bottom">
        <div class="container jobile-container">
            <p class="text-left">Powered by <a target="_blank" href="http://wordpress.org">WordPress</a> and <a target="_blank" href="http://fasterthemes.com/wordpress-themes/Jobile">Jobile</a>.</p>
            <p class="text-right"><?php if(!empty($jobile_options['footertext'])) { echo esc_attr($jobile_options['footertext']); } ?></p>
        </div>    
    </div>
</footer>
<?php wp_footer(); ?>
