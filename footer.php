  ...
  <div class="container">
    <div class="row">
      <?php 
		...
		if($options['fburl'] != ''){ $facebook_link = $options['fburl']; }else{ $facebook_link = 'https://www.facebook.com/faster.themes'; }
		if($options['twitter'] != ''){ $twitter_link = $options['twitter']; }else{ $twitter_link = 'https://twitter.com/FasterThemes'; }
		?>
