<div id="footer">
	...
	<p><a href="<?php echo home_url( '/' ); ?>" title="<?php bloginfo ('name');?>"><?php bloginfo ('name');?></a> <?php _e('powered by','undedicated'); ?> <a href="http://www.wordpress.org"><?php _e('WordPress','undedicated'); ?></a> and <a href="http://www.speckygeek.com/undedicated-minimal-wordpress-theme/" title="Undedicated WordPress theme"><?php _e('Undedicated','undedicated'); ?></a>.</p>
</div><!--#footer-->
