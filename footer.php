...
?>
	...
	<footer id="colophon" class="site-footer" role="contentinfo">
		<div class="site-info">
			...
			<span class="sep"> | </span>
			<?php printf( __( '%1$s by %2$s.', 'semplicemente' ), 'Semplicemente', '<a title="Premium WP Themes" href="http://crestaproject.com/" rel="designer" target="_blank">Cresta Project Wordpress Themes</a>' ); ?>
		</div><!-- .site-info -->
	</footer><!-- #colophon -->
</div><!-- #page -->
