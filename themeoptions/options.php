...
Redux::setSection( $opt_name, array(
    ...
    'fields' => array(
       ...
       array(
            ...
            "subtitle" => __("Organize how you want the layout to appear on the homepage", 'ascend'),
            'options' => array(
              "disabled" => array(
                    "placebo" => "placebo",
...
Redux::setSection( $opt_name, array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'output'    => array('.footerclass a, .footerclass'),
            'transparent'=>false,
            'validate' => 'color',
            ),
      ),
    ...
    'fields' => array(
     	...
     	array(
      	...
      	array(
            ...
            'type' => 'switch', 
            'title' => __('Show Breadcrumbs on Pages & Archives?', 'ascend'),
            'subtitle' => __('Choose to show or hide breadcrumbs on your pages and categories', 'ascend'),
            "default" => 0,
            ),
      	array(
