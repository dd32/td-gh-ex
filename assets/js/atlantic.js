...
( function( $ ) {
	...
	$( document ).ready( function() {
		...
		$subMenu.before( '<button class="sub-menu-toggle" role="button" aria-expanded="false">' + Atlanticl10n.expandMenu + Atlanticl10n.collapseMenu + Atlanticl10n.subNav + '</button>' );
		...
		$masonryEntry.masonry({
			itemSelector: '.entry',
			columnWidth: '.entry'
		});

		$masonryWidget.masonry({
			itemSelector: '.widget',
			columnWidth: '.widget'
		});
	...
	$( window ).load(function(){
        ...
        $masonryEntry.masonry( 'reloadItems' );
