...
**/
	! function(t) {
	    ...
	    var r = function(t, r) {
	        ...
	        o = function(t, r) {
	            return t.css({
	                "background-position": -r + "px center"
	            })
	        },
	        n = function(t, r, o) {
	            return "none" !== o || (o = ""), t.css({
	                "-webkit-transform": "translateY(" + r + "px)" + o,
	                "-moz-transform": "translateY(" + r + "px)" + o,
	                transform: "translateY(" + r + "px)" + o,
	        ...
	        a = function(t, r, o) {
	            return "none" !== o || (o = ""), t.css({
	                "-webkit-transform": "translateX(" + r + "px)" + o,
	                "-moz-transform": "translateX(" + r + "px)" + o,
	                transform: "translateX(" + r + "px)" + o,
	                transition: "transform linear",
	                "will-change": "transform"
	            })
	        };
	    t.fn.paroller = function(e) {
	        ...
	        return this.each(function() {
	            var c = !1,
	                ...
	                l = u.offset().top,
	                f = u.outerHeight(),
	                d = u.data("paroller-factor"),
	                p = u.data("paroller-type"),
	                h = u.data("paroller-direction"),
	                m = d || e.factor,
	                g = p || e.type,
	                b = h || e.direction,
	                v = Math.round(l * m),
	                x = Math.round((l - i / 2 + f) * m),
	                w = u.css("transform");
	            "background" == g ? "vertical" == b ? r(u, v) : "horizontal" == b && o(u, v) : "foreground" == g && ("vertical" == b ? n(u, x, w) : "horizontal" == b && a(u, x, w));
	            var k = function() {
	                c = !1
	            };
	            t(window).on("scroll", function() {
	                if (!c) {
	                    ...
	                    s = t(document).height();
	                    var d = 0;
	                    "static" == t("#top-bar").css("position") && (d = t("#top-bar").outerHeight() / 2), v = Math.round((l - e) * m) - d, x = Math.round((l - i / 2 + f - e) * m), "background" == g ? "vertical" == b ? r(u, v) : "horizontal" == b && o(u, v) : "foreground" == g && e <= s && ("vertical" == b ? n(u, x, w) : "horizontal" == b && a(u, x, w)), window.requestAnimationFrame(k), c = !0
	                }
	            }).trigger("scroll")
	        })
	    }
