...
if ("undefined" == typeof jQuery) throw new Error("Bootstrap's JavaScript requires jQuery"); + function(a) {
    ...
    }, c.prototype.getItemForDirectiazon = function(a, b) {
...
jQuery(function() {
    jQuery("#owl-demo").owlCarousel({
        autoPlay: 3e3,
        singleItem: !0
    }), jQuery(".carousel .slider-content h1,.carousel .slider-content p,.carousel .slider-content a").addClass("wow")
    ...
    jQuery("#nav>ul").addClass("main-list"), jQuery("body").prepend('<div class="mobile-menu"></div>'), jQuery(".main-list").clone().appendTo(".mobile-menu"), jQuery(".mobile-menu ul.main-list > li").find("ul").before('<span class="dropdown"><i class="fa fa-angle-down"></i><i class="fa fa-angle-up"></i></div>'), jQuery(".dropdown").click(function(n) {
        ...
        return $(this).hasClass("isDown") ? jQuery(".mobile-menu").stop().animate({
            left: "-300px"
        }, 200) : jQuery(".mobile-menu").stop().animate({
            left: "0px"
        }, 200), $(this).toggleClass("isDown"), !1
...
function parallaxScroll() {
    ...
    jQuery('.parallax_div').css({
        'transform': 'translate(0px,-' + scrolled / 2 + 'px'
    });
    $('.parallax_div .slider-content,.flex-nav-prev,.flex-nav-next').css('opacity', 1 - (scrolled / 400))
}
jQuery(document).ready(function() {
    ...
    jQuery('article.post .gallery-slider .gallery').remove()
});
    ...
    if (windowWidth >= 1024) {
        jQuery(window).scroll(function() {
            ...
            if (yPos > 0) {
                ...
                jQuery('.parallax_slider_outer.first-header').css('margin-top', '62px');
                jQuery('.parallax_slider_outer.second-header').css('margin-top', '72px')
            } else {
                $("#header").removeClass('fixed');
                jQuery('.parallax_slider_outer.first-header,.parallax_slider_outer.second-header').css('margin-top', '0')
            }
        });
    }
});