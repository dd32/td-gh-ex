<?php
	...
	if($appointment_booking_first_color != false){
		$appointment_booking_custom_css .='a, .main-navigation .current_page_item > a, .main-navigation .current-menu-item > a, .main-navigation .current_page_ancestor > a, .main-navigation a:hover, .main-navigation ul.sub-menu a:hover, .main-navigation ul.sub-menu>li>a:before, #footer .textwidget a,#footer li a:hover,.post-main-box:hover h3 a,#sidebar ul li a:hover,.post-navigation a:hover .post-title, .post-navigation a:focus .post-title,.post-navigation a:hover,.post-navigation a:focus, .woocommerce ul.products li.product .price,.woocommerce div.product p.price, .woocommerce div.product span.price{';
	...
	$appointment_booking_resp_metabox = get_theme_mod( 'appointment_booking_metabox_hide_show',true);
    if($appointment_booking_resp_metabox == true){
    	$appointment_booking_custom_css .='@media screen and (max-width:575px) {';
		$appointment_booking_custom_css .='.post-info{';
			$appointment_booking_custom_css .='display:block;';
		$appointment_booking_custom_css .='} }';
	}else if($appointment_booking_resp_metabox == false){
		$appointment_booking_custom_css .='@media screen and (max-width:575px) {';
		$appointment_booking_custom_css .='.post-info{';
			$appointment_booking_custom_css .='display:none;';
		$appointment_booking_custom_css .='} }';
	...
	$appointment_booking_resp_scroll_top = get_theme_mod( 'appointment_booking_resp_scroll_top_hide_show',false);
