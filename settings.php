...
define( 'WEAVERX_VERSION', '4.4.4.1' );
define( 'WEAVERX_THEMENAME', 'Weaver Xtreme' ); // do not change in child theme!

define( 'WEAVERX_THEMEVERSION', WEAVERX_THEMENAME . ' ' . WEAVERX_VERSION );
define( 'WEAVERX_MIN_WPVERSION', '5.3' );

define( 'WVRX_PAGEBUILDERS', true );    // support for page builders
...
define ( 'WEAVERX_OBSOLETE', ' ' . __( ' *obsolete* ', 'weaver-xtreme') );
