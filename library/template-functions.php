...
$avadanta_custom_css      .= '.header-s1 .header-main{background-color: ' . esc_attr( $avadanta_menubar_bg_color) . ' !important;}';

$avadanta_menu_item_color = get_theme_mod('avadanta_menu_item_color','#131313');

$avadanta_custom_css      .= '.avadanta-navigate .nav-menu>.menu-item>a{color: ' . esc_attr( $avadanta_menu_item_color) . ';}';

$avadanta_menu_item_hover_color = get_theme_mod('avadanta_menu_item_hover_color','#ff7029');

$avadanta_custom_css      .= '.avadanta-navigate .nav-menu>.menu-item>a:hover{color: ' . esc_attr( $avadanta_menu_item_hover_color) . ';}';
