...
$wp_customize->add_section('avadanta_navigation_settings',
 ...
 $wp_customize->add_setting('avadanta_header_show_search',
        array(
            'sanitize_callback' => 'avadanta_sanitize_checkbox',
            'default'           => 0,
        )
    );
    $wp_customize->add_control('avadanta_header_show_search',
        array(
            'type'        => 'checkbox',
            'label'       => esc_html__('Disable Search Bar', 'avadanta'),
            'section'     => 'avadanta_navigation_settings',
            'description' => esc_html__('Check this box to Disable Search Bar From Header', 'avadanta'),
        )
    );
