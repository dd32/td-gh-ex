...
?>
	...
	<div class="donate-info">
		...
		<a title="<?php esc_attr_e( 'Review Attitude', 'attitude' ); ?>" href="<?php echo esc_url( 'http://wordpress.org/support/view/theme-reviews/attitude' ); ?>" target="_blank" class="review"><?php _e( 'Rate Attitude', 'attitude' ); ?></a>
		<a href="<?php echo esc_url( 'http://themehorse.com/theme-instruction/attitude/' ); ?>" title="<?php esc_attr_e( 'Attitude Theme Instructions', 'attitude' ); ?>" target="_blank" class="instruction"><?php _e( 'Theme Instructions', 'attitude' ); ?></a>
