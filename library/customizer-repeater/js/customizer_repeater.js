...
jQuery(document).ready(function () {
    ...
    theme_conrols.on('click', '.customizer-repeater-new-field', function () {
        ...
        {
        if(jQuery('#exist_avadanta_Service').val()>=3)
        {
        ...
        {
        if(jQuery('#exist_avadanta_Testimonial').val()>=3)
        {
        ...
        {
        if(jQuery('#exist_avadanta_Team_Member').val()>=4)
        {
        ...
        return false;   
         ...
         if(jQuery('#exist_avadanta_Team_Member').val()<4)
        {
         var new_service_add_val=parseInt(jQuery('#exist_avadanta_Team_Member').val())+1;
         jQuery('#exist_avadanta_Team_Member').val(new_service_add_val);  
        }
        }
