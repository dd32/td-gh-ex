...
class Bavotasan_Customizer {
	...
	public function customize_register( $wp_customize ) {
		...
		if ( is_active_sidebar( 'second-sidebar' ) ) {
			$wp_customize->add_setting( 'arcade_basic_theme_options[secondary]', array(
				'default' => isset( $bavotasan_theme_options['secondary'] ) ? $bavotasan_theme_options['secondary'] : 'col-md-2',
				'type' => 'option',
				'capability' => 'edit_theme_options',
			) );
			...
			$wp_customize->add_control( 'bavotasan_secondary_column', array(
				...
				'section' => 'bavotasan_layout',
				'settings' => 'arcade_basic_theme_options[secondary]',
				'priority' => 20,
				'type' => 'select',
				'choices' => $choices,
			) );
