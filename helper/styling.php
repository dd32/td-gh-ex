...
echo '#main-menu, #main-menu a, .brand { font-family: ' . $typography['face']. '; font-size:'.$typography['size'] . '; font-style: ' . $typography['style'] . '; color:'.$typography['color'].'; } #controls-wrapper, .navbar-inverse .brand, .navbar-inverse .nav > li > a, .socialbox a:hover {color:'. $typography['color'].'; }  '; } ?>
