...
if ($color) { echo '#footer { color: ' . of_get_option('bottom_text_color') . ' ;}' ; } ?>
...
if ($color) { echo '.navbar .navbar-btn, .socialcount > li, .btn-default, .btn-default:hover, .btn-default:focus, .btn-default a, .socialbox a, .pager li a { color: ' . of_get_option('button_text_color') . ' ;} .socialbox a:hover { background: ' . of_get_option('button_text_color') . ' ;}' ; } ?>
