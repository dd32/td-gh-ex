...
?>
<header role="banner">
	<h2 class="entry-title mb-0 text-left"><?php echo esc_html(get_theme_mod('advance_ecommerce_store_nosearch_found_title',__('Nothing Found','advance-ecommerce-store')));?></h2>
</header>
