...
?>
<header role="banner">
	<h2 class="entry-title"><?php echo esc_html(get_theme_mod('advance_education_nosearch_found_title',__('Nothing Found','advance-education')));?></h2>
</header>
<?php if ( is_home() && current_user_can( 'publish_posts' ) ) : ?>
	...
	<div class="read-moresec">
		<a href="<?php echo esc_url(home_url()); ?>" class="button"><?php esc_html_e( 'Return to Home Page', 'advance-education' ); ?><span class="screen-reader-text"><?php esc_html_e( 'Return to Home Page', 'advance-education' ); ?></span></a>
	</div>
<?php endif; ?>