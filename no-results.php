...
<?php if ( is_home() && current_user_can( 'publish_posts' ) ) : ?>
	<p><?php printf( esc_html( 'Ready to publish your first post? Get started here.','automobile-car-dealer'), esc_url( admin_url( 'post-new.php' ) ) ); ?></p>
...
<?php else : ?>
	...
	<div class="read-moresec">
		<div><a href="<?php echo esc_url( home_url() ); ?>" class="button hvr-sweep-to-right"><?php esc_html_e( 'Back to Home Page', 'automobile-car-dealer' ); ?></a></div>
	</div>
<?php endif; ?>