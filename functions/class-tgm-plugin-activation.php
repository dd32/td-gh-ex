        ...
        if ( ! class_exists( 'generator_Bulk_Installer' ) ) {
            ...
            class generator_Bulk_Installer extends WP_Upgrader {
                ...
                public function install_strings() {
                    ...
                    $this->strings['downloading_package'] = printf( __('Downloading install package from %1$s %s %1$s', 'generator'), '<span class="code">', '</span>&#8230;');
            ...
            class generator_Bulk_Installer_Skin extends Bulk_Upgrader_Skin {
                ...
                public function add_strings() {
                    ...
                    // Default installation strings.
                        ...
                        $this->upgrader->strings['skin_update_failed_error']  = __( 'An error occurred while installing %1$s: %2$s.', 'generator' );
