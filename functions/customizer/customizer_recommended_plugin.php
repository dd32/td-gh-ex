...
$config_customizer = array(
	'recommended_plugins'       => array(
		'webriti-companion' => array(
			'recommended' => true,
			'description' => sprintf('Install and activate <strong>Webriti Companion</strong> plugin for taking full advantage of all the features this theme has to offer %s.', 'rambo'),
		),
	),
...
Rambo_Customizer_Notify::init( apply_filters( 'rambo_customizer_notify_array', $config_customizer ) );
