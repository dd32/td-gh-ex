...
class WP_Pro_Customize_Control extends WP_Customize_Control {
    ...
    */
    ...
    ?>
     <div class="pro-box">
       <a href="<?php echo esc_url( __('http://webriti.com/elitepress/', 'elitepress'));?>" target="_blank" class="upgrade" id="review_pro"><?php _e( 'UPGRADE  TO PRO','elitepress' ); ?></a>
...
$wp_customize->add_section( 'elitepress_pro_section' , array(
		'title'      => __('UPGRADE  TO PRO VERSION', 'elitepress'),
		'priority'   => 1000,
   	) );
...
class WP_Review_Customize_Control extends WP_Customize_Control {
    ...
    */
    ...
    ?>
	  <div class="pro-box">
     <a href="<?php echo esc_url( __('https://wordpress.org/support/view/theme-reviews/elitepress#postform/', 'elitepress'));?>" target="_blank" class="review" id="review_pro"><?php _e( 'ADD YOUR REVIEW','elitepress' ); ?></a>
	 </div>
    <?php
    }
}
...
class WP_document_Customize_Control extends WP_Customize_Control {
    ...
    */
    ...
    ?>
      <div class="pro-box">
	 <a href="<?php echo esc_url( __('http://webriti.com/help/', 'elitepress'));?>" target="_blank" class="document" id="review_pro"><?php _e( 'DOCUMENTATION','elitepress' ); ?></a>
