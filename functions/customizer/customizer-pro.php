...
class WP_demo_Customize_Control extends WP_Customize_Control {
    ...
    */
    ...
    ?>
	  <div class="pro-box">
     <a href="<?php echo esc_url( __('http://webriti.com/demo/wp/spasalon/', 'sis_spa'));?>" target="_blank" class="demo" id="review_pro"><?php _e( 'View Demo','sis_spa' ); ?></a>
	 </div>
    <?php
    }
}
...
$wp_customize->add_control( new WP_demo_Customize_Control( $wp_customize, 'demo_Review', array(	
		'label' => __('Discover Health center lite Pro','sis_spa'),
...
class WP_Pro_Customize_Control extends WP_Customize_Control {
    ...
    */
    ...
    ?>
     <div class="pro-box">
       <a href="<?php echo esc_url( __('http://webriti.com/spasalon/', 'sis_spa'));?>" target="_blank" class="upgrade" id="review_pro"><?php _e( 'UPGRADE  TO PRO','sis_spa' ); ?></a>
...
$wp_customize->add_section( 'spasalon_pro_section' , array(
		'title'      => __('UPGRADE  TO PRO VERSION', 'sis_spa'),
		'priority'   => 1150,
   	) );
...
$wp_customize->add_control( new WP_Pro_Customize_Control( $wp_customize, 'upgrade_pro', array(
		'label' => __('Discover Spasalon lite Pro','sis_spa'),
        'section' => 'spasalon_pro_section',
		'setting' => 'upgrade_pro',
    ))
);
...
class WP_Review_Customize_Control extends WP_Customize_Control {
    ...
    */
    ...
    ?>
	  <div class="pro-box">
     <a href="<?php echo esc_url( __('https://wordpress.org/support/view/theme-reviews/spasalon#postform/', 'sis_spa'));?>" target="_blank" class="review" id="review_pro"><?php _e( 'ADD YOUR REVIEW','sis_spa' ); ?></a>
	 </div>
    <?php
    }
}
