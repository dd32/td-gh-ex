...
$wp_customize->add_control(
    'appointment_options[footer_copyright_text]',
    array(
        'label' => esc_html__('Copyright text','appointment-red'),
...
$wp_customize->add_control(
    ...
    array(
        'type' => 'checkbox',
        'label' => esc_html__('Hide copyright text','appointment-red'),
        'section' => 'copyright_section_one',
    )
);
	...
	$wp_customize->add_section(
        ...
        array(
            'title' => esc_html__('Social Links','appointment-red'),
           'priority' => 45,
			'panel' => 'appointment_copyright_setting',
        )
    );
    ...
    'appointment_options[footer_social_media_enabled]',
    array(
        'label' => esc_html__('Hide footer social icons','appointment-red'),
    ...
    'appointment_options[footer_social_media_facebook_link]',
    array(
        'label' => esc_html__('Facebook URL','appointment-red'),
        'section' => 'copyright_social_icon',
        'type' => 'text',
    )
	);
    ...
    array(
        'type' => 'checkbox',
        'label' => esc_html__('Open link in new tab','appointment-red'),
        'section' => 'copyright_social_icon',
    )
);
    ...
    'appointment_options[footer_social_media_twitter_link]',
    array(
        'label' => esc_html__('Twitter URL','appointment-red'),
        'section' => 'copyright_social_icon',
        'type' => 'text',
    )
	);
    ...
    'appointment_options[footer_social_media_linkedin_link]',
    array(
        'label' => esc_html__('LinkedIn URL','appointment-red'),
        'section' => 'copyright_social_icon',
        'type' => 'text',
    )
	);
    ...
    'appointment_options[footer_social_media_googleplus_link]',
    array(
        'label' => esc_html__('GooglePlus URL','appointment-red'),
        'section' => 'copyright_social_icon',
        'type' => 'text',
    )
	);
   ...
   'appointment_options[footer_social_media_skype_link]',
    array(
        'label' => esc_html__('Skype URL','appointment-red'),
        'section' => 'copyright_social_icon',
        'type' => 'text',
    )
	);
    ...
    function appointment_red_footer_copyright_sanitize_html( $input ) {
        return wp_kses_post( force_balance_tags( $input ) );
        }

    //checkbox box sanitization function
    function appointment_red_sanitize_checkbox($checked) {
        // Boolean check.
        return ( ( isset($checked) && true == $checked ) ? 1 : 0 );
    }

}
add_action( 'customize_register', 'appointment_red_copyright_customizer' );