...
class WP_Pro_Customize_Control extends WP_Customize_Control {
    ...
    */
    ...
    ?>
     <div class="pro-box">
       <a href="<?php echo esc_url( __('http://webriti.com/busiprof/', 'busiprof'));?>" target="_blank" class="upgrade" id="review_pro"><?php _e( 'UPGRADE  TO PRO','busiprof' ); ?></a>
...
$wp_customize->add_section( 'busiprof_pro_section' , array(
		'title'      => __('UPGRADE  TO PRO VERSION', 'busiprof'),
		'priority'   => 1000,
   	) );
...
class WP_Review_Customize_Control extends WP_Customize_Control {
    ...
    */
    ...
    ?>
	  <div class="pro-box">
     <a href="<?php echo esc_url( __('https://wordpress.org/support/view/theme-reviews/busiprof#postform/', 'busiprof'));?>" target="_blank" class="review" id="review_pro"><?php _e( 'ADD YOUR REVIEW','busiprof' ); ?></a>
	 </div>
    <?php
    }
}
...
class WP_document_Customize_Control extends WP_Customize_Control {
    ...
    */
    ...
    ?>
      <div class="pro-box">
	 <a href="<?php echo esc_url( __('http://webriti.com/help/', 'busiprof'));?>" target="_blank" class="document" id="review_pro"><?php _e( 'DOCUMENTATION','busiprof' ); ?></a>
