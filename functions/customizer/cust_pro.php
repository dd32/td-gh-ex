...
class WP_Pro_Customize_Control extends WP_Customize_Control {
    ...
    */
    ...
    ?>
     <div class="pro-box">
       <a href="<?php echo esc_url( __('http://webriti.com/busiprof/', 'busi_prof'));?>" target="_blank" class="upgrade" id="review_pro"><?php _e( 'UPGRADE  TO PRO','busi_prof' ); ?></a>
		
	</div>
    <?php
    }
}
$wp_customize->add_section( 'busi_prof_pro_section' , array(
		'title'      => __('UPGRADE  TO PRO VERSION', 'busi_prof'),
		'priority'   => 1000,
   	) );
...
class WP_Review_Customize_Control extends WP_Customize_Control {
    ...
    */
    ...
    ?>
	  <div class="pro-box">
     <a href="<?php echo esc_url( __('https://wordpress.org/support/view/theme-reviews/busiprof#postform/', 'busi_prof'));?>" target="_blank" class="review" id="review_pro"><?php _e( 'ADD YOUR REVIEW','busi_prof' ); ?></a>
	 </div>
    <?php
    }
}
