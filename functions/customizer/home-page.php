...
function spasalon_home_page_customizer( $wp_customize ){
	...
	$wp_customize->add_panel( 'home_page_settings', array(
		...
		'title'      => __('Home Page', 'sis_spa'),
	) );
	
		/* slider section */
		$wp_customize->add_section( 'slider_section' , array(
			'title'      => __('Slider Settings', 'sis_spa'),
			...
			'label'          => __( 'Slider Banner Enable in home page', 'sis_spa' ),
			...
			'default' => __('Get Yourself','sis_spa'),
			'type'=>'option',
			'sanitize_callback' => 'sanitize_text_field',
			) );
			$wp_customize->add_control('spa_theme_options[line_one]' , array(
			'label'          => __( 'Featured Banner title 1', 'sis_spa' ),
			'section'        => 'slider_section',
			'type'           => 'text'
			) );
			...
			'default' => __('Refreshed','sis_spa'),
			'type'=>'option',
			'sanitize_callback' => 'sanitize_text_field',
			) );
			$wp_customize->add_control('spa_theme_options[line_two]' , array(
			'label'          => __( 'Featured Banner title 2', 'sis_spa' ),
			'section'        => 'slider_section',
			'type'           => 'text'
			) );
			...
			'default' => __('Donec justo odio, lobortis eget congue sed, rutrum sit amet mauris. Curabitur sed lectus nulla. Curabitur sed lectus nulla.lobortis eget congue sed, rutrum sit amet mauris. Curabitur sed lectus nulla rutrum sit amet mauris','sis_spa'),
			'type'=>'option',
			'sanitize_callback' => 'spasalon_home_page_sanitize_text',
			) );
			$wp_customize->add_control('spa_theme_options[description]' , array(
			'label'          => __( 'Featured Banner description', 'sis_spa' ),
			'section'        => 'slider_section',
			'type'           => 'textarea'
			) );
			...
			array(
			'label'          => __( 'Featured Banner image', 'sis_spa' ),
			'section'        => 'slider_section',
		    ) )	);
			...
			array(
			'label'          => __( 'Featured Banner thumbnail 1', 'sis_spa' ),
			'section'        => 'slider_section',
		    ) )	);
			...
			array(
			'label'          => __( 'Featured Banner thumbnail 2', 'sis_spa' ),
			'section'        => 'slider_section',
		    ) )	);
			...
			array(
			'label'          => __( 'Featured Banner thumbnail 3', 'sis_spa' ),
			'section'        => 'slider_section',
		    ) )	);
			...
			class WP_btn_slider_Customize_Control extends WP_Customize_Control {
				...
				?>
				<p>
				<a href="<?php echo esc_url( __('http://webriti.com/spasalon/', 'sis_spa'));?>" target="_blank" ><?php _e( 'Add New Slide Upgrade to Pro.','sis_spa' ); ?></a>
				</p>
				<?php
				}
			}
		...
		$wp_customize->add_section( 'service_section' , array(
			'title'      => __('Service Settings', 'sis_spa'),
			'panel'  => 'home_page_settings'
		) );
			...
			'label'          => __( 'Service Section Title', 'sis_spa' ),
			...
			'label'          => __( 'Service Section Description', 'sis_spa' ),
			'section'        => 'service_section',
			'type'           => 'textarea'
			) );
			...
			'default' => __('Spa Treatment','sis_spa'),
			'type'=>'option',
			'sanitize_callback' => 'sanitize_text_field',
			) );
			$wp_customize->add_control('spa_theme_options[service1_title]' , array(
			'label'          => __( 'Service 1 Title', 'sis_spa' ),
			'section'        => 'service_section',
			'type'           => 'text',
			) );
			...
			'default' => __('Pellen tesque habitant morbi tristique netus et malesuada fames ac turpis egestas In in massa urna, vitae vestibulum orci. yoursb Maecenas quis est sed mauris...','sis_spa'),
			'type'=>'option',
			'sanitize_callback' => 'spasalon_home_page_sanitize_text',
			) );
			$wp_customize->add_control('spa_theme_options[service1_desc]' , array(
			'label'          => __( 'Service 1 Description', 'sis_spa' ),
			'section'        => 'service_section',
			'type'           => 'textarea'
			) );
			...
			array(
			'label'          => __( 'Service 1 image', 'sis_spa' ),
			'section'        => 'service_section',
		    ) )	);
			...
			'label'          => __( 'Service 2 Title', 'sis_spa' ),
			'section'        => 'service_section',
			'type'           => 'text'
			) );
			...
			'label'          => __( 'Service 2 Description', 'sis_spa' ),
			'section'        => 'service_section',
			'type'           => 'textarea'
			) );
			...
			array(
			'label'          => __( 'Service 2 image', 'sis_spa' ),
			'section'        => 'service_section',
		    ) )	);
			...
			'label'          => __( 'Service 3 Title', 'sis_spa' ),
			'section'        => 'service_section',
			'type'           => 'text'
			) );
			...
			'label'          => __( 'Service 3 Description', 'sis_spa' ),
			'section'        => 'service_section',
			'type'           => 'textarea',
			) );
			...
			array(
			'label'          => __( 'Service 3 image', 'sis_spa' ),
			'section'        => 'service_section',
		    ) )	);
			...
			'label'          => __( 'Service 4 Title', 'sis_spa' ),
			'section'        => 'service_section',
			'type'           => 'text'
			) );
			...
			'label'          => __( 'Service 4 Description', 'sis_spa' ),
			'section'        => 'service_section',
			'type'           => 'textarea',
			) );
			...
			array(
			'label'          => __( 'Service 4 image', 'sis_spa' ),
			'section'        => 'service_section',
		    ) )	);
			...
			class WP_btn_service_Customize_Control extends WP_Customize_Control {
				...
				?>
				<p>
				<a href="<?php echo esc_url( __('http://webriti.com/spasalon/', 'sis_spa'));?>" target="_blank" ><?php _e( 'Add New Service Upgrade to Pro','sis_spa' ); ?></a>
		...
		$wp_customize->add_section( 'project_section' , array(
			'title'      => __('Project Settings', 'sis_spa'),
			'panel'  => 'home_page_settings'
		) );
			...
			'label'          => __( 'Project Section Title', 'sis_spa' ),
			...
			'label'          => __( 'Project Section Description', 'sis_spa' ),
			'section'        => 'project_section',
			'type'           => 'textarea'
			) );
			...
			'default' => __('Pellentesque habitant...','sis_spa'),
			'type'=>'option',
			'sanitize_callback' => 'spasalon_home_page_sanitize_text',
			) );
			$wp_customize->add_control('spa_theme_options[product1_desc]' , array(
			'label'          => __( 'Product 1 Description', 'sis_spa' ),
			'section'        => 'project_section',
			'type'           => 'textarea'
			) );
			...
			'label'          => __( 'Product 2 Description', 'sis_spa' ),
			'section'        => 'project_section',
			'type'           => 'textarea'
			) );
			...
			'label'          => __( 'Product 3 Description', 'sis_spa' ),
			'section'        => 'project_section',
			'type'           => 'textarea'
			) );
			...
			'label'          => __( 'Product 4 Description', 'sis_spa' ),
			'section'        => 'project_section',
			'type'           => 'textarea'
			) );
			...
			'label'          => __( 'Product 5 Description', 'sis_spa' ),
			'section'        => 'project_section',
			'type'           => 'textarea'
			) );
			...
			array(
			'label'          => __( 'Product 5 image', 'sis_spa' ),
			'section'        => 'project_section',
		    ) )	);
			...
			class WP_btn_project_Customize_Control extends WP_Customize_Control {
				...
				?>
				<p>
				<a href="<?php echo esc_url( __('http://webriti.com/spasalon/', 'sis_spa'));?>" target="_blank" ><?php _e( 'Add New Product Upgrade to Pro','sis_spa' ); ?></a>
				</p>
				<?php
				}
			}
		...
		$wp_customize->add_section( 'news_section' , array(
			'title'      => __('News Settings', 'sis_spa'),
			'panel'  => 'home_page_settings'
		) );
			...
			'label'          => __( 'Enable News Section', 'sis_spa' ),
			...
			'label'          => __( 'News Section Title', 'sis_spa' ),
			'section'        => 'news_section',
			'type'           => 'text'
			) );
			...
			'label'          => __( 'News Section Description', 'sis_spa' ),
			'section'        => 'news_section',
			'type'           => 'textarea'
			) );
			...
			class WP_btn_news_Customize_Control extends WP_Customize_Control {
				...
				?>
				<p>
				<a href="<?php bloginfo ( 'url' );?>/wp-admin/edit.php" class="button"  target="_blank"><?php _e( 'Click here to add new post', 'sis_spa' ); ?></a>
				</p>
				<?php
				}
			}
