...
<div class="single-nav clearfix" role="navigation">
        <?php
  				the_post_navigation( array(
  					'prev_text' => '<span class="screen-reader-text">' . __( 'Previous Post', 'best-blog' ) . '</span><span class="newspaper-nav-icon nav-left-icon"><i class="fa fa-angle-left"></i></span><span class="nav-left-link">%title</span>',
