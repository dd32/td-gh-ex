...
function multishop_enqueue()
{
	...
	wp_enqueue_script('default-js',get_template_directory_uri().'/js/default.js',array('jquery'));
	wp_enqueue_script('owl-carousel.min-js',get_template_directory_uri().'/js/owl.carousel.min.js',array('jquery'));
	wp_enqueue_script('easyResponsiveTabs-js',get_template_directory_uri().'/js/easyResponsiveTabs.js',array('jquery'));
