<div id="wpbody">
	<div id="wpbody-content">
        ...
        <div id="company-logo" style="float:right;margin-top:2px; font-size:18px;color:#000000;text-shadow:#fff 0px 1px 0, #000 0 -1px 0;"><center><strong>Busiprof Lite By</strong></center>&nbsp;<a href="http://www.webriti.com/" target="_blank"><img src="<?php echo get_template_directory_uri('template_directory').'/functions/theme_options/images/png.png' ?> " /></a>
        </div>
           ...
           <a class="btn btn-large btn-danger" href="#myModal"  data-toggle="modal"><strong>Upgrade to Pro</strong></a>&nbsp;&nbsp;
           
           <a class="btn btn-large btn-info" href="http://wordpress.org/themes/busiprof" target="_blank"><strong>Rate Busiprof</strong></a>
      ...
      <div id="title"><h2 style="background:#6BB3D1;margin-top:0%;padding-bottom:10px;padding-top:10px;color:#FFFFFF">Busiprof-Pro</h2>
          ...
          <table class="table table-hover table-bordered" style="font-size:13px;margin-bottom:0px;" >
                ...
                <tr>
                    <th ><h4>&nbsp;</h4></th>
                    <th style="text-align: center;"><p>Features</p></th>
                    <th style="text-align: center;"><p style="color:#F22853;">Free</p></th>
                    <th style="text-align: center;"><p style="color:#F22853;">Premium</p></th>
                </tr>
                </thead>
                <tbody>
                ...
                <tr style="height:6px;">
                    <td>&nbsp;</td>
                    <td><p><b>Intuitive Option Panel</b><span class="icon help" style="float:right">
					<span class="tooltip"><?php  _e('Customize theme with intutive option panel.','busi_prof');?></span></span>
				</p></td>
     ...
     <tr>
                    <td>&nbsp;</td>
                    <td><p><b>Translation Ready</b><span class="icon help" style="float:right">
					<span class="tooltip"><?php  _e('Translate the theme into your own language.','busi_prof');?></span></span>
				</p></td>
                    <td style="text-align: center;"><p><img src="<?php echo get_template_directory_uri('template_directory').'/functions/theme_options/images/icon_check.png' ?> " /></p></td>
                    <td style="text-align: center;"><p><img src="<?php echo get_template_directory_uri('template_directory').'/functions/theme_options/images/icon_check.png' ?> " /></p></td>
                </tr>
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td><p><b>Customizable Home Page</b><span class="icon help" style="float:right">
    ...
    <tr>
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td><p><b>Page Templates</b><span class="icon help" style="float:right">
					<span class="tooltip"><?php  _e('Number of Page Templates which come with the Theme','busi_prof');?></span></span> </p></td>
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td><p><b>About Us Template</b><span class="icon help" style="float:right">
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td><p><b>Services Template</b><span class="icon help" style="float:right">
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td><p><b>Products Temalate</b> <span class="icon help" style="float:right">
					<span class="tooltip"><?php  _e('Showcase different products which you offer.','busi_prof');?></span></span></p></td>
                    <td style="text-align: center;"><p><img src="<?php echo get_template_directory_uri('template_directory').'/functions/theme_options/images/cross.png' ?> " /></p></td>
                    <td style="text-align: center;"><p><img src="<?php echo get_template_directory_uri('template_directory').'/functions/theme_options/images/icon_check.png' ?> " /></p></td>
                </tr>
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td><p><b>Custom Widgets </b><span class="icon help" style="float:right">
                    ...
                    <td style="text-align: center;"><p><img src="<?php echo get_template_directory_uri('template_directory').'/functions/theme_options/images/icon_check.png' ?> " /></p></td>
                     ...
                     <tr>
                    <td>&nbsp;</td>
                    <td><p><b>Theme Support </b><span class="icon help" style="float:right">
					<span class="tooltip"><?php  _e('Get our fast and friendly support.','busi_prof');?></span></span></p></td>
                    <td style="text-align: center;"><p>Via Wordpress Forums</p></td>
                    <td style="text-align: center;"><p>Private Forums with Email Support</p></td>
                </tr>
                ...
                <tr class="alert alert-info">
                    <td>&nbsp;</td>
                    <td style="text-align: center;"><p>Get the Premium Version</p></td>
...
<!-- header div is end -->
		...
		<div  class="wrap">
			...
			<div class="updated" > 
				<p><strong></strong></p>
				<p><strong><?php _e("This theme recommends the following plugin :",'busi_prof');?> <em><?php _e("appointment calendar",'busi_prof');?></em>.</strong></p>
				<p><strong><a href="http://wordpress.org/plugins/appointment-calendar/" target="_blank"><?php _e("Begin installing plugin",'busi_prof');?></a></strong></p>
				<p></p>
			</div>
