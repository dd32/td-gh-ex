						...
						<div id="busiprof-pro" style="background:#FFFFFF; border:3px solid #ddd" >
							...
							<table class="table table-hover table-bordered" style="font-size:13px;margin-bottom:0px;" >
								<thead class="alert alert-info">
									<tr><th ><h4>&nbsp;</h4></th>
										<th style="text-align: center;"><p><?php _e('Features','busi_prof'); ?></p></th>
										<th style="text-align: center;"><p style="color:#F22853;"><?php _e('Free','busi_prof'); ?></p></th>
										<th style="text-align: center;"><p style="color:#F22853;"><?php _e('Premium','busi_prof'); ?></p></th>
									</tr>
								</thead>
								<tbody>
									<tr style="height:6px;">
									...
									<tr>
										<td>&nbsp;</td>
										<td><p><b><?php _e('Page Templates','busi_prof'); ?></b><span class="icon help" style="float:right">
									...
									<tr>
										<td>&nbsp;</td>
										<td><p><b><?php _e('Theme Support ','busi_prof'); ?></b><span class="icon help" style="float:right">
										<span class="tooltip"><?php  _e('Get our fast and friendly support.','busi_prof');?></span></span></p></td>
										<td style="text-align: center;"><p> <?php _e('Via Wordpress Forums','busi_prof'); ?></p></td>
										<td style="text-align: center;"><p> <?php _e('Private Forums with Email Support','busi_prof'); ?></p></td>
									</tr>
