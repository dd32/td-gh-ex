<div class="block ui-tabs-panel deactive" id="option-ui-id-11" >	
	...
	{	
		...
		{
			$current_options['footer_customizations']="@ Copyright 2014  Corpbiz Design & Developed by";
	...
	<form method="post" id="webriti_theme_options_11">
		...
		<div class="section">		
			<h3><?php _e('footer customizations text','corpbiz'); ?></h3>
			...
			<span class="explain"><?php  _e('Enter the footer customizations text','corpbiz');?></span>
		</div>		
		<div class="section">	
		<h3><?php _e('Created By Webriti text','corpbiz'); ?></h3>			
			...
			<span class="explain"><?php  _e('Enter the created by webriti text','corpbiz');?></span>
		</div>
		
		<div class="section">	
		<h3><?php _e('Created By Link','corpbiz'); ?></h3>			
			...
			<span class="explain"><?php  _e('Enter the Call Out Button Link','corpbiz');?></span>
		</div>
