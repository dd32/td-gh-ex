	...
	<form method="post" id="webriti_theme_options_5">
		<div id="heading">
			<table style="width:100%;"><tr>
				<td><h2><?php _e('Blog  Settings','appointment');?></h2></td>
				<td style="width:30%;">
		...
		<div class="section">
			<h3><?php _e('Enable Blog on HOME Section','appointment'); ?></h3>
			<input type="checkbox" <?php if($current_options['home_blog_enabled']=='on') echo "checked='checked'"; ?> id="home_blog_enabled" name="home_blog_enabled" > <span class="explain"><?php _e('Enable Blog section in front page.','appointment'); ?></span>
			<h3><?php _e('Blog Heading','appointment'); ?></h3>
			...
			<span class="icons help"><span class="tooltip"><?php  _e('Blog Section Heading','appointment');?></span></span>
