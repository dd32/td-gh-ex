 <div class="block ui-tabs-panel deactive" id="option-ui-id-22" >	
	...
	{	
		...
		{	
			...
			$current_options['contact_email']= __('info@elegancetheme.com','elegance');
			$current_options['contact_phone_number']= __('+48-0987-654-321','elegance');
	...
	<form method="post" id="webriti_theme_options_22">
		<div id="heading">
			<table style="width:100%;"><tr>
				<td><h2><?php _e('Social Media Links Settings','elegance');?></h2></td>
				<td><div class="webriti_settings_loding" id="webriti_loding_22_image"></div>
					<div class="webriti_settings_massage" id="webriti_settings_save_22_success" ><?php _e('Options data successfully Saved','elegance');?></div>
					<div class="webriti_settings_massage" id="webriti_settings_save_22_reset" ><?php _e('Options data successfully reset','elegance');?></div>
				</td>
		...
		<div class="section">
			<h3><?php _e('Enable Social Media Links on Header:','elegance'); ?>  </h3>
			<input type="checkbox" <?php if($current_options['header_social_media_enabled']=='on') echo "checked='checked'"; ?> id="header_social_media_enabled" name="header_social_media_enabled" > <span class="explain"><?php _e('Enable social media links on header section.','elegance'); ?></span>
		</div>
		<div class="section">
			<h3><?php _e('Facebook Profile Link:','elegance');?></h3>
			...
			<input type="checkbox" <?php if($current_options['facebook_media_enabled']=='on') echo "checked='checked'"; ?> id="facebook_media_enabled" name="facebook_media_enabled" > <span class="explain"><?php _e('Open facebook media link in new tab/window','elegance'); ?></span>
		</div>
		<div class="section">
			<h3><?php _e('Twitter Profile Link:','elegance');?></h3>
			...
			<input type="checkbox" <?php if($current_options['twitter_media_enabled']=='on') echo "checked='checked'"; ?> id="twitter_media_enabled" name="twitter_media_enabled" > <span class="explain"><?php _e('Open twitter media link in new tab/window','elegance'); ?></span>
		</div>
		<div class="section">
			<h3><?php _e('Google Plus Profile Link:','elegance');?></h3>
			...
			<input type="checkbox" <?php if($current_options['googleplus_media_enabled']=='on') echo "checked='checked'"; ?> id="googleplus_media_enabled" name="googleplus_media_enabled" > <span class="explain"><?php _e('Open googleplus media link in new tab/window','elegance'); ?></span>
		</div>
		<div class="section">
			<h3><?php _e('Linkedin Profile Link:','elegance');?></h3>
			...
			<input type="checkbox" <?php if($current_options['linkedin_media_enabled']=='on') echo "checked='checked'"; ?> id="linkedin_media_enabled" name="linkedin_media_enabled" > <span class="explain"><?php _e('Open linkedin media link in new tab/window','elegance'); ?></span>
		</div>
		<div class="section">
			<h3><?php _e('Skype Profile Link:','elegance');?></h3>
			...
			<input type="checkbox" <?php if($current_options['skype_media_enabled']=='on') echo "checked='checked'"; ?> id="skype_media_enabled" name="skype_media_enabled" > <span class="explain"><?php _e('Open skype media link in new tab/window','elegance'); ?></span>
		</div>
		<div class="section">
			<h3><?php _e('Dribbble Profile Link:','elegance');?></h3>
			...
			<input type="checkbox" <?php if($current_options['dribbble_media_enabled']=='on') echo "checked='checked'"; ?> id="dribbble_media_enabled" name="dribbble_media_enabled" > <span class="explain"><?php _e('Open dribbble media link in new tab/window','elegance'); ?></span>
		</div>
		<div class="section">
			<h3><?php _e('Youtube Profile Link:','elegance');?></h3>
			...
			<input type="checkbox" <?php if($current_options['youtube_media_enabled']=='on') echo "checked='checked'"; ?> id="youtube_media_enabled" name="youtube_media_enabled" > <span class="explain"><?php _e('Open youtube media link in new tab/window','elegance'); ?></span>
		</div>
		<div class="section">
			<h3><?php _e('Vimeo Profile Link:','elegance');?></h3>
			...
			<input type="checkbox" <?php if($current_options['vimeo_media_enabled']=='on') echo "checked='checked'"; ?> id="vimeo_media_enabled" name="vimeo_media_enabled" > <span class="explain"><?php _e('Open vimeo media link in new tab/window','elegance'); ?></span>
		</div>
		<div class="section">
			<h3><?php _e('Pagelines Profile Link:','elegance');?></h3>
			...
			<input type="checkbox" <?php if($current_options['pagelines_media_enabled']=='on') echo "checked='checked'"; ?> id="pagelines_media_enabled" name="pagelines_media_enabled" > <span class="explain"><?php _e('Open pagelines media link in new tab/window','elegance'); ?></span>
		</div>
		<div id="heading">
			<table style="width:100%;"><tr>
				<td><h2><?php _e('Contact setting','elegance');?></h2></td></tr>
			</table>	
	  </div>
	  <div class="section">
			<h3><?php _e('Enable Email id and Phone number on Header:','elegance'); ?>  </h3>
			<input type="checkbox" <?php if($current_options['contact_address_settings']=='on') echo "checked='checked'"; ?> id="contact_address_settings" name="contact_address_settings" > <span class="explain"><?php _e('Enable email and phone number on header section.','elegance'); ?></span>
	 </div>
	<div class="section">
			<h3><?php _e('Input Email id:','elegance');?></h3>
	...
	<div class="section">
			<h3><?php _e('Input Contact Phone Number:','elegance');?></h3>
	...
	<div id="heading">
			<table style="width:100%;"><tr>
				<td><h2><?php _e('Logo setting','elegance');?></h2></td></tr>
			</table>	
	</div>
	<div class="section">
			<h3><?php _e('Enable Logo or text on Header:','elegance'); ?>  </h3>
			<input type="checkbox" <?php if($current_options['logo_section_settings']=='on') echo "checked='checked'"; ?> id="logo_section_settings" name="logo_section_settings" > <span class="explain"><?php _e('Enable Logo or text on header section.','elegance'); ?></span>
	</div>
	
	
	<div class="section">
			<h3><?php _e('Custom Logo','elegance'); ?>
				<span class="icons help"><span class="tooltip"><?php  _e('Add custom logo from here suggested size is 250X50 px','elegance');?></span></span>
			</h3>
		...
		<div class="section">
			<h3><?php _e('Logo Height','elegance'); ?>
				<span class="icons help"><span class="tooltip"><?php  _e('Default Logo Height : 50px, if you want to increase than specify your value','elegance'); ?></span></span>
			</h3>
			<input class="webriti_inpute"  type="text" name="height" id="height" value="<?php echo $current_options['height']; ?>" >						
		</div>
		<div class="section">
			<h3><?php _e('Logo Width','elegance'); ?>
				<span class="icons help"><span class="tooltip"><?php  _e('Default Logo Width : 250px, if you want to increase than specify your value','elegance');?></span></span>
			</h3>
			<input  class="webriti_inpute" type="text" name="width" id="width"  value="<?php echo $current_options['width']; ?>" >			
		</div>
		<div class="section">
			<h3><?php _e('Text Title','elegance'); ?></h3>
			<input type="checkbox" <?php if($current_options['text_title']=='on') echo "checked='checked'"; ?> id="text_title" name="text_title" > <span class="explain"><?php _e('Enable text-based Site Title.   Setup title','elegance');?> <a href="<?php echo home_url( '/' ); ?>wp-admin/options-general.php"><?php _e('Click Here','elegance');?></a>.</span>
		</div>
		
		<div id="heading">
			<table style="width:100%;"><tr>
				<td><h2><?php _e('Header Menu & Search Bar setting','elegance');?></h2></td></tr>
			</table>	
	  </div>
	<div class="section">
			<h3><?php _e('Enable Search bar on Header section:','elegance'); ?>  </h3>
			<input type="checkbox" <?php if($current_options['header_search_bar_enabled']=='on') echo "checked='checked'"; ?> id="header_search_bar_enabled" name="header_search_bar_enabled" > <span class="explain"><?php _e('Enable Search bar on header section.','elegance'); ?></span>
	 </div>
