<div class="block ui-tabs-panel deactive" id="option-ui-id-3" >	
	...
	{	
		...
		if($_POST['webriti_settings_save_3'] == 2) 
		{
			...
			$current_options['service_title']=__('Our Services', 'elegance');	
			$current_options['service_description']=__('Duis aute irure dolor in reprehenderit in voluptate velit cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupid non proident, sunt in culpa qui officia deserunt mollit anim id est laborum..', 'elegance');
			
			$current_options['service_one_title'] = __('Responsive Design', 'elegance');
			$current_options['service_one_description'] = __('Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Cras mattis consectetur purus sit amet ferment etiam porta sem malesuada magna mollis.', 'elegance');
			$current_options['service_one_icon'] = 'fa fa-shield';
			
			$current_options['service_two_title'] = __('Twitter Bootstrap 3.2.0', 'elegance');
			$current_options['service_two_description'] = __('Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Cras mattis consectetur purus sit amet ferment etiam porta sem malesuada magna mollis.', 'elegance');
			$current_options['service_two_icon'] = 'fa fa-tablet';
			
			$current_options['service_three_title'] = __('Exclusive Support', 'elegance');
			$current_options['service_three_description'] = __('Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Cras mattis consectetur purus sit amet ferment etiam porta sem malesuada magna mollis.', 'elegance');
			$current_options['service_three_icon'] = 'fa fa-edit';
			
			$current_options['service_four_title'] = __('Incredibly Flexible', 'elegance');
			$current_options['service_four_description'] = __('Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Cras mattis consectetur purus sit amet ferment etiam porta sem malesuada magna mollis.', 'elegance');
	...
	<form method="post" id="webriti_theme_options_3">
		<div id="heading">
			<table style="width:100%;"><tr>
				<td><h2><?php _e('Service Settings','elegance');?></h2></td>
				<td><div class="webriti_settings_loding" id="webriti_loding_3_image"></div>
					<div class="webriti_settings_massage" id="webriti_settings_save_3_success" ><?php _e('Options data successfully Saved','elegance');?></div>
					<div class="webriti_settings_massage" id="webriti_settings_save_3_reset" ><?php _e('Options data successfully reset','elegance');?></div>
				</td>
		...
		<div class="section">
			<h3><?php _e('Enable Home Service Section','elegance'); ?>  </h3>
			...
			<span class="explain"><?php _e('Enable service on front page.','elegance'); ?></span>
		</div>
		<div class="section">
			<h3><?php _e('Service section Heading on Home page','elegance');?></h3>
			...
			<span class="explain"><?php  _e('Enter Service Heading for Service Section.','elegance');?></span>
		</div>
		<div class="section">
			<h3><?php _e('Service section Description on Home page','elegance');?></h3>
			...
			<span class="explain"><?php  _e('Enter Service Description for Service Section.','elegance');?></span>
		</div>
		
		<div class="section">		
			<h3><?php _e('Service One Settings','elegance'); ?></h3>
		</div>
		<div class="section">	
		<h3><?php _e('Service Icon One ','elegance'); ?></h3>
			...
			<span class="explain"><?php _e('Enter the service icon.','elegance'); ?></span>
		</div>
		
		<div class="section">
			<h3><?php _e('Service One Title','elegance'); ?></h3>
			...
			<span class="explain"><?php _e('Enter the service one title.','elegance'); ?></span>
		</div>
		<div class="section">	
		<h3><?php _e('Service one Description','elegance'); ?></h3>
			...
			<span class="explain"><?php _e('Enter the service one description.','elegance'); ?></span>
		</div>
		<div class="section">		
			<h3><?php _e('Service Two Settings','elegance'); ?></h3>
		</div>
		<div class="section">	
		<h3><?php _e('Service Icon Two ','elegance'); ?></h3>
		...
		<div class="section">
			<h3><?php _e('Service Two Title','elegance'); ?></h3>
			...
			<span class="explain"><?php _e('Enter the service two title.','elegance'); ?></span>
		</div>
		<div class="section">	
		<h3><?php _e('Service Two Description','elegance'); ?></h3>
			...
			<span class="explain"><?php _e('Enter the service two description.','elegance'); ?></span>
		</div>
		<div class="section">		
			<h3><?php _e('Service Three Settings','elegance'); ?></h3>
		</div>
		<div class="section">	
		<h3><?php _e('Service Icon Three ','elegance'); ?></h3>
		...
		<div class="section">
			<h3><?php _e('Service Three Title','elegance'); ?></h3>
			...
			<span class="explain"><?php _e('Enter the service three title.','elegance'); ?></span>
		</div>
		<div class="section">	
		<h3><?php _e('Service Three Description','elegance'); ?></h3>
			...
			<span class="explain"><?php _e('Enter the service three description.','elegance'); ?></span>
		</div>
		<div class="section">		
			<h3><?php _e('Service Four Settings','elegance'); ?></h3>
		</div>
		<div class="section">	
		<h3><?php _e('Service Icon Four ','elegance'); ?></h3>
		...
		<div class="section">
			<h3><?php _e('Service Four Title','elegance'); ?></h3>
			...
			<span class="explain"><?php _e('Enter the service four title.','elegance'); ?></span>
		</div>
		<div class="section">	
		<h3><?php _e('Service Four Description','elegance'); ?></h3>
			...
			<span class="explain"><?php _e('Enter the service four description.','elegance'); ?></span>
		</div>
