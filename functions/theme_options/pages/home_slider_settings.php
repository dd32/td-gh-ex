				...
				<div class="repeat-content-wrap">
					<div class="row"> 
						...
						<div class="col col-2">
							...
							<a href="http://localhost/wordpress_elegent/wp-admin/post.php?post=&amp;action=edit" class="button" title="Click Here To Edit" target="_blank"><?php _e('Click Here To Edit','appointment'); ?></a>
							<p><span> <h5><?php _e("You can use multiple ID's seprated by Commma[ , ]",'appointment');?></span></h5></p>						</div>
					</div>
				</div>
			</div>
		</div>	
