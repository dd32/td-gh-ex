<div class="block ui-tabs-panel " id="option-ui-id-2" >	
	...
	{	
		 ...
		 if($_POST['webriti_settings_save_2'] == 2) 
		{
			...
			$current_options['animation']='fade';
	...
	<form method="post" id="webriti_theme_options_2">
		<div id="heading">
			<table style="width:100%;"><tr>
				<td><h2><?php _e('Home Slider Setting','corpbiz');?></h2></td>
		...
		<div class="section">
			<h3><?php _e('Enable Home Slider','corpbiz'); ?>  </h3>
			...
			<span class="explain"><?php _e('Enable Home Slider on front page.','corpbiz'); ?></span>
		</div>
		<div class="section">
		...
		<div id="post_slider" <?php if($current_options['slider_radio']!='post'){echo 'style="display:none;"';}?>>
			...
			<span class="explain"><?php _e('Enable Feature post slider on Page.','corpbiz'); ?></span>
