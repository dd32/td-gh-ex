<div class="block ui-tabs-panel deactive" id="option-ui-id-2" >	
	...
	{	
		...
		if($_POST['webriti_settings_save_2'] == 2) 
		{
			...
			$current_options['slider_title_one']= __('elegance BY WEBRITI THEMES','elegance');
			$current_options['slider_description']=  __('Create Fresh Website fast with us!','elegance');
	...
	<form method="post" id="webriti_theme_options_2">
		<div id="heading">
			<table style="width:100%;"><tr>
				<td><h2><?php _e('Home Feature Image Setting','elegance');?></h2></td>
				<td><div class="webriti_settings_loding" id="webriti_loding_2_image"></div>
					<div class="webriti_settings_massage" id="webriti_settings_save_2_success" ><?php _e('Options data successfully Saved','elegance');?></div>
					<div class="webriti_settings_massage" id="webriti_settings_save_2_reset" ><?php _e('Options data successfully reset','elegance');?></div>
				</td>
		...
		<div class="section">
			<h3><?php _e('Enable Home Banner','elegance'); ?>  </h3>
			...
			<span class="explain"><?php _e('Enable Home Banner on front page.','elegance'); ?></span>
		</div>
		<div class="section">
			<h3><?php _e('Slider Title One','elegance'); ?></h3>
			...
			<span class="explain"><?php _e('Enter the slider title one.','elegance'); ?></span>
		</div>
		
		<div class="section">
			<h3><?php _e('Slider Description','elegance'); ?></h3>
			...
			<span class="explain"><?php _e('Enter the slider description.','elegance'); ?></span>
		</div>
		<div class="section">
			<h3><?php _e('Home Feature Image','elegance'); ?>
				<span class="icons help"><span class="tooltip"><?php  _e('Add a image with size of 1600 X 750 px. ','elegance');?></span></span>
			</h3>
