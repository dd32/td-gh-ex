<div class="block ui-tabs-panel deactive" id="option-ui-id-24" >	
  ...
  if($_POST['webriti_settings_save_24'] == 2) 
		{
		do_action('elegance_restore_data', 2);		
		}
  }
  ?>
	<form method="post" id="webriti_theme_options_24">
		<div id="heading">
			<table style="width:100%;"><tr>
				<td><h2><?php _e('Banner Settings','elegance');?></h2></td>
				<td><div class="webriti_settings_loding" id="webriti_loding_24_image"></div>
					<div class="webriti_settings_massage" id="webriti_settings_save_24_success" ><?php _e('Options data successfully Saved','elegance');?></div>
					<div class="webriti_settings_massage" id="webriti_settings_save_24_reset" ><?php _e('Options data successfully reset','elegance');?></div>
				</td>
		...
		<div class="section">
			 <h3><b><?php _e('Banner Configuration For Category Template','elegance'); ?></b></h3>
			 <p><h4 class="heading"><?php _e('Category Banner Tagline One','elegance');?></h4>
			...
			<p><h4 class="heading"><?php _e('Category Banner Description','elegance');?></h4>
		...
		<div class="section">
			 <h3><b><?php _e('Banner Configuration For Archive Template','elegance'); ?></b></h3>
			 <p><h4 class="heading"><?php _e('Archive Banner Tagline One','elegance');?></h4>
			...
			<p><h4 class="heading"><?php _e('Archive Banner Description','elegance');?></h4>
		...
		<div class="section">
		 <h3><b><?php _e('Banner Configuration For Author Template','elegance'); ?></b></h3>
			 <p><h4 class="heading"><?php _e('Author Banner Tagline One','elegance');?></h4>
			...
			<p><h4 class="heading"><?php _e('Author Banner Description','elegance');?></h4>
		...
		<div class="section">
			<h3><b><?php _e('Banner Configuration For 404 Template','elegance'); ?></b></h3>
			<p><h4 class="heading"><?php _e('404 Banner Tagline One','elegance');?></h4>
			...
			<p><h4 class="heading"><?php _e('404 Banner Description','elegance');?></h4>
	...
	<div class="section">	
		<h3><b><?php _e('Banner Configuration For Tag Template','elegance'); ?></b></h3>
		 <p><h4 class="heading"><?php _e('Tag Banner Tagline One','elegance');?></h4>
		...
		<p><h4 class="heading"><?php _e('Tag Banner Description','elegance');?></h4>
		...
		<div class="section">
			 <h3><b><?php _e('Banner Configuration For Search Template','elegance'); ?></b></h3>
			<p><h4 class="heading"><?php _e('Search Banner Tagline One','elegance');?></h4>
			...
			<p><h4 class="heading"><?php _e('Search Banner Description','elegance');?></h4>
