...
// Creating the widget
	...
	?>
	<!-- Facebook Link -->
	<h4 for="<?php echo $this->get_field_id( 'facebook_link' ); ?>"><?php _e( 'Facebook URL','rockers' ); ?></h4>
	...
	<label for="<?php echo $this->get_field_id( 'facebook_target' ); ?>"><?php _e( 'Open link in new tab','rockers' ); ?></label>
	
	<!-- Twitter Link -->
	<h4 for="<?php echo $this->get_field_id( 'twitter_link' ); ?>"><?php _e( 'Twitter URL','rockers' ); ?></h4>
	...
	<label for="<?php echo $this->get_field_id( 'twitter_target' ); ?>"><?php _e( 'Open link in new tab','rockers' ); ?></label>
	
	<!-- Google-Plus Link -->
	<h4 for="<?php echo $this->get_field_id( 'google_plus_link' ); ?>"><?php _e( 'Google-Plus URL','rockers' ); ?></h4>
	...
	<label for="<?php echo $this->get_field_id( 'google_plus_target' ); ?>"><?php _e( 'Open link in new tab','rockers' ); ?></label>

	<!-- Lindedin Link -->
	<h4 for="<?php echo $this->get_field_id( 'linkedin_link' ); ?>"><?php _e( 'LinkedIn URL','rockers' ); ?></h4>
	...
	<label for="<?php echo $this->get_field_id( 'linkedin_target' ); ?>"><?php _e( 'Open link in new tab','rockers' ); ?></label>
	
	<!-- Instagram Link -->
	<h4 for="<?php echo $this->get_field_id( 'instagram_link' ); ?>"><?php _e( 'Instagram URL','rockers' ); ?></h4>
	...
	<!-- Skype Link -->
	<h4 for="<?php echo $this->get_field_id( 'skype_link' ); ?>"><?php _e( 'Skype URL','rockers' ); ?></h4>
	...
	<label for="<?php echo $this->get_field_id( 'skype_target' ); ?>"><?php _e( 'Open link in new tab','rockers' ); ?></label>
	
	<!-- Vimeo Link -->
	<h4 for="<?php echo $this->get_field_id( 'vimeo_link' ); ?>"><?php _e( 'Vimeo URL','rockers' ); ?></h4>
	...
	<label for="<?php echo $this->get_field_id( 'vimeo_target' ); ?>"><?php _e( 'Open link in new tab','rockers' ); ?></label>
	
	<!-- Dribble Link -->
	<h4 for="<?php echo $this->get_field_id( 'dribble_link' ); ?>"><?php _e( 'Dribble URL','rockers' ); ?></h4>
	...
	<label for="<?php echo $this->get_field_id( 'dribble_target' ); ?>"><?php _e( 'Open link in new tab','rockers' ); ?></label>
