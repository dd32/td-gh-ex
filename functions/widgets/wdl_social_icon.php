<?php // Register and load the widget
	function rockers_social_icon_widget() {
	    register_widget( 'rockers_social_icon_widget' );
	}
	add_action( 'widgets_init', 'rockers_social_icon_widget' );

// Creating the widget
	class rockers_social_icon_widget extends WP_Widget {

	function __construct() {
		parent::__construct(
			'rockers_social_icon_widget', // Base ID
			esc_html__('ST: Social icons','rockers'), // Widget Name
			array(
				'classname' => 'rockers_social_icon_widget',
				'description' => esc_html__('Rockers social icons widget','rockers'),
			),
			array(
				'width' => 300,
			)
		);
		add_action( 'admin_enqueue_scripts', array( $this, 'rockers_header_topbar_info_style' ) );
	 }

 	public function rockers_header_topbar_info_style(){?>
		<style type="text/css">
  ...
  <?php }
	...
	?>
	<!-- Facebook Link -->
	<h4 for="<?php echo esc_attr($this->get_field_id( 'facebook_link' )); ?>"><?php esc_html_e( 'Facebook URL','rockers' ); ?></h4>
	...
	<label for="<?php echo esc_attr($this->get_field_id( 'facebook_target' )); ?>"><?php esc_html_e( 'Open link in new tab','rockers' ); ?></label>

	<!-- Twitter Link -->
	<h4 for="<?php echo esc_attr($this->get_field_id( 'twitter_link' )); ?>"><?php esc_html_e( 'Twitter URL','rockers' ); ?></h4>
	...
	<label for="<?php echo esc_attr($this->get_field_id( 'twitter_target' )); ?>"><?php esc_html_e( 'Open link in new tab','rockers' ); ?></label>

	<!-- Google-Plus Link -->
	<h4 for="<?php echo esc_attr($this->get_field_id( 'google_plus_link' )); ?>"><?php esc_html_e( 'Google-Plus URL','rockers' ); ?></h4>
	...
	<label for="<?php echo esc_attr($this->get_field_id( 'google_plus_target' )); ?>"><?php esc_html_e( 'Open link in new tab','rockers' ); ?></label>

	<!-- Lindedin Link -->
	<h4 for="<?php echo esc_attr($this->get_field_id( 'linkedin_link' )); ?>"><?php esc_html_e( 'LinkedIn URL','rockers' ); ?></h4>
	...
	<label for="<?php echo esc_attr($this->get_field_id( 'linkedin_target' )); ?>"><?php esc_html_e( 'Open link in new tab','rockers' ); ?></label>

	<!-- Instagram Link -->
	<h4 for="<?php echo esc_attr($this->get_field_id( 'instagram_link' )); ?>"><?php esc_html_e( 'Instagram URL','rockers' ); ?></h4>
	...
	<label for="<?php echo esc_attr($this->get_field_id( 'instagram_target' )); ?>"><?php esc_html_e( 'Open link in new tab','rockers' ); ?></label>

	<!-- Youtube Link -->
	<h4 for="<?php echo esc_attr($this->get_field_id( 'youtube_link' )); ?>"><?php esc_html_e('YouTube URL','rockers' ); ?></h4>
	...
	<label for="<?php echo esc_attr($this->get_field_id( 'youtube_target' )); ?>"><?php esc_html_e( 'Open link in new tab','rockers' ); ?></label>

	<!-- Skype Link -->
	<h4 for="<?php echo esc_attr($this->get_field_id( 'skype_link' )); ?>"><?php esc_html_e( 'Skype URL','rockers' ); ?></h4>
	...
	<label for="<?php echo esc_attr($this->get_field_id( 'skype_target' )); ?>"><?php esc_html_e( 'Open link in new tab','rockers' ); ?></label>

	<!-- Vimeo Link -->
	<h4 for="<?php echo esc_attr($this->get_field_id( 'vimeo_link' )); ?>"><?php esc_html_e( 'Vimeo URL','rockers' ); ?></h4>
	...
	<label for="<?php echo esc_attr($this->get_field_id( 'vimeo_target' )); ?>"><?php esc_html_e( 'Open link in new tab','rockers' ); ?></label>

	<!-- Dribble Link -->
	<h4 for="<?php echo esc_attr($this->get_field_id( 'dribble_link' )); ?>"><?php esc_html_e( 'Dribble URL','rockers' ); ?></h4>
	...
	<label for="<?php echo esc_attr($this->get_field_id( 'dribble_target' )); ?>"><?php esc_html_e( 'Open link in new tab','rockers' ); ?></label>
