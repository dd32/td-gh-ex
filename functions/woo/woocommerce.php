...
add_action('woocommerce_before_main_content', 'busiprof_wrapper_start', 10);
add_action('woocommerce_after_main_content', 'busiprof_wrapper_end', 10);

function busiprof_wrapper_start() {?>
<!-- Header Strip -->
