...
add_action('woocommerce_before_main_content', 'rambo_wrapper_start', 10);
add_action('woocommerce_after_main_content', 'rambo_wrapper_end', 10);

function rambo_wrapper_start() {?>
<!-- Header Strip -->
...
<?php function rambo_wrapper_end() {
