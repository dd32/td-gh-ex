...
/* ----------------------------------------------------------------------------------- */
    ...
    function promax_of_head_css() {
        $output = '';
        $custom_css = promax_get_option('promax_customcss');
        if ($custom_css <> '') {
            $output .= $custom_css . "\n";
        }
// Output styles
...
if ('promax_comment') :
     ...
     * simply create your own promax_comment(), and that function will be used instead.
     *
     * Used as a callback by wp_list_comments() for displaying the comments.
     */
    function promax_comment($comment, $args, $depth) {
...
/////////Theme Options
    ...
    function promax_childtheme_favicon() {
        if (promax_get_option('promax_favicon') != '') {
            echo '<link rel="shortcut icon" href="' . promax_get_option('promax_favicon') . '"/>' . "\n";
        }
    }
