...
function inkthemes_page_init() {
    ...
    <div id="contain">
        <div id="themesheader">
            ...
            <br />
            <div class="menu">	   
                <a href="<?php echo esc_url('https://twitter.com/share'); ?>" class="twitter-share-button" data-url="<?php echo esc_url('http://www.inkthemes.com'); ?>" data-text="Check out the Professional Premium WordPress Themes at InkThemes">Tweet</a>
                ...
                <iframe src="<?php echo esc_url('http://www.facebook.com/plugins/like.php?app_id=153286811409231&href=www.inkthemes.com&send=false&layout=button_count&width=90&show_faces=false&action=like&colorscheme=light&font&height=21'); ?>" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:90px; height:21px;" allowTransparency="true"></iframe>
                <g:plusone size="medium" href="<?php echo esc_url('http://www.inkthemes.com'); ?>"></g:plusone>
        ...
        <div id="container">
            <div class="theme-image">
                <a href="<?php echo esc_url('http://www.inkthemes.com/wp-themes/colorway-wp-theme/'); ?>" target="_blank"><img src="<?php echo $root; ?>/functions/images/colorway.jpg" /></a>
            </div>
            <div class="theme-desc">
                <div class="theme-title"><a href="<?php echo esc_url('http://www.inkthemes.com/wp-themes/colorway-wp-theme/'); ?>" target="_blank">Colorway Theme</a></div>
                <br />
                The best thing about Colorway Theme is the ease with the help of which you can convert your Website in various different Niches. &ldquo;Your Clients Would Love Their Site & You Would smile in the back thinking about the Time That You Spend Building their Sites.&rdquo;
                <br /><br />
                ...
                <div class="buy"><a href="<?php echo esc_url('http://www.inkthemes.com/wp-themes/colorway-wp-theme/'); ?>" target="_blank">Buy Colorway Theme</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a href="<?php echo esc_url('http://wordpress.org/extend/themes/colorway'); ?>" target="_blank">Try Colorway Lite for FREE</a></div>

            </div>

            <div class="theme-image">
                <a href="<?php echo esc_url('http://www.inkthemes.com/wp-themes/local-business-wordpress-theme/'); ?>" target="_blank"><img src="<?php echo $root; ?>/functions/images/Big-thames-Local-Business-theme-1.png" /></a>
            </div>
            <div class="theme-desc">
                <div class="theme-title"><a href="<?php echo esc_url('http://www.inkthemes.com/wp-themes/local-business-wordpress-theme/'); ?>" target="_blank">Local Business Theme</a></div>
                <br />
                ...
                <br /><br />
                <div class="buy"><a href="<?php echo esc_url('http://www.inkthemes.com/wp-themes/local-business-wordpress-theme/'); ?>" target="_blank">Buy Local business Theme</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a href="<?php echo esc_url('http://wordpress.org/extend/themes/local-business'); ?>" target="_blank">Try Local business for FREE</a></div>
            </div>
            ...
            <div class="theme-image">
                <a href="<?php echo esc_url('http://www.inkthemes.com/wp-themes/andrina-theme/'); ?>" target="_blank"><img src="<?php echo $root; ?>/functions/images/andrina.png" /></a>
            </div>
            <div class="theme-desc">
                <div class="theme-title"><a href="<?php echo esc_url('http://www.inkthemes.com/wp-themes/andrina-theme/'); ?>" target="_blank">Andrina Theme</a></div>
                <br />
                ...
                <br /> <br />
                <div class="buy"><a href="<?php echo esc_url('http://www.inkthemes.com/wp-themes/andrina-theme/'); ?>" target="_blank">Buy Andrina Theme</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a href="<?php echo esc_url('http://wordpress.org/extend/themes/andrina-lite'); ?>" target="_blank">Try Andrina Lite for FREE</a></div>
            </div>
            <div class="theme-image">
                <a href="<?php echo esc_url('http://www.inkthemes.com/wp-themes/figero-wordpress-theme/'); ?>" target="_blank"><img src="<?php echo $root; ?>/functions/images/figero-bigthumbnail.png" /></a>
            </div>
            <div class="theme-desc">
                <div class="theme-title"><a href="<?php echo esc_url('http://www.inkthemes.com/wp-themes/figero-wordpress-theme/'); ?>" target="_blank">Figero Theme</a></div>
                <br />
            ...
            <div class="theme-image">
                <a href="<?php echo esc_url('http://www.inkthemes.com/wp-themes/poloray-responsive-wordpress-theme/'); ?>" target="_blank"><img src="<?php echo $root; ?>/functions/images/Poloray-thumbe2013.png" /></a>
            </div>
            <div class="theme-desc">
