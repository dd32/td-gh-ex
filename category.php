		...
		<div class="row">
			<div class="col-md-6">
				<div class="page-title category">
					<h2><?php
                    /* translators: 1. Category Prefix, 2. Category title. */
                        printf(esc_html__('%1$s %2$s', 'arzine'), esc_html($arzine_current_options['category_prefix']), single_cat_title('', false)); ?></h2>
				</div>
			</div>
			<div class="col-md-6">
