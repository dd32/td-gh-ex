		...
		<?php if ( have_posts() ) : ?>
				...
				<div class="author-desc">
					...
					<div class="author-links">
								...
								if (!empty($author_url)) : ?>
									...
									<a class="upper author-link-website" title="<?php esc_html_e('Author website','ace-corporate'); ?>" href="<?php echo esc_url($author_url); ?>"><i class="fa fa-globe"></i> <?php esc_html_e('Author website','ace-corporate'); ?></a>
			...
			<div class="nav-links clearfix">
				...
				<div class="nav-previous">
					<?php next_posts_link( __( '<i class="fa fa-long-arrow-left post-arrow"></i>Older posts','ace-corporate' ) ); ?>
				</div>
				<?php else :  ?>
					<div class="nav-previous disabled">
						<a href="#">
							<i class="fa fa-long-arrow-left post-arrow"></i><?php esc_html_e( 'No Older posts','ace-corporate' ); ?>
						</a>
					</div>
				<?php endif; ?>
				...
				<div class="nav-next">
					<?php previous_posts_link( __( 'Newer posts <i class="fa fa-long-arrow-right post-arrow"></i> ','ace-corporate' ) ); ?></div>
				<?php else :  ?>
					<div class="nav-next disabled">
					<a href="#"> <i class="fa fa-long-arrow-right post-arrow"></i><?php esc_html_e( 'No Newer post','ace-corporate' ); ?></a></div>
				<?php endif; ?>
			</div><!-- .nav-links -->
		</nav><!-- .navigation -->
