...
<div class="col-md-12 blogpost-list">
  <div class="col-md-8 blogpost no-padding-left clearfix">
    <div class="col-md-12 no-padding">
      <h1 class="post-page-title"><?php  esc_html_e( 'All posts by ', 'top-mag' ); echo ' : '. get_the_author();?></h1>
    </div>
    ...
    <div class="col-md-12 no-padding blogpost-border">
      <div class="blogpost-col1 no-padding">
        ...
        <?php } else { ?>
        <img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/no-image.png" width="320" height="221" alt="<?php echo get_the_title(); ?>" class="img-responsive single-post-image" />
        <?php } ?>
