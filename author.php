		...
		<section id="primary" class="span-15 colborder">
			...
			<?php if ( have_posts() ) : ?>
				...
				<header class="page-header">
					<h1 class="page-title author"><?php printf( __( 'Author Archives: %s', AKYUZ_TEXT_DOMAIN ), '<span class="vcard"><a class="url fn n" href="' . esc_url( get_author_posts_url( get_the_author_meta( "ID" ) ) ) . '" title="' . esc_attr( get_the_author() ) . '" rel="me">' . get_the_author() . '</a></span>' ); ?></h1>
				</header>
				...
				<div id="author-info">
					...
					<div id="author-description">
						<h2><?php printf( __( 'About %s', AKYUZ_TEXT_DOMAIN ), get_the_author() ); ?></h2>
