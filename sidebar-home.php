			...
			<div id="top-widget-inner">
				...
				<?php if ( !dynamic_sidebar( 'homepage-top-widget-area' ) && current_user_can('edit_theme_options') ) : ?>
						...
						<h2 class="sidebar-title">
							<?php esc_html_e('Homepage Above Columns', 'ayahandmade'); ?>
						</h2><!-- .sidebar-title -->
						...
						<div class="textwidget">
							<?php esc_html_e('This is homepage above columns widget area. To customize it, please navigate to Admin Panel -> Appearance -> Widgets and add widgets to Homepage Above Columns.', 'ayahandmade'); ?>
						</div><!-- .textwidget -->
		...
		<?php if ( is_active_sidebar( 'homepage-column-1-widget-area' ) ) : ?>
				...
				<div class="col3a">
					...
					<?php if ( !dynamic_sidebar( 'homepage-column-1-widget-area' ) && current_user_can('edit_theme_options') ) : ?>
								...
								<h2 class="sidebar-title">
									<?php esc_html_e('Home Col Widget 1', 'ayahandmade'); ?>
								</h2><!-- .sidebar-title -->
								...
								<div class="textwidget">
									<?php esc_html_e('This is first homepage widget area. To customize it, please navigate to Admin Panel -> Appearance -> Widgets and add widgets to Homepage Column #1.', 'ayahandmade'); ?>
								</div><!-- .textwidget -->
		...
		<?php if ( is_active_sidebar( 'homepage-column-2-widget-area' ) ) : ?>
				...
				<div class="col3b">
					<?php if ( !dynamic_sidebar( 'homepage-column-2-widget-area' ) && current_user_can('edit_theme_options') ) : ?>
							...
							<h2 class="sidebar-title">
								<?php esc_html_e('Home Col Widget 2', 'ayahandmade'); ?>
							</h2><!-- .sidebar-title -->
							...
							<div class="textwidget">
								<?php esc_html_e('This is second homepage widget area. To customize it, please navigate to Admin Panel -> Appearance -> Widgets and add widgets to Homepage Column #2.', 'ayahandmade'); ?>
							</div><!-- .textwidget -->
		...
		<?php if ( is_active_sidebar( 'homepage-column-3-widget-area' ) ) : ?>
				...
				<div class="col3c">
					<?php if ( !dynamic_sidebar( 'homepage-column-3-widget-area' ) && current_user_can('edit_theme_options') ) : ?>
							...
							<h2 class="sidebar-title">
								<?php esc_html_e('Home Col Widget 3', 'ayahandmade'); ?>
							</h2><!-- .sidebar-title -->
							...
							<div class="textwidget">
								<?php esc_html_e('This is third homepage widget area. To customize it, please navigate to Admin Panel -> Appearance -> Widgets and add widgets to Homepage Column #3.', 'ayahandmade'); ?>
							</div><!-- .textwidget -->
