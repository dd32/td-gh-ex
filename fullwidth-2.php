 ...
 */
get_header(); ?>
<div class="inside-page full-width content-area">
		<section class="page-section">		          
		      <div class="detail-content">	
					...
					<li><i class="fa fa-comments-o"></i> <?php comments_popup_link( __( 'zero comment', 'avid-magazine' ), __( 'one comment', 'avid-magazine' ), __( '% comments', 'avid-magazine' ) ); ?></li>
					<?php } ?>
					...
					<?php
					wp_link_pages( array(
					'before' => '<div class="page-links">' . esc_html__( 'Pages:', 'avid-magazine' ),
					'after'  => '</div>',
					) );
					?>     
					</article>
