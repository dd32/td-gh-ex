  ...
  <header class="entry-header">
    ...
    <div class="entry-meta">
      ...
      <?php
				...
				$categories_list = get_the_category_list( __( ', ', 'best-corporate' ) );
				if ( $categories_list && best_corporate_categorized_blog() ) :
			?>
      <span class="cat-links"> <?php printf( __( 'in %1$s', 'best-corporate' ), $categories_list ); ?> </span> <span class="sep"> | </span>
...
?>
    ...
    <!-- .gallery-thumb -->
    <p><em><?php printf( _n( 'This gallery contains <a %1$s>%2$s photo</a>.', 'This gallery contains <a %1$s>%2$s photos</a>.', $total_images, 'best-corporate' ),
						'href="' . get_permalink() . '" title="' . sprintf( esc_attr__( 'Permalink to %s', 'best-corporate' ), the_title_attribute( 'echo=0' ) ) . '" rel="bookmark"',
