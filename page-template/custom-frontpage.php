	          				        ...
	          				        <div class="carousel-caption p-4">
							            <div class="inner_carousel pl-3">
							                ...
							                <?php if( get_theme_mod('advance_blogging_slider_content',true) != ''){ ?>
							                    <p class="m-0"><?php $excerpt = get_the_excerpt(); echo esc_html( advance_blogging_string_limit_words( $excerpt,esc_attr(get_theme_mod('advance_blogging_slider_excerpt','35')) ) ); ?></p>
							                <?php }?>
							            </div>
							        </div>
						        </div>
			              	...
			              	<?php while( $page_query->have_posts() ) : $page_query->the_post(); ?>
				              	<div class="abt-img-box">   
			                      	...
			                      	<div class="cat-box p-3">
			                      		<div class="cat-border pl-2">
				                       		<h2 class="p-0"><a href="<?php the_permalink(); ?>"><?php the_title(); ?><span class="screen-reader-text"><?php the_title(); ?></span></a></h2>
				                      		<p class="m-0"><?php $excerpt = get_the_excerpt(); echo esc_html( advance_blogging_string_limit_words( $excerpt,18 ) ); ?></p>
				                      	</div>
			                      	</div>
			                    </div>
			              	<?php endwhile;
