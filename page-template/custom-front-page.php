...
<?php /** post section **/ ?>
<section id="bride-groom" class="darkbox" >
  <?php if( get_theme_mod('bb_wedding_bliss_main_title') != ''){ ?>
      <div class="heading-line">
        <h3><?php echo esc_html(get_theme_mod('bb_wedding_bliss_main_title','')); ?> </h3>
        <img src="<?php echo esc_url( get_theme_mod('',get_template_directory_uri().'/images/border.png') ); ?>" alt="">
      </div>
    <?php } ?>
  <div class="container">
    <?php 
        $page_query = new WP_Query(array( 'category_name' => get_theme_mod('bb_wedding_bliss_bride_setting','theblog')));?>
        <?php while( $page_query->have_posts() ) : $page_query->the_post(); ?>
          <div class="col-md-6 col-sm-6"> 
            ...
            <div class="contentbox">
              <h4><?php the_title(); ?></h4>
              <p><?php the_excerpt(); ?></p>
              <div class="wow bounceInUp"><a href="<?php the_permalink(); ?>"><?php esc_html_e('Read More','bb-wedding-bliss'); ?></a>
              </div>
            </div>
          </div>
          <?php endwhile; 
