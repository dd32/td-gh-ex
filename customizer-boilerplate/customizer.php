 ...
 * Arrays of options
 */	
get_template_part( 'customizer-boilerplate/options' );

/**
 * Helper functions
 */	
get_template_part( 'customizer-boilerplate/helpers' );
...
function thsp_cbp_customize_register( $wp_customize ) {
	 ...
	 * Custom controls
	 */	
	get_template_part( 'customizer-boilerplate/custom-controls' );
