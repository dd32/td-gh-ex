<?php /* Template Name: Blog ( Small Thumbnails 2 ) */ ?>
...
<section class="content-main" role="main">
			...
			<div class="col-sm-8">
				...
				<div class="category-box category-box-blog col-sm-12">				
							...
							<li class="col-sm-3">							
								...
								<article <?php post_class('h-entry'); ?> id="post-<?php the_ID(); ?>">
									...
									<header class="entry-header">
										...
										<h5 class="entry-title"><a href="<?php the_permalink(); ?>" class="u-url" rel="bookmark"><?php the_title(); ?></a></h5>
