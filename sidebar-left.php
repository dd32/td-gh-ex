...
$navigation_active = ( 'nav-left-sidebar' == asura_get_navigation_location() ) ? true : false;
...
?>
<div id="left-sidebar" itemtype="https://schema.org/WPSideBar" itemscope="itemscope" <?php asura_left_sidebar_class(); ?>>
	<div class="inside-left-sidebar">
		<?php
		/**
		 * asura_before_left_sidebar_content hook.
		 *
		 */
		do_action( 'asura_before_left_sidebar_content' );
		...
		/**
		 * asura_after_left_sidebar_content hook.
		 *
		 */
		do_action( 'asura_after_left_sidebar_content' );
		?>
