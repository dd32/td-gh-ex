...
if (!function_exists('agency_ecommerce_product_columns')) {

	function agency_ecommerce_product_columns() {
...
add_filter('loop_shop_columns', 'agency_ecommerce_product_columns');

//=============================================================
// Change number of related product
//=============================================================

if (!function_exists('agency_ecommerce_related_products_args')) {

	function agency_ecommerce_related_products_args( $args ) {
...
add_filter( 'woocommerce_output_related_products_args', 'agency_ecommerce_related_products_args' );
...
add_action( 'woocommerce_after_single_product_summary', 'agency_ecommerce_output_upsells', 15 );

if ( ! function_exists( 'agency_ecommerce_output_upsells' ) ) {

	function agency_ecommerce_output_upsells() {
...
add_action( 'woocommerce_shop_loop_item_title', 'agency_ecommerce_woocommerce_template_loop_product_title', 10 );

if ( ! function_exists( 'agency_ecommerce_woocommerce_template_loop_product_title' ) ) {

	/**
	 * Show the product title in the product loop. By default this is an H2.
	 */
	function agency_ecommerce_woocommerce_template_loop_product_title() {
...
add_action( 'woocommerce_sidebar', 'agency_ecommerce_woocommerce_sidebar', 10 );

function agency_ecommerce_woocommerce_sidebar( ) {
...
add_filter( 'loop_shop_per_page', 'agency_ecommerce_new_loop_shop_per_page', 20 );

function agency_ecommerce_new_loop_shop_per_page( $cols ) {
...
add_filter( 'woocommerce_add_to_cart_fragments', 'agency_ecommerce_header_add_to_cart_fragment' );

function agency_ecommerce_header_add_to_cart_fragment( $fragments ) {
