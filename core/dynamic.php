...
if ( ! function_exists( 'agency_ecommerce_dynamic_options' ) ) :
    ...
    function agency_ecommerce_dynamic_options(){
        ...
        <style type="text/css">
            ...
            #home-page-widget-area .agency_ecommerce_widget_call_to_action .cta-widget-default .call-to-action-button a.button{
                background: <?php echo esc_attr( $primary_color ); ?>;
...
if( '#6c50fb' != $primary_color ){
    add_action( 'wp_head', 'agency_ecommerce_dynamic_options' );
}
