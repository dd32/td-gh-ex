...
if (!function_exists('suevafree_product_format_function')) {

	function suevafree_product_format_function() {
	...
	add_action( 'suevafree_product_format', 'suevafree_product_format_function', 10, 2 );
