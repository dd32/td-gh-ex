...
if (!function_exists('suevafree_service_format_function')) {

	function suevafree_service_format_function() {
	...
	add_action( 'suevafree_service_format', 'suevafree_service_format_function', 10, 2 );
