...
class IGthemes_Welcome {
   ...
   public function igthemes_welcome_admin_notice() {
    ...
    <div class="updated notice is-dismissible">
        <p>
            <?php echo esc_html__( 'Thanks for choosing ', 'basic-shop' ). wp_get_theme()->get( 'Name' );
            echo sprintf( esc_html__('! You can read documentation to how get the most out of your new theme on the %swelcome screen%s.', 'basic-shop' ), '<a href="' . esc_url( admin_url( 'themes.php?page=igthemes-welcome' ) ) . '">', '</a>' ); ?>
        </p>
        <p>
            <a href="<?php echo esc_url( admin_url( 'themes.php?page=igthemes-welcome' ) ); ?>" class="button button-primary" style="text-decoration: none;">
                <?php echo sprintf( esc_html__( 'Get started with %s', 'basic-shop' ), wp_get_theme()->get( "Name" ) ); ?>
            </a>
        </p>
    </div>
        <?php
    ...
    public function igthemes_welcome_style( $hook_suffix ) {
        if ( 'appearance_page_igthemes-welcome' == $hook_suffix ) {
            wp_enqueue_style( 'igthemes-welcome-screen', get_template_directory_uri() . '/core/welcome/css/welcome.css', '1.0' );
            wp_enqueue_script( 'igthemes-welcome-tab-script',  get_template_directory_uri() . '/core/welcome/js/tab.js' , '1.0' );
        }
    }
    ...
    public function igthemes_welcome_tabs() {
        require_once( get_template_directory() . '/core/welcome/sections/tabs.php' );
    }
    /**
     * Welcome screen getting-started
     */
    public function igthemes_welcome_getting_started() {
        require_once( get_template_directory() . '/core/welcome/sections/getting-started.php' );
    }
    /**
     * Welcome screen free resource
     */
    public function igthemes_welcome_wp_resources() {
        require_once( get_template_directory() . '/core/welcome/sections/wp-resources.php' );
    }
