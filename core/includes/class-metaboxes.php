		...
		public function metaboxes_panel() {
			...
			if (isset($field['type'])) : 
				...
				switch ( $field['type'] ) { 
					...
					<div class="wip_inputbox <?php echo $field['class']; ?>">
                        ...
                        <div class="input-right">
								...
								<div class="bool-slider <?php if ( novalite_postmeta($field['id']) != "") { echo stripslashes(novalite_postmeta($field['id'])); } else { echo $field['std']; } ?>">
					...
					<div class="wip_inputbox">
						...
						<div class="input-right">
							...
							<input data-hex="true" name="<?php echo $field['id']; ?>" id="<?php echo $field['id']; ?>" type="<?php echo $field['type']; ?>" value="<?php if ( novalite_postmeta($field['id']) != "") { echo novalite_postmeta($field['id']) ; } else { echo $field['std']; } ?>" style="width:90%"/>
						...
						<div class="input-right">
							...
							<select name="<?php echo $field['id']; ?>" id="<?php echo $field['id']; ?>" style="width:100%">
								...
								<?php foreach ($field['options'] as $option => $values) { ?>
                                    ...
                                    <option <?php if (( novalite_postmeta( $field['id'] ) == $option) || ( ( !novalite_postmeta($field['id'])) && ( $field['std'] == $option) )) { echo 'selected="selected"'; } ?> value="<?php echo $option; ?>"><?php echo $values; ?></option>
