...
if( !class_exists( 'avventura_lite_metaboxes' ) ) {

	class avventura_lite_metaboxes {
		...
		public function __construct( $posttype, $fields = array() ) {
			...
			add_action( 'save_post', array( &$this, 'avventura_lite_metaboxes_save' ) );
		}
		...
		public function metaboxes_panel() {
			...
			case 'navigation': ?>
				...
				<div id="tabs" class="avventura_lite_metaboxes">
			...
			if (isset($field['type'])) : 
				...
				switch ( $field['type'] ) { 
					...
					<h4 class="title"><?php echo esc_attr($field['name']); ?></h4>
					
					<?php break;
		
					case 'text':  ?>
					
					<div class="avventura_lite_inputbox">
						...
						<div class="input-right">
							...
							<input name="<?php echo esc_attr($field['id']); ?>" id="<?php echo esc_attr($field['id']); ?>" type="<?php echo esc_attr($field['type']); ?>" value="<?php if ( avventura_lite_postmeta( $field['id']) != "") { echo esc_html(avventura_lite_postmeta( $field['id'])); } ?>" />
					...
					<div class="avventura_lite_inputbox">
						...
						<div class="input-right">
							...
							<select name="<?php echo esc_attr($field['id']); ?>" id="<?php echo esc_attr($field['id']); ?>" >
								...
								<option <?php if ( avventura_lite_postmeta($field['id']) == $option || ( !avventura_lite_postmeta($field['id']) && $field['std'] == $option )) { echo 'selected="selected"'; } ?> value="<?php echo esc_attr($option); ?>"><?php echo esc_attr($values); ?></option><?php } ?>  
					...
					<div class="avventura_lite_inputbox">
                        ...
                        <div class="input-right">
                            ...
                            <textarea name="<?php echo esc_attr($field['id']); ?>" id="<?php echo esc_attr($field['id']); ?>" type="<?php echo esc_attr($field['type']); ?>" ><?php if ( avventura_lite_postmeta( $field['id']) != "") { echo stripslashes(avventura_lite_postmeta( $field['id'])); } ?></textarea>
		...
		public function avventura_lite_metaboxes_save() {
