...
if ( class_exists( 'WP_Customize_Control' ) ) {
	...
	class Diarjolite_Customize_Info_Control extends WP_Customize_Control {
        ...
        <h2><?php esc_html_e('WordPress Bundle.','diarjo-lite');?></h2>

          <p><?php esc_html_e("The premium version of Diarjo with other 17 premium WordPress themes and 5 premium WordPress plugins, starting at only €1.","diarjo-lite");?></p>

          <ul>

              <li><a class="button purchase-button" href="<?php echo esc_url( 'https://www.themeinprogress.com/wordpress-deal-bundle/?ref=2&campaign=diarjo-panel' ); ?>" title="<?php esc_attr_e('Get the bundle','diarjo-lite');?>" target="_blank"><?php esc_html_e('Get the bundle','diarjo-lite');?></a></li>
