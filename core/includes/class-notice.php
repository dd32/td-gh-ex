		...
		?>
            ...
            <div class="notice notice-warning is-dismissible">
            	...
            	<p>
            		...
            		<strong>
						...
						<?php
                            ...
                            esc_html_e( 'Upgrade to the premium version of Anna, to enable 600+ Google Fonts, unlimited sidebars, portfolio section and much more. ', 'anna-lite' ); 
            	...
            	<p>
                    ...
                    <a target="_blank" href="<?php echo esc_url( 'https://www.themeinprogress.com/anna-clean-wordpress-blog-and-shop-theme/?ref=2&campaign=anna-notice' ); ?>" class="button button-primary"><?php esc_html_e( 'Upgrade to Anna Premium', 'anna-lite' ); ?></a>
