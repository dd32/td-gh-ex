...
if( !class_exists( 'diarjo_lite_admin_notice' ) ) {
	...
	class diarjo_lite_admin_notice {
		...
		?>
            ...
            esc_html_e( 'The premium version of Diarjo with other 17 premium WordPress themes and 5 premium WordPress plugins, starting at only €1. ', 'diarjo-lite' );
                ...
                <a target="_blank" href="<?php echo esc_url( 'https://www.themeinprogress.com/wordpress-deal-bundle/?ref=2&campaign=diarjo-notice' ); ?>" class="button button-primary"><?php esc_html_e( 'Get the bundle', 'diarjo-lite' ); ?></a>
