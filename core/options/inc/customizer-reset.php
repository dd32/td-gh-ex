...
class IGthemes_Customizer_Reset {
        ...
        public function customize_controls_print_scripts() {
            wp_enqueue_script( 'igthemes-customizer-reset',  get_template_directory_uri() . '/core/options/js/customizer-reset.js', array( 'jquery' ), '20150120' );
            wp_localize_script( 'igthemes-customizer-reset', '_IGthemesCustomizerReset', array(
                'reset'   => __( 'Reset', 'basic-shop' ),
                'confirm' => __( "Attention! This will remove all customizations ever made via customizer to this theme!\n\nThis action is irreversible!", 'basic-shop' ),
                'nonce'   => array(
