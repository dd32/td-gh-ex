...
function agency_ecommerce_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			'name'     => esc_html__( 'One Click Demo Import', 'agency-ecommerce' ),
			'slug'     => 'one-click-demo-import',
			'required' => false,
		),
		array(
			'name'     => esc_html__( 'MailChimp for WordPress', 'agency-ecommerce' ),
			'slug'     => 'mailchimp-for-wp',
			'required' => false,
		),
		array(
			'name'     => esc_html__( 'Contact Form 7', 'agency-ecommerce' ),
			'slug'     => 'contact-form-7',
			'required' => false,
		),
		array(
			'name'     => esc_html__( 'YITH WooCommerce Wishlist', 'agency-ecommerce' ),
			'slug'     => 'yith-woocommerce-wishlist',
			'required' => false,
		),
		array(
			'name'     => esc_html__( 'Video Tab For WooCommerce', 'agency-ecommerce' ),
