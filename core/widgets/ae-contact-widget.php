...
if ( ! class_exists( 'Agency_Ecommerce_Contact_Widget' ) ) :
	 ...
	 * @since 1.0.0
	 */
	class Agency_Ecommerce_Contact_Widget extends WP_Widget {

		function __construct() {
			$opts = array(
					'classname'   => 'agency_ecommerce_widget_contact',
					'description' => esc_html__( 'Widget to display contact informations like address, email and phone with icon. Recommended to use in footer or sidebar only', 'agency-ecommerce' ),
			);
		...
		function form( $instance ) {
            ...
            <p>
    	        <small>
    	        	...
    	        	<?php printf( esc_html__( 'ET-LINE icons are used for icon of each blocks. You can find icon code %1$shere%2$s.', 'agency-ecommerce' ), '<a href="http://rhythm.nikadevs.com/content/icons-et-line" target="_blank">', '</a>' ); ?>
    	        </small>
            </p>

			<h4 class="widefat widget-custom-info">
                <span class="field-label"><strong><?php esc_html_e( 'Block #1', 'agency-ecommerce' ); ?></strong></span>
            </h4>

			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( "icon_one" ) ); ?>"><strong><?php esc_html_e( 'Icon:', 'agency-ecommerce' ); ?></strong></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_name('text_one') ); ?>">
					<?php esc_html_e('Text:', 'agency-ecommerce'); ?>
				</label>
			...
			<h4 class="widefat widget-custom-info">
                <span class="field-label"><strong><?php esc_html_e( 'Block #2', 'agency-ecommerce' ); ?></strong></span>
            </h4>

			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( "icon_two" ) ); ?>"><strong><?php esc_html_e( 'Icon:', 'agency-ecommerce' ); ?></strong></label>
			...
			<h4 class="widefat widget-custom-info">
                <span class="field-label"><strong><?php esc_html_e( 'Block #3', 'agency-ecommerce' ); ?></strong></span>
            </h4>

			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( "icon_three" ) ); ?>"><strong><?php esc_html_e( 'Icon:', 'agency-ecommerce' ); ?></strong></label>
			...
			<h4 class="widefat widget-custom-info">
                <span class="field-label"><strong><?php esc_html_e( 'Block #4', 'agency-ecommerce' ); ?></strong></span>
            </h4>

			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( "icon_four" ) ); ?>"><strong><?php esc_html_e( 'Icon:', 'agency-ecommerce' ); ?></strong></label>
