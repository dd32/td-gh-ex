...
if ( ! class_exists( 'Agency_Ecommerce_Latest_Products_Widget' ) ) :
	 ...
	 * @since 1.0.0
	 */
	class Agency_Ecommerce_Latest_Products_Widget extends WP_Widget {

	    function __construct() {
	    	$opts = array(
				'classname'   => 'agency_ecommerce_widget_latest_products',
	    ...
	    function form( $instance ) {
            ...
            <p>
              <label for="<?php echo esc_attr( $this->get_field_id( 'product_type' ) ); ?>"><strong><?php _e( 'Product Type:', 'agency-ecommerce' ); ?></strong></label>
    			<?php
	        ...
	        <p>
	        	<label for="<?php echo esc_attr( $this->get_field_name('product_number') ); ?>">
	        		<?php esc_html_e('Number of Products:', 'agency-ecommerce'); ?>
	        	</label>
