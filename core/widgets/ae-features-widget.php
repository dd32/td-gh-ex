...
if (!class_exists('Agency_Ecommerce_Features_Widget')) :
     ...
     * @since 1.0.0
     */
    class Agency_Ecommerce_Features_Widget extends WP_Widget {

        function __construct() {
            $opts = array(
                'classname' => 'agency_ecommerce_widget_features',
                'description' => esc_html__('Widget to display features with icon and description including one main image.', 'agency-ecommerce'),
            );
        ...
        function form($instance) {
            ...
            <h4 class="widefat widget-custom-info">
                <span class="field-label"><strong><?php esc_html_e('Feature #1', 'agency-ecommerce'); ?></strong></span>
            </h4>
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_name('feature_one')); ?>">
                    <?php esc_html_e('Title:', 'agency-ecommerce'); ?>
                </label>
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_name('text_one')); ?>">
                    <?php esc_html_e('Short Description:', 'agency-ecommerce'); ?>
                </label>
            ...
            <h4 class="widefat widget-custom-info">
                <span class="field-label"><strong><?php esc_html_e('Feature #2', 'agency-ecommerce'); ?></strong></span>
            </h4>
            ...
            <h4 class="widefat widget-custom-info">
                <span class="field-label"><strong><?php esc_html_e('Feature #3', 'agency-ecommerce'); ?></strong></span>
            </h4>
