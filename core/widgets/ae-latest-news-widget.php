 ...
 */
if (!class_exists('Agency_Ecommerce_Latest_News_Widget')) :
     ...
     * @since 1.0.0
     */
    class Agency_Ecommerce_Latest_News_Widget extends WP_Widget {

        function __construct() {
            $opts = array(
                'classname' => 'agency_ecommerce_widget_latest_news',
                'description' => esc_html__('Widget to dispaly latest posts with thumbnail, title, short content and read more link', 'agency-ecommerce'),
            );

            parent::__construct('agency-ecommerce-latest-news', esc_html__('AE: Latest News', 'agency-ecommerce'), $opts);
        }
                                    ...
                                    <div class="blog-inner">
                                        ...
                                        <div class="blog-text-wrap">
                                            ...
                                            <div class="entry-content">
                                                ...
                                                <?php
                                                $content = agency_ecommerce_get_the_excerpt(absint($excerpt_length));
        ...
        function form($instance) {
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('post_category')); ?>"><strong><?php esc_html_e('Select Category:', 'agency-ecommerce'); ?></strong></label>
                <?php
                $cat_args = array(
                    'orderby' => 'name',
                    'hide_empty' => 0,
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('exclude_categories')); ?>"><strong><?php esc_html_e('Exclude Categories:', 'agency-ecommerce'); ?></strong></label>
                ...
                <small>
                    <?php esc_html_e('Enter category id seperated with comma. Posts from these categories will be excluded from latest post listing.', 'agency-ecommerce'); ?>
                </small>
            </p>

            <p>
                <label for="<?php echo esc_attr($this->get_field_name('excerpt_length')); ?>">
                    <?php esc_html_e('Excerpt Length:', 'agency-ecommerce'); ?>
                </label>
            ...
            <p>
                ...
                <label for="<?php echo $this->get_field_id('disable_date'); ?>"><?php esc_html_e('Hide Posted Date', 'agency-ecommerce'); ?></label>
            </p>
            <?php
        }
