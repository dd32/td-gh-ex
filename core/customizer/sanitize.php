...
if (!function_exists('agency_ecommerce_sanitize_dropdown_pages')) :
     ...
     */
    function agency_ecommerce_sanitize_dropdown_pages($page_id, $setting)
    {
...
if (!function_exists('agency_ecommerce_sanitize_image')) :
     ...
     */
    function agency_ecommerce_sanitize_image($image, $setting)
    {
...
if (!function_exists('agency_ecommerce_sanitize_float_number_range')) :
     ...
     */
    function agency_ecommerce_sanitize_float_number_range($input, $setting)
    {
        ...
        return ($min <= $input && $input <= $max && is_float($input / $step) ? $input : $setting->default);

    }

endif;

if (!function_exists('agency_ecommerce_sanitize_number_range')) :
     ...
     * @return int|string The number, if it is zero or greater and falls within the defined range; otherwise, the setting default.
     */
    function agency_ecommerce_sanitize_number_range($input, $setting)
    {
...
if (!function_exists('agency_ecommerce_sanitize_textarea_content')) :
     ...
     */
    function agency_ecommerce_sanitize_textarea_content($input, $setting)
    {
...
//=============================================================
if (!function_exists('agency_ecommerce_sanitize_credit')) :
     ...
     * @return string Sanitized content.
     */
    function agency_ecommerce_sanitize_credit($input, $setting)
    {
