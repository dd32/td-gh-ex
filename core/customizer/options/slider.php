...
// Enable full width slider
$wp_customize->add_setting('theme_options[enable_fullwidth_slider]',
    array(
        'default' => $default['enable_fullwidth_slider'],
        'sanitize_callback' => 'agency_ecommerce_sanitize_checkbox',
    )
);
$wp_customize->add_control('theme_options[enable_fullwidth_slider]',
    array(
        'label' => esc_html__('Make full width slider?', 'agency-ecommerce'),
        'description' => esc_html__('This option allows you to make slider full width.', 'agency-ecommerce'),
        'section' => 'featured_slider_section',
        'type' => 'checkbox',
        'priority' => 100,
    )
...
$wp_customize->add_setting('theme_options[slider_adaptive_height]',
    array(
        'default' => $default['slider_adaptive_height'],
        'sanitize_callback' => 'agency_ecommerce_sanitize_checkbox',
    )
);
$wp_customize->add_control('theme_options[slider_adaptive_height]',
    array(
        'label' => esc_html__('Adaptive Height', 'agency-ecommerce'),
        'section' => 'featured_slider_section',
        'type' => 'checkbox',
    )
);
