	...
	function antreas_metadata_icons() {
		$icons_packs = array(
            'fontawesomeregular' => array(
                ...
                'icons' => antreas_metadata_fontawesome_regular(),
            ),
            ...
            'fontawesomesolid' => array(
                ...
                'icons' => antreas_metadata_fontawesome_solid(),
            ),
		);
		return apply_filters( 'antreas_metadata_icons', $icons_packs );
	}
}
if ( ! function_exists( 'antreas_check_fontawesome_compatibility') ) {
    function antreas_check_fontawesome_compatibility( $unicode ) {
...
if ( ! function_exists( 'antreas_metadata_fontawesome_regular') ) {
    function antreas_metadata_fontawesome_regular() {
...
if ( ! function_exists( 'antreas_metadata_fontawesome_solid' ) ) {
    function antreas_metadata_fontawesome_solid() {
