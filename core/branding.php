...
function cpotheme_branding_login(){
	$logo_url = cpotheme_get_option('cpo_login_logo');
	$bg_url = cpotheme_get_option('cpo_login_bg');
	$custom_css = cpotheme_get_option('cpo_login_css');
