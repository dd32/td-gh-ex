...
jQuery(document).ready(function ($) {
    ...
    $(".plugin-btn-wrapper .install").on('click', function (e) {
        ...
        var ajaxurl = accesspressparallaxWelcomeObject.ajaxurl;

        $.ajax({
            type: 'POST',
            url: ajaxurl,
            data: {
                action: 'accesspressparallax_plugin_installer',
                plugin: plugin,
                plugin_file: plugin_file,
                nonce: accesspressparallaxWelcomeObject.admin_nonce,
            },
            success: function (response) {
                ...
                if (response == 'success') {
                    ...
                    el.html(accesspressparallaxWelcomeObject.installed_btn);
    ...
    $('.install-offline').on('click', function (e) {
        ...
        $.ajax({
            ...
            url: ajaxurl,
            data: {
                action: 'accesspressparallax_plugin_offline_installer',
    ...
    $(".activate").on('click', function (e) {
        ...
        $.ajax({
            ...
            url: ajaxurl,
            data: {
                action: 'accesspressparallax_plugin_activation',
                plugin: plugin,
                nonce: accesspressparallaxWelcomeObject.activate_nonce,
                dataType: 'json'
            },
            success: function (response) {
                if (response) {
    ...
    $('.activate-offline').on('click', function (e) {
        ...
        $.ajax({
            ...
            url: ajaxurl,
            data: {
                action: 'accesspressparallax_plugin_offline_activation',
                plugin: plugin,
                nonce: accesspressparallaxWelcomeObject.activate_nonce,
                dataType: 'json'
            },
