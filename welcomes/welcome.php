            ...
            if ( is_admin() && ('themes.php' == $pagenow) && (isset( $_GET[ 'activated' ] )) ) {
                ...
                <div class="notice notice-success is-dismissible">
                    <p><?php
                        ...
                        printf( wp_kses_post( 'Welcome! Thank you for choosing %1$s! Please make sure you visit our <a href="%2$s">Welcome page</a> to get started with %1$s.', 'accesspress-parallax' ), esc_html( $this->theme_name ), esc_url( admin_url( 'themes.php?page=accesspressparallax-welcome' ) ) );
                        ?></p>
        ...
        public function accesspressparallax_welcome_screen() {
            ...
            <div class="wrap about-wrap access-wrap">
                <h1><?php
                    ...
                    printf( esc_html__( 'Welcome to %1$s - Version %2$s', 'accesspress-parallax' ), esc_html( $this->theme_name ), esc_html( $this->theme_version ) );
                    ?></h1>
                <div class="about-text"><?php
                    /* translators: Theme Name */
                    printf( esc_html__( '%s is a beautiful WordPress theme with Parallax design. Parallax design has become popular and is widely implemented these days. This is probably the most beautiful, feature rich and complete free WordPress parallax theme with useful features.', 'accesspress-parallax' ), esc_html( $this->theme_name ) );
                    ?></div>
