...
<div class="entry-author">
	<div class="author-avatar">
		 ...
		 */
		$anther_author_bio_avatar_size = apply_filters( 'anther_author_bio_avatar_size', 80 );

		echo get_avatar( get_the_author_meta( 'user_email' ), $anther_author_bio_avatar_size );
		?>
	</div><!-- .author-avatar -->
