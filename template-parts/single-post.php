...
<article  class="page-box-single">
	...
	<?php }?>
	<?php if( get_theme_mod( 'advance_business_show_featured_image_single_post',true) != '') { ?>
	...
	<?php if( get_theme_mod( 'advance_business_tags_hide',true) != '') { ?>
	...
	if ( is_singular( 'attachment' ) ) {
		...
		the_post_navigation( array(
			'next_text' => '<span class="meta-nav" aria-hidden="true">' . __( 'Next<i class="far fa-long-arrow-alt-right"></i>', 'advance-business' ) . '</span> ' .
				'<span class="screen-reader-text">' . __( 'Next post:', 'advance-business' ) . '</span> ' ,
			'prev_text' => '<span class="meta-nav" aria-hidden="true">' . __( '<i class="far fa-long-arrow-alt-left"></i> Previous', 'advance-business' ) . '</span> ' .
