...
<article id="post-<?php the_ID(); ?>" <?php post_class('inner-service'); ?>>
  <h2 class="ecomercepost-title"><a href="<?php echo esc_url( get_permalink() ); ?>" title="<?php the_title_attribute(); ?>"><?php the_title();?><span class="screen-reader-text"><?php the_title(); ?></span></a></h2>
  <div class="metabox">
  ...
  <div class="new-text">
    <div class="entry-content"><p><?php $excerpt = get_the_excerpt(); echo esc_html( bb_ecommerce_store_string_limit_words( $excerpt, esc_attr(get_theme_mod('bb_ecommerce_store_excerpt_number','20')))); ?></p></div>
    <div class="read-btn">
      <a href="<?php the_permalink();?>" class="blogbutton-small" title="<?php esc_attr_e( 'Read More', 'bb-ecommerce-store' ); ?>"><?php echo esc_html(get_theme_mod('bb_ecommerce_store_button_text','Read More'));?><span class="screen-reader-text"><?php esc_html_e( 'Read More','bb-ecommerce-store' );?></span></a>
    </div>
  </div>
