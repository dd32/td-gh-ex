					...
					<?php if ( has_category() ) : ?>
							<p class="categories-wrapper">
								<span class="category-icon">
									<?php esc_html_e('Categories:', 'ayapsychology'); ?>
								</span><!-- .category-icon -->
								<?php the_category( ' ' ) ?>
					...
					<?php if ( has_tag() ) : ?>
							<p class="tags-wrapper">
								<span class="tags-icon">
									<?php esc_html_e('Tags:', 'ayapsychology'); ?>
								</span><!-- .tags-icon -->
								<?php the_tags('', _x( ', ', 'Used between list items, there is a space after the comma.', 'ayapsychology' ), ''); ?>
							</p><!-- .tags-wrapper -->				
					<?php endif; ?>
