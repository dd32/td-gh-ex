...
<article id="post-<?php the_ID(); ?>" <?php post_class('badge-wrapper'); ?>>

	<?php if ( !is_single() && get_the_title() === '' ) : ?>

			<div class="badge clock-icon">
	...
	<?php if ( is_single() ) : ?>
				...
				<div class="content">
					<?php
						the_content( __( 'Read More...', 'ayahairsalon') );

						wp_link_pages( array(
							'before'      => '<div class="page-links"><span class="page-links-title">' . __( 'Pages:', 'ayahairsalon' ) . '</span>',
							'after'       => '</div>',
							'link_before' => '<span>',
							'link_after'  => '</span>',
						  ) );
	...
	<?php else : ?>
				...
				<div class="content">
					<?php the_content( __( 'Read More', 'ayahairsalon') ); ?>
				</div><!-- .content -->
	...
	<div class="after-content">
		...
		<?php edit_post_link( __( 'Edit', 'ayahairsalon' ), '<span class="edit-icon">', '</span>' ); ?>
