...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    ...
    <div class="entry-content post_body <?php echo (has_post_thumbnail() ? 'has_thumbnail' : 'no_thumbnail'); ?>">
        ...
        <div class="post_info_wrapper <?php echo get_post_format(); ?>">
            <?php
            the_content(sprintf(
                            wp_kses(
                                    /* translators: %s: Name of current post. Only visible to screen readers */
                                    __('Continue reading<span class="screen-reader-text"> "%s"</span>', 'aari'), array(
                'span' => array(
                    'class' => array(),
                ),
                                    )
        ...
        if (!is_singular()):
            ...
            <div class="post_bottom_meta">
                <div class="half_width">
                    <?php
                    gutenbergtheme_entry_footer();
                    ?>
                </div>
                <div class="half_width">
                    <div class="post_more">
                        <a href="<?php echo esc_url(get_permalink()); ?>">
                            <span class="icon1"><?php _e('Load More', 'aari'); ?></span>
