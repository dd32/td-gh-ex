...
<!--blog-box-->
      <article class="col-md-4 col-sm-4  eq-blocks">
        <div class="blog-box-inn"> <span><?php echo get_the_date('M d');?></span> 
          ...
          <?php the_category();?>
          <a href="<?php esc_url(the_permalink());?>" class="btn btn-default" style="background-color:<?php echo esc_attr(get_theme_mod( 'atoz_accent_color' ));?>"><?php esc_html_e('View', 'atoz'); ?></a> </div>
      </article>
