...
<a href="<?php echo get_author_posts_url( $post->post_author ); ?>"><?php echo $username->user_nicename; ?></a></span>
...
<span class="aqa-blog-cmnt"><i class="fa fa-comment"></i><a href="<?php comments_link(); ?>" target="_blank"><?php echo esc_html( 'Leave a Comment', 'aquaparallax' ); ?>
</a></span>
