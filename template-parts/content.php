					...
					<?php if ( has_category() ) : ?>
							<p class="categories-wrapper">
								<span class="icon category-icon">
									<?php esc_html_e('Categories:', 'ayamagazine'); ?>
								</span><!-- .category-icon -->
								<?php the_category( ' ' ) ?>
					...
					<?php if ( has_tag() ) : ?>
							<p class="tags-wrapper">
								<span class="icon tags-icon">
									<?php esc_html_e('Tags:', 'ayamagazine'); ?>
								</span><!-- .tags-icon -->
								<?php the_tags('', _x( ', ', 'Used between list items, there is a space after the comma.', 'ayamagazine' ), ''); ?>
							</p><!-- .tags-wrapper -->				
					<?php endif; ?>
