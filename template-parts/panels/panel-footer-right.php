...
<aside id="sidebar-<?php echo esc_attr($panel); ?>" class="<?php echo esc_attr(apply_filters( 'bathemos_style', "sidebar sidebar-{$panel}", "sidebar-{$panel}" )); ?> <?php echo esc_attr(apply_filters( 'bathemos_column_width', 'col-md-2', 'footer', $panel )); ?>">
