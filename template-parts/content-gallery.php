...
<article class="page-box">
  <h2><a href="<?php echo esc_url( get_permalink() ); ?>" alt="<?php the_title(); ?>" title="<?php the_title_attribute(); ?>"><?php the_title();?></a></h2>
  <div class="metabox">
  ...
  <div class="new-text">
    ...
    <div class="second-border">
      <a href="<?php echo esc_url( get_permalink() );?>" alt="<?php the_title(); ?>" title="<?php esc_attr_e( 'Read More', 'advance-ecommerce-store' ); ?>"><?php esc_html_e('Read More','advance-ecommerce-store'); ?><span class="screen-reader-text"><?php the_title(); ?></span></a>
    </div>
  </div>
