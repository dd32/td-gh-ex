...
<article class="page-box">
  ...
  <div class="new-text">
    ...
    <div class="second-border">
      <a href="<?php echo esc_url( get_permalink() );?>" title="<?php esc_attr_e( 'Read More', 'advance-portfolio' ); ?>"><?php esc_html_e('Read More','advance-portfolio'); ?><span class="screen-reader-text"><?php esc_html_e( 'Read More','advance-portfolio' );?></span></a>
    </div>
  </div>
