...
<?php 	elseif ( is_customize_preview() ):
			printf( '<h1>%1$s</h1><p>%2$s</p>',
					...
					__('To fill up this section you have to create some posts, choose the format "video" in Format and save. To put a picture before this section, use the parallax settings in the Customizer. To completely hide this section, choose "Hide Video Section" in the Customizer.', 'bassist') );
