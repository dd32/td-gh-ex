        ...
        <div class="entry-footer">
            ...
            <ul>
                ...
                <?php if( get_theme_mod( 'apex_business_share_twitter_icon_setting', 1 ) ) : ?>
                    <li><a href="https://twitter.com/share?url=<?php the_permalink(); ?>"><span class="fa-twitter"></span></a></li>
                <?php endif; ?>
                ...
                <?php if( get_theme_mod( 'apex_business_share_pinterest_icon_setting', 1 ) ) : ?>
