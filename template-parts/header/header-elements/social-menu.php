<ul class="social-menu text-right">
	...
	<?php if ( ! empty( $fb ) ): ?>
        <li><a href="<?php echo esc_url( $fb ); ?>"
               title="<?php echo esc_attr__( 'Visit us on Facebook', 'atlast-agency'); ?>">
	...
	<?php if ( ! empty( $tw ) ): ?>
        <li><a href="<?php echo esc_url( $tw ); ?>"
               title="<?php echo esc_attr__( 'Follow us on Twitter', 'atlast-agency'); ?>"> <span
                        class="fab fa-twitter"></span></a></li>
	<?php endif; ?>
	<?php if ( ! empty( $gp ) ): ?>
        <li><a href="<?php echo esc_url( $gp ); ?>"
               title="<?php echo esc_attr__( 'View our Google+ profile', 'atlast-agency'); ?>"><span
                        class="fab fa-google-plus"></span></a></li>
	<?php endif; ?>

	<?php if ( ! empty( $ln ) ): ?>
        <li><a href="<?php echo esc_url( $ln ); ?>"
               title="<?php echo esc_attr__( 'View our Linkedin profile', 'atlast-agency'); ?>"><span
                        class="fab fa-linkedin"></span></a></li>
	<?php endif; ?>
	<?php if ( ! empty( $in ) ): ?>
        <li><a href="<?php echo esc_url($in); ?>" title="<?php echo esc_attr__( 'Follow us on Instagram', 'atlast-agency'); ?>"><span
