        ...
        <div class="col-lg-5 col-md-5">
          <div class="social-media">
              ...
              <?php if( get_theme_mod( 'academic_education_instagram_url') != '') { ?>
                <a href="<?php echo esc_url( get_theme_mod( 'academic_education_instagram_url','' ) ); ?>"><i class="fab fa-instagram"></i><span class="screen-reader-text"><?php esc_attr_e( 'Instagram','academic-education' );?></span></a>
              <?php } ?>
