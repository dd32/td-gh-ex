                ...
                <article id="post-<?php the_ID(); ?>" <?php post_class(); ?> data-wow-duration="1s">
                   ...
                   ?>
                    ...
                    <div class="blog-content">
                       ...
                       <a class="blog-readmore-btn2" href="<?php the_permalink(); ?>"><?php if(class_exists('redux')){ echo  esc_html($axiohost['reade_more_label']); }else{ esc_html('Read More', 'axiohost');} ?></a>
                    </div>
                 </article>
            </div> 
        <?php endwhile;
