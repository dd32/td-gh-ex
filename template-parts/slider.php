 ...
 */
// Slider status.
$slider_status = agency_ecommerce_get_option('slider_status');
...
// Slider settings.
$slider_transition_effect = agency_ecommerce_get_option('slider_transition_effect');
$slider_transition_delay = agency_ecommerce_get_option('slider_transition_delay');
$slider_pager_status = agency_ecommerce_get_option('slider_pager_status');
$slider_autoplay_status = agency_ecommerce_get_option('slider_autoplay_status');

$slider_readmore_text = agency_ecommerce_get_option('slider_readmore_text');
...
for ($i = 1; $i <= $slider_number; $i++) {
    $page_id = agency_ecommerce_get_option("slider_page_$i");
    if (absint($page_id) > 0) {
