...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<header class="entry-header">
		...
		<span class="entry-meta">
			...
			<span class="comments-link">
				...
				<?php comments_popup_link( __( 'Leave a comment', 'aguafuerte' ), __( '1 Comment', 'aguafuerte' ), __( '% Comments', 'aguafuerte' ) ); ?>
			</span>
		<?php
			endif; ?>
		</span><!-- .entry-meta -->
	...
	<footer class="entry-footer">		
		...
		// Translators: There is a space after "by".
			printf( '<p class="written-by">' . __('This article was written by ', 'aguafuerte'). '<a href="%1$s">%2$s</a></p>',
				esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ),
				get_the_author() );
