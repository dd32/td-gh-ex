...
if ( '' != $tag_list ) {
$meta_text = __( '<i class="1 fa fa-tags"></i> Category %2$s   <a href="%3$s" title="Permalink to %4$s" rel="bookmark"> <i class="fa fa-link"></i></a>', 'beam' );
} else {
$meta_text = __( '<a href="%3$s" title="Permalink to %4$s" rel="bookmark"> <i class="fa fa-link"></i>Permalink</a>', 'beam' );
}

} else {
// But this blog has loads of categories so we should probably display them here
if ( '' != $tag_list ) {
$meta_text = __( '<p class="categories"><i class="fa fa-folder-open"></i> Categories %1$s </p> <p class="tags"><i class="2 fa fa-tags"></i> Tags %2$s </p> <p> <a href="%3$s" title="Permalink to %4$s" rel="bookmark"><i class="fa fa-link"></i>Permalink</a></p>', 'beam' );
} else {
$meta_text = __( '<i class="fa fa-folder-open"></i> %1$s  <a href="%3$s" title="Permalink to %4$s" rel="bookmark"><i class="fa fa-link"></i>Permalink</a>', 'beam' );
}
