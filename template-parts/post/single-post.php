...
<article id="post-<?php the_ID(); ?>" <?php post_class('inner-service'); ?>>
	...
	the_post_navigation( array(
		'next_text' => '<span class="meta-nav" aria-hidden="true">' . __( 'Next', 'academic-education' ) . '</span> ' .
				'<span class="screen-reader-text">' . __( 'Next post:', 'academic-education' ) . '</span> ' ,
			'prev_text' => '<span class="meta-nav" aria-hidden="true">' . __( 'Previous', 'academic-education' ) . '</span> ' .
