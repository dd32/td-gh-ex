    ...
    <div class="container">
      <div class="menubox">
        <div class="toggle-menu responsive-menu">
          <button role="tab" onclick="academic_education_resMenu_open()"><i class="fas fa-bars"></i><span class="screen-reader-text"><?php esc_html_e('Open Menu','academic-education'); ?></span></button>
        </div>
