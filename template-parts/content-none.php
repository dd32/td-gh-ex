...
<section class="no-results not-found">
	...
	<div class="page-content">
			...
			<p><?php
				printf(
					wp_kses(
						...
						__( 'Ready to publish your first post? <a href="%1$s">Get started here</a>.', 'fmi' ),
						array(
							'a' => array(
								'href' => array(),
							),
		...
		<?php elseif ( is_search() ) : ?>
			...
			<p><?php esc_html_e( 'It seems we can&rsquo;t find what you&rsquo;re looking for. Perhaps searching can help.', 'fmi' ); ?></p>
			<?php
				get_search_form();
