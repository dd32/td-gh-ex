...
?>
	<article id="post-<?php the_ID(); ?>" <?php post_class( 'cols cols-2' ); ?>>
		<div class="entry-content">
			...
			<?php if ( is_front_page() )  { the_excerpt(); } else { the_content( wp_kses_post( get_theme_mod( 'read_more_text', $abc_default_theme_options['read_more_text'] ) ) . ' <span class="screen-reader-text">' . get_the_title() . '</span>' ); } ?>
		</div>
