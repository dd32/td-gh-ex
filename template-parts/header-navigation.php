      ...
      <div class="menu-color">
        <div class="row ">
          ...
          <div class="col-lg-1 col-md-1">
            <a href="#" onclick="advance_startup_search_open()" class="search-box my-2 mx-0">
        ...
        <div class="serach_outer w-100 h-100 pt-2 px-0 pb-0">
          ...
          <a href="#maincontent" onclick="advance_startup_search_close()" class="closepop text-center">X<span class="screen-reader-text"><?php esc_html_e( 'serach-outer','advance-startup' );?></span></a>
        </div>
    </div>
  </div>
</div>