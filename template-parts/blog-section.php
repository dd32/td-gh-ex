...
$blog_description = $auto_car_settings['blog_description'];
        ...
        <div class="container">
            <div class="row">
                ...
                foreach ($blog_variable as $key => $blog_value) {
                    ...
                    echo '<h2>' . wp_kses_post(wp_trim_words($blog_value->post_title, 6)) . '</h2>';
                    echo '<p>' . wp_kses_post(wp_trim_words($content, 10)) . '</p>';
                }
                echo '</div>';
                    ...
                    <div class="col-md-4">
                        <div class="post-wrap">
                            ...
                            <div class="post-review">
                                ...
                                if($blog_meta == 'show-meta') {
                                    ...
                                    if ($comment_count >= 0 && comments_open()) {
                                        ...
                                        /* translators: %s: comment number */
                                            _n('<span>%s</span>', '<span>%s</span>', get_comments_number($post->ID), 'auto-car'), absint(number_format_i18n(get_comments_number($post->ID))));
                                        echo '</a></div>';
                                    }
                                ...
                                <p class="post-description"><?php echo wp_kses_post(auto_car_get_excerpt(get_the_ID(), 125)); ?></p>
                                <a href="<?php echo esc_url(get_the_permalink()); ?>"
                                   class="btn btn-default"><?php echo esc_html__('Read more', 'auto-car'); ?></a>
                            </div>
                        </div>
                    </div>
