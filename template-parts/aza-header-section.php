...
<section id="cover">
    <div class="header-image">
        <div class="container">
            <?php if( ! empty ( $aza_main_header ) || ! empty( $aza_secondary_header ) ) { ?>
                <div class="row heading-row">
                    <div class="col-md-12 text-center cover-text">
                        <?php

                        if( ! empty( $aza_main_header ) ){
                            echo "<h1>". esc_html( $aza_main_header )."</h1>";
                        }

                        if( ! empty( $aza_secondary_header ) ){
                            echo "<h2>". esc_html( $aza_secondary_header ) ."</h2>";
                        }
            ...
            <div class="row btn-row">
                <div class="col-lg-12 text-center">
                    ...
                    switch ( $aza_buttons_type ) {
                        ...
                        case 'normal_buttons':
                            if( ! empty( $aza_button_text_1 ) && ! empty($aza_button_link_2) ) { ?>
