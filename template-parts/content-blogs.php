...
<div class="single-post">
    <div class="info">
        <ul class="list-inline">
            ...
            <li><i class="fa fa-comments-o"></i> &nbsp; <?php comments_popup_link( __('zero comment','agency-x'), __('one comment','agency-x'), '% '.__('comments','agency-x') ); ?></li>
        </ul>
    </div>
    ...
    <div class="post-content">
        ...
        <article class="contents">
            <a href="<?php echo esc_url( get_permalink() ); ?>" rel="bookmark"><h1 class="post-title"><?php the_title(); ?></h1></a>
            <?php the_excerpt(); ?>
        </article>

        <div class="bottom-info">
            <a href="<?php echo esc_url( get_permalink() ); ?>" rel="bookmark" title="" class="btn btn-primary pull-left"><?php esc_html_e('Read More','agency-x'); ?> <i class="fa fa-angle-double-right"></i></a>
