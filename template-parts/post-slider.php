...
// Get cached post ids.
$post_ids = beetle_get_magazine_post_ids( 'post-slider', $theme_options['slider_category'], $theme_options['slider_limit'] );
...
<?php
	...
	remove_filter( 'excerpt_length', 'beetle_slider_excerpt_length' );
