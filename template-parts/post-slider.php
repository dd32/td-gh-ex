...
// Get cached post ids.
$post_ids = zeedynamic_get_magazine_post_ids( 'post-slider', $theme_options['slider_category'], $theme_options['slider_limit'] );
...
if ( $slider_query->have_posts() ) :
	...
	add_filter( 'excerpt_length', 'zeedynamic_slider_excerpt_length' );
...
<?php
	...
	remove_filter( 'excerpt_length', 'zeedynamic_slider_excerpt_length' );
