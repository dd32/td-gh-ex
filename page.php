...
<div class="metabox">
Posted by <?php the_author_posts_link () ?> |<?php the_time('M j, Y') ?> | 
<?php the_tags('Tags: ', ', ', '<br/>'); ?><?php comments_popup_link('No Comments &#187;', '1 Comment &#187;', '% Comments &#187;'); ?>	
</div>
<br style="clear:both" />&nbsp; 
<?php the_content(); ?>
...
<?php endwhile; ?>
<?php else : ?>
<div style="padding:0px 0px 0px 90px;"><h2 class="center"><?php echo  $bxx_404_title;?></h2><p class="center"><?php echo  $bxx_404_text;?></p></div>		
<?php endif; ?>
 </div>
<?php get_sidebar(); ?>
<?php get_footer(); ?>