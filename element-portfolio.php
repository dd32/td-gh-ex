...
<section class="portfolio-section">
	<div class="container">
		...
		if($arenabiz_portfolio_page_id){
			...
			} else echo '<img alt="'. the_title_attribute('echo=0') .'" src="'.get_template_directory_uri() . '/images/port'.$i.'.jpg'.'">';
					?>
							</figure>
							
							<header class="entry-header">
								<h4 class="entry-title"><?php if(the_title_attribute('echo=0') != NULL){ echo the_title_attribute('echo=0');} else echo __('Heading', 'arenabiz'); ?></h4>
							</header>	
