...
class Automotive_Centre_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $automotive_centre_font_awesome_icon_array = automotive_centre_font_awesome_icon_array();
                    foreach ($automotive_centre_font_awesome_icon_array as $automotive_centre_font_awesome_icon) {
                            $icon_class = $this->value() == $automotive_centre_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($automotive_centre_font_awesome_icon).'"></i>
                            <span class="automotive-centre-social-class">'.esc_attr($automotive_centre_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
if(!function_exists('automotive_centre_font_awesome_icon_array')){
    function automotive_centre_font_awesome_icon_array(){
