...
if( !function_exists( 'gridalicious_custom_breadcrumbs' ) ) :
	...
	function gridalicious_custom_breadcrumbs( $showOnHome, $delimiter ) {
		...
		$text['category'] = __( 'Archive for %s', 'gridalicious' ); // text for a category page
		$text['search']   = __( 'Search results for: %s', 'gridalicious' ); // text for a search results page
		$text['tag']      = __( 'Posts tagged %s', 'gridalicious' ); // text for a tag page
		$text['author']   = __( 'View all posts by %s', 'gridalicious' ); // text for an author page
