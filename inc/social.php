...
?>
	...
	<?php endif; ?>
	<!-- Dribbble-->
    <?php if ( false == esc_attr( get_theme_mod( 'avik_enable_dribbble_social', true ) )) : ?>
	<li><a href="<?php echo esc_url( get_theme_mod( 'avik_link_dribbble_social','#' )); ?>">
	<i class="fab fa-dribbble"></i></a></li>
	<?php endif; ?>
    <!-- Tumblr -->
	<?php if ( false == esc_attr( get_theme_mod( 'avik_enable_tumblr_social', true ) )) : ?>
	...
	<?php endif; ?>
    <!-- Youtube -->
    <?php if ( false == esc_attr( get_theme_mod( 'avik_enable_youtube_social', true) )) : ?>
	<li><a href="<?php echo esc_url( get_theme_mod( 'avik_link_youtube_social','#' )); ?>">
	<i class="fab fa-youtube-square"></i></a></li>
	<?php endif; ?>
	<!-- Pinterest -->
	<?php if ( false == esc_attr( get_theme_mod( 'avik_enable_pinterest_social',true ) )) : ?>
	<li><a href="<?php echo esc_url( get_theme_mod( 'avik_link_pinterest_social','#' )); ?>">
	<i class="fab fa-pinterest-p"></i></a></li>
	<?php endif; ?>
    <!-- Flickr -->
    <?php if ( false == esc_attr( get_theme_mod( 'avik_enable_flickr_social', true) )) : ?>
