...
function easy_customize_register($wp_customize){
    ...
    $wp_customize->add_section('easy_options', array(
		...
		'title'    		=> esc_html__('Easy OPTIONS', 'easy'),
    ...
    $wp_customize->add_control('easy_responsive', array(
        'label'      => esc_html__('Activate the Responsive Layout', 'easy'),
        'section'    => 'easy_options',
        'settings'   => 'easy[responsive]',
		'description' => esc_html__('You can Activate the Responsive Layout Checking This Box','easy'),
		'type' 		 => 'checkbox'
    ));
	
	$easy_contype = array( '1' => esc_html__('Full Content in Blog Page. Also Support Read More Button if inserted during Editing', 'easy'), '2' => esc_html__('Some Words and Read More Button in the Blog Page', 'easy'));
    ...
    $wp_customize->add_control('easy_contype', array(
        'label'      	=> esc_html__('Select the Content Type in the Blog Page', 'easy'),
        'section'    	=> 'easy_options',
        'settings'   	=> 'easy[contype]',
		'description' 	=> esc_html__('Select whether you want to show the Full / Selected Content or Some Words and Read More Button Automatically','easy'),
		'type' 		 	=> 'radio',
...
// +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ //
 	...
 	$wp_customize->add_section('easy_slide', array(
        'priority' 		=> 11,
		'capability'     => 'edit_theme_options',
		'title'    		=> esc_html__('&nbsp;&nbsp;&nbsp;&nbsp; - Front Page Slide', 'easy'),
        'description'   => ''
    ));	
...
//  Slide
    ...
    $wp_customize->add_control('easy_main-slide-show', array(
        'label'      => esc_html__('Show the Slider', 'easy'),
        'section'    => 'easy_slide',
        'settings'   => 'easy[main-slide-show]',
		'description' => esc_html__('You can show the Slider Checking This Box','easy'),
		'type' 		 => 'checkbox'
    ));
...
// +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ //
 ...
 $wp_customize->add_section('easy_head', array(
        'priority' 		=> 12,
		'capability'     => 'edit_theme_options',
		'title'    		=> esc_html__('&nbsp;&nbsp;&nbsp;&nbsp; - Front Page Heading', 'easy'),
        'description'   => ''
    ));	
...
// Front Page Heading
    ...
    $wp_customize->add_control('easy_heading_text' , array(
        'label'      => esc_html__('Front Page Heading', 'easy'),
        'section'    => 'easy_head',
...
// +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ //
 ...
 $wp_customize->add_section('easy_quote', array(
        'priority' 		=> 13,
		'capability'     => 'edit_theme_options',
		'title'    		=> esc_html__('&nbsp;&nbsp;&nbsp;&nbsp; - Front Page Bottom Quotation', 'easy'),
        'description'   => ''
    ));	
...
// Front Page Bottom Quotation
    ...
    $wp_customize->add_control('easy_bottom-quotation1' , array(
        'label'      => esc_html__('Front Page Bottom Quotation', 'easy'),
        'section'    => 'easy_quote',
...
// +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ //
 ...
 $wp_customize->add_section('easy_sociall', array(
        'priority' 		=> 14,
		'capability'     => 'edit_theme_options',
		'title'    		=> esc_html__('&nbsp;&nbsp;&nbsp;&nbsp; - Social Links', 'easy'),
        'description'   => esc_html__('Input Your Social Page Link. Example:', 'easy').' <b>http://wordpress.org/d5creation</b>',
    ));	
...
//  Social Links
    ...
    $wp_customize->add_control('easy_sl' . $numslinksn, array(
        'label'      => esc_html__('Social Link - ',  'easy'). $numslinksn,
