...
class best_minimalist_recent_posts extends WP_Widget {

	function __construct() {
        $widget_ops = array( 'classname' => 'widget_best_minimalist_recent_posts', 'description' => __('Displays recent blog entries.', 'best-minimalist') );
        parent::__construct( 'widget_best_minimalist_recent_posts', __('Recent Posts','best-minimalist'), $widget_ops );
    }
	...
	function form($instance) {
		...
		<p>
			<label for="<?php echo $this->get_field_id('widget_title'); ?>"><?php  _e('Title', 'best-minimalist'); ?>:
		...
		<p>
			<label for="<?php echo $this->get_field_id('number_of_posts'); ?>"><?php _e('Number of posts to display', 'best-minimalist'); ?>:
			...
			<small>(<?php _e('Defaults to 5 if empty','best-minimalist'); ?>)</small>
		</p>
		
		<?php
	}
}
register_widget('best_minimalist_recent_posts'); ?>