...
$semper_fi_lite_store_front_customizer_options_array = array(
    ...
    'store_front_enable' => array(
        ...
        'panel_priority'    => 4,
        'priority'          => 10,
        'section_title'     => __('General Simple Store Front Settings', 'semper-fi-lite'),
        'section_priority'  => 10,
    ...
    'store_front_front_title' => array(
        'default_options'  => array(
            1                   => __( 'Cutting Edge Code' , 'semper-fi-lite'), ),
        'description'       => array(
            1                   => '', ),
        'label'             => __('Title', 'semper-fi-lite'),
        'panel_title'       => __('Semper Fi &#8594; Store Front Title', 'semper-fi-lite'),
        'panel_priority'    => 4,
        'priority'          => 10,
        'section_title'     => __('General Simple Store Front Settings', 'semper-fi-lite'),
        'section_priority'  => 10,
        'selector'          => 'header.store-header h2',
        'type'              => 'text'),
    ...
    'store_front_product_enable' => array(
        'default_options'  => array(
            1                   => true,
            2                   => true,
            3                   => true,
        ...
        'description'       => array(
            ...
            9                   => '',
            10                  => '', ),
        'label'             => __('Display Product', 'semper-fi-lite'),
        'panel_title'       => __('Semper Fi &#8594; Store Front', 'semper-fi-lite'),
        'panel_priority'    => 4,
        'priority'          => 10,
        'section_title'     => __('~ Product', 'semper-fi-lite'),
        'section_priority'  => 11,
        'selector'          => 'article.store-front section section:nth-of-type(~)',
        'type'              => 'radio',
        'choices' => array(
            true             => 'Yes',
            false            => 'No', ) ),
    ...
    'store_front_title' => array(
        'default_options'  => array(
            1                   => __( 'HTML5' , 'semper-fi-lite'),
            2                   => __( 'CSS3' , 'semper-fi-lite'),
            3                   => __( 'No JavaScript' , 'semper-fi-lite'),
            4                   => __( 'WordPress Customizer' , 'semper-fi-lite'),
            5                   => __( 'Grid, Flex, and Font Scaling' , 'semper-fi-lite'),
            6                   => __( 'Moble First Responsive Design' , 'semper-fi-lite'),
            7                   => __( 'Woocommerce Shopping Cart' , 'semper-fi-lite'),
            8                   => __( 'Google Structured MicroData' , 'semper-fi-lite'),
            9                   => __( 'Schwarttzy' , 'semper-fi-lite'),
            9                   => __( 'Semper Fi Plus!' , 'semper-fi-lite'), ),
        'description'       => array(
            1                   => '',
            2                   => '',
            3                   => '',
    ...
    'store_front_text' => array(
        'default_options'  => array(
            1                   => __( "HTML5 is the latest evolution of the standard that defines HTML. The term represents two different concepts. It is a new version of the language HTML, with new elements, attributes, and behaviors, and a larger set of technologies that allows the building of more diverse and powerful Web sites and applications." , 'semper-fi-lite'),
            2                   => __( "Cascading Style Sheets (CSS) is a stylesheet language used to describe the presentation of a document written in HTML. CSS3 is the latest evolution of the Cascading Style Sheets language and aims at extending CSS2.1. It brings a lot of long-awaited novelties, like rounded corners, shadows, gradients, transitions or animations, as well as new layouts like multi-columns, flexible box, or grid layouts." , 'semper-fi-lite'),
            3                   => __( "JavaScript (JS) is a lightweight, interpreted, programming language with first-class functions. When setting up a WordPress a theme can run into JavaScript conflicts which would cause issues. Although a WordPress.org theme could avoid all possible conflicts with Plugins, WordPress Updates, and Custom Coding if JavaScript is never used." , 'semper-fi-lite'),
            4                   => __( "The Theme Customization API, added in WordPress 3.4, allows developers to customize and add controls to the 'Appearance' -> 'Customize' admin screen. A theme with automatically generated WordPress Customizer Controls would allow the rapid deployment of custom customizer features. Meaning, it would have one of the most powerful theme customizers ever thought up." , 'semper-fi-lite'),
            5                   => __( "The Flexible Box Module, usually referred to as flexbox, was designed as a one-dimensional layout model, and as a method that could offer space distribution between items in an interface and powerful alignment capabilities. The grid CSS property is a shorthand property that sets all of the explicit grid properties (grid-template-rows, grid-template-columns, and grid-template-areas), and all the implicit grid properties (grid-auto-rows, grid-auto-columns, and grid-auto-flow), in a single declaration. A theme that has true Font Scaling can display a perfect layout and perfectly legible fonts on every modern cell phone, tablet, computer, 8k TV monitor. The size of the screen's resolution would not matter." , 'semper-fi-lite'),
            6                   => __( "Historically, most web designers and their clients have approached the desktop side of any project first, while leaving the mobile part as a secondary goal that gets accomplished later. There are over 1.2 billion mobile web users worldwide. In the U.S., 25% of Web users are mobile-only. A theme that is designed as a mobile website first and desktop second would ensure the best compatibility no matter what the size of the screen the website is viewed on." , 'semper-fi-lite'),
            7                   => __( "In April 2017, a total of 1,986,324 websites used WooCommerce, also 23,724 of the worlds top million websites used WooComerce. Thats 0.5% of all websites or 2.8% of the top million websites. A WordPress theme customized with WooCommerce code has a clean and simple shopping cart experience ready to go. Making it easy to set up an e-commerce shop quickly and focus on the products instead of the website design." , 'semper-fi-lite'),
            8                   => __( "Google Search works hard to understand the content of a website. Structured data is a standardized format for providing information to a search engine to help with classifying the page content; for example, on a recipe page, what are the ingredients, the cooking time and temperature, the calories, and so on. With Structured Microdata coded into a website, it helps ensures the best possible search results. Structured data isn't something an SEO plugin can provide, only a theme author can code microdata." , 'semper-fi-lite'),
            9                   => __( "All of the themes on WordPress.org are created, developed, and maintained free of charge by the author. Theme developers are allowed to upsell their theme but displaying obtrusive upselling isn't allowed. Only one link on the top level in the customizer is allowed. This must be done using the customizer API (no injecting via JavaScript). Further unobtrusive links are allowed in a separate section." , 'semper-fi-lite'),
            10                  => __( "No options or panels/sections can be locked behind a paywall. All settings in a theme must work. Although a WordPress theme author could develop a plugin that integrates with the free theme using built-in hooks to add in additional options." , 'semper-fi-lite'), ),
        'description'       => array(
            1                   => '',
            2                   => '',
            3                   => '',
    ...
    'store_front_button_text' => array(
        'default_options'  => array(
            ...
            6                   => 'View the product page',
            7                   => 'View the product page',
            8                   => 'View the product page',
            9                   => 'View the product page',
            10                  => 'View the product page', ),
        'description'       => array(
            1                   => '',
            2                   => '',
            3                   => '',
            ...
            9                   => '',
            10                  => '', ),
        'label'             => __('Store Front Button Text', 'semper-fi-lite'),
        'panel_title'       => __('Semper Fi &#8594; Store Front', 'semper-fi-lite'),
        'panel_priority'    => 4,
        'priority'          => 10,
        'section_title'     => __('~ Product', 'semper-fi-lite'),
