...
class beenews_Hooks {
	...
	// 	 */
	// 	add_action( 'wp_ajax_beenews_get_attachment_image', array( $this, 'get_attachment_image' ) );
	// 	add_action( 'wp_ajax_nopriv_beenews_get_attachment_image', array( $this, 'get_attachment_image' ) );
	// 	/**
	// 	 * Custom body classes
	// 	 */
	...
	// 	$links = str_replace( '</a> (', '</a> <span class="beenews-cat-count">', $links );
	...
	// /**
	//  * Flush out the transients used in beenews_categorized_blog.
	//  */
	...
	// 	}
	// 	// Like, beat it. Dig?
	// 	delete_transient( 'beenews_categories' );
	// }
	...
	// 	return '<div class="beenews-video-container">' . $html . '</div>';
	// }
