...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'optimize' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'optimize' ),
		'repeat-y'  => __( 'Repeat Vertically', 'optimize' ),
		'repeat'    => __( 'Repeat All', 'optimize' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'optimize' ),
		'top center'    => __( 'Top Center', 'optimize' ),
		'top right'     => __( 'Top Right', 'optimize' ),
		'center left'   => __( 'Middle Left', 'optimize' ),
		'center center' => __( 'Middle Center', 'optimize' ),
		'center right'  => __( 'Middle Right', 'optimize' ),
		'bottom left'   => __( 'Bottom Left', 'optimize' ),
		'bottom center' => __( 'Bottom Center', 'optimize' ),
		'bottom right'  => __( 'Bottom Right', 'optimize')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'optimize' ),
		'fixed'  => __( 'Fixed in Place', 'optimize')
		);
