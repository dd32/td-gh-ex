...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'base' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'base' ),
		'repeat-y'  => __( 'Repeat Vertically', 'base' ),
		'repeat'    => __( 'Repeat All', 'base' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'base' ),
		'top center'    => __( 'Top Center', 'base' ),
		'top right'     => __( 'Top Right', 'base' ),
		'center left'   => __( 'Middle Left', 'base' ),
		'center center' => __( 'Middle Center', 'base' ),
		'center right'  => __( 'Middle Right', 'base' ),
		'bottom left'   => __( 'Bottom Left', 'base' ),
		'bottom center' => __( 'Bottom Center', 'base' ),
		'bottom right'  => __( 'Bottom Right', 'base')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'base' ),
		'fixed'  => __( 'Fixed in Place', 'base')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'base' ),
		'italic'      => __( 'Italic', 'base' ),
		'bold'        => __( 'Bold', 'base' ),
		'bold italic' => __( 'Bold Italic', 'base' )
		);
