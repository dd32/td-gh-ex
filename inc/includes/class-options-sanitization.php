...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'athenea' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'athenea' ),
		'repeat-y'  => __( 'Repeat Vertically', 'athenea' ),
		'repeat'    => __( 'Repeat All', 'athenea' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'athenea' ),
		'top center'    => __( 'Top Center', 'athenea' ),
		'top right'     => __( 'Top Right', 'athenea' ),
		'center left'   => __( 'Middle Left', 'athenea' ),
		'center center' => __( 'Middle Center', 'athenea' ),
		'center right'  => __( 'Middle Right', 'athenea' ),
		'bottom left'   => __( 'Bottom Left', 'athenea' ),
		'bottom center' => __( 'Bottom Center', 'athenea' ),
		'bottom right'  => __( 'Bottom Right', 'athenea')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'athenea' ),
		'fixed'  => __( 'Fixed in Place', 'athenea')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'athenea' ),
		'italic'      => __( 'Italic', 'athenea' ),
		'bold'        => __( 'Bold', 'athenea' ),
		'bold italic' => __( 'Bold Italic', 'athenea' )
		);
