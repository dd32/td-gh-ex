...
class Automobile_Car_Dealer_Icon_Changer extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <ul class="icon-list clearfix">
                    ...
                    foreach ($Automobile_Car_Dealer_Icon_Changer_array as $Automobile_Car_Dealer_Icon_Changer) {
                            $icon_class = $this->value() == $Automobile_Car_Dealer_Icon_Changer ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($Automobile_Car_Dealer_Icon_Changer).'"></i>
                            <span class="automobile-car-dealer-social-class">'.esc_attr($Automobile_Car_Dealer_Icon_Changer).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
if(!function_exists('Automobile_Car_Dealer_Icon_Changer_array')){
    function Automobile_Car_Dealer_Icon_Changer_array(){
        return array("", 
        "fab fa-500px",
