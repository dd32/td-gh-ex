...
class Advance_Blogging_Icon_Changer extends WP_Customize_Control{
      public $type = 'icon';
            ...
            <label>
                  ...
                  <ul class="icon-list">
                        <div class="social-icon-search">
                              <input class="socialInput" type="text" placeholder="<?php echo esc_attr('Search Icon', 'advance-blogging'); ?>">
                        </div>
                        <?php
                        $advance_blogging_font_awesome_icon_array = advance_blogging_font_awesome_icon_array();
                        foreach ($advance_blogging_font_awesome_icon_array as $advance_blogging_font_awesome_icon) {
                              $icon_class = $this->value() == $advance_blogging_font_awesome_icon ? 'icon-active' : '';
                              echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($advance_blogging_font_awesome_icon).'"></i>
                                    <span class="icons-class">'.esc_attr($advance_blogging_font_awesome_icon).'</span>
                              </li>';
                        }
                        ?>
                  </ul>
...
if(!function_exists('advance_blogging_font_awesome_icon_array')){
    function advance_blogging_font_awesome_icon_array(){
        return array("None", 
            "fab fa-500px",
