					...
					<div class="form-metabox">
						<form method="post" action="options.php">
							...
							if ( !empty($_GET['status']) && $_GET['status'] == 'imported' ) {
								echo '<div id="message" class="updated"><p>' . __('Import successful.','generate') . '</p></div>';
							}
							
							if ( !empty($_GET['status']) && $_GET['status'] == 'reset' ) {
								echo '<div id="message" class="updated"><p>' . __('Settings removed.','generate') . '</p></div>';
							}
							
							if ( !empty($_GET['settings-updated']) && $_GET['settings-updated'] == true ) {
								echo '<div id="message" class="updated"><p>' . __('Settings saved.','generate') . '</p></div>';
							}
							?>
