...
<h1>
	...
	echo esc_html( sprintf( __( 'Welcome to %1$s', 'bayn-lite' ), $this->theme->name, $this->theme->version ) );
	?>
</h1>
...
<p class="about-rating">
	...
	echo wp_kses_post( sprintf( __( 'Please rate us <a href="https://wordpress.org/support/theme/%1$s/reviews/?filter=5" target="_blank">&#9733;&#9733;&#9733;&#9733;&#9733;</a> on <a href="https://wordpress.org/support/theme/%1$s/reviews/?filter=5" target="_blank">WordPress.org</a> to help us spread the word. Thank you from GretaThemes!', 'bayn-lite' ), $this->slug ) );
	?>
</p>
