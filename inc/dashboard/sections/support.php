...
<div id="support" class="pk-tab-pane">
	<div class="feature-section two-col">
		<div class="col">
			...
			<a class="button button-primary" href='<?php echo esc_url( "https://www.pankogut.com/wordpress-themes/gump-pro/?utm_source=theme_dashboard&utm_medium=product_links&utm_campaign={$this->slug}_dashboard" ); ?>' target="_blank"><?php esc_html_e( 'Upgrade Now', 'gump' ); ?></a>
		</div>
		<div class="col">
