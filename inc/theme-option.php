<?php
if(is_admin()){
add_action( 'admin_menu', 'artikler_theme_theme_menu_page' );
function artikler_theme_theme_menu_page(){
...
if(isset($_POST['user_submit_url'])){
		...
		$user_adsense_180_150 		=  	$_POST['user_adsense_180_150'];
			...
			if(isset($get_row_theme_option_id_fb) || isset($get_row_theme_option_id_tw) || isset($get_row_theme_option_id_gp) || isset($get_row_theme_option_id_li) || isset($get_row_theme_option_id_ad_728_90)   || isset($get_row_theme_option_id_ad_200_200) || isset($get_row_theme_option_id_ad_180_150)   ){
