...
final class thebox_Custom_Colors {
	...
	public function __construct() {
		...
		add_action( 'wp_ajax_thebox_editor_styles',         array( $this, 'editor_styles_callback' ) );
		add_action( 'wp_ajax_no_priv_thebox_editor_styles', array( $this, 'editor_styles_callback' ) );
	}
	...
	public function customize_register( $wp_customize ) {
		...
		$wp_customize->add_control(
			new WP_Customize_Color_Control(
				...
				array(
					'label'    => esc_html__( 'Primary Color', 'thebox' ),
					'section'  => 'colors',
...
thebox_Custom_Colors::get_instance();
