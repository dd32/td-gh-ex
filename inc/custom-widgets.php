 ...
 * @since aThemes Widget Pack 1.0
 */
require ATHEMES_PATH . 'widgets/widget-fields.php';
 ...
 * @since athemes Widget Pack 1.0
 */
require ATHEMES_PATH . 'widgets/widget-preview-post.php';
 ...
 * @since athemes Widget Pack 1.0
 */
require ATHEMES_PATH . 'widgets/widget-social-icons.php';
 ...
 * @since athemes Widget Pack 1.0
 */
require ATHEMES_PATH . 'widgets/widget-media-embed.php';
 ...
 * @since athemes Widget Pack 1.0
 */
require ATHEMES_PATH . 'widgets/widget-flickr-stream.php';
 ...
 * @since athemes Widget Pack 1.0
 */
require ATHEMES_PATH . 'widgets/widget-tabs.php';