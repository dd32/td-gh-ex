 ...
 */
if( !class_exists( 'Asterion_Custom_WPCF7' ) ) {
    class Asterion_Custom_WPCF7 extends WP_Customize_Control {
        ...
        public function get_contact_forms() {
            ...
            if ( $this->active_callback() ) {
                ...
                if ( $wpcf7 ) {
                    ...
                    $contact_forms[0] = esc_html__('No contact forms found', 'asterion');
                }
            }
        ...
        public function render_content() {
            ...
            if ( is_array( $contact_forms ) && !empty( $contact_forms ) ) : ?>
                ...
                <select <?php esc_url( $this->link() ); ?> style="width:100%;">
                    <option value="default"><?php esc_html_e('Select a contact form', 'asterion');?></option>
                    <?php 
