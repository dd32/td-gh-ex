...
function automotive_centre_customize_preview_js() {
	wp_enqueue_script( 'automotive-centre-customizer', get_template_directory_uri() . '/inc/logo/js/customize-preview.js', array( 'jquery', 'customize-preview' ), '201709081119', true );
}
...
function automotive_centre_customize_controls_js() {
	wp_enqueue_script( 'automotive-centre-customizer-controls', get_template_directory_uri() . '/inc/logo/js/customize-controls.js', array( 'jquery', 'customize-preview' ), '201709071000', true );
}
