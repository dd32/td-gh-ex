    ...
    switch( $comment->comment_type ) :
        ...
        default : ?>
            ...
            <div class="comment-body row">
            	...
            	</div><!-- .comment-body__left -->

            	<div class="col-md-10 comment-body__right">
                <div class="row">
            		<h5 class="col-md-10 element-title comment__author"><?php comment_author(); ?></h5>
                    <span class="col-md-2 text-right"><?php edit_comment_link( __( 'Edit', 'bellini' ), '  ', '' ); ?></span>
