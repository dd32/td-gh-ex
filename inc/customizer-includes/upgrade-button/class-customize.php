 ...
 * @access public
 */
final class catchbase_upgrade_pro_customize {
	...
	public function sections( $manager ) {
		...
		$manager->register_section_type( 'catchbase_upgrade_pro_customize_section_pro' );

		// Register sections.
		$manager->add_section(
			new catchbase_upgrade_pro_customize_section_pro(
				$manager,
				'upgrade_button',
				array(
...
catchbase_upgrade_pro_customize::get_instance();
