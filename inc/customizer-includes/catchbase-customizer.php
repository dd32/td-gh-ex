 ...
 *
 * Catchbase Theme/Customizer Options
 *
 * @package Catchbase
 * 
 * @since Catchbase 1.0
...
function catchbase_customize_register( $wp_customize ) {
	...
	//Removing colors section as it is of no use to the theme
	...
	// Color Options
   	require_once( get_template_directory() . '/inc/customizer-includes/catchbase-customizer-color-options.php' );
