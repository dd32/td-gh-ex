 ...
 * @since Full Frame 1.9
 */
function gridalicious_sanitize_checkbox( $checked ) {
    // Boolean check.
 ...
 */
function gridalicious_sanitize_image( $image, $setting ) {
	/*
 ...
 *                    the setting default.
 */
function gridalicious_sanitize_number_range( $number, $setting ) {
 ...
 */
function gridalicious_sanitize_select( $input, $setting ) {
