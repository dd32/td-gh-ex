...
function beetle_theme_info_menu_link() {
	...
	add_theme_page(
		sprintf( esc_html__( 'Welcome to %1$s %2$s', 'beetle' ), $theme->display( 'Name' ), $theme->display( 'Version' ) ),
...
function beetle_theme_info_page() {
	...
	<div class="wrap theme-info-wrap">
		...
		<h1><?php printf( esc_html__( 'Welcome to %1$s %2$s', 'beetle' ), $theme->display( 'Name' ), $theme->display( 'Version' ) ); ?></h1>
		...
		<div id="getting-started">
			...
			<h3><?php printf( esc_html__( 'Getting Started with %s', 'beetle' ), $theme->display( 'Name' ) ); ?></h3>
			...
			<div class="columns-wrapper clearfix">
				...
				<div class="column column-half clearfix">
					...
					<div class="section">
						...
						<p>
							<a href="<?php echo esc_url( __( 'https://themezee.com/docs/beetle-documentation/', 'beetle' ) . '?utm_source=theme-info&utm_medium=button&utm_campaign=beetle&utm_content=documentation' ); ?>" target="_blank" class="button button-secondary">
					...
					<div class="section">
						...
						<p class="about">
							<?php printf( esc_html__( '%s makes use of the Customizer for all theme settings. Click on "Customize Theme" to open the Customizer now.', 'beetle' ), $theme->display( 'Name' ) ); ?>
						</p>
						<p>
							<a href="<?php echo wp_customize_url(); ?>" class="button button-primary"><?php esc_html_e( 'Customize Theme', 'beetle' ); ?></a>
						</p>
					</div>
		...
		<div id="more-features">
			...
			<div class="columns-wrapper clearfix">
				...
				<div class="column column-half clearfix">
					...
					<div class="section">
						<h4><?php esc_html_e( 'Pro Version Add-on', 'beetle' ); ?></h4>
				...
				<div class="column column-half clearfix">
					...
					<div class="section">
						<h4><?php esc_html_e( 'Recommended Plugins', 'beetle' ); ?></h4>
...
function beetle_theme_info_page_css( $hook ) {
	...
	wp_enqueue_style( 'beetle-theme-info-css', get_template_directory_uri() . '/assets/css/theme-info.css' );
