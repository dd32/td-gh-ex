...
function aglee_lite_customizer_themeinfo( $wp_customize ) {
	...
	$aglee_lite_desc_theme_opt .= "<strong>".__('PRO Plugins','aglee-lite')."</strong><br />";
        $aglee_lite_desc_theme_opt .= '<a target="_blank" href="'.esc_url('https://8degreethemes.com/wordpress-plugins/coming-soon-landing-page-and-maintenance-mode-wordpress-plugin/').'">'.__('Coming Soon Landing Page and Maintenance Mode WordPress Plugin','aglee-lite').'</a> <br />';
        $aglee_lite_desc_theme_opt .= '<a target="_blank" href="'.esc_url('https://8degreethemes.com/wordpress-plugins/8-degree-notification-bar-pro/').'">'.__('Premium Notification Bar Plugin - 8Degree Notification Bar PRO','aglee-lite').'</a> <br />';

	$aglee_lite_desc_theme_opt .= '<strong class="customize-text_editor">'.__('WordPress Resources','aglee-lite').'</strong><a class="red" target="_blank" href="'.esc_url('https://wpall.club/').'">'.__('WordPress Tutorials and Resources','aglee-lite').'</a> <br />';
