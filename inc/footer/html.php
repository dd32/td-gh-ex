...
<?php do_action( 'semperfi_footer_widgets_action' ) ?>    
            
            <section id="credit-to-schwarttzy">
                
                <p><?php $semperfi_theme_info = wp_get_theme(); echo __( 'Good Old Fashioned Hand Written WordPress Theme' , 'semper-fi-lite' ) . ' <a href="' . $semperfi_theme_info->get( 'ThemeURI' ) . '" title="' . $semperfi_theme_info->get( 'Name' ) . ' - v' . $semperfi_theme_info->get( 'Version' ) . '">' . $semperfi_theme_info->get( 'Name' ) . '</a> ' . __( 'by ' , 'semper-fi-lite' ) . '<a href="' . $semperfi_theme_info->get( 'AuthorURI' ) . '" title="Eric J Schwarz">' . $semperfi_theme_info->get( 'Author' ) . '</a>'; ?></p>
