...
$wp_customize->add_section( 'appdetail-testimonial-category', array(
    ...
    'title'          => esc_html__( 'Testimonial Section', 'appdetail' ),
    'description'    => esc_html__( 'Select the required category for the testimonial Recommended image for testimonial is 113X113', 'appdetail' ),
