<?php
if( ! function_exists( 'avid_magazine_register_custom_controls' ) ) :
/**
 * Register Custom Controls
*/
function avid_magazine_register_custom_controls( $wp_customize ) {
    ...
    $wp_customize->register_control_type( 'Avid_Magazine_Radio_Image_Control' );
    $wp_customize->register_control_type( 'Avid_Magazine_Select_Control' );
    $wp_customize->register_control_type( 'Avid_Magazine_Slider_Control' );
    $wp_customize->register_control_type( 'Avid_Magazine_Toggle_Control' );    
    $wp_customize->register_control_type( 'Avid_Magazine_Control_Sortable' );
    $wp_customize->register_control_type( 'Avid_Magazine_Multi_Check_Control' );
}
endif;
add_action( 'customize_register', 'avid_magazine_register_custom_controls' );