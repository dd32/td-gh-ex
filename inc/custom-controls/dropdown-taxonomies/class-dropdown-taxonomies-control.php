 ...
 */
class Avid_Magazine_Customize_Dropdown_Taxonomies_Control extends WP_Customize_Control {
  ...
  public function __construct( $manager, $id, $args = array() ) {
    ...
    $avid_magazine_taxonomy = 'category';
    ...
    $this->taxonomy = esc_attr( $avid_magazine_taxonomy );
