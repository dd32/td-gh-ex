<?php
	...
	if($advance_it_company_footer_content_font_size != false){
	...
	if($advance_it_company_footer_widget_bg_color != false){
	...
	if($advance_it_company_scroll_font_size_icon != false){
