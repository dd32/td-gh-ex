<?php
	...
	if($advance_business_theme_color != false){
		$custom_css .='#footer input[type="search"], #footer form.woocommerce-product-search button, #sidebar form.woocommerce-product-search button{';
    ...
    if($advance_business_theme_lay == 'With Background'){
		...
		$custom_css .='.page-box-single, #sidebar aside,.project_content{';
