<?php
	...
	if($advance_coaching_theme_color != false){
		$custom_css .='#footer input[type="search"],.primary-navigation ul ul, #footer form.woocommerce-product-search button, #sidebar form.woocommerce-product-search button{';
	...
	$custom_css .='#menu-sidebar, .primary-navigation ul ul a, .primary-navigation li a:hover, .primary-navigation li:hover a,.primary-navigation ul ul ul ul, .primary-navigation a:focus, .page-template-custom-front-page .primary-navigation a:focus, .page-template-custom-front-page .primary-navigation a:hover, .primary-navigation li a:hover, .primary-navigation li:hover a{
    ...
    if($advance_coaching_theme_lay == 'Default'){
		...
		$custom_css .='}';
		$custom_css .='@media screen and (max-width:1200px){
		.page-template-custom-front-page .menu-bar{';
			$custom_css .='padding-left:0;';
		$custom_css .='} }';
	}
	...
	if($advance_coaching_top_bottom_product_button_padding != false){
		$custom_css .='.woocommerce #respond input#submit, .woocommerce a.button, .woocommerce button.button, .woocommerce input.button, .woocommerce #respond input#submit.alt, .woocommerce a.button.alt, .woocommerce button.button.alt, .woocommerce input.button.alt, .woocommerce input.button.alt, .woocommerce button.button:disabled, .woocommerce button.button:disabled[disabled]{';
			$custom_css .='padding-top: '.esc_html($advance_coaching_top_bottom_product_button_padding).'px; padding-bottom: '.esc_html($advance_coaching_top_bottom_product_button_padding).'px;';
		$custom_css .='}';
	}
	...
	if($advance_coaching_left_right_product_button_padding != false){
		$custom_css .='.woocommerce #respond input#submit, .woocommerce a.button, .woocommerce button.button, .woocommerce input.button, .woocommerce #respond input#submit.alt, .woocommerce a.button.alt, .woocommerce button.button.alt, .woocommerce input.button.alt, .woocommerce input.button.alt, .woocommerce button.button:disabled, .woocommerce button.button:disabled[disabled]{';
			$custom_css .='padding-left: '.esc_html($advance_coaching_left_right_product_button_padding).'px; padding-right: '.esc_html($advance_coaching_left_right_product_button_padding).'px;';
		$custom_css .='}';
	}
	...
	if($advance_coaching_product_button_border_radius != false){
		$custom_css .='.woocommerce #respond input#submit, .woocommerce a.button, .woocommerce button.button, .woocommerce input.button, .woocommerce #respond input#submit.alt, .woocommerce a.button.alt, .woocommerce button.button.alt, .woocommerce input.button.alt, .woocommerce input.button.alt, .woocommerce button.button:disabled, .woocommerce button.button:disabled[disabled]{';
			$custom_css .='border-radius: '.esc_html($advance_coaching_product_button_border_radius).'px;';
		$custom_css .='}';
	}
	...
	if($advance_coaching_top_bottom_wooproducts_padding != false){
		$custom_css .='.woocommerce ul.products li.product, .woocommerce-page ul.products li.product{';
			$custom_css .='padding-top: '.esc_html($advance_coaching_top_bottom_wooproducts_padding).'px !important; padding-bottom: '.esc_html($advance_coaching_top_bottom_wooproducts_padding).'px !important;';
		$custom_css .='}';
	}
	...
	if($advance_coaching_left_right_wooproducts_padding != false){
		$custom_css .='.woocommerce ul.products li.product, .woocommerce-page ul.products li.product{';
			$custom_css .='padding-left: '.esc_html($advance_coaching_left_right_wooproducts_padding).'px !important; padding-right: '.esc_html($advance_coaching_left_right_wooproducts_padding).'px !important;';
		$custom_css .='}';
	}
	...
	if($advance_coaching_wooproducts_border_radius != false){
		$custom_css .='.woocommerce ul.products li.product, .woocommerce-page ul.products li.product{';
			$custom_css .='border-radius: '.esc_html($advance_coaching_wooproducts_border_radius).'px;';
		$custom_css .='}';
	}
	...
	if($advance_coaching_wooproducts_box_shadow != false){
		$custom_css .='.woocommerce ul.products li.product, .woocommerce-page ul.products li.product{';
			$custom_css .='box-shadow: '.esc_html($advance_coaching_wooproducts_box_shadow).'px '.esc_html($advance_coaching_wooproducts_box_shadow).'px '.esc_html($advance_coaching_wooproducts_box_shadow).'px #e4e4e4;';
		$custom_css .='}';
	}