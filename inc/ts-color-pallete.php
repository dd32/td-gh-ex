<?php
	...
	if($advance_education_stickyheader == true && get_theme_mod( 'advance_education_sticky_header', false) == false){
    	$advance_education_custom_css .='.fixed-header{';
    ...
    if($advance_education_stickyheader == true){
		...
		$advance_education_custom_css .='.fixed-header{';
			$advance_education_custom_css .='position:fixed;';
		$advance_education_custom_css .='} }';
    ...
    if($advance_education_slider == true){
		...
		$advance_education_custom_css .='@media screen and (max-width:575px) {';
		$advance_education_custom_css .='#scroll-top{';
			$advance_education_custom_css .='display:none !important;';
		$advance_education_custom_css .='} }';
	}
    ...
    if($advance_education_theme_lay == 'With Background'){
		$advance_education_custom_css .='.page-box,#sidebar .widget,.woocommerce ul.products li.product, .woocommerce-page ul.products li.product,.front-page-content,.background-img-skin{';
			$advance_education_custom_css .='background-color: #fff;';
		$advance_education_custom_css .='}';
	...
	if($advance_education_copyright_content_align != false){
		$advance_education_custom_css .='.copyright{';
			$advance_education_custom_css .='text-align: '.esc_html($advance_education_copyright_content_align).';';
		$advance_education_custom_css .='}';
	}
	...
	if($advance_education_footer_widget_bg_image != false){
		$advance_education_custom_css .='#footer{';
			$advance_education_custom_css .='background: url('.esc_html($advance_education_footer_widget_bg_image).');';
		$advance_education_custom_css .='}';
	}
