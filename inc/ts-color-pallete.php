<?php
	...
	$advance_business_custom_css .='input[type="submit"],.contact i,.woocommerce-message::before, #footer h3.widget-title a, #footer li a:hover,.primary-navigation a:hover, .primary-navigation li a:hover, .primary-navigation li:hover a,.primary-navigation ul ul a, .sf-arrows ul .sf-with-ul:after, .primary-navigation ul ul li:hover > a, .primary-navigation a:focus,#sidebar ul li a:hover, .page-box h2 a:hover, .metabox a:hover{';
		$advance_business_custom_css .='color: '.esc_attr($advance_business_theme_color).';';
	$advance_business_custom_css .='}';

	$advance_business_custom_css .='.page-box{';
		$advance_business_custom_css .='border-bottom-color: '.esc_attr($advance_business_theme_color).';';
	$advance_business_custom_css .='}';

	$advance_business_custom_css .='.woocommerce-message,.primary-navigation ul ul li:first-child{';
		$advance_business_custom_css .='border-top-color: '.esc_attr($advance_business_theme_color).';';
	$advance_business_custom_css .='}';
	...
	$advance_business_custom_css .='#footer input[type="search"], #footer form.woocommerce-product-search button, #sidebar form.woocommerce-product-search button, .second-border a:hover, #slider .inner_carousel .know-btn a:hover{';
		$advance_business_custom_css .='border-color: '.esc_attr($advance_business_theme_color).';';
	$advance_business_custom_css .='}';

	$advance_business_custom_css .='.main-menu-navigation .primary-navigation ul li a:hover{';
		$advance_business_custom_css .='color: '.esc_attr($advance_business_theme_color).'!important;';
	$advance_business_custom_css .='}';

	$advance_business_custom_css .='#comments input[type="submit"].submit, nav.woocommerce-MyAccount-navigation ul li{';
		$advance_business_custom_css .='background-color: '.esc_attr($advance_business_theme_color).'!important;';
	$advance_business_custom_css .='}';
	...
	background-image: linear-gradient(-90deg, #000 0%, '.esc_attr($advance_business_theme_color).' 120%);
		}';
	}
	$advance_business_custom_css .='}';
	...
	$advance_business_custom_css .='.new-text .second-border a,#slider .inner_carousel .know-btn a, #comments .form-submit input[type="submit"]{';
		$advance_business_custom_css .='border-radius: '.esc_attr($advance_business_button_border_radius).'px;';
	$advance_business_custom_css .='}';
	...
	$advance_business_custom_css .='.woocommerce #respond input#submit, .woocommerce a.button, .woocommerce button.button, .woocommerce input.button, .woocommerce #respond input#submit.alt, .woocommerce a.button.alt, .woocommerce button.button.alt, .woocommerce input.button.alt, .woocommerce input.button.alt, .woocommerce button.button:disabled, .woocommerce button.button:disabled[disabled], .woocommerce div.product form.cart .button{';
		$advance_business_custom_css .='padding-top: '.esc_attr($advance_business_top_bottom_product_button_padding).'px; padding-bottom: '.esc_attr($advance_business_top_bottom_product_button_padding).'px;';
	$advance_business_custom_css .='}';

	$advance_business_left_right_product_button_padding = get_theme_mod('advance_business_left_right_product_button_padding', 16);
	$advance_business_custom_css .='.woocommerce #respond input#submit, .woocommerce a.button, .woocommerce button.button, .woocommerce input.button, .woocommerce #respond input#submit.alt, .woocommerce a.button.alt, .woocommerce button.button.alt, .woocommerce input.button.alt, .woocommerce input.button.alt, .woocommerce button.button:disabled, .woocommerce button.button:disabled[disabled], .woocommerce div.product form.cart .button{';
		$advance_business_custom_css .='padding-left: '.esc_attr($advance_business_left_right_product_button_padding).'px; padding-right: '.esc_attr($advance_business_left_right_product_button_padding).'px;';
	$advance_business_custom_css .='}';

	$advance_business_product_button_border_radius = get_theme_mod('advance_business_product_button_border_radius', 0);
	$advance_business_custom_css .='.woocommerce #respond input#submit, .woocommerce a.button, .woocommerce button.button, .woocommerce input.button, .woocommerce #respond input#submit.alt, .woocommerce a.button.alt, .woocommerce button.button.alt, .woocommerce input.button.alt, .woocommerce input.button.alt, .woocommerce button.button:disabled, .woocommerce button.button:disabled[disabled]{';
		$advance_business_custom_css .='border-radius: '.esc_attr($advance_business_product_button_border_radius).'px;';
	$advance_business_custom_css .='}';
	...
	$advance_business_custom_css .='.woocommerce ul.products li.product, .woocommerce-page ul.products li.product{';
		$advance_business_custom_css .='padding-top: '.esc_attr($advance_business_top_bottom_wooproducts_padding).'px !important; padding-bottom: '.esc_attr($advance_business_top_bottom_wooproducts_padding).'px !important;';
	$advance_business_custom_css .='}';

	$advance_business_left_right_wooproducts_padding = get_theme_mod('advance_business_left_right_wooproducts_padding',0);
	$advance_business_custom_css .='.woocommerce ul.products li.product, .woocommerce-page ul.products li.product{';
		$advance_business_custom_css .='padding-left: '.esc_attr($advance_business_left_right_wooproducts_padding).'px !important; padding-right: '.esc_attr($advance_business_left_right_wooproducts_padding).'px !important;';
	$advance_business_custom_css .='}';

	$advance_business_wooproducts_border_radius = get_theme_mod('advance_business_wooproducts_border_radius',0);
	$advance_business_custom_css .='.woocommerce ul.products li.product, .woocommerce-page ul.products li.product{';
		$advance_business_custom_css .='border-radius: '.esc_attr($advance_business_wooproducts_border_radius).'px;';
	$advance_business_custom_css .='}';

	$advance_business_wooproducts_box_shadow = get_theme_mod('advance_business_wooproducts_box_shadow',0);
	$advance_business_custom_css .='.woocommerce ul.products li.product, .woocommerce-page ul.products li.product{';
		$advance_business_custom_css .='box-shadow: '.esc_attr($advance_business_wooproducts_box_shadow).'px '.esc_attr($advance_business_wooproducts_box_shadow).'px '.esc_attr($advance_business_wooproducts_box_shadow).'px #eee;';
	$advance_business_custom_css .='}';
	...
	if($advance_business_copyright_content_align != false){
		$advance_business_custom_css .='.copyright{';
			$advance_business_custom_css .='text-align: '.esc_attr($advance_business_copyright_content_align).';';
		$advance_business_custom_css .='}';
	}
	...
	$advance_business_custom_css .='.copyright p{';
		$advance_business_custom_css .='font-size: '.esc_attr($advance_business_footer_content_font_size).'px !important;';
	$advance_business_custom_css .='}';

	$advance_business_copyright_padding = get_theme_mod('advance_business_copyright_padding', 15);
	$advance_business_custom_css .='.copyright{';
		$advance_business_custom_css .='padding-top: '.esc_attr($advance_business_copyright_padding).'px; padding-bottom: '.esc_attr($advance_business_copyright_padding).'px;';
	$advance_business_custom_css .='}';
	...
	$advance_business_custom_css .='#footer{';
		$advance_business_custom_css .='background-color: '.esc_attr($advance_business_footer_widget_bg_color).';';
	$advance_business_custom_css .='}';
	...
	if($advance_business_footer_widget_bg_image != false){
		$advance_business_custom_css .='#footer{';
			$advance_business_custom_css .='background: url('.esc_attr($advance_business_footer_widget_bg_image).');';
		$advance_business_custom_css .='}';
	}
	...
	$advance_business_custom_css .='#scroll-top .fas{';
		$advance_business_custom_css .='font-size: '.esc_attr($advance_business_scroll_font_size_icon).'px;';
	$advance_business_custom_css .='}';

	// Slider Height 
	$advance_business_slider_image_height = get_theme_mod('advance_business_slider_image_height');
	$advance_business_custom_css .='#slider img{';
		$advance_business_custom_css .='height: '.esc_attr($advance_business_slider_image_height).'px;';
	$advance_business_custom_css .='}';
	...
	// slider overlay
	$advance_business_slider_overlay = get_theme_mod('advance_business_slider_overlay', true);
	if($advance_business_slider_overlay == false){
		$advance_business_custom_css .='#slider img{';
			$advance_business_custom_css .='opacity:1;';
		$advance_business_custom_css .='}';
	} 
	$advance_business_slider_image_overlay_color = get_theme_mod('advance_business_slider_image_overlay_color', true);
	if($advance_business_slider_overlay != false){
		$advance_business_custom_css .='#slider{';
			$advance_business_custom_css .='background-color: '.esc_attr($advance_business_slider_image_overlay_color).';';
		$advance_business_custom_css .='}';
	}
