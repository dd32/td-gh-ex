...
// css
	...
	if($advance_it_company_top_bottom_product_button_padding != false){
		$custom_css .='.woocommerce #respond input#submit, .woocommerce a.button, .woocommerce button.button, .woocommerce input.button, .woocommerce #respond input#submit.alt, .woocommerce a.button.alt, .woocommerce button.button.alt, .woocommerce input.button.alt, .woocommerce input.button.alt, .woocommerce input.button.alt, .woocommerce button.button:disabled, .woocommerce button.button:disabled[disabled]{';
			$custom_css .='padding-top: '.esc_html($advance_it_company_top_bottom_product_button_padding).'px; padding-bottom: '.esc_html($advance_it_company_top_bottom_product_button_padding).'px;';
		$custom_css .='}';
	}
	...
	if($advance_it_company_left_right_product_button_padding != false){
		$custom_css .='.woocommerce #respond input#submit, .woocommerce a.button, .woocommerce button.button, .woocommerce input.button, .woocommerce #respond input#submit.alt, .woocommerce a.button.alt, .woocommerce button.button.alt, .woocommerce input.button.alt, .woocommerce input.button.alt, .woocommerce input.button.alt, .woocommerce button.button:disabled, .woocommerce button.button:disabled[disabled]{';
			$custom_css .='padding-left: '.esc_html($advance_it_company_left_right_product_button_padding).'px; padding-right: '.esc_html($advance_it_company_left_right_product_button_padding).'px;';
		$custom_css .='}';
	}

	$advance_it_company_product_button_border_radius = get_theme_mod('advance_it_company_product_button_border_radius', 3);
	if($advance_it_company_product_button_border_radius != false){
		$custom_css .='.woocommerce #respond input#submit, .woocommerce a.button, .woocommerce button.button, .woocommerce input.button, .woocommerce #respond input#submit.alt, .woocommerce a.button.alt, .woocommerce button.button.alt, .woocommerce input.button.alt, .woocommerce input.button.alt, .woocommerce input.button.alt, .woocommerce button.button:disabled, .woocommerce button.button:disabled[disabled]{';
			$custom_css .='border-radius: '.esc_html($advance_it_company_product_button_border_radius).'px;';
		$custom_css .='}';
	}
	...
	if($advance_it_company_top_bottom_wooproducts_padding != false){
		$custom_css .='.woocommerce ul.products li.product, .woocommerce-page ul.products li.product{';
			$custom_css .='padding-top: '.esc_html($advance_it_company_top_bottom_wooproducts_padding).'px !important; padding-bottom: '.esc_html($advance_it_company_top_bottom_wooproducts_padding).'px !important;';
		$custom_css .='}';
	}

	$advance_it_company_left_right_wooproducts_padding = get_theme_mod('advance_it_company_left_right_wooproducts_padding',0);
	if($advance_it_company_left_right_wooproducts_padding != false){
		$custom_css .='.woocommerce ul.products li.product, .woocommerce-page ul.products li.product{';
			$custom_css .='padding-left: '.esc_html($advance_it_company_left_right_wooproducts_padding).'px !important; padding-right: '.esc_html($advance_it_company_left_right_wooproducts_padding).'px !important;';
		$custom_css .='}';
	}

	$advance_it_company_wooproducts_border_radius = get_theme_mod('advance_it_company_wooproducts_border_radius',0);
	if($advance_it_company_wooproducts_border_radius != false){
		$custom_css .='.woocommerce ul.products li.product, .woocommerce-page ul.products li.product{';
			$custom_css .='border-radius: '.esc_html($advance_it_company_wooproducts_border_radius).'px;';
		$custom_css .='}';
	}

	$advance_it_company_wooproducts_box_shadow = get_theme_mod('advance_it_company_wooproducts_box_shadow',0);
	if($advance_it_company_wooproducts_box_shadow != false){
		$custom_css .='.woocommerce ul.products li.product, .woocommerce-page ul.products li.product{';
			$custom_css .='box-shadow: '.esc_html($advance_it_company_wooproducts_box_shadow).'px '.esc_html($advance_it_company_wooproducts_box_shadow).'px '.esc_html($advance_it_company_wooproducts_box_shadow).'px #eee;';
		$custom_css .='}';
	}
