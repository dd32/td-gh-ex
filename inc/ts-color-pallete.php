<?php
	...
	if($bb_mobile_application_footer_content_font_size != false){
		$bb_mobile_application_custom_css .='#footer .copyright p{';
	...
	if($bb_mobile_application_footer_widget_bg_color != false){
	...
	if($bb_mobile_application_scroll_font_size_icon != false){
