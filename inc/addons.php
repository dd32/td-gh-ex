...
add_action( 'after_setup_theme', 'anderson_theme_addons_setup' );

function anderson_theme_addons_setup() {
	...
	add_theme_support( 'infinite-scroll', array(
		'type' 		=> 'click',
		'container' => 'content',
		'render'    => 'anderson_infinite_scroll_render',
	) );
...
add_action( 'wp_enqueue_scripts', 'anderson_theme_addons_scripts' );

function anderson_theme_addons_scripts() {
...
add_action( 'after_setup_theme', 'anderson_theme_addons_image_sizes' );
...
function anderson_theme_addons_image_sizes() {
	...
	add_image_size( 'themezee-related-posts', 520, 300, true );
 ...
 */
function anderson_infinite_scroll_render() {
...
} // anderson_infinite_scroll_render()