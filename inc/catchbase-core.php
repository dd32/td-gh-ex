...
if ( ! function_exists( 'catchbase_setup' ) ) :
	...
	function catchbase_setup() {
		 ...
		 */
		add_theme_support( 'custom-background_color', apply_filters( 'catchbase_custom_background_args', array(
...
function catchbase_scripts() {
	...
	//For genericons
	wp_enqueue_style( 'genericons', get_template_directory_uri() . '/css/genericons/genericons.css', false, '3.0.3' );
	 ...
	 */
	wp_enqueue_style( 'catchbase-responsive', get_template_directory_uri() . '/css/catchbase-responsive.css' );
	...
	function catchbase_favicon() {
		if( ( !$catchbase_favicon = get_transient( 'catchbase_favicon' ) ) ) {
			...
			if ( isset( $options[ 'favicon' ] ) &&  $options[ 'favicon' ] != '' &&  !empty( $options[ 'favicon' ] ) ) {
				...
				$catchbase_favicon = '<link rel="shortcut icon" href="'. get_template_directory_uri() .'/images/favicon.ico" type="image/x-icon" />';
			}
	...
	function catchbase_web_clip() {
		if( ( !$catchbase_web_clip = get_transient( 'catchbase_web_clip' ) ) ) {
			...
			if ( isset( $options[ 'web_clip' ] ) &&  $options[ 'web_clip' ] != '' &&  !empty( $options[ 'web_clip' ] ) ){
				...
				// if empty web_clip, display default web clip icon
				$catchbase_web_clip = '<link rel="apple-touch-icon-precomposed" href="'. get_template_directory_uri() .'/images/apple-touch-icon.png" />';
			}
	...
	function catchbase_archive_content_image() {
		...
		if ( '' == get_the_post_thumbnail() ) {
			...
			<figure class="featured-image <?php echo $featured_image; ?>">
	            <a href="<?php the_permalink(); ?>" title="<?php echo esc_attr( sprintf( __( 'Permalink to %s', 'catchbase' ), the_title_attribute( 'echo=0' ) ) ); ?>">
	                <?php 
						if ( is_front_page() && $featured_image == 'excerpt-featured-image' ) {
