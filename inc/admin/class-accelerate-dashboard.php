...
class Accelerate_Dashboard {
	...
	public function enqueue_scripts() {
		wp_enqueue_style( 'accelerate-admin-dashboard', ACCELERATE_CSS_URL . '/admin/dashboard.css' );
	}
	...
	public function create_menu() {
		...
		$page = add_theme_page( $theme_page_name, $theme_page_name, 'edit_theme_options', 'accelerate-options', array(
			$this,
			'option_page'
		) );
	...
	public function enqueue_styles() {
		wp_enqueue_style( 'accelerate-dashboard', ACCELERATE_CSS_URL . '/admin/dashboard.css', array(), ACCELERATE_THEME_VERSION );
	}
