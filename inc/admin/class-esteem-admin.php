...
if ( ! class_exists( 'Esteem_Admin' ) ) :
	...
	class Esteem_Admin {
		...
		public function admin_menu() {
			...
			$page = add_theme_page( esc_html__( 'About', 'esteem' ) . ' ' . $theme->display( 'Name' ), esc_html__( 'About', 'esteem' ) . ' ' . $theme->display( 'Name' ), 'activate_plugins', 'esteem-welcome', array(
				$this,
				'welcome_screen',
			) );
		...
		private function intro() {
			...
			<p class="esteem-actions">
				<a href="<?php echo esc_url( 'https://themegrill.com/themes/esteem/?utm_source=esteem-about&utm_medium=theme-info-link&utm_campaign=theme-info' ); ?>" class="button button-secondary" target="_blank"><?php esc_html_e( 'Theme Info', 'esteem' ); ?></a>
			...
			<h2 class="nav-tab-wrapper">
				<a class="nav-tab <?php if ( empty( $_GET['tab'] ) && $_GET['page'] == 'esteem-welcome' ) {
					echo 'nav-tab-active';
				} ?>" href="<?php echo esc_url( admin_url( add_query_arg( array( 'page' => 'esteem-welcome' ), 'themes.php' ) ) ); ?>">
					<?php echo $theme->display( 'Name' ); ?>
				</a>
				...
				<div class="changelog point-releases">
					<div class="under-the-hood two-col">
						<div class="col">
							...
							<p>
								<a href="<?php echo admin_url( 'customize.php' ); ?>" class="button button-secondary"><?php esc_html_e( 'Customize', 'esteem' ); ?></a>
							</p>
						</div>
						...
						<div class="col">
							...
							<p>
								<a href="<?php echo esc_url( 'https://docs.themegrill.com/esteem/?utm_source=esteem-about&utm_medium=documentation-link&utm_campaign=documentation' ); ?>" class="button button-secondary" target="_blank"><?php esc_html_e( 'Documentation', 'esteem' ); ?></a>
							</p>
						</div>
						...
						<div class="col">
							...
							<p>
								<a href="<?php echo esc_url( 'https://themegrill.com/support-forum/?utm_source=esteem-about&utm_medium=support-forum-link&utm_campaign=support-forum' ); ?>" class="button button-secondary" target="_blank"><?php esc_html_e( 'Support Forum', 'esteem' ); ?></a>
							</p>
						</div>
						...
						<div class="col">
							...
							<p>
								<a href="<?php echo esc_url( 'https://themegrill.com/contact/?utm_source=esteem-about&utm_medium=contact-page-link&utm_campaign=contact-page' ); ?>" class="button button-secondary" target="_blank"><?php esc_html_e( 'Contact Page', 'esteem' ); ?></a>
							</p>
						</div>
		...
		public function supported_plugins_screen() {
			...
			<div class="wrap about-wrap">
				...
				<ol>
					<li>
						<a href="<?php echo esc_url( 'https://wordpress.org/plugins/social-icons/' ); ?>" target="_blank"><?php esc_html_e( 'Social Icons', 'esteem' ); ?></a>
						<?php esc_html_e( ' by ThemeGrill', 'esteem' ); ?>
					</li>
					<li>
						<a href="<?php echo esc_url( 'https://wordpress.org/plugins/easy-social-sharing/' ); ?>" target="_blank"><?php esc_html_e( 'Easy Social Sharing', 'esteem' ); ?></a>
						<?php esc_html_e( ' by ThemeGrill', 'esteem' ); ?>
					</li>
					<li>
						<a href="<?php echo esc_url( 'https://wordpress.org/plugins/contact-form-7/' ); ?>" target="_blank"><?php esc_html_e( 'Contact Form 7', 'esteem' ); ?></a>
					</li>
					<li>
						<a href="<?php echo esc_url( 'https://wordpress.org/plugins/wp-pagenavi/' ); ?>" target="_blank"><?php esc_html_e( 'WP-PageNavi', 'esteem' ); ?></a>
					</li>
					<li>
						<a href="<?php echo esc_url( 'https://wordpress.org/plugins/breadcrumb-navxt/' ); ?>" target="_blank"><?php esc_html_e( 'Breadcrumb NavXT', 'esteem' ); ?></a>
					</li>
					<li>
						<a href="<?php echo esc_url( 'https://wordpress.org/plugins/woocommerce/' ); ?>" target="_blank"><?php esc_html_e( 'WooCommerce', 'esteem' ); ?></a>
						<?php esc_html_e( 'Fully Compatible in Pro Version', 'esteem' ); ?>
					</li>
					<li>
						<a href="<?php echo esc_url( 'https://wordpress.org/plugins/polylang/' ); ?>" target="_blank"><?php esc_html_e( 'Polylang', 'esteem' ); ?></a>
						<?php esc_html_e( 'Fully Compatible in Pro Version', 'esteem' ); ?>
					</li>
					<li>
						<a href="<?php echo esc_url( 'https://wpml.org/' ); ?>" target="_blank"><?php esc_html_e( 'WPML', 'esteem' ); ?></a>
						<?php esc_html_e( 'Fully Compatible in Pro Version', 'esteem' ); ?>
					</li>
				</ol>
