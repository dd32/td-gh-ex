...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'freedom' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'freedom' ),
		'repeat-y'  => __( 'Repeat Vertically', 'freedom' ),
		'repeat'    => __( 'Repeat All', 'freedom' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'freedom' ),
		'top center'    => __( 'Top Center', 'freedom' ),
		'top right'     => __( 'Top Right', 'freedom' ),
		'center left'   => __( 'Middle Left', 'freedom' ),
		'center center' => __( 'Middle Center', 'freedom' ),
		'center right'  => __( 'Middle Right', 'freedom' ),
		'bottom left'   => __( 'Bottom Left', 'freedom' ),
		'bottom center' => __( 'Bottom Center', 'freedom' ),
		'bottom right'  => __( 'Bottom Right', 'freedom')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'freedom' ),
		'fixed'  => __( 'Fixed in Place', 'freedom')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'freedom' ),
		'italic'      => __( 'Italic', 'freedom' ),
		'bold'        => __( 'Bold', 'freedom' ),
		'bold italic' => __( 'Bold Italic', 'freedom' )
		);
