...
//home_posts_per_page
    ...
    $wp_customize->add_control('home_posts_per_page', array(
        'label' => __('', 'basic-shop'),
        'description' => __('Change the number of posts showed in the home page.', 'basic-shop'),
        'type' => 'number',
        'section' => 'home-settings',
...
//home_portfolio_heading
    ...
    $wp_customize->add_control( new IGthemes_Heading( $wp_customize, 'home_portfolio_heading', array(
         'section' => 'home-settings',
         'label' => __( 'Portfolio section', 'basic-shop' ),
         'description' => __( 'To use this section you must download and install our free <a href="https://wordpress.org/plugins/ig-portfolio/" target="_blank">IG Portfolio</a> plugin.', 'basic-shop' ),
         'active_callback' => 'is_home',
    ) ) );
//home_portfolio
    ...
    $wp_customize->add_control('home_portfolio', array(
        'label' => __('Enable portfolio section?', 'basic-shop'),
        'description' => __('', 'basic-shop'),
        'type' => 'checkbox',
        'section' => 'home-settings',
...
//home_portfolio_description
    $wp_customize->add_setting('home_portfolio_description', array(
        'sanitize_callback' => 'igthemes_sanitize_text',
        'default' => __('See our latest works!', 'basic-shop'),
         'active_callback' => 'is_home',
    ));
    $wp_customize->add_control('home_portfolio_description', array(
        'label' => __('', 'basic-shop'),
        'description' => __('Section description', 'basic-shop'),
        'type' => 'textarea',
        'section' => 'home-settings',
...
//home_portfolio_tax
    ...
    $wp_customize->add_control('home_portfolio_tax', array(
        'label' => __('', 'basic-shop'),
        'description' => __('Write the slug of the category you want to show', 'basic-shop'),
        'type' => 'text',
        'section' => 'home-settings',
...
//home_testimonials_heading
    ...
    $wp_customize->add_control( new IGthemes_Heading( $wp_customize, 'home_testimonials_heading', array(
         'section' => 'home-settings',
         'label' => __( 'Testimonials section', 'basic-shop' ),
         'description' => __( 'To use this section you must download and install our free <a href="https://wordpress.org/plugins/ig-testimonals/" target="_blank">IG Testimonials</a> plugin.', 'basic-shop' ),
         'active_callback' => 'is_home',
    ) ) );
//home_testimonials
    ...
    $wp_customize->add_control('home_testimonials', array(
        'label' => __('Enable testimonials section?', 'basic-shop'),
        'description' => __('', 'basic-shop'),
        'type' => 'checkbox',
        'section' => 'home-settings',
...
//home_testimonials_title
    $wp_customize->add_setting('home_testimonials_title', array(
        'default' => __('What our clients says', 'basic-shop'),
         'sanitize_callback' => 'igthemes_sanitize_textarea',
    ));
    $wp_customize->add_control('home_testimonials_title', array(
        'label' => esc_html__('', 'basic-shop'),
        'description' => __('Section title', 'basic-shop'),
        'type' => 'text',
        'section' => 'home-settings',
...
//home_testimonials_description
    $wp_customize->add_setting('home_testimonials_description', array(
        'sanitize_callback' => 'igthemes_sanitize_text',
        'default' => __('We make every thing with best quality, our customers and partners are very happy!', 'basic-shop'),
    ));
