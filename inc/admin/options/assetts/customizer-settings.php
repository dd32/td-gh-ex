...
class IGthemes_Customizer {
    ...
    public function add_customizer_css() {
            ...
            h3.widget-title {
                background:'. igthemes_color_brightness($bg_color,-5) .';
                border: 1px solid '. igthemes_color_brightness($bg_color,8) .';
            }
            .site-header {
            ...
            .main-navigation ul ul {
               background:'. get_theme_mod( 'header_link_hover', $header_link_hover ) .';
            }
            .main-navigation ul li:hover > a {
                color: '. get_theme_mod( 'header_link_hover', $header_link_hover ) .';
            }
            .main-navigation ul ul.light a {
                color:'. igthemes_color_brightness( get_theme_mod('header_link_hover', $header_link_hover) ,-125) .';
            }
            .main-navigation ul ul.light a:hover {
                background:'.  igthemes_color_brightness( get_theme_mod('header_link_hover', $header_link_hover) , -5) .';
                color:'. igthemes_color_brightness( get_theme_mod('header_link_hover', $header_link_hover), -125) .';
            }
