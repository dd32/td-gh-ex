...
class Semplicemente_Admin {
	...
	public function admin_menu() {
		...
		$page = add_theme_page( esc_html__( 'About', 'semplicemente' ) . ' ' . $theme->display( 'Name' ), esc_html__( 'About', 'semplicemente' ) . ' ' . $theme->display( 'Name' ), 'activate_plugins', 'semplicemente-welcome', array( $this, 'welcome_screen' ) );
