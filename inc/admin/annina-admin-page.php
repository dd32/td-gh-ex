...
class Annina_Admin {
	...
	public static function hide_notices() {
		if ( isset( $_GET['annina-hide-notice'] ) && isset( $_GET['_annina_notice_nonce'] ) ) {
			if ( ! wp_verify_nonce( $_GET['_annina_notice_nonce'], 'annina_hide_notices_nonce' ) ) {
				wp_die( __( 'Action failed. Please refresh the page and retry.', 'annina' ) );
			}

			if ( ! current_user_can( 'manage_options' ) ) {
				wp_die( __( 'Cheatin&#8217; huh?', 'annina' ) );
			}

			$hide_notice = sanitize_text_field( $_GET['annina-hide-notice'] );
	...
	public function welcome_notice() {
		...
		<div id="message" class="updated cresta-message">
			...
			<p><?php printf( esc_html__( 'Welcome! Thank you for choosing Annina! To fully take advantage of the best our theme can offer please make sure you visit our %1$swelcome page%2$s.', 'annina' ), '<a href="' . esc_url( admin_url( 'themes.php?page=annina-welcome' ) ) . '">', '</a>' ); ?></p>
			<p class="submit">
		...
		<div class="cresta-theme-info">
			...
			<div class="welcome-description-wrap">
				...
				<p class="cresta-actions">
					<a href="<?php echo esc_url( 'http://crestaproject.com/downloads/annina/' ); ?>" class="button button-secondary" target="_blank"><?php esc_html_e( 'Theme Info', 'annina' ); ?></a>
			...
			<div class="changelog point-releases">
				<div class="under-the-hood two-col">
					<div class="col">
						...
						<p><a href="<?php echo admin_url( 'customize.php' ); ?>" class="button button-secondary"><?php esc_html_e( 'Customize', 'annina' ); ?></a></p>
					</div>
					...
					<div class="col">
						...
						<p><a target="_blank" href="<?php echo esc_url( 'http://crestaproject.com/downloads/annina/' ); ?>" class="button button-secondary"><?php esc_html_e( 'Info about PRO version', 'annina' ); ?></a></p>
					</div>
