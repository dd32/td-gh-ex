...
class Freedom_Dashboard {
	...
	public function enqueue_scripts() {
		wp_enqueue_style( 'freedom-admin-dashboard', get_template_directory_uri() . '/inc/admin/css/admin.css' );
	}
	...
	public function enqueue_styles() {
		wp_enqueue_style( 'freedom-dashboard', get_template_directory_uri() . '/inc/admin/css/admin.css', array(), FREEDOM_THEME_VERSION );
	}
	...
	public function option_page() {
		...
		<div class="freedom-header">
			<h1>
				...
				echo sprintf( esc_html__( 'Freedom %s', 'freedom' ), $theme->Version );
				?>
			</h1>
		</div>
		<div class="welcome-panel">
			<div class="welcome-panel-content">
				...
				<p class="about-description">
					<?php
					/* translators: %s: Theme Name. */
					echo sprintf( esc_html__( 'Important links to get you started with %s', 'freedom' ), $theme->Name );
					?>
				</p>
