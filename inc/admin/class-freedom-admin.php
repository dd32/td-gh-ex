	...
	class Freedom_Admin {
		...
		private function intro() {
			...
			<h2 class="nav-tab-wrapper">
				<a class="nav-tab <?php if ( empty( $_GET['tab'] ) && $_GET['page'] == 'freedom-welcome' ) {
					echo 'nav-tab-active';
				...
				<div class="changelog point-releases">
					<div class="under-the-hood two-col">
						<div class="col">
							...
							<p>
								<a href="<?php echo admin_url( 'customize.php' ); ?>" class="button button-secondary"><?php esc_html_e( 'Customize', 'freedom' ); ?></a>
							</p>
						</div>
		...
		public function supported_plugins_screen() {
			...
			<div class="wrap about-wrap">
				...
				<ol>
					<li>
						<a href="<?php echo esc_url( 'https://wordpress.org/plugins/social-icons/' ); ?>" target="_blank"><?php esc_html_e( 'Social Icons', 'freedom' ); ?></a>
						<?php esc_html_e( ' by ThemeGrill', 'freedom' ); ?>
					</li>
					<li>
						<a href="<?php echo esc_url( 'https://wordpress.org/plugins/easy-social-sharing/' ); ?>" target="_blank"><?php esc_html_e( 'Easy Social Sharing', 'freedom' ); ?></a>
						<?php esc_html_e( ' by ThemeGrill', 'freedom' ); ?>
					</li>
					<li>
						<a href="<?php echo esc_url( 'https://wordpress.org/plugins/everest-forms/' ); ?>" target="_blank"><?php esc_html_e( 'Everest Forms – Easy Contact Form and Form Builder', 'freedom' ); ?></a>
						<?php esc_html_e( ' by WPEverest', 'freedom' ); ?>
					</li>
					<li>
						<a href="<?php echo esc_url( 'https://wordpress.org/plugins/wp-pagenavi/' ); ?>" target="_blank"><?php esc_html_e( 'WP-PageNavi', 'freedom' ); ?></a>
					</li>
