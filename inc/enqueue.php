...
function apex_business_enqueue_cs_js() {
    ...
    wp_enqueue_style( 'lightbox', get_template_directory_uri() . '/assets/css/lightbox.min.css', array(), '1.9.0', 'all' );
    wp_enqueue_style( 'slick-theme', get_template_directory_uri() . '/assets/css/slick-theme.css', array(), '1.9.0', 'all' );
    wp_enqueue_style( 'animate', get_template_directory_uri() . '/assets/css/animate.css', array(), '1.9.0', 'all' );
    ...
    wp_enqueue_script( 'filterizr', get_template_directory_uri() . '/assets/js/jquery.filterizr.min.js', array( 'jquery' ), '1.9.0', true );
    wp_enqueue_script( 'slick-min', get_template_directory_uri() . '/assets/js/slick.min.js', array( 'jquery' ), '1.9.0', true );
    ...
    if ( get_theme_mod( 'apex_business_blog_layout_setting', 'list' ) == 'masonry' ) {
        wp_enqueue_script( 'masonry', get_template_directory_uri() . '/assets/js/masonry.pkgd.min.js', array( 'jquery' ), '1.9.0', true );
    }
