...
function semper_fi_lite_woo_commerce_functions() {
	
    
    add_action( 'semper_fi_lite_woo_commerce' , 'semper_fi_lite_wp_footer_html', 99 );
    ...
    add_action( 'semper_fi_lite_woo_commerce' , 'semper_fi_lite_woo_commerce_html' , 15 );
            
    add_action( 'semper_fi_lite_woo_commerce' , 'semper_fi_lite_page_css' , 1 );
    ...
    add_action( 'semper_fi_lite_woo_commerce' , 'semper_fi_lite_woo_commerce_css', 9 );
...
add_action( 'semper_fi_lite_functions_hook', 'semper_fi_lite_woo_commerce_functions' );
...
function semper_fi_lite_woocommerce_add_css_page() {
    ...
    if ( is_cart() || is_checkout() || is_woocommerce() ) {
        ...
        add_action( 'semper_fi_lite_page' , 'semper_fi_lite_woo_commerce_css' , 1 );
        
        remove_action( 'semper_fi_lite_page' , 'semper_fi_lite_video_tab' , 77 );
        
    }

}

add_action( 'semper_fi_lite_page', 'semper_fi_lite_woocommerce_add_css_page' , 0 );