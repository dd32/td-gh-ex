...
// Set section id
$section_id = $prefix.'_contact_section';
...
$wp_customize->add_section( $section_id,
    array(
        ...
        'description'       => esc_html__( 'Change contact us section information here.', 'asterion' ),
    )
);
...
$wp_customize->add_control(
    new Asterion_Custom_Text(
        ...
        array(
            ...
            'section'           => $section_id,
            'settings'          => $prefix .'_ot_widgets_install_8',
            'priority'          => 7,
