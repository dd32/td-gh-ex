...
if ( ! function_exists( 'bekko_archive_title' ) ) {
	add_action( 'bekko_archive_title', 'bekko_archive_title' );
	/**
	 * Build the archive title
	 *
	 */
	function bekko_archive_title() { ?>
		<header class="page-header<?php if ( is_author() ) echo ' clearfix';?>">
			<?php
			/**
			 * bekko_before_archive_title hook.
			 *
			 */
			do_action( 'bekko_before_archive_title' );
			?>
			...
			<?php
			/**
			 * bekko_after_archive_title hook.
			 *
			 */
			do_action( 'bekko_after_archive_title' );
			...
			/**
			 * bekko_after_archive_description hook.
			 *
			 */
			do_action( 'bekko_after_archive_description' ); ?>
		</header><!-- .page-header -->
		<?php
	}
}

if ( ! function_exists( 'bekko_filter_the_archive_title' ) ) {
	add_filter( 'get_the_archive_title', 'bekko_filter_the_archive_title' );
	/**
	 ...
	 */
	function bekko_filter_the_archive_title( $title ) {
		if ( is_category() ) {
