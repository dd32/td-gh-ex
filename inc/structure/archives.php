...
if ( ! function_exists( 'bhaga_archive_title' ) ) {
	add_action( 'bhaga_archive_title', 'bhaga_archive_title' );
	/**
	 * Build the archive title
	 *
	 */
	function bhaga_archive_title() { ?>
		<header class="page-header<?php if ( is_author() ) echo ' clearfix';?>">
			<?php
			/**
			 * bhaga_before_archive_title hook.
			 *
			 */
			do_action( 'bhaga_before_archive_title' );
			?>
			...
			<?php
			/**
			 * bhaga_after_archive_title hook.
			 *
			 */
			do_action( 'bhaga_after_archive_title' );
			...
			/**
			 * bhaga_after_archive_description hook.
			 *
			 */
			do_action( 'bhaga_after_archive_description' ); ?>
		</header><!-- .page-header -->
		<?php
	}
}

if ( ! function_exists( 'bhaga_filter_the_archive_title' ) ) {
	add_filter( 'get_the_archive_title', 'bhaga_filter_the_archive_title' );
	/**
	 ...
	 */
	function bhaga_filter_the_archive_title( $title ) {
		if ( is_category() ) {
