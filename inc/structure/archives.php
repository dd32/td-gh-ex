...
if ( ! function_exists( 'asagi_archive_title' ) ) {
	add_action( 'asagi_archive_title', 'asagi_archive_title' );
	/**
	...
	function asagi_archive_title() { ?>
		<header class="page-header<?php if ( is_author() ) echo ' clearfix';?>">
			<?php
			/**
			 * asagi_before_archive_title hook.
			 *
			 */
			do_action( 'asagi_before_archive_title' );
			?>
			...
			<?php
			/**
			 * asagi_after_archive_title hook.
			 *
			 */
			do_action( 'asagi_after_archive_title' );
			...
			/**
			 * asagi_after_archive_description hook.
			 *
			 */
			do_action( 'asagi_after_archive_description' ); ?>
		</header><!-- .page-header -->
		<?php
	}
}

if ( ! function_exists( 'asagi_filter_the_archive_title' ) ) {
	add_filter( 'get_the_archive_title', 'asagi_filter_the_archive_title' );
	/**
	 ...
	 */
	function asagi_filter_the_archive_title( $title ) {
		if ( is_category() ) {
