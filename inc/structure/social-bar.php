...
if ( ! function_exists( 'asura_social_bar' ) ) {
	add_action( 'asura_social_bar_action', 'asura_social_bar' );
	function asura_social_bar() {
		$socials_facebook_url  		=  asura_get_setting( 'socials_facebook_url' );
		$socials_twitter_url   		=  asura_get_setting( 'socials_twitter_url' );
		$socials_google_url    		=  asura_get_setting( 'socials_google_url' );
		$socials_tumblr_url    		=  asura_get_setting( 'socials_tumblr_url' );
		$socials_pinterest_url 		=  asura_get_setting( 'socials_pinterest_url' );
		$socials_youtube_url   		=  asura_get_setting( 'socials_youtube_url' );
		$socials_linkedin_url  		=  asura_get_setting( 'socials_linkedin_url' );
		$socials_custom_icon_1  	=  asura_get_setting( 'socials_custom_icon_1' );
		$socials_custom_icon_url_1  =  asura_get_setting( 'socials_custom_icon_url_1' );
		$socials_custom_icon_2  	=  asura_get_setting( 'socials_custom_icon_2' );
		$socials_custom_icon_url_2  =  asura_get_setting( 'socials_custom_icon_url_2' );
		$socials_custom_icon_3  	=  asura_get_setting( 'socials_custom_icon_3' );
		$socials_custom_icon_url_3  =  asura_get_setting( 'socials_custom_icon_url_3' );
		$socials_mail_url     		=  asura_get_setting( 'socials_mail_url' );
	?>
    <div class="asura-social-bar">
    	<ul class="asura-socials-list">
