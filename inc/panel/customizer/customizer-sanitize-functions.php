 ...
 */
function catchevolution_sanitize_checkbox( $input ) {
	if ( "1" == $input ) {
		return "1";
	}
	else {
 ...
 */
function catchevolution_sanitize_image( $image, $setting ) {
	/*
 ...
 * @since Catch Evolution 1.4
 */
function catchevolution_sanitize_post_id( $input ) {
 ...
 *                    the setting default.
 */
function catchevolution_sanitize_number_range( $number, $setting ) {
