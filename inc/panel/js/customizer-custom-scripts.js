...
(function($) {
    ...
    $('.preview-notice').prepend('<span id="adventurous_upgrade"><a target="_blank" class="button btn-upgrade" href="' + adventurous_misc_links.upgrade_link + '">' + adventurous_misc_links.upgrade_text + '</a></span>');
