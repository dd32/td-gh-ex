...
(function($) {
    ...
    $('.preview-notice').prepend('<span id="catchkathmandu_upgrade"><a target="_blank" class="button btn-upgrade" href="' + catchkathmandu_misc_links.upgrade_link + '">' + catchkathmandu_misc_links.upgrade_text + '</a></span>');
