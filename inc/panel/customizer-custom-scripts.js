 ...
 */
(function($) {
    $.each( catchevolution_data.reset_options, function( index, value ) {
            ...
            setting.bind( function( setting_value ) {
                ...
                if ( setting_value ) {
                    setting.notifications.add( code, new wp.customize.Notification(
                        ...
                        {
                            type: 'info',
                            message: catchevolution_data.reset_message
                        }
                    ) );
                } else {
    ...
    jQuery( document ).ready( function() {
        jQuery( '.customize-control-catchevolution_custom_checkbox input[type="checkbox"]' ).on( 'change', function() {
            checkbox_value = "0";
