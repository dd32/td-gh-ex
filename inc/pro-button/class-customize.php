...
final class Annina_Updgrade_Pro_Button {
	...
	public function enqueue_control_scripts() {
		...
		wp_enqueue_script( 'annina-customize-controls-pro-button', trailingslashit( get_template_directory_uri() ) . 'inc/pro-button/customize-controls.js', array( 'customize-controls' ) );

		wp_enqueue_style( 'annina-customize-controls-pro-button', trailingslashit( get_template_directory_uri() ) . 'inc/pro-button/customize-controls.css' );
	}
}

// Doing this customizer thang!
Annina_Updgrade_Pro_Button::get_instance();
