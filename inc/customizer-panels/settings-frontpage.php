...
$wp_customize->add_panel( 'ares_frontpage_panel', array(
    ...
    $wp_customize->add_section( 'ares_cta_trio_section', array(
        ...
        // CTA 1 - Icon
        $wp_customize->add_setting( 'ares[ares_cta1_icon]', array(
            'default' => 'fa fa-gears',
            'transport' => 'refresh',
        ...
        // CTA 1 - Title
        $wp_customize->add_setting( 'ares[ares_cta1_title]', array(
        ...
        // CTA 1 - Tagline
        $wp_customize->add_setting( 'ares[ares_cta1_text]', array(
        ...
        // CTA 1 - URL
        $wp_customize->add_setting( 'ares[ares_cta1_url]', array(
            'default'               => '',
            'transport'             => 'refresh',
            'sanitize_callback'     => 'sanitize_text_field',
            'type'                  => 'option'
        ...
        // CTA 1 - Link Text
        $wp_customize->add_setting( 'ares[ares_cta1_button_text]', array(
        ...
        // CTA 2 - Icon
        $wp_customize->add_setting( 'ares[ares_cta2_icon]', array(
        ...
        // CTA 2 - Title
        $wp_customize->add_setting( 'ares[ares_cta2_title]', array(
        ...
        // CTA 2 - Tagline
        $wp_customize->add_setting( 'ares[ares_cta2_text]', array(
        ...
        // CTA 2 - URL
        $wp_customize->add_setting( 'ares[ares_cta2_url]', array(
            'default'               => '',
            'transport'             => 'refresh',
            'sanitize_callback'     => 'sanitize_text_field',
            'type'                  => 'option'
        ...
        // CTA 2 - Link Text
        $wp_customize->add_setting( 'ares[ares_cta2_button_text]', array(
            'default'               => __( 'Click Here', 'ares' ),
            'transport'             => 'refresh',
            'sanitize_callback'     => 'sanitize_text_field',
            'type'                  => 'option'
        ...
        // CTA 3 - Icon
        $wp_customize->add_setting( 'ares[ares_cta3_icon]', array(
            'default' => 'fa fa-leaf',
            'transport' => 'refresh',
            'sanitize_callback' => 'ares_sanitize_icon',
            'type'                  => 'option'
        ...
        // CTA 3 - Title
        $wp_customize->add_setting( 'ares[ares_cta3_title]', array(
        ...
        // CTA 3 - Tagline
        $wp_customize->add_setting( 'ares[ares_cta3_text]', array(
        ...
        // CTA 3 - URL
        $wp_customize->add_setting( 'ares[ares_cta3_url]', array(
            'default'               => '',
            'transport'             => 'refresh',
            'sanitize_callback'     => 'sanitize_text_field',
            'type'                  => 'option'
        ...
        // CTA 3 - Link Text
        $wp_customize->add_setting( 'ares[ares_cta3_button_text]', array(
            'default'               => __( 'Click Here', 'ares' ),
            'transport'             => 'refresh',
            'sanitize_callback'     => 'sanitize_text_field',
            'type'                  => 'option'
