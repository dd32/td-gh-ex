...
function unite_register_required_plugins() {
   ...
   */
  $config = array(
    'domain'          => 'unite',           // Text domain - likely want to be the same as your theme.
    ...
    'strings'         => array(
      ...
      'installing'                            => __( 'Installing Plugin: %s', 'unite' ), // %1$s = plugin name
      ...
      'complete'                  => __( 'All plugins installed and activated successfully. %s', 'unite' ), // %1$s = dashboard link
