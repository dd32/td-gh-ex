	...
	<section class="align-blog" id="blog">
		<div class="container">
			<div class="mwa_title text-center">
				<h4 class="mwa-title"><?php echo esc_attr( $astral_blog_title ); ?></h4>
				<p class="sub-title"><?php echo esc_attr( $astral_blog_desc ); ?></p>
			</div>
						...
						<div class="swiper-slide">
							<div class="card h-100 wow bounceInRight" >
								<div class="card-header p-0  position-relative">
									...
									<span class="blog-date"><i class="fa fa-calendar"></i> <?php echo get_the_date( 'F j, Y' ); ?></span>
