...
class astral_Contact_Section extends astral_Abstract_Main {
	...
	<div class="parallax" style="background-image:url(<?php if( $contact_image ) { echo esc_url( $contact_image ); } else { echo esc_url( get_template_directory_uri() )."/images/inner.jpg"; } ?>)">
		<div class="abt_bottom py-lg-5 " id="contact">
			<div class="container">
				<div class="mwa_title text-center">
					<h4 class="mwa-title"> <?php echo esc_attr( $astral_contact_title ); ?> </h4>
				</div>
						...
						<div class="flip-card">
						  <div class="flip-card-inner">
							...
							<div class="flip-card-back">
							  ...
							  <p><?php echo esc_attr( $astral_phoneno ); ?></p><br>
							</div>
						  </div>
						</div>
					</div>
						  ...
						  <div class="flip-card-inner">
							...
							<div class="flip-card-back">
							  <h3><?php esc_html_e( 'Location', 'astral'); ?></h3>
								<p><?php echo esc_attr( $astral_address ); ?></p><br>
							</div>
						  </div>
						</div>
					</div>
						  ...
						  <div class="flip-card-inner">
							...
							<div class="flip-card-back">
							  <h3><?php esc_html_e( 'E-mail', 'astral'); ?></h3>
								<p><?php echo esc_attr( $astral_email ); ?></p><br>
							</div>
						  </div>
						</div>
					</div>
