	...
	<section class="align-about" id="about">
		<div class="container">
			<div class="mwa_title text-center">
					<h4 class="mwa-title"><?php echo esc_attr( $astral_service_title ); ?></h4>
					<p class="sub-title"><?php echo esc_attr( $astral_service_desc ); ?></p>
			</div>
			<div class="row">
				<?php for($i=1;$i<4;$i++) {
					...
					<div class="col-lg-4 col-sm-6 wow bounceInLeft">
						<div class="abt-grid" >
							<div class="row">
								...
								<div class="col-9">
									<div class="abt-txt">
										<h4><a href="<?php echo esc_url( $service_link ); ?>" target="_blank">											<?php echo esc_attr( $service_title ); ?></a></h4>
										<p><?php echo esc_attr( $service_desc ); ?></p>
									</div>
								</div>
							</div>
						</div>
