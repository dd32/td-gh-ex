...
class astral_Callout_Section extends astral_Abstract_Main {
    ...
    <div class="abt_bottom py-lg-5 mwa-theme" id="callout">
        <div class="container py-sm-4 py-3">
            <h4 class="abt-text text-capitalize text-sm-center mb-0"><?php echo esc_attr( $callout_title ); ?></h4>
            <p class="color-white text-sm-center "><?php echo esc_attr( $callout_desc ); ?></p>
            <div class="d-sm-flex justify-content-center">
                <a href="<?php echo esc_url( esc_attr( $callout_link_1 ) ); ?>" class="btn  mt-sm-4 mt-3 ml-3 mwa_link_bnr wow fadeInLeft" >
                    <?php esc_html_e( 'View More', 'astral' ); ?></a>
                <a href="<?php echo esc_url( esc_attr( $callout_link_2 ) ); ?>" class="btn  mt-sm-4 mt-3 ml-3 mwa_link_bnr scroll wow fadeInRight" >
