		...
		<div class="swiper-container" id="mwa_banner_slider">
			<div class="swiper-wrapper">
				<?php for($i=1;$i<4;$i++) {
					...
					?>
					<div class="swiper-slide" style="background-image:url(<?php echo esc_url( $slider_image ); ?>)">
						<div class="container banner-text">
							<div class="slider-info wow fadeInLeft">
								<h3><?php echo esc_attr( $slider_title ); ?></h3>
								<span class="line"></span>
								<p><?php echo esc_attr( $slider_desc ); ?></p>
								
								<?php if( $slider_link ) { ?>
								<a class="btn mwa-theme mt-4 mwa_link_bnr scroll" href="<?php echo esc_url( '$slider_desc' ); ?>" role="button"><?php esc_html_e( 'View More','astral' ); ?></a>
								<?php } ?>
							</div>
						</div>
					</div>
