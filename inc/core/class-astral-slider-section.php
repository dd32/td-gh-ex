...
class astral_Slider_Section extends astral_Abstract_Main {
	...
	?>
	<?php if(get_post_thumbnail_id($post1)!='' || get_post_thumbnail_id($post2)!='' || get_post_thumbnail_id($post3)!='') {  ?>
            <div class="swiper-container" id="mwa_banner_slider">
                <div class="swiper-wrapper">
				<?php 
				if(get_theme_mod('astral_dropdown_pages_1')!='' || get_theme_mod('astral_dropdown_pages_2')!='' || get_theme_mod('astral_dropdown_pages_3')!='') {
				$args = array( 
				'post_type' => 'page',
				'post_status'=>'publish', 
