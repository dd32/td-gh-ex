			...
			<div class="row">
				...
				<div class="col-md-6 col-sm-12 social">
					<ul class="social-network social-circle">
						...
						<li><a target="_blank" href="<?php echo esc_url( $facebook_link ); ?>" class="icoFacebook" title="Facebook"><i class="fa fa-facebook"></i></a>
						</li> <?php } ?>
						<?php if( get_theme_mod( 'twitter_link' ) ) { ?>
						<li><a target="_blank" href="<?php echo esc_url( $twitter_link ); ?>" class="icoTwitter" title="Twitter"><i class="fa fa-twitter"></i></a>
						</li> <?php } ?>
						<?php if( get_theme_mod( 'googleplus_link' ) ) { ?>
						<li><a target="_blank" href="<?php echo esc_url( $googleplus_link ); ?>" class="icoGoogle" title="Google +"><i class="fa fa-google-plus"></i></a>
						</li> <?php } ?>
						<?php if( get_theme_mod( 'linkedin_link' ) ) { ?>
						<li><a target="_blank" href="<?php echo esc_url( $linkedin_link ); ?>" class="icoLinkedin" title="Linkedin"><i class="fa fa-linkedin"></i></a>
						</li> <?php } ?>
					</ul>
				</div>
			</div>
