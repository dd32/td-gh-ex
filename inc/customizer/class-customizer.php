...
if ( ! class_exists( 'Ad_Booster_Customizer' ) ) {
	
	class Ad_Booster_Customizer {
		...
		protected function includes() {
			include_once get_template_directory() . '/inc/helpers/include-kirki.php';
			include_once get_template_directory() . '/inc/helpers/class-kirki.php';
			include_once get_template_directory() . '/inc/customizer/fields/blog.php';
		}

		public function init_kirki() {

			Ad_Booster_Kirki::add_config( $this->config_id, array(
			...
			Ad_Booster_Kirki::add_panel( 'adbooster_blog_panel' , array(
			    'priority'    => 100,
			    'title'       => __( 'Blog', 'adbooster' ),
			    'description' => __( 'The basic theme options for free version.', 'adbooster' ),
			) );

			Ad_Booster_Kirki::add_panel( 'adbooster_home_panel' , array(
			    'priority'    => 101,
			    'title'       => __( 'AdBooster Homepage', 'adbooster' ),
		...
		private function add_sections_fields() {
			...
			foreach( $sections as $key => $section ) {
				...
				Ad_Booster_Kirki::add_section( $key, $section);
			...
			foreach ( $fields as $field) {
				...
				Ad_Booster_Kirki::add_field( $this->config_id, $field );
			}
...
return new Ad_Booster_Customizer();