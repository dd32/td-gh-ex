    ...
    // Add Control
		...
		$wp_customize->add_control(
			new WP_Customize_Control(
				...
				'aster_blog_pagination',
				array(
					'label'          => __('Blog Pagination or Navigation', 'aster'),
					'section'        => 'aster_new_section_general',
					'settings'       => 'aster_blog_pagination',
					'type'           => 'radio',
					'priority'	 => 3,
					'choices'        => array(
						'pagination'   => __('Pagination', 'aster'),
						'navigation'  => __('Navigation', 'aster')
					)
				)
			)
		);
