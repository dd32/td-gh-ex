 ...
 */
	 ...
	 */
	$wp_customize->add_section( 'section-site-identity', array(
		'priority' => 5,
		'title'    => __( 'Site Identity', 'astra-theme' ),
	) );
	 ...
	 */
		$wp_customize->add_panel( 'panel-colors-background', array(
			'priority' => 15,
			'title'    => __( 'Colors & Background', 'astra-theme' ),
		) );

		$wp_customize->add_section( 'section-colors-body', array(
			'title'    => __( 'Body', 'astra-theme' ),
	 ...
	 */
		$wp_customize->add_panel( 'panel-typography', array(
			'priority' => 20,
			'title'    => __( 'Typography', 'astra-theme' ),
		) );
		...
		$wp_customize->add_section( 'section-single-typo', array(
			'title'    => __( 'Single Page / Post', 'astra-theme' ),
			'panel'    => 'panel-typography',
			'priority' => 40,
	    ) );
	 ...
	 */
		$wp_customize->add_panel( 'panel-advanced', array(
			'priority' => 50,
			'title' => __( 'Advanced', 'astra-theme' ),
		) );

		$wp_customize->add_section( 'section-advanced-button', array(
			'title'    => __( 'Buttons', 'astra-theme' ),
		...
		$wp_customize->add_section( 'section-widget-areas', array(
			'priority' => 55,
			'title' => __( 'Widget Areas', 'astra-theme' ),
		) );
