	...
	class Admiral_Customize_Upgrade_Control extends WP_Customize_Control {
		...
		public function render_content() {
			...
			<div class="upgrade-pro-version">
				...
				<span class="customize-control-title"><?php esc_html_e( 'Pro Version', 'admiral' ); ?></span>
			...
			<div class="upgrade-plugins">
				...
				<span class="customize-control-title"><?php esc_html_e( 'ThemeZee Plugins', 'admiral' ); ?></span>
				...
				<p>
					<a href="<?php echo esc_url( __( 'https://themezee.com/plugins/', 'admiral' ) ); ?>?utm_source=customizer&utm_medium=button&utm_campaign=admiral&utm_content=plugins" target="_blank" class="button button-secondary">
