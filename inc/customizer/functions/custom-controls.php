...
if ( class_exists( 'WP_Customize_Control' ) ) :
    ...
    public function render_content() {  ?>
			...
			<div class="upgrade-pro-version">
				...
				<span class="customize-control-title"><?php esc_html_e( 'Pro Version Add-on', 'smartline-lite' ); ?></span>
			...
			<div class="upgrade-plugins">
				...
				<span class="customize-control-title"><?php esc_html_e( 'Recommended Plugins', 'smartline-lite' ); ?></span>
