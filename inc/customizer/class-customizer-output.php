...
class adbooster_Customizer_Output {
	...
	public function __construct() {
		...
		add_filter( 'adbooster_show_post_thumbnail', array( $this, 'show_post_thumbnail' ));
	...
	public function change_readmore_label() {
		...
		return adbooster_get_option( 'blog_post_show_readmore_label', __('Read More...', 'adbooster') );
	}
	...
	public function footer_widget_rows( $row ) {
		...
		return adbooster_get_option('blog_footer_widget_rows', 2);

	}

}

new adbooster_Customizer_Output();