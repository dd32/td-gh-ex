...
function app_landing_page_customizer_theme_info( $wp_customize ) {
	...
	$theme_info .= '<span class="sticky_info_row"><label class="row-element">' . __( 'View documentation', 'app-landing-page' ) . ': </label><a href="' . esc_url( 'https://rarathemes.com/documentation/app-landing-page/' ) . '" target="_blank">' . __( 'here', 'app-landing-page' ) . '</a></span><br />';
	$theme_info .= '<span class="sticky_info_row"><label class="row-element">' . __( 'Theme info', 'app-landing-page' ) . ': </label><a href="' . esc_url( 'https://rarathemes.com/wordpress-themes/app-landing-page/' ) . '" target="_blank">' . __( 'here', 'app-landing-page' ) . '</a></span><br />';
