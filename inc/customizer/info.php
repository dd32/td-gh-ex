 ...
 */
if ( ! function_exists( 'app_landing_page_customizer_theme_info' ) ) :

function app_landing_page_customizer_theme_info( $wp_customize ) {
	...
	$theme_info .= '<span class="sticky_info_row"><label class="more-detail row-element">' . __( 'More WordPress Themes', 'app-landing-page' ) . ': </label><a href="' . esc_url( 'https://rarathemes.com/wordpress-themes/' ) . '" target="_blank">' . __( 'here', 'app-landing-page' ) . '</a></span><br />';
...
add_action( 'customize_register', 'app_landing_page_customizer_theme_info' );
 ...
 */
class App_Landing_Page_Customize_Section_Pro extends WP_Customize_Section {
...
function app_landing_page_sections_pro( $manager ) {
	// Register custom section types.
	$manager->register_section_type( 'App_Landing_Page_Customize_Section_Pro' );

	// Register sections.
	$manager->add_section(
		new App_Landing_Page_Customize_Section_Pro(
			$manager,
			'app_landing_page_view_pro',
			array(
				'title'    => esc_html__( 'Pro Available', 'app-landing-page' ),
                'priority' => 5, 
				'pro_text' => esc_html__( 'VIEW PRO THEME', 'app-landing-page' ),
				'pro_url'  => 'https://rarathemes.com/wordpress-themes/app-landing-page-pro/'
			)
		)
	);
}
add_action( 'customize_register', 'app_landing_page_sections_pro' );