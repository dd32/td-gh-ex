...
*/
	...
	$css .= '
		#top-bar {
		  background-color: '. esc_html(ashe_options( 'colors_top_bar_bg' )) .';
		}

		#top-bar a {
		  color: '. esc_html(ashe_options( 'colors_top_bar_link' )) .';
		}
		...
		#top-menu .sub-menu a {
		  	background-color: '. esc_html(ashe_options( 'colors_top_bar_bg' )) .';
			border-color: '. esc_html(ashe_hex2rgba( ashe_options( 'colors_top_bar_link' ), 0.05 )) .';
		}
	';
	...
	$css .= '
		...
		.entry-header {
			background-color: '. esc_html(ashe_options( 'colors_header_bg' )) .';
		}
	';
	...
	$css .= '
		#main-nav {
			background-color: '. esc_html(ashe_options( 'colors_main_nav_bg' )) .';
			box-shadow: 0px 1px 5px '. esc_html(ashe_hex2rgba( ashe_options( 'colors_main_nav_link' ), 0.1 )) .';
		}

		#featured-links h4 {
			background-color: '. esc_html(ashe_hex2rgba( ashe_options( 'colors_main_nav_bg' ), 0.85 )) .';
			color: '. esc_html(ashe_options( 'colors_main_nav_link' )) .';
		}
		...
		.sidebar-alt-close-btn span {
			background-color: '. esc_html(ashe_options( 'colors_main_nav_link' )) .';
		}
		...
		#main-menu .sub-menu a {
			background-color: '. esc_html(ashe_options( 'colors_main_nav_bg' )) .';
			border-color: '. esc_html(ashe_hex2rgba( ashe_options( 'colors_main_nav_link' ), 0.05 )) .';
		}
		...
		#main-nav #s::-webkit-input-placeholder { /* Chrome/Opera/Safari */
			color: '. esc_html(ashe_hex2rgba( ashe_options( 'colors_main_nav_link' ), 0.7 )) .';
		}
	...
	$css .= '
		...
		#page-content .comment-author {
			color: '. esc_html(ashe_options( 'colors_content_text' )) .';
		}
		...
		#page-content .post-share a {
			color: '. esc_html(ashe_options( 'colors_content_title' )) .';
		}

		#page-content h1 a:hover {
			color: '. esc_html(ashe_hex2rgba( ashe_options( 'colors_content_title' ) , 0.75 )).';
		}
		...
		.rpwwt-post-comments-number {
			color: '. esc_html(ashe_options( 'colors_content_meta' )) .';
		}
		...
		table td,
		pre {
			border-color: '. esc_html(ashe_options( 'colors_content_border' )) .';
		}

		hr {
			background-color: '. esc_html(ashe_options( 'colors_content_border' )) .';
		}
		...
		#page-content .wpcf7 [type="submit"] {
			color: '. esc_html(ashe_options( 'colors_button_text' )) .';
			background-color: '. esc_html(ashe_options( 'colors_button' )) .';
		}
		...
		#page-content .wpcf7 [type="submit"]:hover {
			color: '. esc_html(ashe_options( 'colors_button_hover_text' )) .';
			background-color: '. esc_html(ashe_options( 'colors_content_accent' )) .';
		}
		...
		#page-content h4.image-overlay {
			color: '. esc_html(ashe_options( 'colors_overlay_text' )) .';
			background-color: '. esc_html(ashe_hex2rgba( ashe_options( 'colors_overlay' ), 0.3 )) .';
		}
		...
		.slide-caption {
			background: '. esc_html(ashe_hex2rgba( ashe_options( 'colors_overlay_text' ), 0.95 )) .';
		}

		#featured-slider .slick-active {
			background: '. esc_html(ashe_options( 'colors_overlay_text' )) .';
		}
	';
	...
	$css .= '
		...
		#page-footer textarea {
			background-color: '. esc_html(ashe_options( 'colors_footer_bg' )) .';
			color: '. esc_html(ashe_options( 'colors_footer_text' )) .';
		}
		...
		#page-footer h5,
		#page-footer h6 {
			color: '. esc_html(ashe_options( 'colors_footer_title' )) .';
		}
		...
		.footer-widgets {
			border-color: '. esc_html(ashe_options( 'colors_footer_border' )) .';
		}

		#page-footer hr {
			background-color: '. esc_html(ashe_options( 'colors_footer_border' )) .';
		}
	';
	...
	$css .= '
		.ashe-preloader-wrap {
			background-color: '. esc_html(ashe_options( 'colors_preloader_bg' )) .';
		}
	';
...
*/
	...
	$css .= '
		.boxed-wrapper {
			max-width: '. (int)ashe_options( 'general_site_width' ) .'px;
		}
	';
	...
	$css .= '
		...
		.sidebar-left,
		.sidebar-right {
			width: '. ( (int)ashe_options( 'general_sidebar_width' ) + (int)ashe_options( 'blog_page_gutter_horz' ) ) .'px;
		}

		[data-layout*="rsidebar"] .main-container,
		[data-layout*="lsidebar"] .main-container {
			width: calc(100% - '. ( (int)ashe_options( 'general_sidebar_width' ) + (int)ashe_options( 'blog_page_gutter_horz' ) ) .'px);
			width: -webkit-calc(100% - '. ( (int)ashe_options( 'general_sidebar_width' ) + (int)ashe_options( 'blog_page_gutter_horz' ) ) .'px);
		}

		[data-layout*="lrsidebar"] .main-container {
			width: calc(100% - '. ( ( (int)ashe_options( 'general_sidebar_width' ) + (int)ashe_options( 'blog_page_gutter_horz' ) ) * 2 ) .'px);
			width: -webkit-calc(100% - '. ( ( (int)ashe_options( 'general_sidebar_width' ) + (int)ashe_options( 'blog_page_gutter_horz' ) ) * 2 ) .'px);
		}
	...
	.main-content,
	.page-footer-inner {
		padding-left: '. (int)ashe_options( 'general_content_padding' ) .'px;
		padding-right: '. (int)ashe_options( 'general_content_padding' ) .'px;
	}
	';
...
*/
	// Transparent
	if ( ashe_true_false(ashe_options( 'top_bar_transparent' )) === true ) {
		$css .= '
			#top-bar {
				position: absolute;
				top: 0;
	...
	// Align
	if ( esc_html(ashe_options( 'top_bar_align' )) === 'left-right' ) {
		$css .= '
			#top-menu {
				float: left;
			}
		...
		'; 
	} elseif ( esc_html(ashe_options( 'top_bar_align' )) === 'right-left' ) {
		$css .= '
			#top-menu {
				float: right;
			}
...
*/
	...
	$css .= '
		.entry-header {
			height: '. (int)ashe_options( 'header_image_height' ) .'px;
	...
	if ( ashe_options( 'main_nav_align' ) === 'center' ) {
		$css .= '
			.main-nav-sidebar {
			  position: absolute;
			  top: 0px;
			  left: '. esc_html(ashe_options( 'general_content_padding' )) .'px;
			  z-index: 1;
			}
			...
			.main-nav-icons {
			  position: absolute;
			  top: 0px;
			  right: '. esc_html(ashe_options( 'general_content_padding' )) .'px;
			  z-index: 2;
			}
		';
	} else {
...
*/
	...
	if ( esc_html(ashe_options( 'main_nav_position' )) === 'below' ) {
		$css .= '
			#featured-slider.boxed-wrapper {
			  padding-top: 41px;
			}
...
*/
	...
	$featured_links = array(
		...
		esc_url(ashe_options( 'featured_links_image_4' )),
		esc_url(ashe_options( 'featured_links_image_5' ))
	);

	$featured_links = ashe_true_false(ashe_options( 'featured_links_fill' )) ? array_filter( $featured_links ) : $featured_links;
	$featured_links_gutter = 0;

	// Gutter
	if ( ashe_true_false(ashe_options( 'featured_links_gutter_horz' )) === true ) {
...
*/
	...
	$css .= '	
		.blog-grid > li {
			margin-bottom: ' . (int)ashe_options( 'blog_page_gutter_vert' ) . 'px;
		}
		...
		[data-layout*="col4"] .blog-grid > li {
			...
			vertical-align: top;
			margin-right: '. (int)ashe_options( 'blog_page_gutter_horz' ) .'px;
		}
		...
		[data-layout*="col2"] .blog-grid > li {
			width: calc((100% - ' . (int)ashe_options( 'blog_page_gutter_horz' ) . 'px ) /2);
			width: -webkit-calc((100% - ' . (int)ashe_options( 'blog_page_gutter_horz' ) . 'px ) /2);
		}

		[data-layout*="col3"] .blog-grid > li {
			width: calc((100% - 2 * ' . ( (int)ashe_options( 'blog_page_gutter_horz' ) ) . 'px ) /3);
			width: -webkit-calc((100% - 2 * ' . ( (int)ashe_options( 'blog_page_gutter_horz' ) ) . 'px ) /3);
		}

		[data-layout*="col4"] .blog-grid > li {
			width: calc((100% - 3 * ' . ( (int)ashe_options( 'blog_page_gutter_horz' ) ) . 'px ) /4);
			width: -webkit-calc((100% - 3 * ' . ( (int)ashe_options( 'blog_page_gutter_horz' ) ) . 'px ) /4);
		}

		[data-layout*="rsidebar"] .sidebar-right {
			padding-left: ' . (int)ashe_options( 'blog_page_gutter_horz' ) . 'px;
		}

		[data-layout*="lsidebar"] .sidebar-left {
			padding-right: ' . (int)ashe_options( 'blog_page_gutter_horz' ) . 'px;
		}
	...
	// Blog Page Dropcups
	if ( ashe_true_false(ashe_options( 'blog_page_show_dropcaps' )) === true && !is_single() && !is_page() ) {
		$css .= '
	...
	if ( ashe_true_false(ashe_options( 'single_page_show_dropcaps' )) === true && is_single() ) {
		$css .= '
			.post-content > p:first-child:first-letter { /* MOD */
			  float: left;
			  margin: 0px 12px 0 0;
...
*/
	...
	// Widget Columns
	if ( esc_html(ashe_options( 'page_footer_columns' )) === 'three' ) {
		$css .= '
	...
	if ( esc_html(ashe_options( 'page_footer_columns' )) === 'four' ) {
		$css .= '
			.footer-widgets > .ashe-widget {
				width: 22%;
				margin-right: 4%;
	...
	if ( esc_html(ashe_options( 'page_footer_align' )) === 'center' ) {
		$css .= '
			.footer-copyright {
				text-align: center;
			}
		'; 
	} elseif ( esc_html(ashe_options( 'page_footer_align' )) === 'left-right' ) {
		$css .= '
			.copyright-info {
				float: left;
			}
		...
		'; 
	} elseif ( esc_html(ashe_options( 'page_footer_align' )) === 'right-left' ) {
		$css .= '
			.copyright-info {
				float: right;
			}
...
*/
	...
	$css .= '
		...
		.woocommerce a.remove:hover {
		    color: '. esc_html(ashe_options( 'colors_content_text' )) .' !important;
		}
	';
	...
	$css .= '
		...
		.woocommerce a.remove {
		    color: '. esc_html(ashe_options( 'colors_content_meta' )) .' !important;
		}
	';
	...
	$css .= '
		...
		.woocommerce .woocommerce-message,
		.woocommerce div.product .woocommerce-tabs ul.tabs li {
			background-color: '. esc_html(ashe_hex2rgba( ashe_options( 'colors_content_border' ), 0.3 )) .';
		}

		.woocommerce-cart #payment div.payment_box::before,
		#add_payment_method #payment div.payment_box::before,
		.woocommerce-checkout #payment div.payment_box::before {
			border-color: '. esc_html(ashe_hex2rgba( ashe_options( 'colors_content_border' ), 0.5 )) .';
		}

		.woocommerce-cart #payment div.payment_box,
		#add_payment_method #payment div.payment_box,
		.woocommerce-checkout #payment div.payment_box {
			background-color: '. esc_html(ashe_hex2rgba( ashe_options( 'colors_content_border' ), 0.5 )) .';
		}
	';
	...
	$css .= '
		...
		.woocommerce #page-content nav.woocommerce-pagination ul li a.next {
			color: '. esc_html(ashe_options( 'colors_button' )) .';
		}
