...
if ( ! function_exists( 'business_consulting_sanitize_image' ) ) :
	 ...
	 */
	function business_consulting_sanitize_image( $image, $setting ) {
...
if ( ! function_exists( 'business_consulting_sanitize_number_range' ) ) :
	 ...
	 */
	function business_consulting_sanitize_number_range( $input, $setting ) {
