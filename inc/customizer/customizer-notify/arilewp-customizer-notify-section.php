	...
	public function json() {
			...
			if ( isset( $arilewp_lite_customizer_notify_recommended_action['plugin_slug'] ) ) {
				...
				switch ( $active['needs'] ) {
					...
					case 'deactivate':
						...
						$arilewp_lite_customizer_notify_recommended_action['button_label'] = $deactivate_button_label;
						break;
				}
			}
		...
		foreach ( $arilewp_customizer_notify_recommended_plugins as $slug => $plugin_opt ) {
			...
			if ( ! empty( $plugin_opt['description'] ) ) {
				...
				$ti_customizer_notify_recommended_plugin['description'] = $info->arilewp_description;
			}
