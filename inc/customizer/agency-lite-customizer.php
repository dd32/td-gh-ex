...
$wp_customize->add_control( new Agency_Lite_Customize_Radioimage_Control( $wp_customize,'agency_lite_single_page_sidebar', array(
	...
	//blog archive
$wp_customize->add_setting( 'agency_lite_archive_meta_enable',array(
	'sanitize_callback' => 'agency_lite_sanitize_show_hide',
	'default'           => 'on'
));

$wp_customize->add_control( new agency_lite_Switch_Control( $wp_customize,'agency_lite_archive_meta_enable',array(
	'label'         	=> esc_html__( 'Show/Hide Meta Data on Archive Page ', 'agency-lite' ),
	'section'       	=> 'agency_lite_blog_post_display_section',
	'priority'		=> 10,
	'on_off_label'  	=> array(
		'on'          	=> esc_html__( 'Show', 'agency-lite' ),
...
$wp_customize->add_setting( 'agency_lite_archive_excerpt_lenght',array(
		'default' => '150',
		'sanitize_callback' => 'absint'
	)
);
$wp_customize->add_control( 'agency_lite_archive_excerpt_lenght', array(
		'label' => esc_html__('Excerpt length','agency-lite'),
		'section' => 'agency_lite_blog_post_display_section',
		'type' => 'number',
		'priority' => 20
	)
