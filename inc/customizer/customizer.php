...
function artpop_theme_customizer( $wp_customize ) {
	...
	$wp_customize->add_section( 'home_options', array(
		'title'       => __( 'Homepage Options', 'artpop' ),
		'description' => __( 'Settings for Blog Homepage.', 'artpop' ),
		'priority'    => 1,
		'panel'       => 'home_panel',
	) );
	...
	$wp_customize->add_setting( 'archive_upsell_link', array(
		'sanitize_callback' => 'sanitize_text_field',
	) );
	$wp_customize->add_control( new Artpop_Customize_Upsell( $wp_customize, 'archive_upsell_link', array(
		'label'   => __( 'Need more options?', 'artpop' ),
		'section' => 'archive_options',
	) ) );
	...
	$wp_customize->add_setting( 'post_upsell_link', array(
		'sanitize_callback' => 'sanitize_text_field',
	) );
	$wp_customize->add_control( new Artpop_Customize_Upsell( $wp_customize, 'post_upsell_link', array(
		'label'   => __( 'Need more options?', 'artpop' ),
		'section' => 'post_options',
	) ) );
	...
	$wp_customize->add_setting( 'footer_upsell_link', array(
		'sanitize_callback' => 'sanitize_text_field',
	) );
	$wp_customize->add_control( new Artpop_Customize_Upsell( $wp_customize, 'footer_upsell_link', array(
		'label'   => __( 'Need more options?', 'artpop' ),
		'section' => 'footer_options',
	) ) );
