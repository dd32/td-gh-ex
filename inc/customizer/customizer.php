...
function rubine_customize_register_options( $wp_customize ) {
	...
	$wp_customize->selective_refresh->add_partial( 'blogname', array(
		...
		'render_callback' => 'rubine_customize_partial_blogname',
	) );
	$wp_customize->selective_refresh->add_partial( 'blogdescription', array(
		'selector'        => '.site-description',
		'render_callback' => 'rubine_customize_partial_blogdescription',
	) );
	...
	$wp_customize->add_control( 'rubine_theme_options[header_tagline]', array(
		'label'    => esc_html__( 'Display Tagline', 'rubine-lite' ),
		'section'  => 'title_tagline',
 ...
 */
function rubine_customize_partial_blogname() {
	bloginfo( 'name' );
}
 ...
 */
function rubine_customize_partial_blogdescription() {
...
function rubine_customize_preview_js() {
	wp_enqueue_script( 'rubine-lite-customizer-preview', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), '20161214', true );
}
...
function rubine_customize_preview_css() {
	wp_enqueue_style( 'rubine-lite-customizer-css', get_template_directory_uri() . '/css/customizer.css', array(), '20161214' );
