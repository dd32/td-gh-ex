...
* Repeater customizer
*/
add_action( 'customize_register', 'arrival_repeaters_customize_register' );
function arrival_repeaters_customize_register( $wp_customize ) {
...
*
*/
$wp_customize->add_setting( 'arrival_social_icons', array(
    'sanitize_callback' => 'arrival_sanitize_repeater',
...
$wp_customize->add_control(  new Arrival_Repeater_Controler( $wp_customize, 'arrival_social_icons', 
    array(
        ...
        'section'                   => 'arrival_social_icons_section',
        'arrival_box_label'           => esc_html__('Social Icons','arrival'),
        'arrival_box_add_control'     => esc_html__('Add Profile','arrival'),
    ),
        array(
            'social_icons' => array(
            'type'        => 'social_icon',
            'label'       => esc_html__( 'Choose Icon', 'arrival' ),
            'default'     => '',
            ...
            'social_url' => array(
            'type'        => 'url',
            'label'       => esc_html__( 'Enter URL', 'arrival' ),
            'default'     => '',
            'class'       => 'un-bottom-block-cat1'
            )  
        )
        ...
        * Repeater Sanitize
        */
        function arrival_sanitize_repeater($input){      
 ...
 *
 */
 function arrival_social_icons_arrays(){
