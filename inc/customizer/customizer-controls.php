...
$control_dir = AST_THEME_DIR . 'inc/customizer/custom-controls';

require $control_dir . '/sortable/class-ast-control-sortable.php';
require $control_dir . '/radio-image/class-ast-control-radio-image.php';
