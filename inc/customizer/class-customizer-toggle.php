<?php
class Apex_Business_Customizer_Toggle_Control extends WP_Customize_Control {
    public $type = 'ios';
    /**
    ...
    public function enqueue() {
        wp_enqueue_script( 'apex-business-customizer-toggle-control', $this->abs_path_to_url( dirname( __FILE__ ) . '/toggle/toggle.js' ), array( 'jquery' ), rand(), true );
        wp_enqueue_style( 'apex-business-pure-css-toggle-buttons', $this->abs_path_to_url( dirname( __FILE__ ) . '/toggle/toggle.css' ), array(), rand() );
        $css = '
