 ...
 * @subpackage Example
 * @version    2.6.1 for parent theme Asthir for publication on WordPress.org
...
add_action( 'tgmpa_register', 'asthir_register_required_plugins' );
 ...
 */
function asthir_register_required_plugins() {
	/*
