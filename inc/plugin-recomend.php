...
add_action( 'tgmpa_register', 'beshop_register_required_plugins' );
 ...
 */
function beshop_register_required_plugins() {
	/*
	 ...
	 */
	$config = array(
		'id'           => 'beshop2',                 // Unique ID for hashing notices for multiple instances of TGMPA.
