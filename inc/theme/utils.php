...
function mp_artwork_theme_comment($mp_artwork_comment, $mp_artwork_args, $mp_artwork_depth) {
    ...
    <?php endif; ?>
            ...
            <?php if ($mp_artwork_args['avatar_size'] != 0) echo get_avatar($mp_artwork_comment, $mp_artwork_args['avatar_size']); ?>            
            </div>
    ...
    <?php endif; ?>
                ...
                <div class="reply">
    <?php comment_reply_link(array_merge($mp_artwork_args, array('add_below' => $mp_artwork_add_below, 'depth' => $mp_artwork_depth, 'max_depth' => $mp_artwork_args['max_depth']))); ?>
                </div>
                    <?php if ('div' != $mp_artwork_args['style']) : ?>
                </div>
            </div>
