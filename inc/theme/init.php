...
class MP_Artwork {
    ...
    function scripts_styles() {
        ...
        wp_enqueue_script($this->get_prefix() . 'script', get_template_directory_uri() . '/js/artwork.min.js', array('jquery', 'superfish.min', 'jquery-labelauty', 'jquery.infinitescroll'), '1.0', true);
        ...
        wp_enqueue_style($this->get_prefix() . 'main', get_template_directory_uri() . '/css/artwork-style.min.css', array('bootstrap', 'font-awesome'), '1.0', 'all');
        ...
        if (is_plugin_active('motopress-content-editor/motopress-content-editor.php') || is_plugin_active('motopress-content-editor-lite/motopress-content-editor.php')) {
            wp_enqueue_style($this->get_prefix() . 'motopress', get_template_directory_uri() . '/css/artwork-motopress.min.css', array('bootstrap', 'font-awesome', $this->get_prefix() . 'main'), '1.0', 'all');
        }

        if (is_plugin_active('woocommerce/woocommerce.php')) {
            wp_enqueue_style($this->get_prefix() . 'woocommerce', get_template_directory_uri() . '/css/artwork-woocommerce.min.css', array('bootstrap', 'font-awesome', $this->get_prefix() . 'main'), '1.0', 'all');
        }

        if (is_plugin_active('bbpress/bbpress.php')) {
            wp_enqueue_style($this->get_prefix() . 'bbpress', get_template_directory_uri() . '/css/artwork-bbpress.min.css', array('bootstrap', 'font-awesome', $this->get_prefix() . 'main'), '1.0', 'all');
        }
        if (is_rtl()) {
            wp_enqueue_style($this->get_prefix() . 'rtl', get_template_directory_uri() . '/css/artwork-rtl.min.css', array('bootstrap', 'font-awesome', $this->get_prefix() . 'main'), '1.0', 'all');
        }
        /*
         *  Loads our main stylesheet.
         */
        wp_enqueue_style($this->get_prefix() . 'style', get_stylesheet_uri(), array(), '1.0');
    }
