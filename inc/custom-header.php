...
function blue_planet_custom_header_setup() {
	add_theme_support( 'custom-header', apply_filters( 'blue_planet_custom_header_args', array(
		...
		'admin-head-callback'    => 'blue_planet_admin_header_style',
		'admin-preview-callback' => 'blue_planet_admin_header_image',
	) ) );
}
...
endif; // blue_planet_header_style

if ( ! function_exists( 'blue_planet_admin_header_style' ) ) :
/**
 * Styles the header image displayed on the Appearance > Header admin panel.
 *
 * @see blue_planet_custom_header_setup().
 */
function blue_planet_admin_header_style() {
?>
	<style type="text/css">
...
endif; // blue_planet_admin_header_style

if ( ! function_exists( 'blue_planet_admin_header_image' ) ) :
/**
 * Custom header image markup displayed on the Appearance > Header admin panel.
 *
 * @see blue_planet_custom_header_setup().
 */
function blue_planet_admin_header_image() {
...
endif; // blue_planet_admin_header_image
