 ...
 *
 * @uses accesspress_root_header_style()
 * @uses accesspress_root_admin_header_style()
 * @uses accesspress_root_admin_header_image()
 */
function accesspress_root_custom_header_setup() {
	add_theme_support( 'custom-header', apply_filters( 'accesspress_root_custom_header_args', array(
		'default-image'          => '',
...
if ( ! function_exists( 'accesspress_root_header_style' ) ) :
/**
 * Styles the header image and text displayed on the blog
 *
 * @see accesspress_root_custom_header_setup().
 */
function accesspress_root_header_style() {
