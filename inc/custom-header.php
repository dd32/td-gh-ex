 ...
 *
 * @uses ace_corporate_header_style()
...
if ( ! function_exists( 'ace_corporate_header_style' ) ) :
/**
 * Styles the header image and text displayed on the blog
 *
 * @see ace_corporate_custom_header_setup().
 */
function ace_corporate_header_style() {
...
endif; // ace_corporate_header_style

if ( ! function_exists( 'ace_corporate_admin_header_style' ) ) :
/**
 * Styles the header image displayed on the Appearance > Header admin panel.
 *
 * @see ace_corporate_custom_header_setup().
 */
function ace_corporate_admin_header_style() {
?>
	<style type="text/css">
