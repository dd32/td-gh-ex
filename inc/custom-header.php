...
class MP_Artwork_Custom_Header {
    ...
    function header_style() {
        ...
        if (strcasecmp($font_family, "Niconne") != 0) {
            ?>
            <link id='theme-title-font-family' href="http://fonts.googleapis.com/css?family=<?php echo str_replace(" ", "+", $font_family) . ":" . $font_weight_style . ( $font_weight_style != '400' ? ',400' : '' ); ?>" rel='stylesheet' type='text/css'>
        ...
        if (strcasecmp($font_family_text, "Josefin Sans") != 0) {
            ?>
            <link id='theme-title-font-family' href="http://fonts.googleapis.com/css?family=<?php echo str_replace(" ", "+", $font_family_text) . ":" . $font_weight_style_text . ( $font_weight_style_text != '400' ? ',400' : '' ); ?>" rel='stylesheet' type='text/css'>
        ...
        <?php endif; ?>
        <?php if ($third_brand_color != MP_ARTWORK_THIRD_BRAND_COLOR && $third_brand_color != '') : ?>
