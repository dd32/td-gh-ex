...
function igthemes_add_daynamic_css() {
    ...
    .site-footer .widget {
        ...
        border: 1px solid '. igthemes_color_brightness(get_theme_mod('footer_background_color', $footer_background_color ),-15 ).';
    }
    
    .site-footer .widget .widget-title {
        background: '. igthemes_color_brightness(get_theme_mod('footer_background_color', $footer_background_color ),-6 ).';
