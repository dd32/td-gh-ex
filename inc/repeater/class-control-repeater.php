...
if( ! class_exists( 'Best_Charity_Control_Repeater' ) ) {
    /**
     * Repeater control
     */
    class Best_Charity_Control_Repeater extends WP_Customize_Control {
        ...
        public function __construct( $manager, $id, $args = array() ) {
            ...
            $this->row_label = array(
                'type' => 'text',
                'value' => esc_attr__( 'row', 'best-charity' ),
                'field' => false,
            );
            ...
            if ( empty( $this->button_label ) ) {
             ...
             $this->button_label = sprintf( esc_attr__( 'Add new %s', 'best-charity' ), $this->row_label['value'] );
         }
        ...
        public function enqueue() {    
            ...
            wp_enqueue_script( 'best-charity-repeater', get_template_directory_uri() . '/assets/customizer/repeater.js', array( 'jquery', 'jquery-ui-core', 'jquery-ui-sortable' ), false, true );
            wp_enqueue_style( 'best-charity-repeater', get_template_directory_uri() . '/assets/customizer/repeater.css', null );
        }
        ...
        protected function render_content() {
            ...
            <?php if ( isset( $this->choices['limit'] ) ) : ?>
                ...
                printf( esc_attr__( 'Limit: %s rows', 'best-charity' ), esc_html( $this->choices['limit'] ) ); ?></p>
            <?php endif; ?>
        ...
        public function repeater_js_template() {
            ...
            <label>
                ...
                <span class="description customize-control-description">{{{ field.description }}}</span>
                <# } #>
                <input class="color-picker-hex" type="text" maxlength="7" placeholder="<?php esc_attr_e( 'Hex Value', 'best-charity' ); ?>"  value="{{{ field.default }}}" data-field="{{{ field.id }}}" {{ defaultValue }} />
            ...
            <figure class="kirki-image-attachment" data-placeholder="<?php esc_attr_e( 'No Image Selected', 'best-charity' ); ?>" >
                <# if ( field.default ) { #>
                <# var defaultImageURL = ( field.default.url ) ? field.default.url : field.default; #>
                <img src="{{{ defaultImageURL }}}">
                <# } else { #>
                <?php esc_attr_e( 'No Image Selected', 'best-charity' ); ?>
                <# } #>
            </figure>
            
            <div class="actions">
                <button type="button" class="button remove-button<# if ( ! field.default ) { #> hidden<# } #>"><?php esc_attr_e( 'Remove', 'best-charity' ); ?></button>
                <button type="button" class="button upload-button" data-label=" <?php esc_attr_e( 'Add Image', 'best-charity' ); ?>" data-alt-label="<?php esc_attr_e( 'Change Image', 'best-charity' ); ?>" >
                    <# if ( field.default ) { #>
                    <?php esc_attr_e( 'Change Image', 'best-charity' ); ?>
                    <# } else { #>
                    <?php esc_attr_e( 'Add Image', 'best-charity' ); ?>
                    <# } #>
                </button>
                <# if ( field.default.id ) { #>
            ...
            <figure class="kirki-file-attachment" data-placeholder="<?php esc_attr_e( 'No File Selected', 'best-charity' ); ?>" >
                <# if ( field.default ) { #>
                ...
                <# } else { #>
                <?php esc_attr_e( 'No File Selected', 'best-charity' ); ?>
                <# } #>
            </figure>
            
            <div class="actions">
                <button type="button" class="button remove-button<# if ( ! field.default ) { #> hidden<# } #>"></button>
                <button type="button" class="button upload-button" data-label="<?php esc_attr_e( 'Add File', 'best-charity' ); ?>" data-alt-label="<?php esc_attr_e( 'Change File', 'best-charity' ); ?>" >
                    <# if ( field.default ) { #>
                    <?php esc_attr_e( 'Change File', 'best-charity' ); ?>
                    <# } else { #>
                    <?php esc_attr_e( 'Add File', 'best-charity' ); ?>
                    <# } #>
                </button>
                <# if ( field.default.id ) { #>
                <input type="hidden" class="hidden-field" value="{{{ field.default.id }}}" data-field="{{{ field.id }}}" >
        ...
        <# }); #>
        <button type="button" class="button-link repeater-row-remove"><?php esc_attr_e( 'Remove', 'best-charity' ); ?></button>
    </div>
</li>
</script>
<?php
