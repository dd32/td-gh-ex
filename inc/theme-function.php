...
function astral_inner_banner() { ?>
	<div class="inner-banner d-flex flex-column justify-content-center align-items-center" style="background:url( <?php if( get_theme_mod( 'inner_header_image' ) ) { echo esc_url( get_theme_mod( 'inner_header_image' ) ); } else { echo esc_url( get_template_directory_uri() ). "/images/inner.jpg"; } ?>);"> </div>
<?php }
	...
	<nav aria-label="breadcrumb">
        ...
        <ol class="breadcrumb d-flex justify-content-center">
            <li class="breadcrumb-item">
                <a href="<?php echo esc_url( home_url() ); ?>"><?php esc_attr_e( 'Home', 'astral' ); ?></a>
            </li>
			...
			<?php if( is_search() ) { 
				...
				<li class="breadcrumb-item " aria-current="page"><?php printf( esc_html__( 'Search Results for: %s', 'astral' ), '<span>' . get_search_query() . '</span>'  ); ?></li>
			<?php } ?>
