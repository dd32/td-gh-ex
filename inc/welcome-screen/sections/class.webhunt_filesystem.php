...
if (!class_exists('WebHunt_Filesystem')) {
    class WebHunt_Filesystem
    {
        private $parent = null;
        ...
        public function ftp_form()
        {
            if (isset($this->parent->ftp_form) && !empty($this->parent->ftp_form)) {
                ...
                echo __('Unable to modify required files. Please ensure that', 'awada');
                echo __('has the proper read/write permissions or enter your FTP information below.', 'awada');
        ...
        public function execute($action, $file = '', $params = '')
        {
            ...
            $base = 'themes.php?page=awada-welcome';
            

            $url = wp_nonce_url($base, 'awada-welcome');
