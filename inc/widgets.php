...
class qq_list extends WP_Widget //QQ邮件列表
{
    ...
    function form($instance){
		$instance = wp_parse_args((array)$instance,array('title'=>'订阅邮箱','list'=>'5a6733636ae16bbc45cb8b243e7f523482b59fe6bc25e6d2'));
    	...
    	echo '<p style="text-align:left;"><div class="wp_syntax" style="overflow: auto;height: 37px; width: 220px;border: 1px solid #C0C0C0;"><pre  style="font-family:monospace;">   http://list.qq.com/cgi-bin/qf_invite?id=<span style="color: #0000ff;">5a6733636ae16bbc45cb8b243e7f523482b59fe6bc25e6d2</span></pre></div></p>';
	}
   ...
   function widget($args,$instance){
	  ...
	  ?>
		...
		<input style="width:100px; margin:10px 0; padding: 5px 0; cursor: pointer;" type="submit" value="确认订阅">
		</form> 
