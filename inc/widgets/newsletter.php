 ...
 */
 if( !class_exists('NNfy_Newsletter_Widget') ){
	class NNfy_Newsletter_Widget extends WP_Widget{
		/**
		 * Register widget with WordPress.
		 */
		function __construct(){
			$widget_ops = array( 'description' => esc_html__('NNfy contact for address email and phone no.','99fy'),'customize_selective_refresh' => true, );
			parent:: __construct('NNfy_Newsletter_Widget',
				esc_html__('NNfy: Newsletter','99fy'), $widget_ops );
		}
		/**
		...
		public function form($instance){
			...
			?>
			<p>
				<label for="<?php echo esc_attr($this->get_field_id( 'title' ) ); ?>"><?php esc_html_e('Title:', '99fy');?></label>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('description')); ?>"><?php esc_html_e('Description:' ,'99fy') ?></label>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('shortcode')); ?>"><?php esc_html_e('Shortcode:' ,'99fy') ?></label>
...
function NNfy_Newsletter_Widget() {
    register_widget( 'NNfy_Newsletter_Widget' );
}
add_action( 'widgets_init', 'NNfy_Newsletter_Widget' ); 