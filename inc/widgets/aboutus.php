...
class advance_aboutus extends WP_Widget {
	
	public function __construct() {
		parent::__construct(
			'ctUp-ads-aboutwidget',
			__( 'Advance - About Us', 'advance-widgets' )
		);
	}
...
<?php
    ...
    function form($instance) {
		...
		$defaults = array(
		'main_title'=>__('Why Choose Us?', 'advance-widgets'),
		'sub_title'=>__('Find reasons to choose us as your Web partner ', 'advance-widgets'),
		'title1' => __('Customer Satisfication Tools', 'advance-widgets'),
		'icon1' => 'fa-bar-chart',
		'text1' =>  __('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam nec rhoncus risus. In ultrices lacinia ipsum, posuere faucibus velit bibendum ac.Lorem Ipsum is simply dummy text of the printing and typesetting industry.', 'advance-widgets'),
		'title2' => __('Compliance Solutions', 'advance-widgets'),
		'icon2' => 'fa-life-ring',
		'text2' =>  __('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam nec rhoncus risus. In ultrices lacinia ipsum, posuere faucibus velit bibendum ac.Lorem Ipsum is simply dummy text of the printing and typesetting industry.', 'advance-widgets'),
		
		'title3' => __('Compliance Solutions', 'advance-widgets'),
		'icon3' => 'fa-life-ring',
		'text3' =>  __('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam nec rhoncus risus. In ultrices lacinia ipsum, posuere faucibus velit bibendum ac.Lorem Ipsum is simply dummy text of the printing and typesetting industry.', 'advance-widgets'),

'title4' => __('Compliance Solutions', 'advance-widgets'),
		'icon4' => 'fa-life-ring',
		'text4' =>  __('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam nec rhoncus risus. In ultrices lacinia ipsum, posuere faucibus velit bibendum ac.Lorem Ipsum is simply dummy text of the printing and typesetting industry.', 'advance-widgets'),
       ...
       <p>
            <label for="<?php echo $this->get_field_id('main_title'); ?>"><?php _e('Main Title', 'advance-widgets'); ?></label><br/>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('sub_title'); ?>"><?php _e('Sub Title', 'advance-widgets'); ?></label><br/>
        ...
        <h4><?php _e('For font-awesome icon visit ', 'advance-widgets') ?><a href="<?php echo esc_url('https://fortawesome.github.io/Font-Awesome/icons/');?>"><?php _e('font-awesome','advance-widgets')?></a></h4>


        <!--BLOCK 1 START-->
        <div class="accordion_advance">      
                 	<h4> <?php _e('Block 1', 'advance-widgets') ?></h4>
          
          <div class="pane_advance">                  
         <p>
            <label for="<?php echo $this->get_field_id('icon1'); ?>"><?php _e('Icon', 'advance-widgets'); ?></label><br/>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('title1'); ?>"><?php _e('Title', 'advance-widgets'); ?></label><br/>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('text1'); ?>"><?php _e('Text', 'advance-widgets'); ?></label><br/>
       ...
       <h4> <?php _e('Block 2', 'advance-widgets') ?></h4>
          
         <div class="pane_advance">
         <p>
            <label for="<?php echo $this->get_field_id('icon2'); ?>"><?php _e('Icon 2', 'advance-widgets'); ?></label><br/>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('title2'); ?>"><?php _e('Title 2', 'advance-widgets'); ?></label><br/>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('text2'); ?>"><?php _e('Text 2', 'advance-widgets'); ?></label><br/>
        ...
        <h4><?php _e('Block 3', 'advance-widgets') ?></h4>
          
        <div class="pane_advance">
         <p>
            <label for="<?php echo $this->get_field_id('icon3'); ?>"><?php _e('Icon 3', 'advance-widgets'); ?></label><br/>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('title3'); ?>"><?php _e('Title 3', 'advance-widgets'); ?></label><br/>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('text3'); ?>"><?php _e('Text 3', 'advance-widgets'); ?></label><br/>
       ...
       <h4> <?php _e('Block 4', 'advance-widgets') ?></h4>
          
        <div class="pane_advance">
         <p>
            <label for="<?php echo $this->get_field_id('icon4'); ?>"><?php _e('Icon 4', 'advance-widgets'); ?></label><br/>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('title4'); ?>"><?php _e('Title 4', 'advance-widgets'); ?></label><br/>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('text4'); ?>"><?php _e('Text 4', 'advance-widgets'); ?></label><br/>
