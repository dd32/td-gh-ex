...
class Beka_Widget_About extends WP_Widget {
	...
	function __construct() {
		parent::__construct( 'beka_about_widget', __( '(Beka) About Widget', 'beka' ), array(
			'description' => __( 'A widget to show author description and image', 'beka' ),
		) );
	}
	...
	public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'author_image' ) ); ?>"><?php _e( 'Author Image URL:', 'beka' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'author_description' ) ); ?>"><?php _e( 'Author Description:', 'beka' ) ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'fb_url' ) ); ?>"><?php _e( 'Facebook URL:', 'beka' ); ?></label>
            <input type="url" class="widefat"
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'twtr_url' ) ); ?>"><?php _e( 'Twitter URL:', 'beka' ); ?></label>
            <input type="url" class="widefat"
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'gp_url' ) ); ?>"><?php _e( 'Google Plus URL:', 'beka' ); ?></label>
            <input type="url" class="widefat"
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'inst_url' ) ); ?>"><?php _e( 'Instagram URL:', 'beka' ); ?></label>
            <input type="url" class="widefat"
