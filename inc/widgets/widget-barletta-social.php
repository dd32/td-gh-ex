...
class barletta_social_widget extends WP_Widget
{
	...
	*/
	...
	<!-- Facebook URL -->
	<p>
		<label for="<?php echo $this->get_field_id( 'facebook' ); ?>"><?php _e('URL address of your Facebook profile or page','barletta') ?>:</label>
	...
	<!-- Twitter URL -->
	<p>
		<label for="<?php echo $this->get_field_id( 'twitter' ); ?>"><?php _e('URL address of your Twitter profile','barletta') ?>:</label>
	...
	<!-- Google Plus URL -->
	<p>
		<label for="<?php echo $this->get_field_id( 'google' ); ?>"><?php _e('URL address of your Google+ profile','barletta') ?>:</label>
	...
	<!-- Pinterest URL -->
	<p>
		<label for="<?php echo $this->get_field_id( 'pinterest' ); ?>"><?php _e('URL address of your Pinterest profile','barletta') ?>:</label>
	...
	<!-- Instagram URL -->
	<p>
		<label for="<?php echo $this->get_field_id( 'instagram' ); ?>"><?php _e('URL address of your Instagram profile','barletta') ?>:</label>
	...
	<!-- Tumblr URL -->
	<p>
		<label for="<?php echo $this->get_field_id( 'tumblr' ); ?>"><?php _e('URL address of your Tumblr profile','barletta') ?>:</label>
	...
	<!-- Dribbble URL -->
	<p>
		<label for="<?php echo $this->get_field_id( 'dribbble' ); ?>"><?php _e('URL address of your Dribbble profile','barletta') ?>:</label>
	...
	<!-- Last FM URL -->
	<p>
		<label for="<?php echo $this->get_field_id( 'lastfm' ); ?>"><?php _e('URL address of your Last FM profile','barletta') ?>:</label>
	...
	<!-- Soundcloud URL -->
	<p>
		<label for="<?php echo $this->get_field_id( 'soundcloud' ); ?>"><?php _e('URL address of your Soundcloud profile','barletta') ?>:</label>
	...
	<!-- YouTube URL -->
	<p>
		<label for="<?php echo $this->get_field_id( 'youtube' ); ?>"><?php _e('URL address of your YouTube channel','barletta') ?>:</label>
	...
	<!-- Flickr URL -->
	<p>
		<label for="<?php echo $this->get_field_id( 'flickr' ); ?>"><?php _e('URL address of your Flickr profile page','barletta') ?>:</label>
	...
	<!-- RSS URL -->
	<p>
		<label for="<?php echo $this->get_field_id( 'rss' ); ?>"><?php _e('URL address of your RSS feed','barletta') ?>:</label>
		<input class="widefat" id="<?php echo $this->get_field_id( 'rss' ); ?>" name="<?php echo $this->get_field_name( 'rss' ); ?>" type="text" value="<?php echo $instance['rss']; ?>" style="width:90%;" />
	</p>
