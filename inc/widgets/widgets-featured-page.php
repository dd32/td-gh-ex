            ...
            <?php if($feat_page_query->have_posts()) : ?>
                ...
                <div class="feat-page-wrap">
                    <?php if(!empty($feat_page_title)) : ?>
                        <h2 class="feat-page-title"><?php echo $feat_page_title; ?></h2>
                    <?php else : ?>
                    ...
                    <?php if(!empty($feat_readmore_text) && !(empty($feat_readmore_link))) : ?>
                        <a class="button feat-page_readmore_btn" href="<?php echo $feat_readmore_link; ?>"><?php echo $feat_readmore_text; ?></a>
                    <?php endif; ?>
                </div>
                <?php endwhile; ?>
            <?php endif; ?>
