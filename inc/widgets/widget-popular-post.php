...
// register App_Landing_Page_Popular_Post widget
function app_landing_page_register_popular_post_widget() {
    register_widget( 'App_Landing_Page_Popular_Post' );
}
add_action( 'widgets_init', 'app_landing_page_register_popular_post_widget' );
 
 /**
 * Adds App_Landing_Page_Popular_Post widget.
 */
class App_Landing_Page_Popular_Post extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'app_landing_page_popular_post', // Base ID
			esc_html__( 'RARA: Popular Post', 'app-landing-page' ), // Name
			array( 'description' => esc_html__( 'A Popular Post Widget', 'app-landing-page' ), ) // Args
		);
	}
	...
	public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php esc_html_e( 'Title', 'app-landing-page' ); ?></label> 
            <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'title' ) );  ?>" name="<?php echo esc_attr( $this->get_field_name( 'title' ) ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" />
		</p>
        
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'num_post' ) ); ?>"><?php esc_html_e( 'Number of Posts', 'app-landing-page' ); ?></label> 
        ...
        <p>
            ...
            <label for="<?php echo esc_attr( $this->get_field_id( 'show_thumbnail' ) ); ?>"><?php esc_html_e( 'Show Post Thumbnail', 'app-landing-page' ); ?></label>
		</p>
        ...
        <p>
            ...
            <label for="<?php echo esc_attr( $this->get_field_id( 'show_postdate' ) ); ?>"><?php esc_html_e( 'Show Post Date', 'app-landing-page' ); ?></label>
		</p>
		<?php 
	}
...
} // class App_Landing_Page_Popular_Post 