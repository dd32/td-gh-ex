 ...
 */
 if( !class_exists('NNfy_description_Widget') ){
	class NNfy_description_Widget extends WP_Widget{
		/**
		 * Register widget with WordPress.
		 */
		function __construct(){
			$widget_ops = array( 'description' => esc_html__('Our short description  .','99fy'),'customize_selective_refresh' => true, );
			parent:: __construct('NNfy_description_Widget', esc_html__('NNfy: Short Description','99fy'),$widget_ops );
		}
		/**
		...
		?>
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('image')); ?>"><?php echo esc_html__('Upload Image:','99fy');?></label>
					...
					<a href="#" id="custom_media_button" style="margin-top:10px;" class="button button-primary custom_media_button"><?php esc_html_e('Upload', '99fy'); ?></a>
			</p>
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('text')); ?>"><?php echo esc_html__('Content:' ,'99fy') ?></label>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('rss')); ?>"><?php echo esc_html__('Rss Link:' ,'99fy') ?></label>
...
function NNfy_description_Widget() {
    register_widget( 'NNfy_description_Widget' );
}
add_action( 'widgets_init', 'NNfy_description_Widget' );