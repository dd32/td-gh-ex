...
<div class="column clearfix">
  <div class="one-half">
    ...
    <div class="testimonial-content">
      ...
      <div class="testimonial-meta"> <strong><?php echo esc_html( $name2 ); ?></strong> <?php echo esc_html( $designation2 );  echo '-'; ?> <a href="<?php echo esc_url($company_link1); ?>" title="<?php echo $company_name1; ?>" target="_blank"> <?php echo esc_html( $company_name1 ); ?></a> </div>
    </div>
  </div>
  <div class="one-half">
