...
class Smartline_Category_Posts_Grid_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_ops = array(
			...
			'description' => esc_html__( 'Displays your posts from a selected category in a grid layout. Please use this widget ONLY in the Magazine Homepage widget area.', 'smartline-lite' ),
			'customize_selective_refresh' => true,
		);
		parent::__construct('smartline_category_posts_grid', sprintf( esc_html__( 'Category Posts: Grid (%s)', 'smartline-lite' ), 'Smartline' ), $widget_ops);
