...
class absolutte_Contact_Info extends WP_Widget{
        ...
        ?>
            ...
            <div class="widget_contact_info">
                ...
                <ul>
                    ...
                    <li class="email"><i class="fa fa-envelope"></i> <a href="mailto:<?php echo $instance['email']; ?>"><?php  echo $instance['email']; ?></a></li>
                    <?php } ?>
    ...
    public function form( $instance ) {
        ...
        <p>
            ...
            <label for="<?php echo $this->get_field_id('title'); ?>"><?php esc_html_e( 'Title', 'absolutte' ); ?></label><br/>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('address'); ?>"><?php esc_html_e( 'Address', 'absolutte' ); ?></label><br />
        ...
        <p>
            <label for="<?php echo $this->get_field_id('email'); ?>"><?php esc_html_e( 'Email', 'absolutte' ); ?></label><br />
        ...
        <p>
            <label for="<?php echo $this->get_field_id('phone'); ?>"><?php esc_html_e( 'Phone', 'absolutte' ); ?></label><br />
        ...
        <p>
            <label for="<?php echo $this->get_field_id('website'); ?>"><?php esc_html_e( 'Website', 'absolutte' ); ?></label><br />
