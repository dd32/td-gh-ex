...
class Aster_Social_Widget extends WP_Widget {

    public function __construct() {
        parent::__construct(
            'aster_social_button', // Base ID
            esc_html__('Aster Social Icons', 'aster'), // Name
            array('description' => esc_html__('Displaying social icons', 'aster'),) // Args
        );
    }
    ...
    public function form($instance) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php esc_html_e('Title :', 'aster');
                ?></label>
            <input class="widefat" id="<?php echo esc_attr($this->get_field_id('title')); ?>" name="<?php echo esc_attr($this->get_field_name('title')); ?>" type="text" value="<?php echo esc_attr($title); ?>" />
        </p>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('facebook')); ?>"><?php esc_html_e('Enter facebook URL:', 'aster');
                ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('twitter')); ?>"><?php esc_html_e('Enter twitter URL:', 'aster'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('google')); ?>"><?php esc_html_e('Enter google URL:', 'aster'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('pinterest')); ?>"><?php esc_html_e('Enter pinterest URL:', 'aster'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('dribbble')); ?>"><?php esc_html_e('Enter dribbble URL:', 'aster'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('behance')); ?>"><?php esc_html_e('Enter behance URL:', 'aster'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('youtube')); ?>"><?php esc_html_e('Enter youtube URL:', 'aster'); ?></label>
    ...
    {
        $title = apply_filters('widget_title', empty($instance['title']) ? __('Social Icons', 'aster') :
