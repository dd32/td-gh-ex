 ...
 * Adds Author widget.
 */
class anissa_Author_Box_Widget extends WP_Widget
{

	public function __construct()
	{
		parent::__construct(
			'anissa-author-box-widget',
			__( 'Author Box Widget', 'anissa' ),
			array(
				'description' => __( 'Author box widget for the sidebar', 'anissa' ),
			)
		);
	}
	...
	{
		echo '<div class="anissa-author-box-widget-container">';
		echo '<label for="author">' . __( 'Settings for author: ', 'anissa' ) . '</label>';
		...
		foreach ( $users as $user ):
			...
			$title = ( isset( $instance['title-' . $user->ID] ) ) ? $instance['title-' . $user->ID] : __( 'AUTHOR PROFILE', 'anissa' );
			$textbox = ( isset( $instance['textbox-' . $user->ID] ) ) ? $instance['textbox-' . $user->ID] : __( 'About the author text', 'anissa' );
			...
			?>
			<div id="anissa-author-box-settings-<?php echo $user->ID; ?>" class="hidden"
				 style="<?php if ( $showUserId === $user->ID ): ?>display: block;<?php endif; ?>">

				<p>
					<label
						for="<?php echo $this->get_field_id( 'title-' . $user->ID ); ?>"><?php _e( 'Title', 'anissa' ); ?></label>
				...
				<p>
					<label
						for="<?php echo $this->get_field_id( 'textbox-' . $user->ID ); ?>"><?php _e( 'About:', 'anissa' ); ?></label>
				...
				<p>
					<label
						for="<?php echo $this->get_field_id( 'social_twitter-' . $user->ID ); ?>"><?php _e( 'Twitter url', 'anissa' ); ?></label>
					...
					<label
						for="<?php echo $this->get_field_id( 'social_facebook-' . $user->ID ); ?>"><?php _e( 'Facebook url', 'anissa' ); ?></label>
					...
					<label
						for="<?php echo $this->get_field_id( 'social_dribbble-' . $user->ID ); ?>"><?php _e( 'Dribbble url', 'anissa' ); ?></label>
					...
					<label
						for="<?php echo $this->get_field_id( 'social_pinterest-' . $user->ID ); ?>"><?php _e( 'Pinterest url', 'anissa' ); ?></label>
					...
					<label
						for="<?php echo $this->get_field_id( 'social_linkedin-' . $user->ID ); ?>"><?php _e( 'Linkedin url', 'anissa' ); ?></label>
					...
					<label
						for="<?php echo $this->get_field_id( 'social_drupal-' . $user->ID ); ?>"><?php _e( 'Drupal url', 'anissa' ); ?></label>
					...
					<label
						for="<?php echo $this->get_field_id( 'social_wordpress-' . $user->ID ); ?>"><?php _e( 'Wordpress url', 'anissa' ); ?></label>
					...
					<label
						for="<?php echo $this->get_field_id( 'social_y-combinator-' . $user->ID ); ?>"><?php _e( 'Y-combinator url', 'anissa' ); ?></label>
					...
					<label
						for="<?php echo $this->get_field_id( 'social_google-plus-' . $user->ID ); ?>"><?php _e( 'Google+ url', 'anissa' ); ?></label>
					...
					<label
						for="<?php echo $this->get_field_id( 'social_behance-' . $user->ID ); ?>"><?php _e( 'Behance url', 'anissa' ); ?></label>
					...
					<label
						for="<?php echo $this->get_field_id( 'social_500px-' . $user->ID ); ?>"><?php _e( '500px url', 'anissa' ); ?></label>
					...
					<label
						for="<?php echo $this->get_field_id( 'social_flickr-' . $user->ID ); ?>"><?php _e( 'Flickr url', 'anissa' ); ?></label>
					...
					<label
						for="<?php echo $this->get_field_id( 'social_reddit-' . $user->ID ); ?>"><?php _e( 'Reddit url', 'anissa' ); ?></label>
					...
					<label
						for="<?php echo $this->get_field_id( 'social_youtube-' . $user->ID ); ?>"><?php _e( 'Youtube url', 'anissa' ); ?></label>
					...
					<label
						for="<?php echo $this->get_field_id( 'social_soundcloud-' . $user->ID ); ?>"><?php _e( 'Soundcloud url', 'anissa' ); ?></label>
					...
					<label
						for="<?php echo $this->get_field_id( 'social_medium-' . $user->ID ); ?>"><?php _e( 'Medium url', 'anissa' ); ?></label>
				...
				<p>
					<label
						for="<?php echo $this->get_field_id( 'image_url-' . $user->ID ); ?>"><?php _e( 'Image:', 'anissa' ); ?></label><br/>
					...
					<input type="button" class="anissa-select-img"
						   value="<?php _e( 'Select Image', 'anissa' ); ?>"/>
				</p>
			</div>
		<?php
		endforeach;
		echo '<input type="hidden" id="anissa-current-author" name="' . $this->get_field_name( 'author' ) . '" value="' . $users[0]->ID . '">';
		echo '</div>';
	}
