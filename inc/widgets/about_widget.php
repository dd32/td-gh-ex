...
class aster_about_widget extends WP_Widget {
	 ...
	 * Widget setup.
	 */
	function aster_about_widget() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'aster_about_widget', 'description' => __('A widget that displays an About
		widget', 'aster') );

		/* Widget control settings. */
		$control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => 'aster_about_widget' );

		/* Create the widget. */
		parent::__construct( 'aster_about_widget', __('Aster About Me', 'aster'), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		$defaults = array( 'title' => __('About Me', 'aster'), 'image' => '', 'description' => '');
		...
		<!-- image url -->
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'image' )); ?>"><?php _e('Image URL:', 'aster') ?></label>
