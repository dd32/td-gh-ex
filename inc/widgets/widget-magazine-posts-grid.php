...
class zeeDynamic_Magazine_Posts_Grid_Widget extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct(
			...
			esc_html__( 'Magazine (Grid)', 'zeedynamic' ), // Name.
			array(
				'classname' => 'zeedynamic-magazine-grid-widget',
	...
	function render( $settings ) {
		...
		// Get cached post ids.
		$post_ids = zeedynamic_get_magazine_post_ids( $this->id, $settings['category'], $settings['number'] );
	...
	function widget_title( $args, $settings ) {
		...
		if ( ! empty( $widget_title ) ) :
			...
			$widget_title = zeedynamic_magazine_widget_title( $widget_title, $settings['category'] );
