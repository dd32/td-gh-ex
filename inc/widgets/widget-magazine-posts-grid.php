...
class Beetle_Magazine_Posts_Grid_Widget extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct(
			...
			array(
				...
				'description' => esc_html__( 'Displays your posts from a selected category in a grid layout.', 'beetle' ),
	...
	private function default_settings() {
		...
		$defaults = array(
			'title'    => esc_html__( 'Magazine (Grid)', 'beetle' ),
			'category' => 0,
	...
	function widget_title( $args, $settings ) {
		...
		if ( ! empty( $widget_title ) ) :
			...
			$widget_title = beetle_magazine_widget_title( $widget_title, $settings['category'] );
