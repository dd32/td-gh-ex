...
class Beetle_Magazine_Posts_Grid_Widget extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct(
			...
			sprintf( esc_html__( 'Magazine Posts: Grid (%s)', 'beetle' ), wp_get_theme()->Name ), // Name
			array( 
				'classname' => 'beetle_magazine_posts_grid', 
	...
	function widget( $args, $instance ) {
		...
		if ( ! $this->is_preview() ) {
			$cache = wp_cache_get( 'widget_beetle_magazine_posts_grid', 'widget' );
		}
		if ( ! is_array( $cache ) ) {
			$cache = array();
		}
	...
	<?php
		...
		if ( ! $this->is_preview() ) {
			...
			wp_cache_set( 'widget_beetle_magazine_posts_grid', $cache, 'widget' );
		} else {
			ob_end_flush();
		}
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id('layout'); ?>"><?php esc_html_e( 'Grid Layout:', 'beetle' ); ?></label><br/>
			<select id="<?php echo $this->get_field_id('layout'); ?>" name="<?php echo $this->get_field_name('layout'); ?>">
				<option <?php selected( $settings['layout'], 'two-columns' ); ?> value="two-columns" ><?php esc_html_e( 'Two Columns Grid', 'beetle' ); ?></option>
				<option <?php selected( $settings['layout'], 'three-columns' ); ?> value="three-columns" ><?php esc_html_e( 'Three Columns Grid', 'beetle' ); ?></option>
			</select>
		</p>
		...
		<p>
			<label for="<?php echo $this->get_field_id('excerpt'); ?>">
				...
				<?php esc_html_e( 'Display post excerpt', 'beetle' ); ?>
			</label>
		</p>
...
<?php
	...
	public function delete_widget_cache() {
		...
		wp_cache_delete( 'widget_beetle_magazine_posts_grid', 'widget' );
...
// Register Widget
add_action( 'widgets_init', 'beetle_register_magazine_posts_grid_widget' );

function beetle_register_magazine_posts_grid_widget() {

	register_widget( 'Beetle_Magazine_Posts_Grid_Widget' );
