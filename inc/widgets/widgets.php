...
/**
 * Class bfastmag_Ad_Code
 */
class bfastmag_Ad_Code extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		echo '<div class="bfastmag-a-d-v-content">';
	...
	public function form( $instance ) {
		...
		$code = 'banner_code';
		?>
	  <h3><?php esc_html_e( 'Advertisement ', 'bfastmag' );?></h3>
	  <p class="description">
		<?php
	  ...
	  <p>
		<input type="radio" name="<?php echo esc_attr( $this->get_field_name( 'ad_type' ) ); ?>" value="image" class="bfastmag-big-ad-type" <?php if ( ! empty( $instance['ad_type'] ) ) :  checked( $instance['ad_type'], 'image' );
endif; ?>/> <?php esc_html_e( 'Image', 'bfastmag' ); ?>
		<input type="radio" name="<?php echo esc_attr( $this->get_field_name( 'ad_type' ) ); ?>" value="code" class="bfastmag-big-ad-type" <?php if ( ! empty( $instance['ad_type'] ) ) :  checked( $instance['ad_type'], 'code' );
endif; ?>/> <?php esc_html_e( 'Code', 'bfastmag' ); ?>
	  </p>

		<p class="bfastmag-big-ad-image" style="<?php if ( $instance['ad_type'] == 'code' ) { echo 'display:none'; } ?>">
		...
		<label for="<?php echo esc_attr( $this->get_field_id( 'new_tab' ) ); ?>"><?php _e( 'Open in new tab', 'bfastmag' ); ?></label> <br/>

		<label for="<?php echo esc_attr( $this->get_field_id( $link ) ); ?>"><?php _e( 'Link', 'bfastmag' ); ?></label><br/>
		...
		<label for="<?php echo esc_attr( $this->get_field_name( $url ) ); ?>"><?php _e( 'Image:','bfastmag' ); ?></label>
	  ...
	  <p class="bfastmag-big-ad-code" style="<?php if ( $instance['ad_type'] == 'image' ) { echo 'display:none'; } ?>">
		<label for="<?php echo esc_attr( $this->get_field_name( $code ) ); ?>"><?php _e( 'Code:','bfastmag' ); ?></label><br/>
		<textarea name="<?php echo esc_attr( $this->get_field_name( $code ) ); ?>" placeholder="<?php esc_html_e( 'Text', 'bfastmag' ); ?>"><?php if ( ! empty( $instance[ $code ] ) ) :  echo $instance[ $code ];
endif; ?></textarea>
	  </p>
<?php
	}
...
/**
 * Class bfastmag_sb_ad
 *
 * @package WordPress
 * @subpackage bfastmag
 */
class bfastmag_sb_ad extends WP_Widget {
	...
	public function form( $instance ) {
	  ...
	  <p>
		<label for="<?php echo esc_attr( $this->get_field_id( 'widget_title' ) ); ?>"><?php _e( 'Title', 'bfastmag' ); ?></label><br/>
	  ...
	  <p class="description">
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( $title_alt ) ); ?>"><?php _e( 'Alt Title','bfastmag' ); ?></label><br/>
