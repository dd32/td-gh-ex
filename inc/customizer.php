			...
			<div class="star-radio-buttons">
				<fieldset>
					...
					<label>
						...
						<i class="fa fa-female"></i> <?php esc_html_e( 'Female', 'star' ); ?>
					</label>
					<label>
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			...
			array(
				...
				'description' => __( 'This color shows if no header image has been selected.', 'star' ),
...
/**
 * Sanitze the customizer checkboxes.
 *
