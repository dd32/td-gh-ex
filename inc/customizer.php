...
function advance_fitness_gym_customize_register($wp_customize) {
	...
	// woocommerce section
	$wp_customize->add_setting('advance_fitness_gym_show_related_products',array(
       'default' => true,
       'sanitize_callback'	=> 'advance_fitness_gym_sanitize_checkbox'
    ));
    $wp_customize->add_control('advance_fitness_gym_show_related_products',array(
       'type' => 'checkbox',
       'label' => __('Show / Hide Related Product','advance-fitness-gym'),
       'section' => 'woocommerce_product_catalog',
    ));

	$wp_customize->add_setting('advance_fitness_gym_show_wooproducts_border',array(
       'default' => false,
       'sanitize_callback'	=> 'advance_fitness_gym_sanitize_checkbox'
    ));
    $wp_customize->add_control('advance_fitness_gym_show_wooproducts_border',array(
       'type' => 'checkbox',
       'label' => __('Show / Hide Product Border','advance-fitness-gym'),
       'section' => 'woocommerce_product_catalog',
    ));

    $wp_customize->add_setting( 'advance_fitness_gym_wooproducts_per_columns' , array(
		'default'           => 3,
		'transport'         => 'refresh',
		'sanitize_callback' => 'advance_fitness_gym_sanitize_choices',
	) );
	$wp_customize->add_control( 'advance_fitness_gym_wooproducts_per_columns', array(
		'label'    => __( 'Display Product Per Columns', 'advance-fitness-gym' ),
		'section'  => 'woocommerce_product_catalog',
		'type'     => 'select',
		'choices'  => array(
						'2' => '2',
	...
	$wp_customize->add_setting('advance_fitness_gym_wooproducts_per_page',array(
		'default'	=> 9,
		'sanitize_callback'	=> 'advance_fitness_gym_sanitize_float',
	));	
	$wp_customize->add_control('advance_fitness_gym_wooproducts_per_page',array(
		'label'	=> __('Display Product Per Page','advance-fitness-gym'),
		'section'	=> 'woocommerce_product_catalog',
		'type'		=> 'number'
	));

	$wp_customize->add_setting( 'advance_fitness_gym_top_bottom_wooproducts_padding',array(
		'default' => 0,
		'sanitize_callback'	=> 'advance_fitness_gym_sanitize_float',
	));
	$wp_customize->add_control( 'advance_fitness_gym_top_bottom_wooproducts_padding',	array(
		'label' => esc_html__( 'Top Bottom Product Padding','advance-fitness-gym' ),
		'section' => 'woocommerce_product_catalog',
		'input_attrs' => array(
			'min' => 0,
			'max' => 50,
	...
	$wp_customize->add_setting( 'advance_fitness_gym_left_right_wooproducts_padding',array(
		'default' => 0,
		'sanitize_callback'	=> 'advance_fitness_gym_sanitize_float',
	));
	$wp_customize->add_control( 'advance_fitness_gym_left_right_wooproducts_padding',	array(
		'label' => esc_html__( 'Right Left Product Padding','advance-fitness-gym' ),
		'section' => 'woocommerce_product_catalog',
		'input_attrs' => array(
			'min' => 0,
			'max' => 50,
	...
	$wp_customize->add_setting( 'advance_fitness_gym_wooproducts_border_radius',array(
		'default' => 0,
		'sanitize_callback'    => 'advance_fitness_gym_sanitize_number_range',
	));
	$wp_customize->add_control('advance_fitness_gym_wooproducts_border_radius',array(
		'label' => esc_html__( 'Product Border Radius','advance-fitness-gym' ),
		'section' => 'woocommerce_product_catalog',
		'input_attrs' => array(
			'min' => 0,
			'max' => 50,
	...
	$wp_customize->add_setting( 'advance_fitness_gym_wooproducts_box_shadow',array(
		'default' => 0,
		'sanitize_callback'    => 'advance_fitness_gym_sanitize_number_range',
	));
	$wp_customize->add_control('advance_fitness_gym_wooproducts_box_shadow',array(
		'label' => esc_html__( 'Product Box Shadow','advance-fitness-gym' ),
		'section' => 'woocommerce_product_catalog',
		'input_attrs' => array(
			'min' => 0,
			'max' => 50,
	...
	$wp_customize->add_section('advance_fitness_gym_product_button_section', array(
		'title'    => __('Product Button Settings', 'advance-fitness-gym'),
		'priority' => null,
		'panel'    => 'woocommerce',
	));

	$wp_customize->add_setting( 'advance_fitness_gym_top_bottom_product_button_padding',array(
		'default' => 10,
		'sanitize_callback'	=> 'advance_fitness_gym_sanitize_float',
	));
	$wp_customize->add_control('advance_fitness_gym_top_bottom_product_button_padding',	array(
		'label' => esc_html__( 'Product Button Top Bottom Padding','advance-fitness-gym' ),
		'section' => 'advance_fitness_gym_product_button_section',
		'input_attrs' => array(
			'min' => 0,
			'max' => 50,
			'step' => 1,
	...
	$wp_customize->add_setting( 'advance_fitness_gym_left_right_product_button_padding',array(
		'default' => 16,
		'sanitize_callback'	=> 'advance_fitness_gym_sanitize_float',
	));
	$wp_customize->add_control('advance_fitness_gym_left_right_product_button_padding',array(
		'label' => esc_html__( 'Product Button Right Left Padding','advance-fitness-gym' ),
		'section' => 'advance_fitness_gym_product_button_section',
		'type'		=> 'number',
		'input_attrs' => array(
			'min' => 0,
	...
	$wp_customize->add_setting( 'advance_fitness_gym_product_button_border_radius',array(
		'default' => 0,
		'sanitize_callback'    => 'advance_fitness_gym_sanitize_number_range',
	));
	$wp_customize->add_control('advance_fitness_gym_product_button_border_radius',array(
		'label' => esc_html__( 'Product Button Border Radius','advance-fitness-gym' ),
		'section' => 'advance_fitness_gym_product_button_section',
		'type'		=> 'range',
		'input_attrs' => array(
			'min' => 0,
	...
	$wp_customize->add_setting('advance_fitness_gym_preloader_option',array(
       'default' => true,
       'sanitize_callback'	=> 'advance_fitness_gym_sanitize_checkbox'
    ));
    $wp_customize->add_control('advance_fitness_gym_preloader_option',array(
       'type' => 'checkbox',
       'label' => __('Show / Hide Preloader','advance-fitness-gym'),
       'section' => 'advance_fitness_gym_left_right'
    ));

    $wp_customize->add_setting( 'advance_fitness_gym_shop_page_sidebar',array(
		'default' => true,
		'sanitize_callback'	=> 'advance_fitness_gym_sanitize_checkbox'
    ) );
    $wp_customize->add_control('advance_fitness_gym_shop_page_sidebar',array(
    	'type' => 'checkbox',
       	'label' => __('Show / Hide Shop Page Sidebar','advance-fitness-gym'),
		'section' => 'advance_fitness_gym_left_right'
    ));

	$wp_customize->add_setting( 'advance_fitness_gym_wocommerce_single_page_sidebar',array(
		'default' => true,
		'sanitize_callback'	=> 'advance_fitness_gym_sanitize_checkbox'
    ) );
    $wp_customize->add_control('advance_fitness_gym_wocommerce_single_page_sidebar',array(
    	'type' => 'checkbox',
       	'label' => __('Show / Hide Single Product Page Sidebar','advance-fitness-gym'),
		'section' => 'advance_fitness_gym_left_right'
    ));
	...
	$wp_customize->add_section( 'advance_fitness_gym_theme_button', array(
		'title' => __('Button Option','advance-fitness-gym'),
		'panel' => 'advance_fitness_gym_panel_id',
	));

	$wp_customize->add_setting('advance_fitness_gym_button_padding_top_bottom',array(
		'default'=> '',
		'sanitize_callback'	=> 'advance_fitness_gym_sanitize_float',
	));
	$wp_customize->add_control('advance_fitness_gym_button_padding_top_bottom',array(
		'label'	=> __('Top and Bottom Padding','advance-fitness-gym'),
		'input_attrs' => array(
            'step'             => 1,
			'min'              => 0,
			'max'              => 50,
        ),
		'section'=> 'advance_fitness_gym_theme_button',
		'type'=> 'number'
	));

	$wp_customize->add_setting('advance_fitness_gym_button_padding_left_right',array(
		'default'=> '',
		'sanitize_callback'	=> 'advance_fitness_gym_sanitize_float',
	));
	$wp_customize->add_control('advance_fitness_gym_button_padding_left_right',array(
		'label'	=> __('Left and Right Padding','advance-fitness-gym'),
		'input_attrs' => array(
            'step'             => 1,
			'min'              => 0,
			'max'              => 50,
	...
	$wp_customize->add_setting( 'advance_fitness_gym_button_border_radius', array(
		'default'=> '',
		'sanitize_callback'	=> 'advance_fitness_gym_sanitize_float',
	) );
	$wp_customize->add_control( 'advance_fitness_gym_button_border_radius', array(
		'label'       => esc_html__( 'Button Border Radius','advance-fitness-gym' ),
		'section'     => 'advance_fitness_gym_theme_button',
		'type'        => 'number',
		'input_attrs' => array(
			'step'             => 1,
	...
	$wp_customize->add_setting('advance_fitness_gym_contact',array(
		'default'	=> '',
		'sanitize_callback'	=> 'advance_fitness_gym_sanitize_phone_number'
	));	
	...
	$wp_customize->add_setting('advance_fitness_gym_email',array(
		'default'	=> '',
		'sanitize_callback'	=> 'advance_fitness_gym_sanitize_email'
	));	
	...
	$wp_customize->add_setting('advance_fitness_gym_slider_overlay',array(
       'default' => true,
       'sanitize_callback'	=> 'advance_fitness_gym_sanitize_checkbox'
    ));
    $wp_customize->add_control('advance_fitness_gym_slider_overlay',array(
       'type' => 'checkbox',
       'label' => __('Home Page Slider Overlay','advance-fitness-gym'),
		'description'    => __('This option will add colors over the slider.','advance-fitness-gym'),
       'section' => 'advance_fitness_gym_slider'
    ));

    $wp_customize->add_setting('advance_fitness_gym_slider_image_overlay_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'advance_fitness_gym_slider_image_overlay_color', array(
		'label'    => __('Home Page Slider Overlay Color', 'advance-fitness-gym'),
		'section'  => 'advance_fitness_gym_slider',
		'description'    => __('It will add the color overlay of the slider. To make it transparent, use the below option.','advance-fitness-gym'),
		'settings' => 'advance_fitness_gym_slider_image_overlay_color',
	)));
	...
	//404 Page Setting
	$wp_customize->add_section('advance_fitness_gym_404_page_setting',array(
		'title'	=> __('404 Page','advance-fitness-gym'),
		'panel' => 'advance_fitness_gym_panel_id',
	));	

	$wp_customize->add_setting('advance_fitness_gym_title_404_page',array(
		'default'=> __('404 Not Found', 'advance-fitness-gym'),
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('advance_fitness_gym_title_404_page',array(
		'label'	=> __('404 Page Title','advance-fitness-gym'),
		'section'=> 'advance_fitness_gym_404_page_setting',
		'type'=> 'text'
	));

	$wp_customize->add_setting('advance_fitness_gym_content_404_page',array(
		'default'=> __('Looks like you have taken a wrong turn&hellip. Dont worry&hellip it happens to the best of us.', 'advance-fitness-gym'),
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('advance_fitness_gym_content_404_page',array(
		'label'	=> __('404 Page Content','advance-fitness-gym'),
		'section'=> 'advance_fitness_gym_404_page_setting',
		'type'=> 'text'
	));

	$wp_customize->add_setting('advance_fitness_gym_button_404_page',array(
		'default'=>  __('Back to Home Page', 'advance-fitness-gym'),
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('advance_fitness_gym_button_404_page',array(
		'label'	=> __('404 Page Button','advance-fitness-gym'),
		'section'=> 'advance_fitness_gym_404_page_setting',
		'type'=> 'text'
	));

	//Responsive Media Settings
	$wp_customize->add_section('advance_fitness_gym_responsive_setting',array(
		'title'	=> __('Responsive Setting','advance-fitness-gym'),
		'panel' => 'advance_fitness_gym_panel_id',
	));
    ...
    $wp_customize->add_control('advance_fitness_gym_responsive_slider',array(
       'type' => 'checkbox',
       'label' => __('Slider','advance-fitness-gym'),
       'section' => 'advance_fitness_gym_responsive_setting'
    ));
    ...
    $wp_customize->add_setting('advance_fitness_gym_responsive_sidebar',array(
       'default' => true,
       'sanitize_callback'	=> 'advance_fitness_gym_sanitize_checkbox'
    ));
    $wp_customize->add_control('advance_fitness_gym_responsive_sidebar',array(
       'type' => 'checkbox',
       'label' => __('Sidebar','advance-fitness-gym'),
       'section' => 'advance_fitness_gym_responsive_setting'
    ));

    $wp_customize->add_setting('advance_fitness_gym_responsive_preloader',array(
       'default' => true,
       'sanitize_callback'	=> 'advance_fitness_gym_sanitize_checkbox'
    ));
    $wp_customize->add_control('advance_fitness_gym_responsive_preloader',array(
       'type' => 'checkbox',
       'label' => __('Preloader','advance-fitness-gym'),
       'section' => 'advance_fitness_gym_responsive_setting'
    ));
    ...
    $wp_customize->add_setting('advance_fitness_gym_show_featured_image_single_post',array(
       'default' => true,
       'sanitize_callback'	=> 'advance_fitness_gym_sanitize_checkbox'
    ));
    $wp_customize->add_control('advance_fitness_gym_show_featured_image_single_post',array(
       'type' => 'checkbox',
       'label' => __('Single Post Image','advance-fitness-gym'),
       'section' => 'advance_fitness_gym_blog_post'
    ));

    $wp_customize->add_setting('advance_fitness_gym_blog_post_description_option',array(
    	'default'   => __('Excerpt Content','advance-fitness-gym'),
        'sanitize_callback' => 'advance_fitness_gym_sanitize_choices'
	));
	...
	$wp_customize->add_setting( 'advance_fitness_gym_post_suffix_option', array(
		'default'   => __('...','advance-fitness-gym'),
		'sanitize_callback'	=> 'sanitize_text_field'
	) );
	...
	$wp_customize->add_setting('advance_fitness_gym_button_text',array(
		'default'=> __('READ MORE','advance-fitness-gym'),
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	...
	$wp_customize->add_setting( 'advance_fitness_gym_metabox_separator_blog_post', array(
		'default'   => '',
		'sanitize_callback'	=> 'sanitize_text_field'
	) );
	$wp_customize->add_control( 'advance_fitness_gym_metabox_separator_blog_post', array(
		'label'       => esc_html__( 'Meta Box Separator','advance-fitness-gym' ),
		'input_attrs' => array(
            'placeholder' => __( 'Add Meta Separator. e.g.: "|", "/", etc.', 'advance-fitness-gym' ),
        ),
		'section'     => 'advance_fitness_gym_blog_post',
		'type'        => 'text',
	...
	$wp_customize->add_setting('advance_fitness_gym_blog_post_pagination',array(
       'default' => true,
       'sanitize_callback'	=> 'advance_fitness_gym_sanitize_checkbox'
    ));
    $wp_customize->add_control('advance_fitness_gym_blog_post_pagination',array(
       'type' => 'checkbox',
       'label' => __('Pagination in Blog Page','advance-fitness-gym'),
       'section' => 'advance_fitness_gym_blog_post'
    ));
	...
	$wp_customize->add_setting('advance_fitness_gym_nosearch_found_title',array(
		'default'=> __('Nothing Found','advance-fitness-gym'),
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('advance_fitness_gym_nosearch_found_title',array(
		'label'	=> __('No Result Found Title','advance-fitness-gym'),
		'section'=> 'advance_fitness_gym_noresult_found',
		'type'=> 'text'
	));

	$wp_customize->add_setting('advance_fitness_gym_nosearch_found_content',array(
		'default'=> __('Sorry, but nothing matched your search terms. Please try again with some different keywords.','advance-fitness-gym'),
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('advance_fitness_gym_nosearch_found_content',array(
		'label'	=> __('No Result Found Content','advance-fitness-gym'),
		'section'=> 'advance_fitness_gym_noresult_found',
		'type'=> 'text'
	));

	$wp_customize->add_setting('advance_fitness_gym_show_noresult_search',array(
       'default' => true,
       'sanitize_callback'	=> 'advance_fitness_gym_sanitize_checkbox'
    ));
    $wp_customize->add_control('advance_fitness_gym_show_noresult_search',array(
       'type' => 'checkbox',
       'label' => __('No Result search','advance-fitness-gym'),
       'section' => 'advance_fitness_gym_noresult_found'
    ));
    ...
    $wp_customize->add_setting('advance_fitness_gym_footer_widget_bg_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'advance_fitness_gym_footer_widget_bg_color', array(
		'label'    => __('Footer Widget Background Color', 'advance-fitness-gym'),
		'section'  => 'advance_fitness_gym_footer_section',
	)));

	$wp_customize->add_setting('advance_fitness_gym_footer_widget_bg_image',array(
		'default'	=> '',
		'sanitize_callback'	=> 'esc_url_raw',
	));
	$wp_customize->add_control( new WP_Customize_Image_Control($wp_customize,'advance_fitness_gym_footer_widget_bg_image',array(
        'label' => __('Footer Widget Background Image','advance-fitness-gym'),
        'section' => 'advance_fitness_gym_footer_section'
	)));
	...
	$wp_customize->add_setting('advance_fitness_gym_copyright_content_align',array(
        'default' => __('center','advance-fitness-gym'),
        'sanitize_callback' => 'advance_fitness_gym_sanitize_choices'
	));
	$wp_customize->add_control('advance_fitness_gym_copyright_content_align',array(
        'type' => 'select',
        'label' => __('Copyright Text Alignment ','advance-fitness-gym'),
        'section' => 'advance_fitness_gym_footer_section',
        'choices' => array(
            'left' => __('Left','advance-fitness-gym'),
            'right' => __('Right','advance-fitness-gym'),
	...
	$wp_customize->add_setting('advance_fitness_gym_footer_content_font_size',array(
		'default'=> 15,
		'sanitize_callback'	=> 'advance_fitness_gym_sanitize_float',
	));
	$wp_customize->add_control('advance_fitness_gym_footer_content_font_size',array(
		'label' => esc_html__( 'Copyright Font Size','advance-fitness-gym' ),
		'section'=> 'advance_fitness_gym_footer_section',
		'input_attrs' => array(
            'step'             => 1,
			'min'              => 0,
	...
	$wp_customize->add_setting('advance_fitness_gym_copyright_padding',array(
		'default'=> 15,
		'sanitize_callback'	=> 'advance_fitness_gym_sanitize_float',
	));
	$wp_customize->add_control('advance_fitness_gym_copyright_padding',array(
		'label'	=> __('Copyright Padding','advance-fitness-gym'),
		'input_attrs' => array(
            'step'             => 1,
			'min'              => 0,
			'max'              => 50,
	...
	$wp_customize->add_setting('advance_fitness_gym_scroll_font_size_icon',array(
		'default'=> 20,
		'sanitize_callback'	=> 'advance_fitness_gym_sanitize_float',
	));
	$wp_customize->add_control('advance_fitness_gym_scroll_font_size_icon',array(
		'label'	=> __('Scroll Icon Font Size','advance-fitness-gym'),
		'section'=> 'advance_fitness_gym_footer_section',
		'input_attrs' => array(
            'step'             => 1,
			'min'              => 0,
