	...
	function customize_register( $wp_customize ){
		...
		if( method_exists($wp_customize, 'add_panel') ) {
			$wp_customize->add_panel( 'theme_settings', array(
				'title' => __( 'Theme Settings', 'origami' ),
				'description' => __( 'Change settings for your theme.', 'origami' ),
				'priority' => 10,
			) );
		}
		...
		if(
			...
			$wp_customize->add_section( 'theme_settings_premium', array(
				'title' => __( 'SiteOrigin Premium', 'origami' ),
				'priority' => 1,
			...
			$wp_customize->add_control(
				new SiteOrigin_Settings_Control_Premium(
					...
					array(
						'label' => __( 'SiteOrigin Premium', 'origami' ),
