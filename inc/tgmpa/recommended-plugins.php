...
add_action( 'tgmpa_register', 'avid_magazine_register_required_plugins', 15 );
/**
...
function avid_magazine_register_required_plugins() {
    /*
     ...
     */
    $config = array(
        'id'           => 'avid-magazine',    // Unique ID for hashing notices for multiple instances of TGMPA.
