...
class Rubine_Featured_Content {
	 ...
	 *
	 * @uses Rubine_Featured_Content::$max_posts
	 */
	public static function init() {

		add_filter( 'rubine_get_featured_content',     array( __CLASS__, 'get_featured_posts' )    );
	 ...
	 * Get featured posts
	 *
	 * @uses Rubine_Featured_Content::get_featured_post_ids()
	 *
	 * @return array
	 */
	...
	public static function get_featured_post_ids() {
		...
		if ( ! empty( $featured_ids ) ) {
			return array_map( 'absint', apply_filters( 'rubine_featured_content_post_ids', (array) $featured_ids ) );
		}
		...
		if ( $term ) {
			...
			return apply_filters( 'rubine_featured_content_post_ids', array() );
		}
		...
		return apply_filters( 'rubine_featured_content_post_ids', $featured_ids );
	}
	 ...
	 * @see Rubine_Featured_Content::validate_settings().
	 */
	 ...
	 * is deleted by Rubine_Featured_Content::validate_settings().
	 *
	...
	public static function customize_register( $wp_customize ) {
		 ...
		 *
		 * Sanitization callback registered in Rubine_Featured_Content::validate_settings().
	...
	public static function enqueue_scripts() {
		wp_enqueue_script( 'rubine-featured-content-suggest', get_template_directory_uri() . '/js/featured-content-admin.js', array( 'jquery', 'suggest' ), '20150401', true );
	}
	 ...
	 * Rubine_Featured_Content::get_featured_content().
	 *
	 * @uses Rubine_Featured_Content::delete_transient()
	 *
	 * @param array $input
	 * @return array $output
	 */
