 ...
 */
function a_portfolio_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function a_portfolio_sanitize_dropdown_pages( $page_id, $setting ) {
 ...
 */
function a_portfolio_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function a_portfolio_sanitize_number_absint( $number, $setting ) {
 ...
 */
function a_portfolio_sanitize_select( $input, $setting ) {
 ...
 * @return int
 */
function a_portfolio_sanitize_category($input){
	$output=intval($input);
	return $output;
}
...
/**
 * Class a_portfolio_Customize_Dropdown_Taxonomies_Control
 */
class a_portfolio_Customize_Dropdown_Taxonomies_Control extends WP_Customize_Control {
