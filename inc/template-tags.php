<?php
    ...
    if (!function_exists('aster_posts_navigation')) {

        function aster_posts_navigation()
        {
            ?>
                ...
                <?php if (get_previous_posts_link()) { ?>
                    <div class="col-xs-6 pull-left">
                        <div class="next-posts">
                            <div class="text-left">
                                <?php previous_posts_link(__('<i class="fa fa-angle-left"></i> Newer posts', 'aster')); ?></a>
                            </div>
                        </div>
                    </div>
                <?php } ?>
                    ...
                    <div class="col-xs-6 pull-right">
                        <div class="previous-posts">
                            <div class="text-right">
                                <?php next_posts_link(__('Older posts <i class="fa fa-angle-right"></i>', 'aster')); ?></a>
                            </div>
                        </div>
                    </div>
                <?php } ?>
    ...
    if (!function_exists('aster_posts_pagination')) {
        function aster_posts_pagination()
        {
            global $wp_query;
