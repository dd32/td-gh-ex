...
if ( ! function_exists( 'courage_site_logo' ) ) :
    /**
     * Displays the site logo in the header area
     */
	function courage_site_logo() {
...
if ( ! function_exists( 'courage_site_title' ) ) :
	/**
     * Displays the site title in the header area
     */
	function courage_site_title() {
...
if ( ! function_exists( 'courage_site_description' ) ) :
	/**
	 * Displays the site description in the header area
	 */
	function courage_site_description() {
