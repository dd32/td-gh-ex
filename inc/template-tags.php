...
if ( ! function_exists( 'aak_posted_on' ) ) :
	/**
...
if ( ! function_exists( 'aak_posted_by' ) ) :
	/**
...
if ( ! function_exists( 'aak_post_thumbnail' ) ) :
	/**
