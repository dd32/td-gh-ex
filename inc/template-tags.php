...
function skirmish_content_nav( $nav_id ) {
	...
	<nav role="navigation" id="<?php echo $nav_id; ?>" class="<?php echo $nav_class; ?>">
		<h1 class="assistive-text"><?php _e( 'Post navigation', 'skirmish' ); ?></h1>
		...
		<article id="comment-<?php comment_ID(); ?>" class="comment">
			<footer>
				<div class="comment-author vcard">
					...
					<?php printf( __( '%s <span class="says">says:</span>', 'skirmish' ), sprintf( '<cite class="fn">%s</cite>', get_comment_author_link() ) ); ?>
				...
				<div class="comment-meta commentmetadata">
					...
					<?php
						...
						printf( __( '%1$s at %2$s', 'skirmish' ), get_comment_date(), get_comment_time() ); ?>
					</time></a>
