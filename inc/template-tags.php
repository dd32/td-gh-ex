...
function artist_categorized_blog() {
	...
	if ( $all_the_cool_cats > 1 ) {
		// This blog has more than 1 category so artist_categorized_blog should return true.
		return true;
	} else {
		// This blog has only 1 category so artist_categorized_blog should return false.
		return false;
	}
}

/**
 * Flush out the transients used in artist_categorized_blog.
 */
...
/**
 * Check if header image is set. Display it.
 */
