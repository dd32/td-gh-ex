...
if ( ! function_exists( 'ansia_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time and author.
	 */
	function ansia_posted_on() {
			...
			comments_popup_link(
				sprintf(
					wp_kses(
						...
						__( 'Leave a Comment<span class="screen-reader-text"> on %s</span>', 'ansia' ),
						array(
							'span' => array(
								'class' => array(),
							),
...
if ( ! function_exists( 'ansia_entry_footer' ) ) :
	/**
	 * Prints HTML with meta information for the tags and edit links.
	 */
...
if ( ! function_exists( 'ansia_entry_category' ) ) :
	/**
