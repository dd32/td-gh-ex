...
if ( ! function_exists( 'atlas_concern_posted_on' ) ) :
	 ...
	 */
	function atlas_concern_posted_on() {
		...
		$posted_on = sprintf(
			...
			esc_html_x( 'Posted on %s', 'post date', 'atlas-concern' ),
...
if ( ! function_exists( 'atlas_concern_posted_by' ) ) :
	/**
	 * Prints HTML with meta information for the current author.
	 */
	function atlas_concern_posted_by() {
		$byline = sprintf(
			/* translators: %s: post author. */
			esc_html_x( 'by %s', 'post author', 'atlas-concern' ),
...
if ( ! function_exists( 'atlas_concern_entry_footer' ) ) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function atlas_concern_entry_footer() {
...
if ( ! function_exists( 'atlas_concern_post_thumbnail' ) ) :
	/**
	 ...
	 */
	function atlas_concern_post_thumbnail() {
