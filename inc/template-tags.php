		...
		*/
		function beam_content_nav( $nav_id ) {
			...
			if ( is_single() ) : // navigation links for single posts
				...
				previous_post_link( '<div class="nav-previous">%link</div>', '<span class="meta-nav">' . _x( '&larr;', 'Previous post link', 'beam' ) . '</span> %title' );
				next_post_link( '<div class="nav-next">%link</div>', '%title <span class="meta-nav">' . _x( '&rarr;', 'Next post link', 'beam' ) . '</span>' );
