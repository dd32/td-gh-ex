...
if ( ! function_exists( 'bb_wedding_bliss_the_attached_image' ) ) :
/**
 * Prints the attached image with a link to the next attached image.
 */
function bb_wedding_bliss_the_attached_image() {
	$post                = get_post();
	$attachment_size     = apply_filters( 'bb_wedding_bliss_attachment_size', array( 1200, 1200 ) );
...
function bb_wedding_bliss_categorized_blog() {
	...
	if ( '1' != $bb_wedding_bliss_all_the_cool_cats ) {
		...
		// This blog has only 1 category so bb_wedding_bliss_categorized_blog should return false
		return false;
	}
}

if ( ! function_exists( 'bb_wedding_bliss_the_custom_logo' ) ) :
/**
 * Displays the optional custom logo.
 *
 * Does nothing if the custom logo is not available.
 *
 * @since BB Wedding Bliss 1.2
 */
function bb_wedding_bliss_the_custom_logo() {
...
/**
 * Flush out the transients used in bb_wedding_bliss_categorized_blog
 */
