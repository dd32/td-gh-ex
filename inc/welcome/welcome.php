	...
	class Accesspress_Root_Welcome {
			...
			public function __construct( $plugins, $strings ) {
				...
				$this->tab_sections = array(
					...
					'support' => esc_html__('Support', 'accesspress-root'),
				);
			...
			public function welcome_admin_notice_display() {
				...
				if( is_admin() && ('themes.php' == $pagenow) /*&& (isset($_GET['activated']))*/ ) {
					...
					<div class="updated apwelcome-an notice notice-success is-dismissible">
						...
						<p class="about-desc"><?php /* translators: %s : Theme Name */ printf(esc_html__( 'Thank you for installing %1$s. It is now installed and ready to use. Here are some useful links to get started: ', 'accesspress-root' ), $this->theme_name);  ?></p>
						<hr/>
							...
							<div class="apwelcome-column col-doc">
								<div>
									<h3>
										...
										<?php printf(esc_html__( 'Documentation', 'accesspress-root' )) ?>
									</h3>
								...
								<div class="welcome-section-wrapper is_loading">
									...
									<div class="notice-sidebar is_loading">
										<div class= "notice-sidebar-item">
											<h4><?php echo esc_html('Join in our social networks!','accesspress-root') ?></h4>
											<p><?php echo esc_html__('Get connected, share your opinions and more via our social community: ', 'accesspress-root'); ?></p>

											<p><a href="<?php echo esc_url('https://www.facebook.com/AccessPressThemes')?>"><?php echo esc_html('Join our Facebook Group','accesspress-root') ?></a><?php echo esc_html__(' -to receive updates, offers and more.', 'accesspress-root'); ?></p>

											<p><a href="<?php echo esc_url('https://www.youtube.com/channel/UCzD8I1moKISXDjAVr8dIf-w')?>"><?php echo esc_html('Subscribe our YouTube Channel','accesspress-root') ?></a><?php echo esc_html__(' -for tutorials, videos and more.', 'accesspress-root'); ?></p>

											<p><a href="<?php echo esc_url('https://twitter.com/apthemes')?>"><?php echo esc_html('Follow us on Twitter','accesspress-root') ?></a><?php echo esc_html__(' -to stay updated. ', 'accesspress-root'); ?></p>
										</div>
										<div class= "notice-sidebar-item">
											<h4><?php echo esc_html('Rate us!','accesspress-root') ?></h4>
											<p><?php /* translators: %s : Theme Name */ printf(esc_html__('Are you enjoying %1$s? We would love to hear your feedback!', 'accesspress-root'),$this->theme_name); ?></p>
											<a href="https://wordpress.org/support/theme/accesspress-root/reviews/#new-post"><?php echo esc_html('Write a review','accesspress-root') ?></a>
				...
				// Get Plugin Info
					...
					public function plugin_activation_callback() {
						...
						if(file_exists($plugin_file)) {
							...
							echo esc_html__('Plugin Does not Exists' , 'accesspress-root');
						}
