<?php
if(!class_exists('Accesspress_Lite_Welcome')) :

	class Accesspress_Lite_Welcome {
			...
			public function __construct( $plugins, $strings ) {
				...
				$this->tab_sections = array(
					...
					'support' => esc_html__('Support', 'accesspress-lite'),
				);
						...
						<div class="apwelcome-column-wrap">
							...
							<div class="apwelcome-column col-demos">
								...
								<div>
									<div class="button-wrapper">
										<a class="button button-primary button-hero install-now" href="<?php echo esc_url(admin_url( 'themes.php?page=welcome-page#demo_import' )) ?>"><?php esc_html_e( 'ready to use starter sites.', 'accesspress-lite' ); ?></a>
									</div>
							...
							<div class="apwelcome-column col-doc">
								...
								<div class="apwelcome-doc-btn">
									<a href="#" class=" button" ><span><?php esc_html_e( 'Return to your Dashboard', 'accesspress-lite' ); ?></span></a>
								</div>
							</div>
						</div>
					</div>
