	...
	class Accesspress_Store_Welcome {
			...
			public function __construct( $plugins, $strings ) {
				...
				$this->tab_sections = array(
					...
					'actions_required' => esc_html__('Recommended Plugins', 'accesspress-store'),
					'demo_import' => esc_html__('Import Demo', 'accesspress-store'),
					'free_vs_pro' => esc_html__('Free Vs Pro', 'accesspress-store'),
					'changelog' => esc_html__('ChangeLog', 'accesspress-store'),
			...
			public function welcome_admin_notice_display() {
				...
				if( is_admin() && ('themes.php' == $pagenow)  && (isset($_GET['activated']))  ) {
					...
					<div class="updated apwelcome-an notice notice-success is-dismissible">
						...
						<p class="about-desc"><?php /* translators: %s : Theme Name */ printf(esc_html__( 'Thank you for installing %1$s. It is now installed and ready to use. Here are some useful links to get started: ', 'accesspress-store' ), $this->theme_name);  ?></p>
						<hr/>
							...
							<div class="apwelcome-column col-doc">
								<div>
									<h3>
										...
										<?php printf(esc_html__( 'Documentation', 'accesspress-store' )) ?>
									</h3>
									<p><?php printf( wp_kses_post( 'How to use %1$s! Here we\'ve a full and detailed documentation that explains how to use %1$s in its best. ', 'accesspress-store' ), $this->theme_name  ); ?></p>
									
									<div class="apwelcome-doc-btn">
									<a href="<?php echo esc_url($this->strings['doc_link']);?>" class=" button" ><span><?php esc_html_e( 'Full Documentation', 'accesspress-store' ); ?></span></a>
									<a href="<?php echo esc_url('https://accesspressthemes.com/support/')?>" class=" ti-return-dashboard  button button-secondary  install-now" ><span><?php esc_html_e( 'Contact Support', 'accesspress-store' ); ?></span></a>
									</div>
								</div>
								...
								<div class="welcome-section-wrapper is_loading">
									...
									<div class="notice-sidebar is_loading">
										<div class= "notice-sidebar-item">
											<h4><?php echo esc_html('Join in our social networks!','accesspress-store') ?></h4>
											<p><?php echo esc_html__('Get connected, share your opinions and more via our social community: ', 'accesspress-store'); ?></p>

											<p><a href="<?php echo esc_url('https://www.facebook.com/AccessPressThemes')?>"><?php echo esc_html('Join our Facebook Group','accesspress-store') ?></a><?php echo esc_html__(' -to receive updates, offers and more.', 'accesspress-store'); ?></p>

											<p><a href="<?php echo esc_url('https://www.youtube.com/channel/UCzD8I1moKISXDjAVr8dIf-w')?>"><?php echo esc_html('Subscribe our YouTube Channel','accesspress-store') ?></a><?php echo esc_html__(' -for tutorials, videos and more.', 'accesspress-store'); ?></p>

											<p><a href="<?php echo esc_url('https://twitter.com/apthemes')?>"><?php echo esc_html('Follow us on Twitter','accesspress-store') ?></a><?php echo esc_html__(' -to stay updated. ', 'accesspress-store'); ?></p>
										</div>
										<div class= "notice-sidebar-item">
											<h4><?php echo esc_html('Rate us!','accesspress-store') ?></h4>
											<p><?php /* translators: %s : Theme Name */ printf(esc_html__('Are you enjoying %1$s? We would love to hear your feedback!', 'accesspress-store'),$this->theme_name); ?></p>
											<a href="<?php echo esc_url('https://wordpress.org/support/theme/accesspress-store/reviews/#new-post')?>"><?php echo esc_html('Write a review','accesspress-store') ?></a>
				...
				// Get Plugin Info
					...
					public function plugin_activation_callback() {
						...
						if(file_exists($plugin_file)) {
							...
							echo esc_html__('Plugin Does not Exists' , 'accesspress-store');
						}
