	...
	class Accesspress_Mag_Welcome {
			...
			public function __construct( $plugins, $strings ) {
				...
				$this->tab_sections = array(
					'getting_started' => esc_html__('Getting Started', 'accesspress-mag'),
					'actions_required' => esc_html__('Required Plugins', 'accesspress-mag'),
					'recommended_plugins' => esc_html__('Recommended Plugins', 'accesspress-mag'),
					'demo_import' => esc_html__('Import Demo', 'accesspress-mag'),
					'free_vs_pro' => esc_html__('Free Vs Pro', 'accesspress-mag'),
					'changelog' => esc_html__('ChangeLog', 'accesspress-mag'),
					'support' => esc_html__('Support', 'accesspress-mag'),
				);
			...
			public function welcome_admin_notice_display() {
				...
				if( is_admin() && ('themes.php' == $pagenow) /*&& (isset($_GET['activated']))*/ ) {
					...
					<div class="updated apwelcome-an notice notice-success is-dismissible">
						<h2><?php printf(esc_html__( 'Welcome!', 'accesspress-mag' )) ?></h2>
						<p class="about-desc"><?php /* translators: %s : Theme Name */ printf(esc_html__( 'Thank you for installing %1$s. It is now installed and ready to use. Here are some useful links to get started: ', 'accesspress-mag' ), $this->theme_name);  ?></p>
						<hr/>
						<div class="apwelcome-column-wrap">
							...
							<div class="apwelcome-column col-demos">
								...
								<div>
									...
									<p><?php esc_html_e( 'You can also reach-out to us for any support during the theme setup and use.', 'accesspress-mag' ); ?></p>
							...
							<div class="apwelcome-column col-doc">
								...
								<div class="apwelcome-doc-btn">
									<a href="#" class=" button" ><span><?php esc_html_e( 'Return to your Dashboard', 'accesspress-mag' ); ?></span></a>
								</div>
							</div>
						</div>
					</div>
								...
								<div class="welcome-section-wrapper is_loading">
									...
									<div class="notice-sidebar is_loading">
										<div class= "notice-sidebar-item">
											<h4><?php echo esc_html('Join in our social networks!','accesspress-mag') ?></h4>
											<p><?php echo esc_html__('Get connected, share your opinions and more via our social community: ', 'accesspress-mag'); ?></p>

											<p><a href="<?php echo esc_url('https://www.facebook.com/AccessPressThemes')?>"><?php echo esc_html('Join our Facebook Group','accesspress-mag') ?></a><?php echo esc_html__(' -to receive updates, offers and more.', 'accesspress-mag'); ?></p>

											<p><a href="<?php echo esc_url('https://www.youtube.com/channel/UCzD8I1moKISXDjAVr8dIf-w')?>"><?php echo esc_html('Subscribe our YouTube Channel','accesspress-mag') ?></a><?php echo esc_html__(' -for tutorials, videos and more.', 'accesspress-mag'); ?></p>

											<p><a href="<?php echo esc_url('https://twitter.com/apthemes')?>"><?php echo esc_html('Follow us on Twitter','accesspress-mag') ?></a><?php echo esc_html__(' -to stay updated. ', 'accesspress-mag'); ?></p>
										</div>
										<div class= "notice-sidebar-item">
											<h4><?php echo esc_html('Rate us!','accesspress-mag') ?></h4>
											<p><?php /* translators: %s : Theme Name */ printf(esc_html__('Are you enjoying %1$s? We would love to hear your feedback!', 'accesspress-mag'),$this->theme_name); ?></p>
											<a href="https://wordpress.org/support/theme/accesspress-mag/reviews/#new-post"><?php echo esc_html('Write a review','accesspress-mag') ?></a>
				...
				// Get Plugin Info
					...
					public function plugin_activation_callback() {
						...
						if(file_exists($plugin_file)) {
							...
							echo esc_html__('Plugin Does not Exists' , 'accesspress-mag');
						}
