 ...
 * @since Aladdin 1.0.0
 */
add_action( 'customize_register', 'aladdin_customize_register_fonts' );
function aladdin_customize_register_fonts( $wp_customize ) {

	$defaults = aladdin_get_defaults();
	
	class aladdin_Customize_Reset_Control extends WP_Customize_Control {
		public $type = 'button';
		...
		public function render_content() {
			...
			<form>
				...
				<input type="button" onclick="aladdin_refresh()" value="<?php echo esc_attr( $this->value() ); ?>" <?php $this->link(); ?> />
			</form>
			<?php
		}
...
//Font for site
	$wp_customize->add_setting( 'body_font', array(
		...
		'sanitize_callback' => 'aladdin_sanitize_font_choice'
	) );
	$wp_customize->add_control( 'body_font', array(
		'label'   => __( 'Body Font', 'aladdin' ),
		'section' => 'fonts',
		'settings'   => 'body_font',
		'type'       => 'select',
		'priority'   => 2,
		'choices'	 => aladdin_get_font_choices(),
	) );	
...
//Font for headings
	$wp_customize->add_setting( 'heading_font_size', array(
		'default'        => $defaults['heading_font_size'],
		'capability'     => 'edit_theme_options',
		'sanitize_callback' => 'absint'
	) );
	
	$wp_customize->add_control( 'heading_font_size', array(
		'label'      => __( 'Heading font size(px)', 'aladdin' ),
		'section'    => 'fonts_size',
...
//Font weight for headings
	$wp_customize->add_setting( 'heading_weight', array(
		'default'        => $defaults['heading_weight'],
		'capability'     => 'edit_theme_options',
		'sanitize_callback' => 'aladdin_sanitize_weight_choice'
	) );
	$wp_customize->add_control( 'heading_weight', array(
		'label'   => __( 'Heading Font Weight', 'aladdin' ),
		'section' => 'fonts',
		'settings'   => 'heading_weight',
		'type'       => 'select',
		'priority'   => 2,
		'choices'	 => aladdin_get_weight_choices(),
	) );
	
//New section in customizer: Reset
	$wp_customize->add_section( 'reset', array(
		'title'          => __( 'Reset', 'aladdin' ),
		'description'          => __( 'Reset font settings to default', 'aladdin' ),
		'priority'       => $section_priority++,
		'panel'  => 'fonts',
	) );
	
	$wp_customize->add_setting( 'reset_fonts', array(
		'type'			 => 'empty',
		'default'        => __( 'Reset', 'aladdin' ),
		'sanitize_callback' => 'aladdin_sanitize_url'
	) );
	
	$wp_customize->add_control( new aladdin_Customize_Reset_Control( $wp_customize, 'reset_fonts', array(
		'label'   => 'reset_fonts',
		'section' => 'reset',
...
/**
 * Return weight choices for font.
 *
 * @return array weight choices.
 *
 * @since Aladdin 1.0.1
 */
function aladdin_get_weight_choices() {

	$out = array( 'lighter' => __( 'Lighter', 'aladdin' ), 
				  'normal' => __( 'Normal', 'aladdin' ), 
				  'bold' => __( 'Bold', 'aladdin' ));
	return $out;
}
 ...
 * @since Aladdin 1.0.1
 */
function aladdin_sanitize_weight_choice( $value ) {

	if ( array_key_exists( $value, aladdin_get_weight_choices() ) ) {
		return $value;
	} else {
		return 'lighter';
	}
 ...
 * @since Aladdin 1.0.0
 */
function aladdin_sanitize_font_choice( $value ) {
	if ( '0' == $value ) {
		return '0';
	} else if ( array_key_exists( $value, aladdin_get_font_choices() ) ) {
		return $value;
	} else {
		return 'Open Sans';
	}
 ...
 * @since Aladdin 1.0.0
 */
function aladdin_get_font_choices() {
	$fonts = aladdin_get_google_fonts();
	$out = array();
...
if ( ! function_exists( 'aladdin_get_google_fonts' ) ) :
/**
 ...
 * @since Aladdin 1.0.0
 */
function aladdin_get_google_fonts() {
	return array(
		'0' => array(
			'label'    => __( 'None', 'aladdin' ), 
		),		
		'ABeeZee' => array(
			'label'    => 'ABeeZee',
			'variants' => array(
 ...
 * @since Aladdin 1.0.1
*/
function aladdin_hook_font_css() {

	$body_font = aladdin_get_theme_mod( 'body_font' );
	
	$heading_font = aladdin_get_theme_mod( 'heading_font' );
	if ( '0' == $heading_font )
		$heading_font = $body_font;
		
	$header_font = aladdin_get_theme_mod( 'header_font' );
	if ( '0' == $header_font )
...
?>
	...
	.site-content ins,
	.site-content kbd,
	.site-content q, .site-content s, .site-content samp, .site-content small, .site-content strike, .site-content strong, .site-content sub, .site-content sup, .site-content tt, .site-content var, .site-content dl, .site-content dt, .site-content dd, .site-content ol, .ul, .site-content li, .site-content fieldset, .site-content form, .site-content label, .site-content legend, .site-content table, .site-content caption, .site-content tbody, .site-content tfoot, .site-content thead, .site-content tr, .site-content .site-content th, .site-content td,
	.site {
	<?php if ( '0' != $body_font ) : ?>
		font-family: '<?php echo esc_attr( $body_font ); ?>', sans-serif;
	<?php endif; ?>
		font-size: <?php echo esc_attr( aladdin_get_theme_mod( 'body_font_size' ) ); ?>px;
	}
	...
	h5,
	h6 {
		font-weight: <?php echo esc_attr( aladdin_get_theme_mod( 'heading_weight' ) ); ?>;
	<?php if ( '0' != $heading_font ) : ?>
		font-family: '<?php echo esc_attr( $heading_font ); ?>', sans-serif;
	<?php endif; ?>
	}
	
	<?php if ( '0' != $header_font ) : ?>
		.site .site-title h1,
		.site-title a  {
	...
	@media screen and (min-width: 680px) {
		h1 {
			font-size:<?php echo esc_attr( aladdin_get_theme_mod( 'heading_font_size' ) ); ?>px;
		}
	}
...
add_action( 'wp_head', 'aladdin_hook_font_css' );

 /**
 * Print js for reset fonts button in the customizer.
 *
 * @since Aladdin 1.0.1
*/
add_action( 'customize_controls_print_scripts', 'aladdin_print_customizer_js_colors' );
function aladdin_print_customizer_js_colors( ) {
	$defaults = aladdin_get_defaults();
	
	$fields = array(
		'body_font_size' => $defaults['body_font_size'],
		'heading_font_size' => $defaults['heading_font_size'],
		'heading_weight' => $defaults['heading_weight'],
		'header_font' => $defaults['header_font'],
		'heading_font' => $defaults['heading_font'],
		'body_font' => $defaults['body_font'],	
	);
	aladdin_print_reset( $fields, 'reset_fonts' );
}

 /**
 * Print js for reset fonts button in the customizer.
 *
 * $fields array conrols to be reset
 * $bind string reset control name
 *
 * @since Aladdin 1.0.1
*/
function aladdin_print_reset( $fields, $bind ) {

?>
<script type="text/javascript">
	
	function aladdin_set_val(name, newVal) {
	...
	function aladdin_refresh() { 
	
	<?php 
		foreach( $fields as $id => $value ) {
			?>
			aladdin_set_val( '<?php echo esc_js( $id ); ?>', '<?php echo esc_js( $value ); ?>' );
			<?php
		}	
	?>
	}
