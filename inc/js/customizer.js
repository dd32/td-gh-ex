...
--------------------------------------------------------------*/
	...
	// Other Color
	wp.customize( 'bellini_primary_color', function( value ) {
		value.bind( function( newval ) {
	...
	// Hero Content Color
	wp.customize( 'bellini_hero_content_color', function( value ) {
		value.bind( function( newval ) {
	...
	wp.customize( 'bellini_feature_block_background_color', function( value ) {
		value.bind( function( newval ) {
	...
	wp.customize( 'bellini_frontpage_textarea_section_color', function( value ) {
		value.bind( function( newval ) {
	...
	wp.customize( 'bellini_woocommerce_product_card_back_color', function( value ) {
		value.bind( function( newval ) {
	...
	wp.customize( 'bellini_woocommerce_product_title_color', function( value ) {
		value.bind( function( newval ) {
	...
	wp.customize( 'bellini_woocommerce_product_button_text_color', function( value ) {
		value.bind( function( newval ) {
	...
	wp.customize( 'bellini_woocommerce_product_button_color', function( value ) {
		value.bind( function( newval ) {
...
--------------------------------------------------------------*/
	...
	wp.customize( 'bellini_header_title_capitalization', function( value ) {
		value.bind( function( newval ) {
	...
	wp.customize( 'bellini_widget_title_alignment', function( value ) {
		value.bind( function( newval ) {
...
--------------------------------------------------------------*/
    ...
    //Frontpage Slider
    wp.customize( 'bellini_show_frontpage_slider', function( value ) {
    value.bind( function( to ) {
        if ( true === to) {
    ...
    //Feature Blocks
    wp.customize( 'bellini_show_frontpage_feature_block', function( value ) {
    value.bind( function( to ) {
        if ( true === to) {
    ...
    wp.customize( 'bellini_show_frontpage_woo_category', function( value ) {
    value.bind( function( to ) {
        if ( true === to) {
    ...
    wp.customize( 'bellini_show_frontpage_woo_products', function( value ) {
    value.bind( function( to ) {
        if ( true === to) {
    ...
    wp.customize( 'bellini_show_frontpage_woo_products_featured', function( value ) {
    value.bind( function( to ) {
        if ( true === to) {
    ...
    //Frontpage Blogposts
    wp.customize( 'bellini_show_frontpage_blog_posts', function( value ) {
    value.bind( function( to ) {
        if ( true === to) {
            $( '.front-blog' ).show();
          } else {
    ...
    wp.customize( 'bellini_show_frontpage_text_section', function( value ) {
    value.bind( function( to ) {
        if ( true === to) {
    ...
    wp.customize( 'bellini_show_footer_social_menu', function( value ) {
    value.bind( function( to ) {
        if ( true === to) {
...
--------------------------------------------------------------*/
	...
	wp.customize('bellini_static_slider_title', function (value) {
		value.bind( function ( to ) {
	...
	wp.customize('bellini_static_slider_content', function (value) {
		value.bind( function (to) {
	...
	wp.customize('bellini_static_slider_button_text-1', function (value) {
		value.bind( function (to) {
	...
	wp.customize('bellini_static_slider_button_text-2', function (value) {
		value.bind( function (to) {
	...
	wp.customize('bellini_feature_block_title_one', function (value) {
		value.bind( function (to) {
	...
	wp.customize('bellini_feature_block_title_two', function (value) {
		value.bind( function (to) {
	...
	wp.customize('bellini_feature_block_title_three', function (value) {
		value.bind( function (to) {
	...
	wp.customize('bellini_feature_block_content_one', function (value) {
		value.bind( function (to) {
			$('.block-one p').text( to );
		} );
	} );
	...
	wp.customize('bellini_feature_block_content_two', function (value) {
		value.bind( function (to) {
			$('.block-two p').text( to );
		} );
	} );
	...
	wp.customize('bellini_feature_block_content_three', function (value) {
		value.bind( function (to) {
	...
	wp.customize('bellini_woo_category_description', function (value) {
		value.bind( function (to) {
	...
	wp.customize('bellini_woo_product_description', function (value) {
		value.bind( function (to) {
	...
	wp.customize('woo_product_button_text', function (value) {
		value.bind( function (to) {
	...
	wp.customize('woo_featured_product_description', function (value) {
		value.bind( function (to) {
	...
	wp.customize('bellini_home_blogposts_title', function (value) {
		value.bind( function (to) {
	...
	wp.customize('bellini_home_blogposts_description', function (value) {
		value.bind( function (to) {
	...
	wp.customize('bellini_home_blogposts_button_text', function (value) {
		value.bind( function (to) {
	...
	// Text Field Content
	wp.customize('bellini_frontpage_textarea_section_field', function (value) {
		value.bind( function (to) {
	...
	// Text Field Content
	wp.customize('bellini_copyright_text', function (value) {
		value.bind( function (to) {
