...
class Automotive_Centre_About_Widget extends WP_Widget {
	function __construct() {
		parent::__construct(
			'Automotive_Centre_About_Widget',
			__('VW About us', 'automotive-centre'),
			array( 'description' => __( 'Widget for about us section in sidebar', 'automotive-centre' ), ) 
		);
	}
	...
	public function form( $instance ) {
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('author')); ?>"><?php esc_html_e('Author Name:','automotive-centre'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('designation')); ?>"><?php esc_html_e('Designation:','automotive-centre'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('description')); ?>"><?php esc_html_e('Description:','automotive-centre'); ?></label>
    	...
    	<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_text')); ?>"><?php esc_html_e('Button Text:','automotive-centre'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_url')); ?>"><?php esc_html_e('Button Url:','automotive-centre'); ?></label>
...
add_action( 'widgets_init', 'automotive_centre_about_custom_load_widget' );