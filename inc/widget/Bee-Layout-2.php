...
class BeeLayout2 extends WP_Widget {


  // Set up the widget name and description.
  public function __construct() {
    $widget_options = array( 'classname' => 'news', 'description' => 'Custom Bee News Layout 2' );
    parent::__construct( 'bee_layout_2_widget', 'Bee News Layout Two', $widget_options );
  }
  ...
  public function widget( $args, $instance ) {
    ...
    <div class="container">
     <div class="row">
      <div class="col-md-8">
        <?php beenews_layout_3(array('cat_id' => $cat_id ));  ?>
      </div>
      <div class="col-md-4">
        <?php beenews_layout_5(array('cat_id' => $cat_id_1 ));  ?>
      </div>
