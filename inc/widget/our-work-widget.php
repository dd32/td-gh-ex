<?php
if (!class_exists('Better_Health_Our_Work_Widget'))
{
    class Better_Health_Our_Work_Widget extends WP_Widget
    {
        ...
        private function defaults()
        {
            ...
            $defaults = array(
                'title' => esc_html__('Treatment Gallery', 'better-health'),
        ...
        {
            parent::__construct(
                    'better-health-our-work-widget',
                    esc_html__('Better Health Treatment Gallery Widget', 'better-health'),
                    array('description' => esc_html__('Better Health Treatment Gallery Section', 'better-health'))
               );
        }
...
add_action('widgets_init', 'better_health_our_work_widget');
function better_health_our_work_widget()
{
    register_widget('Better_Health_Our_Work_Widget');
