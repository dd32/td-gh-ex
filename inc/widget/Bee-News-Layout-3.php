...
class Bee_News_Layout3 extends WP_Widget {


  // Set up the widget name and description.
  public function __construct() {
    $widget_options = array( 'classname' => 'news', 'description' => 'Custom Bee News Layout 3' );
    parent::__construct( 'bee_news_layout_3_widget', 'Bee News Layout Three', $widget_options );
  }
...
function bee_news_layout_3_register__widget() { 
  register_widget( 'Bee_News_Layout3' );
}
