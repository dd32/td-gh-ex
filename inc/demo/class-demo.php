...
if ( ! class_exists( 'Best_Charity_Demo' ) ) {
	 ...
	 * @since 1.0.0
	 */
	class Best_Charity_Demo {

		/**
		 * Singleton instance of Best_Charity_Demo.
		 *
		 * @var Best_Charity_Demo $instance Best_Charity_Demo instance.
		 */
		...
		/**
		 * Main Best_Charity_Demo instance.
		 *
		 * @since 1.0.0
		 *
		...
		public static function init( $config ) {
			if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Best_Charity_Demo ) ) {
				self::$instance = new Best_Charity_Demo();
