...
if ( ! class_exists( 'beshop_About' ) ) {
	...
	class beshop_About {
		 ...
		 *
		 * @var beshop_About $instance The  TI_About_Page instance.
		 */
		...
		public static function init( $config ) {
			if ( ! isset( self::$instance ) && ! ( self::$instance instanceof beshop_About ) ) {
				self::$instance = new beshop_About;
		...
		public function ti_about_page_render() {
			...
			if ( ! empty( $welcome_title ) || ! empty( $welcome_content ) || ! empty( $this->tabs ) ) {
				...
				echo '<div class="wrap about-wrap beshop-about-wrap">';
				...
				echo '<a href="'.esc_url('https://wpthemespace.com/product/beshop/').'" target="_blank" class="wp-badge epsilon-welcome-logo"></a>';
    ...
    return add_query_arg(
		...
		public function getting_started() {
			...
			?>
			<div class="feature-section beshop-section beshop-section-getting-started three-col">
				<?php foreach ( $content as $item ) : ?>
					<?php $this->render_grid_item( $item ); ?>
				<?php endforeach; ?>
			</div><!-- .feature-section .beshop-section -->
			<?php
		}
		...
		public function support() {
			...
			?>
			<div class="feature-section beshop-section beshop-section-support three-col">
        ...
        'activating_string'        => __( 'Activating', 'beshop' )
        )
    );
