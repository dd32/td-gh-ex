<?php
	...
	if($advance_it_company_theme_color_first != false){
		$custom_css .='.page-box-single h3, #sidebar ul li a:hover,#sidebar ul li:active, #sidebar ul li:focus, h3.widget-title a, .nav-links a, p.logged-in-as a{';
			$custom_css .='color: '.esc_html($advance_it_company_theme_color_first).'!important;';
		$custom_css .='}';
	}
	if($advance_it_company_theme_color_first != false){
		$custom_css .='.serach_inner form.search-form, #footer input[type="search"], .woocommerce #respond input#submit:hover, .woocommerce a.button:hover, .woocommerce button.button:hover, .woocommerce input.button:hover,.woocommerce #respond input#submit.alt:hover, .woocommerce a.button.alt:hover, .woocommerce button.button.alt:hover, .woocommerce input.button.alt:hover, .woocommerce .quantity .qty, .pagination a:hover, .pagination .current{';
	...
	if($advance_it_company_theme_color_second != false){
		$custom_css .='#work_cat h3, #header .nav ul li a:hover,#header .nav ul li.current-menu-item a{';
			$custom_css .='color: '.esc_html($advance_it_company_theme_color_second).';';
		$custom_css .='}';
	}
	if($advance_it_company_theme_color_second != false){
		$custom_css .='{';
			$custom_css .='border-bottom-color: '.esc_html($advance_it_company_theme_color_second).';';
		$custom_css .='}';
	}
	if($advance_it_company_theme_color_second != false){
		$custom_css .='{';
			$custom_css .='border-top-color: '.esc_html($advance_it_company_theme_color_second).';';
		$custom_css .='}';
	}
	if($advance_it_company_theme_color_second != false){
		$custom_css .='{';
			$custom_css .='border-color: '.esc_html($advance_it_company_theme_color_second).';';
		$custom_css .='}';
	}
	if($advance_it_company_theme_color_second != false){
		$custom_css .='{';
