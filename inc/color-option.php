<?php
	...
	if($advance_fitness_gym_theme_color != false){
		$custom_css .='a.button, .account a i, .categry-title, .product-category::-webkit-scrollbar-thumb:hover, #fitness-togym .wlcm-hr, .second-border a:hover, span.meta-nav, #footer input[type="submit"], .copyright, #footer .tagcloud a:hover, .woocommerce span.onsale, .woocommerce #respond input#submit, .woocommerce a.button, .woocommerce button.button, .woocommerce input.button,.woocommerce #respond input#submit.alt, .woocommerce a.button.alt, .woocommerce button.button.alt, .woocommerce input.button.alt, #sidebar h3, #sidebar input[type="submit"], #sidebar .tagcloud a:hover, .pagination a:hover, .pagination .current, #footer input[type="submit"], .primary-navigation ul ul, .primary-navigation ul ul a:hover, .primary-navigation ul ul a:hover{';
			$custom_css .='background-color: '.esc_html($advance_fitness_gym_theme_color).';';
		$custom_css .='}';
	}
	if($advance_fitness_gym_theme_color != false){
		$custom_css .='input[type="submit"], #slider .inner_carousel h2, #footer h3, .woocommerce-message::before, h1.entry-title,h1.page-title, #slider .inner_carousel h2, input[type="submit"],#header .top-contact i, h3.widget-title a, #footer li a:hover, .primary-navigation a:hover, .primary-navigation ul ul a, h2.entry-title, h2.page-title{';
