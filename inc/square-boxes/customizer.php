...
$semperfi_square_boxes_customizer_options_array = array(
    ...
    'square_boxes_img' => array(
        'default_options'  => array(
            1                   => get_template_directory_uri() . '/inc/square-boxes/images/Chris-Tandem-Skydive-850x478.jpg',
            2                   => get_template_directory_uri() . '/inc/square-boxes/images/Kara_Skydiving_Sitfly-850x478.jpg',
            3                   => get_template_directory_uri() . '/inc/square-boxes/images/HALO-Skydives-850x478.jpg',
            4                   => get_template_directory_uri() . '/inc/square-boxes/images/Head-Down-Freeflying-Casey-Heather-Paul-850x478.jpg',
            5                   => get_template_directory_uri() . '/inc/square-boxes/images/Chris-Tandem-Skydive-850x478.jpg',
            6                   => get_template_directory_uri() . '/inc/square-boxes/images/Kara_Skydiving_Sitfly-850x478.jpg',
            7                   => get_template_directory_uri() . '/inc/square-boxes/images/HALO-Skydives-850x478.jpg',
            8                   => get_template_directory_uri() . '/inc/square-boxes/images/Head-Down-Freeflying-Casey-Heather-Paul-850x478.jpg', ),
        'description'       => array(
            1                   => '',
            2                   => '',
            3                   => '',
