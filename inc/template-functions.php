	...
	function attesa_register_all_social_network() {
		...
		$social = array(
			...
			'spotify' => array (
				'slug' => '_tiktokurl',
				'default' => '',
				'label' => __('TikTok URL', 'attesa'),
				'name' => __('TikTok', 'attesa'),
				'icon' => $iconPrefix .' fa-tiktok',
			),
		);
