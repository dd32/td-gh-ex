...
data.choices.labels = _.defaults( data.choices.labels, {
	select: '<?php esc_html_e( 'Select image', 'i-transform' ); ?>',
	change: '<?php esc_html_e( 'Change image', 'i-transform' ); ?>',
	'default': '<?php esc_html_e( 'Default', 'i-transform' ); ?>',
	remove: '<?php esc_html_e( 'Remove', 'i-transform' ); ?>',
	placeholder: '<?php esc_html_e( 'No image selected', 'i-transform' ); ?>',
	frame_title: '<?php esc_html_e( 'Select image', 'i-transform' ); ?>',
	frame_button: '<?php esc_html_e( 'Choose image', 'i-transform' ); ?>',
} );
#>
