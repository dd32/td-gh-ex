...
class Kirki_Control_Base extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_localize_script(
			...
			'kirkiL10n',
			array(
				'noFileSelected'   => esc_attr__( 'No File Selected', 'i-transform' ),
				'remove'           => esc_attr__( 'Remove', 'i-transform' ),
				'default'          => esc_attr__( 'Default', 'i-transform' ),
				'selectFile'       => esc_attr__( 'Select File', 'i-transform' ),
				'standardFonts'    => esc_attr__( 'Standard Fonts', 'i-transform' ),
				'googleFonts'      => esc_attr__( 'Google Fonts', 'i-transform' ),
				'defaultCSSValues' => esc_attr__( 'Default CSS Values', 'i-transform' ),
			)
		);
