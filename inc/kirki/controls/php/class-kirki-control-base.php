	...
	public function enqueue() {
		...
		wp_localize_script(
			...
			array(
				...
				'noFileSelected'       => esc_html__( 'No File Selected', 'i-transform' ),
				'remove'               => esc_html__( 'Remove', 'i-transform' ),
				'default'              => esc_html__( 'Default', 'i-transform' ),
				'selectFile'           => esc_html__( 'Select File', 'i-transform' ),
				'standardFonts'        => esc_html__( 'Standard Fonts', 'i-transform' ),
				'googleFonts'          => esc_html__( 'Google Fonts', 'i-transform' ),
				'defaultCSSValues'     => esc_html__( 'CSS Defaults', 'i-transform' ),
				'defaultBrowserFamily' => esc_html__( 'Default Browser Font-Family', 'i-transform' ),
			)
		);
