...
class Kirki_Control_Image extends Kirki_Control_Base {
	...
	protected function content_template() {
		...
		data.choices.labels = _.defaults( data.choices.labels, {
			select: '<?php esc_attr_e( 'Select image', 'i-transform' ); ?>',
			change: '<?php esc_attr_e( 'Change image', 'i-transform' ); ?>',
			'default': '<?php esc_attr_e( 'Default', 'i-transform' ); ?>',
			remove: '<?php esc_attr_e( 'Remove', 'i-transform' ); ?>',
			placeholder: '<?php esc_attr_e( 'No image selected', 'i-transform' ); ?>',
			frame_title: '<?php esc_attr_e( 'Select image', 'i-transform' ); ?>',
			frame_button: '<?php esc_attr_e( 'Choose image', 'i-transform' ); ?>',
		} );
		#>
		<label>
