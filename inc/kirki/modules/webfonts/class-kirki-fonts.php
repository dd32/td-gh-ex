...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_html__( 'Ultra-Light 100', 'i-transform' ),
			'100light'  => esc_html__( 'Ultra-Light 100', 'i-transform' ),
			'100italic' => esc_html__( 'Ultra-Light 100 Italic', 'i-transform' ),
			'200'       => esc_html__( 'Light 200', 'i-transform' ),
			'200italic' => esc_html__( 'Light 200 Italic', 'i-transform' ),
			'300'       => esc_html__( 'Book 300', 'i-transform' ),
			'300italic' => esc_html__( 'Book 300 Italic', 'i-transform' ),
			'400'       => esc_html__( 'Normal 400', 'i-transform' ),
			'regular'   => esc_html__( 'Normal 400', 'i-transform' ),
			'italic'    => esc_html__( 'Normal 400 Italic', 'i-transform' ),
			'500'       => esc_html__( 'Medium 500', 'i-transform' ),
			'500italic' => esc_html__( 'Medium 500 Italic', 'i-transform' ),
			'600'       => esc_html__( 'Semi-Bold 600', 'i-transform' ),
			'600bold'   => esc_html__( 'Semi-Bold 600', 'i-transform' ),
			'600italic' => esc_html__( 'Semi-Bold 600 Italic', 'i-transform' ),
			'700'       => esc_html__( 'Bold 700', 'i-transform' ),
			'700italic' => esc_html__( 'Bold 700 Italic', 'i-transform' ),
			'800'       => esc_html__( 'Extra-Bold 800', 'i-transform' ),
			'800bold'   => esc_html__( 'Extra-Bold 800', 'i-transform' ),
			'800italic' => esc_html__( 'Extra-Bold 800 Italic', 'i-transform' ),
			'900'       => esc_html__( 'Ultra-Bold 900', 'i-transform' ),
			'900bold'   => esc_html__( 'Ultra-Bold 900', 'i-transform' ),
			'900italic' => esc_html__( 'Ultra-Bold 900 Italic', 'i-transform' ),
		);
	}
