 ...
 * @access public
 */
final class AeonAccess_Customize {
	...
	public function sections( $manager ) {
		...
		// Register sections.
		$manager->add_section(
			new AeonAccess_Customize_Section_Pro(
				$manager,
				'aeonaccess_plus',
				array(
	...
	public function enqueue_control_scripts() {
		wp_enqueue_script( 'aeonaccess-customize-controls', trailingslashit( get_template_directory_uri() ) . '/js/customize-controls.js', array( 'customize-controls' ) );
	}
}

// Doing this customizer thang!
AeonAccess_Customize::get_instance();
