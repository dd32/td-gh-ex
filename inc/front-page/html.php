...
<?php if ( has_post_thumbnail() ) : ?>
        ...
        <?php if ( is_customize_preview() && absint ( get_theme_mod( 'square_boxes_enable_1' , false ) ) ) { echo '<div class="customizer-title-image-3">'; esc_html_e( "The featured image of the selected static page will display here. If a featured image is not selected, the default background set in customizer will display. The page's featured image cannot be changed in customizer. Instead navigate to the edditor for the page and select the featured image.", 'semper-fi-lite' ); echo '</div>'; } ?>
...
<?php endif; ?>
        ...
        <main id="the-article" itemprop="articleBody" style="background-image:url(<?php semper_fi_lite_image( 'main_background_img_1' , '/inc/single/images/eeeeee-mouse-chocolate-lab-tennis-ball-300x300.jpg' , 300 , 300 ); ?>);" >
            ...
            <?php edit_post_link( esc_html__( 'Edit this Post' , 'semper-fi-lite' ) ); ?>
