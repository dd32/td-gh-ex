...
if ( ! function_exists( 'best_classifieds_get_font_choices' ) ) :
/**
 ...
 */
function best_classifieds_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'best-classifieds' ) ) ) );
	$standard_fonts = best_classifieds_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'best-classifieds' ) ) ) );
	$google_fonts   = best_classifieds_get_google_fonts();
	 ...
	 */
	return apply_filters( 'best_classifieds_all_fonts', array_merge( $heading1, $standard_fonts, $heading2, $google_fonts ) );
}
endif;
 ...
 * @return array    The fonts in value/label pairs.
 */
function best_classifieds_get_font_choices() {
	$fonts   = best_classifieds_get_all_fonts();
	$choices = array();
...
if ( ! function_exists( 'best_classifieds_get_google_font_uri' ) ) :
/**
 ...
 */
function best_classifieds_get_google_font_uri( $fonts ) {

	// De-dupe the fonts
	$fonts         = array_unique( $fonts );
	$allowed_fonts = best_classifieds_get_google_fonts();
	$family        = array();
	...
	foreach ( $fonts as $font ) {
		...
		if ( array_key_exists( $font, $allowed_fonts ) ) {
			...
			$family[] = urlencode( $font . ':' . join( ',', best_classifieds_choose_google_font_variants( $font, $allowed_fonts[ $font ]['variants'] ) ) );
		}
	}
	...
	$subset = get_theme_mod( 'font-subset', best_classifieds_get_default( 'font-subset' ) );

	if ( 'all' === $subset ) {
		$subsets_available = best_classifieds_get_google_font_subsets();
...
if ( ! function_exists( 'best_classifieds_get_google_font_subsets' ) ) :
/**
 ...
 */
function best_classifieds_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'best-classifieds' ),
		'cyrillic'     => __( 'Cyrillic', 'best-classifieds' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'best-classifieds' ),
		'devanagari'   => __( 'Devanagari', 'best-classifieds' ),
		'greek'        => __( 'Greek', 'best-classifieds' ),
		'greek-ext'    => __( 'Greek Extended', 'best-classifieds' ),
		'khmer'        => __( 'Khmer', 'best-classifieds' ),
		'latin'        => __( 'Latin', 'best-classifieds' ),
		'latin-ext'    => __( 'Latin Extended', 'best-classifieds' ),
		'vietnamese'   => __( 'Vietnamese', 'best-classifieds' ),
	);
}
endif;

if ( ! function_exists( 'best_classifieds_choose_google_font_variants' ) ) :
/**
 ...
 */
function best_classifieds_choose_google_font_variants( $font, $variants = array() ) {
	$chosen_variants = array();
	if ( empty( $variants ) ) {
		$fonts = best_classifieds_get_google_fonts();
	...
	return apply_filters( 'best_classifieds_font_variants', array_unique( $chosen_variants ), $font, $variants );
}
endif;

if ( ! function_exists( 'best_classifieds_get_standard_fonts' ) ) :
/**
 ...
 */
function best_classifieds_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'best-classifieds' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'best-classifieds' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'best-classifieds' ),
...
if ( ! function_exists( 'best_classifieds_get_font_stack' ) ) :
/**
 ...
 */
function best_classifieds_get_font_stack( $font ) {

	$all_fonts = best_classifieds_get_all_fonts();

	// Sanitize font choice
	$font = best_classifieds_sanitize_font_choice( $font );
...
if ( ! function_exists( 'best_classifieds_sanitize_font_choice' ) ) :
/**
 ...
 */
function best_classifieds_sanitize_font_choice( $value ) {
	if ( is_int( $value ) ) {
		// The array key is an integer, so the chosen option is a heading, not a real choice
		return '';
	} else if ( array_key_exists( $value, best_classifieds_get_font_choices() ) ) {
		return $value;
	} else {
		return '';
	}
...
if ( ! function_exists( 'best_classifieds_get_google_fonts' ) ) :
/**
 ...
 */
function best_classifieds_get_google_fonts() {
	return apply_filters( 'best_classifieds_get_google_fonts', array(
		'ABeeZee' => array(
			'label'    => 'ABeeZee',
			'variants' => array(
				'regular',
