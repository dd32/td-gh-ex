 ...
 *
 * Catchbase Default Theme/Customizer  Options
 *
 * @package Catchbase
 * @since Catchbase 1.0
 */
...
function catchbase_get_content() {
	...
	$catchbase_content['left'] 	= sprintf( __( 'Copyright &copy; %s %s . All Rights Reserved.', 'catchbase' ), date( 'Y' ), '<a title="'. $theme_data->get( 'Name') . '" href="'. esc_url( home_url( '/' ) ) .'">'. $theme_data->get( 'Name') . '</a>' );

	$catchbase_content['right']	= $theme_data->get( 'Name') . '&nbsp;' . __( 'by', 'catchbase' ). '&nbsp;<a target="_blank" href="'. $theme_data->get( 'AuthorURI' ) .'">'. $theme_data->get( 'Author' ) .'</a>';
