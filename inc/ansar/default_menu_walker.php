<?php 
function agencyup_page_menu_args( $args ) {
	if ( ! isset( $args['show_home'] ) )
		$args['show_home'] = true;
	return $args;
}
add_filter( 'wp_page_menu_args', 'agencyup_page_menu_args' );

 
function agencyup_fallback_page_menu( $args = array() ) {
	...
	$list_args['title_li'] = '';
	$list_args['walker'] = new agencyup_walker_page_menu;
...
class agencyup_walker_page_menu extends Walker_Page{
