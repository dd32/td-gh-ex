...
function bard_preview_right_sidebar() {
	the_widget('WP_Widget_Search', 'title=' . esc_html__('Search', 'bard'), 'before_title=<div class="widget-title"><h2>&after_title=</h2></div>&before_widget=<div class="bard-widget widget_search">&after_widget=</div>');
	the_widget('WP_Widget_Recent_Posts', 'title=' . esc_html__('Recent Posts', 'bard'), 'before_title=<div class="widget-title"><h2>&after_title=</h2></div>&before_widget=<div class="bard-widget widget_recent_entries">&after_widget=</div>');
	the_widget('WP_Widget_Archives', 'title=' . esc_html__('Archives', 'bard'), 'before_title=<div class="widget-title"><h2>&after_title=</h2></div>&before_widget=<div class="bard-widget widget_archive">&after_widget=</div>');
	the_widget('WP_Widget_Categories', 'title=' . esc_html__('Categories', 'bard'), 'before_title=<div class="widget-title"><h2>&after_title=</h2></div>&before_widget=<div class="bard-widget widget_categories">&after_widget=</div>');
}

function bard_preview_footer_sidebar() {
	the_widget('WP_Widget_Pages', 'title=' . esc_html__('Pages', 'bard'), 'before_title=<div class="widget-title"><h2>&after_title=</h2></div>&before_widget=<div class="bard-widget widget_pages">&after_widget=</div>');
	the_widget('WP_Widget_Archives', 'title=' . esc_html__('Archives', 'bard'), 'before_title=<div class="widget-title"><h2>&after_title=</h2></div>&before_widget=<div class="bard-widget widget_archive">&after_widget=</div>');
	the_widget('WP_Widget_Recent_Comments', 'title=' . esc_html__('Recent Comments', 'bard'), 'before_title=<div class="widget-title"><h2>&after_title=</h2></div>&before_widget=<div class="bard-widget widget_recent_comments">&after_widget=</div>');
}
