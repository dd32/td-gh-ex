...
function accesspresslite_theme_options_page() {
	...
	<div class="accesspresslite-header">
		...
		<div class="accesspresslite_title"><?php echo wp_get_theme();  _e( ' Theme Options', 'accesspress-lite' )?></div>
	</div>

	<div class="clear"></div>

	<?php 	if ( false !== $_REQUEST['settings-updated'] ) : ?>
	<div class="updated fade"><p><strong><?php _e( 'Options saved' , 'accesspress-lite' ); ?></strong></p></div>
	<?php endif; // If the form has just been submitted, this shows the notification ?>

	<?php // Shows all the tabs of the theme options ?>
	<div class="nav-tab-wrapper">
	<a id="options-group-1-tab" class="nav-tab nav-tab-active" href="#options-group-1"><?php _e('Basic Settings','accesspress-lite'); ?></a>
    <a id="options-group-2-tab" class="nav-tab" href="#options-group-2"><?php _e('Home Page','accesspress-lite'); ?></a>
	<a id="options-group-3-tab" class="nav-tab" href="#options-group-3"><?php _e('Slider Settings','accesspress-lite'); ?></a>
	<a id="options-group-4-tab" class="nav-tab" href="#options-group-4"><?php _e('Sidebar','accesspress-lite'); ?></a>
	<a id="options-group-5-tab" class="nav-tab" href="#options-group-5"><?php _e('Social Links','accesspress-lite'); ?></a>
	<a id="options-group-6-tab" class="nav-tab" href="#options-group-6"><?php _e('Tools','accesspress-lite'); ?></a>
	<a id="options-group-7-tab" class="nav-tab" href="#options-group-7"><?php _e('About AccessPress Lite','accesspress-lite'); ?></a>
	</div>
	...
	<div id="optionsframework-metabox" class="metabox-holder clearfix">
		<div id="optionsframework" class="postbox">
			...
			<h3><?php _e('Basic Settings','accesspress-lite'); ?></h3>
				<table class="form-table">
                    <tr><th scope="row"><label for="home_template"><?php _e('Home Page Template','accesspress-lite'); ?></label></th>
    					<td>
					...
					<tr>
						<th><label for="footer_copyright"><?php _e('Disable Responsive Design?','accesspress-lite'); ?></label></th>
						<td>
							...
							<label for="responsive_design"><?php _e('Check to disable','accesspress-lite'); ?></label>
						</td>
					</tr>

					<tr><th scope="row"><label for="webpage_layouts"><?php _e('Web Page Layout','accesspress-lite'); ?></label></th>
					<td>
                    ...
                    <tr>
						<th><label for="show_search"><?php _e('Show Search in Header?','accesspress-lite') ?></label></th>
						<td>
							...
							<label for="show_search"><?php _e('Check to enable','accesspress-lite'); ?></label>
						</td>
					</tr>

					<tr>
						<th><label for="accesspresslite_favicon"><?php _e('Upload Favicon','accesspress-lite'); ?></label></th>
						<td>
							<div class="accesspresslite_fav_icon">
							  ...
							  <input class="button" name="media_upload_button" id="accesspresslite_media_upload_button" value="<?php _e('Upload','accesspress-lite'); ?>" type="button" /><br />
							  <em class="f13"><?php _e('Upload favicon(.png) with size of 16px X 16px', 'accesspress-lite'); ?></em>
							  ...
							  <div id="accesspresslite_fav_icon_remove"><?php _e('Remove','accesspress-lite'); ?></div>
							  </div>
							  <?php }else{ ?>
							  ...
							  <a href="javascript:void(0)" id="accesspresslite_fav_icon_remove" title="remove"><?php _e('Remove','accesspress-lite'); ?></a>
							  </div>
							  <?php	} ?>
							</div>
						</td>
					...
					<tr>
						<th><label for="upload_log"><?php _e('Upload Logo','accesspress-lite'); ?></label></th>
						<td>
							<a class="button" target="_blank" href="<?php echo admin_url('/themes.php?page=custom-header'); ?>"><?php _e('Upload','accesspress-lite'); ?></a>
						</td>
					</tr>

					<tr>
					<th scope="row"><label for="header_text"><?php _e('Header Text','accesspress-lite'); ?></label></th>
					<td>
					<textarea id="header_text" name="accesspresslite_options[header_text]" rows="5" cols="30" placeholder="<?php _e('Example.. Call Us : 985XXX9856XX','accesspress-lite')?>"><?php echo wp_kses_post($settings['header_text']); ?></textarea><br />
                    <em class="f13"><?php _e('Html content allowed','accesspress-lite'); ?></em> </td>
                    </tr>

					<tr><th scope="row"><label for="menu_alignment"><?php _e('Menu Alignment','accesspress-lite'); ?></label></th>
					<td>
					...
					<tr><th scope="row"><label for="event_cat"><?php _e('Select the category to display as Events','accesspress-lite'); ?></label></th>
					<td>
					...
					<tr><th scope="row"><label for="testimonial_cat"><?php _e('Select the category to display as Testimonials','accesspress-lite'); ?></label></th>
					<td>
					...
					<tr><th scope="row"><label for="portfolio_cat"><?php _e('Select the category to display as Portfolio/Products','accesspress-lite'); ?></label></th>
					<td>
					...
					<tr>
						<td colspan="2">
							<em><?php _e('You can show these categories in the menu by configuring','accesspress-lite'); ?> <a target="_blank" href="<?php echo admin_url('nav-menus.php'); ?>">Menus</a> <?php _e('Page.','accesspress-lite'); ?></em>
						</td>
					</tr>
			...
			<h3><?php _e('Home Page Settings','accesspress-lite'); ?></h3> 
				<table class="form-table">
                    <tr><th scope="row"><label for="home_page_layout"><?php _e('Home Page Layout','accesspress-lite'); ?></label></th>
					<td>
					...
					<tr><th scope="row"><label for="welcome_post"><?php _e('Welcome Post','accesspress-lite'); ?></label></th>
					<td>
					...
					<tr>
						<th><label for="full_content"><?php _e('Show Full Content?','accesspress-lite'); ?></label></th>
						<td>
							...
							<label for="full_content"><?php _e('Check to enable','accesspress-lite'); ?></label><br />
						</td>
					</tr>

					<tr>
						<th><label for="welcome_post_char"><?php _e('Welcome Post Excerpt Character','accesspress-lite'); ?></label></th>
						<td><input id="welcome_post_char" type="text" name="accesspresslite_options[welcome_post_char]" value="<?php if (isset($settings['welcome_post_char'])){ echo esc_attr($settings['welcome_post_char']); } ?>"> <?php _e('Characters','accesspress-lite'); ?></td>
					</tr>

					<tr>
						<th><label for="welcome_post_readmore"><?php _e('Read More Text','accesspress-lite'); ?></label></th>
						<td><input id="welcome_post_readmore" type="text" name="accesspresslite_options[welcome_post_readmore]" value="<?php if (isset($settings['welcome_post_readmore'])){ echo esc_attr($settings['welcome_post_readmore']); } ?>"><br /><em class="f13"><?php _e('Leave blank if you don\'t want to show read more','accesspress-lite'); ?></em></td>
					</tr>

					<tr><td colspan="2" class="seperator">&nbsp;</td></tr>

					<tr>
						<th><label for="show_eventdate"><?php _e('Disable Event Section?','accesspress-lite'); ?></label></th>
						<td>
							...
							<label for="disable_event"><?php _e('Check to Disable','accesspress-lite'); ?></label><br />
							<em class="f13"><?php _e('The welcome post will cover the full width if disabled.','accesspress-lite'); ?></em>
						</td>
					</tr>
					...
					<tr>
						<th><label for="show_eventdate"><?php _e('Show Event Date?','accesspress-lite'); ?></label></th>
						<td>
							...
							<label for="show_eventdate"><?php _e('Check to enable','accesspress-lite'); ?></label>
						</td>
					</tr>

					<tr>
						<td colspan="2"><em><?php _e('To replace the Event section in homepage, Go to', 'accesspress-lite'); ?> <a href="<?php echo admin_url('widgets.php'); ?>" target="blank"><?php _e('widget','accesspress-lite'); ?></a> <?php _e('and drag widget item into the Event Sidebar Widget area.', 'accesspress-lite' ); ?></em></td>
					</tr>

					<tr><td colspan="2" class="seperator">&nbsp;</td></tr>

					<tr>
						<th><label for="show_fontawesome"><?php _e('Show Font Awesome icon for Featured Post?','accesspress-lite'); ?></label></th>
						<td>
							...
							<label for="show_fontawesome"><?php _e('Check to enable','accesspress-lite'); ?></label><br />
                            <em class="f13"><?php _e('(If enabled the featured image will be replaced by Font Awesome Icon. For lists of icons click','accesspress-lite'); ?> <a href="<?php echo esc_url('http://fontawesome.io/icons/'); ?>" target="_blank"><?php _e('here','accesspress-lite'); ?></a>)</em>
						</td>
					</tr>
                    
                    <tr>
						<th><label for="big_icons"><?php _e('Show Big Font Awesome icon with center aligned','accesspress-lite'); ?></label></th>
						<td>
					...
					<input id="featured_post1_icon" name="accesspresslite_options[featured_post1_icon]" type="text" value="<?php echo esc_attr($settings['featured_post1_icon']); ?>" placeholder="<?php _e('Font Awesome icon name','accesspress-lite'); ?>" /><em class="f13">&nbsp;&nbsp;<?php _e('Example:','accesspress-lite'); ?> fa-bell</em>
					</td>
					</tr>

					<tr><th scope="row"><label for="featured_post2"><?php _e('Featured Post 2','accesspress-lite'); ?></label></th>
					<td>
					...
					<input id="featured_post2_icon" name="accesspresslite_options[featured_post2_icon]" type="text" value="<?php echo esc_attr($settings['featured_post2_icon']); ?>" placeholder="<?php _e('Font Awesome icon name','accesspress-lite'); ?>" /><em class="f13">&nbsp;&nbsp;<?php _e('Example:','accesspress-lite'); ?> fa-bell</em>
					</td>
					</tr>

					<tr><th scope="row"><label for="featured_post3"><?php _e('Featured Post 3','accesspress-lite'); ?></label></th>
					<td>
					...
					<input id="featured_post3_icon" name="accesspresslite_options[featured_post3_icon]" type="text" value="<?php echo esc_attr($settings['featured_post3_icon']); ?>" placeholder="<?php _e('Font Awesome icon name','accesspress-lite'); ?>" /><em class="f13">&nbsp;&nbsp;<?php _e('Example:','accesspress-lite'); ?> fa-bell</em>
					</td>
					</tr>

					<tr>
						<th><label for="featured_post_readmore"><?php _e('Read More Text','accesspress-lite'); ?></label></th>
						<td><input id="featured_post_readmore" type="text" name="accesspresslite_options[featured_post_readmore]" value="<?php if ( isset($settings['featured_post_readmore'])){echo esc_attr($settings['featured_post_readmore']); } ?>"><br /><em class="f13"><?php _e('Leave blank if you don\'t want to show read more','accesspress-lite'); ?></em></td>
					</tr>
                    
                    <tr><td colspan="2" class="seperator">&nbsp;</td></tr>
                    
                    <tr>
					<th scope="row"><label for="gallery_code"><?php _e('Gallery Short Code','accesspress-lite'); ?></label></th>
					<td>
                    ...
                    <tr>
                        <td colspan="2">
                        <em><?php _e('You can replace the gallery and testimonial section of the home page with custom widget','accesspress-lite'); ?> <a href="<?php echo admin_url('/widgets.php') ?>" target="_blank"><?php _e('here','accesspress-lite'); ?></a></em>
                        </td>
                    </tr>
                    ...
                    <tr>
						<th><label for="featured_bar"><?php _e('Disable Featured Bar (above footer)','accesspress-lite'); ?></label></th>
						<td>
			...
			<h3><?php _e('Home Page Slider Settings','accesspress-lite'); ?></h3>
				<table class="form-table">
				<tbody>
					<tr class="slider-options">
						<th>
							<?php _e('Show','accesspress-lite'); ?>
						</th>
						<td>
						<?php 
						...
						<label class="checkbox" id="single_post_slider">
							<input value="single_post_slider" type="radio" name="accesspresslite_options[slider_options]" <?php checked($settings['slider_options'],'single_post_slider'); ?> ><?php _e('Single Posts as a Slider','accesspress-lite'); ?>
						</label>
						&nbsp;&nbsp;&nbsp;&nbsp;
						<label class="checkbox" id="cat_post_slider">
							<input value="cat_post_slider" name="accesspresslite_options[slider_options]" type="radio" <?php checked($settings['slider_options'],'cat_post_slider'); ?> ><?php _e('Category Posts as a Slider','accesspress-lite'); ?>
						</label>
						</td>
					</tr>
					...
					<tr>
						<td colspan="2"><em class="f13"><?php _e('Select the post that you want to display as a Slider','accesspress-lite'); ?></em></td>
					</tr>

					<tr>
					
					<th scope="row"><label for="slider1"><?php _e('Silder 1','accesspress-lite'); ?></label></th>
					<td>
					...
					<tr><th scope="row"><label for="slider2"><?php _e('Silder 2','accesspress-lite'); ?></label></th>
					<td>
					...
					<tr><th scope="row"><label for="slider3"><?php _e('Silder 3','accesspress-lite'); ?></label></th>
					<td>
					...
					<tr>
					<th scope="row"><label for="slider4"><?php _e('Silder 4','accesspress-lite'); ?></label></th>
					<td>
					...
					<tr>
					<th><?php _e('Select the Category','accesspress-lite'); ?></th>
					<td>
					<?php 
					...
					<tr>
						<td colspan="2"><em class="f13"><?php _e('Adjust the slider as per your need.','accesspress-lite'); ?></em></td>
					</tr>

					<tr><th scope="row"><?php _e('Show Slider','accesspress-lite'); ?></th>
					<td>
					...
					<tr><th scope="row"><?php _e('Show Slider Pager (Navigation dots)','accesspress-lite'); ?></th>
					<td>
					...
					<tr><th scope="row"><?php _e('Show Slider Controls (Arrows)','accesspress-lite'); ?></th>
					<td>
					...
					<tr><th scope="row"><?php _e('Slider Transition - fade/slide','accesspress-lite'); ?></th>
					<td>
					...
					<tr><th scope="row"><?php _e('Slider auto Transition','accesspress-lite'); ?></th>
					<td>
			...
			<h3><?php _e('Sidebar Settings','accesspress-lite'); ?></h3>
				<table class="form-table">
				<tr>
					<td>
						<table>
						<tbody>
						<tr><th colspan="2" class="line"><?php _e('Left Sidebar Options','accesspress-lite'); ?></th></tr>
						<tr>
							<th><label for="leftsidebar_show_latest_events"><?php _e('Show Latest Events?','accesspress-lite'); ?></label></th>
							<td>
							...
							<label for="leftsidebar_show_latest_events"><?php _e('Check to enable','accesspress-lite'); ?></label>
							</td>
						</tr>

						<tr>
							<th><label for="leftsidebar_show_testimonials"><?php _e('Show Testimonials?','accesspress-lite'); ?></label></th>
							<td>
							...
							<label for="leftsidebar_show_testimonials"><?php _e('Check to enable','accesspress-lite'); ?></label>
							</td>
						</tr>

						<tr>
							<th colspan="2"><?php _e('To add Custom widget in Left Sidebar, Click','accesspress-lite'); ?> <a href="<?php echo admin_url('/widgets.php')?>" target="_blank"><?php _e('here','accesspress-lite'); ?></a></th>
						</tr>
						</table>
					...
					<td>
						<table>
						<tr><th colspan="2" class="line"><?php _e('Right Sidebar Options','accesspress-lite'); ?></th></tr>
						<tr>
							<th><label for="rightsidebar_show_latest_events"><?php _e('Show Latest Events?','accesspress-lite'); ?></label></th>
							<td>
							...
							<label for="rightsidebar_show_latest_events"><?php _e('Check to enable','accesspress-lite'); ?></label>
							</td>
						</tr>

						<tr>
							<th><label for="rightsidebar_show_testimonials"><?php _e('Show Testimonials?','accesspress-lite'); ?></label></th>
							<td>
							...
							<label for="rightsidebar_show_testimonials"><?php _e('Check to enable','accesspress-lite'); ?></label>
							</td>
						</tr>

						<tr>
							<th colspan="2"><?php _e('To add Custom widget in Right Sidebar, Click','accesspress-lite'); ?> <a href="<?php echo admin_url('/widgets.php')?>" target="_blank"><?php _e('here','accesspress-lite'); ?></a></th>
						</tr>
						</table>
				...
				<tbody>
					<tr>
						<td colspan="2"><?php _e('View All Text','accesspress-lite'); ?>&nbsp;&nbsp;
						<input type="text" name="accesspresslite_options[view_all_text]" value="<?php if (isset($settings['view_all_text'])){ echo esc_attr($settings['view_all_text']); } ?>" />&nbsp;&nbsp;<em class="f13"><?php _e('Leave blank if you don\'t want to show View All Text','accesspress-lite'); ?></em></td>
					</tr>
				</tbody>
				</table>
			</div>
			...
			<h3><?php _e('Social links - Put your social url','accesspress-lite'); ?></h3>
				<table class="form-table social-urls">
					<tr>
						<td colspan="2"><em class="f13"><?php _e('Put your social url below.. Leave blank if you don\'t want to show it.','accesspress-lite'); ?></em></td>
					</tr>

					<tr>
						<th><label for="show_social_header"><?php _e('Disable Social icons in header?','accesspress-lite'); ?></label></th>
						<td>
							...
							<label for="show_social_header"><?php _e('Check to disable','accesspress-lite'); ?></label>
						</td>
					</tr>
			...
			<h3><?php _e('Footer Contact','accesspress-lite'); ?></h3>
				<table class="form-table">
					<tr><th scope="row"><label for="custom_css"><?php _e('Custom CSS','accesspress-lite'); ?></label></th>
						<td>
						...
						<p class="f13"><em><?php _e('Put your custom CSS','accesspress-lite'); ?></em></p>
						</td>
					</tr>
				</table>
			</div>
			...
			<h3><?php _e('Know more about AccessPress Themes','accesspress-lite'); ?></h3>
				<table class="form-table">
					<tr>
					<td colspan="2">
						...
						<h4><?php _e('Our other Products','accesspress-lite'); ?></h4>
						<p><?php _e('Themes - ','accesspress-lite'); ?><a target="_blank" href="<?php echo esc_url('https://accesspressthemes.com/wordpress-themes'); ?>"><?php echo esc_url('https://accesspressthemes.com/wordpress-themes/'); ?></a></p>
						<p><?php _e('Plugins - ','accesspress-lite'); ?><a target="_blank" href="<?php echo esc_url('https://accesspressthemes.com/plugins'); ?>"><?php echo esc_url('https://accesspressthemes.com/plugins'); ?></a></p>
						<hr />
						<h4><?php _e('Get in touch','accesspress-lite'); ?></h4>
						...
						<?php _e('For Queries Regading Pro Themes','accesspress-lite'); ?><br/>
			...
			<input type="submit" class="button-primary" value="<?php esc_attr_e('Save Options','accesspress-lite'); ?>" />
			</div>
		...
		<div class="update-banner">
			...
			<div class="any-question">
				<?php echo sprintf(__('Any question!! Click <a href="%s" target="_blank">here</a> for Live Chat.','accesspress-lite'),esc_url('https://accesspressthemes.com/contact/')); ?>
			</div>
		</div>
