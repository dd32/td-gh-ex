...
<div id="about-page">
	...
	<div class="floatcntr">
		...
		<p class="heading-des" >Ready to take your WordPress site to the next level? Give your CMS a beautiful design to draw in more visitors. Peoples love us because of the green of our Themes. We deliver User Friendly Responsive and Premium WordPress Themes with Unique and Modern Design. You can Trust our Themes</p>
		...
		<a class="specialbutton inblk" target="_blank" href="<?php echo esc_url( 'https://d5creation.com/wp-login.php?action=register' ) ?>">Become a Happy Member</a>
        
        
        <div class="width85 featured-boxs">
			
            <h2 class="spetitle">Some Extended Version Themes</h2>
			<a href="<?php echo esc_url('https://d5creation.com/theme/innovation/' ) ?>" target="_blank">
			...
			<a href="<?php echo esc_url('https://d5creation.com/theme/premium/' ) ?>" target="_blank">
				<div class="view view-sixth" >
			...
			<a href="<?php echo esc_url('https://d5creation.com/theme/newspress/' ) ?>" target="_blank">
				<div class="view view-sixth">
			...
			<a href="<?php echo esc_url('https://d5creation.com/theme/simplify/' ) ?>" target="_blank">
				<div class="view view-sixth">
