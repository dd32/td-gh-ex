            ...
            'sections' => array(
				'pro' => array(
						...
						'fields' => array(
                                ...
                                'type' => 'info',
                                'label' => sprintf( __( 'More options available in Pro version. <a href="%1$s">%2$s</a>.', 'bakery' ), esc_url('http://dinozoom.com/themes/bakery-wordpress-theme-for-bakeries-food-bloggers-coffee-shops-and-cupcakes/bakery-pro/'), __( 'Upgrade Now', 'bakery' ) ),
                                'default' => '#ff8800',
                                'sanitize_callback' => 'sanitize_hex_color',
                           		),
                            ),
