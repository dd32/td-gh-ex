		...
		<?php if ( $active_tab == 'tab_colorschemes' ) : ?>
				...
				<form method="post">
					...
					<div style="background-color:#CCCCCC;padding:10px;">
							...
							<div>
								These options are available in the full version only. <a href="<?php echo $fullThemeUrl; ?>" title="Click Here">Click Here</a> to get the full version of tKidd theme.
							</div>		
							<ul>
								<li>
					...
					<p class="submit">  
						<a href="<?php echo $fullThemeUrl; ?>" title="Get tKidd Theme" class="button-primary">Get tKidd Theme</a>
					</p>
		...
		<?php else : ?>
				...
				<form method="post" enctype="multipart/form-data" action="options.php">
					...
					if ( $active_tab == 'tab_general' ) :
						...
						settings_fields( 'fkidd_tishonator_general_settings' );
						do_settings_sections( 'fkidd_tishonator_general_settings' );
?>
						<div style="background-color:#CCCCCC;padding:10px;">
						...
						<p class="submit">  
							<a href="<?php echo $fullThemeUrl; ?>" title="Get tKidd Theme" class="button-primary">Get tKidd Theme</a>   <input type="submit" class="button-primary" value="<?php _e( 'Save Changes', 'tishonator' ) ?>" />  
						</p>
<?php
					elseif ( $active_tab == 'tab_header' ) :

						settings_fields( 'fkidd_tishonator_header_settings' );
						do_settings_sections( 'fkidd_tishonator_header_settings' );
?>						
						<div style="background-color:#CCCCCC;padding:10px;">
...
<?php						
					elseif ( $active_tab == 'tab_footer' ) :
						...
						settings_fields( 'fkidd_tishonator_footer_settings' );
						do_settings_sections( 'fkidd_tishonator_footer_settings' );
?>						
						<div style="background-color:#CCCCCC;padding:10px;">
							<div>
								These options are available in the full version only. <a href="<?php echo $fullThemeUrl; ?>" title="Click Here">Click Here</a> to get the full version of tKidd theme.
...
<?php
					elseif ($active_tab == 'tab_social' ) :
						...
						settings_fields( 'fkidd_tishonator_social_settings' );
						do_settings_sections( 'fkidd_tishonator_social_settings' );
?>
						<div style="background-color:#CCCCCC;padding:10px;">
...
<?php
					elseif ( $active_tab == 'tab_notfound' ) :
						...
						settings_fields( 'fkidd_tishonator_notfound_settings' );
						do_settings_sections( 'fkidd_tishonator_notfound_settings' );
?>
						<p class="submit">  
							<a href="<?php echo $fullThemeUrl; ?>" title="Get tKidd Theme" class="button-primary">Get tKidd Theme</a>   <input type="submit" class="button-primary" value="<?php _e( 'Save Changes', 'tishonator' ) ?>" />  
						</p>
...
function tishonator_register_general_settings() {
	...
	if ( $options === false ) :
		...
		add_option( 'fkidd_tishonator_general_settings', $options );
	endif;

	register_setting( 'fkidd_tishonator_general_settings', 'fkidd_tishonator_general_settings' );
					 
	add_settings_section( 'tishonator_general_options_section', __( 'General Settings', 'tishonator' ),
						  'tishonator_display_general_settings_section', 'fkidd_tishonator_general_settings' );
	...
	$field_args = array( 'type'        => 'image',
						 ...
						 'option_name' => 'fkidd_tishonator_general_settings',
					   );

	add_settings_field( 'tishonator_general_favicon_image', __( 'Favicon', 'tishonator' ), 'tishonator_display_setting',
				'fkidd_tishonator_general_settings', 'tishonator_general_options_section', $field_args );
}
...
function tishonator_register_header_settings() {
	...
	if ( $options === false ) {
		...
		add_option( 'fkidd_tishonator_header_settings', $options );
	}
	
	register_setting( 'fkidd_tishonator_header_settings', 'fkidd_tishonator_header_settings' );
					 
	add_settings_section( 'tishonator_header_options_section', __( 'Header Settings', 'tishonator' ),
		'tishonator_display_header_settings_section', 'fkidd_tishonator_header_settings');
	...
	$field_args = array( 'type'        => 'image',
						 ...
						 'option_name' => 'fkidd_tishonator_header_settings',
					   );

	add_settings_field( 'tishonator_header_logo_image', __( 'Logo image', 'tishonator' ), 'tishonator_display_setting',
				'fkidd_tishonator_header_settings', 'tishonator_header_options_section', $field_args );
}
...
function tishonator_register_footer_settings() {
	...
	if ( $options === false ) {
		...
		add_option( 'fkidd_tishonator_footer_settings', $options );
	}
	
	register_setting( 'fkidd_tishonator_footer_settings', 'fkidd_tishonator_footer_settings' );
	
	add_settings_section( 'tishonator_footer_options_section', __( 'Footer Settings', 'tishonator' ),
		'tishonator_display_footer_settings_section', 'fkidd_tishonator_footer_settings');
	...
	$field_args = array( 'type'        => 'text',
						 ...
						 'option_name' => 'fkidd_tishonator_footer_settings',
					   );

	add_settings_field( 'tishonator_footer_copyrighttext_text', __( 'Copyright Text', 'tishonator' ), 'tishonator_display_setting',
				'fkidd_tishonator_footer_settings', 'tishonator_footer_options_section', $field_args );
}
...
function tishonator_register_slider_settings() {
	...
	if ( $options === false ) {
		...
		add_option( 'fkidd_tishonator_slider_settings', $options );
	}
	
	register_setting( 'fkidd_tishonator_slider_settings', 'fkidd_tishonator_slider_settings' );
					 
	add_settings_section( 'tishonator_slider_options_section', __( 'Slider Settings', 'tishonator' ),
		'tishonator_display_slider_settings_section', 'fkidd_tishonator_slider_settings');
	...
	$field_args = array( 'type'        => 'textarea',
					 ...
					 'option_name' => 'fkidd_tishonator_slider_settings',
				   );

	add_settings_field( 'tishonator_slider_slide1_content_textarea', 'Slide #1 Content', 'tishonator_display_setting',
			'fkidd_tishonator_slider_settings', 'tishonator_slider_options_section', $field_args );
...
function tishonator_register_social_settings() {
	...
	if ( $options === false ) {
		...
		add_option( 'fkidd_tishonator_social_settings', $options );
	}

    register_setting( 'fkidd_tishonator_social_settings', 'fkidd_tishonator_social_settings' );

	add_settings_section( 'tishonator_social_sites_section', __( 'Social Websites', 'tishonator' ),
		'tishonator_display_social_settings_section', 'fkidd_tishonator_social_settings' );
	...
	$field_args = array( 'type'        => 'text',
					 ...
					 'option_name' => 'fkidd_tishonator_social_settings',
				   );

	add_settings_field( 'tishonator_social_facebook_text', 'Facebook', 'tishonator_display_setting',
			'fkidd_tishonator_social_settings', 'tishonator_social_sites_section', $field_args );
...
function tishonator_register_notfound_settings() {
	...
	if ( $options === false ) {
		...
		add_option( 'fkidd_tishonator_notfound_settings', $options );
	}
	
	register_setting( 'fkidd_tishonator_notfound_settings', 'fkidd_tishonator_notfound_settings' );
					 
	add_settings_section( 'tishonator_notfound_options_section', __( 'Error 404 Not Found Page Settings', 'tishonator' ),
		'tishonator_display_notfound_settings_section', 'fkidd_tishonator_notfound_settings');
	...
	$field_args = array( 'type'    => 'image',
					 ...
					 'option_name' => 'fkidd_tishonator_notfound_settings',
				   );

	add_settings_field( 'tishonator_notfound_image_text', __( 'Image', 'tishonator' ), 'tishonator_display_setting',
			'fkidd_tishonator_notfound_settings', 'tishonator_notfound_options_section', $field_args );
