...
function theme_options_do_page() {
	...
	?>
	<div class="wrap">
		<?php screen_icon(); echo "<h2>" . wp_get_theme() . __( ' Theme Options', 'd5smartia' ) . "</h2>"; ?>
		...
		<form method="post" action="options.php">
			...
			<table class="form-table">
				 ...
				 */
				?>
				<tr valign="top"><th scope="row"><?php _e( 'Banner Ad Code (180 X 150) Left Side, HTML Allowed ', 'd5smartia' ); ?></th>
					<td>
				 ...
				 */
				?>
				<tr valign="top"><th scope="row"><?php _e( 'Banner Ad Code (180 X 150) Right Side, HTML Allowed', 'd5smartia' ); ?></th>
					<td>
				 ...
				 */
				?>
				<tr valign="top"><th scope="row"><?php _e( 'Page Top Ad Code (728 X 90), HTML Allowed', 'd5smartia' ); ?></th>
					<td>
				 ...
				 */
				?>
				<tr valign="top"><th scope="row"><?php _e( 'Custom Code within HEAD Tag such as; Google Analytics Code', 'd5smartia' ); ?></th>
					<td>
