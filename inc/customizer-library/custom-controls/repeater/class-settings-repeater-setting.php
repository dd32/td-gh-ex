...
add_action( 'customize_register', 'astore_astore_settings_repeater_setting' );
function astore_astore_settings_repeater_setting(){
/**
 * Repeater Settings.
 */
class AStore_Settings_Repeater_Setting extends WP_Customize_Setting {
