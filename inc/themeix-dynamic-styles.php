...
if (!function_exists('axiohost_dynamic_styles')):
    ...
    function axiohost_dynamic_styles() {
        ...
        $output_css.= "a,a:hover,a:focus,.blog-content h4 a, [class*=light-text] .btn,.headeing-2 span,.section-label,#navigation-menu li.has-submenu ul li a:hover ,.cart-popup-wrapper .cart-popup-btn a,.slider-content .slider-btn2,.slider-content .slider-btn:hover,
...
,.headeing-2 span,.section-label ,#navigation-menu li.has-submenu ul li a:hover, .cart-popup-wrapper .cart-popup-btn a 
