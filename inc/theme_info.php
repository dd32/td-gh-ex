...
function anarcho_theme_options_do_page() { ?>
	...
	<p>
	   You can translate this theme directly out of your WordPress Admin Panel with the plugin <a href="https://wordpress.org/plugins/codestyling-localization/" target="_blank" rel="nofollow" >"CodeStyling Localization"</a>.
	   Many of theme users would be delighted if you shared your translation files with the community.
	   Just send the <b>*.po</b> and <b>*.mo</b> files generated by this plugin to me at the arthurgareginyan@gmail.com and I will include the translation files within the one of the next theme update.
	</p>
