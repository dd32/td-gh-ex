...
if ( ! class_exists( 'Atento_Demo' ) ) {
    ...
    class Atento_Demo {
        ...
        /**
         * Singleton instance of Atento_Demo.
         *
         * @var Atento_Demo $instance Atento_Demo instance.
         */
        ...
        public static function init( $config ) {
            if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Atento_Demo ) ) {
                self::$instance = new Atento_Demo();
...
$config = array(
    ...
    'ocdi'           => array(
        array(
            ...
            'local_import_file'            => ATENTO_THEME_DIR . '/inc/framework/demo-importer/demo/default/content.xml',
            'local_import_widget_file'     => ATENTO_THEME_DIR . '/inc/framework/demo-importer/demo/default/widget.wie',
            'local_import_customizer_file' => ATENTO_THEME_DIR . '/inc/framework/demo-importer/demo/default/customizer.dat',
            'import_preview_image_url'     => ATENTO_THEME_URI . '/inc/framework/demo-importer/demo/default/screenshot.png',
            'preview_url'                  => 'https://precisethemes.com/demo/atento-free/',
        ),
    ),
    'intro_content'  => esc_html__( 'NOTE: In demo import, category selection could be omitted in old (non-fresh) WordPress setup. After import is complete, please go to Widgets admin page under Appearance menu and select the appropriate category in the widgets.', 'atento' ),
);

Atento_Demo::init( apply_filters( 'atento_demo_filter', $config ) );
