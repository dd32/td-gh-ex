<?php if ( ! class_exists( 'a1_Plugin_Activation' ) ) {

    /*  Automatic plugin installation and activation library. */

    class a1_Plugin_Activation {
        ...
        public $menu = 'a1-install-plugins';
        ...
        public function __construct() {
            ...
            do_action_ref_array( 'a1_init', array( $this ) );
        ...
        public function init() {
            ...
            $this->strings = array(
                ...
                'page_title'                     => __( 'Install Required Plugins', 'a1' ),

                'menu_title'                     => __( 'Install Plugins', 'a1' ),

                'installing'                     => __( 'Installing Plugin: %s', 'a1' ),

                'oops'                           => __( 'Something went wrong.', 'a1' ),

                'notice_can_install_required'    => _n_noop( 'This theme requires the following plugin: %1$s.', 'This theme requires the following plugins: %1$s.', 'a1' ),

                'notice_can_install_recommended' => _n_noop( 'This theme recommends the following plugin: %1$s.', 'This theme recommends the following plugins: %1$s.', 'a1' ),

                'notice_cannot_install'          => _n_noop( 'Sorry, but you do not have the correct permissions to install the %s plugin. Contact the administrator of this site for help on getting the plugin installed.', 'Sorry, but you do not have the correct permissions to install the %s plugins. Contact the administrator of this site for help on getting the plugins installed.', 'a1' ),

                'notice_can_activate_required'   => _n_noop( 'The following required plugin is currently inactive: %1$s.', 'The following required plugins are currently inactive: %1$s.', 'a1' ),

                'notice_can_activate_recommended'=> _n_noop( 'The following recommended plugin is currently inactive: %1$s.', 'The following recommended plugins are currently inactive: %1$s.', 'a1' ),

                'notice_cannot_activate'         => _n_noop( 'Sorry, but you do not have the correct permissions to activate the %s plugin. Contact the administrator of this site for help on getting the plugin activated.', 'Sorry, but you do not have the correct permissions to activate the %s plugins. Contact the administrator of this site for help on getting the plugins activated.', 'a1' ),

                'notice_ask_to_update'           => _n_noop( 'The following plugin needs to be updated to its latest version to ensure maximum compatibility with this theme: %1$s.', 'The following plugins need to be updated to their latest version to ensure maximum compatibility with this theme: %1$s.', 'a1' ),

                'notice_cannot_update'           => _n_noop( 'Sorry, but you do not have the correct permissions to update the %s plugin. Contact the administrator of this site for help on getting the plugin updated.', 'Sorry, but you do not have the correct permissions to update the %s plugins. Contact the administrator of this site for help on getting the plugins updated.', 'a1' ),

                'install_link'                   => _n_noop( 'Begin installing plugin', 'Begin installing plugins', 'a1' ),

                'activate_link'                  => _n_noop( 'Begin activating plugin', 'Begin activating plugins', 'a1' ),

                'return'                         => __( 'Return to Required Plugins Installer', 'a1' ),

                'dashboard'                      => __( 'Return to the dashboard', 'a1' ),

                'plugin_activated'               => __( 'Plugin activated successfully.', 'a1' ),

                'activated_successfully'         => __( 'The following plugin was activated successfully:', 'a1' ),

                'complete'                       => __( 'All plugins installed and activated successfully. %1$s', 'a1' ),

                'dismiss'                        => __( 'Dismiss this notice', 'a1' ),

            );

            do_action( 'a1_register' );
        ...
        public function thickbox() {
            ...
            if ( ! get_user_meta( get_current_user_id(), 'a1_dismissed_notice_' . $this->id, true ) ) {
        ...
        public function install_plugins_page() {
            ...
            $plugin_table = new a1PA_List_Table;

            // Return early if processing a plugin installation action.

            if ( isset( $_POST['action'] ) && 'a1-bulk-install' == $_POST['action'] && $plugin_table->process_bulk_actions() || $this->do_plugin_install() ) {
...
<div class="a1 wrap">
  ...
  <form id="a1-plugins" action="" method="post">

    <input type="hidden" name="a1-page" value="<?php echo $this->menu; ?>" />
...
<?php
        ...
        protected function do_plugin_install() {
            ...
            if ( isset( $_GET['plugin'] ) && ( isset( $_GET['a1-install'] ) && 'install-plugin' == $_GET['a1-install'] ) ) {

                check_admin_referer( 'a1-install' );
                ...
                $fields = array( 'a1-install' ); // Extra fields to pass to WP_Filesystem.
                ...
                if ( empty( $complete ) ) {
                    ...
                    echo '<p>' .  sprintf( $this->strings['complete'], '<a href="' . admin_url() . '" title="' . __( 'Return to the Dashboard', 'a1' ) . '">' . __( 'Return to the Dashboard', 'a1' ) . '</a>' ) . '</p>';
            ...
            elseif ( isset( $_GET['plugin'] ) && ( isset( $_GET['a1-activate'] ) && 'activate-plugin' == $_GET['a1-activate'] ) ) {

                check_admin_referer( 'a1-activate', 'a1-activate-nonce' );
        ...
        public function notices() {
            ...
            if ( $this->is_a1_page() ) { return; }

            // Return early if the nag message has been dismissed.

            if ( get_user_meta( get_current_user_id(), 'a1_dismissed_notice_' . $this->id, true ) ) {  return; }
            ...
            if ( ! empty( $message ) ) {
                ...
                foreach ( $message as $type => $plugin_groups ) {
                    ...
                    $rendered .= '<p>' . sprintf( translate_nooped_plural( $this->strings[$type], $count, 'a1' ), $imploded, $count ) . '</p>';

                }

                // Setup variables to determine if action links are needed.

                $show_install_link  = $install_link ? '<a href="' . add_query_arg( 'page', $this->menu, admin_url( 'themes.php' ) ) . '">' . translate_nooped_plural( $this->strings['install_link'], $install_link_count, 'a1' ) . '</a>' : '';

                $show_activate_link = $activate_link ? '<a href="' . add_query_arg( 'page', $this->menu, admin_url( 'themes.php' ) ) . '">' . translate_nooped_plural( $this->strings['activate_link'], $activate_link_count, 'a1' ) . '</a>'  : '';

                // Define all of the action links.

                $action_links = apply_filters(

                    'a1_notice_action_links',
                    ...
                    array(
                        ...
                        'dismiss'  => $this->dismissable ? '<a class="dismiss-notice" href="' . add_query_arg( 'a1-dismiss', 'dismiss_admin_notices' ) . '" target="_parent">' . $this->strings['dismiss'] . '</a>' : '',
                ...
                if ( ! empty( $this->strings['nag_type'] ) ) {
                    ...
                    add_settings_error( 'a1', 'a1', $rendered, sanitize_html_class( strtolower( $this->strings['nag_type'] ) ) );

                } else {

                    add_settings_error( 'a1', 'a1', $rendered, $nag_class );
        ...
        public function dismiss() {
            ...
            if ( isset( $_GET['a1-dismiss'] ) ) {

                update_user_meta( get_current_user_id(), 'a1_dismissed_notice_' . $this->id, 1 );
        ...
        public function actions( $install_actions ) {
            ...
            // Remove action links on the a1PA install page.

            if ( $this->is_a1_page() ) { return false; }
        ...
        /* Determine if we're on the a1PA Install page. */

        protected function is_a1_page() {
        ...
        public function update_dismiss() {
            ...
            delete_user_meta( get_current_user_id(), 'a1_dismissed_notice_' . $this->id );
        ...
        public static function get_instance() {
            ...
            if ( ! isset( self::$instance ) && ! ( self::$instance instanceof a1_Plugin_Activation ) ) {

                self::$instance = new a1_Plugin_Activation();
    ...
    $a1 = a1_Plugin_Activation::get_instance();
...
if ( ! function_exists( 'a1' ) ) {
    ...
    function a1( $plugins, $config = array() ) {

        foreach ( $plugins as $plugin ) {

            a1_Plugin_Activation::$instance->register( $plugin );

        } if ( $config ) {

            a1_Plugin_Activation::$instance->config( $config );
...
if ( ! class_exists( 'a1PA_List_Table' ) ) {

    /* List table class for handling plugins. */

    class a1PA_List_Table extends WP_List_Table {
        ...
        protected function _gather_plugin_data() {
            ...
            a1_Plugin_Activation::$instance->admin_init();

            a1_Plugin_Activation::$instance->thickbox();
            ...
            foreach ( a1_Plugin_Activation::$instance->plugins as $plugin ) {
                ...
                if ( ! empty( $plugin['source'] ) ) {
                    ...
                    if ( preg_match( '|^http(s)?://|', $plugin['source'] ) ) {
                        ...
                        $table_data[$i]['source'] = __( 'Private Repository', 'a1' );

                    // The plugin is pre-packaged with the theme.

                    } else {

                        $table_data[$i]['source'] = __( 'Pre-Packaged', 'a1' );

                    } } else {

                    $table_data[$i]['source'] = __( 'WordPress Repository', 'a1' );

                }

                $table_data[$i]['type'] = isset( $plugin['required'] ) && $plugin['required'] ? __( 'Required', 'a1' ) : __( 'Recommended', 'a1' );

                if ( ! isset( $installed_plugins[$plugin['file_path']] ) ) {

                    $table_data[$i]['status'] = sprintf( '%1$s', __( 'Not Installed', 'a1' ) );

                } elseif ( is_plugin_inactive( $plugin['file_path'] ) ) {

                    $table_data[$i]['status'] = sprintf( '%1$s', __( 'Installed But Not Activated', 'a1' ) );
        ...
        /* Retrieve plugin data, given the plugin name. Taken from the a1_Plugin_Activation class.*/

        protected function _get_plugin_data_from_name( $name, $data = 'slug' ) {

            foreach ( a1_Plugin_Activation::$instance->plugins as $plugin => $values ) {
            ...
            if ( ! isset( $installed_plugins[$item['file_path']] ) ) {
                ...
                $actions = array(
                    ...
                    'install' => sprintf(
                        ...
                        '<a href="%1$s" title="' . __( 'Install', 'a1' ) . ' %2$s">' . __( 'Install', 'a1' ) . '</a>',
                        ...
                        wp_nonce_url(
                            ...
                            add_query_arg(
                                ...
                                array(
                                    ...
                                    'page'          => a1_Plugin_Activation::$instance->menu,
            ...
            elseif ( is_plugin_inactive( $item['file_path'] ) ) {
                ...
                $actions = array(
                    ...
                    'activate' => sprintf(
                        ...
                        '<a href="%1$s" title="' . __( 'Activate', 'a1' ) . ' %2$s">' . __( 'Activate', 'a1' ) . '</a>',
                        ...
                        add_query_arg(
                            ...
                            array(
                                ...
                                'a1-activate'       => 'activate-plugin',

                                'a1-activate-nonce' => wp_create_nonce( 'a1-activate' ),
        ...
        public function no_items() {
		    ...
		    _e('No plugins to install or activate','a1'); echo ".<a href='admin_url()'>".__('Return to the Dashboard','a1'). "</a>";
        ...
        public function get_bulk_actions() {
            ...
            $actions = array(
                ...
                'a1-bulk-install'  => __( 'Install', 'a1' ),

                'a1-bulk-activate' => __( 'Activate', 'a1' ),
        ...
        public function process_bulk_actions() {
            ...
            if ( 'a1-bulk-install' === $this->current_action() ) {
                ...
                if ( empty( $plugin_installs ) ) {
                    ...
                    echo '<div id="message" class="error"><p>' . __( 'No plugins are available to be installed at this time.', 'a1' ) . '</p></div>';
                ...
                // Loop through each plugin to install and try to grab information from WordPress API, if not create 'a1-empty' scalar.

                $i = 0;

                foreach ( $plugin_installs as $plugin ) {

                    $api[$i] = plugins_api( 'plugin_information', array( 'slug' => $plugin, 'fields' => array( 'sections' => false ) ) ) ? plugins_api( 'plugin_information', array( 'slug' => $plugin, 'fields' => array( 'sections' => false ) ) ) : (object) $api[$i] = 'a1-empty';

                    $i++;

                }

                if ( is_wp_error( $api ) ) { wp_die( a1_Plugin_Activation::$instance->strings['oops'] . var_dump( $api ) ); }
                ...
                $url   = add_query_arg( array( 'page' => a1_Plugin_Activation::$instance->menu ), admin_url( 'themes.php' ) );

                $nonce = 'bulk-plugins';

                $names = $plugin_names;

                // Create a new instance of a1_Bulk_Installer.

                $installer = new a1_Bulk_Installer( $skin = new a1_Bulk_Installer_Skin( compact( 'url', 'nonce', 'names' ) ) );

                // Wrap the install process with the appropriate HTML.

                echo '<div class="a1 wrap">';

                    if ( version_compare( a1_Plugin_Activation::$instance->wp_version, '3.8', '<' ) ) {                        
            ...
            if ( 'a1-bulk-activate' === $this->current_action() ) {
                ...
                if ( empty( $plugins_to_activate ) ) {
                    ...
                    echo '<div id="message" class="error"><p>' . __( 'No plugins are available to be activated at this time.', 'a1' ) . '</p></div>';
                ...
                if ( is_wp_error( $activate ) ) {
                    ...
                    printf( '<div id="message" class="updated"><p>%1$s %2$s.</p></div>', _n( 'The following plugin was activated successfully:', 'The following plugins were activated successfully:', $count, 'a1' ), $imploded );
...
add_action( 'admin_init', 'a1_load_bulk_installer' );

function a1_load_bulk_installer() {

    if ( ! class_exists( 'WP_Upgrader' ) && ( isset( $_GET['page'] ) && a1_Plugin_Activation::$instance->menu === $_GET['page'] ) ) {

        require_once ABSPATH . 'wp-admin/includes/class-wp-upgrader.php';

        if ( ! class_exists( 'a1_Bulk_Installer' ) ) {

            /* Installer class to handle bulk plugin installations. */

            class a1_Bulk_Installer extends WP_Upgrader {
                ...
                public function bulk_install( $packages ) {
                    ...
                    if ( a1_Plugin_Activation::$instance->is_automatic ) { $this->activate_strings(); }
                ...
                public function run( $options ) {
                    ...
                    if ( a1_Plugin_Activation::$instance->is_automatic ) {
                        ...
                        a1_Plugin_Activation::$instance->populate_file_path();
                ...
                public function install_strings() {
                    ...
                    $this->strings['no_package']          = __( 'Install package not available.', 'a1' );

                    $this->strings['downloading_package'] = printf( __('Downloading install package from %1$s %s %1$s', 'a1'), '<span class="code">', '</span>&#8230;');

					$this->strings['unpack_package']      = __( 'Unpacking the package&#8230;', 'a1' );

                    $this->strings['installing_package']  = __( 'Installing the plugin&#8230;', 'a1' );

                    $this->strings['process_failed']      = __( 'Plugin install failed.', 'a1' );

                    $this->strings['process_success']     = __( 'Plugin installed successfully.', 'a1' );
                ...
                public function activate_strings() {
                    ...
                    $this->strings['activation_failed']  = __( 'Plugin activation failed.', 'a1' );

                    $this->strings['activation_success'] = __( 'Plugin activated successfully.', 'a1' );
        ...
        if ( ! class_exists( 'a1_Bulk_Installer_Skin' ) ) {

            /* Installer skin to set strings for the bulk plugin installations. */

            class a1_Bulk_Installer_Skin extends Bulk_Upgrader_Skin {
                ...
                public function add_strings() {
                    ...
                    if ( a1_Plugin_Activation::$instance->is_automatic ) {
                        ...
                        $this->upgrader->strings['skin_upgrade_start']        = __( 'The installation and activation process is starting. This process may take a while on some hosts, so please be patient.', 'a1' );

                        $this->upgrader->strings['skin_update_successful']    = __( '%1$s installed and activated successfully.', 'a1' ) . ' <a onclick="%2$s" href="#" class="hide-if-no-js"><span>' . __( 'Show Details', 'a1' ) . '</span><span class="hidden">' . __( 'Hide Details', 'a1' ) . '</span>.</a>';

                        $this->upgrader->strings['skin_upgrade_end']          = __( 'All installations and activations have been completed.', 'a1' );

                        $this->upgrader->strings['skin_before_update_header'] = __( 'Installing and Activating Plugin %1$s (%2$d/%3$d)', 'a1' );
                    ...
                    // Default installation strings.
                        ...
                        $this->upgrader->strings['skin_upgrade_start']        = __( 'The installation process is starting. This process may take a while on some hosts, so please be patient.', 'a1' );

                        $this->upgrader->strings['skin_update_failed_error']  = __( 'An error occurred while installing %1$s: %2$s.', 'a1' );

                        $this->upgrader->strings['skin_update_failed']        = __( 'The installation of %1$s failed.', 'a1' );

                        $this->upgrader->strings['skin_update_successful']    = __( '%1$s installed successfully.', 'a1' ) . ' <a onclick="%2$s" href="#" class="hide-if-no-js"><span>' . __( 'Show Details', 'a1' ) . '</span><span class="hidden">' . __( 'Hide Details', 'a1' ) . '</span>.</a>';

                        $this->upgrader->strings['skin_upgrade_end']          = __( 'All installations have been completed.', 'a1' );

                        $this->upgrader->strings['skin_before_update_header'] = __( 'Installing Plugin %1$s (%2$d/%3$d)', 'a1' );
                ...
                public function bulk_footer() {
                    ...
                    foreach ( a1_Plugin_Activation::$instance->plugins as $plugin ) {
                        ...
                        if ( ! is_plugin_active( $plugin['file_path'] ) ) {
                            ...
                            echo '<p><a href="' . add_query_arg( 'page', a1_Plugin_Activation::$instance->menu, admin_url( 'themes.php' ) ) . '" title="' . esc_attr( a1_Plugin_Activation::$instance->strings['return'] ) . '" target="_parent">' . a1_Plugin_Activation::$instance->strings['return'] . '</a></p>';
                    ...
                    if ( empty( $complete ) ) {
                        ...
                        echo '<p>' .  sprintf( a1_Plugin_Activation::$instance->strings['complete'], '<a href="' . admin_url() . '" title="' . __( 'Return to the Dashboard', 'a1' ) . '">' . __( 'Return to the Dashboard', 'a1' ) . '</a>' ) . '</p>';
