 ...
 *
 */
function absolutte_featured_color() {
    return ".pagination li.active a:hover,
	...
	.question,
	.absolutte-contact-form .absolutte-contact-form-text,
	.absolutte-contact-form input[type='text'],
	.absolutte-contact-form input[type='email'],
	.absolutte-contact-form textarea,
	...
	.absolutte-product-view .absolutte-product-desc .summary .entry .price,
	.woocommerce .absolutte-product-view .absolutte-product-desc .summary .entry .price,
	.absolutte-login-btn:hover,
	.absolutte-login-btn:focus,
	...
	.woocommerce a.added_to_cart,
	#ql_load_more,
	.absolutte-service .absolutte-service-content-wrap .absolutte-service-title,
	.absolutte-service.absolutte-service-style-7 .absolutte-service-action a,
 ...
 *
 */
function absolutte_featured_background_color() {
	...
	.absolutte-home-slider-fullscreen .slider-fullscreen-controls .prevnext-button,
	.pace .pace-progress,
	...
	.absolutte-contact-form input[type='submit'],
	.woocommerce-cart .wc-proceed-to-checkout a.checkout-button,
	.woocommerce #payment #place_order, .woocommerce-page #payment #place_order,
	.contact-form input[type='submit'],
	.portfolio-load-wrapper .portfolio-load-more,
	.absolutte-preloader .absolutte-folding-cube .absolutte-cube::before,
	.woocommerce .widget_price_filter .price_slider_wrapper .ui-widget-content,
	.no-touch .ql_secundary_btn:hover,
	.no-touch .absolutte-mini-cart .woocommerce-mini-cart__buttons .button:hover,
	...
	.absolutte-product-view .absolutte-product-desc .summary .entry a.button,
	.woocommerce .absolutte-product-view .absolutte-product-desc .summary .entry a.button,
	.woocommerce #main .single_add_to_cart_button, .woocommerce .absolutte-product-view button.single_add_to_cart_button,
	...
	.absolutte-double-bounce1,
	.absolutte-double-bounce2,
	.absolutte-sidebar-wrapper #absolutte-shop-cart-panel .woocommerce-mini-cart__buttons .button.checkout,
	.no-touch .woocommerce a.added_to_cart:hover,
	.absolutte-preloader .absolutte-double-bounce1, .absolutte-preloader .absolutte-double-bounce2,
	.absolutte-section-title::after,
	.absolutte-section-title-small::after,
 ...
 *
 */
function absolutte_featured_border_color() {
	...
	.absolutte-contact-form input[type='text']:focus,
	.absolutte-contact-form input[type='email']:focus,
	.absolutte-contact-form textarea:focus,
	.ql_secundary_btn,
	.absolutte-mini-cart .woocommerce-mini-cart__buttons .button,
	.woocommerce #review_form #respond .form-submit input,
	.woocommerce-page #review_form #respond .form-submit input,
	...
	.woocommerce a.added_to_cart,
	#ql_load_more,
	.no-touch .absolutte-service.absolutte-service-style-7:hover,
	.comment-list .comment.bypostauthor .comment-body,
	.main-navigation ul ul,
	.no-touch .blog #content .post .entry-footer .metadata ul li a:hover, .no-touch .archive #content .post .entry-footer .metadata ul li a:hover, .no-touch .search #content .post .entry-footer .metadata ul li a:hover
	";
}
 ...
 *
 */
function absolutte_secondary_color() {
    return "";
}
 ...
 *
 */
function absolutte_secondary_background_color() {
    return ".absolutte-button, .comment-form .form-submit input[type='submit']";
}
 ...
 *
 */
function absolutte_secondary_border_color() {
    return "";
}
 ...
 */
function absolutte_custom_css() {
    /*
    Colors
     */
    $heroColor = esc_html( get_theme_mod( 'absolutte_featured_color', '#6683e2' ) );
    $secondaryColor = esc_html( get_theme_mod( 'absolutte_secondary_color', '#2fc77c' ) );
    $headings_color = esc_html( get_theme_mod( 'absolutte_headings_color', '#222222' ) );
    $text_color = esc_html( get_theme_mod( 'absolutte_text_color', '#777777' ) );
    $link_color = esc_html( get_theme_mod( 'absolutte_link_color', '#6683e2' ) );
    $content_background_color = esc_html( get_theme_mod( 'absolutte_content_background_color', '#FFFFFF' ) );
    $footer_background = esc_html( get_theme_mod( 'absolutte_footer_background', '#FFFFFF' ) );
    $site_gradient = esc_html( get_theme_mod( 'absolutte_site_gradient', '1' ) );
    $site_background_color = esc_html( get_theme_mod( 'absolutte_site_background_color', '#e08461' ) );
    $logo_color = esc_html( get_theme_mod( 'absolutte_logo_color', '#222222' ) );
    $header_bck_color = esc_html( get_theme_mod( 'absolutte_header_bck_color', '#FFFFFF' ) );
    $header_lines_color = esc_html( get_theme_mod( 'absolutte_header_lines_color', '#EEEEEE' ) );
    $quick_view_bck = esc_html( get_theme_mod( 'absolutte_shop_quick_view_bck', '#efefef' ) );
    ...
    $custom_css = absolutte_get_custom_css( $colors );

    wp_add_inline_style( 'absolutte_style', $custom_css );

    /*
    Typography
     */
    $absolutte_typography_font_family = esc_html( get_theme_mod( 'absolutte_typography_font_family', 'Lato' ) );
    $absolutte_typography_font_family_headings = esc_html( get_theme_mod( 'absolutte_typography_font_family_headings', 'Lato' ) );
    $absolutte_typography_subsets = esc_html( get_theme_mod( 'absolutte_typography_subsets', '' ) );
    $absolutte_typography_font_size = esc_html( get_theme_mod( 'absolutte_typography_font_size', '16' ) );

    $typography = array(
        'font-family'          => $absolutte_typography_font_family,
        'font-family-headings' => $absolutte_typography_font_family_headings,
        'font-size'            => $absolutte_typography_font_size,
    );

    //Add Google Fonts
    $absolutte_font_subset = '';
    if ( is_array( $absolutte_typography_subsets ) ) {
        $absolutte_font_subset = '&subset=';
        foreach ( $absolutte_typography_subsets as $subset ) {
            $absolutte_font_subset .= $subset . ',';
        }
        $absolutte_font_subset = rtrim( $absolutte_font_subset, ',' );
    }

    $absolutte_google_font = '//fonts.googleapis.com/css?family=' . $absolutte_typography_font_family . ':400,700' . $absolutte_font_subset;
    wp_enqueue_style( 'absolutte_google-font', $absolutte_google_font, array(), '1.0', 'all' );

    $absolutte_google_font_headings = '//fonts.googleapis.com/css?family=' . $absolutte_typography_font_family_headings . ':100,400,700' . $absolutte_font_subset;
    wp_enqueue_style( 'absolutte_google-font-headings', $absolutte_google_font_headings, array(), '1.0', 'all' );

    $custom_css = absolutte_get_custom_typography_css( $typography );

    wp_add_inline_style( 'absolutte_style', $custom_css );
}
add_action( 'wp_enqueue_scripts', 'absolutte_custom_css' );
 ...
 * @return string CSS.
 */
function absolutte_get_custom_css( $colors ) {

    //Default colors
    $colors = wp_parse_args( $colors, array(
        'heroColor'                => '#fd6848',
        'secondaryColor'           => '#2fc77c',
    ...
    $heroColor_darker = absolutte_darken_color( $colors['heroColor'], 1.1 );
    $link_color_darker = absolutte_darken_color( $colors['link_color'], 1.2 );
    $heroColor_rgb = absolutte_hex2rgb( $colors['heroColor'] );

    $secondaryColor_darker = absolutte_darken_color( $colors['secondaryColor'], 1.1 );

    // Custom CSS for the current page only
    $absolutte_header_bck_color = rwmb_meta( 'absolutte_header_bck_color' );
    $absolutte_header_logo_color = rwmb_meta( 'absolutte_header_logo_color' );
    $absolutte_header_text_color = rwmb_meta( 'absolutte_header_text_color' );
    $absolutte_header_hover_color = rwmb_meta( 'absolutte_header_hover_color' );
    $absolutte_header_mobile_menu_bck_color = rwmb_meta( 'absolutte_header_mobile_menu_bck_color' );
    // If is Shop page we need to pass the page ID
    if ( function_exists( 'is_shop' ) && is_shop() ) {
        $shop_id = get_option( 'woocommerce_shop_page_id' );
        $absolutte_header_bck_color = rwmb_meta( 'absolutte_header_bck_color', '', $shop_id );
        $absolutte_header_logo_color = rwmb_meta( 'absolutte_header_logo_color', '', $shop_id );
        $absolutte_header_text_color = rwmb_meta( 'absolutte_header_text_color', '', $shop_id );
        $absolutte_header_hover_color = rwmb_meta( 'absolutte_header_hover_color', '', $shop_id );
        $absolutte_header_mobile_menu_bck_color = rwmb_meta( 'absolutte_header_mobile_menu_bck_color', '', $shop_id );
    }
	...
	.absolutte-button:hover, .absolutte-button-secondary:hover, .absolutte-app-store-button:hover, .comment-form .form-submit input:hover[type="submit"], .absolutte-button:focus, .absolutte-button-secondary:focus, .absolutte-app-store-button:focus, .comment-form .form-submit input:focus[type="submit"]{
		background-color: {$secondaryColor_darker};
	}
	...
	body .single-product .top-bar{
		background-color: {$absolutte_header_bck_color} !important;
	}

	body #header .absolutte-logo-wrap .site-title .ql_logo{
		color: {$absolutte_header_logo_color} !important;
	}
	...
	body #header .nav_social li a{
		color: {$absolutte_header_text_color};
	}
	...
	.no-touch .main-navigation ul > li > a:hover{
		color: {$absolutte_header_hover_color};
	}

	@media (max-width: 767px) {
		.main-navigation{
			background-color: {$absolutte_header_mobile_menu_bck_color};
		}
	}
 ...
 * @return string CSS.
 */
function absolutte_get_custom_typography_css( $typography ) {
...
/**
 * Returns CSS for the typography styles for Admin
 *
 * @param array $typography typography.
 * @return string CSS.
 */
function absolutte_get_admin_custom_typography_css( $typography ) {
...
function absolutte_admin_typography() {
    /*
    Typography
     */
    $absolutte_typography_font_family = esc_html( get_theme_mod( 'absolutte_typography_font_family', 'Source Sans Pro' ) );
    $absolutte_typography_font_family_headings = esc_html( get_theme_mod( 'absolutte_typography_font_family_headings', 'Lato' ) );
    $absolutte_typography_subsets = esc_html( get_theme_mod( 'absolutte_typography_subsets', '' ) );
    $absolutte_typography_font_size = esc_html( get_theme_mod( 'absolutte_typography_font_size', '16' ) );
    ...
    $custom_css = absolutte_get_admin_custom_typography_css( $typography );

    echo '<style>';
    echo wp_kses_post( $custom_css );
    echo '</style>';
}
add_action( 'admin_head', 'absolutte_admin_typography' );
