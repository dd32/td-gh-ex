...
$custom_header_support = array( 
	...
	'default-text-color' => '',
	'width' => apply_filters( 'chiplife_header_image_width', 280 ),
	'height' => apply_filters( 'chiplife_header_image_height', 60 ),
	'flex-height' => true,
	'header-text' => false,
	'wp-head-callback' => 'chiplife_header_style',
	'admin-head-callback' => 'chiplife_admin_header_style',
	'admin-preview-callback' => 'chiplife_admin_header_image'
...
register_default_headers( array(
	...
	'chiplife' => array(
		...
		'description' => __( 'Chiplife', 'chiplife' )
	)

) );

/** Styles the header image and text displayed on the blog. */
function chiplife_header_style() {
}

/** Styles the header image displayed on the Appearance > Header admin panel. */
function chiplife_admin_header_style() {
?>
<style type="text/css">
...
function chiplife_admin_header_image() {
?>
<div id="headimg">	
