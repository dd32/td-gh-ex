...
add_action( 'kadence_post_header', 'ascend_single_post_header', 20 );
...
/* Single Post Layout */
add_action( 'kadence_single_post_begin', 'ascend_single_post_upper_headcontent', 10 );
...
add_action( 'kadence_single_attachment_header', 'ascend_single_post_meta_date_author', 30 );
add_action( 'kadence_post_excerpt_header', 'ascend_single_post_meta_date_author', 30 );
add_action( 'kadence_single_loop_post_header', 'ascend_single_post_meta_date_author', 30 );
add_action( 'kadence_single_post_header', 'ascend_single_post_meta_date_author', 30 );
...
add_action( 'kadence_single_attachment_footer', 'ascend_post_footer_pagination', 10 );
add_action( 'kadence_single_post_footer', 'ascend_post_footer_pagination', 10 );
...
add_action( 'kadence_single_post_footer', 'ascend_post_footer_tags', 20 );
...
add_action( 'kadence_single_post_footer', 'ascend_post_nav', 40 );
...
add_action( 'kadence_post_grid_excerpt_footer', 'ascend_post_grid_footer_meta', 20 );
