...
if(isset($pinnacle['topbar_mobile_hide']) && $pinnacle['topbar_mobile_hide'] == '1') {
    $topbar_mobile_hide = '@media (max-width: 767pxpx) {#topbar{display:none;}}';
    } else {
      $topbar_mobile_hide = '';
    } 
...
if(isset($pinnacle['pagetitle_align']) && $pinnacle['pagetitle_align'] == 'right') {
  ...
  $x2logo = ' @media (-webkit-min-device-pixel-ratio: 2), (min-resolution: 192dpi) { body #kad-banner #logo .kad-standard-logo, .trans-header .is-sticky #kad-banner #logo .kad-standard-logo {display: none;} #kad-banner #logo .kad-retina-logo, .trans-header .is-sticky #kad-banner #logo .kad-retina-logo {display: block;}}';
} else {
  $x2logo = '';
}
  if(!empty($pinnacle['th_x2_logo_upload']['url'])) {
  $x2logo_white = ' @media (-webkit-min-device-pixel-ratio: 2), (min-resolution: 192dpi) { .trans-header #kad-banner #logo .kad-standard-logo-tranbg {display: none;} .trans-header #kad-banner #logo .kad-retina-logo-tranbg {display: block;}}';
} else {
  $x2logo_white = '';
}
