...
?>
        <<?php echo $tag; ?> id="comment-<?php comment_ID(); ?>" <?php comment_class( '', $comment ); ?>>
            <div class="comment-body">
                <?php _e('Pingback:','backyard'); ?> <?php comment_author_link( $comment ); ?> <?php edit_comment_link( __('Edit','backyard'), '<span class="edit-link">', '</span>' ); ?>
            </div>
<?php
    }
...
?>
        ...
        <div class="comment-meta commentmetadata"><a href="<?php echo esc_url( get_comment_link( $comment, $args ) ); ?>">
            <?php
                ...
                printf(__( '%1$s at %2$s', 'backyard'), get_comment_date( '', $comment ),  get_comment_time() ); ?></a><?php edit_comment_link(__('| (Edit)', 'backyard'), '', ''); ?>
        </div>
                    ...
                    <div class="comment-metadata">
                        <a href="<?php echo esc_url( get_comment_link( $comment, $args ) ); ?>">
                            <time datetime="<?php comment_time( 'c' ); ?>">
                                <?php
                                    /* translators: 1: comment date, 2: comment time */
                                    printf(__('%1$s at %2$s','backyard'), get_comment_date( '', $comment ), get_comment_time() );
                                ?>
                            </time>
                        </a>
                        <?php edit_comment_link(__('Edit <span class="edit-link"> </span>','backyard')); ?>
                    </div><!-- .comment-metadata -->
 
                    <?php if ( '0' == $comment->comment_approved ) : ?>
                    <p class="comment-awaiting-moderation"><?php _e('Your comment is awaiting moderation.','backyard'); ?></p>
                    <?php endif; ?>
                </footer><!-- .comment-meta -->
