...
if(!class_exists('KT_Aq_Resize')) {
    ...
    class KT_Aq_Resize
    {
        ...
        public function process( $url, $width = null, $height = null, $crop = null, $single = true, $upscale = false ) {
            try {
                ...
                if ( false === strpos( $url, $upload_url ) )
                    throw new KT_Aq_Exception('Image must be local: ' . $url);
                ...
                if ( ! file_exists( $img_path ) or ! getimagesize( $img_path ) )
                    throw new KT_Aq_Exception('Image file does not exist (or is not an image): ' . $img_path);
                ...
                if ( ! $dims && ( ( ( null === $height && $orig_w == $width ) xor ( null === $width && $orig_h == $height ) ) xor ( $height == $orig_h && $width == $orig_w ) ) ) {
                    ...
                    if ( ! $dims || ( true == $crop && false == $upscale && ( $dst_w < $width || $dst_h < $height ) ) ) {
                        ...
                        throw new KT_Aq_Exception('Unable to resize image because image_resize_dimensions() failed');
                    }
                    ...
                    // Else, we resize the image and return the new resized image url.
                        ...
                        if ( is_wp_error( $editor ) || is_wp_error( $editor->resize( $width, $height, $crop ) ) ) {
                            throw new KT_Aq_Exception('Unable to get WP_Image_Editor: (is GD or ImageMagick installed?)');
                        }
                        ...
                        if ( ! is_wp_error( $resized_file ) ) {
                            ...
                            $img_url = $upload_url . $resized_rel_path;
                                ...
                                throw new KT_Aq_Exception('Unable to save resized image file.');
                        }
         ...
         */
        function kt_aq_upscale( $default, $orig_w, $orig_h, $dest_w, $dest_h, $crop ) {
...
if(!function_exists('ascend_aq_resize')) {

    /**
     * This is just a tiny wrapper function for the class above so that there is no
     * need to change any code in your own WP themes. Usage is still the same :)
     */
    function ascend_aq_resize( $url, $width = null, $height = null, $crop = null, $single = true, $upscale = false, $id = null ) {
        if( class_exists( 'Jetpack' ) && Jetpack::is_module_active( 'photon' ) ) {
            ...
            $kt_aq_resize = KT_Aq_Resize::getInstance();
            return $kt_aq_resize->process( $url, $width, $height, $crop, $single, $upscale );
        }
    }
}