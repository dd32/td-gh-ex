...
class kad_contact_widget extends WP_Widget {
    ...
    public function widget($args, $instance) {
        ...
        <div class="vcard">
            ...
            <?php if(!empty($instance['company'])):?><p class="vcard-company"><i class="kt-icon-building"></i><?php echo $company; ?></p><?php endif;?>
            <?php if(!empty($instance['name'])):?><p class="vcard-name fn"><i class="kt-icon-user"></i><?php echo $instance['name']; ?></p><?php endif;?>
            <?php if(!empty($instance['street_address']) || !empty($instance['locality']) || !empty($instance['region']) ):?>
                <p class="vcard-address"><i class="kt-icon-map-marker"></i><?php echo $instance['street_address']; ?>
            ...
            <?php if(!empty($instance['fixedtel'])):?><p class="tel fixedtel"><i class="kt-icon-phone"></i><?php echo $instance['fixedtel']; ?></p><?php endif;?>
            <?php if(!empty($instance['email'])):?><p><a class="email" href="mailto:<?php echo antispambot($instance['email']);?>"><i class="kt-icon-envelope"></i><?php echo antispambot($instance['email']); ?></a></p> <?php endif;?>
    ...
    public function widget($args, $instance){ 
        ...
        echo $before_widget; 
            echo '<div class="kad_img_upload_widget kt-image-widget-'.esc_attr($args['widget_id']).'">';
                ...
                if($size == 'custom') {
                	$img = ascend_get_image($instance['width'], $instance['height'], true, null, null, $instance['image_id'], true);
