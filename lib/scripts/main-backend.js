...
jQuery(document).ready(function(){
	...
	if(jQuery('tr._thinkup_meta_blogstyle input[value=option3]').is(":checked")){
		jQuery('tr._thinkup_meta_blogstylelayout').show();
	}
	else if(jQuery('tr._thinkup_meta_blogstyle input[value=option3]').not(":checked")){
		jQuery('tr._thinkup_meta_blogstylelayout').hide();
	}
...
jQuery(document).ready(function(){
	...
	if( jQuery('#section-thinkup_blog_style input[value=option2]').is(":checked") ){
		jQuery('#section-thinkup_blog_stylegrid').show();
	}
	else if(jQuery('#section-thinkup_blog_style input[value=option2]').not(":checked") ){
		jQuery('#section-thinkup_blog_stylegrid').hide();
	}
	...
	// Team - Show layout options for grid style - DONE
	if(jQuery('#section-thinkup_team_styleswitch input[value=option2]').is(":checked")){
		jQuery('#section-thinkup_team_layout').show();
	}
	else if(jQuery('#section-thinkup_team_styleswitch input[value=option2]').not(":checked")){
		jQuery('#section-thinkup_team_layout').hide();
	}
...
jQuery(document).ready(function(){
	jQuery('input[type=radio]').change(function() {
		...
		// Team - Show layout options for grid style - DONE
		if(jQuery('#section-thinkup_team_styleswitch input[value=option2]').is(":checked")){
			jQuery('#section-thinkup_team_layout').fadeIn('slow');
		}
		else if(jQuery('#section-thinkup_team_styleswitch input[value=option2]').not(":checked")){
			jQuery('#section-thinkup_team_layout').fadeOut('slow');
		}
...
jQuery(document).ready(function(){
	jQuery('input[type=radio]').change(function() {
		...
		// Select Blog Style - DONE
		if( jQuery('#section-thinkup_blog_style input[value=option2]').is(":checked") ){
			jQuery('#section-thinkup_blog_stylegrid').fadeIn();
		}
		else if(jQuery('#section-thinkup_blog_style input[value=option2]').not(":checked") ){
			jQuery('#section-thinkup_blog_stylegrid').fadeOut();
		}
