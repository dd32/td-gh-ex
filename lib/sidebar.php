...
function backyard_sidebar_id() {
    if(is_front_page()) {
      global $backyard;
        if (!empty($backyard['home_sidebar'])) {
          $sidebar = $backyard['home_sidebar'];
          }
        else  {
        ...
        global $backyard;
        if (!empty($backyard['shop_sidebar'])) {
          $sidebar = $backyard['shop_sidebar'];
        } else {
          $sidebar = 'sidebar-primary';
        } 
    ...
    return apply_filters('backyard_sidebar_id', $sidebar);
}