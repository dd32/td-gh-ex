...
if( ! class_exists('Backyard_Customizer_API_Wrapper') ) {
	class Backyard_Customizer_API_Wrapper {
		...
		public static function getInstance($options) {
			if(! self::$_instance) {
				self::$_instance = new Backyard_Customizer_API_Wrapper($options);
			}
		...
		public function enqueue_scripts() {
			...
			wp_enqueue_script( 
				'backyard-customizer-admincss', 
				get_template_directory_uri() . '/admin/css/admin.js',
				array()
			);
