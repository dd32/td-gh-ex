...
<?php the_post_thumbnail('thumbnail', array('class' => 'alignleft')); ?>
<?php the_content( __( 'Continue reading <span class="meta-nav">&rarr;</span>', 'beam' ) ); ?>
<?php
wp_link_pages( array(
...
/*$mypermalink = get_permalink( $id );
$mytitle = get_the_title( $id );*/
if ( $categories_list && beam_categorized_blog() ) :
?>

<span class="fa fa-permalink"><a href="<?php echo get_permalink( $id ); ?>" title="Permalink to <?php echo get_the_title($id); ?>" rel="bookmark"><i class="fa fa-link"></i></a></span>
