                ...
                <div class="wid-50 mobwid-100 title-details">
                    <div class="title-header">
                        ...
                        <div class="persona-meta">
                            ...
                            <span class="mg-rt-20 author"><?php esc_html_e( 'By ', 'axis-magazine' ); the_author_posts_link(); ?></span>
                    ...
                    <div class="details-box relative">
                        <div class="details-box-inner">
                            ...
                            <h3><?php the_excerpt(__(' &raquo;', 'axis-magazine')); ?></h3>
                            <div class="btn-case dsply-fl jc-center">
                                <a href="<?php the_permalink(); ?>"><?php esc_html_e( 'Read More', 'axis-magazine' ); ?></a>
                            </div>
                        </div>
