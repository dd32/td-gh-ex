...
<article id="post-<?php the_ID(); ?>" class="<?php hybrid_entry_class(); ?>">
	...
	<?php if ( is_singular() && is_main_query() ) { ?>
		...
		<header class="entry-header">
			...
			<?php echo apply_atomic_shortcode( 'byline', '<div class="byline">' . __( 'Published by [entry-author] on [entry-published] [entry-comments-link before=" | "] [entry-edit-link before=" | "]', 'adroa' ) . '</div>' ); ?>
		</header><!-- .entry-header -->
