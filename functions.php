...
function my_theme_register_required_plugins() {
    ...
    $plugins = array(
        ...
        array(
            ...
            'slug'               => 'post-teaser', // The plugin slug (typically the folder name).
            'source'             => get_stylesheet_directory() . '/plugins/post teaser.zip', // The plugin source.
    ...
    $config = array(
        ...
        'strings'      => array(
            ...
            'notice_can_install_required'     => _n_noop( '<h2>This theme requires the following plugin: %1$s.</h2>', '<h2>This theme requires the following plugins: %1$s.</h2>' ), // %1$s = plugin name(s).
