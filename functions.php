...
if ( ! function_exists( 'ayahairsalon_show_social_sites' ) ) :
	...
	function ayahairsalon_show_social_sites() {
		...
		if ( !empty($socialURL) ) {
			...
			echo '<li><a href="' . esc_url( $socialURL ) . '" title="' . __('Follow us on Facebook', 'ayahairsalon') . '" class="facebook16"></a>';
		}

		$socialURL = get_theme_mod('ayahairsalon_social_google');
		if ( !empty($socialURL) ) {

			echo '<li><a href="' . esc_url( $socialURL ) . '" title="' . __('Follow us on Google+', 'ayahairsalon') . '" class="google16"></a>';
		}

		$socialURL = get_theme_mod('ayahairsalon_social_twitter');
		if ( !empty($socialURL) ) {

			echo '<li><a href="' . esc_url( $socialURL ) . '" title="' . __('Follow us on Twitter', 'ayahairsalon') . '" class="twitter16"></a>';
		}

		$socialURL = get_theme_mod('ayahairsalon_social_linkedin');
		if ( !empty($socialURL) ) {

			echo '<li><a href="' . esc_url( $socialURL ) . '" title="' . __('Follow us on LinkedIn', 'ayahairsalon') . '" class="linkedin16"></a>';
		}

		$socialURL = get_theme_mod('ayahairsalon_social_instagram');
		if ( !empty($socialURL) ) {

			echo '<li><a href="' . esc_url( $socialURL ) . '" title="' . __('Follow us on Instagram', 'ayahairsalon') . '" class="instagram16"></a>';
		}

		$socialURL = get_theme_mod('ayahairsalon_social_rss');
		if ( !empty($socialURL) ) {

			echo '<li><a href="' . esc_url( $socialURL ) . '" title="' . __('Follow our RSS Feeds', 'ayahairsalon') . '" class="rss16"></a>';
		}

		$socialURL = get_theme_mod('ayahairsalon_social_tumblr');
		if ( !empty($socialURL) ) {

			echo '<li><a href="' . esc_url( $socialURL ) . '" title="' . __('Follow us on Tumblr', 'ayahairsalon') . '" class="tumblr16"></a>';
		}

		$socialURL = get_theme_mod('ayahairsalon_social_youtube');
		if ( !empty($socialURL) ) {

			echo '<li><a href="' . esc_url( $socialURL ) . '" title="' . __('Follow us on Youtube', 'ayahairsalon') . '" class="youtube16"></a>';
		}

		$socialURL = get_theme_mod('ayahairsalon_social_pinterest');
		if ( !empty($socialURL) ) {

			echo '<li><a href="' . esc_url( $socialURL ) . '" title="' . __('Follow us on Pinterest', 'ayahairsalon') . '" class="pinterest16"></a>';
		}

		$socialURL = get_theme_mod('ayahairsalon_social_vk');
		if ( !empty($socialURL) ) {

			echo '<li><a href="' . esc_url( $socialURL ) . '" title="' . __('Follow us on VK', 'ayahairsalon') . '" class="vk16"></a>';
		}

		$socialURL = get_theme_mod('ayahairsalon_social_flickr');
		if ( !empty($socialURL) ) {

			echo '<li><a href="' . esc_url( $socialURL ) . '" title="' . __('Follow us on Flickr', 'ayahairsalon') . '" class="flickr16"></a>';
		}

		$socialURL = get_theme_mod('ayahairsalon_social_vine');
		if ( !empty($socialURL) ) {

			echo '<li><a href="' . esc_url( $socialURL ) . '" title="' . __('Follow us on Vine', 'ayahairsalon') . '" class="vine16"></a>';
		}
	}
