...
if ( ! function_exists( 'agency_x_setup' ) ) :
	...
	function agency_x_setup() {
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'agency-x' ),
		) );
...
function agency_x_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'agency-x' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'agency-x' ),
...
function agency_x_scripts() {
	...
	wp_enqueue_style( 'ionicons-css', get_template_directory_uri() . '/css/ionicons.css' );
	wp_enqueue_style( 'speedster-pace-css', get_template_directory_uri() . '/css/pace.css' );
	wp_enqueue_style( 'speedster-custom-css', get_template_directory_uri() . '/css/custom.css' );
	

	wp_enqueue_script( 'bootstrap-js', get_template_directory_uri() . '/js/bootstrap.js', array('jquery'), '3.3.3', true );
	wp_enqueue_script( 'modernizer-js', get_template_directory_uri() . '/js/modernizr.custom.js', array('jquery'), '2.7.1', true );
	wp_enqueue_script( 'pace-js', get_template_directory_uri() . '/js/pace.js', array('jquery'), '0.5.6', true );
