...
function adamsrazor_setup() {
	...
	load_theme_textdomain( 'theme-adamsrazor', TEMPLATEPATH . '/languages' );
	...
	register_nav_menus( array(
		'primary' => __( 'Primary Navigation', 'theme-adamsrazor' ),
	) );			
...
function adamsrazor_continue_reading_link() {
	return ' <a href="'. get_permalink() . '">' . __( 'Continue reading <span class="meta-nav">&raquo;</span>', 'theme-adamsrazor' ) . '</a>';
}
...
function adamsrazor_post_meta_date() {
	printf( __( '<span class="%1$s">Published on</span> %2$s <span class="meta-sep">by</span> %3$s', 'theme-adamsrazor' ),
...
function adamsrazor_posted_in() {
	...
	if ( $tag_list ) {
		$posted_in = __( 'This entry was posted in %1$s and tagged %2$s. Bookmark this <a href="%3$s" title="Permalink to %4$s" rel="bookmark">page</a>.', 'theme-adamsrazor' );
	} elseif ( is_object_in_taxonomy( get_post_type(), 'category' ) ) {
		$posted_in = __( 'This entry was posted in %1$s. Bookmark this <a href="%3$s" title="Permalink to %4$s" rel="bookmark">page</a>.', 'theme-adamsrazor' );
	} else {
		$posted_in = __( 'Bookmark this <a href="%3$s" title="Permalink to %4$s" rel="bookmark">page</a>.', 'theme-adamsrazor' );
	}
...
$html=preg_replace('/(\<img[^>]+)(height\=\"[^\"]+\")([^>]+)(>)/', '${1}${3}${4}', $html );
$html=preg_replace('/(\<img[^>]+)(width\=\"[^\"]+\")([^>]+)(>)/', '${1}${3}${4}', $html );
return $html;
}
...
function adamsrazor_comment( $comment, $args, $depth ) {
	...
	<li <?php comment_class(); ?> id="li-comment-<?php comment_ID(); ?>">
		...
		<div class="comment-author vcard">
			...
			<?php printf( __( '%s <span class="says">says:</span>', 'theme-adamsrazor' ), sprintf( '<cite class="fn">%s</cite>', get_comment_author_link() ) ); ?>
		</div>
		<?php if ( $comment->comment_approved == '0' ) : ?>
			<em class="comment-awaiting-moderation"><?php _e( 'Your comment is awaiting moderation.', 'theme-adamsrazor' ); ?></em>
			<br />
		<?php endif; ?>
		...
		<div class="comment-meta commentmetadata"><a href="<?php echo esc_url( get_comment_link( $comment->comment_ID ) ); ?>">
			<?php
				...
				printf( __( '%1$s at %2$s', 'theme-adamsrazor' ), get_comment_date(),  get_comment_time() ); ?></a><?php edit_comment_link( __( '(Edit)', 'theme-adamsrazor' ), ' ' );
			?>
		</div>
	...
	<li class="post pingback">
		<p><?php _e( 'Pingback:', 'theme-adamsrazor' ); ?> <?php comment_author_link(); ?><?php edit_comment_link( __( '(Edit)', 'theme-adamsrazor' ), ' ' ); ?></p>
	<?php
			break;
	endswitch;
}
