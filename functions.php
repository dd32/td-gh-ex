...
function barletta_scripts() {
  ...
  wp_enqueue_style( 'barletta-bootstrap', get_template_directory_uri() . '/css/bootstrap.min.css' );
  ...
  // Add JS Files
  wp_enqueue_script( 'barletta-bootstrapjs', get_template_directory_uri().'/js/bootstrap.min.js', array('jquery') );
