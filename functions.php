...
if ( function_exists('register_sidebar') ) 
{
  register_sidebar(array(
	  'name'=>'sidebar-left',
	  'before_widget' => '<div id="%1$s" class="menu opacity widget">', // %2$s
    'after_widget' => '</div>', 
    'before_title' => '<h3><span class="unibullet">&raquo;</span> ',
    'after_title' => '</h3>'
  ));

	register_sidebar(array(
	  'name'=>'sidebar-right',
	  'before_widget' => '<div id="%1$s" class="menu opacity widget">',
    'after_widget' => '</div>', 
    'before_title' => '<h3><span class="unibullet">&raquo;</span> ',
    'after_title' => '</h3>'
	));
  ...
  register_sidebar(array(
	  'name' => 'sidebar-double',
	  'before_widget' => '<div id="doubleColInset  widget %1$s">',
    'after_widget' => '</div>', 
    'before_title' => '<h3><span class="unibullet">&raquo;</span> ',
    'after_title' => '</h3>'
  ));
	...
	register_sidebar(array(
  	...
  	'before_widget' => '<div id="footerCol-1" class="grid_3 widget %1$s">',
    'after_widget' => '</div>', 
    'before_title' => '<h4><span class="unibullet">&raquo;</span> ',
    'after_title' => '</h4>'
));

	register_sidebar(array(
  	'name' => 'footer-column-2',
  	'before_widget' => '<div id="footerCol-2" class="grid_3 widget %1$s">',
    'after_widget' => '</div>', 
    'before_title' => '<h4><span class="unibullet">&raquo;</span> ',
    'after_title' => '</h4>'
));
	...
	register_sidebar(array(
  	...
  	'before_widget' => '<div id="footerCol-3" class="grid_5 widget %1$s">',
    'after_widget' => '</div>', 
    'before_title' => '<h4><span class="unibullet">&raquo;</span> ',
    'after_title' => '</h4>'
));
	...
	register_sidebar(array(
  	...
  	'before_widget' => '<div id="footerCol-4" class="grid_5 widget %1$s">',
    'after_widget' => '</div>', 
    'before_title' => '<h4><span class="unibullet">&raquo;</span> ',
    'after_title' => '</h4>'
));
...
I would recommend to use the following way of placing the function in your template:
	<?php if (function_exists('simple_recent_comments')) { simple_recent_comments(); } ?>
