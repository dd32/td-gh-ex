...
function keratin_setup() {
	...
	// Theme Image Sizes
	add_image_size( 'keratin-featured-image', 500, 800 );
	add_image_size( 'keratin-featured-image-single', 900, 0 );

	// This theme uses wp_nav_menu() in one locations.
	register_nav_menus( array (
		'header-menu' => esc_html__( 'Header Menu', 'keratin' ),
	) );

	// This theme styles the visual editor to resemble the theme style.
	add_editor_style( array ( 'css/editor-style.css', keratin_fonts_url() ) );
...
function keratin_content_width() {
	...
	$GLOBALS['content_width'] = apply_filters( 'keratin_content_width', 774 );
}
