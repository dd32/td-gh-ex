...
'page_title'                      => __( 'Install Recommended Plugins', 'tgmpa' ),
            ...
            'notice_can_install_recommended'  => _n_noop( '<h2>This theme recommends the following plugin: %1$s.</h2>', 'This theme recommends the following plugins: %1$s.' ), // %1$s = plugin name(s).
