...
add_action('avedontheme_custom_scripts', 'avedontheme_custom_scripts');
...
jQuery(document).ready(function() {
	...
	jQuery('#social_icons').click(function() {
  		jQuery('#section-twitter_uid').fadeToggle(400);
  		jQuery('#section-googleplus_uid').fadeToggle(400);
  		jQuery('#section-facebook_uid').fadeToggle(400);
  		jQuery('#section-stumble_uid').fadeToggle(400);
  		jQuery('#section-pinterest_uid').fadeToggle(400);
  		jQuery('#section-flickr_uid').fadeToggle(400);
  		jQuery('#section-instagram_uid').fadeToggle(400);
  		jQuery('#section-foursquare_uid').fadeToggle(400);
  		jQuery('#section-youtube_uid').fadeToggle(400);
  		jQuery('#section-vimeo_uid').fadeToggle(400);
  		jQuery('#section-linkedin_uid').fadeToggle(400);
  		jQuery('#section-dribbble_uid').fadeToggle(400);
  		jQuery('#section-forrst_uid').fadeToggle(400);
  		jQuery('#section-wordpress_uid').fadeToggle(400);
  		jQuery('#section-soundcloud_uid').fadeToggle(400);
  		jQuery('#section-lastfm_uid').fadeToggle(400);
  		jQuery('#section-rss_uid').fadeToggle(400);
  		jQuery('#section-sociallink_color').fadeToggle(400);
  		jQuery('#section-sociallinkhover_color').fadeToggle(400);
	});

	if (jQuery('#social_icons:checked').val() !== undefined) {
		jQuery('#section-twitter_uid').show();
		jQuery('#section-googleplus_uid').show();
		jQuery('#section-facebook_uid').show();
		jQuery('#section-stumble_uid').show();
		jQuery('#section-pinterest_uid').show();
		jQuery('#section-flickr_uid').show();
		jQuery('#section-instagram_uid').show();
		jQuery('#section-foursquare_uid').show();
		jQuery('#section-youtube_uid').show();
		jQuery('#section-vimeo_uid').show();
		jQuery('#section-linkedin_uid').show();
		jQuery('#section-dribbble_uid').show();
		jQuery('#section-forrst_uid').show();
		jQuery('#section-wordpress_uid').show();
		jQuery('#section-soundcloud_uid').show();
		jQuery('#section-lastfm_uid').show();
		jQuery('#section-rss_uid').show();
		jQuery('#section-sociallink_color').show();
		jQuery('#section-sociallinkhover_color').show();
	}


	jQuery('#show_supersize').click(function() {
  		jQuery('#section-example_uploadnumber').fadeToggle(400);
  		jQuery('#section-super_effects').fadeToggle(400);
  		jQuery('#section-super_translideint').fadeToggle(400);
  		jQuery('#section-super_transpeed').fadeToggle(400);
  		jQuery('#section-super_mode').fadeToggle(400);
  		jQuery('#section-super_array').fadeToggle(400);
	});

	if (jQuery('#show_supersize:checked').val() !== undefined) {
		jQuery('#section-example_uploadnumber').show();
		jQuery('#section-super_effects').show();
		jQuery('#section-super_translideint').show();
		jQuery('#section-super_transpeed').show();
		jQuery('#section-super_mode').show();
		jQuery('#section-super_array').show();
	}

	jQuery('#radio_images').click(function() {
  		jQuery('#section-radio_image_one').fadeToggle(400);
  		jQuery('#section-radio_image_one_credit').fadeToggle(400);
	});

	if (jQuery('#avedontheme_avedon-radio_images-one:checked').val() !== undefined) {
		jQuery('#section-radio_image_one').show();
		jQuery('#section-radio_image_one_credit').show();
	}

	if (jQuery('#avedontheme_avedon-radio_images-two:checked').val() !== undefined) {
		jQuery('#section-radio_image_one').show();
		jQuery('#section-radio_image_one_credit').show();
		jQuery('#section-radio_image_two').show();
		jQuery('#section-radio_image_two_credit').show();
	}

	if (jQuery('#avedontheme_avedon-radio_images-three:checked').val() !== undefined) {
		jQuery('#section-radio_image_one').show();
		jQuery('#section-radio_image_one_credit').show();
		jQuery('#section-radio_image_two').show();
		jQuery('#section-radio_image_two_credit').show();
		jQuery('#section-radio_image_three').show();
		jQuery('#section-radio_image_three_credit').show();
	}

	if (jQuery('#avedontheme_avedon-radio_images-four:checked').val() !== undefined) {
		jQuery('#section-radio_image_one').show();
		jQuery('#section-radio_image_one_credit').show();
		jQuery('#section-radio_image_two').show();
		jQuery('#section-radio_image_two_credit').show();
		jQuery('#section-radio_image_three').show();
		jQuery('#section-radio_image_three_credit').show();
		jQuery('#section-radio_image_four').show();
		jQuery('#section-radio_image_four_credit').show();
	}

	if (jQuery('#avedontheme_avedon-radio_images-five:checked').val() !== undefined) {
		jQuery('#section-radio_image_one').show();
		jQuery('#section-radio_image_one_credit').show();
		jQuery('#section-radio_image_two').show();
		jQuery('#section-radio_image_two_credit').show();
		...
		jQuery('#section-radio_image_four').show();
		jQuery('#section-radio_image_four_credit').show();
		jQuery('#section-radio_image_five').show();
		jQuery('#section-radio_image_five_credit').show();
	}

	if (jQuery('#avedontheme_avedon-radio_images-six:checked').val() !== undefined) {
		jQuery('#section-radio_image_one').show();
		jQuery('#section-radio_image_one_credit').show();
		jQuery('#section-radio_image_two').show();
		jQuery('#section-radio_image_two_credit').show();
		...
		jQuery('#section-radio_image_five').show();
		jQuery('#section-radio_image_five_credit').show();
		jQuery('#section-radio_image_six').show();
		jQuery('#section-radio_image_six_credit').show();
	}
