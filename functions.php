...
function beshop_content_width() {
	...
	$GLOBALS['content_width'] = apply_filters( 'beshop_content_width', 1170 );
}
...
function beshop_widgets_init() {
	...
	register_sidebar(
		array(
			'name'          => esc_html__( 'Footer Widget', 'beshop' ),
			'id'            => 'footer-widget',
			'description'   => esc_html__( 'Add Footer widgets here.', 'beshop' ),
...
function beshop_gb_block_style() {

   wp_enqueue_style( 'beshop-gb-block', get_theme_file_uri( '/assets/css/admin-block.css' ), false, '1.0', 'all' );
