...
// Add class to post nav 
	...
	add_filter('next_posts_link_attributes', 'leftside_post_next'); 

	function leftside_post_prev() { 
		return 'class="nav-prev"'; 
	}
	add_filter('previous_posts_link_attributes', 'leftside_post_prev'); 
...
// Add class to comment nav 
	...
	add_filter('next_comments_link_attributes', 'leftside_comment_next'); 

	function leftside_comment_prev() { 
		return 'class="comment-prev"'; 
	}
	add_filter('previous_comments_link_attributes', 'leftside_comment_prev'); 
