...
if (!function_exists('best_education_setup')) :
    ...
    function best_education_setup()
    {
        ...
        add_image_size('best-education-1140-600', 1140, 600, true);
        add_image_size('best-education-400-260', 400, 260, true);
        add_image_size('best-education-900-600', 900, 600, true);
        ...
        register_nav_menus(array(
            'primary' => esc_html__('Primary', 'best-education'),
...
if (!function_exists('best_education_fonts_url')) :
    ...
    function best_education_fonts_url()
    {
        ...
        if ('off' !== _x('on', 'Open Sans font: on or off', 'best-education')) {
