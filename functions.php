...
function anarcho_widgets_init() {
	register_sidebar(array(
			...
			'id' => 'sidebar-1',
			'description' => __( 'Widgets in this area will be shown below "Pages".' ),
	...
	register_sidebar(array(
			'name' => __( 'Sidebar Area 2' ),
			'id' => 'sidebar-2',
			'description' => __( 'Widgets in this area will be shown below "What is this place".' ),
			'before_widget' => '<aside id="%1$s" class="widget %2$s">',
			'after_widget' => '</aside>',
			'before_title' => '<h3 class="widget-title">',
			'after_title' => '</h3>',
	...
	register_sidebar(array(
			'name' => __( 'Sidebar Area 3' ),
			'id' => 'sidebar-3',
			'description' => __( 'Widgets in this area will be shown below "Frends & Links".' ),
			'before_widget' => '<aside id="%1$s" class="widget %2$s">',
			'after_widget' => '</aside>',
			'before_title' => '<h3 class="widget-title">',
			'after_title' => '</h3>',
	...
	register_sidebar(array(
			'name' => __( 'Sidebar Area 4' ),
			'id' => 'sidebar-4',
			'description' => __( 'Widgets in this area will be shown below "Recent Posts".' ),
			'before_widget' => '<aside id="%1$s" class="widget %2$s">',
			'after_widget' => '</aside>',
			'before_title' => '<h3 class="widget-title">',
			'after_title' => '</h3>',
