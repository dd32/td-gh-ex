...
function accesspress_parallax_scripts() {
	$query_args = array(
		'family' => 'Roboto+Slab:400,300,100,700|Oxygen:400,300,700',
	);
	...
	wp_enqueue_style( 'accesspress_nivo-lightbox', get_template_directory_uri() . '/css/nivo-lightbox.css' );
	...
	wp_enqueue_script( 'accesspress_parallax-ScrollTo', get_template_directory_uri() . '/js/jquery.scrollTo.js', array(), '1.4.3', true );
	wp_enqueue_script( 'accesspress_parallax-local-scroll', get_template_directory_uri() . '/js/jquery.localScroll.min.js', array(), '1.3.5', true );
	wp_enqueue_script( 'accesspress_parallax-parallax-nav', get_template_directory_uri() . '/js/jquery.nav.js', array(), '2.2.0', true );
	wp_enqueue_script( 'accesspress_parallax-bx_slider', get_template_directory_uri() . '/js/jquery.bxslider.min.js', array(), '4.2.1', true );
	wp_enqueue_script( 'accesspress_parallax-easing', get_template_directory_uri() . '/js/jquery.easing.min.js', array(), '1.3', true );
	wp_enqueue_script( 'accesspress_parallax-fit-vid', get_template_directory_uri() . '/js/jquery.fitvids.js', array(), '1.0', true );
	wp_enqueue_script( 'accesspress_parallax-actual', get_template_directory_uri() . '/js/jquery.actual.min.js', array(), '1.0.16', true );
	wp_enqueue_script( 'accesspress_nivo-lightbox', get_template_directory_uri() . '/js/nivo-lightbox.min.js', array(), '1', true );
	...
	wp_enqueue_script( 'accesspress_parallax-custom', get_template_directory_uri() . '/js/custom.js', array(), '1.0', true );
