...
function alanding_lite_widgets() {
	...
	array(
		'id' => 'sidebar-header',
		'name' => __( 'sidebar-header', 'alanding_lite' ),
	)		
	);
	register_sidebar(		
	array(
		'id' => 'sidebar-block1-user1',
		'name' => __( 'sidebar-block1-user1', 'alanding_lite' ),
	)		
	);
	register_sidebar(		
	array(
		'id' => 'sidebar-block1-user2',
		'name' => __( 'sidebar-block1-user2', 'alanding_lite' ),
	)		
	);
	register_sidebar(		
	array(
		'id' => 'sidebar-block1-user3',
		'name' => __( 'sidebar-block1-user3', 'alanding_lite' ),
	)		
	);
	register_sidebar(		
	array(
		'id' => 'sidebar-block2-user1',
		'name' => __( 'sidebar-block2-user1', 'alanding_lite' ),
	)		
	);
	register_sidebar(		
	array(
		'id' => 'sidebar-block2-user2',
		'name' => __( 'sidebar-block2-user2', 'alanding_lite' ),
	)		
	);
	register_sidebar(		
	array(
		'id' => 'sidebar-block2-user3',
		'name' => __( 'sidebar-block2-user3', 'alanding_lite' ),
	)		
	);
	register_sidebar(		
	array(
		'id' => 'sidebar-block3-user1',
		'name' => __( 'sidebar-block3-user1', 'alanding_lite' ),
	)		
	);
	register_sidebar(		
	array(
		'id' => 'sidebar-block3-user2',
		'name' => __( 'sidebar-block3-user2', 'alanding_lite' ),
	)		
	);
	register_sidebar(		
	array(
		'id' => 'sidebar-block3-user3',
		'name' => __( 'sidebar-block3-user3', 'alanding_lite' ),
	)		
	);
	register_sidebar(		
	array(
		'id' => 'sidebar-block4-user1',
		'name' => __( 'sidebar-block4-user1', 'alanding_lite' ),
	)		
	);
	register_sidebar(		
	array(
		'id' => 'sidebar-block4-user2',
		'name' => __( 'sidebar-block4-user2', 'alanding_lite' ),
	)		
	);
	register_sidebar(		
	array(
		'id' => 'sidebar-block4-user3',
		'name' => __( 'sidebar-block4-user3', 'alanding_lite' ),
	)		
	);
	register_sidebar(		
	array(
		'id' => 'sidebar-block5-user1',
		'name' => __( 'sidebar-block5-user1', 'alanding_lite' ),
	)		
	);
	register_sidebar(		
	array(
		'id' => 'sidebar-block5-user2',
		'name' => __( 'sidebar-block5-user2', 'alanding_lite' ),
	)		
	);
	register_sidebar(		
	array(
		'id' => 'sidebar-block5-user3',
		'name' => __( 'sidebar-block5-user3', 'alanding_lite' ),
	)		
	);
	register_sidebar(		
	array(
		'id' => 'sidebar-block6-user1',
		'name' => __( 'sidebar-block6-user1', 'alanding_lite' ),
	)	);
	register_sidebar(		
	array(
		'id' => 'sidebar-block6-user2',
		'name' => __( 'sidebar-block6-user2', 'alanding_lite' ),
	)		);
	register_sidebar(		
	array(
		'id' => 'sidebar-block6-user3',
		'name' => __( 'sidebar-block6-user3', 'alanding_lite' ),
	)	);
	register_sidebar(		
	array(
		'id' => 'sidebar-block6-user4',
		'name' => __( 'sidebar-block6-user4', 'alanding_lite' ),
	)				
	);
}
...
function alanding_lite_wp_title( $title, $sep ) {
	...
	if ( $paged >= 2 || $page >= 2 )
		$title = "$title $sep " . sprintf( __( 'Page %s', 'alanding_lite' ), max( $paged, $page ) );
	return $title;
}
add_filter( 'wp_title', 'alanding_lite_wp_title', 10, 2 );
function alanding_lite_menu() {
	add_theme_page('ALanding Setup', 'Theme Options', 'edit_theme_options', 'alanding_lite', 'alanding_lite_menu_page');
}
