...
function arzine_theme_css()
{
    ...
    wp_enqueue_style('arzine-default-style-css', get_stylesheet_directory_uri()."/css/default.css");
    wp_dequeue_style('arzine-default-css', get_template_directory_uri() .'/css/default.css');
    wp_enqueue_style('arzine-custom-style-css', get_stylesheet_directory_uri()."/css/custom.css");
    wp_dequeue_style('arzine-custom-css', get_template_directory_uri() .'/css/custom.css');
	...
	jQuery("#blog-masonry").mpmansory(
		{
			...
			breakpoints:{
				lg: <?php echo intval($col); ?>, //Change masonry column here like 2, 3, 4 column
				md: 6,
				sm: 6,
				xs: 12
			},
...
add_action('after_switch_theme', 'arzine_import_busiprof_theme_data_in_busiprof_child_theme');
/**
* Import theme mods when switching from Busiprof child theme to Busiprof
*/
function arzine_import_busiprof_theme_data_in_busiprof_child_theme()
{
