...
function advance_ecommerce_store_scripts() {
	...
	wp_enqueue_script('advance-ecommerce-store-customscripts-jquery', esc_url(get_template_directory_uri()).'/js/custom.js', array('jquery'));
	...
	wp_enqueue_style('advance-ecommerce-store-ie', esc_url(get_template_directory_uri()).'/css/ie.css', array('advance-ecommerce-store-basic-style'));
...
if (!function_exists('advance_ecommerce_store_loop_columns')) {
	function advance_ecommerce_store_loop_columns() {
		$columns = get_theme_mod( 'advance_ecommerce_store_wooproducts_per_columns', 3 );
