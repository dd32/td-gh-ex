...
<?php endif;
  ...
  function spa_enqueue_script() {
  	...
  	wp_enqueue_style('spa_font', get_template_directory_uri().'/css/font/font.css'); //enqueue color css
  	wp_enqueue_style('spa_color',get_template_directory_uri().'/css/skins/default.css');
