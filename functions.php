...
@media all and (min-width:769px){#menu .current-menu-item a, #menu .current_page_parent a{border-color:<?php echo esc_html( get_theme_mod( 'bands_accent_color' ) ); ?>}}
a{color:<?php echo esc_html( get_theme_mod( 'bands_link_color' ) ); ?>}
h1, h2, h3, h4, h5, h6, h1 a, h2 a, h3 a, h4 a, h5 a, h6 a{font-family:"<?php echo esc_html( str_replace( '+', ' ', get_theme_mod( 'bands_header_font' ) ) ); ?>";color:<?php echo esc_html( get_theme_mod( 'bands_header_color' ) ); ?>}
</style>
<?php
}
