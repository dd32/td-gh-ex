...
add_action( 'tgmpa_register', 'adaptable_notes_register_required_plugins' );
 ...
 */
function adaptable_notes_register_required_plugins() {
    /*
    ...
    $config = array(
        'id'           => 'adaptable-notes',                 // Unique ID for hashing notices for multiple instances of TGMPA.
