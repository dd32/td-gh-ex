...
function aesblo_enqueue_scripts() {
	// Google fonts
	wp_enqueue_style( 'aseblo-Alegreya-Sans', 'http://fonts.googleapis.com/css?family=Alegreya+Sans:400,400italic,700' );
	
	// Font awesome
	wp_enqueue_style( 'aesblo-fontawesome', get_template_directory_uri() . '/assets/font-awesome/css/font-awesome.min.css' );
	
	// Enclude style.css file.
...
class aesblo_walker_primary_nav_menu extends Walker_Nav_Menu {
	...
	public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		if ( in_array( 'menu-item-has-children', (array) $item->classes ) ) {
			$item_output .= '<button type="button" class="submenu-switch" data-expand_icon="fa-angle-up" data-close_icon="fa-angle-down"><span class="fa fa-angle-down"></span></button>';
		}		
