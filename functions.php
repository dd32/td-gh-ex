...
function advance_startup_setup() {
	$GLOBALS['content_width'] = apply_filters('advance_startup_content_width', 640);
 	...
 	load_theme_textdomain( 'advance-startup', get_template_directory() . '/languages' );
...
if (!function_exists('advance_startup_loop_columns')) {
	function advance_startup_loop_columns() {
		$columns = get_theme_mod( 'advance_startup_wooproducts_per_columns', 3 );
		return $columns; // 3 products per row
	}
}

//Change number of products that are displayed per page (shop page)
add_filter( 'loop_shop_per_page', 'advance_startup_shop_per_page', 20 );
function advance_startup_shop_per_page( $cols ) {
  	$cols = get_theme_mod( 'advance_startup_wooproducts_per_page', 9 );
	return $cols;
}
...
function advance_startup_scripts() {
	...
	// blocks-css
	wp_enqueue_style( 'advance-startup-block-style', get_theme_file_uri('/css/blocks.css') );
	...
	wp_enqueue_style('advance-startup-customcss', esc_url(get_template_directory_uri()).'/css/custom.css');
	wp_enqueue_style('font-awesome', esc_url(get_template_directory_uri()).'/css/fontawesome-all.css');
	// Paragraph
	    $advance_startup_paragraph_color = get_theme_mod('advance_startup_paragraph_color', '');
	    $advance_startup_paragraph_font_family = get_theme_mod('advance_startup_paragraph_font_family', '');
	    $advance_startup_paragraph_font_size = get_theme_mod('advance_startup_paragraph_font_size', '');
	// "a" tag
		$advance_startup_atag_color = get_theme_mod('advance_startup_atag_color', '');
	    $advance_startup_atag_font_family = get_theme_mod('advance_startup_atag_font_family', '');
	// "li" tag
		$advance_startup_li_color = get_theme_mod('advance_startup_li_color', '');
	    $advance_startup_li_font_family = get_theme_mod('advance_startup_li_font_family', '');
	// H1
		$advance_startup_h1_color = get_theme_mod('advance_startup_h1_color', '');
	    $advance_startup_h1_font_family = get_theme_mod('advance_startup_h1_font_family', '');
	    $advance_startup_h1_font_size = get_theme_mod('advance_startup_h1_font_size', '');
	// H2
		$advance_startup_h2_color = get_theme_mod('advance_startup_h2_color', '');
	    $advance_startup_h2_font_family = get_theme_mod('advance_startup_h2_font_family', '');
	    $advance_startup_h2_font_size = get_theme_mod('advance_startup_h2_font_size', '');
	// H3
		$advance_startup_h3_color = get_theme_mod('advance_startup_h3_color', '');
	    $advance_startup_h3_font_family = get_theme_mod('advance_startup_h3_font_family', '');
	    $advance_startup_h3_font_size = get_theme_mod('advance_startup_h3_font_size', '');
	// H4
		$advance_startup_h4_color = get_theme_mod('advance_startup_h4_color', '');
	    $advance_startup_h4_font_family = get_theme_mod('advance_startup_h4_font_family', '');
	    $advance_startup_h4_font_size = get_theme_mod('advance_startup_h4_font_size', '');
	// H5
		$advance_startup_h5_color = get_theme_mod('advance_startup_h5_color', '');
	    $advance_startup_h5_font_family = get_theme_mod('advance_startup_h5_font_family', '');
	    $advance_startup_h5_font_size = get_theme_mod('advance_startup_h5_font_size', '');
	// H6
		$advance_startup_h6_color = get_theme_mod('advance_startup_h6_color', '');
	    $advance_startup_h6_font_family = get_theme_mod('advance_startup_h6_font_family', '');
	    $advance_startup_h6_font_size = get_theme_mod('advance_startup_h6_font_size', '');

		$advance_startup_custom_css ='
			p,span{
			    color:'.esc_html($advance_startup_paragraph_color).'!important;
			    font-family: '.esc_html($advance_startup_paragraph_font_family).';
			    font-size: '.esc_html($advance_startup_paragraph_font_size).';
			}
			a{
			    color:'.esc_html($advance_startup_atag_color).'!important;
			    font-family: '.esc_html($advance_startup_atag_font_family).';
			}
			li{
			    color:'.esc_html($advance_startup_li_color).'!important;
			    font-family: '.esc_html($advance_startup_li_font_family).';
			}
			h1{
			    color:'.esc_html($advance_startup_h1_color).'!important;
			    font-family: '.esc_html($advance_startup_h1_font_family).'!important;
			    font-size: '.esc_html($advance_startup_h1_font_size).'!important;
			}
			h2{
			    color:'.esc_html($advance_startup_h2_color).'!important;
			    font-family: '.esc_html($advance_startup_h2_font_family).'!important;
			    font-size: '.esc_html($advance_startup_h2_font_size).'!important;
			}
			h3{
			    color:'.esc_html($advance_startup_h3_color).'!important;
			    font-family: '.esc_html($advance_startup_h3_font_family).'!important;
			    font-size: '.esc_html($advance_startup_h3_font_size).'!important;
			}
			h4{
			    color:'.esc_html($advance_startup_h4_color).'!important;
			    font-family: '.esc_html($advance_startup_h4_font_family).'!important;
			    font-size: '.esc_html($advance_startup_h4_font_size).'!important;
			}
			h5{
			    color:'.esc_html($advance_startup_h5_color).'!important;
			    font-family: '.esc_html($advance_startup_h5_font_family).'!important;
			    font-size: '.esc_html($advance_startup_h5_font_size).'!important;
			}
			h6{
			    color:'.esc_html($advance_startup_h6_color).'!important;
			    font-family: '.esc_html($advance_startup_h6_font_family).'!important;
			    font-size: '.esc_html($advance_startup_h6_font_size).'!important;
			}
	...
	wp_enqueue_script('advance-startup-customscripts-jquery', esc_url(get_template_directory_uri()).'/js/custom.js', array('jquery'));
	...
	wp_enqueue_style('advance-startup-ie', esc_url(get_template_directory_uri()).'/css/ie.css', array('advance-startup-basic-style'));
