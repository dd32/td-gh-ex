...
if ( ! function_exists( 'bhaga_setup' ) ) {
	 ...
	 *
	 */
	function bhaga_setup() {
		// Make theme available for translation.
		load_theme_textdomain( 'bhaga' );
		...
		register_nav_menus( array(
			'primary' => __( 'Primary Menu', 'bhaga' ),
		) );

		/**
		 * Set the content width to something large
		 * We set a more accurate width in bhaga_smart_content_width()
		 */
