                       ...
                       <div id="comment-<?php comment_ID(); ?>" class="comment col-md-12 a1-blog-comment no-padding">
                           ...
                           <div class="comment-message-section">
                               <div class="comm-title">
								   ...
								   echo '<a href="#">' . comment_reply_link(array_merge($a1_args, array('reply_text' => '<div class="pull-right color-red">'.__('Reply', 'a1').'</div>', 'after' => '', 'depth' => $depth, 'max_depth' => $a1_args['max_depth']))) . '</a>';
                                   ?>
