<?php
/**
 * TwentyTen base functions and definitions
 *
 * @package WordPress
...
function atmosphere_setup() {
	...
	register_nav_menus( array(
		'primary' => __( 'Below Header', 'twentyten' ),
		'secondary' => __( 'Above Header', 'twentyten' ),
	) );
	...
	define( 'HEADER_TEXTCOLOR', 'F1F1F1' );
	define( 'HEADER_IMAGE', '%s/images/header.jpg' );
	define( 'HEADER_IMAGE_WIDTH', apply_filters( 'twentyten_header_image_width', 724 ) );
	define( 'HEADER_IMAGE_HEIGHT', apply_filters( 'twentyten_header_image_height', 314 ) );
...
/* Start Section is for the Digital Raindrops Specific Changes */

/* Start add theme Category Defaults */
...
/* End add theme Category Defaults */

/* Start insert our Two new Theme Categories */
cms_insert_category('category','gallery');
cms_insert_category('category','asides');
/* End insert our Two new Theme Categories */

/* List all Images in a folder for social icons */
...
/* End Section is for the Digital Raindrops Specific Changes */
...
function twentyten_continue_reading_link() {
	return ' <a href="'. get_permalink() . '">' . __( 'Read the rest of this entry <span class="meta-nav">&rarr;</span>', 'twentyten' ) . '</a>';
}
...
function twentyten_posted_on() {
	printf( __( '<span class="%1$s"></span> %2$s <span class="meta-sep"> | Posted by</span> %3$s', 'twentyten' ),
