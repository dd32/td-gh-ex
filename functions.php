...
function theme_2013bluesequence_custom_header_setup() { 
...
add_action( 'after_setup_theme', 'theme_2013bluesequence_custom_header_setup' );
...
function theme_2013bluesequence_styles() {
...
add_action( 'wp_enqueue_scripts', 'theme_2013bluesequence_styles' );
