...
require_once locate_template('/lib/template_include.php'); // Template Include functions
require_once locate_template('/lib/init.php'); // Initial theme setup and constants
require_once locate_template('/lib/scripts.php'); //  setup style and script
require_once locate_template('/lib/sidebar.php'); //  setup sidebar
require_once locate_template('/lib/widgets.php'); //  setup sidebar
require_once locate_template('/lib/custom.php'); //  setup custom function
require_once locate_template('/lib/aq_resizer.php'); //  setup resize function
require_once locate_template('/lib/comments.php');
require_once locate_template('/lib/theme-options.php');
require_once locate_template('/lib/yds-breadcrumbs.php');
