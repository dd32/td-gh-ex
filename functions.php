...
function bb_wedding_bliss_scripts() {
	...
	// blocks-css
	wp_enqueue_style( 'bb-wedding-bliss-block-style', get_theme_file_uri('/css/blocks.css') );
	...
	wp_enqueue_style( 'bb-wedding-bliss-effect', esc_url(get_template_directory_uri()).'/css/effect.css' );
	...
	wp_enqueue_script( 'bb-wedding-bliss-customscripts', esc_url(get_template_directory_uri()) . '/js/custom.js', array('jquery') );
	...
	wp_enqueue_style('bb-wedding-bliss-ie', esc_url(get_template_directory_uri()).'/css/ie.css', array('bb-wedding-bliss-basic-style'));
...
function bb_wedding_bliss_sanitize_checkbox( $input ) {
	return ( ( isset( $input ) && true == $input ) ? true : false );
}

function bb_wedding_bliss_sanitize_float( $input ) {
	return filter_var($input, FILTER_SANITIZE_NUMBER_FLOAT, FILTER_FLAG_ALLOW_FRACTION);
}

function bb_wedding_bliss_sanitize_number_range( $number, $setting ) {
