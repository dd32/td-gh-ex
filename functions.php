...
define( 'KAIRA_THEME_ENDPOINT' , 'http://kairaweb.com/themes/' );
...
function alba_setup_theme() {
	 ...
	 * to change 'alba' to the name of your theme in all the template files
	 */
	...
	register_nav_menus( array(
		'main-menu' => __( 'Main Menu', 'alba' ),
        'header-bar-menu' => __( 'Header Bar Menu (Header Layout Two)', 'alba' )
	) );
	...
	add_theme_support('custom-header', array(
        'default-image' => get_template_directory_uri() . '/images/alba_logo.png',
		'width'         => 300,
		'height'        => 110,
		'flex-width' => true,
		'flex-height' => true,
...
function alba_print_styles(){
    ...
    $body_font = $cx_framework_options['cx-options-styling-font-body']['font-family'];
    $body_font_color = $cx_framework_options['cx-options-styling-font-body']['color'];
    $h_font = $cx_framework_options['cx-options-styling-font-head']['font-family'];
    $h_font_color = $cx_framework_options['cx-options-styling-font-head']['color'];
...
function alba_scripts() {
	...
	wp_enqueue_style( 'alba-style', get_stylesheet_uri() );

	wp_enqueue_script( 'alba-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '1.0', true );
	wp_enqueue_script( 'alba-caroufredSel', get_template_directory_uri() . '/js/jquery.carouFredSel-6.2.1-packed.js', array('jquery'), '1.0', true );
    wp_enqueue_script( 'alba-waypoints', get_template_directory_uri() . '/js/waypoints.min.js', array('jquery'), '1.0', true );
    
	wp_enqueue_script( 'alba-customjs', get_template_directory_uri() . '/js/custom.js', array('jquery'), '1.0', true );
    
	wp_enqueue_script( 'alba-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '1.0', true );
	...
	if ( is_singular() && wp_attachment_is_image() ) {
		wp_enqueue_script( 'kaira-keyboard-image-navigation', get_template_directory_uri() . '/js/keyboard-image-navigation.js', array('jquery'), '1.0' );
	}
}
