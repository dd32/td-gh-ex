...
function advance_fitness_gym_scripts() {
	...
	// Paragraph
	    $advance_fitness_gym_paragraph_color = get_theme_mod('advance_fitness_gym_paragraph_color', '');
	    $advance_fitness_gym_paragraph_font_family = get_theme_mod('advance_fitness_gym_paragraph_font_family', '');
	    $advance_fitness_gym_paragraph_font_size = get_theme_mod('advance_fitness_gym_paragraph_font_size', '');
	// "a" tag
		$advance_fitness_gym_atag_color = get_theme_mod('advance_fitness_gym_atag_color', '');
	    $advance_fitness_gym_atag_font_family = get_theme_mod('advance_fitness_gym_atag_font_family', '');
	// "li" tag
		$advance_fitness_gym_li_color = get_theme_mod('advance_fitness_gym_li_color', '');
	    $advance_fitness_gym_li_font_family = get_theme_mod('advance_fitness_gym_li_font_family', '');
	// H1
		$advance_fitness_gym_h1_color = get_theme_mod('advance_fitness_gym_h1_color', '');
	    $advance_fitness_gym_h1_font_family = get_theme_mod('advance_fitness_gym_h1_font_family', '');
	    $advance_fitness_gym_h1_font_size = get_theme_mod('advance_fitness_gym_h1_font_size', '');
	// H2
		$advance_fitness_gym_h2_color = get_theme_mod('advance_fitness_gym_h2_color', '');
	    $advance_fitness_gym_h2_font_family = get_theme_mod('advance_fitness_gym_h2_font_family', '');
	    $advance_fitness_gym_h2_font_size = get_theme_mod('advance_fitness_gym_h2_font_size', '');
	// H3
		$advance_fitness_gym_h3_color = get_theme_mod('advance_fitness_gym_h3_color', '');
	    $advance_fitness_gym_h3_font_family = get_theme_mod('advance_fitness_gym_h3_font_family', '');
	    $advance_fitness_gym_h3_font_size = get_theme_mod('advance_fitness_gym_h3_font_size', '');
	// H4
		$advance_fitness_gym_h4_color = get_theme_mod('advance_fitness_gym_h4_color', '');
	    $advance_fitness_gym_h4_font_family = get_theme_mod('advance_fitness_gym_h4_font_family', '');
	    $advance_fitness_gym_h4_font_size = get_theme_mod('advance_fitness_gym_h4_font_size', '');
	// H5
		$advance_fitness_gym_h5_color = get_theme_mod('advance_fitness_gym_h5_color', '');
	    $advance_fitness_gym_h5_font_family = get_theme_mod('advance_fitness_gym_h5_font_family', '');
	    $advance_fitness_gym_h5_font_size = get_theme_mod('advance_fitness_gym_h5_font_size', '');
	// H6
		$advance_fitness_gym_h6_color = get_theme_mod('advance_fitness_gym_h6_color', '');
	    $advance_fitness_gym_h6_font_family = get_theme_mod('advance_fitness_gym_h6_font_family', '');
	    $advance_fitness_gym_h6_font_size = get_theme_mod('advance_fitness_gym_h6_font_size', '');

		$advance_fitness_gym_custom_css ='
			p,span{
			    color:'.esc_html($advance_fitness_gym_paragraph_color).'!important;
			    font-family: '.esc_html($advance_fitness_gym_paragraph_font_family).';
			    font-size: '.esc_html($advance_fitness_gym_paragraph_font_size).';
			}
			a{
			    color:'.esc_html($advance_fitness_gym_atag_color).'!important;
			    font-family: '.esc_html($advance_fitness_gym_atag_font_family).';
			}
			li{
			    color:'.esc_html($advance_fitness_gym_li_color).'!important;
			    font-family: '.esc_html($advance_fitness_gym_li_font_family).';
			}
			h1{
			    color:'.esc_html($advance_fitness_gym_h1_color).'!important;
			    font-family: '.esc_html($advance_fitness_gym_h1_font_family).'!important;
			    font-size: '.esc_html($advance_fitness_gym_h1_font_size).'!important;
			}
			h2{
			    color:'.esc_html($advance_fitness_gym_h2_color).'!important;
			    font-family: '.esc_html($advance_fitness_gym_h2_font_family).'!important;
			    font-size: '.esc_html($advance_fitness_gym_h2_font_size).'!important;
			}
			h3{
			    color:'.esc_html($advance_fitness_gym_h3_color).'!important;
			    font-family: '.esc_html($advance_fitness_gym_h3_font_family).'!important;
			    font-size: '.esc_html($advance_fitness_gym_h3_font_size).'!important;
			}
			h4{
			    color:'.esc_html($advance_fitness_gym_h4_color).'!important;
			    font-family: '.esc_html($advance_fitness_gym_h4_font_family).'!important;
			    font-size: '.esc_html($advance_fitness_gym_h4_font_size).'!important;
			}
			h5{
			    color:'.esc_html($advance_fitness_gym_h5_color).'!important;
			    font-family: '.esc_html($advance_fitness_gym_h5_font_family).'!important;
			    font-size: '.esc_html($advance_fitness_gym_h5_font_size).'!important;
			}
			h6{
			    color:'.esc_html($advance_fitness_gym_h6_color).'!important;
			    font-family: '.esc_html($advance_fitness_gym_h6_font_family).'!important;
			    font-size: '.esc_html($advance_fitness_gym_h6_font_size).'!important;
			}

			';
		wp_add_inline_style( 'advance-fitness-gym-basic-style',$advance_fitness_gym_custom_css );

	wp_enqueue_script('SmoothScroll-jquery', esc_url(get_template_directory_uri()).'/js/SmoothScroll.js', array('jquery'));
	wp_enqueue_script('advance-fitness-gym-customscripts-jquery', esc_url(get_template_directory_uri()).'/js/custom.js', array('jquery'));
	...
	wp_enqueue_style('advance-fitness-gym-ie', esc_url(get_template_directory_uri()).'/css/ie.css', array('advance-fitness-gym-basic-style'));
...
function advance_fitness_gym_sanitize_phone_number( $phone ) {
	return preg_replace( '/[^\d+]/', '', $phone );
}

function advance_fitness_gym_sanitize_email( $email, $setting ) {
	$email = sanitize_email( $email );
	return ( ! is_null( $email ) ? $email : $setting->default );
}

function advance_fitness_gym_sanitize_checkbox( $input ) {
	return ( ( isset( $input ) && true == $input ) ? true : false );
}

function advance_fitness_gym_sanitize_float( $input ) {
	return filter_var($input, FILTER_SANITIZE_NUMBER_FLOAT, FILTER_FLAG_ALLOW_FRACTION);
}

function advance_fitness_gym_sanitize_number_range( $number, $setting ) {
...
if (!function_exists('advance_fitness_gym_credit')) {
	function advance_fitness_gym_credit() {
		echo "<a href=".esc_url(ADVANCE_FITNESS_GYM_CREDIT).">".esc_html__('Fitness WordPress Theme', 'advance-fitness-gym')."</a>";
	}
}
