<?php 
add_action( 'wp_enqueue_scripts', 'affiliate_newspaperly_enqueue_styles' );
function affiliate_newspaperly_enqueue_styles() {
	wp_enqueue_style( 'affiliate-newspaperly-style', get_template_directory_uri() . '/style.css' ); 
} 


function affiliate_newspaperly_customize_register( $wp_customize ) {
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'header_background_color', array(
		'label'       => __( 'Header Background Color', 'newspaperly' ),
		'section'     => 'header_image',
		'priority'   => 1,
		'settings'    => 'header_background_color',
		) ) );
$wp_customize->add_section( 'footer_settings', array(
		'title'      => __('Footer Settings','newspaperly'),
		'priority'   => 1,
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'footer_headline_color', array(
		'label'       => __( 'Headline Color', 'newspaperly' ),
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'footer_text_color', array(
		'label'       => __( 'Text Color', 'newspaperly' ),
		'section'     => 'footer_settings',
		'priority'   => 1,
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'footer_link_color', array(
		'label'       => __( 'Link Color', 'newspaperly' ),
		'section'     => 'footer_settings',
		'priority'   => 1,
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'footer_border_color', array(
		'label'       => __( 'Border Color', 'newspaperly' ),
		'section'     => 'footer_settings',
		'priority'   => 1,
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'footer_background_color', array(
		'label'       => __( 'Background Color', 'newspaperly' ),
		'section'     => 'footer_settings',
		'priority'   => 1,
		'settings'    => 'footer_background_color',
		) ) );
}
add_action( 'customize_register', 'affiliate_newspaperly_customize_register', 999 );




if(! function_exists('newspaperly_customizer_css_final_output' ) ):
	function newspaperly_customizer_css_final_output(){
		?>
		...
		<?php }
		add_action( 'wp_head', 'newspaperly_customizer_css_final_output' );
		endif;