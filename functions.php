<?php
/**
 * a-portfolio functions and definitions
 *
...
if ( ! function_exists( 'a_portfolio_setup' ) ) :
	/**
	 ...
	 */
	function a_portfolio_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on a-portfolio, use a find and replace
		 * to change 'a-portfolio' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'a-portfolio', get_template_directory() . '/languages' );
		...
		add_theme_support( 'custom-background', apply_filters( 'a_portfolio_custom_background_args', array(
...
add_action( 'after_setup_theme', 'a_portfolio_setup' );
 ...
 */
function a_portfolio_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'a_portfolio_content_width', 640 );
}
add_action( 'after_setup_theme', 'a_portfolio_content_width', 0 );
 ...
 */
function a_portfolio_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'a-portfolio' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'a-portfolio' ),
	...
	register_sidebar( array(
		'name'          => __( 'Google map iframe', 'a-portfolio' ),
		'id'            => 'google-map',
		'description'   => __( 'Add widgets here.', 'a-portfolio' ),
		'before_widget' => '',
		'after_widget'  => '',
		'before_title'  => '<h2 class="widget-title">',
		'after_title'   => '</h2>',
...
add_action( 'widgets_init', 'a_portfolio_widgets_init' );
...
function a_portfolio_scripts() {
	...
	wp_enqueue_style( 'slick-theme-css', get_template_directory_uri() .'/assets/slick/slick-theme.css', array(), '4.7.0' );

	wp_enqueue_style( 'a-portfolio-style', get_stylesheet_uri() );
	...
	// Main JS
	wp_enqueue_script( 'a-portfolio-main-js', get_template_directory_uri() . '/assets/js/main.js', array('jquery'), '1.0.0', true );

	
	wp_enqueue_script( 'a-portfolio-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'a-portfolio-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );

	if ( is_singular() && comments_open() && get_option( 'thread_comments' ) ) {
		wp_enqueue_script( 'comment-reply' );
	}
}
add_action( 'wp_enqueue_scripts', 'a_portfolio_scripts' );
