...
<?php endif ?>
<div class="loop-section-col <?php echo apply_filters('actuate_loop_section_col_class_filter', '', $actuate_loop_count) ?>">
    <div class="loop-section">
        <div id="post-<?php the_ID() ?>" <?php post_class() ?>>
			...
			<div class="loop-thumbnail-section" style="width: 100%; height: 260px;">
			...
			<div class="loop-content-section">
				 <div class="loop-post-title">
					...
					<div class="loop-post-meta">
						 <span><?php _e('Written on', 'actuate') ?> </span><span class="loop-meta-date"><?php echo get_the_time('M, d, Y') ?></span>
