...
<div id="status" style="background-image: url('<?php if (get_template_directory_uri().esc_attr(get_theme_mod('at_image_preloader'))) : 
      echo get_template_directory_uri().esc_attr(get_theme_mod('at_image_preloader')); else: echo get_template_directory_uri().'/images/preloader/at-preloader-1.gif'; endif; ?>');">&nbsp;</div>
</div>
