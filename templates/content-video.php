...
<?php 		weaverx_entry_header( 'video' ); ?>
		</header><!-- .entry-header -->
...
?>
		<footer class="entry-utility-wrap">
			<div class="entry-utility<?php echo weaverx_text_class( 'post_info_bottom' ); ?>">
				<?php
					printf( weaverx_filter_text( __( '<a href="%1$s" rel="bookmark"><time class="entry-date" datetime="%2$s">%3$s</time></a><span class="by-author"> <span class="sep"> by </span> <span class="author vcard"><a class="url fn n" href="%4$s" title="%5$s" rel="author">%6$s</a></span></span>','weaver-xtreme' ) ),
				...
				<span class="cat-links">
					<?php printf( weaverx_filter_text( __( '<span class="%1$s">Posted in</span> %2$s','weaver-xtreme' ) ), 'entry-utility-prep entry-utility-prep-cat-links', $categories_list ); ?>
				</span>
				...
				<span class="tag-links">
					<?php printf( weaverx_filter_text( __( '<span class="%1$s">Tagged</span> %2$s','weaver-xtreme' ) ), 'entry-utility-prep entry-utility-prep-tag-links', $tags_list ); ?>
				</span>
				<?php endif; // End if $tags_list ?>

				<?php if ( comments_open() ) : ?>
				<span class="comments-link"><?php comments_popup_link( '<span class="leave-reply">' . esc_html__( 'Reply','weaver-xtreme' ) . '</span>', weaverx_filter_text( __( '<strong>1</strong> Reply','weaver-xtreme' ) ), weaverx_filter_text( __( '<strong>%</strong> Replies','weaver-xtreme' ) ) ); ?></span>
