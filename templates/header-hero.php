...
<div id="header-hero-section">
	 <div class="hero-callout">
		...
		<?php if($business_trust_link !='' || $business_trust_button_text !=''): ?>
	
		<a href="<?php echo esc_url( $business_trust_link ); ?>"><span class="call-to-action" ><?php echo esc_html($business_trust_button_text); ?></span></a>
