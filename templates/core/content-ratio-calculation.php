...
if ($arjunaOptions['sidebar']['display'] == 'both') {
	...
	$contentArea = $GLOBALS['__g_content_area_width'] = $available - $sidebarLeft - $sidebarRight;
	...
	$available = 920;
	$sidebarLeft = $arjunaOptions['sidebar']['widthLeft'];
	$contentArea = $GLOBALS['__g_content_area_width'] = $available - $sidebarLeft;
	...
	$available = 920;
	$sidebarRight = $arjunaOptions['sidebar']['widthRight'];
	$contentArea = $GLOBALS['__g_content_area_width'] = $available - $sidebarRight;
