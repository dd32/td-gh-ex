	...
	<?php else : ?>
		<form action="<?php echo site_url( '/wp-comments-post.php' ); ?>" name="reply" method="post" id="commentform">
			...
			<?php else : ?>
				...
				<div class="replyRow"><input type="text" class="inputText<?php if(empty($commenter['comment_author'])): ?> inputIA<?php endif; ?>" id="replyName" name="author" value="<?php if(!empty($commenter['comment_author'])) { echo esc_attr($commenter['comment_author']); } else { _e('Your name', 'Arjuna'); } ?>" /></div>
				<div class="replyRow"><input type="text" class="inputText<?php if(empty($commenter['comment_author_email'])): ?> inputIA<?php endif; ?>" id="replyEmail" name="email" value="<?php if(!empty($commenter['comment_author_email'])) { echo esc_attr($commenter['comment_author_email']); } else { _e('Your email', 'Arjuna'); } ?>" /></div>
				<div class="replyRow"><input type="text" class="inputText<?php if(empty($commenter['comment_author_url'])): ?> inputIA<?php endif; ?>" id="replyURL" name="url" value="<?php if(!empty($commenter['comment_author_url'])) { echo esc_attr($commenter['comment_author_url']); } else { _e('Your website', 'Arjuna'); } ?>" /></div>
			...
			<div class="replyRow"><?php echo apply_filters( 'comment_form_field_comment', '<div class="replyRow"><textarea class="inputIA" id="comment" name="comment">' . __('Your comment', 'Arjuna') . '</textarea></div>' ); ?></div>
