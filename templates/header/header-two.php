                ...
                <?php endif; ?>
                    ...
                    <div class="header-meta">
                        ...
                        <?php if ( get_theme_mod( 'conica-set-text-header-add' ) ) : ?>
                            <span class="header-top-bar-ad"><i class="fas fa-map-marker-alt"></i> <?php echo wp_kses_post( get_theme_mod( 'conica-set-text-header-add' ) ); ?></span>
                        <?php endif; ?>
                        
                        <?php if ( get_theme_mod( 'conica-set-text-header-phone' ) ) : ?>
                            <span class="header-top-bar-no"><i class="fas fa-phone"></i> <?php echo wp_kses_post( get_theme_mod( 'conica-set-text-header-phone' ) ); ?></span>
                        <?php endif; ?>
