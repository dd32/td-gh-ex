...
?>
		<div class="entry-content clearfix">
			...
			<?php wp_link_pages( array( 'before' => '<div class="page-link"><span>' . __( 'Pages:','weaverx') . '</span>', 'after' => '</div>' ) ); ?>
		</div><!-- .entry-content -->
<?php
	if (!weaverx_compact_post()
...
?>
		<footer class="entry-utility<?php echo weaverx_text_class( 'post_info_bottom' ); ?>">
				...
				<?php
					printf( __( '<a href="%1$s" rel="bookmark"><time class="entry-date" datetime="%2$s">%3$s</time></a><span class="by-author"> <span class="sep"> by </span> <span class="author vcard"><a class="url fn n" href="%4$s" title="%5$s" rel="author">%6$s</a></span></span>','weaverx'),
						esc_url( get_permalink() ),
						get_the_date( 'c' ),
						get_the_date(),
						esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ),
						sprintf( esc_attr__( 'View all posts by %s','weaverx'), get_the_author() ),
						get_the_author()
					);
				?>
				...
				<span class="cat-links">
					<?php printf( __( '<span class="%1$s">Posted in</span> %2$s','weaverx'), 'entry-utility-prep entry-utility-prep-cat-links', $categories_list ); ?>
				</span>
				...
				<span class="tag-links">
					<?php printf( __( '<span class="%1$s">Tagged</span> %2$s','weaverx'), 'entry-utility-prep entry-utility-prep-tag-links', $tags_list ); ?>
				</span>
				<?php endif; // End if $tags_list ?>

				<?php if ( comments_open() ) : ?>
				<span class="comments-link"><?php comments_popup_link( '<span class="leave-reply">' . __( 'Reply','weaverx') . '</span>', __( '<strong>1</strong> Reply','weaverx'), __( '<strong>%</strong> Replies','weaverx') ); ?></span>
