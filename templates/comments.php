  ...
  <section id="respond">
    ...
    <?php else : ?>
      <form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
        ...
        <div class="row">
          <div class="col-md-4">
            <label for="author"><?php _e('Name', 'pinnacle'); if ($req) _e(' <span>*</span>', 'pinnacle'); ?></label>
          ...
          <div class="col-md-4">
            <label for="email"><?php _e('Email (will not be published)', 'pinnacle'); if ($req) _e(' <span>*</span>', 'pinnacle'); ?></label>
          ...
          <div class="col-md-4">
            <label for="url"><?php _e('Website', 'pinnacle'); ?></label>
