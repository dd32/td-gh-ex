        ...
        $slide_sidebar = 848; $portraittext = 'col-md-7'; $portraitimg = 'col-md-5';
         // Get summary setting
            if ( has_post_format( 'video' )) {
              ...
              $swidth = get_post_meta( $post->ID, '_kad_image_posthead_width', true ); if (!empty($swidth)) $slidewidth = $swidth; else $slidewidth = $slide_sidebar;
                ...
                <article id="post-<?php the_ID(); ?>" <?php post_class('kad_blog_item postclass kad-animation'); ?> data-animation="fade-in" data-delay="0">
                      ...
                      <?php } elseif($postsummery == 'img_portrait') { 
                            ...
                            <?php $image = null; $thumbnailURL = null; }  else  {$textsize = 'col-md-12';} ?>
