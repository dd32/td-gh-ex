    ...
    <div class="single-article">
          ...
          <?php if ($headcontent == 'flex') { ?>
              <section class="postfeat">
                <div class="flexslider kt-flexslixer loading kad-light-gallery" style="max-width:<?php echo $slidewidth;?>px;" data-flex-speed="7000" data-flex-anim-speed="400" data-flex-animation="fade" data-flex-auto="true">
                <ul class="slides">
                  <?php
