...
<div id="gallery">
	...
	<a href="#" class="show">
		...
		<img src="<?php echo esc_url( home_url( '/' ) ); ?>wp-content/themes/d5socialia/images/slides/(1).jpg" alt="D5 Socialia by D5 Creation" rel="<h3>Welcome to D5 Socialia Theme Previewing, Visit D5 Creation for Details</h3>D5 Socialia is a WordPress Theme which is Ideal for Social Organizations, NGOs, CBOs, Environmental Organizations, Societies, Climate Change Related Progrms.You can Chnage these Images and Captions by Editing the <?php echo site_url(); ?>/wp-config/themes/d5socialia/slide-image.php"/>
