...
?>
        ...
        <?php responsive_widgets(); // above widgets hook ?>
                ...
                <div class="widget-title"><?php _e('Image Information', 'responsive'); ?></div>
                    ...
                    <span class="full-size">Full Size: <a href="<?php echo wp_get_attachment_url($post->ID); ?>"><?php echo $responsive_data['width'] . '&#215;' . $responsive_data['height']; ?></a>px</span>
                    
					<?php if ($responsive_data['image_meta']['aperture']) { ?>
                    <span class="aperture">Aperture: f/<?php echo $responsive_data['image_meta']['aperture']; ?></span>
                    <?php } ?>

                    <?php if ($responsive_data['image_meta']['focal_length']) { ?>
                    <span class="focal-length">Focal Length: <?php echo $responsive_data['image_meta']['focal_length']; ?>mm</span>
                    <?php } ?>

                    <?php if ($responsive_data['image_meta']['iso']) { ?>
                    <span class="iso">ISO: <?php echo $responsive_data['image_meta']['iso']; ?></span>
                    <?php } ?>
                    ...
                    <span class="camera">Camera: <?php echo $responsive_data['image_meta']['camera']; ?></span>
                    <?php } ?>
