    	...
    	<div class="container jobile-container">
            <div class="col-md-4 no-padding-lr">
				...
				<?php } else { ?>
					<div class="header-logo header-logo2">
						<a href="<?php echo site_url(); ?>"><img src="<?php echo esc_url($jobile_options['logo']); ?>" width="87" height="23" class="img-responsive" alt="logo"></a>
					</div>
				<?php } ?>
            </div>
            <div class="col-md-8 col-xs-12 no-padding-lr">
                	<nav class="jobile-nav jobile-nav2">
                        ...
                        <?php $jobile_defaults = array('theme_location' => 'primary',
												'container' => 'div',
												'container_class' => 'navbar-collapse collapse no-padding-lr',
												'echo'            => true,
												'items_wrap'      => '<ul class="jobile-menu">%3$s</ul>');
