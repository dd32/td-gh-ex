...
<body <?php body_class(); ?>>
  <header role="banner">
    ...
    <div id="header">
      <div class="container">
        <div class="row">
          <div class="logo col-lg-4 col-md-4 col-8">
          ...
          <div class="menubox col-lg-8 col-md-8 col-4">
            ...
            <div id="menu-sidebar" class="nav sidebar">
              <nav id="primary-site-navigation" class="primary-navigation" role="navigation" aria-label="<?php esc_attr_e( 'Top Menu', 'bb-mobile-application' ); ?>">
                <a href="javascript:void(0)" class="closebtn responsive-menu" onclick="resMenu_close()"><i class="fas fa-times"></i><span class="screen-reader-text"><?php esc_html_e('Close Menu','bb-mobile-application'); ?></span></a>
                <?php 
                  wp_nav_menu( array( 
