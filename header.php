...
<head>
	...
	<![endif]-->
	<?php wp_head(); ?>
	<?php if(!empty($a1_options['scroll-top-header'])) { 
			echo"<script> var scroll_top_header = 'yes'; </script>"; 
	     } else { 
			echo"<script> var scroll_top_header = ''; </script>";
	} ?>
</head>
  ...
  <div class="container a1-container">
	...
	<?php if(!empty($a1_options['googleplus'])): ?><li><a href="<?php echo esc_url($a1_options['googleplus']) ?>"><i class="fa fa-google-plus"></i></a></li><?php endif; ?>
      ...
      <?php if(!empty($a1_options['email'])): ?>
      		<p class="top-header-email"><i class="fa fa-envelope-o"></i><?php echo esc_attr($a1_options['email']); ?></p>
      <?php endif; ?>
    </div>
    <div class="col-md-6 col-sm-6 location-part  no-padding-lr">
	<?php if(!empty($a1_options['header-location'])): ?>
      		<p><i class="fa fa-location-arrow"></i><?php echo esc_attr($a1_options['header-location']); ?></p>
      	<?php endif; if(!empty($a1_options['phone'])): ?>
  ...
  <div class="container a1-container">
    <div class="col-md-2 no-padding-lr header-logo"> <a href="<?php echo  esc_url( home_url()); ?>">
      <?php if(!empty($a1_options['logo'])): ?>
        <img src="<?php echo esc_url($a1_options['logo']); ?>" width="90" height="55" alt="A One">
      <?php else: ?>
