...
<div id="page" class="site">
	<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'auto-store' ); ?></a>
	<?php if (esc_attr(get_theme_mod( 'social_media_activate_header' ))) { auto_store_social_section (); } ?>
			...
			<div class="site-branding">
				...
				<?php if ( has_custom_logo() ) : ?>
						...
						<?php if ( is_front_page() && is_home() ) : ?>
							<h1 class="site-title aniview" data-av-animation="bounceInLeft"><?php the_custom_logo(); ?></h1>
						<?php else : ?>
							<p class="site-title aniview"  data-av-animation="bounceInLeft"><?php the_custom_logo(); ?></p>
						<?php endif;
