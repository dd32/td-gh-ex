...
<header role="banner">
  <?php if(get_theme_mod('advance_it_company_preloader_option',true)){ ?>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-lg-8 col-md-12">
          ...
          <?php } ?>
            <div class="main-menu <?php if( get_theme_mod( 'advance_it_company_sticky_header') != '') { ?> sticky-header"<?php } else { ?>close-sticky <?php } ?>">
              <div class="row m-0 ">
              ...
              <div class="serach_outer">
                ...
                <a href="#" onclick="advance_it_company_search_close()" class="closepop">X<span class="screen-reader-text"><?php esc_html_e( 'serach-outer','advance-it-company' );?></span></a>
              </div>
            </div>
        </div>
      </div>
