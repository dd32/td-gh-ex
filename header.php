  ...
  <div class="header">
    <div class="container">
      <div class="row">
        ...
        <div class="cart-btn-box col-lg-3 col-md-12">
          ...
          <div class=" col-lg-9 col-md-9">
            <div id="menu-sidebar" class="nav sidebar">
              <nav id="primary-site-navigation" class="primary-navigation" role="navigation" aria-label="<?php esc_attr_e( 'Top Menu', 'bb-ecommerce-store' ); ?>">
                <a href="javascript:void(0)" class="closebtn responsive-menu" onclick="resMenu_close()"><i class="fas fa-times"></i><span class="screen-reader-text"><?php esc_html_e('Close Menu','bb-ecommerce-store'); ?></span></a>
                <?php 
                  wp_nav_menu( array( 
