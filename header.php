...
<div id="container">
	...
	<a class="skip-link screen-reader-text" href="<?php echo $main_content; ?>"><?php _e( 'Skip to content', 'shipyard' ); ?></a>
	<div id="header">
		<div class="logo">
		...
		<?php if ( has_nav_menu( 'primary' ) ) : ?>
			...
			<div class="mobile-nav-container">
				<button class="mobile-nav-toggle"><?php _e( 'Menu', 'shipyard' ); ?><?php _e( ' +', 'shipyard' ); ?></button>
