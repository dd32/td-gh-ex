  ...
  <header role="banner">
    ...
    <div id="header">
      <?php if( get_theme_mod('advance_pet_care_display_topbar') != ''){ ?>
        <div class="top-header pt-2 px-0 pb-4">
          <div class="container">
            <div class="row">
      ...
      <div class="pet-top">
        <div class="container">
          <div class="row">
              ...
              <div class="logo p-2">
                <?php if ( has_custom_logo() ) : ?>
                  ...
                  <?php if ( ! empty( $blog_info ) ) : ?>
                    <?php if( get_theme_mod('advance_pet_care_site_title',true) != ''){ ?>
                      <?php if ( is_front_page() && is_home() ) : ?>
                        <h1 class="site-title text-center p-0"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><?php bloginfo( 'name' ); ?></a></h1>
                      <?php else : ?>
                        <p class="site-title text-center p-0 m-0"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><?php bloginfo( 'name' ); ?></a></p>
                      <?php endif; ?>
                    <?php }?>
                  <?php endif; ?>
                  <?php
                  ...
                  <?php if( get_theme_mod('advance_pet_care_tagline',true) != ''){ ?>
                    <p class="site-description text-center p-0 m-0">
            ...
            <div class="col-lg-4 col-md-4">
              <div class="address mt-3 mb-md-0 text-md-right text-center mb-2">
                <div class="row m-0">
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-10 col-md-7 col-4">
              <?php 
                ...
                <div class="toggle-menu responsive-menu text-left">
                  <button role="tab" class="mobiletoggle"><i class="fas fa-bars my-2 mx-0"></i><span class="screen-reader-text"><?php esc_html_e('Open Menu','advance-pet-care'); ?></span></button>
                </div>
              <?php }?>
                  ...
                  <?php
                    if(has_nav_menu('primary')){ 
                      wp_nav_menu( array( 
                        ...
                        'menu_class' => 'clearfix',
                        'items_wrap' => '<ul id="%1$s" class="%2$s mobile_nav pl-lg-0 text-lg-left text-center">%3$s</ul>',
                        'fallback_cb' => 'wp_page_menu',
                      ) );
                    } 
                  ?>
                  <div id="contact-info w-100">
                    <div class="mail text-center mb-2 p-2 m-md-0 p-md-0">
                      <?php if( get_theme_mod('advance_pet_care_mail1') != ''){ ?>
                        <a href="mailto:<?php echo esc_attr( get_theme_mod('advance_pet_care_mail1','') ); ?>" class="text-lowercase p-2"><i class="fas fa-envelope"></i><?php echo esc_html( get_theme_mod('advance_pet_care_mail1','')); ?><span class="screen-reader-text"><i class="fas fa-envelope"></i><?php echo esc_html( get_theme_mod('advance_pet_care_mail1','')); ?></span></a>
                      <?php } ?>
                    </div>
                    <div class="phone text-center mb-2">
                      <?php if( get_theme_mod('advance_pet_care_phone1') != ''){ ?>
                        <a href="tel:<?php echo esc_attr( get_theme_mod('advance_pet_care_phone1','' )); ?>" class="p-2 m-0"><i class="fas fa-phone"></i><?php echo esc_html( get_theme_mod('advance_pet_care_phone1','' )); ?><span class="screen-reader-text"><i class="fas fa-phone"></i><?php echo esc_html( get_theme_mod('advance_pet_care_phone1','' )); ?></span></a>
                      <?php } ?>
                    </div>
                    <?php get_search_form();?>
            ...
            <div class="col-lg-1 col-md-1 col-4">
              <div class="search-box my-1 mx-0">
