  ...
  <header role="banner">
    ...
    <div id="header">
      <?php if( get_theme_mod('advance_coaching_display_topbar', false) != ''){ ?>
        <div class="top-header pb-lg-1 pb-3"> 
          <div class="container">
            <div class="row">
                  ...
                  <div class="time p-3">
                    <div class="row m-0">
                      <div class="col-lg-3 col-md-3">
                        <i class="far fa-clock p-2 p-md-2"></i>
                      </div>
                      <div class="col-lg-9 col-md-9 p-0">
                        <p class="mt-2"><?php echo esc_html( get_theme_mod('advance_coaching_time','' )); ?></p>
                      </div>
                    </div>
                  </div>  
                <?php } ?>
              ...
              <div class="col-lg-6 col-md-6">
                <div class="welcome-text">
                  <?php if( get_theme_mod('advance_coaching_welcome_text') != ''){ ?>
                    <p class="mt-4 mt-md-2"><?php echo esc_html( get_theme_mod('advance_coaching_welcome_text','' )); ?></p>
                  <?php } ?>
                </div>
              </div>
              <div class="col-lg-3 col-md-3">
                <div class="request-btn mt-3">
                  <?php if ( get_theme_mod('advance_coaching_course1','') != "" ) {?>
                    <span><a href="<?php echo esc_url(get_theme_mod('advance_coaching_course')); ?>" class="text-uppercase p-3"><?php echo esc_html(get_theme_mod('advance_coaching_course1','')); ?> <i class="fas fa-angle-right ml-3 rounded-circle ml-md-0"></i></a><span class="screen-reader-text"><?php esc_html_e( 'Requestbtn','advance-coaching' );?></span></span>
                  <?php }?>
                </div>
              </div>
            </div>
            ...
            <div class="row">
                  ...
                  <?php if ( ! empty( $blog_info ) ) : ?>
                    <?php if( get_theme_mod('advance_coaching_site_title',true) != ''){ ?>
                      <?php if ( is_front_page() && is_home() ) : ?>
                        <h1 class="site-title"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home" class="text-left text-uppercase"><?php bloginfo( 'name' ); ?></a></h1>
                      <?php else : ?>
                        <p class="site-title m-0"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home" class="text-left text-uppercase"><?php bloginfo( 'name' ); ?></a></p>
                      <?php endif; ?>
                    <?php }?>
                  <?php endif; ?>
                  <?php
              ...
              <div class="col-lg-9 col-md-8 p-0">
                <div class="topbar">
                    ...
                    <div class="row m-0">
                          ...
                          <div class="container">
                            <div id="menu-sidebar" class="nav sidebar">
                              <nav id="primary-site-navigation" class="primary-navigation" role="navigation" aria-label="<?php esc_attr_e( 'Top Menu', 'advance-coaching' ); ?>">
                                <?php
                                  if(has_nav_menu('primary')){  
                                    wp_nav_menu( array( 
                                      ...
                                      'menu_class' => 'clearfix',
                                      'items_wrap' => '<ul id="%1$s" class="%2$s mobile_nav m-lg-0 text-lg-left pl-lg-0">%3$s</ul>',
                                ...
                                <div class="request-btn mt-3">
                                  <?php if ( get_theme_mod('advance_coaching_course1','') != "" ) {?>
                                    <span><a href="<?php echo esc_url(get_theme_mod('advance_coaching_course')); ?>"><?php echo esc_html(get_theme_mod('advance_coaching_course1','')); ?> <i class="fas fa-angle-right ml-3 rounded-circle"></i></a><span class="screen-reader-text"><?php esc_html_e( 'Requestbtn','advance-coaching' );?></span></span>
                                  <?php }?>
                                </div>
                                <?php get_search_form();?>
                      ...
                      <div class="col-lg-1 col-md-1 col-6">
                        <div class="search-box my-2 mx-0">
                          <button type="button" data-toggle="modal" data-target="#myModal"><i class="fas fa-search m-2 py-2 px-0"></i></button>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="modal fade p-0" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" class="p-0">
                  ...
                  <div class="contact_data row m-0 w-100">
                    <div class="col-lg-4 col-md-4">
                      <?php if( get_theme_mod('advance_coaching_mail') != ''){ ?>
                      <div class="mail pt-3 px-0 pb-2 p-md-0 text-md-center">
                        <div class="row m-0">
                          <div class="col-lg-3 col-md-12">
                            <i class="fas fa-at p-2 ml-3 p-md-2"></i>
                          </div>
                    ...
                    <div class="col-lg-4 col-md-4">
                      <?php if( get_theme_mod('advance_coaching_phone') != ''){ ?>
                        <div class="mail pt-3 px-0 pb-2">
                          <div class="row m-0">
                            <div class="col-lg-3 col-md-12">
                              <i class="fas fa-phone p-2 ml-3"></i>
                            </div>
                            <div class="col-lg-9 col-md-12">
                              <?php if( get_theme_mod('advance_coaching_phone') != ''){ ?>
                    ...
                    <div class="col-lg-4 col-md-4">
                      <?php if( get_theme_mod('advance_coaching_address') != ''){ ?>
                        <div class="mail pt-3 px-0 pb-2">
                          <div class="row m-0">
                            <div class="col-lg-3 col-md-12">
                              <i class="fas fa-map-marker-alt p-2 ml-3"></i>
                            </div>
                            <div class="col-lg-9 col-md-12">
                              <?php if( get_theme_mod('advance_coaching_address') != ''){ ?>
