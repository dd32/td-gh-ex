...
<link rel="alternate" type="application/rss+xml" title="<?php printf(__('%s RSS Feed', 'auroral'), get_bloginfo('name')); ?>" href="<?php bloginfo('rss2_url'); ?>" />
<link rel="alternate" type="application/atom+xml" title="<?php printf(__('%s Atom Feed', 'auroral'), get_bloginfo('name')); ?>" href="<?php bloginfo('atom_url'); ?>" /> 
