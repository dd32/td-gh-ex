...
<body <?php body_class(); ?>>
    <div id="page" class="hfeed site">
        <header id="header" class="blog-header">
            <p class="blog-title"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home"><?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?></a></p>
            <p class="blog-description"><?php bloginfo( 'description' ); ?> | <a href="<?php bloginfo( 'rss2_url' ); ?>" title="<?php _e( 'Subscribe to the RSS Feed of this site', 'rockers' ); ?>" id="rss">RSS</a></p>
            <nav id="blog-menu" class="menu">
                <h2 class="menu-toggle"><?php _e( 'Menu', 'rockers' ); ?></h2>
                <p class="skip-link accessibility"><a href="#content" title="<?php esc_attr_e( 'Skip to content', 'rockers' ); ?>"><?php _e( 'Skip to content', 'rockers' ); ?></a></p>
                <?php wp_nav_menu(
                    array( 
                        'container' => '',
                        'theme_location' => 'menu', 
