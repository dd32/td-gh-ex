...
<div id="page" class="site">
	<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'aperture-real-estate' ); ?></a>
	...
	<header id="masthead" class="site-header grid-wide">
		...
		<?php aperture_real_estate_header(); ?>
	</header><!-- #masthead -->

	<div id="content" class="site-content">
	<?php aperture_real_estate_intro(); ?>
