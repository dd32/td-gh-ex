...
<div class="remove-for-print">
	...
	<a href="http://www.openbase.ru"><img src="<?php bloginfo('template_directory'); ?>/images/blank.gif" alt="openbase"></a>
	...
	<div class="foncheg"style="margin: 0; padding: 0; height:479px;background:url(wp-content/themes/avril_S/images/header/header6.jpg)  center top no-repeat;">
    <a href="http://www.openbase.ru"><img src="<?php bloginfo('template_directory'); ?>/images/blank.gif" alt="openbase"></a>
		<?php if ( $ata_overlay_blog_title == "No") { ?>
		<?php if ( $ata_header_opacity != 0 ) { ?>
			<div style="float: left; height: <?php echo $ata_headerimage_height; ?>px; width: <?php echo $ata_leftcolumn_width; ?>em;">
			&nbsp;
			</div>
			<div style="float: right; height: <?php echo $ata_headerimage_height; ?>px; width: <?php echo $ata_rightcolumn_width; ?>em;">
			&nbsp;
			</div>
			<div style="clear:both"></div>
