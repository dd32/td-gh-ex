			...
			<div class="ansia-menu">
				<div class="ansia-menu-wrapper">
					<nav id="site-navigation" class="main-navigation">
						<button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false" aria-label="<?php esc_attr_e( 'Menu', 'ansia' ); ?>"><?php esc_html_e( 'Menu', 'ansia' ); ?><i class="fa fa-lg spaceLeft fa-bars" aria-hidden="true"></i></button>
						<?php
							wp_nav_menu( array(
