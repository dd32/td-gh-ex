                                    ...
                                    <?php if (get_theme_mod(mp_artwork_get_prefix() . 'logo') != "" || get_bloginfo('description') || get_theme_mod('name') != "") : ?>
                                        <a class="home-link" href="<?php echo esc_url(home_url('/')); ?>"
                                           title="<?php echo esc_attr(get_bloginfo('name', 'display')); ?>" rel="home">
                                               <?php if (get_theme_mod(mp_artwork_get_prefix() . 'logo', false) === false) : ?> 
                                            ...
                                            <?php else: ?>
                                                <?php if (get_theme_mod(mp_artwork_get_prefix() . 'logo')) : ?> 
                                                    <div class="header-logo "><img src="<?php echo esc_url(get_theme_mod(mp_artwork_get_prefix() . 'logo')); ?>" alt="<?php echo esc_attr(get_bloginfo('name', 'display')); ?>"></div>
                                                <?php endif; ?>
                                            <?php endif; ?>
                                        </a>
                                    <?php endif ?>
