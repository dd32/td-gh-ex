...
<div id="page" class="site">
    ...
    if (batourslight_Settings::$layout_current != 'frontpage'){ 
    ...
    ?>">
       ...
       <div class="row">
			...
			<div id="primary" class="content-area <?php echo esc_attr(apply_filters( 'batourslight_column_width', 'col-lg-'.batourslight_Settings::$layout_vars['width']['main'], 'primary' )); ?>">
