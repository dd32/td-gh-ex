      ...
      <div class="container">
        <div class="row">
          ...
          <div class="cart-btn-box col-lg-3 col-md-4">
            <div class="cart_icon"><i class="fas fa-shopping-bag"></i><a href="<?php the_permalink((get_option('woocommerce_cart_page_id'))); ?>"><?php echo esc_html_e('SHOPPING CART','bb-ecommerce-store'); ?><span class="screen-reader-text"><?php esc_html_e( 'SHOPPING CART','bb-ecommerce-store' );?></span></a></div>
          </div>
        </div>
      </div>
