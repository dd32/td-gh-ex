...
if ( ! function_exists( 'elementor_theme_do_location' ) || ! elementor_theme_do_location( 'header' ) ) {
	...
	$axis_magazine_ad_img_set   = wp_get_attachment_url(get_theme_mod('axis_magazine_ad_img_settings'));
?>
...
<div class="header-box">
	<div class="mg-auto header-box-flex wid-90 mobwid-90">
		...
		<div class="ad-box-img wid-70 mobwid-100">
			<?php if ( !$axis_magazine_ad_img_set ): ?>
				<a href="<?php echo esc_url(esc_html(get_theme_mod('axis_magazine_ad_img_link_settings'))); ?>">
					<img class="ad-img" src="<?php echo esc_url(esc_html(get_theme_mod('axis_magazine_ad_img_settings'))); ?>" alt="<?php bloginfo('name'); ?>" />
				</a>
			<?php endif; ?>
		</div>
	</div>
