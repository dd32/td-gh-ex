...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo esc_url_raw($booster_options['fevicon']);?>">
    <?php } ?>
	<!--[if lt IE 9]>
  ...
  <div class="col-md-12">
    ...
    <?php } ?>
      <div class="col-md-3 no-padding text-left-menu">
            ...
            <?php } else { ?>
            	<a href="<?php echo site_url(); ?>" class="pull-left booster-site-name"><img src="<?php echo esc_url_raw($booster_options['logo']); ?>" alt="" class="img-responsive header-logo" /></a> 
            <?php } ?>	
      ...
      <div class="col-md-2 no-padding text-left-menu">
        <div class="">
          <ul class="social-icon">
            <li><?php if(!empty($booster_options['fburl'])) { ?><a href="<?php echo esc_url_raw($booster_options['fburl']); ?>"><img class="sp" src="<?php echo get_template_directory_uri();?>/images/fb.png" alt="" /></a><?php } ?></li>
            <li><?php if(!empty($booster_options['twitter'])) { ?><a href="<?php echo esc_url_raw($booster_options['twitter']); ?>"><img class="sp" src="<?php echo get_template_directory_uri();?>/images/tw.png" alt="" /></a><?php } ?></li>
            <li><?php if(!empty($booster_options['linkedin'])) { ?><a href="<?php echo esc_url_raw($booster_options['linkedin']); ?>"><img class="sp" src="<?php echo get_template_directory_uri();?>/images/in.png" alt="" /></a><?php } ?></li>         
          </ul>
        </div>
