	...
	<header id="masthead" class="site-header" style="background-image: url('<?php header_image(); ?>')">
		<div class="wrap">
			...
			if ( is_front_page() && is_home() ) :
				...
				$best_minimalist_description = get_bloginfo( 'description', 'display' );
				if ( $best_minimalist_description || is_customize_preview() ) :
					?>
					<p class="site-description"><?php echo $best_minimalist_description; /* WPCS: xss ok. */ ?></p>
				<?php endif; ?>
			</div><!-- .site-branding -->
