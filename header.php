...
<div id="page" class="site">
	...
	<?php	 
	  $wpostheme_enabale_fp     = beatrix_lite_get_theme_mod( 'enabale-featured-post' );
	  $fc_post_layout 	    	= beatrix_lite_get_theme_mod( 'fc_post_layout' );		
	  $fp_full_width            = beatrix_lite_get_theme_mod( 'show_fc_post_full' );
