        ...
        <div class="row m-0">
          ...
          <?php if( get_theme_mod( 'automobile_car_dealer_button_link','' ) != '') { ?>
            <div class="col-lg-3 col-md-3 appointbtn">
               <a href="<?php echo esc_url( get_theme_mod('automobile_car_dealer_button_link','#' ) ); ?>"><i class="fas fa-calendar-alt"></i><?php esc_html_e( 'MAKE AN APPOINTMENT','automobile-car-dealer' ); ?></a>
            </div>
          <?php }?>
        </div>
      </div>
