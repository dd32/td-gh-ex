...
<head>
    <?php if(is_customize_preview()) echo '<!-- preview woot woot -->'; ?>
...
<ul class="navigation <?php if(is_customize_preview() && get_theme_mod('display_menu')) echo 'customizer'; ?>" id="drop-the-menu-down">
