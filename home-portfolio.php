            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="enigma_heading_title">
                        <h3><?php esc_html_e( get_theme_mod('port_heading', 'Recent Works'), 'enigma' ); ?></h3>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div id="enigma_portfolio_section" class="enima_photo_gallery">
                <?php for ($i = 1; $i <= 4; $i++) {
                    if (!empty (get_theme_mod('port_' . $i . '_img', get_template_directory_uri() . "/images/portfolio1.png"))) {
                        ?>
                        ...
                        <div class="img-wrapper">
                            ...
                            <div class="enigma_home_portfolio_showcase">
                                <img class="enigma_img_responsive" alt="<?php the_title_attribute(); ?>"
                                     src="<?php echo esc_url(get_theme_mod('port_' . $i . '_img', get_template_directory_uri() . "/images/portfolio" . $i . ".png")); ?>">
                            ...
                            <?php if (!empty (get_theme_mod('port_' . $i . '_title', __('Bonorum', 'enigma')))) { ?>
