<?php
/**
 * The template displaying an image custom post format
 *
 */
?>
...
<?php endif; ?>
		<span class="image-icon">
			<a href="<?php echo esc_url( get_post_format_link( 'image' ) ); ?>" title="<?php echo esc_attr( get_post_format_string( 'image' ) ); ?>"><?php echo get_post_format_string( 'image' ); ?></a>
		</span>
