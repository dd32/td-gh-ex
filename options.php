...
function optionsframework_options() {
     ...
     // Pull all the categories into an array
		...
		$options[] = array( 'name' => __('Element color on hover', 'unite'),
							'desc' => __('Default used if no color is selected', 'unite'),
							'id' => 'element_color_hover',
							'std' => '',
							'type' => 'color');

		$options[] = array( 'name' => __('Custom Favicon', 'unite'),
		...
		$options[] = array( 'name' => __('Heading Color', 'unite'),
							'desc' => __('Default used if no color is selected', 'unite'),
							'id' => 'heading_color',
							'std' => '',
							'type' => 'color');
		...
		$options[] = array( 'name' => __('Top nav dropdown background color', 'unite'),
		...
		$options[] = array( 'name' => __('Social Icon Color', 'unite'),
							'desc' => __('Default used if no color is selected', 'unite'),
							'id' => 'social_color',
							'std' => '',
							'type' => 'color');
