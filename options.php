...
function optionsframework_options() {
    ...
    $footer_columns = array(
        'col-md-12' => __('One', 'options_framework_theme'),
        'col-md-6' => __('Two', 'options_framework_theme'),
        'col-md-4' => __('Three', 'options_framework_theme'),
        'col-md-3' => __('Four', 'options_framework_theme'),
    );
    $icon_array = array(
...
//    );
    ...
    $options[] = array(
        'name' => __('Font Size', 'options_framework_theme'),
        'desc' => __('Main body font size', 'options_framework_theme'),
        'id' => 'sc_font_size',
        'std' => '14px',
        'type' => 'select',
    ...
    $options[] = array(
        'name' => __('Font Family', 'options_framework_theme'),
        'desc' => __('font family for the website', 'options_framework_theme'),
        'id' => 'sc_font_family',
...
//        "section" => "nav");
    ...
    $options[] = array(
        'name' => __('CTA Heading 1', 'options_framework_theme'),
        'desc' => __('first heading for CTA boxes', 'options_framework_theme'),
        'id' => 'sc_cta_header_one',
        'std' => 'Easy to customize',
        'type' => 'text');    
    
    $options[] = array(
        'name' => __('CTA Heading 2', 'options_framework_theme'),
        'desc' => __('second heading for CTA boxes', 'options_framework_theme'),
        'id' => 'sc_cta_header_two',
        'std' => 'Restaurant and food inspired theme',
        'type' => 'text');    
  ...
  // box 1
    ...
    $options[] = array(
        'name' => __('Templates', 'options_framework_theme'),
        'type' => 'heading');
    ...
    $options[] = array(
        'name' => __('Theme Branding','options_framework_theme'),
        'desc' => __('Show or Hide the smartcat branding'),
        'id' => 'sc_theme_branding',
        'std' => 'on',
        'type' => 'radio',
        'options' => array(
            'on' => 'Show',
...
function sc_avenue_options_display_sidebar() {
    ...
    <div class="width30 left ml2p">
        ...
        <div class="sc-tab-option">
            <a href="http://smartcatdesign.net/themes/tasty" target="_blank">
                Instructions
            </a>
        </div>
