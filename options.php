    ...
    <div class="metabox-holder goto">
        <div class="postbox">
			...
			<ol>
				...
				<a href="<?php echo esc_url(__(admin_url( 'customize.php' ))); ?>" target="_blank"><?php echo esc_attr__( 'Customizer', 'promax' ); ?></a></b>
				</li>
				<li>
				<?php _e('Add Widget and put ads codes in different area in website','promax'); ?> <b>Go to <a href="<?php echo esc_url(__(admin_url( 'widgets.php' ))); ?>" target="_blank"><?php echo esc_attr__( 'Widget Settings', 'promax' ); ?></a></b>	
				</li>
				<li>
			<?php _e('Google Fonts Change and Live Set from Customize > Google Fonts','promax'); ?> <b>Go to <a href="<?php echo esc_url(__(admin_url( 'customize.php' ))); ?>" target="_blank"><?php echo esc_attr__( 'customizer', 'promax' ); ?></a></b>	
				</li>
			</ol>
...
$options[] = array(
	...
	$options[] = array(
		...
		'type' => 'textarea');
$options[] = array(
		'name' => __('WooCommerce', 'promax'),
		'type' => 'heading');
		
	$options[] = array(
		'name' => __('Enable Quick Checkout Button', 'promax'),
		'desc' => __('Quick checkout button will be added into product page after add to cart button, that redirect users directly to checkout page', 'promax'),
		'id' => 'promax_quickcheckout',
		'std' => 'on',
		'type' => 'radio',
		'options' => array(
						'on' => __('Enable','promax'),
						'off' => __('Disable','promax')
							));	
	$options[] = array(
		'desc' => __('Custom name of Quick Checkout button', 'promax'),
		'id' => 'promax_quickcheckoutname',
		'std' => __('Quick Checkout','promax'),
		'class' => 'mini',
		'type' => 'text');	
	$options[] = array(		
		'name' => __('Quick Checkout Button Background Color', 'promax'),
		'desc' => __('Buttons Background color', 'promax'),
		'id' => 'promax_quickcheckoutbg',
		'std' => '#2196f3',
		'type' => 'color');	
	$options[] = array(
		'name' => __('Light box Open Images', 'promax'),
		'desc' => __('Enable or Disable Gallery Light box ', 'promax'),
		'id' => 'promax_woolightbox',
		'std' => 'on',
		'type' => 'radio',
		'options' => array(
						'on' => __('Enable','promax'),
	...
	$options[] = array(
	'name' => __('Zoom Single Product Image', 'promax'),
		'desc' => __('Enable or Disable Zoom Feature', 'promax'),
		'id' => 'promax_woozoom',
		'std' => 'off',
		'type' => 'radio',
		'options' => array(
	...
	$options[] = array(
		'name' => __('Slider Feature on Product Images', 'promax'),
		'desc' => __('Enable or Disable Slider Feature', 'promax'),
		'id' => 'promax_wooslider',
		'std' => 'off',
		'type' => 'radio',
		'options' => array(
