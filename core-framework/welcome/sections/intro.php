...
<div class="ig-intro ig-row">
    <div class="welcome ig-col ig-col2">
        ...
        <p style="font-size: 1.2em;"><?php esc_html_e( 'Thank you to use ', 'base-wp'); ?><?php echo wp_get_theme()->get( "Name" ); ?></p>
        <p><?php esc_html_e( 'Here you can read the documentation and you can know how to get the most out of your new theme.', 'base-wp' ); ?></p>
    </div><!-- end ig-col2 -->  
    <div class="ig-boxed premium ig-col ig-col2">
        <h3><span class="dashicons dashicons-star-filled"></span><?php esc_html_e( 'UPGRADE TO PREMIUM', 'base-wp' ); ?></h3>
        <p><?php esc_html_e( 'If you like this theme, considering supporting development by purchasing the premium version.', 'base-wp' ); ?></p>
