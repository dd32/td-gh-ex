...
<div class="ig-themes">
    <div class="ig-col ig-col2">
        ...
        <h3><span class="dashicons dashicons-admin-appearance"></span> <?php esc_html_e( 'Free themes', 'base-wp' ); ?></h3>
            <?php
...
<div class="ig-plugins">
    <div class="ig-col ig-col2">
        <div class="ig-boxed ig-row">
    <h3><span class="dashicons dashicons-admin-plugins"></span> <?php esc_html_e( 'Free plugins', 'base-wp' ); ?></h3>
    <?php
    $args = array(
        'author' => 'iografica',
        'fields' => array(
    ...
    if ( !is_wp_error($response) ) {
        ...
        <div class="item-details">
            ...
            <div class="item-description">
                <?php echo esc_html(substr($plugin->short_description, 0, 60). __( '&#8230;', 'base-wp' ));?>
