...
<?php
 $advance_coaching_wocommerce_single_page_sidebar = get_theme_mod( 'advance_coaching_wocommerce_single_page_sidebar', true);
 if ( false == $advance_coaching_wocommerce_single_page_sidebar ) {
