...
<ul class="result-count">
    <li class="view-title"><?php esc_html_e( 'View:', 'bc-shop' ) ?></li>
    ...
    <li><a class="view-all<?php if ( $num_prod == 'all' ) echo esc_attr('active'); ?>" href="<?php echo esc_url( add_query_arg( 'products-per-page', 'all', $link  ) ) ?>"><?php esc_html_e( 'All', 'bc-shop' ) ?></a></li>
</ul>
