...
<ul class="result-count">
    <li class="view-title"><?php esc_html_e( 'View:', 'bc-shop-lang' ) ?></li>
    ...
    <li><a class="view-all<?php if ( $num_prod == 'all' ) echo ' active'; ?>" href="<?php echo esc_url( add_query_arg( 'products-per-page', 'all', $link  ) ) ?>"><?php esc_html_e( 'All', 'bc-shop-lang' ) ?></a></li>
</ul>
