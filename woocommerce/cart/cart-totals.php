...
<div class="row">
    <div class="col-sm-4 col-sm-offset-8 col-lg-3 col-lg-offset-9">
        ...
        <?php do_action( 'woocommerce_before_cart_totals' ); ?>
            ...
            <ul class="list-total">
                <li>
                    <label><?php _e( 'Subtotal', 'ariel' ); ?></label>
                ...
                <?php elseif ( WC()->cart->needs_shipping() && 'yes' === get_option( 'woocommerce_enable_shipping_calc' ) ) : ?>
                    ...
                    <li class="shipping">
                        <label><?php _e( 'Shipping', 'ariel' ); ?></label>
                ...
                <?php if ( wc_tax_enabled() && 'excl' === WC()->cart->tax_display_cart ) :
                    ...
                    $estimated_text  = WC()->customer->is_customer_outside_base() && ! WC()->customer->has_calculated_shipping()
                            ? sprintf( ' <small>' . __( '(estimated for %s)', 'ariel' ) . '</small>', WC()->countries->estimated_for_prefix( $taxable_address[0] ) . WC()->countries->countries[ $taxable_address[0] ] )
                            : '';
                ...
                <li class="order-total">
                    <label><?php _e( 'Total', 'ariel' ); ?></label>
