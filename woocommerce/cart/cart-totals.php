...
<div class="cart_totals col-md-6 <?php echo $crosssells > 1 ? " " : "col-md-offset-6"; ?> <?php if ( WC()->customer->has_calculated_shipping() ) echo 'calculated_shipping'; ?>">
	...
	<table cellspacing="0" class="table table-bordered shop_table shop_table_responsive">
		...
		<tr class="cart-subtotal">
			...
			<td data-title="<?php esc_attr_e( 'Subtotal', 'basicstore' ); ?>"><?php wc_cart_totals_subtotal_html(); ?></td>
		</tr>
		...
		<?php elseif ( WC()->cart->needs_shipping() && 'yes' === get_option( 'woocommerce_enable_shipping_calc' ) ) : ?>
			...
			<tr class="shipping">
				<th><?php _e( 'Shipping', 'basicstore' ); ?></th>
				<td data-title="<?php esc_attr_e( 'Shipping', 'basicstore' ); ?>"><?php woocommerce_shipping_calculator(); ?></td>
			</tr>
		...
		<tr class="order-total">
			...
			<td data-title="<?php esc_attr_e( 'Total', 'basicstore' ); ?>"><?php wc_cart_totals_order_total_html(); ?></td>
		</tr>
