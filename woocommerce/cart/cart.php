...
<form class="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
    ...
    <table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
        ...
        <tr>
            ...
            <th class="product-name"><?php _e( 'Product', 'attire' ); ?></th>
            <th class="product-price"><?php _e( 'Price', 'attire' ); ?></th>
            <th class="product-quantity"><?php _e( 'Quantity', 'attire' ); ?></th>
            <th class="product-subtotal"><?php _e( 'Total', 'attire' ); ?></th>
        </tr>
        </thead>
        <tbody>
        ...
        <tr>
            <td colspan="6" class="actions">
				...
				<?php if ( wc_coupons_enabled() ) { ?>
                    <div class="coupon">
                        <label for="coupon_code"><?php _e( 'Coupon:', 'attire' ); ?></label> <input type="text"
                                                                                                     name="coupon_code"
