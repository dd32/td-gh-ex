...
<div class="coupon-form-checkout">
	...
	<div class="woocommerce-form-coupon-toggle">
		...
		<?php wc_print_notice( apply_filters( 'woocommerce_checkout_coupon_message', esc_attr__( 'Have a coupon?', 'suevafree' ) . ' <a href="#" class="showcoupon">' . esc_attr__( 'Click here to enter your code', 'suevafree' ) . '</a>' ), 'notice' ); ?>
