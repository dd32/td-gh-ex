...
<?php if ( $has_downloads ) : ?>
	...
	<div class="table-responsive">
		...
		<table class="table table-bordered table-striped woocommerce-MyAccount-downloads shop_table shop_table_responsive">
			<thead>
				<tr>
											...
											<?php
												...
												if ( $actions = apply_filters( 'woocommerce_account_download_actions', $actions, $download ) ) {
													foreach ( $actions as $key => $action ) {
														echo '<a href="' . esc_url( $action['url'] ) . '" class="btn btn-default button woocommerce-Button ' . sanitize_html_class( $key ) . '">' . esc_html( $action['name'] ) . '</a>';
													}
												}
											?>
											<?php break;
