...
<?php endif; ?>
		...
		<form method="post" class="login">
			...
			<p class="form-row">
				...
				<input type="submit" class="button kad-btn kad-btn-primary" name="login" value="<?php _e( 'Login', 'woocommerce' ); ?>" />
	...
	<div class="col-md-6">
		...
		<form method="post" class="register">
			...
			<p class="form-row">
				...
				<input type="submit" class="button kad-btn kad-btn-primary" name="register" value="<?php _e( 'Register', 'woocommerce' ); ?>" />
			</p>
