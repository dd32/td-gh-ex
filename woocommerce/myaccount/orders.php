...
<?php if ( $has_orders ) : ?>
	...
	<div class="table-responsive">
		...
		<table class="table table-bordered table-striped vert-align-middle woocommerce-orders-table woocommerce-MyAccount-orders shop_table shop_table_responsive my_account_orders account-orders-table">
			<thead>
				<tr>
									...
									<?php
										...
										if ( $actions = apply_filters( 'woocommerce_my_account_my_orders_actions', $actions, $order ) ) {
											foreach ( $actions as $key => $action ) {
												echo '<a href="' . esc_url( $action['url'] ) . '" class="btn btn-sm woocommerce-button button '  . sanitize_html_class( $key ) .' '. sanitize_html_class( $action['btn-class'] ) . '">' . esc_html( $action['name'] ) . '</a>';
											}
										}
									?>
								<?php endif; ?>
