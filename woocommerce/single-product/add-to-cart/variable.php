...
<form class="variations_form cart form-horizontal" method="post" enctype='multipart/form-data' data-product_id="<?php echo absint( $product->get_id() ); ?>" data-product_variations="<?php echo htmlspecialchars( wp_json_encode( $available_variations ) ) ?>">
		...
		<div class="variations">
			...
			<?php foreach ( $attributes as $attribute_name => $options ) : ?>
					...
					<div class="form-group">
						...
						<label class="col-sm-2 control-label" for="<?php echo sanitize_title( $attribute_name ); ?>"><?php echo wc_attribute_label( $attribute_name ); ?></label>
