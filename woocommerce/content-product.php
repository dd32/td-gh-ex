...
<div class="product-card__inner">
	...
	<div class="product-card__info row">
		<div itemprop="name" class="col-md-12 product-card__info__product">
			<a property="url" href="<?php the_permalink(); ?>">
				<?php woocommerce_template_loop_product_title();?>
			</a>
		</div>
		<div itemprop="offers" itemscope itemtype="http://schema.org/Offer" class="col-md-12 product-card__info__price">
