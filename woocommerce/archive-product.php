...
<?php
 $advance_ecommerce_store_shop_page_sidebar = get_theme_mod( 'advance_ecommerce_store_shop_page_sidebar',true );
 if ( false == $advance_ecommerce_store_shop_page_sidebar ) {
