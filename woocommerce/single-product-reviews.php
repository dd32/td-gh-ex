...
<div id="reviews" class="woocommerce-Reviews">
	...
	<div id="comments">
		...
		<?php else : ?>
			...
			<p class="woocommerce-noreviews alert alert-warning" role="alert"><?php _e( 'There are no reviews yet.', 'woocommerce' ); ?></p>
			...
			<div id="review_form">
				...
				<?php
					...
					$comment_form = array(
						...
						'comment_notes_after'  => '',
						'fields'               => array(
							'author' => '<div class="form-group"><p class="comment-form-author">' . '<label for="author">' . __( 'Name', 'woocommerce' ) . ' <span class="required">*</span></label> ' .
							...
							'email'  => '<div class="form-group"><p class="comment-form-email"><label for="email">' . __( 'Email', 'woocommerce' ) . ' <span class="required">*</span></label> ' .
					...
					$comment_form['comment_field'] .= '<div class="form-group comment-form-comment"><label for="comment">' . esc_html__( 'Your review', 'woocommerce' ) . ' <span class="required">*</span></label><textarea class="form-control" id="comment" name="comment" cols="45" rows="8" aria-required="true" required></textarea></div>';
	...
	<?php else : ?>
		...
		<p class="woocommerce-verification-required alert alert-warning" role="alert"><?php _e( 'Only logged in customers who have purchased this product may leave a review.', 'woocommerce' ); ?></p>
