...
if (have_comments()) :
	...
	if ($comment_count > 0) : ?>
		...
		<div id="comments" class="the_comments">
            <div class="stars_and_bars">
                <span class="left"><?php _e('Comments', 'localize_semperfi'); ?></span></div>
	...
	if ($pings_and_tracks > 0) : ?>
        ...
        <div class="the_comments">
            <div class="stars_and_bars">
                <span class="left"><?php _e('Pingbacks &amp; Trackbacks', 'localize_semperfi'); ?></span></div>
...
<div id="comments" class="the_comments">
    <div class="stars_and_bars">
        <span class="left">Comments</span></div></div>
