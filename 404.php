	...
	<div class="row" id="blog" >
        ...
        <article class="post-container col-md-12">
			...
			<div class="post-article">
                ...
                <h2> <?php _e( 'Oops, it is a little bit embarassing...',"bazaar-lite" ) ?> </h2>           
			
				<?php _e( 'The page that you requested, was not found.','bazaar-lite'); ?> 

                <h2> <?php _e( 'What can i do?',"bazaar-lite" ) ?> </h2>           

                <p> <a href="<?php echo home_url(); ?>" title="<?php bloginfo('name') ?>"> <?php _e( 'Back to the homepage','bazaar-lite'); ?> </a> </p>
