    ...
    <div class="container">
        <div class="page-content">
            ...
            <div class="read-moresec">
                <a href="<?php echo esc_url( home_url() ); ?>" alt="<?php esc_html_e( 'Home link', 'bb-ecommerce-store' ); ?>" class="button"><?php esc_html_e( 'Back to Home Page', 'bb-ecommerce-store' ); ?><span class="screen-reader-text"><?php esc_html_e( 'Back to Home Page', 'bb-ecommerce-store' ); ?></span></a>
            </div>
