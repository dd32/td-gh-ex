				...
				<article id="post-0" class="post not-found">
					...
					<div class="entry-content">
						...
						<div class="not-found-options">
                            <a href="<?php echo esc_url(home_url('/')); ?>" class="alba-button"><?php esc_html_e( 'Return Home', 'conica' ) ?></a>
                            <a class="alba-button search-button"><?php esc_html_e( 'Search', 'conica' ) ?></a>
                        </div>
