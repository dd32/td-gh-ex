...
<article id="post-0" class="post error404 not-found">
	...
	if ( ! weaverx_getopt( '_hide_not_found_search' ) ) {
		...
		<div class="entry-content clearfix">
			<p><?php echo esc_html__( 'It seems we can&rsquo;t find what you&rsquo;re looking for. Perhaps searching, or one of the links below, can help.', 'weaver-xtreme' ); ?>
			</p>
			...
			?>
			<div class="widget">
				<h2 class="widgettitle"><?php echo esc_html__( 'Most Used Categories', 'weaver-xtreme' ); ?></h2>
				<ul>
					<?php
					wp_list_categories(
						array(
			...
			$archive_content = '<p>' . sprintf( esc_html__( 'Try looking in the monthly archives. %1$s', 'weaver-xtreme' ), convert_smilies( ':)' ) ) . '</p>';
			the_widget(
				'WP_Widget_Archives',
				array(
					'count'    => 0,
