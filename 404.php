...
get_header(); ?>
    <section>
        ...
        <div class="col-md-12 bread-row">
            <div class="container jobile-container">
            	<div class="col-md-6 no-padding-lr bread-left">
                    <h2><?php esc_html_e('404 Page not found','jobile'); ?></h2>
                </div>
    	...
    	<article class="about-article clearfix">	
            <h4><?php esc_html_e('Epic 404 - Article Not Found.','jobile'); ?></h4>
         <section class="post_content col-md-12">
			<h5><?php esc_html_e("This is embarassing. We can't find what you were looking for.",'jobile'); ?></h5>
