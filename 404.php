	...
	<div id="wrap" class="container clearfix">
		...
		<section id="content" class="primary" role="main">
			...
			<div class="type-page">
				...
				<h2 class="page-title"><?php esc_html_e( '404: Page not found', 'rubine-lite' ); ?></h2>
				
				<div class="entry">
					<p><?php esc_html_e( 'It looks like nothing was found at this location. Maybe try a search or one of the links below?', 'rubine-lite' ); ?></p>
