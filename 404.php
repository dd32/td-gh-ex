	...
	<div class="container">
        <div class="page-content">
			...
			<div class="read-moresec">
        		<a href="<?php echo esc_url(home_url() ); ?>" class="button"><?php esc_html_e( 'Back to Home Page', 'bb-mobile-application' ); ?><span class="screen-reader-text"><?php esc_html_e( 'Back to Home Page', 'bb-mobile-application' ); ?></span></a>
			</div>
