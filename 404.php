		...
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="title text-center">
					<h1><?php echo esc_html_e('404 Error Page','bagility'); ?></h1>
				</div>   
		...
		<div class="row v-center">
			<div class="col-md-12 col-sm-12 col-xs-12">							
				<div class="error-404 text-center">
					...
					<p><?php echo esc_html_e('We`re sorry, but the page you are looking for doesn`t exist.','bagility'); ?></p>
					<div class="btn-block text-center">
						<a href="#" class="btn-large btn-dark btn-animation" target="_blank"><?php echo esc_html_e('Go Back Homepage','bagility'); ?></a>
					</div>
				</div>
			</div>
		</div>
