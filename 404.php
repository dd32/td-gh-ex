        ...
        <div class="page-content">
			...
			<?php if( get_theme_mod('bb_wedding_bliss_button_404_page','Back to Home Page') != ''){ ?>
				<div class="read-moresec">
	        		<a href="<?php echo esc_url(home_url()); ?>" class="button"><?php echo esc_html(get_theme_mod('bb_wedding_bliss_button_404_page',__('Back to Home Page','bb-wedding-bliss')));?><span class="screen-reader-text"><?php echo esc_html(get_theme_mod('bb_wedding_bliss_button_404_page',__('Back to Home Page','bb-wedding-bliss')));?></span></a>
	        	</div>
        	<?php } ?>
        </div>
	</div>
