                ...
                <div <?php post_class( 'post' ); ?>>
                    ...
                    <div class="card" style="width: 500px;margin: 20px auto">
                        ...
                        <div  class="card-footer bg-white text-center">
                            <a href="<?php echo esc_url(home_url('/')); ?>"><?php _e('Back To Home', 'attire'); ?></a>
                        </div>
                    </div>
