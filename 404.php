...
<div id="content-ts">
	<div class="container">
        <div class="page-content">
			<h3><?php esc_html_e('404 Not Found', 'bb-mobile-application' ); ?></h3>
			...
			<div class="read-moresec">
        		<a href="<?php echo esc_url(home_url() ); ?>" class="button hvr-sweep-to-right"><?php esc_html_e( 'Back to Home Page', 'bb-mobile-application' ); ?></a>
			</div>
