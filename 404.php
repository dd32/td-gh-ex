	...
	<div class="container">
        <div class="middle-align">
			...
			<div class="read-moresec">
        		<a href="<?php echo esc_url(home_url() ) ?>" alt="<?php esc_html_e( 'Home link', 'advance-portfolio' ); ?>" class="button"><?php esc_html_e( 'Back to Home Page', 'advance-portfolio' ); ?><span class="screen-reader-text"><?php esc_html_e( 'Back to Home Page', 'advance-portfolio' ); ?></span></a>
        	</div>
