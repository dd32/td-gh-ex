		...
		<div <?php b3theme_content_wrap_class(); ?>>
			<section class="error-404 not-found  <?php echo b3theme_option('panel_post') ? 'spacer-all' : ''; ?>">
				...
				<div class="page-content">
					<p><?php _e('It looks like nothing was found at this location. Maybe try one of the links below or a search?', 'b3theme'); ?></p>

					<?php get_search_form(); ?>

					<?php the_widget('WP_Widget_Recent_Posts'); ?>

					<?php if ( b3theme_categorized_blog() ) : // Only show the widget if site has multiple categories. ?>
