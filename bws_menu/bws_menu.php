	...
	function bws_add_themes_menu_render() {
		...
		$bws_plugins = array(
			'captcha/captcha.php'                               => array(
				'name'         => 'Captcha',
				'description'  => __( 'Plugin intended to prove that the visitor is a human being and not a spam robot.', 'bestwebsoft' ),
				'link'         => 'https://wordpress.org/plugins/captcha/',
			...
			'contact-form-plugin/contact_form.php'              => array(
				'name'         => 'Contact Form',
				'description'  => __( 'Add Contact Form to your WordPress website.', 'bestwebsoft' ),
				'link'         => 'https://wordpress.org/plugins/contact-form-plugin/',
			...
			'facebook-button-plugin/facebook-button-plugin.php' => array(
				...
				'description'  => __( 'Allows you to add the Follow and Like buttons the easiest way.', 'bestwebsoft' ),
				'link'         => 'https://wordpress.org/plugins/facebook-button-plugin/',
			...
			'twitter-plugin/twitter.php'                        => array(
				'name'         => 'Twitter',
				'description'  => __( 'Allows you to add the Twitter "Follow" and "Like" buttons the easiest way.', 'bestwebsoft' ),
				'link'         => 'https://wordpress.org/plugins/twitter-plugin/',
			...
			'portfolio/portfolio.php'                           => array(
				'name'        => 'Portfolio',
				'description' => __( 'Allows you to create a page with the information about your past projects.', 'bestwebsoft' ),
				'link'        => 'https://wordpress.org/plugins/portfolio/',
			...
			'gallery-plugin/gallery-plugin.php'                 => array(
				'name'         => 'Gallery',
				'description'  => __( 'Allows you to implement a Gallery page into your website.', 'bestwebsoft' ),
				'link'         => 'https://wordpress.org/plugins/gallery-plugin/',
			...
			'adsense-plugin/adsense-plugin.php'                 => array(
				...
				'description' => __( 'Allows Google AdSense implementation to your website.', 'bestwebsoft' ),
				'link'        => 'https://wordpress.org/plugins/adsense-plugin/',
			...
			'custom-search-plugin/custom-search-plugin.php'     => array(
				'name'        => 'Custom Search',
				'description' => __( 'Allows to extend your website search functionality by adding a custom post type.', 'bestwebsoft' ),
				'link'        => 'https://wordpress.org/plugins/custom-search-plugin/',
			...
			'quotes-and-tips/quotes-and-tips.php'               => array(
				...
				'description' => __( 'Allows you to implement quotes & tips block into your web site.', 'bestwebsoft' ),
				'link'        => 'https://wordpress.org/plugins/quotes-and-tips/',
			...
			'google-sitemap-plugin/google-sitemap-plugin.php'   => array(
				...
				'description'  => __( 'Allows you to add sitemap file to Google Webmaster Tools.', 'bestwebsoft' ),
				'link'         => 'https://wordpress.org/plugins/google-sitemap-plugin/',
			...
			'updater/updater.php'                               => array(
				'name'         => 'Updater',
				'description'  => __( 'Allows you to update plugins and WP core.', 'bestwebsoft' ),
				'link'         => 'https://wordpress.org/plugins/updater/',
			...
			'custom-fields-search/custom-fields-search.php'     => array(
				...
				'description' => __( 'Allows you to add website search any existing custom fields.', 'bestwebsoft' ),
				'link'        => 'https://wordpress.org/plugins/custom-fields-search/',
			...
			'google-one/google-plus-one.php'                    => array(
				...
				'description'  => __( 'Allows you to see how many times your page has been liked on Google Search Engine as well as who has liked the article.', 'bestwebsoft' ),
				'link'         => 'https://wordpress.org/plugins/google-one/',
			...
			'relevant/related-posts-plugin.php'                 => array(
				...
				'description' => __( 'Allows you to display related posts with similar words in category, tags, title or by adding special meta key for posts.', 'bestwebsoft' ),
				'link'        => 'https://wordpress.org/plugins/relevant/',
			...
			'contact-form-to-db/contact_form_to_db.php'         => array(
				...
				'description'  => __( 'Allows you to manage the messages that have been sent from your site.', 'bestwebsoft' ),
				'link'         => 'https://wordpress.org/plugins/contact-form-to-db/',
			...
			'pdf-print/pdf-print.php'                           => array(
				'name'         => 'PDF & Print',
				'description'  => __( 'Allows you to create PDF and Print page with adding appropriate buttons to the content.', 'bestwebsoft' ),
			...
			'donate-button/donate.php'                          => array(
				'name'        => 'Donate',
				'description' => __( 'Makes it possible to place donation buttons of various payment systems on your web page.', 'bestwebsoft' ),
				'link'        => 'https://wordpress.org/plugins/donate-button/',
			...
			'post-to-csv/post-to-csv.php'                       => array(
				'name'        => 'Post To CSV',
				'description' => __( 'The plugin allows to export posts of any types to a csv file.', 'bestwebsoft' ),
				'link'        => 'https://wordpress.org/plugins/post-to-csv/',
			...
			'google-shortlink/google-shortlink.php'             => array(
				...
				'description' => __( 'Allows you to get short links from goo.gl servise without leaving your site.', 'bestwebsoft' ),
				'link'        => 'https://wordpress.org/plugins/google-shortlink/',
			...
			'htaccess/htaccess.php'                             => array(
				'name'         => 'Htaccess',
				'description'  => __( 'Allows controlling access to your website using the directives Allow and Deny.', 'bestwebsoft' ),
				'link'         => 'https://wordpress.org/plugins/htaccess/',
				...
				'purchase'     => 'http://bestwebsoft.com/products/htaccess/buy/?k=59e9209a32864be534fda77d5e591c15&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
			...
			'sender/sender.php'                                 => array(
				'name'         => 'Sender',
				'description'  => __( 'You can send mails to all users or to certain categories of users.', 'bestwebsoft' ),
				'link'         => 'https://wordpress.org/plugins/sender/',
			...
			'subscriber/subscriber.php'                         => array(
				'name'         => 'Subscriber',
				'description'  => __( 'This plugin allows you to subscribe users for newsletters from your website.', 'bestwebsoft' ),
				'link'         => 'https://wordpress.org/plugins/subscriber/',
				...
				'purchase'     => 'http://bestwebsoft.com/products/subscriber/buy/?k=02dbb8b549925d9b74e70adc2a7282e4&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
			...
			'contact-form-multi/contact-form-multi.php'         => array(
				...
				'description'  => __( 'This plugin allows you to subscribe users for newsletters from your website.', 'bestwebsoft' ),
				'link'         => 'https://wordpress.org/plugins/contact-form-multi/',
			...
			'bws-google-maps/bws-google-maps.php'               => array(
				...
				'description'  => __( 'Easy to set up and insert Google Maps to your website.', 'bestwebsoft' ),
				'link'         => 'https://wordpress.org/plugins/bws-google-maps/',
			...
			'bws-google-analytics/bws-google-analytics.php'     => array(
				...
				'description'  => __( 'Allows you to retrieve basic stats from Google Analytics account and add the tracking code to your blog.', 'bestwebsoft' ),
				'link'         => 'https://wordpress.org/plugins/bws-google-analytics/',
				...
				'purchase'     => 'http://bestwebsoft.com/products/bws-google-analytics/buy/?k=83796e84fec3f70ecfcc8894a73a6c4a&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
				'pro_settings' => 'admin.php?page=bws-google-analytics-pro.php',
			),
			'db-manager/db-manager.php'                         => array(
				'name'        => 'DB manager',
				'description' => __( 'Allows you to download the latest version of PhpMyadmin and Dumper and manage your site.', 'bestwebsoft' ),
			...
			'user-role/user-role.php'                           => array(
				'name'         => 'User Role',
				'description'  => __( 'Allows to change wordpress user role capabilities.', 'bestwebsoft' ),
				'link'         => 'https://wordpress.org/plugins/user-role/',
			...
			'email-queue/email-queue.php'                       => array(
				'name'        => 'Email Queue',
				'description' => __( 'Allows to manage email massages sent by BestWebSoft plugins.', 'bestwebsoft' ),
				'link'        => 'https://wordpress.org/plugins/email-queue/',
			...
			'limit-attempts/limit-attempts.php'                 => array(
				'name'         => 'Limit Attempts',
				'description'  => __( 'Allows you to limit rate of login attempts by the ip, and create whitelist and blacklist.', 'bestwebsoft' ),
				'link'         => 'https://wordpress.org/plugins/limit-attempts/',
			...
			'job-board/job-board.php'                           => array(
				'name'        => 'Job board',
				'description' => __( 'Allows to create a job-board page on your site.', 'bestwebsoft' ),
				'link'        => 'https://wordpress.org/plugins/job-board/',
			...
			'multilanguage/multilanguage.php'                   => array(
				'name'        => 'Multilanguage',
				'description' => __( 'Allows to create content on a Wordpress site in different languages.', 'bestwebsoft' ),
				'link'        => 'https://wordpress.org/plugins/multilanguage/',
			...
			'bws-popular-posts/bws-popular-posts.php'           => array(
				...
				'description' => __( 'This plugin will help you can display the most popular posts on your blog in the widget.', 'bestwebsoft' ),
				'link'        => 'https://wordpress.org/plugins/bws-popular-posts/',
				'download'    => 'http://bestwebsoft.com/products/popular-posts/download/?k=4d529f116d2b7f7df3a78018c383f975&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
			...
			'bws-testimonials/bws-testimonials.php'             => array(
				...
				'description' => __( 'Allows creating and displaying a Testimonial on your website.', 'bestwebsoft' ),
				'link'        => 'https://wordpress.org/plugins/bws-testimonials/',
				'download'    => 'http://bestwebsoft.com/products/testimonials/download/?k=3fe4bb89dc901c98e43a113e08f8db73&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
			...
			'bws-featured-posts/bws-featured-posts.php'         => array(
				...
				'description' => __( 'Displays featured posts randomly on any website page.', 'bestwebsoft' ),
				'link'        => 'https://wordpress.org/plugins/bws-featured-posts/',
				'download'    => 'http://bestwebsoft.com/products/featured-posts/download/?k=f0afb31185ba7c7d6d598528d69f6d97&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
			...
			'gallery-categories/gallery-categories.php'         => array(
				...
				'description' => __( 'Add-on for Gallery Plugin by BestWebSoft', 'bestwebsoft' ),
				'link'        => 'https://wordpress.org/plugins/gallery-categories/',
				'download'    => 'http://bestwebsoft.com/products/gallery-categories/download/?k=7d68c7bfec2486dc350c67fff57ad433&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
			...
			're-attacher/re-attacher.php'                       => array(
				'name'        => 'Re-attacher',
				'description' => __( 'This plugin allows to attach, unattach or reattach media item in different post.', 'bestwebsoft' ),
				'link'        => 'https://wordpress.org/plugins/re-attacher/',
				'download'    => 'http://bestwebsoft.com/products/re-attacher/download/?k=4d529f116d2b7f7df3a78018c383f975&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
			...
			'bws-smtp/bws-smtp.php'                             => array(
				...
				'description' => __( 'This plugin introduces an easy way to configure sending email messages via SMTP.', 'bestwebsoft' ),
				'link'        => 'https://wordpress.org/plugins/bws-smtp/',
				'download'    => 'http://bestwebsoft.com/products/bws-smtp/download/?k=0546419f962704429ad2d9b88567752f&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
			...
			'promobar/promobar.php'                             => array(
				'name'         => 'PromoBar',
				'description'  => __( 'This plugin allows placing banners with any data on your website.', 'bestwebsoft' ),
				'link'         => 'https://wordpress.org/plugins/promobar/',
				'download'     => 'http://bestwebsoft.com/products/promobar/download/?k=619eac2232d9cfa382c4e678c3b14766&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
				...
				'purchase'     => 'http://bestwebsoft.com/products/promobar/buy/?k=a9b09708502f12a1483532ba12fe2103&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
				'pro_settings' => 'admin.php?page=promobar-pro.php',
			),
			'realty/realty.php'                                 => array(
				'name'         => 'Realty',
				'description'  => __( 'A convenient plugin that adds Real Estate functionality.', 'bestwebsoft' ),
				'link'         => 'https://wordpress.org/plugins/realty/',
				'download'     => 'http://bestwebsoft.com/products/realty/download/?k=d55de979dbbbb7af0b2ff1d7f43884fa&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
				...
				'purchase'     => 'http://bestwebsoft.com/products/realty/buy/?k=c7791f0a72acfb36f564a614dbccb474&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
			...
			'zendesk-help-center/zendesk-help-center.php'       => array(
				...
				'description' => __( 'This plugin allows to backup Zendesk Help Center.', 'bestwebsoft' ),
				'link'        => 'https://wordpress.org/plugins/zendesk-help-center/',
				'download'    => 'http://bestwebsoft.com/products/zendesk-help-center/download/?k=2a5fd2f4b2f4bde46f2ca44b8d15846d&pn=' . $bws_theme_info["id"] . '&v=' . $bws_theme_info["version"] . '&wp_v=' . $wp_version,
		...
		<div class="wrap">
			...
			<h2>
				...
				<ul class="subsubsub bws_title_menu">
					<li>
						<a href="<?php echo esc_url( 'http://support.bestwebsoft.com/home' ); ?>" target="_blank"><?php _e( 'Need help?', 'bestwebsoft' ); ?></a>
					</li>
					<li>
						<a href="<?php echo esc_url( 'http://bestwebsoft.com/wp-login.php' ); ?>" target="_blank"><?php _e( 'Client area', 'bestwebsoft' ); ?></a>
					</li>
					<li><a class="bws_system_status <?php if ( isset( $_GET['action'] ) && 'system_status' == $_GET['action'] ) echo ' nav-tab-active'; ?>" href="admin.php?page=bws_themes&amp;action=system_status"><?php _e( 'System status', 'bestwebsoft' ); ?></a>
					</li>
				</ul>
				<div class="clear"></div>
			</h2>
			...
			<?php if ( isset( $_GET['action'] ) && 'plugins' == $_GET['action'] ) { ?>
				<ul class="subsubsub">
					...
					<li><a <?php if ( isset( $_GET['sub'] ) && 'installed' == $_GET['sub'] ) echo 'class="current" '; ?>href="admin.php?page=bws_themes&amp;action=plugins&amp;sub=installed"><?php _e( 'Installed', 'bestwebsoft' ); ?></a>
					</li>
					<li><a <?php if ( isset( $_GET['sub'] ) && 'recommended' == $_GET['sub'] ) echo 'class="current" '; ?>href="admin.php?page=bws_themes&amp;action=plugins&amp;sub=recommended"><?php _e( 'Recommended', 'bestwebsoft' ); ?></a>
					</li>
				</ul>
				<div class="clear"></div>
			...
			<?php } elseif ( ! isset( $_GET['action'] ) || ( isset( $_GET['action'] ) && 'themes' == $_GET['action'] ) ) { ?>
				<div id="availablethemes">
					...
					load_template( ABSPATH . 'wp-admin/includes/theme-install.php' );
					load_template( ABSPATH . 'wp-admin/includes/class-wp-themes-list-table.php' );
					load_template( ABSPATH . 'wp-admin/includes/class-wp-theme-install-list-table.php' );
								...
								<div class="action-links">
									<ul>
										...
										<li class="hide-if-no-js">
											<a href="#" class="theme-detail"><?php _e( 'Details', 'bestwebsoft' ) ?></a></li>
									</ul>
								</div>
			...
			<?php } elseif ( 'system_status' == $_GET['action'] ) { ?>
				<div class="updated fade" <?php if ( ! ( isset( $_REQUEST['bwsmn_form_submit'] ) || isset( $_REQUEST['bwsmn_form_submit_custom_email'] ) ) || $error != "" ) echo "style=\"display:none\""; ?>>
				...
				<div class="inside">
					<table class="bws_system_info">
						<thead>
						<tr>
							<th><?php _e( 'Environment', 'bestwebsoft' ); ?></th>
							<td></td>
						</tr>
						</thead>
						<tbody>
					...
					<table class="bws_system_info">
						<thead>
						<tr>
							<th><?php _e( 'Active Plugins', 'bestwebsoft' ); ?></th>
							<th></th>
						</tr>
						</thead>
						<tbody>
					...
					<table class="bws_system_info">
						<thead>
						<tr>
							<th><?php _e( 'Inactive Plugins', 'bestwebsoft' ); ?></th>
							<th></th>
						</tr>
						</thead>
						<tbody>
