...
{	
	...
	return $theme_options=array(
			...
			'slider_image_one_description'=> __('Corpbiz is extremely clean in each code line, intensely awesome in wvery homepage, supper easy to use, highly flexible with responsive feature.','corpbiz'),
			...
			'home_support_desciption_one'=>__('Lorem ipsum dolor sit amet, consectetur faucibus risus non iaculis. Fusce a augue Fusce in turpis in','corpbiz'),
			'home_support_learn_more_text_one'=>__('learn more','corpbiz'),
			...
			'home_support_desciption_two'=>__('Lorem ipsum dolor sit amet, consectetur faucibus risus non iaculis. Fusce a augue Fusce in turpis in','corpbiz'),
			'home_support_learn_more_text_two'=>__('learn more','corpbiz'),
			...
			'home_support_desciption_three'=>__('Lorem ipsum dolor sit amet, consectetur faucibus risus non iaculis. Fusce a augue Fusce in turpis in','corpbiz'),
			'home_support_learn_more_text_three'=>__('learn more','corpbiz'),
			'home_support_learn_more_link_three'=>'#',
			'home_support_learn_more_target_three'=>true,
			
			//	testimonial			
			'home_testimonial_title'=> __('What Our Clients Say','corpbiz'),
			'home_testimonial_desciption'=>__('lets see what we hear from our valuable clients','corpbiz'),
			
			//blog
			'blog_meta_section_settings' => false,
			'blog_selected_category_id'=> 1,
			'blog_title' => 'From Blog',
			'blog_description' => __('Latest blog Description','corpbiz'),
			'post_display_count' => '3' ,
			
			//Footer call out area
			'call_out_title'=>__('Get your app ideas transformed into reality','corpbiz'),
			'call_out_text'=>__('Lorem ipsum dolor sit amet, consectetur faucibus risus non iaculis. Fusce a augue Fusce in turpis in.','corpbiz'),
			'call_out_button_text'=>__('Buy it Now','corpbiz'),
			...
			'contect_info_description' => __('Aliquam suscipit quis odio a volutpat. Aenean sed sagittis dolor. Pellentesque vitae fermentum diam, vitae gravida eros. Proin interdum imperdiet elit, in auctor sem consequat sed.','corpbiz'),
			'send_usmessage' => __('Contact Us','corpbiz'),
			'our_office_enabled'=>'on',
			'contact_address'=>__('138, AtlantisLnKingsport ','corpbiz'),
			'contact_address_two'=>__('Illinois. 121164 ','corpbiz'),
