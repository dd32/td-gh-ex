...
<article class="page-wrapper">
    <div id="post-<?php the_ID(); ?>" <?php post_class('work-post'); ?>>
        <div class="container">
            ...
            ?>
            <div class="row">
                <div class="col-xs-12 col-sm-8 col-md-8 <?php if (!empty($mp_artwork_img)) { ?> col-lg-6 col-lg-offset-3 <?php } else { ?> col-lg-8 col-lg-offset-2 <?php } ?> col-sm-offset-2 col-md-offset-2 ">  
