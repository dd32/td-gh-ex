 ...
 */
(function(){var i=typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?function(C){return typeof C}:function(C){return C&&typeof Symbol==="function"&&C.constructor===Symbol&&C!==Symbol.prototype?"symbol":typeof C};var u=function(){function C(G,E){for(var D=0;D<E.length;D++){var F=E[D];F.enumerable=F.enumerable||false;F.configurable=true;if("value" in F){F.writable=true}Object.defineProperty(G,F.key,F)}}return function(F,D,E){if(D){C(F.prototype,D)}if(E){C(F,E)}return F}}();function d(C,D){if(!(C instanceof D)){throw new TypeError("Cannot call a class as a function")}}var o=document.createElement("div");function h(E){var D=["O","Moz","ms","Ms","Webkit"];var C=D.length;if(o.style[E]!==undefined){return true}E=E.charAt(0).toUpperCase()+E.substr(1);while(--C>-1&&o.style[D[C]+E]===undefined){}return C>=0}var k=h("transform");var l=h("perspective");var w=navigator.userAgent;var A=w.toLowerCase().indexOf("android")>-1;var t=/iPad|iPhone|iPod/.test(w)&&!window.MSStream;var e=w.toLowerCase().indexOf("firefox")>-1;var p=w.indexOf("MSIE ")>-1||w.indexOf("Trident/")>-1||w.indexOf("Edge/")>-1;var x=document.all&&!window.atob;var r=window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||function(C){setTimeout(C,1000/60)};function n(E,C,D){if(E.addEventListener){E.addEventListener(C,D)}else{E.attachEvent("on"+C,function(){D.call(E)})}}var v=void 0;var a=void 0;var s=void 0;function m(){v=window.innerWidth||document.documentElement.clientWidth;a=window.innerHeight||document.documentElement.clientHeight}m();n(window,"resize",m);n(window,"orientationchange",m);n(window,"load",m);var b=[];var z=false;function g(){if(!b.length){return}if(window.pageYOffset!==undefined){s=window.pageYOffset}else{s=(document.documentElement||document.body.parentNode||document.body).scrollTop}var D=!z||z.width!==v||z.height!==a;var C=D||!z||z.y!==s;if(D||C){b.forEach(function(E){if(D){E.onResize()}if(C){E.onScroll()}})}z={width:v,height:a,y:s};r(g)}var j=0;var y=function(){function D(U,W){d(this,D);var Y=this;Y.instanceID=j++;Y.$item=U;Y.defaults={type:"scroll",speed:0.5,imgSrc:null,imgElement:".jarallax-img",imgSize:"cover",imgPosition:"50% 50%",imgRepeat:"no-repeat",keepImg:false,elementInViewport:null,zIndex:-100,noAndroid:false,noIos:false,videoSrc:null,videoStartTime:0,videoEndTime:0,videoVolume:0,videoPlayOnlyVisible:true,onScroll:null,onInit:null,onDestroy:null,onCoverImage:null};var V=Y.$item.getAttribute("data-jarallax");var R=JSON.parse(V||"{}");if(V){console.warn("Detected usage of deprecated data-jarallax JSON options, you should use pure data-attribute options. See info here - https://github.com/nk-o/jarallax/issues/53")}var X=Y.$item.dataset;var S={};Object.keys(X).forEach(function(Z){var aa=Z.substr(0,1).toLowerCase()+Z.substr(1);if(aa&&typeof Y.defaults[aa]!=="undefined"){S[aa]=X[Z]}});Y.options=Y.extend({},Y.defaults,R,S,W);Y.pureOptions=Y.extend({},Y.options);Object.keys(Y.options).forEach(function(Z){if(Y.options[Z]==="true"){Y.options[Z]=true}else{if(Y.options[Z]==="false"){Y.options[Z]=false}}});Y.options.speed=Math.min(2,Math.max(-1,parseFloat(Y.options.speed)));var T=Y.options.elementInViewport;if(T&&(typeof T==="undefined"?"undefined":i(T))==="object"&&typeof T.length!=="undefined"){T=T[0]}if(!(T instanceof Element)){T=null}Y.options.elementInViewport=T;Y.image={src:Y.options.imgSrc||null,$container:null,useImgTag:t||A||p,position:!l||e?"absolute":"fixed"};if(Y.initImg()&&Y.canInitParallax()){Y.init()}}u(D,[{key:"css",value:function J(R,S){if(typeof S==="string"){if(window.getComputedStyle){return window.getComputedStyle(R).getPropertyValue(S)}return R.style[S]}if(S.transform){if(l){S.transform+=" translateZ(0)"}S.WebkitTransform=S.transform;S.MozTransform=S.transform;S.msTransform=S.transform;S.OTransform=S.transform}Object.keys(S).forEach(function(T){R.style[T]=S[T]});return R}},{key:"extend",value:function M(R){var S=arguments;R=R||{};Object.keys(arguments).forEach(function(T){if(!S[T]){return}Object.keys(S[T]).forEach(function(U){R[U]=S[T][U]})});return R}},{key:"getWindowData",value:function O(){return{width:v,height:a,y:s}}},{key:"initImg",value:function N(){var S=this;var R=S.options.imgElement;if(R&&typeof R==="string"){R=S.$item.querySelector(R)}if(!(R instanceof Element)){R=null}if(R){if(S.options.keepImg){S.image.$item=R.cloneNode(true)}else{S.image.$item=R;S.image.$itemParent=R.parentNode}S.image.useImgTag=true;S.image.useCustomImgTag=true}if(S.image.$item){return true}if(S.image.src===null){S.image.src=S.css(S.$item,"background-image").replace(/^url\(['"]?/g,"").replace(/['"]?\)$/g,"")}return !(!S.image.src||S.image.src==="none")}},{key:"canInitParallax",value:function H(){return k&&!(A&&this.options.noAndroid)&&!(t&&this.options.noIos)}},{key:"init",value:function Q(){var Y=this;var S={position:"absolute",top:0,left:0,width:"100%",height:"100%",overflow:"hidden",pointerEvents:"none"};var V={};if(!Y.options.keepImg){var T=Y.$item.getAttribute("style");if(T){Y.$item.setAttribute("data-jarallax-original-styles",T)}if(Y.image.$item&&Y.image.useCustomImgTag){var X=Y.image.$item.getAttribute("style");if(X){Y.image.$item.setAttribute("data-jarallax-original-styles",X)}}}if(Y.css(Y.$item,"position")==="static"){Y.css(Y.$item,{position:"relative"})}if(Y.css(Y.$item,"z-index")==="auto"){Y.css(Y.$item,{zIndex:0})}Y.image.$container=document.createElement("div");Y.css(Y.image.$container,S);Y.css(Y.image.$container,{"z-index":Y.options.zIndex});Y.image.$container.setAttribute("id","jarallax-container-"+Y.instanceID);Y.$item.appendChild(Y.image.$container);if(Y.image.useImgTag){if(!Y.image.$item){Y.image.$item=document.createElement("img");Y.image.$item.setAttribute("src",Y.image.src)}V=Y.extend({"object-fit":Y.options.imgSize,"font-family":"object-fit: "+Y.options.imgSize+"; object-position: "+Y.options.imgPosition+";","max-width":"none"},S,V)}else{Y.image.$item=document.createElement("div");V=Y.extend({"background-position":Y.options.imgPosition,"background-size":Y.options.imgSize,"background-repeat":Y.options.imgRepeat,"background-image":'url("'+Y.image.src+'")'},S,V)}var U=0;var W=Y.$item;while(W!==null&&W!==document&&U===0){var R=Y.css(W,"-webkit-transform")||Y.css(W,"-moz-transform")||Y.css(W,"transform");if(R&&R!=="none"){U=1;Y.css(Y.image.$container,{transform:"translateX(0) translateY(0)"})}W=W.parentNode}if(U||Y.options.type==="opacity"||Y.options.type==="scale"||Y.options.type==="scale-opacity"||Y.options.speed===1){Y.image.position="absolute"}V.position=Y.image.position;Y.css(Y.image.$item,V);Y.image.$container.appendChild(Y.image.$item);Y.coverImage();Y.clipContainer();Y.onScroll(true);if(Y.options.onInit){Y.options.onInit.call(Y)}if(Y.css(Y.$item,"background-image")!=="none"){Y.css(Y.$item,{"background-image":"none"})}Y.addToParallaxList()}},{key:"addToParallaxList",value:function K(){b.push(this);if(b.length===1){g()}}},{key:"removeFromParallaxList",value:function F(){var R=this;b.forEach(function(T,S){if(T.instanceID===R.instanceID){b.splice(S,1)}})}},{key:"destroy",value:function P(){var T=this;T.removeFromParallaxList();var S=T.$item.getAttribute("data-jarallax-original-styles");T.$item.removeAttribute("data-jarallax-original-styles");if(!S){T.$item.removeAttribute("style")}else{T.$item.setAttribute("style",S)}if(T.image.$item&&T.image.useCustomImgTag){var R=T.image.$item.getAttribute("data-jarallax-original-styles");T.image.$item.removeAttribute("data-jarallax-original-styles");if(!R){T.image.$item.removeAttribute("style")}else{T.image.$item.setAttribute("style",S)}if(T.image.$itemParent){T.image.$itemParent.appendChild(T.image.$item)}}if(T.$clipStyles){T.$clipStyles.parentNode.removeChild(T.$clipStyles)}if(T.image.$container){T.image.$container.parentNode.removeChild(T.image.$container)}if(T.options.onDestroy){T.options.onDestroy.call(T)}delete T.$item.jarallax}},{key:"clipContainer",value:function E(){if(x){return}if(this.image.position!=="fixed"){return}var W=this;var V=W.image.$container.getBoundingClientRect();var T=V.width;var R=V.height;if(!W.$clipStyles){W.$clipStyles=document.createElement("style");W.$clipStyles.setAttribute("type","text/css");W.$clipStyles.setAttribute("id","jarallax-clip-"+W.instanceID);var S=document.head||document.getElementsByTagName("head")[0];S.appendChild(W.$clipStyles)}var U=["#jarallax-container-"+W.instanceID+" {","   clip: rect(0 "+T+"px "+R+"px 0);","   clip: rect(0, "+T+"px, "+R+"px, 0);","}"].join("\n");if(W.$clipStyles.styleSheet){W.$clipStyles.styleSheet.cssText=U}else{W.$clipStyles.innerHTML=U}}},{key:"coverImage",value:function G(){var Y=this;var U=Y.image.$container.getBoundingClientRect();var S=U.height;var V=Y.options.speed;var W=Y.options.type==="scroll"||Y.options.type==="scroll-opacity";var X=0;var T=S;var R=0;if(W){if(V<0){X=V*Math.max(S,a)}else{X=V*(S+a)}if(V>1){T=Math.abs(X-a)}else{if(V<0){T=X/V+Math.abs(X)}else{T+=Math.abs(a-S)*(1-V)}}X/=2}Y.parallaxScrollDistance=X;if(W){R=(a-T)/2}else{R=(S-T)/2}Y.css(Y.image.$item,{height:T+"px",marginTop:R+"px",left:Y.image.position==="fixed"?U.left+"px":"0",width:U.width+"px"});if(Y.options.onCoverImage){Y.options.onCoverImage.call(Y)}return{image:{height:T,marginTop:R},container:U}}},{key:"isVisible",value:function I(){return this.isElementInViewport||false}},{key:"onScroll",value:function L(T){var ab=this;var ad=ab.$item.getBoundingClientRect();var X=ad.top;var af=ad.height;var ah={};var U=ad;if(ab.options.elementInViewport){U=ab.options.elementInViewport.getBoundingClientRect()}ab.isElementInViewport=U.bottom>=0&&U.right>=0&&U.top<=a&&U.left<=v;if(T?false:!ab.isElementInViewport){return}var V=Math.max(0,X);var ag=Math.max(0,af+X);var ae=Math.max(0,-X);var ac=Math.max(0,X+af-a);var Y=Math.max(0,af-(X+af-a));var Z=Math.max(0,-X+a-af);var S=1-2*(a-X)/(a+af);var R=1;if(af<a){R=1-(ae||ac)/af}else{if(ag<=a){R=ag/a}else{if(Y<=a){R=Y/a}}}if(ab.options.type==="opacity"||ab.options.type==="scale-opacity"||ab.options.type==="scroll-opacity"){ah.transform="";ah.opacity=R}if(ab.options.type==="scale"||ab.options.type==="scale-opacity"){var W=1;if(ab.options.speed<0){W-=ab.options.speed*R}else{W+=ab.options.speed*(1-R)}ah.transform="scale("+W+")"}if(ab.options.type==="scroll"||ab.options.type==="scroll-opacity"){var aa=ab.parallaxScrollDistance*S;if(ab.image.position==="absolute"){aa-=X}ah.transform="translateY("+aa+"px)"}ab.css(ab.image.$item,ah);if(ab.options.onScroll){ab.options.onScroll.call(ab,{section:ad,beforeTop:V,beforeTopEnd:ag,afterTop:ae,beforeBottom:ac,beforeBottomEnd:Y,afterBottom:Z,visiblePercent:R,fromViewportCenter:S})}}},{key:"onResize",value:function C(){this.coverImage();this.clipContainer()}}]);return D}();var c=function c(E){if((typeof HTMLElement==="undefined"?"undefined":i(HTMLElement))==="object"?E instanceof HTMLElement:E&&(typeof E==="undefined"?"undefined":i(E))==="object"&&E!==null&&E.nodeType===1&&typeof E.nodeName==="string"){E=[E]}var H=arguments[1];var G=Array.prototype.slice.call(arguments,2);var C=E.length;var D=0;var F=void 0;for(D;D<C;D++){if((typeof H==="undefined"?"undefined":i(H))==="object"||typeof H==="undefined"){if(!E[D].jarallax){E[D].jarallax=new y(E[D],H)}}else{if(E[D].jarallax){F=E[D].jarallax[H].apply(E[D].jarallax,G)}}if(typeof F!=="undefined"){return F}}return E};c.constructor=y;var B=window.jarallax;window.jarallax=c;window.jarallax.noConflict=function(){window.jarallax=B;return this};if(typeof jQuery!=="undefined"){var q=function q(){var C=arguments||[];Array.prototype.unshift.call(C,this);var D=c.apply(window,C);return(typeof D==="undefined"?"undefined":i(D))!=="object"?D:this};q.constructor=y;var f=jQuery.fn.jarallax;jQuery.fn.jarallax=q;jQuery.fn.jarallax.noConflict=function(){jQuery.fn.jarallax=f;return this}}n(window,"DOMContentLoaded",function(){c(document.querySelectorAll("[data-jarallax]"))})}());