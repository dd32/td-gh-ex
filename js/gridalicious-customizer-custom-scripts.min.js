 ...
 * Control of show/hide events on feature grid content type selection
 */
(function($) {
    ...
    /*
     * For Feature Grid Content on featured_grid_content_type change event
     */
    ...
    $('#accordion-panel-gridalicious_featured_grid_content .accordion-section-title').live( "click", function() {
        ...
        if (value == 'featured-page-grid-content') {
    ...
    /**
     * Control of show/hide events on feature grid_content type selection on page load if prevously value has been saved
     * For WordPress versions less than 4.0
     */
    var gridalicious_featured_grid_content_layout_value = $("#customize-control-gridalicious_featured_grid_content_type label select").val();

    if (gridalicious_featured_grid_content_layout_value == 'demo-featured-grid-content') {
        $('#customize-control-gridalicious_featured_grid_content_page').hide();
    } else {
        $('#customize-control-gridalicious_featured_grid_content_page').show();
    }

    if (gridalicious_featured_grid_content_layout_value == 'featured-page-grid-content') {
        $('[id*=customize-control-gridalicious_featured_grid_content_page]').show();
    } else {
        $('[id*=customize-control-gridalicious_featured_grid_content_page]').hide();
    }
