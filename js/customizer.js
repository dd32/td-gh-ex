...
( function( $ ) {
	...
	wp.customize( 'avid_magazine_logo_size', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'site_title_color_option', function( value ) {
		value.bind( function( to ) {
			$( 'header .logo h1, header .logo h2' ).css( 'color', to );
		} );
	} );
	...
	wp.customize( 'avid_magazine_font_weight', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'avid_magazine_line_height', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'avid_magazine_heading_1_size', function( value ) {
		value.bind( function( to ) {
			$( '.content-area h1' ).css( 'font-size', to + 'px' );
		} );
	} );

	wp.customize( 'avid_magazine_heading_2_size', function( value ) {
		value.bind( function( to ) {
			$( '.content-area h2' ).css( 'font-size', to + 'px' );
		} );
	} );

	wp.customize( 'avid_magazine_heading_3_size', function( value ) {
		value.bind( function( to ) {
			$( 'h3' ).css( 'font-size', to + 'px' );
		} );
	} );

	wp.customize( 'avid_magazine_heading_4_size', function( value ) {
		value.bind( function( to ) {
			$( 'h4' ).css( 'font-size', to + 'px' );
		} );
	} );

	wp.customize( 'avid_magazine_heading_5_size', function( value ) {
		value.bind( function( to ) {
			$( 'h5' ).css( 'font-size', to + 'px' );
		} );
	} );

	wp.customize( 'avid_magazine_heading_6_size', function( value ) {
	...
	wp.customize( 'avid_magazine_slider_layouts', function( value ) {
		value.bind( function( to ) {
			var slider_class;
			var remove_class;
			if( to == 'one' ) {
	...
	wp.customize( 'avid_magazine_featured_layouts', function( value ) {
		value.bind( function( to ) {
			var featured_class;
			var remove_class;
			if( to == 'one' ) {
