...
( function( $ ) {
	...
	wp.customize( 'aileron_archive_co_post_date', function( value ) {
		value.bind( function( to ) {
			if ( true === to ) {
	...
	wp.customize( 'aileron_archive_co_post_categories', function( value ) {
		value.bind( function( to ) {
			if ( true === to ) {
	...
	wp.customize( 'aileron_archive_co_post_author', function( value ) {
		value.bind( function( to ) {
			if ( true === to ) {
	...
	wp.customize( 'aileron_archive_co_post_comments', function( value ) {
		value.bind( function( to ) {
			if ( true === to ) {
	...
	// Date Control Single
	wp.customize( 'aileron_single_co_post_date', function( value ) {
		value.bind( function( to ) {
			if ( true === to ) {
	...
	wp.customize( 'aileron_single_co_post_categories', function( value ) {
		value.bind( function( to ) {
			if ( true === to ) {
	...
	// Tag Control Single
	wp.customize( 'aileron_single_co_post_tags', function( value ) {
		value.bind( function( to ) {
			if ( true === to ) {
	...
	wp.customize( 'aileron_single_co_post_author', function( value ) {
		value.bind( function( to ) {
			if ( true === to ) {
				$( '.single .byline' ).css( {
					clip: 'auto',
