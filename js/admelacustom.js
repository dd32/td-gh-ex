...
jQuery(function() {
        jQuery(window).scroll(function() {
            if (jQuery(this).scrollTop() > 600) {
                ...
                jQuery('#admela_top').fadeOut();
            }
        });
        jQuery('#admela_top a').on('click', function() {
...
jQuery('.owl-next').on('mouseover', function(){
  ...
  jQuery(this).parent().removeClass('admela_nxtishover');
});
...
! function(e, t) {
	"use strict";
    t("nav").before('<button type="button" class="admela_menutoggle" role="button" aria-pressed="false"></button>'), t("nav .sub-menu,.widget_nav_menu .sub-menu,.widget_pages .children,.widget_categories .children").before('<button class="admela_submenutoggle" role="button" aria-pressed="false"></button>'), t(".admela_menutoggle, .admela_submenutoggle").on("click", function() {
        var e = t(this);
...
jQuery(window).scroll(function(){
		...
		var scrollbarval = (scrolltop) / (docheight - winheight);
		var scrollbarroundup = Math.round(scrollbarval*100);
		jQuery('#admela_postredbar').css('width',scrollbarroundup+'%');
	});
...
jQuery(window).scroll(function(){
	    	...
	    	if(jQuery(this).scrollTop() >= 150){
	    		...
	    		jQuery('#admela_postinfobar').addClass('admela_pstifscroll');
	    		
	        }
	        else if(jQuery(this).scrollTop() < 150)
	        {
	        	
	    		jQuery('#admela_postinfobar').removeClass('admela_pstifscroll');
	        }
