...
$s.css('background-image','url('+$img.attr('src')+')');$img.css('visibility','hidden');$s.wrapInner('<div class="full-container"></div>');});});var pixelRatio=!!window.devicePixelRatio?window.devicePixelRatio:1;if(pixelRatio>1||true){$('img[data-retina-image]').each(function(){$(this).attr('src',$(this).data('retina-image'));})}});