...
//max content wrapper width
	wp.customize( 'width_main_wrapper', function( value ) {
		value.bind( function( to ) {
			$( '.main-wrapper, .sidebar-footer .widget-area,.wide .widget > input,.wide .widget > form, .wide .widget > div, .wide .widget-area .widget > ul, .text-container, .max-width, .max-header-width, .logo-block' ).css('maxWidth', to + 'px');
		} );
	} );
...
//link
	wp.customize( 'link_color', function( value ) {
		value.bind( function( to ) {
			...
			$( '.widget.aladdin_recent_posts .content article footer a, .content article footer a, .content-container article .entry-content a, .comments-link a, .category-list a, .featured-post, .logged-in-as a, .site .edit-link, .jetpack-widget-tag-nav, .jetpack-widget-nav, .content footer' ).css( 'color', to);	
...
//background
	wp.customize( 'buttons_color', function( value ) {
		value.bind( function( to ) {
			$( '.widget.aladdin_widget_button' ).css( 'background-color', to_rgba(to,  GetControlVal('buttons_color_opacity') ));
		} );
	} );

	wp.customize( 'buttons_color_opacity', function( value ) {
		value.bind( function( to ) {
			$( '.widget.aladdin_widget_button' ).css( 'background-color', to_rgba(GetControlVal('buttons_color'), to));
		} );
	} );
...
//button
	wp.customize( 'buttons_button', function( value ) {
		value.bind( function( to ) {
			$( '.widget.aladdin_widget_button .aladdin-link' ).css( 'background-color', to_rgba(to,  GetControlVal('buttons_button_opacity') ));
		} );
	} );

	wp.customize( 'buttons_button_opacity', function( value ) {
		value.bind( function( to ) {
			$( '.widget.aladdin_widget_button .aladdin-link' ).css( 'background-color', to_rgba(GetControlVal('buttons_button'), to));
		} );
	} );
...
//link
	wp.customize( 'buttons_link', function( value ) {
		value.bind( function( to ) {
			$( '.widget.aladdin_widget_button a' ).css( 'color', to);
		} );
	} );	
//border
	wp.customize( 'buttons_border', function( value ) {
		value.bind( function( to ) {
			$( '.widget.aladdin_widget_button .aladdin-link' ).css( 'border-color', to_rgba(to,  GetControlVal('buttons_border_opacity') ));
		} );
	} );

	wp.customize( 'buttons_border_opacity', function( value ) {
		value.bind( function( to ) {
			$( '.widget.aladdin_widget_button .aladdin-link' ).css( 'border-color', to_rgba(GetControlVal('buttons_border'), to));
		} );
	} );
...
//content
	wp.customize( 'content_color', function( value ) {
		value.bind( function( to ) {
			$( '.flex .content-container, #woocommerce-wrapper, .header-wrapper, .nothing-found, .archive-header, .after-content,.comments-area, .nav-link, .pagination.loop-pagination, .content-container' ).css( 'background-color', to_rgba(to,  GetControlVal('content_color_opacity') ));
		} );
	} );

	wp.customize( 'content_color_opacity', function( value ) {
		value.bind( function( to ) {
			$( '.flex .content-container, #woocommerce-wrapper, .header-wrapper, .nothing-found, .archive-header, .after-content,.comments-area, .nav-link, .pagination.loop-pagination, .content-container' ).css( 'background-color', to_rgba(GetControlVal('content_color'), to));
		} );
	} );
...
//text		
	wp.customize( 'content_text', function( value ) {
		value.bind( function( to ) {
			$( '.flex .content-container, #woocommerce-wrapper, .header-wrapper, .nothing-found, .archive-header, .after-content,.comments-area, .nav-link, .pagination.loop-pagination, .content-container' ).css( 'color', to );
		} );
	} );	
...
//menu widget		
	wp.customize( 'widget1_color', function( value ) {
		value.bind( function( to ) {
			$( '.wide .widget.aladdin_recent_posts' ).css( 'background-color', to_rgba(to, GetControlVal('widget1_color_opacity')));
		} );
	} );	
	
	wp.customize( 'widget1_color_opacity', function( value ) {
		value.bind( function( to ) {
			$( '.wide .widget.aladdin_recent_posts' ).css( 'background-color', to_rgba(GetControlVal('widget1_color'), to));
		} );
	} );
...
//top sidebar background		
	...
	wp.customize( 'sidebar1_color_opacity', function( value ) {
		value.bind( function( to ) {
			$( '.sidebar-top-full' ).css( 'background-color', to_rgba(GetControlVal('sidebar1_color'), to));
		} );
	} );
