jQuery(function(){
	...
	jQuery(window).resize(function(){
		...
		var cap_height = jQuery(this).outerHeight();
    ...
    jQuery('.thumbnail-gallery .gallery-item a').each(function(){
        jQuery(this).addClass('fancybox-gallery').attr('data-fancybox-group','group');
    });

    if(jQuery(window).width() > 940 ){
    var totalWidth = 0;
    var wrapperWidth = jQuery('#site-navigation .menu').width() - 100;
    var items = jQuery('#site-navigation .menu > li').each(function(){
