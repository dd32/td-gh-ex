...
( function( $ ) {
	...
	var style = $( '#adelin-color-scheme-css' );
	var api = wp.customize;

	if ( ! style.length ) {
		style = $( 'head' ).append( '<style type="text/css" id="adelin-color-scheme-css" />' )
		                    .find( '#adelin-color-scheme-css' );
	}
	...
	function writeCSS(){
		...
		$('#adelin-preview-style-inline-css').text(cssOutput);
	}
