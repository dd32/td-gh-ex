(function($) {
	...
	$( document ).ready(function() {
		...
		ayamagazine_mainMenuInit();

		if (ayamagazine_options && ayamagazine_options.loading_effect) {
			ayamagazine_init_loading_effects();
		}
   ...
   $('.sub-menu-item-toggle').on('click', function(e) {
		...
		$(window).resize(function () {
	    	...
	    	ayamagazine_mainMenuClear();
	    	ayamagazine_mainMenuInit();
		});
	});

	function ayamagazine_mainMenuClear() {
	...
	function ayamagazine_mainMenuInit() {
	...
	function ayamagazine_init_loading_effects() {
