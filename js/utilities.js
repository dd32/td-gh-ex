(function($) {
	...
	$( document ).ready(function() {
		...
		if (ayapsychology_options && ayapsychology_options.loading_effect) {
			ayapsychology_init_loading_effects();
		}
   ...
   $('.sub-menu-item-toggle').on('click', function(e) {
	...
	function ayapsychology_mainMenuClear() {
	...
	function ayapsychology_mainMenuInit() {
	...
	function ayapsychology_init_loading_effects() {
