 ...
 * General settings
 */
$ariel_defaults['ariel_footer_copyright']        = esc_html__( 'Copyright &copy; ', 'ariel' ). date( 'Y' ) . ' <a href="https://www.lyrathemes.com/ariel/">Ariel</a>';
 ...
 * Site Identity
 */
$ariel_defaults['ariel_image_logo_show'] = 0;
$ariel_defaults['ariel_text_logo']       = get_bloginfo( 'name' );
/**
 * Banner setting
 */
$ariel_defaults['ariel_banner_heading']     = get_bloginfo( 'name' );
$ariel_defaults['ariel_banner_description'] = get_bloginfo( 'description' );
$ariel_defaults['ariel_banner_url']         = '#';
/**
 * Frontpage > Banner / Slider
 */
$ariel_defaults['ariel_frontpage_banner']                 = 'Banner';
$ariel_defaults['ariel_frontpage_slider_type']            = 'Default';
 ...
 */
$ariel_defaults['ariel_frontpage_featured_posts_show']    = 1;
 ...
 * Blog feed
 */
$ariel_defaults['ariel_blog_feed_meta_show']     = 1;
...
$ariel_defaults['ariel_blog_feed_label']         = __( 'Recent Posts', 'ariel' );
$ariel_defaults['ariel_blog_feed_sidebar_show']  = 1;
$ariel_defaults['ariel_blog_feed_post_format']   = 'Grid';
/**
 * Posts
 */
$ariel_defaults['ariel_posts_meta_show']            = 1;
