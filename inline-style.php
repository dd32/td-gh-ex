<?php
	...
	if($automotive_centre_first_color != false){
		$custom_css .='#sidebar .tagcloud a:hover,.pagination a:hover,.pagination .current,#sidebar h3,#comments input[type="submit"],#footer-2,input[type="submit"],#sidebar .custom-social-icons i, #footer .custom-social-icons i,.search-box i,.top-btn a:hover,.slider-btn a:before,.more-btn a,#slider .carousel-control-prev-icon:hover, #slider .carousel-control-next-icon:hover,.main-navigation ul.sub-menu li:hover,#footer .tagcloud a:hover,nav.woocommerce-MyAccount-navigation ul li,.woocommerce #respond input#submit, .woocommerce a.button, .woocommerce button.button, .woocommerce input.button, .woocommerce #respond input#submit.alt, .woocommerce a.button.alt, .woocommerce button.button.alt, .woocommerce input.button.alt, .scrollup i {';
			$custom_css .='background-color: '.esc_html($automotive_centre_first_color).';';
		$custom_css .='}';
	}
	if($automotive_centre_first_color != false){
		$custom_css .='#sidebar ul li a:hover,.info-box i,a,.post-navigation a:hover .post-title, .post-navigation a:focus .post-title,#header .main-navigation a:hover,.post-main-box:hover h3,#footer h3,.serv-box a,#footer li a:hover,a.scrollup, #footer .custom-social-icons i:hover, .entry-content a{';
	...
	if($automotive_centre_first_color != false){
		$custom_css .='#header .main-navigation ul li a:hover,#footer h3:after{';
