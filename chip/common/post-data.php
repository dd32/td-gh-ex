...
<div class="chipboxg1 chiplisth1 margin10b font11">
  ...
  <?php endforeach; ?>
  on <a href="<?php the_permalink() ?>" rel="bookmark" title="Permanent Link to <?php the_title_attribute(); ?>"><?php the_time('M j, Y') ?></a> by <a href="<?php echo get_author_posts_url($authordata->ID); ?>"><?php echo $authordata->display_name; ?></a>
