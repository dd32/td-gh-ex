...
<div>
  ...
  <?php if( $chip_life_global['theme_options']['chip_life_rss'] == 1 ): ?>
  ...
  <?php if( $chip_life_global['theme_options']['chip_life_delicious'] == 1 ): ?>
  ...
  <?php if( $chip_life_global['theme_options']['chip_life_facebook'] == 1 ): ?>
  ...
  <?php if( $chip_life_global['theme_options']['chip_life_stumble'] == 1 ): ?>
  <a href="<?php echo $chip_life_global['theme_options']['chip_life_stumble_url']; ?>"><img src="<?php echo CHIP_LIFE_IMAGES_WSROOT; ?>stumbleupon.png" width="32" height="32" alt="<?php echo $chip_life_global['theme_options']['chip_life_stumble_url']; ?>" /></a>
  <?php endif; ?>
  
  <?php if( $chip_life_global['theme_options']['chip_life_digg'] == 1 ): ?>
  <a href="<?php echo $chip_life_global['theme_options']['chip_life_digg_url']; ?>"><img src="<?php echo CHIP_LIFE_IMAGES_WSROOT; ?>digg.png" width="32" height="32" alt="<?php echo $chip_life_global['theme_options']['chip_life_digg_url']; ?>" /></a>
  <?php endif; ?>
  
  <?php if( $chip_life_global['theme_options']['chip_life_twitter'] == 1 ): ?>
