...
<div id="content">
	...
	<?php if ( have_posts() ) : ?>
		<h3 class="page-title"><?php printf( __( 'Search Results for: %s', 'guido' ), '<span>' . get_search_query() . '</span>' ); ?></h3>
	...
	<?php while ( have_posts() ) : the_post(); ?>
		...
		<h5 class="postmetadata"> <?php _e('Posted on ', 'guido'); ?><?php echo get_the_date(); ?></h5>
