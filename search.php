...
<section class="section-main back-img-aboutus">
  <div class="container">
    <div class="col-md-12 img-banner-aboutus">
      <p class="font-34 color-fff conter-text""><?php esc_html_e( 'Search Results for', 'booster' ); echo ' : '. get_search_query(); ?></p>
  ...
  <div class="container no-padding-left"> 
    <div class="row">
      <div class="col-md-8 booster-post main">
        ...
        echo "<h3>".esc_html( "Result can't be found.", 'booster' )."</h3>";
        get_search_form();
    endif; ?>
    <!--Pagination Start-->
