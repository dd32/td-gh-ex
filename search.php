...
<div class="post" id="post-<?php the_ID(); ?>">
	...
	<div class="comments"><?php comments_popup_link(__('0 Comments'), __('1 Comments'), __('% Comments')); ?></div>
	<a href="<?php the_permalink() ?>" class="moresearch">Read More</a>
	<div class="date">
...
<div class="navigation postnavigation">
	<div class="alignleft"><?php next_posts_link('Previous <span>Page</span>') ?></div>
	<div class="alignright"><?php previous_posts_link('Next <span>Page</span>') ?></div>
</div>
