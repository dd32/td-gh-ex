...
<main id="maincontent" role="main">
    <div class="middle-align container">
        <?php
            $automotive_centre_theme_lay = get_theme_mod( 'automotive_centre_theme_options','Right Sidebar');
            if($automotive_centre_theme_lay == 'Left Sidebar'){ ?>
                <div class="row m-0">
                    ...
                    <div id="our-services" class="services col-lg-8 col-md-8">
                        ...
                        printf( esc_html__( 'Results For: %s','automotive-centre'), esc_html( get_search_query() ) ); ?></h1> 
                        <?php if ( have_posts() ) :
                            /* Start the Loop */
                ...
                <div class="clearfix"></div>
            <?php }else if($automotive_centre_theme_lay == 'Right Sidebar'){ ?>
                <div class="row m-0">
                    <div id="our-services" class="services col-lg-8 col-md-8"> 
                        <h1 class="entry-title"><?php /* translators: %s: search term */
                        printf( esc_html__( 'Results For: %s','automotive-centre'), esc_html( get_search_query() ) ); ?></h1>
            ...
            <?php }else if($automotive_centre_theme_lay == 'One Column'){ ?>
            ...
            <?php }else if($automotive_centre_theme_lay == 'Four Columns'){ ?>
                <div class="row m-0">
                    <div class="col-lg-3 col-md-3" id="sidebar"><?php dynamic_sidebar('sidebar-1');?></div>
            ...
            <?php }else if($automotive_centre_theme_lay == 'Grid Layout'){ ?>
                <div class="row m-0">
