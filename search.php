...
<p class="timestamp">Your search for "<?php echo $s ?>" returned the following matches:</p>
...
<p>Your search for "<?php echo $s ?>" gave no matches. Please try a different word, or use the navigation menus to search the site.</p>
<?php endif; ?>
