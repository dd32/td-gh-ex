...
get_header(); ?><div id="container">
	...
	<div id="content" class="searchinfo">
        <h1 class="page-title fa-search-plus">SEARCH RESULTS</h1>
		...
		<?php while (have_posts()) : the_post();
			if($counter == 0) { 
				...
				<h3 class="arc-src"><spanNumber of Results: </span><?php echo $numposts; ?></h3><br />
				<?php } //endif ?>
...
<?php the_post_thumbnail('thumbnail');  writingboard_content(); ?> 
 ...
 <div class="up-bottom-border">
 				<p class="postmetadata"><?php edit_post_link('Edit', '', ' | '); ?>  <?php comments_popup_link('No Comments' . ' &#187;', 'One Comment' . '  &#187;', '% Comments &#187;'); ?> <?php the_tags('<br />' .  'Tags'. ': ', ', ', '<br />'); ?></p>
 				</div></div></div>
