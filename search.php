...
?>
    ...
    <?php }?>
	    ...
	    <div id="primary" class="content-area <?php echo esc_attr($sidebar_class); ?>">
			...
			<main id="main" class="site-main search-main" role="main">
				...
				<?php if ( have_posts() ) : ?>
					...
					<header class="page-header">
						<h3 class="page-title">
							<?php printf( esc_html__( 'Search Results for: %s','ace-corporate' ), '<span> ' . get_search_query() . ' </span>' ); ?>
						</h3>
					</header>
					<!-- End the .page-header -->
			...
			<h2 class="screen-reader-text"><?php esc_html_e( 'Posts navigation','ace-corporate' ); ?></h2>
			<div class="nav-links clearfix">
				<?php if ( get_next_posts_link() ) : ?>
				<div class="nav-previous">
					<?php next_posts_link( __( 'Older posts <i class="fa fa-long-arrow-left post-arrow"></i>','ace-corporate' ) ); ?>
				</div>
				<?php else :  ?>
