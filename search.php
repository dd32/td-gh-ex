...
<div class="generator-single-blog section-main">
  <div class=" container-generator container">
	<h1> <?php _e('Search Results for','generator'); echo ": ". get_search_query(); ?></h1>
      ...
      <?php while ( have_posts() ) : the_post();
       ...
       <div class="blog-post-list">
        ...
        <div class="col-md-12 generator-post-content no-padding">
         ...
         <?php if($generator_image != "") { ?><a href="<?php the_permalink(); ?>"><img src="<?php echo $generator_image; ?>" class="img-responsive generator-featured-image" /></a><?php }
            the_excerpt(); ?>
