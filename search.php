...
<main role="main" id="maincontent" class="our-services">
    <div class="innerlightbox">
        <div class="container">
            <?php
            $advance_coaching_left_right = get_theme_mod( 'advance_coaching_layout_options','Right Sidebar');
            if($advance_coaching_left_right == 'Left Sidebar'){ ?>
                <div class="row">
                    ...
                    <div id="post-<?php the_ID(); ?>" <?php post_class('col-lg-8 col-md-8'); ?>>
                       <h1 class="entry-title"><?php /* translators: %s: search term */ printf( esc_html__( 'Results For: %s','advance-coaching'), '<span>' . esc_html( get_search_query() ) . '</span>' ); ?></h1>
