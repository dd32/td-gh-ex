...
<span class="meta"><?php _e( avedon_posted_on(), 'avedon' ); ?></span>
<?php the_excerpt();?>
</div></div>
...
<p class="panel-body"><?php _e( 'It seems we cannot find what you are looking for. Perhaps you should try again with a different search term.', 'avedon' ); ?></p><hr />
<?php get_search_form(); ?>
</div></div>
