...
class Smart_Project_Base extends Smart_Base {
	...
	public $project_enqueue_styles = array(
		...
		'maxflat-flexslider'           => array(
			'path'     => '/css/flexslider/flexslider.css',

		),
		'maxflat-responsive-tables'           => array(
	...
	public $project_sidebars = array(
		...
		'sidebar-4' => array(
			'name'          => 'MaxFlat: Category Page Sidebar',
		...
		'sidebar-5' => array(
			'name'          => 'MaxFlat: Single Page Sidebar',
		...
		'sidebar-2' => array(
			...
			'description'   => 'MaxFlat: Footer Front Page Widget Area',
			'before_widget' => '<li id="%1$s" class="widget %2$s">',
			'after_widget'  => '<hr /></li>',
		...
		'sidebar-3' => array(
			'name'          => 'MaxFlat: Footer Single Page Widget Area',
			...
			'sidebar-6' => array(
			'name'          => 'MaxFlat: sidebar below the vertical menu',
			'description'   => 'Appears below the vertical menu',
			'before_widget' => '<li id="%1$s" class="widget %2$s">',
			'after_widget'  => '</li>',
			'before_title'  => '<h3 class="widget-title"><span>',
			'after_title'   => '</span></h3>'
	...
	public function __construct() {
		...
		//Initialize layout
		$this->obj_utils = new Smart_Project_Utils( $this );
